...
function PromptDialog({ promptDialog, setPromptDialog, t }) {
  ...
  const handleDialogKeyDown = React.useCallback((e) => {
    if (e.key === "Enter" && !promptDialog.multiline) {
      e.preventDefault();
      handleSubmit();
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center shrink-0" }, /* @__PURE__ */ React.createElement(Edit3, { size: 20, className: "text-indigo-600", "aria-hidden": "true" })), /* @__PURE__ */ React.createElement("h3", { id: "alloflow-prompt-title", className: "text-lg font-bold text-slate-800 flex-1 truncate" }, promptDialog.title || t("common.enter_value") || "Enter Value"), /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ React.createElement("p", { id: "alloflow-prompt-description", className: "text-sm text-slate-700 leading-relaxed mb-4 whitespace-pre-wrap" }, promptDialog.message),
