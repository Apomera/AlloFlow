...
function EducatorHubModal(props) {
  ...
  } }, /* @__PURE__ */ React.createElement("div", { "data-help-key": "educator_hub_modal_panel", className: "bg-white rounded-2xl shadow-2xl w-full max-w-2xl p-8 max-h-[90vh] overflow-y-auto", role: "dialog", "aria-modal": "true", "aria-label": t("educator_hub.dialog_aria") || "Educator Tools", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-6" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-bold text-slate-800 flex items-center gap-2" }, "\u{1F6E0}\uFE0F ", t("educator_hub.title") || "Educator Tools"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-600 mt-1" }, t("educator_hub.subtitle") || "Professional tools for educators and clinicians")), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowEducatorHub(false), className: "p-2 -m-1 rounded-lg text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-colors text-xl", "aria-label": t("educator_hub.close_aria") || "Close educator tools" }, "\u2715")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement("button", { "data-help-key": "educator_hub_bridge_card", onClick: () => {
    setShowEducatorHub(false);
    setBridgeSendOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-cyan-50 to-sky-50 border border-cyan-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1" }, "\u{1F309}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-cyan-800" }, t("educator_hub.bridge_title") || "Family Bridge"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-cyan-700 mt-1" }, t("educator_hub.bridge_desc") || "Live two-way translation to connect with multilingual families and students: speak or type, hear it read back, and save key terms."))), /* @__PURE__ */ React.createElement("button", { "data-help-key": "educator_hub_behavior_lens_card", onClick: () => {
    setShowEducatorHub(false);
