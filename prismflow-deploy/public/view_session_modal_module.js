...
function SessionModal({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: `fixed inset-0 bg-black/80 z-[150] flex items-center justify-center animate-in fade-in duration-200 ${isProjectionMode ? "p-0" : "p-4"}`, role: "presentation", onClick: handleSetShowSessionModalToFalse }, /* @__PURE__ */ React.createElement("div", { ref: dialogRef, tabIndex: -1, className: `bg-white shadow-2xl text-center w-full overflow-y-auto relative animate-in zoom-in-95 duration-200 focus:outline-none ${isProjectionMode ? "h-screen max-w-none rounded-none p-6 sm:p-10" : "max-h-[90vh] max-w-md rounded-2xl p-5 sm:p-8"}`, onClick: (e) => e.stopPropagation(), role: "dialog", "aria-modal": "true", "aria-labelledby": "alloflow-session-modal-title" }, !isLocalOnly && liveJoinUrl && /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => setIsProjectionMode((value) => !value), className: "absolute top-4 left-4 z-10 flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs font-bold text-slate-800 shadow-sm hover:border-indigo-400", "aria-label": isProjectionMode ? "Exit projection mode" : "Open projection mode" }, isProjectionMode ? /* @__PURE__ */ React.createElement(Minimize, { size: 16 }) : /* @__PURE__ */ React.createElement(Maximize, { size: 16 }), " ", /* @__PURE__ */ React.createElement("span", { className: "hidden sm:inline" }, isProjectionMode ? "Exit projection" : "Project QR")), /* @__PURE__ */ React.createElement("button", { onClick: handleSetShowSessionModalToFalse, className: "absolute top-4 right-4 p-2 rounded-full text-slate-600 hover:text-slate-600 hover:bg-slate-100 focus:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors", "aria-label": t("common.close") }, /* @__PURE__ */ React.createElement(X, { size: 24 })), /* @__PURE__ */ React.createElement("div", { className: "flex justify-center mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-green-100 p-4 rounded-full shadow-inner" }, /* @__PURE__ */ React.createElement(Wifi, { size: 48, className: "text-green-600 animate-pulse" }))), /* @__PURE__ */ React.createElement("h2", { id: "alloflow-session-modal-title", className: "text-2xl font-black text-slate-800 mb-2" }, isLocalOnly ? "Local preview" : isMailboxSession ? "Class Mailbox live session" : t("session.live_title")), /* @__PURE__ */ React.createElement("p", { className: "text-slate-600 mb-6 font-medium" }, isLocalOnly ? "Firebase did not create a shareable session. This preview stays on the teacher device." : isMailboxSession ? "Students join through your Class Mailbox without accounts." : t("session.live_instruction")), /* @__PURE__ */ React.createElement(
  ...
  ), liveJoinUrl && /* @__PURE__ */ React.createElement("div", { className: `bg-cyan-50 rounded-xl border border-cyan-200 text-left ${isProjectionMode ? "mx-auto max-w-5xl p-5 mb-3" : "p-4 mb-6"}` }, /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-cyan-700 font-bold uppercase tracking-wider mb-2 text-center" }, isMailboxSession ? "Class Mailbox QR join" : "Student QR join"), /* @__PURE__ */ React.createElement("div", { className: "flex justify-center mb-3" }, /* @__PURE__ */ React.createElement("div", { className: `bg-white border border-cyan-200 rounded-lg p-2 flex items-center justify-center shadow-sm ${isProjectionMode ? "w-[min(52vh,72vw)] h-[min(52vh,72vw)]" : "w-40 h-40"}` }, liveQrSvg ? /* @__PURE__ */ React.createElement("div", { className: "w-full h-full [&_svg]:w-full [&_svg]:h-full", dangerouslySetInnerHTML: { __html: liveQrSvg } }) : /* @__PURE__ */ React.createElement("span", { className: "text-xs font-bold text-cyan-700 text-center" }, liveQrError ? "Copy link below" : "QR loading"))), /* @__PURE__ */ React.createElement("div", { className: "mb-3 grid grid-cols-1 gap-2 text-xs sm:grid-cols-3", "aria-label": "Live session readiness" }, /* @__PURE__ */ React.createElement("span", { className: "flex items-center justify-center gap-1.5 rounded-lg bg-white px-2 py-2 font-bold text-emerald-800" }, /* @__PURE__ */ React.createElement(CheckCircle2, { size: 14 }), " Session active"), /* @__PURE__ */ React.createElement("span", { className: "flex items-center justify-center gap-1.5 rounded-lg bg-white px-2 py-2 font-bold text-emerald-800" }, /* @__PURE__ */ React.createElement(CheckCircle2, { size: 14 }), " Student link ready"), /* @__PURE__ */ React.createElement("span", { className: "flex items-center justify-center gap-1.5 rounded-lg bg-white px-2 py-2 font-bold text-emerald-800" }, /* @__PURE__ */ React.createElement(CheckCircle2, { size: 14 }), " QR validated")), /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    " ",
    /* @__PURE__ */ React.createElement(Copy, { size: 12 })
  )), !isProjectionMode && sessionData && /* @__PURE__ */ React.createElement("div", { className: "mb-6 text-center animate-in slide-in-from-bottom-2" }, /* @__PURE__ */ React.createElement(
    "button",
    {
