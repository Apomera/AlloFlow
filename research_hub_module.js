  ...
  "_tmp_research_hub_entry.jsx"(exports, module) {
    ...
    (function() {
      ...
      function ResearchAlloSheetReviewDialog(props) {
        ...
        }))), /* @__PURE__ */ React.createElement("div", { role: "group", "aria-label": "Research Hub AlloSheet transfer preview", style: { display: "grid", gap: "8px" } }, selectedTables.length ? selectedTables.map(function(table) {
