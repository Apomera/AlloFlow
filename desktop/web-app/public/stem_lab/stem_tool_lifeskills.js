...
(function() {
  ...
  var LAUNDRY_STAINS = [
    { stain: 'Pizza grease on a hoodie', icon: '\uD83C\uDF55', type: 'Oil/fat', answer: 0, choices: ['Blot, pretreat with liquid detergent, then wash warm if the label allows', 'Rinse only with cold water, then dry on high heat to bake the stain away', 'Rub hard with a dry towel', 'Add extra fabric softener'], science: 'Surfactants have oil-loving and water-loving parts, so they can surround grease and help rinse it away.' },
    { stain: 'Grass on socks', icon: '\uD83C\uDF31', type: 'Pigment + protein', answer: 1, choices: ['Use chlorine bleach on every fabric', 'Pretreat with enzyme detergent and wait before washing', 'Dry the garment first so the stain is easier to see and treat', 'Only use fabric softener'], science: 'Enzymes can help break down proteins and starches; waiting gives the chemistry time to work.' },
    { stain: 'Coffee on a white shirt', icon: '\u2615', type: 'Tannin', answer: 2, choices: ['Use dryer heat immediately', 'Scrub hard with bar soap and hot water before rinsing', 'Flush with cool water and pretreat before washing', 'Wash with new dark jeans'], science: 'Tannin stains spread through water-soluble compounds; early rinsing moves them out before they bind deeper.' },
    { stain: 'Muddy knees on pants', icon: '\uD83E\uDD4C', type: 'Clay/soil', answer: 3, choices: ['Put straight into the dryer', 'Use lots of detergent without rinsing first', 'Wash with delicates', 'Let mud dry, brush off solids, then wash'], science: 'Removing loose particles first keeps mineral soil from grinding into the fibers.' },
    { stain: 'Sweat odor in athletic gear', icon: '\uD83C\uDFC3', type: 'Body oil + bacteria', answer: 0, choices: ['Wash soon with detergent and skip fabric softener', 'Seal wet gear in a bag for a week', 'Use dryer sheets only', 'Always use hot water on stretch fabric to kill odor'], science: 'Odor often comes from body oils and microbes trapped in synthetic fibers. Softener coatings can make odor harder to remove.' },
    { stain: 'Ink mark on a pocket', icon: '\uD83D\uDD8A\uFE0F', type: 'Dye/ink', answer: 2, choices: ['Wash with white towels', 'Put it in the dryer first so the ink dries hard and flakes off in the wash', 'Isolate, test a safe remover on a hidden spot, then rinse and wash', 'Add extra detergent and hope'], science: 'Ink is a dye mixture. Isolating and testing first prevents spreading color or damaging the fabric.' }
  ];
  ...
  window.StemLab.registerTool('lifeSkills', {
    ...
    render: function(ctx) {
      ...
      function updateLifeSkills3dPassportSignals(source, signals) {
        var labId = lifeSkills3dLabId(source);
        if (!LIFE_SKILLS_3D_LABS.some(function(lab) { return lab.id === labId; })) return;
        upd('lifeSkills3dPassport', function(current) {
          var next = Object.assign({}, current || {});
      ...
      window.__alloflowLifeSkills3dBridge.handle = function(data) {
        ...
        if (/-reflection$/.test(type)) {
          upd('lifeSkills3dStatus', label + ' reflection saved.');
          announceToSR('Saved the 3D ' + label + ' reflection.');
          setTimeout(function() { upd('lifeSkills3dStatus', null); }, 5000);
          return;
        }
        if (/-confidence$/.test(type)) {
          updateLifeSkills3dPassportSignals(data.source, { confidence: data.confidence });
          upd('lifeSkills3dStatus', label + ' readiness saved.');
          announceToSR('Saved the 3D ' + label + ' readiness level.');
          setTimeout(function() { upd('lifeSkills3dStatus', null); }, 5000);
          return;
        }
        if (/-next-step$/.test(type)) {
          updateLifeSkills3dPassportSignals(data.source, { nextStep: data.nextStep });
          upd('lifeSkills3dStatus', label + ' next practice step saved.');
          announceToSR('Saved the 3D ' + label + ' next practice step.');
          setTimeout(function() { upd('lifeSkills3dStatus', null); }, 5000);
          return;
        }
        if (/-replay-complete$/.test(type)) {
          upd('lifeSkills3dStatus', label + ' replay completed.');
          announceToSR('Completed the 3D ' + label + ' replay.');
          setTimeout(function() { upd('lifeSkills3dStatus', null); }, 5000);
          return;
        }
      ...
      function openLifeSkillsSafety3D() {
        ...
        if (!w) {
          announceToSR(__alloT('stem.lifeskills.sr_the_3d_home_safety_walkthrough_was_blocked_allow', 'The 3D home safety walkthrough was blocked. Allow pop-ups for this page, then try again.'));
        ...
        announceToSR(__alloT('stem.lifeskills.sr_opened_the_3d_home_safety_walkthrough_in_a_new_wi', 'Opened the 3D home safety walkthrough in a new window.'));
        try { w.focus(); } catch (_) {}
      }
      function openLifeSkillsRepair3D() {
        ...
        if (!w) {
          announceToSR(__alloT('stem.lifeskills.sr_the_3d_home_repair_lab_was_blocked_allow_pop_ups', 'The 3D home repair lab was blocked. Allow pop-ups for this page, then try again.'));
        ...
        announceToSR(__alloT('stem.lifeskills.sr_opened_the_3d_home_repair_lab_in_a_new_window', 'Opened the 3D home repair lab in a new window.'));
        try { w.focus(); } catch (_) {}
      }
      function openLifeSkillsKitchen3D() {
        ...
        if (!w) {
          announceToSR(__alloT('stem.lifeskills.sr_the_3d_kitchen_lab_was_blocked_allow_pop_ups_for', 'The 3D kitchen lab was blocked. Allow pop-ups for this page, then try again.'));
        ...
        announceToSR(__alloT('stem.lifeskills.sr_opened_the_3d_kitchen_and_food_safety_lab_in_a_ne', 'Opened the 3D kitchen and food safety lab in a new window.'));
        try { w.focus(); } catch (_) {}
      }
      function openLifeSkillsLaundry3D() {
        ...
        if (!w) {
          announceToSR(__alloT('stem.lifeskills.sr_the_3d_laundry_lab_was_blocked_allow_pop_ups_for', 'The 3D laundry lab was blocked. Allow pop-ups for this page, then try again.'));
        ...
        announceToSR(__alloT('stem.lifeskills.sr_opened_the_3d_laundry_and_clothing_care_lab_in_a', 'Opened the 3D laundry and clothing care lab in a new window.'));
        try { w.focus(); } catch (_) {}
      }
      function openLifeSkillsTransit3D() {
        ...
        if (!w) {
          announceToSR(__alloT('stem.lifeskills.sr_the_3d_transit_lab_was_blocked_allow_pop_ups_for', 'The 3D transit lab was blocked. Allow pop-ups for this page, then try again.'));
        ...
        announceToSR(__alloT('stem.lifeskills.sr_opened_the_3d_transit_and_street_safety_lab_in_a', 'Opened the 3D transit and street safety lab in a new window.'));
        try { w.focus(); } catch (_) {}
      }
      ...
      function openLifeSkillsCapstone3D() {
        ...
        if (!w) { announceToSR(__alloT('stem.lifeskills.sr_the_3d_day_in_the_life_capstone_was_blocked_allow', 'The 3D day-in-the-life capstone was blocked. Allow pop-ups for this page, then try again.')); upd('capstone3dMsg', 'Pop-up blocked — allow pop-ups for this page, then try again.'); return; }
        upd('capstone3dMsg', 'Adaptive 3D capstone opened with ' + capstoneSupport + ' support.');
        announceToSR('Opened an adaptive 3D capstone focused on ' + capstoneFocusLab.title + '.');
        try { w.focus(); } catch (_) {}
      }
      ...
      function saveOverviewPlan() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_life_skills_plan_saved', 'Life Skills plan saved'));
      }
      ...
      function speakInterviewText(text) {
        if (!text) return;
        announceToSR(__alloT('stem.lifeskills.sr_reading_interview_text', 'Reading interview text'));
      ...
      function sparkInterviewTopic() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_coaching_spark_ready', 'Interview coaching spark ready'));
      }
      ...
      function saveInterviewTranscript() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_transcript_saved', 'Interview transcript saved'));
      }
      ...
      function resetInterviewChat() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_chat_reset', 'Interview chat reset'));
      }
      ...
      function saveInterviewStarAnswer() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_star_answer_saved', 'STAR answer saved'));
      }
      ...
      function selectInterviewPracticePlan(idx) {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_practice_plan_selected', 'Interview practice plan selected'));
      }
      ...
      function buildInterviewPlanFromFeedback() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_practice_plan_updated_from_coaching_fee', 'Interview practice plan updated from coaching feedback'));
      }
      ...
      function saveInterviewPracticePlan() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_practice_plan_saved', 'Interview practice plan saved'));
      }
      ...
      function resetInterviewPracticePlan() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_practice_plan_progress_reset', 'Interview practice plan progress reset'));
      }
      ...
      function saveInterviewRehearsalNote() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_rehearsal_note_saved', 'Interview rehearsal note saved'));
      }

      function useInterviewRehearsalScript() {
        upd('interviewInput', interviewRehearsalScript.script);
        announceToSR(__alloT('stem.lifeskills.sr_interview_rehearsal_script_added_to_chat_answer', 'Interview rehearsal script added to chat answer'));
      }
      ...
      function saveInterviewProofCue() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_proof_cue_saved', 'Interview proof cue saved'));
      }

      function useInterviewProofCueInChat() {
        upd('interviewInput', interviewProofCuePreview);
        announceToSR(__alloT('stem.lifeskills.sr_interview_proof_cue_added_to_chat_answer', 'Interview proof cue added to chat answer'));
      }
      ...
      function saveInterviewDayRunSheet() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_day_run_sheet_saved', 'Interview day run sheet saved'));
      }
      ...
      function saveInterviewPrepPacket() {
        ...
        announceToSR(__alloT('stem.lifeskills.sr_interview_prep_packet_saved', 'Interview prep packet saved'));
      }
      ...
      function downloadInterviewPrepPacket() {
        ...
        try {
          ...
          checkBadge('interviewPacketBuilder');
          announceToSR(__alloT('stem.lifeskills.sr_interview_prep_packet_downloaded', 'Interview prep packet downloaded'));
        } catch(e) {
          ...
          announceToSR(__alloT('stem.lifeskills.sr_download_blocked', 'Download blocked'));
        }
      }
      ...
      function openInterviewPacketPrintView() {
        ...
        try {
          ...
          checkBadge('interviewPacketBuilder');
          announceToSR(__alloT('stem.lifeskills.sr_print_friendly_interview_packet_opened', 'Print-friendly interview packet opened'));
        } catch(e) {
          ...
          announceToSR(__alloT('stem.lifeskills.sr_print_view_blocked', 'Print view blocked'));
        }
      }
      ...
      return h('div', { className: 'space-y-4' },
          ...
          h('div', { className: glassCard + ' space-y-3 relative overflow-hidden', 'data-lifeskills-3d-passport': 'true' },
            ...
            h('div', { className: 'flex items-center justify-between gap-3 flex-wrap' },
              h('div', null,
                ...
                h('p', { className: 'text-[10px] text-slate-500' }, lifeSkills3dReadinessCount + '/' + LIFE_SKILLS_3D_LABS.length + ' readiness check-ins'),
                h('p', { className: 'text-[10px] text-slate-500' }, lifeSkills3dNextStepCount + '/' + LIFE_SKILLS_3D_LABS.length + ' next plans')
              ),
              h('div', { className: 'flex items-center gap-2 flex-wrap' },
                ...
                lifeSkills3dNextLab && h('button', { type: 'button', onClick: function() { openLifeSkills3dById(lifeSkills3dNextLab.id); }, className: 'px-2 py-1 rounded-full bg-teal-700 text-white text-[11px] font-black hover:bg-teal-800 focus:outline-none focus:ring-2 focus:ring-teal-700', 'aria-label': 'Open suggested next lab: ' + lifeSkills3dNextLab.title }, 'Open next lab')
              )
            ),
            h('div', { className: 'grid grid-cols-3 sm:grid-cols-6 gap-1.5 pt-1', 'data-lifeskills-3d-path': 'true', 'aria-hidden': 'true' },
              LIFE_SKILLS_3D_LABS.map(function(lab) {
                var pathRecord = lifeSkills3dPassport[lab.id] || {};
                var pathTotal = Math.max(1, Number(pathRecord.total) || Number(lab.total) || 6);
            ...
            h('div', { className: 'grid sm:grid-cols-2 xl:grid-cols-3 gap-2' },
              LIFE_SKILLS_3D_LABS.map(function(lab) {
                ...
                return h('button', {
                  key: lab.id,
                  type: 'button',
                  'data-lifeskills-3d-passport-tile': lab.id,
                  ...
                  h('div', { className: 'flex items-start justify-between gap-2 pl-1' },
                    h('span', { className: 'min-w-0 flex items-center gap-2 text-sm font-black', style: { color: lab.accent } },
                      h('span', { className: 'shrink-0', 'aria-hidden': 'true' }, lab.icon),
                      h('span', { className: 'truncate' }, lab.title)
                    ),
                    h('div', { className: 'flex shrink-0 items-center gap-1.5' },
                      h('span', { className: 'relative flex h-9 w-9 items-center justify-center rounded-full', style: { background: 'conic-gradient(' + (done ? '#059669' : lab.accent) + ' ' + percent + '%, #e2e8f0 0)' }, 'aria-hidden': 'true' },
                        h('span', { className: 'flex h-7 w-7 items-center justify-center rounded-full bg-white text-[10px] font-black text-slate-700' }, percent + '%')
                      ),
          ...
          h('div', { className: glassCard + ' space-y-3', 'data-lifeskills-action-plan': 'true' },
            ...
            h('div', { className: 'grid md:grid-cols-[1fr_1fr] gap-3' },
              ...
              h('div', { className: 'space-y-2' },
                ...
                h('input', { type: 'range', min: 1, max: 5, step: 1, value: overviewConfidence, onChange: function(e) { upd('overviewConfidence', parseInt(e.target.value, 10) || 1); }, className: 'w-full', style: { accentColor: overviewPath.accent }, 'aria-label': __alloT('stem.lifeskills.a11y_confidence_right_now', 'Confidence right now'), 'aria-valuetext': overviewConfidence + ' out of 5' })
              )
            ),
            h('div', { className: 'space-y-2' },
        ...
        tab === 'paycheck' && h('div', { className: 'space-y-4' },
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('div', { className: 'grid grid-cols-2 sm:grid-cols-5 gap-2' },
              ...
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.pay_period', 'Pay Period')), h('select', { 'aria-label': __alloT('stem.lifeskills.pay_period', 'Pay Period'), value: payFreq, onChange: function(e) { upd('payFreq', e.target.value); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' }, h('option', { value: 'weekly' }, __alloT('stem.lifeskills.weekly', 'Weekly')), h('option', { value: 'biweekly' }, 'Bi-weekly'), h('option', { value: 'monthly' }, __alloT('stem.lifeskills.monthly', 'Monthly')))),
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.state', 'State')), h('select', { 'aria-label': __alloT('stem.lifeskills.state', 'State'), value: payState, onChange: function(e) { upd('payState', e.target.value); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' }, h('option', { value: 'none' }, __alloT('stem.lifeskills.no_state_tax', 'No State Tax')), h('option', { value: 'CA' }, __alloT('stem.lifeskills.california', 'California')), h('option', { value: 'NY' }, __alloT('stem.lifeskills.new_york', 'New York')), h('option', { value: 'TX' }, __alloT('stem.lifeskills.texas_0', 'Texas (0%)')), h('option', { value: 'FL' }, __alloT('stem.lifeskills.florida_0', 'Florida (0%)')), h('option', { value: 'IL' }, __alloT('stem.lifeskills.illinois', 'Illinois')), h('option', { value: 'PA' }, __alloT('stem.lifeskills.pennsylvania', 'Pennsylvania')), h('option', { value: 'MA' }, __alloT('stem.lifeskills.massachusetts', 'Massachusetts')), h('option', { value: 'OH' }, __alloT('stem.lifeskills.ohio', 'Ohio')))),
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.filing', 'Filing')), h('select', { 'aria-label': __alloT('stem.lifeskills.filing', 'Filing'), value: payFiling, onChange: function(e) { upd('payFiling', e.target.value); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' }, h('option', { value: 'single' }, __alloT('stem.lifeskills.single', 'Single')), h('option', { value: 'married' }, __alloT('stem.lifeskills.married', 'Married'))))
            )
          ),
          // Results
        ...
        tab === 'records' && h('div', { className: 'space-y-4', 'data-lifeskills-records-paperwork': 'true' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { updMulti({ recordScenarioIdx: recordScenarioIdx + 1, recordScenarioChoice: '', recordScenarioFb: '' }); }, className: 'px-3 py-1.5 rounded-xl text-[11px] font-bold bg-slate-800 text-white hover:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Next scenario')
            )
          ),
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            h('div', { className: glassCard + ' space-y-3' },
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('button', { onClick: function() {
              ...
              announceToSR(__alloT('stem.lifeskills.sr_paperwork_plan_saved', 'Paperwork plan saved'));
            }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save paperwork plan'),
        ...
        tab === 'transport' && h('div', { className: 'space-y-4', 'data-lifeskills-transportation': 'true' },
            ...
            h('div', { className: 'flex items-start justify-between gap-3 flex-wrap' },
              h('div', null,
                ...
                h('div', { className: 'flex items-center gap-2 flex-wrap mt-3' },
                  h('button', { onClick: openLifeSkillsTransit3D, className: 'px-3 py-2 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-blue-700 to-emerald-700 hover:from-blue-800 hover:to-emerald-800 focus:outline-none focus:ring-2 focus:ring-blue-300', 'aria-label': __alloT('stem.lifeskills.a11y_open_the_3d_transit_and_street_safety_lab_in_a', 'Open the 3D transit and street safety lab in a new window') }, '\uD83C\uDF10 Open 3D transit lab \u2197'),
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { updMulti({ transportScenarioIdx: transportScenarioIdx + 1, transportScenarioChoice: '', transportScenarioFb: '' }); }, className: 'px-3 py-1.5 rounded-xl text-[11px] font-bold bg-sky-700 text-white hover:bg-sky-800 focus:outline-none focus:ring-2 focus:ring-sky-300' }, 'Next scenario')
            )
          ),
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            h('div', { className: glassCard + ' space-y-3' },
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('button', { onClick: function() {
              ...
              announceToSR(__alloT('stem.lifeskills.sr_trip_plan_saved', 'Trip plan saved'));
            }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save trip plan'),
        ...
        tab === 'workreadiness' && h('div', { className: 'space-y-4', 'data-lifeskills-job-readiness': 'true' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { updMulti({ workScenarioIdx: workScenarioIdx + 1, workScenarioChoice: '', workScenarioFb: '' }); }, className: 'px-3 py-1.5 rounded-xl text-[11px] font-bold bg-indigo-700 text-white hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-300' }, 'Next scenario')
            )
          ),
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            h('div', { className: glassCard + ' space-y-3' },
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('button', { onClick: function() {
              ...
              checkBadge('jobReady');
              announceToSR(__alloT('stem.lifeskills.sr_work_readiness_plan_saved', 'Work readiness plan saved'));
            }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save work plan'),
        ...
        tab === 'resumebuilder' && h('div', { className: 'space-y-4', 'data-lifeskills-resume-builder': 'true' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { updMulti({ resumeScenarioIdx: resumeScenarioIdx + 1, resumeScenarioChoice: '', resumeScenarioFb: '' }); }, className: 'px-3 py-1.5 rounded-xl text-[11px] font-bold bg-teal-700 text-white hover:bg-teal-800 focus:outline-none focus:ring-2 focus:ring-teal-300' }, 'Next scenario')
            )
          ),
          h('div', { className: glassCard + ' space-y-3' },
            h('div', { className: 'flex items-center justify-between gap-2 flex-wrap' },
            ...
            h('button', { onClick: function() {
              ...
              announceToSR(__alloT('stem.lifeskills.sr_resume_bullet_saved', 'Resume bullet saved'));
            }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save evidence bullet'),
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('button', { onClick: function() {
              ...
              announceToSR(__alloT('stem.lifeskills.sr_resume_plan_saved', 'Resume plan saved'));
            }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save resume plan'),
        ...
        tab === 'prooflocker' && h('div', { className: 'space-y-4', 'data-lifeskills-proof-locker': 'true' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { updMulti({ proofScenarioIdx: proofScenarioIdx + 1, proofScenarioChoice: '', proofScenarioFb: '' }); }, className: 'px-3 py-1.5 rounded-xl text-[11px] font-bold bg-cyan-700 text-white hover:bg-cyan-800 focus:outline-none focus:ring-2 focus:ring-cyan-300' }, 'Next scenario')
            )
          ),
          h('div', { className: glassCard + ' space-y-3' },
            h('div', { className: 'flex items-center justify-between gap-2 flex-wrap' },
            ...
            h('button', { onClick: function() {
              ...
              announceToSR(__alloT('stem.lifeskills.sr_proof_item_saved', 'Proof item saved'));
            }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save proof item'),
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() {
                ...
                announceToSR(__alloT('stem.lifeskills.sr_proof_locker_plan_saved', 'Proof locker plan saved'));
              }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save proof plan'),
        ...
        tab === 'interviewstudio' && h('div', { className: 'space-y-4', 'data-lifeskills-interview-studio': 'true' },
          ...
          h('div', { className: glassCard + ' space-y-3', 'data-lifeskills-interview-practice-plan': 'true' },
            ...
            h('div', { className: 'grid lg:grid-cols-[1fr_0.9fr] gap-3' },
              h('div', { className: 'space-y-3' },
                ...
                h('div', { className: 'flex flex-wrap gap-2' },
                  ...
                  h('button', { onClick: saveInterviewPracticePlan, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save practice plan'),
            ...
            h('div', { className: 'rounded-xl bg-white border border-slate-200 p-3 space-y-2', role: 'log', 'aria-live': 'polite', 'aria-label': __alloT('stem.lifeskills.a11y_interview_practice_plan_progress', 'Interview practice plan progress') },
            ...
            h('div', { className: 'grid lg:grid-cols-[0.8fr_1.2fr] gap-3' },
              h('div', { className: 'space-y-3' },
                h('label', { className: 'block text-[11px] font-bold text-slate-700' }, 'Confidence before practice: ' + interviewRehearsalConfidence,
                  h('input', { type: 'range', min: 1, max: 5, step: 1, value: interviewRehearsalConfidence, onChange: function(e) { upd('interviewRehearsalConfidence', Number(e.target.value)); }, className: 'mt-2 w-full accent-blue-700', 'aria-label': __alloT('stem.lifeskills.a11y_interview_rehearsal_confidence', 'Interview rehearsal confidence') })
                ),
                h('div', { className: 'space-y-2' },
            ...
            h('div', { className: 'grid lg:grid-cols-[0.8fr_1.2fr] gap-3' },
              ...
              h('div', { className: 'space-y-3' },
                h('label', { className: 'text-[11px] font-bold text-slate-700' }, 'Proof item or real example',
                  h('textarea', { value: interviewProofNote, onChange: function(e) { upd('interviewProofNote', e.target.value); }, rows: 3, placeholder: interviewProofMatcher.proofPrompt, className: 'mt-1 w-full px-3 py-2 border border-slate-500 rounded-xl text-sm text-slate-800 bg-white resize-y', 'aria-label': __alloT('stem.lifeskills.a11y_interview_proof_item_or_example', 'Interview proof item or example') })
                ),
                h('div', { className: 'rounded-xl bg-white border border-slate-200 p-3 space-y-2' },
                ...
                h('div', { className: 'flex flex-wrap gap-2' },
                  h('button', { onClick: saveInterviewProofCue, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save proof cue'),
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { updMulti({ interviewScenarioIdx: interviewScenarioIdx + 1, interviewScenarioChoice: '', interviewScenarioFb: '' }); }, className: 'px-3 py-1.5 rounded-xl text-[11px] font-bold bg-violet-700 text-white hover:bg-violet-800 focus:outline-none focus:ring-2 focus:ring-violet-300' }, 'Next scenario')
            )
          ),
          h('div', { className: glassCard + ' space-y-3' },
            h('div', { className: 'flex items-center justify-between gap-2 flex-wrap' },
            ...
            h('div', { className: 'rounded-2xl bg-slate-50 border border-slate-200 p-3 max-h-80 overflow-y-auto space-y-3', role: 'log', 'aria-live': 'polite', 'aria-atomic': 'false', 'aria-label': __alloT('stem.lifeskills.a11y_mock_interview_conversation', 'Mock interview conversation') },
                ...
                return h('div', { key: idx, className: 'flex ' + (isStudent ? 'justify-end' : 'justify-start') },
                  h('div', { className: 'max-w-[88%] rounded-2xl border p-3 shadow-sm ' + (isStudent ? 'bg-violet-100 text-violet-950 border-violet-200 rounded-br-sm' : 'bg-white text-slate-800 border-slate-200 rounded-bl-sm') },
                    h('div', { className: 'flex items-center justify-between gap-2 mb-1' },
                      ...
                      !isStudent && h('button', { onClick: function() { speakInterviewText(msg.text); }, className: 'px-2 py-0.5 rounded-full bg-slate-100 text-slate-700 text-[10px] font-bold border border-slate-200 focus:outline-none focus:ring-2 focus:ring-violet-700', 'aria-label': __alloT('stem.lifeskills.a11y_read_interviewer_message_aloud', 'Read interviewer message aloud') }, 'Read')
                    ),
            ...
            h('div', { className: 'grid lg:grid-cols-[1fr_0.85fr] gap-3' },
              h('div', { className: 'space-y-2' },
                h('label', { className: 'text-[11px] font-bold text-slate-700' }, 'Your answer',
                  h('textarea', { value: interviewInput, onChange: function(e) { upd('interviewInput', e.target.value); }, rows: 4, placeholder: interviewMode === 'guided' ? 'Use a suggested response or write your own STAR answer...' : 'Write your answer freely...', className: 'mt-1 w-full px-3 py-2 border border-slate-500 rounded-xl text-sm text-slate-800 bg-white resize-y', 'aria-label': __alloT('stem.lifeskills.a11y_interview_answer_input', 'Interview answer input') })
                ),
                h('div', { className: 'flex flex-wrap gap-2' },
                  h('button', { onClick: function() { sendInterviewMessage(); }, disabled: !interviewInput.trim() || interviewLoading, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-violet-700 text-white hover:bg-violet-800 disabled:bg-slate-200 disabled:text-slate-500 focus:outline-none focus:ring-2 focus:ring-violet-300', 'aria-busy': interviewLoading ? 'true' : 'false' }, interviewLoading ? 'Sending...' : 'Send answer'),
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('div', { className: 'flex flex-wrap gap-2' },
                h('button', { onClick: saveInterviewStarAnswer, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save STAR answer'),
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() {
                ...
                checkBadge('interviewReady');
                announceToSR(__alloT('stem.lifeskills.sr_interview_reflection_saved', 'Interview reflection saved'));
              }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save reflection'),
              ...
              h('div', { className: 'rounded-xl bg-white border border-slate-200 p-3 space-y-2' },
                ...
                h('textarea', { value: interviewFollowUpMessage, onChange: function(e) { upd('interviewFollowUpMessage', e.target.value); }, rows: 3, className: 'w-full px-3 py-2 border border-slate-500 rounded-xl text-xs text-slate-800 bg-white resize-y', 'aria-label': __alloT('stem.lifeskills.a11y_interview_follow_up_message', 'Interview follow-up message') })
              )
            )
          ),
          h('div', { className: glassCard + ' space-y-3', 'data-lifeskills-interview-prep-packet': 'true' },
            ...
            h('div', { className: 'grid lg:grid-cols-[0.8fr_1.2fr] gap-3' },
              h('div', { className: 'space-y-3' },
                ...
                h('div', { className: 'flex flex-wrap gap-2' },
                  h('button', { onClick: saveInterviewPrepPacket, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save packet'),
              ...
              h('label', { className: 'text-[11px] font-bold text-slate-700' }, 'Packet preview',
                h('textarea', { readOnly: true, value: interviewPacketPreview, rows: 16, className: 'mt-1 w-full px-3 py-2 border border-slate-500 rounded-xl text-xs text-slate-800 bg-white resize-y font-mono leading-relaxed', 'aria-label': __alloT('stem.lifeskills.a11y_interview_prep_packet_preview', 'Interview prep packet preview') })
              )
            )
          )
        ),
        ...
        tab === 'communication' && h('div', { className: 'space-y-4', 'data-lifeskills-communication': 'true' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { updMulti({ communicationScenarioIdx: communicationScenarioIdx + 1, communicationScenarioChoice: '', communicationScenarioFb: '' }); }, className: 'px-3 py-1.5 rounded-xl text-[11px] font-bold bg-orange-700 text-white hover:bg-orange-800 focus:outline-none focus:ring-2 focus:ring-orange-300' }, 'Next scenario')
            )
          ),
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            h('div', { className: glassCard + ' space-y-3' },
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('button', { onClick: function() {
              ...
              announceToSR(__alloT('stem.lifeskills.sr_communication_plan_saved', 'Communication plan saved'));
            }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save communication plan'),
        ...
        tab === 'timemanagement' && h('div', { className: 'space-y-4', 'data-lifeskills-time-management': 'true' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { updMulti({ timeScenarioIdx: timeScenarioIdx + 1, timeScenarioChoice: '', timeScenarioFb: '' }); }, className: 'px-3 py-1.5 rounded-xl text-[11px] font-bold bg-yellow-700 text-white hover:bg-yellow-800 focus:outline-none focus:ring-2 focus:ring-yellow-400' }, 'Next scenario')
            )
          ),
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            h('div', { className: glassCard + ' space-y-3' },
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('button', { onClick: function() {
              ...
              announceToSR(__alloT('stem.lifeskills.sr_time_plan_saved', 'Time plan saved'));
            }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500' }, 'Save time plan'),
        ...
        tab === 'bodycare' && h('div', { className: 'space-y-4', 'data-lifeskills-body-care': 'true' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { checkBadge('bodyCareReady'); awardXP(10, 'Body care reset practiced'); announceToSR(__alloT('stem.lifeskills.sr_body_care_reset_practiced', 'Body care reset practiced')); }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-slate-900 text-white hover:bg-slate-800' }, 'Mark reset practiced')
            )
          ),
          h('div', { className: glassCard + ' grid sm:grid-cols-3 gap-3' },
        ...
        tab === 'sleep' && h('div', { className: 'space-y-4', 'data-lifeskills-sleep-energy': 'true' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { checkBadge('sleepPlanner'); awardXP(10, 'Sleep plan saved'); announceToSR(__alloT('stem.lifeskills.sr_sleep_plan_saved', 'Sleep plan saved')); }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-blue-700 text-white hover:bg-blue-800' }, 'Save sleep plan')
            )
          ),
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            h('div', { className: glassCard + ' space-y-3' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() {
                ...
                announceToSR(__alloT('stem.lifeskills.sr_medication_question_saved', 'Medication question saved'));
        ...
        tab === 'appointments' && h('div', { className: 'space-y-4', 'data-lifeskills-appointments': 'true' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { checkBadge('appointmentReady'); awardXP(10, 'Appointment prep practiced'); announceToSR(__alloT('stem.lifeskills.sr_appointment_prep_practiced', 'Appointment prep practiced')); }, className: 'px-3 py-2 rounded-xl text-xs font-bold bg-cyan-700 text-white hover:bg-cyan-800' }, 'Mark prep practiced')
            )
          ),
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            h('div', { className: glassCard + ' space-y-3' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() {
                ...
                announceToSR(__alloT('stem.lifeskills.sr_appointment_script_saved', 'Appointment script saved'));
        ...
        tab === 'homesafety' && h('div', { className: 'space-y-4', 'data-lifeskills-home-safety': 'true' },
          ...
          h('div', { className: 'flex items-center gap-2 flex-wrap' },
            h('button', { onClick: openLifeSkillsSafety3D, className: 'px-3 py-2 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-800 hover:to-orange-800 focus:outline-none focus:ring-2 focus:ring-red-300', 'aria-label': __alloT('stem.lifeskills.a11y_open_the_3d_home_safety_walkthrough_in_a_new_wi', 'Open the 3D home safety walkthrough in a new window') }, '🌐 Open 3D safety walkthrough ↗'),
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() {
                ...
                announceToSR(__alloT('stem.lifeskills.sr_home_safety_plan_saved', 'Home safety plan saved'));
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() {
                ...
                announceToSR(__alloT('stem.lifeskills.sr_digital_safety_plan_saved', 'Digital safety plan saved'));
        ...
        tab === 'homerepair' && h('div', { className: 'space-y-4' },
          h('div', { className: glassCard },
            ...
            h('div', { className: 'flex items-center gap-2 flex-wrap mt-3' },
              h('button', { onClick: openLifeSkillsRepair3D, className: 'px-3 py-2 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-sky-700 to-indigo-700 hover:from-sky-800 to-indigo-800 focus:outline-none focus:ring-2 focus:ring-sky-300', 'aria-label': __alloT('stem.lifeskills.a11y_open_the_3d_home_repair_and_systems_lab_in_a_ne', 'Open the 3D home repair and systems lab in a new window') }, '\uD83C\uDF10 Open 3D repair lab \u2197'),
          ...
          h('div', { className: glassCard },
            ...
            h('div', { className: 'grid grid-cols-3 gap-2' },
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.length_ft', 'Length (ft)')), h('input', { 'aria-label': __alloT('stem.lifeskills.length_ft', 'Length (ft)'), type: 'number', value: paintL, onChange: function(e) { upd('paintL', parseInt(e.target.value) || 0); }, className: 'w-full px-2 py-1 border border-slate-400 rounded-lg text-sm mt-1' })),
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.width_ft', 'Width (ft)')), h('input', { 'aria-label': __alloT('stem.lifeskills.width_ft', 'Width (ft)'), type: 'number', value: paintW, onChange: function(e) { upd('paintW', parseInt(e.target.value) || 0); }, className: 'w-full px-2 py-1 border border-slate-400 rounded-lg text-sm mt-1' })),
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.height_ft', 'Height (ft)')), h('input', { 'aria-label': __alloT('stem.lifeskills.height_ft', 'Height (ft)'), type: 'number', value: paintH, onChange: function(e) { upd('paintH', parseInt(e.target.value) || 0); }, className: 'w-full px-2 py-1 border border-slate-400 rounded-lg text-sm mt-1' }))
            ),
        ...
        tab === 'budget' && h('div', { className: 'space-y-4' },
          ...
          h('div', { className: glassCard + ' space-y-3' },
            h('div', { className: 'flex items-center gap-3 mb-2' },
              ...
              h('input', { 'aria-label': __alloT('stem.lifeskills.monthly_income', 'Monthly Income'), type: 'number', step: '100', value: budgetIncome, onChange: function(e) { upd('budgetIncome', Math.max(0, parseInt(e.target.value) || 0)); checkBadge('budgeteer'); }, className: 'w-32 px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold' }),
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('div', { className: 'grid grid-cols-3 gap-2' },
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.goal_amount', 'Goal Amount')), h('input', { 'aria-label': __alloT('stem.lifeskills.goal_amount', 'Goal Amount'), type: 'number', step: '1000', value: savingsGoal, onChange: function(e) { upd('savingsGoal', Math.max(0, parseInt(e.target.value) || 0)); checkBadge('saver'); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' })),
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.monthly_savings', 'Monthly Savings')), h('input', { 'aria-label': __alloT('stem.lifeskills.monthly_savings', 'Monthly Savings'), type: 'number', step: '25', value: savingsMonthly, onChange: function(e) { upd('savingsMonthly', Math.max(0, parseInt(e.target.value) || 0)); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' })),
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.interest_rate', 'Interest Rate (%)')), h('input', { 'aria-label': __alloT('stem.lifeskills.interest_rate', 'Interest Rate (%)'), type: 'number', step: '0.5', value: savingsRate, onChange: function(e) { upd('savingsRate', Math.max(0, parseFloat(e.target.value) || 0)); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' }))
            ),
        ...
        tab === 'credit' && h('div', { className: 'space-y-4' },
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('div', { className: 'grid grid-cols-2 sm:grid-cols-4 gap-2' },
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.starting', 'Starting $')), h('input', { 'aria-label': __alloT('stem.lifeskills.starting', 'Starting $'), type: 'number', step: '500', value: ciPrincipal, onChange: function(e) { upd('ciPrincipal', Math.max(0, parseInt(e.target.value) || 0)); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' })),
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.monthly_add', 'Monthly Add')), h('input', { 'aria-label': __alloT('stem.lifeskills.monthly_add', 'Monthly Add'), type: 'number', step: '25', value: ciMonthly, onChange: function(e) { upd('ciMonthly', Math.max(0, parseInt(e.target.value) || 0)); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' })),
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.rate_2', 'Rate (%)')), h('input', { 'aria-label': __alloT('stem.lifeskills.rate_2', 'Rate (%)'), type: 'number', step: '0.5', value: ciRate, onChange: function(e) { upd('ciRate', Math.max(0, parseFloat(e.target.value) || 0)); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' })),
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('div', { className: 'grid grid-cols-3 gap-2' },
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.loan_amount', 'Loan Amount')), h('input', { 'aria-label': __alloT('stem.lifeskills.loan_amount', 'Loan Amount'), type: 'number', step: '1000', value: loanPrincipal, onChange: function(e) { upd('loanPrincipal', Math.max(0, parseInt(e.target.value) || 0)); checkBadge('loanCalc'); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' })),
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.apr', 'APR (%)')), h('input', { 'aria-label': __alloT('stem.lifeskills.apr', 'APR (%)'), type: 'number', step: '0.25', value: loanRate, onChange: function(e) { upd('loanRate', Math.max(0, parseFloat(e.target.value) || 0)); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' })),
              h('div', null, h('label', { className: 'text-[11px] font-bold text-slate-600' }, __alloT('stem.lifeskills.years_2', 'Years')), h('select', { 'aria-label': __alloT('stem.lifeskills.years_2', 'Years'), value: loanTerm, onChange: function(e) { upd('loanTerm', parseInt(e.target.value)); }, className: 'w-full px-2 py-1.5 border border-slate-400 rounded-lg text-sm font-bold mt-1' },
        ...
        tab === 'foodconfidence' && h('div', { className: 'space-y-4', 'data-lifeskills-food-confidence': 'true' },
          ...
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              h('button', { onClick: function() { updMulti({ foodConfidenceScenarioIdx: foodConfidenceScenarioIdx + 1, foodConfidenceScenarioChoice: '', foodConfidenceScenarioFb: '' }); }, className: 'px-3 py-1.5 rounded-xl text-[11px] font-bold bg-emerald-700 text-white hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-300' }, 'Next scenario')
            )
          ),
          h('div', { className: 'grid lg:grid-cols-2 gap-4' },
            h('div', { className: glassCard + ' space-y-3' },
            ...
            h('div', { className: glassCard + ' space-y-3' },
              ...
              [
                ...
                return h('div', { key: group.key, className: 'grid sm:grid-cols-[110px_1fr] gap-2 items-start' },
                  ...
                  h('div', null,
                    h('select', { id: group.key, value: group.value, onChange: function(e) { upd(group.key, parseInt(e.target.value, 10) || 0); }, className: 'w-full px-3 py-2 border border-slate-500 rounded-xl text-sm font-bold bg-white text-slate-800' },
        ...
        tab === 'cooking' && h('div', { className: 'space-y-4' },
          h('div', { className: glassCard },
            ...
            h('div', { className: 'flex items-center gap-2 flex-wrap mt-3' },
              h('button', { onClick: openLifeSkillsKitchen3D, className: 'px-3 py-2 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-emerald-700 to-orange-700 hover:from-emerald-800 hover:to-orange-800 focus:outline-none focus:ring-2 focus:ring-emerald-300', 'aria-label': __alloT('stem.lifeskills.a11y_open_the_3d_kitchen_and_food_safety_lab_in_a_ne', 'Open the 3D kitchen and food safety lab in a new window') }, '\uD83C\uDF10 Open 3D kitchen lab \u2197'),
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('div', { className: 'flex gap-2' },
              // Named by hand: the only text above this field is the quiz
              // question itself, which changes every round, so there is no
              // static caption to borrow. aria-labelledby pointing at that <p>
              // would read better still, but it has no id to point at.
              h('input', { 'aria-label': __alloT('stem.lifeskills.a11y_your_answer', 'Your answer'), type: 'text', value: nutritionAnswer, onChange: function(e) { upd('nutritionAnswer', e.target.value); }, onKeyDown: function(e) {
        ...
        tab === 'laundry' && h('div', { className: 'space-y-4', 'data-lifeskills-laundry-lab': 'true' },
          h('div', { className: glassCard + ' space-y-3 overflow-hidden' },
            h('div', { className: 'flex items-start justify-between gap-3 flex-wrap' },
              h('div', null,
                ...
                h('div', { className: 'flex items-center gap-2 flex-wrap mt-3' },
                  h('button', { onClick: openLifeSkillsLaundry3D, className: 'px-3 py-2 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-cyan-700 to-indigo-700 hover:from-cyan-800 hover:to-indigo-800 focus:outline-none focus:ring-2 focus:ring-cyan-300', 'aria-label': __alloT('stem.lifeskills.a11y_open_the_3d_laundry_and_clothing_care_lab_in_a', 'Open the 3D laundry and clothing care lab in a new window') }, '\uD83C\uDF10 Open 3D laundry lab \u2197'),
          ...
          h('div', { className: 'flex flex-wrap gap-2', role: 'tablist', 'aria-label': __alloT('stem.lifeskills.a11y_laundry_lab_sections', 'Laundry lab sections') },
            [
              ...
              h('div', { className: glassCard + ' space-y-3' },
                ...
                h('div', { className: 'grid grid-cols-2 gap-2' },
                  h('div', null,
                    ...
                    h('select', { 'aria-label': __alloT('stem.lifeskills.a11y_water_temperature', 'Water temperature'), value: laundryWater, onChange: function(e) { upd('laundryWater', e.target.value); }, className: 'w-full mt-1 px-2 py-2 rounded-xl border border-slate-500 text-sm font-bold bg-white' },
                  ...
                  h('div', null,
                    ...
                    h('select', { 'aria-label': __alloT('stem.lifeskills.a11y_cycle', 'Cycle'), value: laundryCycle, onChange: function(e) { upd('laundryCycle', e.target.value); }, className: 'w-full mt-1 px-2 py-2 rounded-xl border border-slate-500 text-sm font-bold bg-white' },
        ...
        tab === 'challenge' && h('div', { className: 'space-y-4' },
          ...
          h('div', { className: glassCard + ' space-y-3' },
            ...
            h('div', { className: 'flex gap-2' },
              ...
              h('button', { onClick: function() { upd('chalFeedback', '\uD83D\uDCA1 ' + (chalQ.h || 'No hint')); }, className: 'px-3 py-2 text-sm font-bold bg-amber-50 text-amber-700 rounded-xl' }, __alloT('stem.lifeskills.hint', '\uD83D\uDCA1 Hint')),
