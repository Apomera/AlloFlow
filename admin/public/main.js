...
ipcMain.handle('oauth:gemini-start', async () => {
  ...
  return new Promise((resolve) => {
    ...
    callbackServer.listen(0, '127.0.0.1', () => {
      ...
      authUrl.searchParams.set('scope', 'https://www.googleapis.com/auth/generative-language.peruserquota https://www.googleapis.com/auth/cloud-platform openid email');
