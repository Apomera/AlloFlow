...
(function() {
  ...
  if (!document.getElementById('eco-css-anims')) {
    ...
    ecoStyle.textContent = [
      ...
      '.theme-default .eco-accent, .theme-light .eco-accent { color: var(--eco-acc-light, currentColor); }',
