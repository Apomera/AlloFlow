...
(function () {
  ...
  var SKELETON = [
    ...
    "    // Read persisted state by TYPE, not truthiness: `|| 0` lets a stored",
    "    // {} or \"5\" through, and `count + 1` then yields \"[object Object]1\"",
    "    // or \"51\" — a silent corruption that no crash gate can see.",
    "    var _saved = ctx.toolData && ctx.toolData.myTool && ctx.toolData.myTool.count;",
    "    var st = React.useState(typeof _saved === 'number' && isFinite(_saved) ? _saved : 0);",
