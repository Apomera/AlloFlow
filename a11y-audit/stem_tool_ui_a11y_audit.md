...
- Registered STEM tools audited: 148
- Plugin files loaded: 145
- Shared shell coverage: 148/148 tools
...
| `artStudio` Art & Design Studio | creative | standard | 20 | 3 | 1 | 0 | 0 | 0 |  |
...
| `consciousnessLab` Consciousness Theory Lab | science | standard | 21 | 0 | 0 | 0 | 0 | 0 |  |
...
| `dissection` Virtual Dissection Lab | science | standard | 85 | 11 | 1 | 0 | 0 | 0 |  |
| `dnaLab` DNA Lab | biology | standard | 99 | 3 | 1 | 0 | 1 | 0 | tiny-text x1 |
...
| `epidemicSim` Epidemic Modeling Lab | Life Science | standard | 24 | 14 | 1 | 0 | 1 | 0 | canvas-focus x1 |
...
| `geologyExplorer` Geology Explorer | geology | standard | 49 | 2 | 0 | 0 | 0 | 0 |  |
...
| `roadReady` RoadReady: Driver's Ed & Auto Science | life-skills | standard | 64 | 4 | 0 | 0 | 0 | 0 |  |
...
| `sourcebook` Sourcebook | creative | standard | 54 | 6 | 0 | 0 | 0 | 0 |  |
...
| `trajectoryComputing` Trajectory Computing Lab | coding | standard | 9 | 3 | 0 | 0 | 0 | 0 |  |
| `treeLab` Tree Life Lab | Life Science | standard | 34 | 12 | 0 | 0 | 0 | 0 |  |
...
| `wheelAndFire` Wheel & Fire: Pottery Lab | creative | standard | 22 | 6 | 0 | 0 | 0 | 0 |  |
