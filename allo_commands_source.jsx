...
const CMD_GROUP = {
  ...
  open_symbol_studio:'tools', open_accessibility_lab:'tools', open_lumen:'tools', open_community_catalog:'tools', open_dynamic_assessment:'tools',
  ...
  cycle_reading_theme:'display', open_sel_hub:'tools', open_submission_inbox:'navigate', toggle_cloud_sync:'navigate', generate_outline:'create', export_pack:'create',
};
const CMD_CONTEXT = {
