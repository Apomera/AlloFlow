...
describe('EPPP claim-level adjudication batch 06', () => {
  ...
  it('keeps deployment artifacts identical to source artifacts', () => {
    expect(read('prismflow-deploy/public/test_prep/eppp_legacy/adjudication_batch_06.json')).toEqual(read('test_prep/eppp_legacy/adjudication_batch_06.json'));
    expect(fs.readFileSync(resolve(root, 'prismflow-deploy/public/test_prep/eppp_legacy/adjudication_batch_06.md'), 'utf8')).toBe(fs.readFileSync(resolve(root, 'test_prep/eppp_legacy/adjudication_batch_06.md'), 'utf8'));
  });
});
