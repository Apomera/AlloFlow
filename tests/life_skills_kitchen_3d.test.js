...
describe('Life Skills 3D kitchen and food safety lab', () => {
  ...
  it('keeps the 3D view optional and provides an accessible checklist fallback', () => {
    ...
    expect(scene).toContain('alloflow-life-kitchen-3d-confidence');
    ...
    expect(scene).toContain('alloflow-life-kitchen-3d-replay-complete');
    expect(scene).toContain('data-task-id');
    expect(scene).toContain('alloflow-life-kitchen-3d-next-step');
    expect(scene).toContain('alloflow-life-kitchen-3d-reflection');
