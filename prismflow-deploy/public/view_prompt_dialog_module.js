...
function PromptDialog({ promptDialog, setPromptDialog, t }) {
  ...
  const handleCancel = React.useCallback(() => {
    if (typeof promptDialog.onCancel === "function") {
      try {
  ...
  React.useEffect(() => {
    const onKey = (e) => {
      if (e.key === "Escape") {
        e.preventDefault();
        handleCancel();
      } else if (e.key === "Enter" && !promptDialog.multiline) {
        e.preventDefault();
        handleSubmit();
      } else if (e.key === "Enter" && promptDialog.multiline && (e.ctrlKey || e.metaKey)) {
        e.preventDefault();
        handleSubmit();
      }
    };
  ...
  const inputCommonProps = {
    ...
    "aria-invalid": !!error,
    "aria-describedby": error ? "alloflow-prompt-error" : void 0
  };
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center shrink-0" }, /* @__PURE__ */ React.createElement(Edit3, { size: 20, className: "text-indigo-600" })), /* @__PURE__ */ React.createElement("h3", { id: "alloflow-prompt-title", className: "text-lg font-bold text-slate-800 flex-1 truncate" }, promptDialog.title || t("common.enter_value") || "Enter Value"), /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-700 leading-relaxed mb-4 whitespace-pre-wrap" }, promptDialog.message),
      promptDialog.multiline ? /* @__PURE__ */ React.createElement("textarea", { ...inputCommonProps, rows: 4 }) : /* @__PURE__ */ React.createElement("input", { ...inputCommonProps, type: promptDialog.inputType || "text" }),
      error && /* @__PURE__ */ React.createElement("p", { id: "alloflow-prompt-error", role: "alert", className: "text-xs text-red-600 mt-2 font-semibold" }, error),
      /* @__PURE__ */ React.createElement("div", { className: "flex gap-3 justify-end mt-5" }, /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
          onClick: handleCancel,
