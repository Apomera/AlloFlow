...
const itemSpecs = [
  ...
  { unit: 2, section: 2, topicId: '2.5', practiceId: 'H2', skillId: '2.B', reasoning: 'continuity-change', prompt: 'A Spanish colonial report minimizes Indigenous resistance after a revolt but emphasizes restored order. Which source feature should a historian examine first?', answer: 'The report’s official audience and purpose may encourage it to present colonial control as successful.', distractors: ['The report proves that the resistance ended everywhere in all of the Spanish borderlands.', 'The report cannot provide any evidence at all about the colonial administration there.', 'The report must therefore have been written by an Indigenous author rather than a Spanish one.'], rationale: 'An official report written for authorities may frame events to justify policy or reassure superiors, so its perspective and purpose matter.', sourceUrl: 'https://openstax.org/books/us-history/pages/4-introduction' },
  // Unit 3
  { unit: 3, section: 0, topicId: '3.2', practiceId: 'H4', skillId: '4.A', reasoning: 'causation', prompt: 'Which development provided important context for colonial resistance to British revenue measures after 1763?', answer: 'Britain’s victory in the Seven Years’ War left it with war debt and new costs of administering its empire.', distractors: ['The United States had already adopted the federal Constitution by that point in time.', 'France had ended all of its competition for North American territory before the war began.', 'The colonial assemblies had ceased debating both taxation and representation altogether.'], rationale: 'The postwar fiscal and imperial context helps explain why Britain changed its policies and why colonists contested those changes.', sourceUrl: 'https://openstax.org/books/us-history/pages/5-introduction' },
  { unit: 3, section: 0, topicId: '3.4', practiceId: 'H3', skillId: '3.C', reasoning: 'causation', prompt: 'Colonial protesters argued that Parliament could not tax them without their consent. Which larger issue did that argument raise?', answer: 'Whether legitimate political authority required representation by the people being governed.', distractors: ['Whether the colonies should eliminate all of their elected assemblies entirely.', 'Whether Britain should expand its hereditary monarchy further into North America.', 'Whether the taxation could be collected only during periods of open warfare.'], rationale: 'The protest used a tax dispute to challenge the constitutional relationship between the colonies and the British government.', sourceUrl: 'https://openstax.org/books/us-history/pages/5-introduction' },
  { unit: 3, section: 0, topicId: '3.4', practiceId: 'H2', skillId: '2.A', reasoning: 'causation', prompt: 'A revolutionary pamphlet uses universal language about natural rights while seeking support for independence. Which limitation is most important when using it to study social equality in 1776?', answer: 'The political goals of the authors may not represent the rights available to women, enslaved people, or Indigenous peoples.', distractors: ['The pamphlet could not have been read by any colonist anywhere at the time when it was first written.', 'The language of rights proves that legal equality already existed in all of the colonies well before 1776.', 'The authors necessarily opposed every possible form of representative government of any kind at the time.'], rationale: 'A source can articulate influential ideals while reflecting the boundaries of its authors’ political community and immediate purpose.', sourceUrl: 'https://openstax.org/books/us-history/pages/5-introduction' },
  { unit: 3, section: 1, topicId: '3.6', practiceId: 'H1', skillId: '1.B', reasoning: 'causation', prompt: 'Which weakness of the Articles of Confederation helped encourage support for a stronger national framework?', answer: 'The national government had difficulty raising revenue and coordinating common economic policies.', distractors: ['The national government had abolished every one of the existing state governments.', 'The Articles created a powerful executive who rejected all congressional laws.', 'The national government controlled every local election in the states directly.'], rationale: 'Problems with revenue, interstate coordination, and national authority led many leaders to seek a revised federal structure.', sourceUrl: 'https://openstax.org/books/us-history/pages/7-introduction' },
  { unit: 3, section: 1, topicId: '3.8', practiceId: 'H5', skillId: '5.A', reasoning: 'comparison', prompt: 'Federalists and Anti-Federalists disagreed most directly over which question during ratification?', answer: 'How much authority the national government should possess and how individual liberty would be protected.', distractors: ['Whether the former colonies should simply return to direct British colonial rule instead.', 'Whether the United States should have a written constitution of any kind whatsoever.', 'Whether agriculture existed anywhere outside of the Atlantic seaboard states at that time.'], rationale: 'Ratification debates centered on federal power, representation, executive authority, and protections for individual rights.', sourceUrl: 'https://openstax.org/books/us-history/pages/7-introduction' },
  { unit: 3, section: 2, topicId: '3.10', practiceId: 'H5', skillId: '5.B', reasoning: 'continuity-change', prompt: 'What did the emergence of political parties in the early republic demonstrate?', answer: 'The new constitutional system created institutions but did not eliminate disagreement over economy, foreign policy, and federal power.', distractors: ['The Constitution required all national leaders to join one permanent political party from the very beginning.', 'Political parties in the United States formed only after the Civil War had finally come to an end in the 1860s.', 'The early political parties all agreed that federal power should never expand in any direction at all in those years.'], rationale: 'Federalists and Democratic-Republicans used different interpretations of the new government and different regional and economic interests.', sourceUrl: 'https://openstax.org/books/us-history/pages/8-introduction' },
  // Unit 4
  { unit: 4, section: 0, topicId: '4.4', practiceId: 'H1', skillId: '1.B', reasoning: 'causation', prompt: 'Canals and steamboats lowered transportation costs between interior farms and Atlantic ports. Which effect was most likely?', answer: 'Farmers could participate more fully in commercial markets and regional specialization increased.', distractors: ['The United States became economically identical across every one of its regions.', 'The new technologies ended the use of wage labor throughout all manufacturing.', 'Transportation improvements prevented the cities from growing in any region at all.'], rationale: 'Lower transportation costs connected producers to distant markets while allowing regions to specialize in different products.', sourceUrl: 'https://openstax.org/books/us-history/pages/12-introduction' },
  { unit: 4, section: 1, topicId: '4.8', practiceId: 'H3', skillId: '3.C', reasoning: 'comparison', prompt: 'A historian argues that Jacksonian democracy expanded political participation but also strengthened executive power. Which evidence best supports the claim?', answer: 'More white men voted while the president used federal authority in the Bank War and Indian Removal.', distractors: ['Women and enslaved people gained fully equal voting rights during the same period.', 'The president surrendered all of his policy authority to the Congress entirely here.', 'The expansion of voting ended political parties and popular campaigning entirely.'], rationale: 'The claim is supported by the simultaneous expansion of white male electoral participation and forceful use of presidential and federal power.', sourceUrl: 'https://openstax.org/books/us-history/pages/12-introduction' },
  { unit: 4, section: 2, topicId: '4.10', practiceId: 'H4', skillId: '4.B', reasoning: 'causation', prompt: 'Which development helped create the setting for the Second Great Awakening and antebellum reform movements?', answer: 'Democratic and individualistic ideas, mobility, and market changes encouraged people to organize around moral improvement.', distractors: ['The complete end of all religious disagreement across the United States during that whole period of time.', 'The restoration of hereditary aristocratic privilege in the years right after independence was won.', 'The complete collapse of voluntary associations and of print culture across the whole of the nation.'], rationale: 'Religious revival and reform drew energy from social mobility, democratic ideas, print networks, and concern about changing communities.', sourceUrl: 'https://openstax.org/books/us-history/pages/13-introduction' },
  { unit: 4, section: 2, topicId: '4.11', practiceId: 'H3', skillId: '3.B', reasoning: 'continuity-change', prompt: 'An abolitionist petition appeals to revolutionary ideals while describing the continued existence of slavery. What tension does the source reveal?', answer: 'The language of liberty could be used to challenge a social and legal system that excluded enslaved people from freedom.', distractors: ['Revolutionary ideals had no influence at all on any of the antebellum reform movements of the period.', 'Abolitionists generally supported expanding slavery into all of the new western territories of the period.', 'The petition demonstrates that legal emancipation had already occurred all across the whole nation.'], rationale: 'Reformers drew on republican and Christian language to expose the gap between national ideals and the institution of slavery.', sourceUrl: 'https://openstax.org/books/us-history/pages/13-introduction' },
  { unit: 4, section: 2, topicId: '4.7', practiceId: 'H5', skillId: '5.B', reasoning: 'comparison', prompt: 'Which comparison between the market revolution and reform movements is most defensible?', answer: 'Economic and social change created problems and networks that reformers tried to address through voluntary action and policy.', distractors: ['The market revolution ended all reform efforts by making everyone equally prosperous across the country.', 'Reform movements rejected print, public meetings, and all of the other new networks of that whole period.', 'The two developments occurred in entirely separate communities that never overlapped with each other.'], rationale: 'Market change altered work and communities, while new religious and print networks helped reformers organize responses.', sourceUrl: 'https://openstax.org/books/us-history/pages/13-introduction' },
  { unit: 4, section: 1, topicId: '4.6', practiceId: 'H2', skillId: '2.B', reasoning: 'causation', prompt: 'A federal official describes Indian Removal as a policy that will protect Indigenous communities by relocating them. Which evidence would most challenge the official’s framing?', answer: 'Accounts of forced removal, land loss, and the disruption of Indigenous governments and communities.', distractors: ['A speech praising westward settlement without naming any of the affected communities.', 'A map showing that the United States had a rapidly growing population in the East.', 'A newspaper advertisement announcing a newly proposed canal project in the region.'], rationale: 'The official purpose statement should be tested against evidence about implementation and consequences for the people being moved.', sourceUrl: 'https://openstax.org/books/us-history/pages/12-introduction' },
  // Unit 5
  ...
  { unit: 5, section: 0, topicId: '5.5', practiceId: 'H5', skillId: '5.C', reasoning: 'continuity-change', prompt: 'Why did congressional compromises over slavery fail to resolve the sectional crisis permanently?', answer: 'They managed political balance temporarily while leaving the underlying conflict over slavery’s expansion intact.', distractors: ['They abolished slavery in every one of the states immediately and permanently everywhere at once.', 'They removed the issue of slavery from all of the western territorial politics entirely and at once.', 'They ended the political importance of sectional identity across the whole of the country at once.'], rationale: 'Compromise could postpone conflict, but each new territory and political crisis reopened the question of slavery’s future.', sourceUrl: 'https://openstax.org/books/us-history/pages/13-introduction' },
  ...
  { unit: 5, section: 1, topicId: '5.8', practiceId: 'H1', skillId: '1.B', reasoning: 'causation', prompt: 'Why did Black military service and community organizing matter to the course of the Civil War?', answer: 'They strengthened the Union war effort and pressed the government to make emancipation a more durable outcome.', distractors: ['They caused the Union to abandon emancipation as one of its stated war aims entirely here.', 'They demonstrated that slavery had already ended before the fighting had even begun there.', 'They prevented the passage of any of the constitutional amendments that followed the war.'], rationale: 'Black participation challenged slavery, supplied military labor, and influenced the meaning and policies of Union victory.', sourceUrl: 'https://openstax.org/books/us-history/pages/16-introduction' },
  { unit: 5, section: 2, topicId: '5.9', practiceId: 'H3', skillId: '3.B', reasoning: 'continuity-change', prompt: 'A Reconstruction-era state constitution expands public education and voting rights, while local groups use violence to suppress Black voters. Which conclusion is best supported?', answer: 'Reconstruction expanded formal rights while resistance limited access to those rights in practice.', distractors: ['The constitution had no effect at all because the law never matters in history.', 'The violence proves that Reconstruction created no political change whatsoever.', 'The new rights applied equally and securely to every resident of the whole state.'], rationale: 'The evidence shows a gap between constitutional or legal change and the conditions required to exercise rights.', sourceUrl: 'https://openstax.org/books/us-history/pages/17-introduction' },
  { unit: 5, section: 2, topicId: '5.9', practiceId: 'H6', skillId: '6.A', reasoning: 'continuity-change', prompt: 'Which thesis would be most historically defensible about Reconstruction?', answer: 'Reconstruction changed the constitutional meaning of citizenship and freedom, but political retreat and white supremacist violence limited its immediate reach.', distractors: ['Reconstruction changed nothing at all, because the Constitution was never amended at any single point during those postwar years.', 'Reconstruction completely eliminated racial inequality everywhere in the United States by the time that it finally ended in 1877.', 'Reconstruction was only an economic program that had no effect at all on the constitutional meaning of citizenship itself at all.'], rationale: 'The strongest claim recognizes both transformative constitutional changes and the limits imposed by enforcement, violence, and political decisions.', sourceUrl: 'https://openstax.org/books/us-history/pages/17-introduction' },
  // Unit 6
  ...
  { unit: 6, section: 0, topicId: '6.4', practiceId: 'H3', skillId: '3.C', reasoning: 'continuity-change', prompt: 'Why did federal western policy often produce conflict with Indigenous nations?', answer: 'Settlement and resource extraction required the United States to restrict Indigenous land, sovereignty, and mobility.', distractors: ['Indigenous nations had no established governments and no territorial claims of any kind at all.', 'Federal policy sought to prevent all non-Indigenous settlement west of the Mississippi River entirely.', 'Railroads and mining together reduced the pressure on western land and on all of its resources.'], rationale: 'The expansion of settlement and extraction conflicted with Indigenous sovereignty and existing relationships to land.', sourceUrl: 'https://openstax.org/books/us-history/pages/18-introduction' },
  { unit: 6, section: 1, topicId: '6.3', practiceId: 'H1', skillId: '1.B', reasoning: 'causation', prompt: 'A corporation controls its mines, factories, rail lines, and distribution network. Which business strategy does this describe?', answer: 'Vertical integration, which combines multiple stages of production or distribution under one company.', distractors: ['Collective bargaining, which transfers all management of the firm to a labor union.', 'A tariff, which places a tax on imported goods at the national border of a country.', 'Sharecropping, which organizes agricultural labor in the years after emancipation.'], rationale: 'Vertical integration is control across stages of a production and distribution chain, increasing coordination and often market power.', sourceUrl: 'https://openstax.org/books/us-history/pages/18-introduction' },
  ...
  { unit: 6, section: 2, topicId: '6.7', practiceId: 'H5', skillId: '5.B', reasoning: 'comparison', prompt: 'Which comparison best explains why nativist movements and industrial employers could coexist in the late nineteenth century?', answer: 'Employers could seek immigrant labor while nativists opposed immigration for cultural, racial, or political reasons.', distractors: ['Both of the groups agreed that all immigration into the country should end immediately and entirely.', 'Immigrants worked entirely outside of the industrial labor markets throughout that whole period.', 'Nativism was caused only by the absence of urban growth in the industrial cities of that era.'], rationale: 'Economic demand for labor and political or cultural opposition to immigration could operate at the same time.', sourceUrl: 'https://openstax.org/books/us-history/pages/20-introduction' },
  { unit: 6, section: 2, topicId: '6.8', practiceId: 'H6', skillId: '6.B', reasoning: 'causation', prompt: 'Which claim best explains why labor conflict became a national political issue during industrialization?', answer: 'Large firms and national markets made workplace disputes affect public order, commerce, and debates over government intervention.', distractors: ['Industrial disputes remained isolated because the firms had no national connections of any kind at all then.', 'Workers never organized beyond the level of a single individual workplace anywhere in the whole country.', 'The government and the courts refused to take any position at all in any one of these labor disputes here.'], rationale: 'Industrial scale and interconnected markets increased the public consequences of strikes and made labor rights a national question.', sourceUrl: 'https://openstax.org/books/us-history/pages/18-introduction' },
  // Unit 7
  { unit: 7, section: 0, topicId: '7.4', practiceId: 'H1', skillId: '1.B', reasoning: 'causation', prompt: 'Which problem most directly motivated Progressive reformers to support stronger government regulation?', answer: 'Industrial and urban conditions exposed consumers and workers to risks that private markets did not reliably control.', distractors: ['The complete disappearance of large corporations and of city governments during the whole period.', 'The complete end of immigration and of urban growth during the whole of the industrial period.', 'The belief that government had already solved every public-health problem in the growing cities.'], rationale: 'Progressive reform responded to problems associated with industrial capitalism, urbanization, corruption, and weak oversight.', sourceUrl: 'https://openstax.org/books/us-history/pages/21-introduction' },
  { unit: 7, section: 1, topicId: '7.3', practiceId: 'H2', skillId: '2.B', reasoning: 'causation', prompt: 'A president presents overseas intervention as a defense of civilization and national honor. Which context would help a historian evaluate the claim?', answer: 'The growth of U.S. commercial and strategic interests and debates over imperialism at the end of the nineteenth century.', distractors: ['The complete withdrawal of the United States from all world trade during the whole of that period.', 'The complete absence of any domestic disagreement about overseas expansion during that entire time.', 'The end of all anticolonial resistance in the years after the end of the Spanish-American War itself.'], rationale: 'Foreign-policy rhetoric should be situated within strategic, economic, ideological, and domestic debates rather than accepted as a complete explanation.', sourceUrl: 'https://openstax.org/books/us-history/pages/22-introduction' },
  { unit: 7, section: 1, topicId: '7.5', practiceId: 'H5', skillId: '5.B', reasoning: 'comparison', prompt: 'How did World War I and the Great Migration connect to one another?', answer: 'War production increased demand for labor, encouraging African American migration to industrial cities while also producing racial tensions.', distractors: ['The war ended racial discrimination in every one of the industrial cities of the northern states altogether now.', 'The Great Migration moved workers away from all of the northern manufacturing centers during those same war years.', 'World War I prevented African Americans from entering any of the northern labor markets during all those war years.'], rationale: 'Wartime labor demand was one important push-and-pull factor in migration, but migrants encountered both opportunity and discrimination.', sourceUrl: 'https://openstax.org/books/us-history/pages/24-introduction' },
  { unit: 7, section: 2, topicId: '7.7', practiceId: 'H3', skillId: '3.B', reasoning: 'continuity-change', prompt: 'A historian uses Harlem Renaissance literature and music to study the 1920s. Which claim is best supported by that evidence?', answer: 'Black artists and intellectuals shaped a vibrant urban culture while challenging dominant racial assumptions.', distractors: ['The 1920s eliminated racial inequality entirely across the whole United States during the decade.', 'The Harlem Renaissance occurred outside of the migration and urbanization patterns entirely.', 'Cultural production had no connection at all to any political or social identity at all.'], rationale: 'The Harlem Renaissance reflected migration, urban community formation, artistic innovation, and debates over Black identity and citizenship.', sourceUrl: 'https://openstax.org/books/us-history/pages/25-introduction' },
  { unit: 7, section: 2, topicId: '7.10', practiceId: 'H6', skillId: '6.A', reasoning: 'causation', prompt: 'Which thesis most accurately evaluates the New Deal’s historical significance?', answer: 'It expanded federal responsibility for relief, recovery, and reform while leaving the Depression and racial inequality incompletely resolved.', distractors: ['It ended the Depression immediately and eliminated all opposition to federal action of every kind almost at once.', 'It reduced the role of the federal government in economic life to almost nothing during the whole of that decade.', 'It had no lasting effect at all on any political coalitions or on any of the government institutions of that period.'], rationale: 'The New Deal’s significance lies in institutional and political change as well as the limits of its economic and social results.', sourceUrl: 'https://openstax.org/books/us-history/pages/25-introduction' },
  { unit: 7, section: 2, topicId: '7.12', practiceId: 'H2', skillId: '2.C', reasoning: 'continuity-change', prompt: 'A wartime government describes Japanese American incarceration as a security necessity. Which evidence is most important for evaluating the claim?', answer: 'Evidence about the policy’s racial classification, military decision-making, and the absence of individualized proof of disloyalty.', distractors: ['A poster encouraging the purchase of war bonds that makes no reference at all to the incarceration policy.', 'A factory report showing only that wartime industrial production increased sharply in the months that followed.', 'A speech that discusses only European diplomacy and never once mentions the incarceration policy anywhere.'], rationale: 'Evaluating the claim requires evidence about how the policy was made and applied, not only evidence that the nation was at war.', sourceUrl: 'https://openstax.org/books/us-history/pages/26-introduction' },
  // Unit 8
  { unit: 8, section: 0, topicId: '8.2', practiceId: 'H4', skillId: '4.B', reasoning: 'causation', prompt: 'Which development provides the clearest context for the creation of postwar containment policies?', answer: 'The wartime alliance with the Soviet Union broke down amid ideological rivalry and disputes over the postwar order.', distractors: ['The United States and the Soviet Union had become one single shared political system after the war.', 'The United States had abandoned all of the international economic institutions after the war.', 'The Cold War began before World War II ended because of a direct U.S.-Soviet battle between the two.'], rationale: 'Postwar tensions, ideological rivalry, and disagreement over security and reconstruction shaped containment.', sourceUrl: 'https://openstax.org/books/us-history/pages/28-introduction' },
  { unit: 8, section: 0, topicId: '8.2', practiceId: 'H3', skillId: '3.C', reasoning: 'comparison', prompt: 'A U.S. policy document describes aid as support for free nations, while a recipient describes the same aid as pressure to align with Washington. What does the comparison show?', answer: 'Foreign-policy consequences can differ from the policy’s stated purpose and can be interpreted differently by participants.', distractors: ['Only the U.S. policy source can provide any useful historical evidence about the whole aid program.', 'Economic aid has no connection at all to any form of geopolitical competition between the two powers.', 'The two sources cannot describe the same event, because their accounts of it differ from each other so sharply.'], rationale: 'Comparing perspectives helps identify purpose, power, and the difference between official language and lived or strategic consequences.', sourceUrl: 'https://openstax.org/books/us-history/pages/28-introduction' },
  { unit: 8, section: 1, topicId: '8.5', practiceId: 'H5', skillId: '5.B', reasoning: 'continuity-change', prompt: 'Which development best demonstrates the interaction between grassroots civil rights activism and federal policy?', answer: 'Local campaigns and legal challenges helped create pressure for federal court decisions and civil-rights legislation.', distractors: ['Federal policy changed without any organizing, any protest, or any litigation of any kind at all.', 'Grassroots movements rejected the use of courts and legislation of every kind in their campaigns.', 'Civil-rights laws were enacted long before segregation and disenfranchisement had ever appeared.'], rationale: 'Civil-rights change resulted from sustained organizing and litigation interacting with federal institutions and political opportunities.', sourceUrl: 'https://openstax.org/books/us-history/pages/28-introduction' },
  { unit: 8, section: 1, topicId: '8.8', practiceId: 'H2', skillId: '2.C', reasoning: 'causation', prompt: 'A presidential speech presents the Vietnam War as a necessary defense against communism. Which additional evidence would most help assess the speech’s purpose and limits?', answer: 'Evidence about decolonization, local Vietnamese nationalism, executive decision-making, and public disagreement in the United States.', distractors: ['A list of unrelated domestic inventions from the 1920s that has nothing at all to do with the war in Vietnam.', 'A source proving that every Vietnamese group shared exactly the same political goals throughout the whole war.', 'A statement assuming that the president’s stated motive was the only possible cause of the entire war in Vietnam.'], rationale: 'A source about intervention should be tested against local context, broader geopolitical conditions, institutional decisions, and competing public interpretations.', sourceUrl: 'https://openstax.org/books/us-history/pages/29-introduction' },
  { unit: 8, section: 2, topicId: '8.10', practiceId: 'H6', skillId: '6.B', reasoning: 'causation', prompt: 'Which claim best explains the historical significance of Great Society programs?', answer: 'They expanded federal efforts in health, poverty, and education while provoking continuing debates about the scope and effectiveness of government.', distractors: ['They ended poverty everywhere in the country and removed the need for any later social policy of any kind whatsoever at all here.', 'They returned all responsibility for social welfare entirely to the local charities and the private churches of the day.', 'They had no effect at all on the expectations that citizens came to hold of their own federal government in later years.'], rationale: 'The programs changed policy capacity and public expectations even though they did not eliminate poverty or political disagreement.', sourceUrl: 'https://openstax.org/books/us-history/pages/29-introduction' },
  // Unit 9
  ...
  { unit: 9, section: 1, topicId: '9.6', practiceId: 'H5', skillId: '5.B', reasoning: 'continuity-change', prompt: 'Which statement best describes the relationship between globalization and U.S. work after 1980?', answer: 'Trade and technology reorganized production and employment, creating gains in some sectors and displacement or insecurity in others.', distractors: ['Globalization affected only the foreign economies and never touched any workers within the United States itself.', 'Technology eliminated every regional difference in employment across the whole of the United States as well.', 'Globalization ended the importance of both immigration and of internal migration within the whole country.'], rationale: 'Economic restructuring is uneven: it can create new opportunities while reducing employment or bargaining power in other regions and industries.', sourceUrl: 'https://openstax.org/books/us-history/pages/31-introduction' },
  { unit: 9, section: 1, topicId: '9.7', practiceId: 'H3', skillId: '3.C', reasoning: 'comparison', prompt: 'A historian compares census data with local oral histories to study late-twentieth-century migration. Why is using both kinds of evidence useful?', answer: 'Statistics show patterns of movement while oral histories can reveal how migrants experienced and interpreted those changes.', distractors: ['Oral histories make all quantitative data completely unnecessary for any historian studying migration.', 'Census data alone can explain every individual motivation without any other kind of evidence at all.', 'The two kinds of source cannot be compared at all, because they rely on entirely different methods of study.'], rationale: 'Different sources answer different questions; corroboration can connect demographic scale with lived experience while preserving each source’s limits.', sourceUrl: 'https://openstax.org/books/us-history/pages/31-introduction' },
  { unit: 9, section: 2, topicId: '9.6', practiceId: 'H4', skillId: '4.B', reasoning: 'causation', prompt: 'Why should a historian use dated evidence when analyzing developments after September 11, 2001?', answer: 'Policies, public interpretations, and available information changed over time, so later knowledge should not be projected backward without explanation.', distractors: ['Recent events simply cannot be studied historically in any way at all until several more decades have finally gone past us.', 'Dates matter only for those events that took place before the federal Constitution was first written in the year 1787 itself here.', 'A single later interpretation automatically resolves all of the earlier uncertainty that surrounds any period of history.'], rationale: 'Contemporary history requires chronology and source criticism because policies and interpretations evolve and later evidence can change the questions historians ask.', sourceUrl: 'https://openstax.org/books/us-history/pages/31-introduction' },
  { unit: 9, section: 2, topicId: '9.7', practiceId: 'H6', skillId: '6.A', reasoning: 'continuity-change', prompt: 'Which thesis would be most defensible about the period after 1980?', answer: 'Political realignment, globalization, technology, and demographic change reshaped the United States while leaving continuing debates over government, inequality, and national identity.', distractors: ['The period after 1980 had one single uncontested political and economic direction that nearly everyone in the country accepted without any argument.', 'The end of the Cold War eliminated all international conflict and all domestic disagreement inside the United States for the decades that came after.', 'Technological change affected only communication and never touched work, politics, or culture in any way at all during the whole period after the 1980s.'], rationale: 'The best thesis identifies several interacting developments and preserves continuity in unresolved political, economic, and social debates.', sourceUrl: 'https://openstax.org/books/us-history/pages/31-introduction' },
];
