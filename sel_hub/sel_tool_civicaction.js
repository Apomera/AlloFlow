...
(function() {
  ...
  var CIVIC_QUIZ = {
    elementary: [
      { q: 'What is voting?', options: ['Telling your friends what they have to do', 'A way to choose leaders and make decisions', 'A prize given to the most popular student in class', 'A test you take about famous leaders'], answer: 1, explain: 'Voting is how people in a democracy choose their leaders and make decisions about rules and laws. It gives everyone a voice!' },
      { q: 'What does a mayor do?', options: ['Teaches all of the classes at a school', 'Leads and makes decisions for a city or town', 'Owns all of the stores and parks in a city or town', 'Delivers the mail to every house in town'], answer: 1, explain: 'A mayor is the leader of a city or town. They help make decisions about things like parks, roads, schools, and keeping the community safe.' },
      { q: 'What are rights?', options: ['Things you have to buy before you can use them', 'Freedoms and protections every person has', 'Prizes you can earn for good behavior at school', 'Rules that only grown-ups have to follow'], answer: 1, explain: 'Rights are freedoms and protections that every person has. For example, the right to go to school, the right to be safe, and the right to speak your mind.' },
      { q: 'What is a community?', options: ['A single big building where the government keeps its offices', 'A group of people who live, work, or play in the same area', 'A club that you can only join by paying money every year', 'A list of the rules that everyone in a town must follow'], answer: 1, explain: 'A community is a group of people who share a place or interests. Your neighborhood, school, and city are all communities you belong to!' },
      { q: 'Why do we have rules and laws?', options: ['To give the police something to write down every day', 'To keep people safe and treat everyone fairly', 'Because grown-ups enjoy telling children what to do', 'To make sure that nobody ever gets to have any fun'], answer: 1, explain: 'Rules and laws help keep everyone safe and make sure people are treated fairly. Without them, it would be hard to live together peacefully.' },
      { q: 'What does it mean to be a good citizen?', options: ['Winning every race and contest at school', 'Helping others and following rules', 'Having more friends than anyone else in class', 'Getting the very best grades on every test'], answer: 1, explain: 'Being a good citizen means caring about your community, helping others, following rules, and doing your part to make things better for everyone.' },
      { q: 'What is a petition?', options: ['A special kind of test you must pass before you are allowed to vote', 'A written request signed by many people asking for a change', 'A promise you make to always follow every rule', 'A letter that only the mayor is allowed to write'], answer: 1, explain: 'A petition is when people write down what they want to change and collect signatures to show that many people agree. It is a powerful way to make your voice heard!' },
      { q: 'Who makes the rules at your school?', options: ['Only the students, by voting at lunch every single day', 'The principal, teachers, and school board with input from families', 'The president of the country, who writes the rules for every school', 'Each teacher alone, with nobody else allowed to help decide'], answer: 1, explain: 'School rules are made by principals, teachers, and school boards. Good schools also listen to students and families when making decisions.' },
    ],
    middle: [
      { q: 'What are the three branches of the U.S. government?', options: ['President, Vice President, Speaker of the House', 'Legislative, Executive, Judicial', 'Federal, State, and Local governments', 'The Senate, the House, and the Supreme Court'], answer: 1, explain: 'The three branches are Legislative (Congress, makes laws), Executive (President, carries out laws), and Judicial (Courts, interprets laws). This system of "checks and balances" prevents any one branch from having too much power.' },
      { q: 'How does a bill become a law?', options: ['The president writes it and signs it, and it becomes law without any votes in Congress', 'A member of Congress introduces it, both chambers vote, and the president signs it', 'Citizens vote directly on every law in a national election each year', 'The Supreme Court writes the laws and Congress approves the judges'], answer: 1, explain: 'A bill is introduced in Congress, debated in committees, voted on by both the House and Senate, and then sent to the President to sign. The President can also veto (reject) a bill.' },
      { q: 'What is the Bill of Rights?', options: ['The document in which the American colonies declared independence from Britain in 1776', 'The first ten amendments to the Constitution that protect individual freedoms', 'The list of laws about paying taxes that Congress passes every year', 'The oath of loyalty every new citizen must sign when they arrive'], answer: 1, explain: 'The Bill of Rights is the first ten amendments to the U.S. Constitution. It protects freedoms like speech, religion, press, and the right to a fair trial.' },
      { q: 'What does the First Amendment protect?', options: ['The right of the people to keep and bear arms for self-defense', 'Freedom of speech, religion, press, assembly, and petition', 'The right of every citizen to vote at age eighteen', 'The right to a speedy and public trial before a jury'], answer: 1, explain: 'The First Amendment protects five key freedoms: speech, religion, press, peaceful assembly, and the right to petition the government. These are foundational to democracy.' },
      { q: 'What is the difference between a right and a responsibility?', options: ['A right is something the government can take away at any time; a responsibility is something you may ignore whenever you choose', 'A right is something you are entitled to; a responsibility is something you should do for your community', 'A right must be earned by working; a responsibility is optional for anyone who pays taxes', 'A right is something adults have; a responsibility is something children are given at school'], answer: 1, explain: 'Rights are protections and freedoms you have. Responsibilities are duties you have as a citizen, like voting, serving on juries, and helping your community.' },
      { q: 'What does "civic engagement" mean?', options: ['Holding an official government job in your city or state', 'Participating in your community and government to make a difference', 'Joining every club and sports team that your school offers', 'Watching or reading the news every day so you know what is happening'], answer: 1, explain: 'Civic engagement means actively participating in the life of your community and government. It includes voting, volunteering, speaking up about issues, and working to make positive change.' },
      { q: 'What is an amendment?', options: ['Another word for any law that Congress passes', 'A change or addition to the Constitution', 'A special election held to choose new judges', 'The building where the Constitution is kept'], answer: 1, explain: 'An amendment is a formal change or addition to the Constitution. There are currently 27 amendments. The process is intentionally difficult to ensure broad agreement.' },
      { q: 'Why is a free press important in a democracy?', options: ['So that newspapers can earn money by selling advertisements', 'To hold the government accountable and keep citizens informed', 'To let the government decide which stories reporters may print', 'So that reporters can become famous celebrities and win prestigious awards'], answer: 1, explain: 'A free press investigates wrongdoing, shares information, and holds leaders accountable. Without it, citizens cannot make informed decisions about their government.' },
    ],
    high: [
      { q: 'What is the difference between the Electoral College and the popular vote?', options: ['They are two names for the same national count, reported in different ways by each of the states', 'The Electoral College is a system where electors cast votes for president; the popular vote is the total of all individual votes', 'The popular vote decides state elections and the Electoral College decides local ones', 'The Electoral College is a university in Washington where future presidents and senators study law and government before taking office'], answer: 1, explain: 'The popular vote is the total count of all individual votes. The Electoral College is a system where each state gets a number of electors based on population, and those electors formally choose the president. A candidate can win the Electoral College without winning the popular vote.' },
      { q: 'What is lobbying?', options: ['Gathering signatures to put a new question on the election ballot', 'Attempting to influence government decisions on behalf of a group or cause', 'Campaigning and raising money to run for a political office yourself', 'Observing polling places on election day to make sure votes are counted fairly'], answer: 1, explain: 'Lobbying is when individuals or groups try to influence legislators and government officials to support specific policies. While it is a form of civic participation, the outsized influence of wealthy lobbyists is a major concern in modern politics.' },
      { q: 'What is judicial review?', options: ['A yearly performance review that the Senate gives every federal judge', 'The power of courts to determine if laws are constitutional', 'The election process that some states use to choose their judges', 'The written opinion a court publishes after deciding a case'], answer: 1, explain: 'Judicial review is the power of courts, especially the Supreme Court, to examine laws and government actions and determine whether they violate the Constitution. This was established in Marbury v. Madison (1803).' },
      { q: 'What is civil disobedience?', options: ['Refusing to vote in any election until the laws are changed', 'The nonviolent refusal to obey unjust laws as a form of protest', 'Voting against whatever the majority of your community supports', 'Filing a lawsuit against the government to overturn an unjust law'], answer: 1, explain: 'Civil disobedience is the deliberate, nonviolent refusal to obey laws considered unjust, in order to bring about change. Famous examples include Rosa Parks, Gandhi\'s Salt March, and lunch counter sit-ins during the Civil Rights Movement.' },
      { q: 'What does "gerrymandering" mean?', options: ['Holding a recount when an election result is extremely close', 'Manipulating electoral district boundaries to favor a particular party', 'The process of replacing a governor who leaves office early', 'A campaign strategy of visiting every county in a state before an election'], answer: 1, explain: 'Gerrymandering is when political district boundaries are drawn to give one party an unfair advantage. It undermines fair representation and is a significant challenge to democracy.' },
      { q: 'What is the filibuster?', options: ['A rule that lets the House pass emergency bills without any debate', 'A tactic used in the Senate to delay or block a vote by extended debate', 'An amendment that limits how long each senator is allowed to serve', 'A fundraising event where candidates give long speeches to wealthy donors'], answer: 1, explain: 'A filibuster is a tactic in the U.S. Senate where a senator speaks for an extended time to delay or prevent a vote on a bill. It effectively requires 60 out of 100 senators to agree before most legislation can pass.' },
      { q: 'What is the difference between equity and equality?', options: ['Equality applies only to money and taxes, while equity is a legal term that applies only to the court system', 'Equality gives everyone the same resources; equity gives people what they need to have equal outcomes', 'They are interchangeable terms that both appear in the text of the Constitution', 'Equity means owning part of a company; it has no meaning in public policy'], answer: 1, explain: 'Equality means treating everyone the same. Equity means giving people what they specifically need to have fair opportunities and outcomes. For example, equality gives every student the same textbook; equity ensures students who need additional support get it.' },
      { q: 'What role does the Supreme Court play in protecting civil liberties?', options: ['It advises the president about civil liberties, but its written opinions are never legally binding', 'It interprets the Constitution and can strike down laws that violate individual rights', 'It writes new laws whenever Congress is unable to reach an agreement', 'It commands the federal police forces that enforce the laws it approves'], answer: 1, explain: 'The Supreme Court interprets the Constitution and has the final say on whether laws respect civil liberties. Landmark cases like Brown v. Board of Education and Obergefell v. Hodges have expanded rights and protections for millions of Americans.' },
    ]
  };
    ...
    render: function(ctx) {
      ...
      return h('div', { className: 'space-y-4 animate-in fade-in duration-200' },
        ...
        earnedBadges.length > 0 && h('div', { className: 'flex gap-2 flex-wrap bg-amber-50 border border-amber-200 rounded-xl p-2' },
          h('span', { className: 'text-xs font-bold text-amber-700 uppercase self-center' }, 'Badges:'),
          earnedBadges.map(function(bid) {
            var badge = BADGES.find(function(b) { return b.id === bid; });
            if (!badge) return null;
            return h('span', { key: bid, className: 'inline-flex items-center gap-1 bg-white border border-amber-300 rounded-full px-2 py-0.5 text-xs font-bold text-amber-700', title: badge.desc }, badge.icon, ' ', badge.label);
          })
        ),
  ...
  var TAB_META = {
            ...
            (function() {
              ...
              return h('div', { className: 'space-y-3' },
                ...
                callTTS && h('button', { 'aria-label': 'Hear this read aloud',
                  ...
                  className: 'text-xs text-teal-500 hover:text-teal-700 font-bold'
          ...
          h('div', { className: 'bg-white rounded-2xl border-2 border-teal-200 p-5 space-y-4' },
            h('div', null,
              ...
              h('input', {
                ...
                className: 'w-full text-sm p-2.5 border border-slate-400 rounded-lg outline-none focus:ring-2 focus:ring-teal-300 bg-white text-slate-800'
              })
            ),
            h('div', null,
              ...
              h('textarea', {
                ...
                className: 'w-full text-sm p-3 border border-slate-400 rounded-lg resize-none h-20 outline-none focus:ring-2 focus:ring-teal-300 bg-white text-slate-800'
              })
            ),
            h('div', null,
              ...
              h('textarea', {
                ...
                className: 'w-full text-sm p-3 border border-slate-400 rounded-lg resize-none h-16 outline-none focus:ring-2 focus:ring-teal-300 bg-white text-slate-800'
              })
            )
          ),
            ...
            COPING_STRATEGIES.map(function(strategy) {
              ...
              return h('div', {                 key: strategy.id,
                ...
                h('button', { 'aria-label': strategy.label,
                  ...
                  h('div', { className: 'text-xs text-slate-600 mt-0.5 uppercase font-bold' }, strategy.category)
                ),
          ...
          h('div', { className: 'space-y-2' },
            actions.map(function(a, i) {
              return h('div', { key: i, className: 'bg-white rounded-xl border border-slate-400 p-4 flex items-start gap-3 hover:border-teal-300 transition-colors' },
                h('div', { className: 'bg-teal-100 text-teal-700 px-2 py-1 rounded-lg text-xs font-bold shrink-0' }, a.impact),
                h('div', { className: 'flex-1' },
                  h('p', { className: 'text-sm text-slate-800 font-medium' }, a.action),
                  h('span', { className: 'text-xs text-amber-500' }, a.difficulty)
                )
              );
            })
          ),
        ...
        tab === 'planner' && h('div', { role: 'region', 'aria-labelledby': 'cv-planner-title', className: 'space-y-4' },
          ...
          h('div', { role: 'region', 'aria-labelledby': 'cv-planner-step-label', className: 'bg-white rounded-2xl border-2 border-teal-200 p-5 space-y-3' },
            ...
            h('textarea', {
              ...
              className: 'w-full text-sm p-3 border border-slate-400 rounded-lg resize-none h-28 outline-none focus:ring-2 focus:ring-teal-300 bg-white text-slate-800'
            }),
            h('div', { className: 'flex justify-between' },
              ...
              }, 'Next \u2192') : h('button', { onClick: function() {
          ...
          h('div', { className: 'bg-gradient-to-r from-slate-50 to-teal-50 rounded-2xl border border-slate-400 p-5 space-y-3' },
            ...
            selectedTemplate && (function() {
              ...
              return h('div', { className: 'bg-white rounded-xl border border-slate-400 p-4 mt-2 space-y-2' },
                ...
                h('p', { className: 'text-xs text-slate-600 mt-1' }, 'Tip: Copy this template and customize the parts in [brackets] with your own words.')
              );
            })()
          ),
          ...
          h('div', { className: 'bg-white rounded-2xl border-2 border-amber-200 p-5 space-y-3' },
            ...
            h('div', null,
              ...
              h('input', {
                ...
                className: 'w-full text-sm p-2.5 border border-slate-400 rounded-lg outline-none focus:ring-2 focus:ring-amber-300 bg-white text-slate-800'
              })
            ),
            h('div', null,
              ...
              h('div', { className: 'bg-white rounded-2xl border-2 border-teal-200 p-5 space-y-4' },
                ...
                h('div', { className: 'space-y-2 mt-3' },
                  currentProposal.options.map(function(opt, oi) {
                    ...
                    if (showResult && isChosen) btnClass += 'border-teal-400 bg-teal-50 font-bold text-slate-800';
                    else if (!showResult) btnClass += 'border-slate-200 bg-white hover:border-teal-600 hover:bg-teal-50 text-slate-800';
                    ...
                    return h('div', { key: oi },
                      ...
                      showResult && isChosen && h('div', { className: 'mt-2 ml-2 bg-blue-50 border border-blue-200 rounded-xl p-3' },
                        ...
                        h('div', { className: 'flex gap-3 mt-2' },
                          h('span', { className: 'text-xs font-bold ' + (opt.impact.happiness > 0 ? 'text-emerald-600' : opt.impact.happiness < 0 ? 'text-red-500' : 'text-slate-300') }, '\ud83d\ude0a Happiness: ' + (opt.impact.happiness > 0 ? '+' : '') + opt.impact.happiness),
                          h('span', { className: 'text-xs font-bold ' + (opt.impact.learning > 0 ? 'text-emerald-600' : opt.impact.learning < 0 ? 'text-red-500' : 'text-slate-300') }, '\ud83d\udcda Learning: ' + (opt.impact.learning > 0 ? '+' : '') + opt.impact.learning),
                          h('span', { className: 'text-xs font-bold ' + (opt.impact.health > 0 ? 'text-emerald-600' : opt.impact.health < 0 ? 'text-red-500' : 'text-slate-300') }, '\ud83d\udc9a Health: ' + (opt.impact.health > 0 ? '+' : '') + opt.impact.health)
                        )
                      )
                    );
                  })
                ...
                h('div', { className: 'bg-white rounded-2xl border-2 border-indigo-200 p-5 space-y-3' },
                  ...
                  currentStep.bills.map(function(bill) {
                    ...
                    return h('button', { 'aria-label': bill.title,
                      ...
                      h('p', { className: 'text-xs text-amber-600 mt-1' }, '\u26a0\ufe0f Opposition: ' + bill.opposition),
                      h('p', { className: 'text-xs text-teal-600 font-bold mt-1' }, 'Base support: ' + bill.support_base + '%')
                    );
                  }),
                    ...
                    return h('div', { key: ally.id, className: 'p-3 rounded-xl border-2 ' + (isRecruited ? 'border-emerald-300 bg-emerald-50' : 'border-slate-200 bg-white') },
                      ...
                      !isRecruited && h('div', { className: 'flex gap-2 mt-2' },
                        h('button', { 'aria-label': 'Accept & Recruit',
                          ...
                          className: 'px-3 py-1 bg-emerald-700 text-white rounded-lg text-xs font-bold hover:bg-emerald-700'
                        }, '\u2705 Accept & Recruit'),
                      ...
                      isRecruited && h('span', { className: 'text-xs text-emerald-600 font-bold mt-1 block' }, '\u2705 Recruited')
                    );
                  }),
                    ...
                    return h('div', { key: qi, className: 'p-3 rounded-xl border-2 ' + (answered ? 'border-slate-200 bg-slate-50' : 'border-amber-300 bg-amber-50') },
                      ...
                      !answered && h('div', { className: 'flex gap-2 mt-2' },
                        h('button', { 'aria-label': '\u2705 ' + cq.good,
                          ...
                          className: 'flex-1 px-3 py-2 bg-emerald-700 text-white rounded-lg text-xs font-bold hover:bg-emerald-700'
                        }, '\u2705 ' + cq.good),
                        h('button', { 'aria-label': '\u274c ' + cq.bad,
                          ...
                          className: 'flex-1 px-3 py-2 bg-red-100 text-red-700 rounded-lg text-xs font-bold hover:bg-red-200'
                        }, '\u274c ' + cq.bad)
                      ),
                      answered && h('p', { className: 'text-xs mt-1 font-bold ' + (legAnswers[qi] === 'good' ? 'text-emerald-600' : 'text-red-500') }, legAnswers[qi] === 'good' ? '\u2705 Strong response \u2014 committee impressed' : '\u274c Weak response \u2014 committee skeptical')
                    );
                  }),
        ...
        tab === 'survey' && h('div', { className: 'space-y-4' },
          ...
          h('div', { className: 'bg-slate-50 rounded-2xl border border-slate-400 p-5 space-y-3' },
            ...
            h('p', { className: 'text-xs text-slate-600' }, 'Click to add a template question to your survey.'),
            h('div', { className: 'space-y-2' },
          ...
          h('div', { className: 'bg-white rounded-2xl border-2 border-amber-200 p-5 space-y-3' },
            ...
            h('div', { className: 'flex gap-2' },
              h('button', { 'aria-label': 'Open-ended',
                ...
                className: 'px-3 py-1.5 rounded-lg text-xs font-bold border ' + (surveyCustomType === 'open' ? 'bg-amber-700 text-white border-amber-600' : 'bg-white text-slate-600 border-slate-300')
              }, 'Open-ended'),
              h('button', { 'aria-label': 'Multiple Choice',
                onClick: function() { upd('surveyCustomType', 'choice'); },
                className: 'px-3 py-1.5 rounded-lg text-xs font-bold border ' + (surveyCustomType === 'choice' ? 'bg-amber-700 text-white border-amber-600' : 'bg-white text-slate-600 border-slate-300')
              }, 'Multiple Choice')
            ),
            surveyCustomType === 'choice' && h('div', null,
              h('label', { htmlFor: 'cv-answer-opts', className: 'text-xs text-slate-600 block mb-1' }, 'Answer options (comma-separated)'),
              h('input', {
                id: 'cv-answer-opts',
                type: 'text',
          ...
          surveyQuestions.length > 0 && h('div', { className: 'bg-gradient-to-r from-teal-50 to-emerald-50 rounded-2xl border-2 border-teal-200 p-5 space-y-3' },
            ...
            surveyQuestions.map(function(sq, si) {
              return h('div', { key: si, className: 'bg-white rounded-xl border border-teal-200 p-3 flex justify-between items-start' },
                h('div', { className: 'flex-1' },
                  ...
                  h('span', { className: 'text-xs text-slate-600' }, sq.type === 'choice' ? 'Choices: ' + (sq.options || []).join(', ') : 'Open-ended response'),
                  sq.custom && h('span', { className: 'text-xs text-amber-500 ml-2 font-bold' }, '(custom)')
                ),
                h('button', {
                  onClick: function() {
            ...
            h('div', { className: 'flex gap-2 mt-2' },
              ...
              surveyExported && h('span', { className: 'self-center text-xs font-bold text-emerald-600' }, '\u2705 Exported!')
            )
          ),
          ...
          rightsInfo.sections ? (function() {
            ...
            return h('div', { className: 'space-y-3' },
              ...
              h('div', { className: 'flex gap-1 bg-slate-50 rounded-xl p-1 border border-slate-400 overflow-x-auto', role: 'tablist', 'aria-label': 'Rights & Dissent sections' },
                sections.map(function(s, si) {
                  ...
                  return h('button', {
                    ...
                    className: 'flex-1 px-2 py-2 rounded-lg text-xs font-bold transition-all whitespace-nowrap ' +
              ...
              item && h('div', { className: 'bg-white rounded-2xl border-2 border-indigo-200 p-5 space-y-3' },
                ...
                item.primarySource && h('div', { className: 'text-xs text-slate-700 px-1' },
              ...
              item && item.scenario && h('div', { className: 'bg-amber-50 rounded-2xl border-2 border-amber-200 p-5 space-y-3' },
                ...
                h('textarea', {
                  ...
                  placeholder: 'Write your response here.',
                  className: 'w-full text-sm p-3 border border-amber-600 rounded-lg resize-none h-24 outline-none focus:ring-2 focus:ring-amber-300 bg-white text-slate-800'
                }),
              ...
              h('div', { className: 'flex justify-between items-center pt-1' },
                ...
                h('div', { className: 'text-xs text-slate-300 font-bold' }, totalExplored + ' / ' + totalItems + ' explored'),
                ...
                }, '\u2728 Complete') : h('div', { className: 'text-xs text-slate-300 italic' }, 'Visit every item to finish')
              )
            );
          })() : (function() {
              ...
              (function() {
                ...
                return h('div', { className: 'space-y-4' },
                  h('div', { className: 'bg-white rounded-2xl border-2 border-indigo-200 p-5 space-y-4' },
                    ...
                    h('div', { className: 'bg-indigo-50 rounded-xl p-4 border border-indigo-200' },
                      h('h5', { className: 'text-xs font-bold text-indigo-600 uppercase tracking-widest mb-1' }, 'What This Means'),
                      h('p', { className: 'text-sm text-slate-700 leading-relaxed' }, right.explain)
                    ),
                    h('div', { className: 'bg-emerald-50 rounded-xl p-4 border border-emerald-200' },
                      h('h5', { className: 'text-xs font-bold text-emerald-600 uppercase tracking-widest mb-1' }, 'Your Responsibility'),
                  ...
                  h('div', { className: 'bg-amber-50 rounded-2xl border-2 border-amber-200 p-5 space-y-3' },
                    ...
                    h('textarea', {
                      ...
                      className: 'w-full text-sm p-3 border border-amber-600 rounded-lg resize-none h-20 outline-none focus:ring-2 focus:ring-amber-300 bg-white text-slate-800'
                    }),
            ...
            return h('div', { className: 'space-y-4' },
              ...
              h('div', { role: 'region', 'aria-labelledby': 'cv-service-phase-label', className: 'bg-white rounded-2xl border-2 border-teal-200 p-5 space-y-3' },
                ...
                h('div', { className: 'bg-amber-50 rounded-xl p-3 border border-amber-200' },
                  ...
                  h('p', { className: 'text-xs text-amber-500 mt-1' }, 'Track the hours you spend on each phase of your project.')
                ),
                ...
                h('div', { className: 'flex justify-between mt-2' },
                  ...
                  servicePhase < SERVICE_PHASES.length - 1 ? h('button', { 'aria-label': 'Next service-learning phase',
                    ...
                    className: 'px-4 py-2 bg-teal-700 text-white rounded-lg text-xs font-bold hover:bg-teal-700'
                  }, 'Next Phase \u2192') : h('button', { onClick: function() {
            ...
            return h('div', { className: 'bg-gradient-to-r from-teal-50 to-emerald-50 rounded-2xl border-2 border-teal-200 p-6 text-center space-y-4' },
              ...
              h('div', { className: 'flex justify-center gap-6' },
                h('div', null,
                  ...
                  h('div', { className: 'text-xs text-slate-600' }, 'Hours Logged')
                ),
                h('div', null,
                  h('div', { className: 'text-2xl font-bold text-teal-700' }, Object.keys(serviceNotes).length),
                  h('div', { className: 'text-xs text-slate-600' }, 'Phases Documented')
                )
              ),
                ...
                h('div', { className: 'space-y-2' },
                  question.options.map(function(opt, oi) {
                    ...
                    return h('button', { 'aria-label': '\ud83d\udca1 ' + question.explain,
                      ...
                      showResult && isCorrect && h('span', { className: 'text-xs ml-1 font-bold' }, ' \u2714'),
                      showResult && isChosen && !isCorrect && h('span', { className: 'text-xs ml-1 font-bold' }, ' \u2718')
                    );
                  })
                ),
              ...
              h('div', { className: 'bg-white rounded-2xl border-2 border-indigo-200 p-5 space-y-4' },
                ...
                h('div', { className: 'space-y-2 mt-3' },
                  scenario.choices.map(function(choice, ci) {
                    ...
                    var btnClass = 'w-full p-3 rounded-xl border-2 text-left text-sm transition-all ';
                    if (showResult && isChosen) btnClass += (choice.score >= 4 ? 'border-emerald-400 bg-emerald-50' : choice.score >= 3 ? 'border-amber-400 bg-amber-50' : 'border-red-600 bg-red-50') + ' text-slate-800';
                    else if (!showResult) btnClass += 'border-slate-200 bg-white hover:border-indigo-600 hover:bg-indigo-50 text-slate-800';
                    else btnClass += 'border-slate-200 bg-slate-50 text-slate-300';
                    return h('div', { key: ci },
                ...
                stakeholders.map(function(s) {
                  return h('div', { key: s.id, className: 'flex items-center gap-2 p-2 bg-slate-50 rounded-lg' },
                    ...
                    h('div', { className: 'flex items-center gap-1' },
                      h('span', { className: 'text-xs text-slate-500 mr-1' }, 'Pos:'),
                      ...
                      h('span', { className: 'text-xs text-slate-500 ml-2 mr-1' }, 'Pow:'),
              ...
              h('div', { className: 'grid grid-cols-2 md:grid-cols-5 gap-2' },
                support.map(function(s) {
                  ...
                  return h('div', { key: s, className: 'p-2 rounded ' + (count > 0 ? 'bg-emerald-100 border border-emerald-300' : 'bg-rose-100 border border-rose-300') },
                    h('div', { className: 'text-xs font-bold uppercase ' + (count > 0 ? 'text-emerald-700' : 'text-rose-700') }, s),
                ...
                return h('div', { key: m.id, className: 'relative bg-white rounded-xl border-2 p-3 ' + (m.done ? 'border-emerald-300 bg-emerald-50' : 'border-slate-300') },
                  ...
                  h('div', { className: 'flex items-center gap-2' },
                    ...
                    h('div', { className: 'flex-1' },
                      ...
                      m.doneOn && h('div', { className: 'text-xs text-emerald-600' }, 'Completed ' + m.doneOn)
                    ),
            ...
            h('div', { className: 'bg-white rounded-2xl border-2 border-teal-200 p-4' },
              ...
              [
                ...
                return h('div', { key: f.key, className: 'mb-3' },
                  ...
                  h('div', { className: 'text-xs text-slate-500 italic mb-1' }, f.help),
                  h('textarea', {
                    id: 'talk-' + f.key, value: currentDraft[f.key] || '',
                    onChange: function(e) { updateDraft(f.key, e.target.value); },
                    placeholder: f.placeholder, rows: 2,
                    className: 'w-full text-sm p-2 border border-slate-300 rounded bg-white text-slate-800'
                  })
                );
              }),
          ...
          h('div', { className: 'space-y-3' },
            ...
            HOPE_ANCHORS.map(function(anchor, i) {
              return h('div', { key: i, className: 'bg-white rounded-xl border border-slate-400 p-4 hover:border-teal-300 transition-colors' },
                h('div', { className: 'flex items-start gap-3' },
                  h('div', { className: 'bg-teal-100 text-teal-700 px-2 py-1 rounded-lg text-xs font-bold shrink-0' }, anchor.theme),
                  h('div', null,
                ...
                h('div', { className: 'flex items-start gap-3' },
                  ...
                  h('div', null,
                    h('div', { className: 'flex items-center gap-2 flex-wrap' },
                      ...
                      h('span', { className: 'text-xs text-slate-600' }, cm.years),
        ...
        aiResponse && h('div', { className: 'bg-teal-50 border border-teal-200 rounded-xl p-4' },
          h('div', { className: 'flex items-start gap-2' },
            ...
            h('div', null,
              h('div', { className: 'text-xs font-bold text-teal-600 uppercase tracking-widest mb-1' }, 'Counselor'),
              h('p', { className: 'text-sm text-teal-800 leading-relaxed' }, aiResponse)
            )
          ),
          h('button', { 'aria-label': 'Dismiss', onClick: function() { upd('aiResponse', null); }, className: 'mt-2 text-xs text-teal-400 hover:text-teal-600 font-bold' }, 'Dismiss')
        )
      );
    }
  });
