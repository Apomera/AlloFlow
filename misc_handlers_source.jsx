            ...
            if (Array.isArray(rawData)) {
                ...
                if (rawData.settings) {
                    ...
                    if (rawData.settings.defaultAdventureConfig) {
                        ...
                        if (defs.typingPace !== undefined) setAdventureTypingPaceEnabled(!!defs.typingPace);
                        if (defs.sceneReadingPractice !== undefined) setAdventureFluencyEnabled(!!defs.sceneReadingPractice);
