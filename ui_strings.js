...
• **Representation**: Guides processing and visualization (Guideline 3.3) by transforming linear text into spatial relationships.`,
    ...
    visual_text: `Enhance comprehension with AI-generated imagery. Create visual representations of key concepts using 8 different art styles and customization options to support Dual Coding strategies.
### Panel Options
• **Art Style**: Choose from 8 visual styles:
  - Default, Isometric Diagram, Pixel Art, Watercolor
  - Technical Blueprint, Comic Book Style, Line Art, 3D Render
• **Worksheet Mode**: Creates fill-in-the-blank style visuals for student activities.
• **Creative Mode**: Enables more artistic, less literal interpretations.
• **No Text**: Generates pure visuals without labels or captions.
• **Low Quality**: Faster generation for quick previews.
...
### Pro Tip
Use "Technical Blueprint" style for STEM diagrams or "Comic Book Style" for engaging story visuals!
### UDL Connection
