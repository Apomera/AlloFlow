...
<section id="demo-scene-shop" class="demo-scene" aria-labelledby="demo-shop-title" hidden><h2 id="demo-shop-title">Buy one Notebook</h2><p>Select Avery in cashier checkout, add <strong>one Notebook (10 points)</strong>, then use <strong>Refresh, review, and complete checkout</strong>. Your browser shows the live check as a confirmation box; choose <strong>OK</strong> to complete the purchase.</p><p class="demo-small">After the recognition and one purchase: 65 → 55 points. The checkout panel then reports the purchase, and the receipt appears below the catalog; navigation never makes a purchase.</p><div class="demo-actions"><a href="/?demoStep=balance&amp;role=student">See the updated student balance →</a></div></section>
