...
(function() {
  ...
  var _semiAC = null;
  function getSemiAC() { if (!_semiAC) { try { _semiAC = (window.StemLab && window.StemLab.audioContext ? window.StemLab.audioContext() : new (window.AudioContext || window.webkitAudioContext)()); } catch(e) {} } if (_semiAC && _semiAC.state==="suspended") { try { _semiAC.resume(); } catch(e) {} } return _semiAC; }
