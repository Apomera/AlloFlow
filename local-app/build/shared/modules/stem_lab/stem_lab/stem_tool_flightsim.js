...
(function() {
  ...
  window.StemLab.registerTool('flightSim', {
    ...
    render: function(ctx) {
      ...
      // ── MENU VIEW ──
      if (view === 'menu') {
        return h('div', { style: { minHeight: '500px', height: 'calc(100vh - 120px)', background: 'linear-gradient(135deg, #0c1222 0%, #1e3a5f 50%, #0c4a6e 100%)', borderRadius: '16px', overflow: 'auto' } },
          // Back button
      ...
      // ── FLYING VIEW ──
      if (view === 'flying') {
        return h('div', { id: 'skyschool-flight-container', style: { position: 'relative', width: '100%', height: 'calc(100vh - 120px)', minHeight: '500px', borderRadius: '12px', overflow: 'hidden', background: '#000', display: 'flex', flexDirection: 'column' } },
      ...
      if (view === 'debrief' && d.lastDebrief) {
        ...
        return h('div', { style: { minHeight: '400px', height: 'calc(100vh - 120px)', background: 'linear-gradient(135deg, #0c1222 0%, #1e3a5f 50%, #0c4a6e 100%)', borderRadius: '16px', padding: '24px', color: '#fff', overflow: 'auto' } },
