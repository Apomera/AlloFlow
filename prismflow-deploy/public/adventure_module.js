...
var CastLobby = React.memo(({ characters, onUpdateCharacter, onConfirm, onGeneratePortrait, onRefinePortrait, onAddCharacter, onRemoveCharacter, onUploadPortrait, t }) => {
  ...
  }, className: "min-h-11 px-3 py-2 bg-emerald-50 text-emerald-700 rounded-full hover:bg-emerald-100 transition-all font-medium border border-emerald-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-700 focus-visible:ring-offset-2" }, "\u{1F4BE} Save"))), !char.portrait && !char.isGenerating && /* @__PURE__ */ React.createElement("div", { className: "mt-2 flex flex-wrap gap-1.5 justify-center" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => onGeneratePortrait(i), className: "min-h-11 px-3 py-2 bg-violet-700 text-white rounded-full hover:bg-violet-800 transition-all font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-700 focus-visible:ring-offset-2" }, "\u{1F3A8} Generate Portrait"), /* @__PURE__ */ React.createElement("input", { type: "file", "aria-label": t("adventure.upload_portrait") || "Upload portrait image", "aria-describedby": portraitUploadError?.charIdx === i ? `adventure-portrait-upload-error-${i}` : void 0, accept: "image/*", ref: (el) => portraitFileRefs.current["new-" + i] = el, onChange: (e) => handlePortraitFileChange(i, e), className: "hidden" }), /* @__PURE__ */ React.createElement("button", { type: "button", "aria-describedby": portraitUploadError?.charIdx === i ? `adventure-portrait-upload-error-${i}` : void 0, onClick: () => {
    setPortraitUploadError(null);
    portraitFileRefs.current["new-" + i]?.click();
  }, className: "min-h-11 px-3 py-2 bg-sky-50 text-sky-700 rounded-full hover:bg-sky-100 transition-all font-medium border border-sky-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-700 focus-visible:ring-offset-2", title: t("adventure.upload_portrait") || "Upload your own portrait image" }, "\u{1F4F7} Upload Photo")), portraitUploadError?.charIdx === i && /* @__PURE__ */ React.createElement("p", { id: `adventure-portrait-upload-error-${i}`, role: "alert", "aria-atomic": "true", className: "w-full mt-2 rounded-lg border border-red-300 bg-red-50 px-3 py-2 text-xs font-semibold text-red-800" }, portraitUploadError.message), char.isGenerating && /* @__PURE__ */ React.createElement("p", { className: "mt-2 text-[11px] text-violet-700 animate-pulse font-medium", role: "status", "aria-live": "polite" }, t("common.loading") || "Loading"))), isAdding ? /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-br from-violet-50 to-indigo-50 rounded-2xl border-2 border-dashed border-violet-300 p-4 flex flex-col items-center text-center" }, /* @__PURE__ */ React.createElement("span", { className: "text-2xl mb-2", "aria-hidden": "true" }, "\u2728"), /* @__PURE__ */ React.createElement("input", { type: "text", "aria-label": t("adventure.char_name_placeholder") || "Character name", value: newName, onChange: (e) => setNewName(e.target.value), placeholder: t("adventure.char_name_placeholder"), className: "w-full text-sm px-3 py-1.5 mb-2 border border-violet-600 rounded-lg focus:ring-2 focus:ring-violet-600 focus:outline-none text-center font-bold" }), /* @__PURE__ */ React.createElement("input", { type: "text", "aria-label": t("adventure.role_placeholder") || "Character role", value: newRole, onChange: (e) => setNewRole(e.target.value), placeholder: t("adventure.role_placeholder"), className: "w-full text-xs px-3 py-1.5 mb-2 border border-violet-600 rounded-lg focus:ring-2 focus:ring-violet-600 focus:outline-none text-center" }), /* @__PURE__ */ React.createElement("input", { type: "text", "aria-label": t("adventure.appearance_placeholder") || "Character appearance", value: newAppearance, onChange: (e) => setNewAppearance(e.target.value), placeholder: t("adventure.appearance_placeholder") || "Appearance (e.g. tall, silver hair, blue robe)", className: "w-full text-xs px-3 py-1.5 mb-2 border border-violet-600 rounded-lg focus:ring-2 focus:ring-violet-400 focus:outline-none text-center", onKeyDown: (e) => {
