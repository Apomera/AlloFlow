...
for (const target of [path.join(root, 'test_prep', 'audiology_5343_learning_library.json'), path.join(root, 'prismflow-deploy', 'public', 'test_prep', 'audiology_5343_learning_library.json')]) {
