// Headless driver for pdfbox_font_embed.html — boots the co-load window and reports
...
(async () => {
  ...
  page.on('console', (m) => { const t = m.text(); if (t.startsWith('[font]')) console.log('  ' + t.slice(9)); });
  page.on('pageerror', (e) => console.log('[pageerror] ' + e.message));
  await page.goto('http://localhost:' + PORT + '/pdfbox_font_embed.html', { waitUntil: 'load', timeout: 60000 });
