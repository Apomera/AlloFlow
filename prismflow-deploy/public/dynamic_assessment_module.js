(function () {
  ...
  function DynamicAssessment(props) {
    ...
    var startScreenViewTuple = useState("start");
    ...
    var customFormTuple = useState({
      domain: "math", gradeBand: "4-5", construct: "",
      bottleneck: "", context: "", itemCount: 3, mode: "clinician"
    });
    var customForm = customFormTuple[0];
    var setCustomForm = customFormTuple[1];
    var generatedItemsTuple = useState([]);   // Array of validated item objects
