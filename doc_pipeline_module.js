...
Return ONLY valid JSON:
{
  ...
  "hasForms": true/false
      ...
      const triangulated = {
        ...
        summary: scoreRange > 25 ? `Scores varied significantly (range: ${scoreRange}, SD: ${scoreSD}) across ${n} audits — additional expert review recommended. ${parsedAudits[0].summary}` : `${parsedAudits[0].summary} (${n}-auditor consensus, SD: ${scoreSD})`,
