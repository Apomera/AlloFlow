...
describe('module readiness loader', () => {
    ...
    it('splash holds for the curated core set with the existing hard ceiling', () => {
        expect(anti).toMatch(/CORE_BOOT_MODULES = \['AppStyles', 'LiveAac', 'SharedActivity', 'LaunchPadView', 'MiscComponents', 'UtilsPure', 'SidebarTabsNav', 'HistoryPanel', 'GuidedModeConfig'\]/);
