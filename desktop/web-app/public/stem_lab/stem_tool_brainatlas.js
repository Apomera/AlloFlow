            ...
            state.updateCutawayLabels = function () {
              ...
              ['left', 'right'].forEach(function (side) {
                ...
                entries.forEach(function (entry) {
                  var top = Math.max(8, Math.min(height - 42, Math.max(entry.y - 14, previousTop)));
                  previousTop = top + 36;
