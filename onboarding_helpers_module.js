...
(function () {
  ...
  var COACH_CATALOG = [
    ...
    '   containing seven tiles: STEAM Lab, StoryForge, LitLab, PoetTree, SEL Hub,',
    ...
    '- STEAM Lab: Science and math activities (rocks, molecules, geometry, optics, etc.).',
  ...
  function buildOnboardingPrompt(input) {
    ...
    return [
      ...
      'conversation. STEAM Lab is for science/math. StoryForge is for narrative writing. SEL Hub',
