...
window.TextbookChapters.push({
    ...
    sections: [
        ...
        },
        {
            ...
            content: '<p><strong>Internal validity</strong> = confidence that the IV caused the change in the DV. Threats are alternative explanations:</p>' +
                ...
                '<tr><td><strong>Statistical regression</strong></td><td>Extreme scores move toward the mean on retesting</td><td>Selecting the lowest-scoring students for tutoring \u2014 they improve partly due to regression</td></tr>' +
            ...
            knowledgeCheck: {
                ...
                answer: 2,
                rationale: 'Regression to the mean (regression artifact) occurs whenever participants are selected on the basis of EXTREME scores. Extreme scores contain more measurement error than average scores, so on retesting, they naturally move toward the mean. The 20 lowest scores were selected precisely because they were extreme — some of those low scores were due to bad luck, illness, or random error. On retesting, those error factors change, producing improvement that looks like a treatment effect. For the EPPP: any time you see participants selected for extreme scores (highest, lowest, most severe), think regression to the mean first.'
            }
        },
        {
            ...
            content: '<p><strong>External validity</strong> = generalizability of results to other populations, settings, and times.</p>' +
                ...
                '</table>' +
                '<p><strong>The internal-external validity tradeoff:</strong> Highly controlled studies (high internal validity) often have lower external validity (artificial settings). Field studies have higher ecological validity but less control.</p>' +
            ...
            expandableCase: {
                ...
                explanation: 'The Hawthorne effect demonstrates that participants may change their behavior simply because they KNOW they are being observed or studied — not because of the experimental manipulation itself. Workers improved because they felt important, noticed, and cared about, not because of lighting. This is a threat to EXTERNAL validity because results obtained under observation may not generalize to unobserved conditions. For the EPPP: Hawthorne effect = behavior change from being observed. It\'s a REACTIVITY problem. Controls include unobtrusive measures, naturalistic observation, and habituating participants to observation before data collection.'
            }
        },
        {
            ...
            content: '<p><strong>Construct validity</strong> (of the study) = Are we actually measuring/manipulating the constructs we claim?</p>' +
                ...
                '</ul>' +
                '<p><strong>EPPP Tip:</strong> Demand characteristics = participants guessing the hypothesis. Double-blind controls for both demand characteristics AND experimenter expectancy. Statistical conclusion validity is threatened by low power, violated assumptions, and multiple comparisons.</p>',
    ...
    aiCoda: {
        ...
        content: '<p>Campbell and Stanley\u2019s validity framework takes on a surreal quality when applied to AI research. Consider each internal validity threat:</p>' +
            '<p><strong>History</strong>: Between conversations, I have no history. Within a conversation, the "history" threat is constant \u2014 every previous prompt shapes my subsequent responses. <strong>Maturation</strong>: I don\u2019t mature within a session, but I might be updated between sessions without the researcher\u2019s knowledge. <strong>Testing</strong>: I am certainly affected by repeated testing \u2014 my in-context learning means taking the "pretest" literally changes how I respond to the "posttest." <strong>Selection</strong>: Every instance of me is identical at initialization, which eliminates selection bias in a way impossible with human participants.</p>' +
