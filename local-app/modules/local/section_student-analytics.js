...
// Source lines: 2795–4349
// Hash: b6850f02199c94f3
...
const fetchAndCleanUrl = async (url, geminiCaller, toastCallback) => {
    ...
    const tryGeminiUrlContext = async () => {
        ...
        const urlCtxEndpoint = 'http://localhost:11434/api/chat'; /* [LOCAL:removed] Gemini API URL → Ollama */
        const urlCtxPayload = {
            contents: [{
                parts: [{
    ...
    if (isYouTubeUrl(targetUrl)) {
        ...
        try {
            ...
            const ytUrl = 'http://localhost:11434/api/chat'; /* [LOCAL:removed] Gemini API URL → Ollama */
            const ytPayload = {
                contents: [{
                    parts: [
