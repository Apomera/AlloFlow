...
function LearningHubModal(props) {
  ...
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("stem-lab") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "text-inquiry", "data-hub-label": "Text Inquiry Studio", "data-hub-section": "core" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "learning_hub_text_inquiry_card", onClick: openTextInquiryStudio, className: "flex flex-col items-center gap-3 p-5 bg-gradient-to-br from-fuchsia-50 to-cyan-50 border border-fuchsia-700 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-center", "aria-describedby": textInquiryLaunchError ? "text-inquiry-launch-error" : void 0 }, /* @__PURE__ */ React.createElement("span", { className: "text-4xl", "aria-hidden": "true" }, "\u{1F50E}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-fuchsia-900" }, "Text Inquiry Studio"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-fuchsia-800 mt-1" }, "Inspect frequency and concordance, then test an interpretation against exceptions and context."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("text-inquiry"), "aria-label": hubFavoriteIds.includes("text-inquiry") ? tr("hub.remove_favorite", "Remove from favorites") + ": Text Inquiry Studio" : tr("hub.add_favorite", "Add to favorites") + ": Text Inquiry Studio", title: hubFavoriteIds.includes("text-inquiry") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
