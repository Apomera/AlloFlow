...
{"headingColor":"hex","accentColor":"hex","bgColor":"hex","headerBg":"hex","headerText":"hex","tableBg":"hex","tableBorder":"hex","bodyFont":"CSS font-family","headingFont":"CSS font-family"}`,
    ...
    })(), pdfAuditResult._scoreIsBlended ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", { className: "text-[11px] opacity-70 mt-0.5" }, "AI Rubric: ", pdfAuditResult._aiOnlyScore, " | axe-core: ", pdfAuditResult._baselineAxeScore, " | Blended: ", pdfAuditResult.score, " (50/50)"), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] opacity-60 mt-0.5" }, t("pdf_audit.score.axe_baseline_scope") || "Baseline axe-core runs on the document's extracted text - it checks structure (headings, lists, landmarks), not images, color contrast, or visual layout. The AI rubric reads the actual PDF for those."), (() => {
