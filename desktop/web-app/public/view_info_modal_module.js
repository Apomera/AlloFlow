...
const READING_SOURCE_CREDITS = [
  {
    ...
    items: [
      { sourceId: "storyweaver", name: "StoryWeaver \xB7 Pratham Books", scope: "multilingual picture books with creator credits retained per edition", license: "CC BY 4.0", url: "https://storyweaver.org.in" },
      { sourceId: "african-storybook", name: "African Storybook \xB7 SAIDE", scope: "approved multilingual editions with writers, illustrators, translators, and copyright holders retained", license: "Creative Commons variant per edition; some are noncommercial", url: "https://www.africanstorybook.org/" },
      { sourceId: "bloom", name: "Bloom Library \xB7 SIL", scope: "open picture books mirrored only when adaptation and redistribution are allowed; restricted editions remain link-only", license: "CC BY / CC BY-SA / CC0 per title; other variants link-only", url: "https://bloomlibrary.org/" },
      ...
      { sourceId: "open-rn", name: "Open RN \xB7 Chippewa Valley Technical College", scope: "selected nursing textbook text from NCBI Bookshelf; third-party figures and media are excluded", license: "CC BY 4.0", url: "https://www.cvtc.edu/grants/open-rn" },
      ...
      { sourceId: "wikisource", name: "Wikisource \xB7 Wikimedia community", scope: "curated primary-source excerpts and link-out records with work-level source notes", license: "Public domain or free license per work", url: "https://wikisource.org/" }
    ]
  },
  {
    ...
    items: [
      ...
      { sourceId: "wikibooks", name: "Wikibooks \xB7 Wikimedia community", scope: "revision-pinned discovery cards; no book text or media is copied", license: "CC BY-SA 4.0 / GFDL; media may vary", url: "https://www.wikibooks.org/" },
...
function OpenSourceTab({ t }) {
  return /* @__PURE__ */ React.createElement("div", { className: "space-y-5 text-slate-700" }, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-50 p-4 rounded-lg border border-indigo-100" }, /* @__PURE__ */ React.createElement("h4", { className: "font-bold text-indigo-900 mb-1 flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "\u{1F49B}"), t("about.oss_credits_title") || "Built on open source"), /* @__PURE__ */ React.createElement("p", { className: "text-sm leading-relaxed text-slate-700" }, t("about.oss_credits_intro") || "AlloFlow is free and open source (AGPL-3.0), built on the generous work of the projects below. Thank you to their authors and communities. The projects highlighted first are ones you can explore directly inside AlloFlow.")), /* @__PURE__ */ React.createElement("div", { className: "bg-emerald-50 p-4 rounded-lg border border-emerald-100" }, /* @__PURE__ */ React.createElement("h5", { className: "font-bold text-emerald-900 text-sm mb-1" }, t("about.media_guardrails_title") || "Open/free media guardrails"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-700 leading-relaxed mb-3" }, t("about.media_guardrails_intro") || "Video Studio can track stock/open media credits in each project. We do not treat every free-stock site as open source: each asset needs its own license, source URL, and attribution record before sharing."), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2" }, MEDIA_SOURCE_GUIDE.map((item) => /* @__PURE__ */ React.createElement("a", { key: item.name, href: item.url, target: "_blank", rel: "noopener noreferrer", className: "block rounded-lg border border-emerald-100 bg-white p-3 hover:border-emerald-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600" }, /* @__PURE__ */ React.createElement("span", { className: "flex items-start justify-between gap-2" }, /* @__PURE__ */ React.createElement("strong", { className: "text-xs text-slate-800" }, item.name), /* @__PURE__ */ React.createElement("span", { className: "text-[10px] font-semibold text-emerald-700 bg-emerald-50 border border-emerald-100 rounded-full px-2 py-0.5" }, item.status)), /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] font-medium text-slate-500 mt-1" }, item.license), /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] text-slate-600 leading-relaxed mt-1" }, item.guidance))))), /* @__PURE__ */ React.createElement("div", { className: "bg-amber-50 p-4 rounded-lg border border-amber-200" }, /* @__PURE__ */ React.createElement("h5", { className: "font-bold text-amber-950 text-sm mb-1" }, "Reading catalog acknowledgements"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-700 leading-relaxed" }, "Reading works and catalog records are not covered by AlloFlow\u2019s AGPL license. Every readable title keeps its creators, publisher, source link, exact item-level license, and applicable restrictions. Collections with mixed or unclear rights stay link-only until a title-level audit approves more."), /* @__PURE__ */ React.createElement("details", { className: "mt-3 rounded-lg border border-amber-200 bg-white group" }, /* @__PURE__ */ React.createElement("summary", { className: "min-h-11 cursor-pointer select-none px-3 py-2.5 font-bold text-amber-900 text-xs flex items-center gap-2 hover:text-amber-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-amber-700" }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "text-amber-600 group-open:rotate-90 transition-transform motion-reduce:transition-none" }, "\u25B8"), "View recognized reading sources (", READING_SOURCE_TOTAL, ")"), /* @__PURE__ */ React.createElement("div", { className: "px-3 pb-3 pt-1 space-y-4" }, READING_SOURCE_CREDITS.map((section) => /* @__PURE__ */ React.createElement("div", { key: section.group }, /* @__PURE__ */ React.createElement("h6", { className: "font-bold text-[10px] uppercase tracking-wider text-slate-500 mb-1.5" }, section.group), /* @__PURE__ */ React.createElement("ul", { className: "space-y-2 list-none" }, section.items.map((item) => /* @__PURE__ */ React.createElement("li", { key: item.sourceId, className: "text-[11px] text-slate-700 leading-relaxed" }, /* @__PURE__ */ React.createElement("a", { href: item.url, target: "_blank", rel: "noopener noreferrer", className: "font-bold text-indigo-700 hover:text-indigo-900 hover:underline rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600" }, item.name), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, " \u2014 ", item.scope), /* @__PURE__ */ React.createElement("span", { className: "block text-slate-500" }, /* @__PURE__ */ React.createElement("span", { className: "font-semibold" }, "Rights:"), " ", item.license))))))))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h5", { className: "font-bold text-[11px] uppercase tracking-wider text-slate-500 mb-2" }, t("about.oss_featured_header") || "Learning tools we integrate"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3" }, FEATURED_OSS.map((item) => /* @__PURE__ */ React.createElement(FeaturedCard, { key: item.name, item })))), /* @__PURE__ */ React.createElement("details", { className: "bg-slate-50 rounded-xl border border-slate-200 group" }, /* @__PURE__ */ React.createElement("summary", { className: "min-h-11 cursor-pointer select-none px-4 py-3 font-bold text-slate-700 text-sm flex items-center gap-2 hover:text-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-indigo-600" }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "text-slate-400 group-open:rotate-90 transition-transform motion-reduce:transition-none" }, "\u25B8"), t("about.oss_full_list_header") || "Libraries and open resources we integrate", " (", OSS_TOTAL, ")"), /* @__PURE__ */ React.createElement("div", { className: "px-4 pb-4 pt-1 space-y-4" }, OSS_CREDITS.map((section) => /* @__PURE__ */ React.createElement("div", { key: section.group }, /* @__PURE__ */ React.createElement("h5", { className: "font-bold text-[11px] uppercase tracking-wider text-slate-500 mb-1.5" }, section.group), /* @__PURE__ */ React.createElement("ul", { className: "space-y-1.5 list-none" }, section.items.map((item) => /* @__PURE__ */ React.createElement("li", { key: item.name, className: "text-xs text-slate-700 leading-snug flex flex-col sm:flex-row sm:items-baseline sm:gap-2" }, /* @__PURE__ */ React.createElement(
    ...
    item.name
  ), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, "\u2014 ", item.use, " ", /* @__PURE__ */ React.createElement("span", { className: "text-slate-400" }, "\xB7"), " ", /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-500" }, item.license))))))))), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] text-slate-600 leading-relaxed pt-1 border-t border-slate-200" }, t("about.oss_credits_footer") || "Hosted AI features use the provider configured in AI settings (such as Gemini, OpenAI, Claude, or an OpenAI-compatible endpoint); those services are not bundled software. Software libraries above are credited with their copyright notices in THIRD_PARTY_LICENSES.md, and full verbatim license texts ship with the source in the licenses/ folder \u2014 bundled into the School Box desktop app too. Reading works retain title-level attribution, source, and rights notices in the catalog and reader. Spot something we should credit or correct? Let us know."));
}
const ATLAS_HUBS = [
  {
...
function AtlasHubRoute({ hub, visual }) {
  return /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border " + visual.border + " bg-gradient-to-r " + visual.surface + " p-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-baseline justify-between gap-1 mb-2" }, /* @__PURE__ */ React.createElement("p", { className: "text-[10px] font-black uppercase tracking-widest " + visual.text }, visual.eyebrow), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] text-slate-500" }, "A guide, not a required sequence")), /* @__PURE__ */ React.createElement("p", { className: "sr-only" }, hub.hub, " overview: ", visual.route.join(", "), "."), /* @__PURE__ */ React.createElement("div", { "aria-hidden": "true", className: "grid grid-cols-1 gap-1.5 sm:flex sm:items-center" }, visual.route.map((step, index) => /* @__PURE__ */ React.createElement(React.Fragment, { key: step }, index > 0 && /* @__PURE__ */ React.createElement("span", { className: "hidden sm:block h-px min-w-2 flex-1 bg-slate-300" }), /* @__PURE__ */ React.createElement("span", { className: "min-w-0 sm:flex-1 whitespace-normal break-words rounded-lg border border-white/90 bg-white/80 px-2 py-1.5 text-center text-[10px] font-bold text-slate-700 shadow-sm" }, step)))));
}
...
function AtlasHubCard({ hub, isOpen, onToggle, cardRef, isFiltered, query, onLaunch }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("summary", { className: "min-h-11 cursor-pointer select-none p-4 grid grid-cols-[auto_minmax(0,1fr)_auto] items-start sm:flex sm:items-center gap-2 hover:bg-slate-50 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-indigo-600" }, /* @__PURE__ */ React.createElement("span", { className: "col-start-1 row-start-1 w-9 h-9 shrink-0 rounded-xl bg-gradient-to-br " + visual.surface + " border " + visual.border + " flex items-center justify-center text-xl leading-none", "aria-hidden": "true" }, hub.icon), /* @__PURE__ */ React.createElement("span", { className: "col-start-2 row-start-1 min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-800 text-sm block" }, /* @__PURE__ */ React.createElement(AtlasHighlight, { text: hub.hub, query })), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-slate-500 font-normal leading-snug block mt-0.5" }, /* @__PURE__ */ React.createElement(AtlasHighlight, { text: visual.description, query })), /* @__PURE__ */ React.createElement("span", { className: "text-[9px] font-bold text-slate-600 leading-snug block mt-1" }, /* @__PURE__ */ React.createElement(AtlasHighlight, { text: hub.sourceLabel || "Curated product index", query }))), /* @__PURE__ */ React.createElement("span", { className: "col-start-2 col-span-2 row-start-2 mt-2 justify-self-start max-w-full text-[11px] font-semibold text-indigo-700 bg-indigo-50 border border-indigo-100 rounded-full px-2 py-0.5 whitespace-normal break-words sm:mt-0 sm:shrink-0 sm:whitespace-nowrap" }, isFiltered ? resultLabel : hub.total + " entries" + (catCount > 1 ? " / " + catCount + " areas" : "")), /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "col-start-3 row-start-1 self-center text-slate-400 group-open:rotate-90 transition-transform motion-reduce:transition-none text-xs" }, ">")),
...
function AtlasTab({ t, onRequestClose }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "space-y-5 text-slate-700" }, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-50 p-4 rounded-lg border border-indigo-100" }, /* @__PURE__ */ React.createElement("h4", { className: "font-bold text-indigo-900 mb-1 flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "\u{1F5FA}\uFE0F"), t("about.atlas_title") || "The AlloFlow Atlas"), /* @__PURE__ */ React.createElement("p", { className: "text-sm leading-relaxed text-slate-700" }, t("about.atlas_intro") || "A structured map of AlloFlow\u2019s cataloged hubs and launch surfaces. Choose a region for its visual guide, areas, searchable entries, and source notes.")), /* @__PURE__ */ React.createElement("div", { role: "group", "aria-label": "Atlas view", className: "grid grid-cols-2 rounded-xl border border-slate-200 bg-slate-100 p-1" }, /* @__PURE__ */ React.createElement(
  ...
  )), /* @__PURE__ */ React.createElement("p", { id: "atlas-search-status", role: "status", "aria-live": "polite", className: "text-[10px] text-slate-500 mt-2" }, isSearching ? resultStats.entries ? resultStats.entries + (resultStats.entries === 1 ? " matching catalog entry" : " matching catalog entries") + " across " + resultStats.areas + (resultStats.areas === 1 ? " area." : " areas.") : "No Atlas matches found." : "Browse the current directory or search to narrow it.")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-1" }, /* @__PURE__ */ React.createElement("h5", { id: "atlas-directory-title", className: "text-[10px] font-black uppercase tracking-[0.18em] text-slate-600" }, "Catalog directory"), /* @__PURE__ */ React.createElement("div", { role: "group", "aria-label": "Atlas hub visibility", className: "flex flex-wrap gap-1.5" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    "Clear search"
  )))), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] text-slate-600 leading-relaxed pt-1 border-t border-slate-200" }, t("about.atlas_footer") || "Registry-backed sections are generated from current catalogs; curated and mixed sections are labeled in the map. Counts are searchable catalog entries, not unique-tool totals. An automated freshness check flags generated-data drift."));
}
...
function InfoModal({
  ...
  React.useEffect(() => {
    ...
    const frame = window.requestAnimationFrame(() => {
      ...
      const trigger = originalTrigger?.isConnected ? originalTrigger : Array.from(panelRef.current?.querySelectorAll("[data-feature-guide-key]") || []).find((candidate) => candidate.getAttribute("data-feature-guide-key") === featureReturnFocusKeyRef.current);
  ...
  return /* @__PURE__ */ React.createElement("div", { role: "presentation", className: "fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-[300] flex items-stretch sm:items-center justify-center p-0 sm:p-4 motion-safe:animate-in motion-safe:fade-in motion-safe:duration-200", onClick: handleSetShowInfoModalToFalse }, /* @__PURE__ */ React.createElement("div", { ref: dialogRef, tabIndex: -1, className: "bg-white rounded-none sm:rounded-2xl shadow-2xl max-w-4xl w-full h-[100dvh] max-h-[100dvh] sm:h-auto sm:max-h-[90vh] overflow-hidden flex flex-col focus:outline-none", role: "dialog", "aria-modal": "true", "aria-labelledby": "info-modal-title", "aria-describedby": "info-modal-description", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("p", { id: "info-modal-description", className: "sr-only" }, "Explore AlloFlow\u2019s approach, catalog map, guided workflows, privacy data paths, and open-source credits."), /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-700 px-4 py-3 sm:p-4 text-white flex justify-between items-center gap-3 shrink-0" }, /* @__PURE__ */ React.createElement("h3", { id: "info-modal-title", className: "min-w-0 font-bold text-lg leading-tight flex items-center gap-2" }, /* @__PURE__ */ React.createElement(Layers, { size: 20, className: "shrink-0", "aria-hidden": "true" }), " ", t("about.title")), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: handleSetShowInfoModalToFalse, className: "min-h-11 min-w-11 shrink-0 inline-flex items-center justify-center rounded-full hover:bg-indigo-600 focus:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors motion-reduce:transition-none", "aria-label": t("common.close") }, /* @__PURE__ */ React.createElement(X, { size: 20, "aria-hidden": "true" }))), /* @__PURE__ */ React.createElement("div", { ref: tabListRef, className: "flex border-b border-slate-200 bg-slate-50 shrink-0 overflow-x-auto overscroll-x-contain scroll-px-2", role: "tablist", "aria-orientation": "horizontal", "aria-label": t("about.title") }, /* @__PURE__ */ React.createElement(
    ...
    "Users": Users
  }[selectedFeature.icon] || Sparkles, { size: 24, "aria-hidden": true })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] font-bold uppercase tracking-wider block" }, selectedFeature.categoryName), /* @__PURE__ */ React.createElement("h4", { className: "font-extrabold text-xl leading-none mt-1" }, selectedFeature.title))), /* @__PURE__ */ React.createElement("p", { className: "text-sm leading-relaxed opacity-95 mt-2" }, selectedFeature.desc)), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    return /* @__PURE__ */ React.createElement("div", { key: catKey }, /* @__PURE__ */ React.createElement("h4", { className: "font-black text-slate-600 uppercase tracking-widest text-xs mb-3 border-b border-slate-200 pb-1" }, categoryTitle), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4" }, categoryItems.map((feature, idx) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("span", { className: "block text-xs leading-snug" }, feature.desc)
      );
    })));
