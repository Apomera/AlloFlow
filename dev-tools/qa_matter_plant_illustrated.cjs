...
const slug=process.argv[2];if(!['states_of_matter_grade4','plant_needs_grade3'].includes(slug))throw Error('Provide an approved pack slug');
const panelCount=slug==='states_of_matter_grade4'?13:14;
