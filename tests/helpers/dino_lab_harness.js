...
export function setupDinoLab() {
  ...
  src = src.replace(
    ...
    "globalThis.__dinoInternals = { DINOS: DINOS, PERIODS: PERIODS, CLADES: CLADES, EXTINCTIONS: EXTINCTIONS, KPG_EVIDENCE: KPG_EVIDENCE, ANATOMY: ANATOMY, MYTHS: MYTHS, QUIZ: QUIZ, GLOSSARY: GLOSSARY, SITES: SITES, RECORDS: RECORDS, PEOPLE: PEOPLE, byId: byId, periodName: periodName, fmtLength: fmtLength, fmtWeight: fmtWeight, fmtMya: fmtMya, catalogList: catalogList, specimenMap: specimenMap, notebookMap: notebookMap, notebookText: notebookText, dinoSurfaceGeometry: dinoSurfaceGeometry, dinoFrameDistance: dinoFrameDistance };\n  window.StemLab.registerTool('dinoLab'"
  );
