...
1. Open **Source Material** and paste, import, or generate a text ([Prepare a lesson](02-prepare-a-lesson.md)).
2. Open **Universal Settings** once: grade, language, translations ([Universal Settings](11-universal-settings.md)).
...
- **Review before delivery, every time.** A fluent answer can still be wrong ([Privacy and responsible AI](07-privacy-and-responsible-ai.md)).
