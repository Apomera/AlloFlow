  ...
  window.StemLab.registerTool('renewablesLab', {
    ...
    render: function(ctx) {
      ...
      var MENU_TILES = [
        ...
        // Assessment
        { id: 'quiz',        icon: '📝',     label: '10-question quiz',  desc: 'Test your understanding of all sources.' },
      ...
      function svgGshp() {
        return h('svg', { viewBox: '0 0 600 360', width: '100%', height: '100%',
          ...
          h('path', { d: 'M 280 145 Q 300 120 308 105', stroke: '#fbbf24', strokeWidth: 1.5, fill: 'none', markerEnd: 'url(#arr)' }),
