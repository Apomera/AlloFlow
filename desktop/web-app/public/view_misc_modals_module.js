...
function AIBackendModalBody(props) {
  ...
  const renderGuidedStep = () => {
    ...
    ), /* @__PURE__ */ React.createElement("span", { className: "text-xs leading-relaxed text-violet-900" }, /* @__PURE__ */ React.createElement("span", { className: "font-black" }, t("ai_backend.pledge_title") || "I will help make AlloFlow better."), " ", t("ai_backend.pledge_body") || "A developer key is a developer tool. If something breaks I will report it, and if I build a lesson, pack or tool worth sharing I will offer it back to other teachers.", " ", /* @__PURE__ */ React.createElement("a", { href: "https://github.com/Apomera/AlloFlow/issues/new", target: "_blank", rel: "noopener noreferrer", className: "font-bold underline" }, t("ai_backend.pledge_report") || "Report something \u2197"), " \xB7 ", /* @__PURE__ */ React.createElement("a", { href: "https://apomera.github.io/AlloFlow/feedback.html", target: "_blank", rel: "noopener noreferrer", className: "font-bold underline" }, t("ai_backend.pledge_share") || "Share what you made \u2197"))), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-500" }, t("ai_backend.guided_gemini_key_note") || "Stored only on this device. The free tier covers everyday classroom use."), guidedBackBtn("choose"));
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, guidedStepHeading(t("ai_backend.guided_choose_kicker") || "First-time setup \xB7 Choose your AI"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-600 leading-relaxed" }, t("ai_backend.guided_intro") || "AlloFlow uses an AI engine to create lessons, read aloud, and answer questions. Pick how you'd like it to work \u2014 you can change this any time."), connected && /* @__PURE__ */ React.createElement("p", { className: "text-[11px] font-bold text-green-800 bg-green-50 border border-green-100 rounded-xl p-2" }, "\u2705 ", (t("ai_backend.guided_connected_chip") || "Connected \u2014") + " " + (GUIDED_BACKEND_LABELS[currentBackend] || currentBackend)), !connected && guidedCard(
      ...
      () => {
        try {
          window.open("https://share.gemini.google/sMuYEoIE2l8s", "_blank", "noopener");
        } catch (e) {
        }
      },
      "\u{1F680}",
