...
const maintained = ['README.md','AdminBrief.md','AlloFlow Complete User Manual.md','architecture.md','FEATURE_INVENTORY.md','COMPETITOR_COMPARISON.md','CONTRIBUTING.md','ORIENTATION.md','DEPLOY_YOUR_OWN.md','SECURITY.md','VPAT-2.5-WCAG-AlloFlow.md','docs/README.md','desktop/README.md','prismflow-deploy/README.md'];
const errors = [];
