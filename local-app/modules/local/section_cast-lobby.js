...
Return ONLY the hint text as a single paragraph (no JSON, no markdown). Keep it under 2 sentences. Be encouraging.`;
  ...
  React.useEffect(() => {
    ...
    loadModule('StemLab', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/stem_lab/stem_lab_module.js');
    loadModule('WordSoundsModal', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/word_sounds_module.js');
    loadModule('StudentAnalytics', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/student_analytics_module.js');
    loadModule('BehaviorLens', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/behavior_lens_module.js');
    loadModule('SymbolStudio', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/symbol_studio_module.js');
    loadModule('SelHub', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/sel_hub/sel_hub_module.js');
    loadModule('GamesBundle', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/games_module.js');
    loadModule('QuickStartWizard', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/quickstart_module.js');
    loadModule('AlloBot', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/allobot_module.js');
    loadModule('TeacherModule', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/teacher_module.js');
    loadModule('StoryForge', 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/story_forge_module.js');
    ...
    setTimeout(function() {
      var pluginCdnBase = 'https://cdn.jsdelivr.net/gh/Apomera/AlloFlow@0573012/';
      var toolModules = [
