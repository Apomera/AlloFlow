...
- Name: document_builder_responsive_keyboard.spec.ts >> Enhancements: find tools without shrinking the preview at 390
...
Call log:
  ...
  - waiting for locator('[data-builder-tool-result]')
    31 × locator resolved to 0 elements
       - unexpected value "0"
  ...
  - dialog "Document Builder" [ref=e3]:
    ...
    - generic [ref=e18]:
      ...
      - generic [ref=e20]:
        ...
        - dialog "Find a tool" [ref=e41]:
          - generic [ref=e42]:
            - strong [ref=e43]: Find a tool
            - button "Close tool search" [ref=e44] [cursor=pointer]: Close
          - generic [ref=e45]: Find a document tool
          - searchbox "Find a document tool" [active] [ref=e46]: Table body rows
          - paragraph [ref=e47]: Choose a result to open its controls. Arrow keys move through results.
          - status [ref=e48]: 0 tools shown
          - paragraph [ref=e49]: No matching tools. Try a shorter term, or select an image or table to see its tools.
      - iframe [ref=e52]:
        - main [ref=f1e2]:
          - heading "Classroom handout" [level=1] [ref=f1e3]
          - paragraph [ref=f1e4]: Original lesson text.
          - button "Run lesson action" [ref=f1e5]: Run
      - generic "Document status bar" [ref=e53]:
        - generic [ref=e54]:
          - generic [ref=e55]: Editing enabled
          - status [ref=e56]: No local changes yet
          - 'button "Track: Off · 0 changes" [ref=e58] [cursor=pointer]'
          - 'button "Words: 6" [ref=e60] [cursor=pointer]'
          - generic [ref=e61]: Page 1 of 2
          - group [ref=e62]:
            - generic "Details & shortcuts" [ref=e63] [cursor=pointer]
        - generic [ref=e64]:
          - combobox "Preview zoom mode" [ref=e65]:
            - option "Fit width" [selected]
            - option "Fit page"
            - option "Custom zoom"
          - generic "Editor zoom controls" [ref=e66]:
            - button "Zoom out" [ref=e67] [cursor=pointer]: −
            - slider "Editor zoom" [ref=e68]: "50"
            - button "Zoom in" [ref=e69] [cursor=pointer]: +
            - button "Reset editor zoom to 100 percent" [ref=e70] [cursor=pointer]: 50%
```
