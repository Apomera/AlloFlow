...
describe('Test Prep Hub render flow', () => {
  ...
  it('opens the native EPPP pilot and the complete guarded legacy workspace', async () => {
    ...
    expect(host.textContent).toContain('Question 1 of 80');
    expect(host.textContent).toContain('80/80 native items passed content QA');
    ...
    expect(host.textContent).toContain('72 / 2,933 legacy items');
    ...
    expect(host.textContent).toContain('Question 9 of 80');
