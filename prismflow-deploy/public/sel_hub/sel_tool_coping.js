    ...
    render: function(ctx) {
      ...
      var tabBar = h('div', {
        ...
        h('button', { 'aria-label': '\uD83C\uDFC5 ' + Object.keys(earnedBadges).length + '/' + BADGES.length,
          ...
          style: { padding: '7px 10px', borderRadius: 8, border: 'none', cursor: 'pointer', background: showBadgesPanel ? '#14b8a633' : 'transparent', color: '#9ca3af', fontSize: 14, flexShrink: 0 }
              ...
              return h('div', {
                ...
                h('button', { 'aria-label': 'Toggle sound',
                  ...
                  h('div', { style: { flex: 1 } },
                    h('div', { style: { display: 'flex', alignItems: 'center', gap: 6, marginBottom: 2 } },
                      ...
                      wasViewed && h('span', { style: { fontSize: 10, color: '#9ca3af' } }, '\u2713')
                    ),
                    h('p', { style: { margin: 0, fontSize: 11, color: '#cbd5e1', lineHeight: 1.3 } }, strat.desc[band] || strat.desc.elementary)
                  ),
                  h('span', { style: { color: '#9ca3af', fontSize: 16, flexShrink: 0, transform: isExpanded ? 'rotate(180deg)' : 'none', transition: 'transform 0.2s' } }, '\u25BC')
                ),
                // Expanded content
                isExpanded && h('div', { style: { padding: '0 16px 16px', borderTop: '1px solid #334155' } },
                  ...
                  h('div', { style: { display: 'flex', gap: 6, marginTop: 12, marginBottom: 12, flexWrap: 'wrap' } },
                    h('span', { style: { fontSize: 11, color: '#9ca3af', marginRight: 4 } }, 'Best for:'),
                  ...
                  band === 'elementary' && callTTS && h('button', { 'aria-label': 'Read Aloud',
                    ...
                    style: { marginBottom: 10, padding: '6px 14px', borderRadius: 8, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', cursor: 'pointer', fontSize: 12 }
                  }, '\uD83D\uDD0A Read Aloud'),
                  ...
                  h('div', { style: { display: 'flex', gap: 6, marginTop: 6 } },
                    h('button', { 'aria-label': 'Log it',
                      ...
                      style: {
                        ...
                        background: 'transparent', color: '#cbd5e1', fontWeight: 600, fontSize: 12, cursor: 'pointer'
                      }
                    }, '\uD83D\uDCDD Log it'),
      ...
      if (activeTab === 'practice') {
              ...
              [
                ...
                return h('button', { 'aria-label': mode.icon,
                  ...
                  h('div', { style: { flex: 1 } },
                    ...
                    h('div', { style: { fontSize: 12, color: '#cbd5e1' } }, mode.desc)
                  )
                );
              })
            )
        ...
        if (practiceMode === 'pmr') {
          ...
          practiceContent = h('div', { style: { padding: 20, maxWidth: 500, margin: '0 auto', textAlign: 'center' } },
            ...
            !pmrDone && h('p', { style: { color: '#9ca3af', fontSize: 12, marginBottom: 8 } },
            ...
            !pmrDone ? h('div', null,
              ...
              h('div', {
                ...
                h('p', { style: { fontSize: 12, color: '#9ca3af', marginTop: 8 } },
              ...
              h('div', { style: { display: 'flex', gap: 10, justifyContent: 'center' } },
                ...
                h('button', { 'aria-label': 'Back',
                  ...
                  style: { padding: '12px 20px', borderRadius: 10, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', fontWeight: 600, cursor: 'pointer' }
                }, '\u2190 Back')
              )
              ...
              h('p', { style: { color: '#9ca3af', fontSize: 12 } }, 'Sessions completed: ' + (pmrComplete + 1)),
        ...
        if (practiceMode === 'breathing') {
          ...
          practiceContent = h('div', { style: { padding: 20, maxWidth: 500, margin: '0 auto', textAlign: 'center' } },
            ...
            h('p', { style: { color: '#cbd5e1', fontSize: 12, marginBottom: 16 } },
              ...
              h('div', { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 16 } },
                BREATH_PATTERNS.map(function(pat, idx) {
                  ...
                  return h('button', { 'aria-label': pat.name,
                    ...
                    h('div', { style: { fontSize: 10, color: '#cbd5e1' } }, pat.desc),
                    h('div', { style: { fontSize: 10, color: '#9ca3af', marginTop: 4 } },
            ...
            breathActive && h('div', null,
              h('p', { style: { fontSize: 12, color: '#9ca3af', marginBottom: 4 } },
              ...
              h('button', { 'aria-label': 'Stop',
                ...
                style: { padding: '10px 24px', borderRadius: 8, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', fontWeight: 600, cursor: 'pointer' }
              }, 'Stop')
            ),
            ...
            breathPhase === 'done' && !breathActive && h('div', { style: { padding: 30 } },
              ...
              h('p', { style: { color: '#cbd5e1', fontSize: 13, marginBottom: 12 } },
              ...
              h('p', { style: { color: '#9ca3af', fontSize: 12 } }, 'Total sessions: ' + breathSessions),
            ...
            h('div', { style: { marginTop: 20 } },
              h('button', { 'aria-label': 'Back to Practice Menu',
                ...
                style: { padding: '8px 20px', borderRadius: 8, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', fontWeight: 600, cursor: 'pointer' }
              }, '\u2190 Back to Practice Menu')
            )
          );
        }
        ...
        if (practiceMode === 'movement') {
          ...
          practiceContent = h('div', { style: { padding: 20, maxWidth: 500, margin: '0 auto', textAlign: 'center' } },
                ...
                MOVEMENT_EXERCISES.map(function(ex, idx) {
                  ...
                  return h('button', { 'aria-label': ex.icon,
                    ...
                    h('div', null,
                      ...
                      h('div', { style: { fontSize: 11, color: '#cbd5e1' } }, (ex.steps[band] || ex.steps.elementary).length + ' steps')
                    )
                  );
                })
              ),
            ...
            moveActive && !moveDone && h('div', null,
              ...
              h('p', { style: { fontSize: 12, color: '#9ca3af', marginBottom: 8 } }, exercise.icon + ' ' + exercise.name + ' \u2022 Step ' + (moveStep + 1) + '/' + exSteps.length),
            ...
            moveDone && h('div', { style: { padding: 30 } },
              ...
              h('p', { style: { color: '#9ca3af', fontSize: 12 } }, 'Sessions completed: ' + moveSessions),
        ...
        if (practiceMode === 'thought_flip') {
          ...
          practiceContent = h('div', { style: { padding: 20, maxWidth: 550, margin: '0 auto' } },
            ...
            h('p', { style: { textAlign: 'center', color: '#9ca3af', fontSize: 11, marginBottom: 20 } }, 'Thoughts flipped: ' + tfFlipCount),
            ...
            h('button', { 'aria-label': 'Back to Practice Menu',
              ...
              style: { display: 'block', width: '100%', padding: '8px 0', borderRadius: 8, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', fontWeight: 600, cursor: 'pointer' }
            }, '\u2190 Back to Practice Menu')
          );
        }
        ...
        if (practiceMode === 'i_statement') {
          ...
          practiceContent = h('div', { style: { padding: 20, maxWidth: 550, margin: '0 auto' } },
            ...
            iHistory.length > 0 && h('div', { style: { marginTop: 12, marginBottom: 12 } },
              h('p', { style: { fontSize: 12, fontWeight: 700, color: '#cbd5e1', marginBottom: 8 } }, 'Your I-Statements (' + iHistory.length + ')'),
        ...
        if (practiceMode === 'calm_counting') {
          practiceContent = h('div', { style: { padding: 20, maxWidth: 500, margin: '0 auto', textAlign: 'center' } },
            ...
            h('p', { style: { color: '#cbd5e1', fontSize: 12, marginBottom: 20 } },
            ...
            countCurrent === null
              ? h('div', null,
                  h('p', { style: { color: '#9ca3af', fontSize: 13, marginBottom: 12 } }, 'Count from:'),
                  ...
                  band === 'high' && h('p', { style: { fontSize: 11, color: '#9ca3af', marginBottom: 16 } }, 'Challenge: count by 3s (50, 47, 44...)'),
              ...
              : h('div', null,
                  ...
                  countCurrent > 0 && h('p', { style: { color: '#cbd5e1', fontSize: 13, marginBottom: 20 } },
                  ...
                  countCurrent <= 0 && h('div', null,
                    ...
                    h('p', { style: { color: '#cbd5e1', fontSize: 13, marginBottom: 16 } },
                    ...
                    h('p', { style: { color: '#9ca3af', fontSize: 12 } }, 'Sessions completed: ' + countComplete)
                  ),
                  h('button', { 'aria-label': 'Reset',
                    onClick: function() { upd({ countCurrent: null, countActive: false }); },
                    style: { padding: '8px 20px', borderRadius: 8, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', fontWeight: 600, cursor: 'pointer', marginTop: 8 }
                  }, '\u2190 Reset')
                ),
        ...
        if (practiceMode === 'self_talk') {
          practiceContent = h('div', { style: { padding: 20, maxWidth: 550, margin: '0 auto' } },
            ...
            stSaved.length > 0 && h('div', { style: { marginBottom: 16 } },
              h('p', { style: { fontSize: 12, fontWeight: 700, color: '#cbd5e1', marginBottom: 8 } }, 'Saved Self-Talk (' + stSaved.length + ')'),
      ...
      if (activeTab === 'plan') {
        ...
        planContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
            ...
            (plan.warningSigns || []).map(function(sign, i) {
              return h('div', { key: i, style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 } },
                ...
                h('button', { 'aria-label': 'Add a warning sign...',
                  ...
                  style: { padding: '2px 6px', borderRadius: 4, border: 'none', background: '#334155', color: '#cbd5e1', cursor: 'pointer', fontSize: 10 }
                }, '\u2715')
              );
            }),
          ...
          h('div', { style: { marginBottom: 20, padding: 16, borderRadius: 14, background: '#1e293b', border: '1px solid #334155' } },
            ...
            h('p', { style: { fontSize: 11, color: '#9ca3af', marginTop: 10, marginBottom: 6 } }, 'Quick-add:'),
            h('div', { style: { display: 'flex', flexWrap: 'wrap', gap: 4 } },
              ['Take 5 deep breaths', 'Count backwards from 10', 'Squeeze a stress ball', 'Walk away from the situation', 'Talk to a trusted adult', 'Use an I-statement'].map(function(quick) {
                return h('button', { 'aria-label': 'Quick add: ' + quick,
                  ...
                  style: { padding: '4px 10px', borderRadius: 6, border: '1px solid #334155', background: '#0f172a', color: '#cbd5e1', cursor: 'pointer', fontSize: 10 }
                }, '+ ' + quick);
              })
            )
          ),
          ...
          callGemini && h('div', { style: { marginTop: 20, padding: 16, borderRadius: 14, background: 'linear-gradient(135deg, #14b8a612 0%, #8b5cf612 100%)', border: '1px solid #14b8a633' } },
            ...
            h('p', { style: { fontSize: 11, color: '#cbd5e1', marginBottom: 12 } },
            ...
            : h('div', null,
                ...
                (function() {
                  ...
                  return h('div', { style: { display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10, marginBottom: 20 } },
                    ...
                    h('div', { style: { textAlign: 'center', padding: 14, borderRadius: 12, background: avgRating ? '#eab30818' : '#1e293b', border: '1px solid ' + (avgRating ? '#eab30844' : '#334155') } },
                      ...
                      h('div', { style: { fontSize: 10, color: '#cbd5e1' } }, 'Avg Rating'),
                ...
                (function() {
                  ...
                  return h('div', { style: { display: 'flex', alignItems: 'center', gap: 12, padding: 14, borderRadius: 12, background: '#22c55e12', border: '1px solid #22c55e33', marginBottom: 20 } },
                    ...
                    h('div', { style: { flex: 1 } },
                      ...
                      h('p', { style: { fontSize: 11, color: '#cbd5e1', margin: '2px 0 0 0' } }, 'Avg rating: ' + best.avg + '/5')
                    ),
                ...
                (function() {
                  ...
                  return h('div', { style: { marginBottom: 20, padding: 14, borderRadius: 12, background: '#1e293b', border: '1px solid #334155' } },
                    h('p', { style: { fontSize: 11, fontWeight: 700, color: '#cbd5e1', marginBottom: 8 } }, 'Effectiveness Trend (last ' + rated.length + ' rated)'),
                ...
                h('div', { style: { display: 'flex', gap: 6, flexWrap: 'wrap', justifyContent: 'center', marginBottom: 20 } },
                  STRATEGY_TYPES.map(function(type) {
                    ...
                    return h('div', {
                      ...
                      h('div', { style: { fontSize: 11, color: '#cbd5e1' } }, type.label)
                    );
                  })
                ),
                h('p', { style: { textAlign: 'center', color: '#9ca3af', fontSize: 12, marginBottom: 16 } },
                    ...
                    h('div', { style: { flex: 1 } },
                      ...
                      !hasRating
                        ? h('div', { style: { display: 'flex', alignItems: 'center', gap: 4, marginTop: 4 } },
                            h('span', { style: { fontSize: 10, color: '#9ca3af', marginRight: 4 } }, 'How helpful was it?'),
                            [1, 2, 3, 4, 5].map(function(star) {
                              return h('button', { 'aria-label': 'Rate ' + star + ' stars',
                                ...
                                style: { background: 'none', border: 'none', cursor: 'pointer', fontSize: 16, padding: 0, color: '#9ca3af' }
                              }, '\u2606');
                            })
                          )
                        : h('div', { style: { display: 'flex', alignItems: 'center', gap: 2, marginTop: 4 } },
                            ...
                            h('span', { style: { fontSize: 10, color: '#9ca3af', marginLeft: 4 } }, entry.rating + '/5')
                          )
                    )
                  );
                })
          ...
          h('div', { style: { display: 'flex', gap: 8, justifyContent: 'center' } },
            CHECKIN_MOODS.map(function(mood) {
              return h('button', { 'aria-label': 'info',
                ...
                h('span', { style: { fontSize: 11, color: '#cbd5e1' } }, mood.label)
              );
            })
          )
        );
          ...
          h('div', { style: { display: 'flex', alignItems: 'flex-start', gap: 10 } },
            ...
            h('div', { style: { flex: 1 } },
              ...
              h('button', { 'aria-label': 'Dismiss',
                ...
                style: { marginTop: 6, padding: '3px 10px', borderRadius: 6, border: 'none', background: '#334155', color: '#cbd5e1', cursor: 'pointer', fontSize: 10 }
              }, 'Dismiss')
            )
          )
        );
      ...
      if (checkinDoneToday && dailyRecLoading) {
        dailyRecBanner = h('div', {
          ...
          h('span', { style: { fontSize: 12, color: '#cbd5e1' } }, '\u2728 Finding a strategy for you...')
        );
      }
