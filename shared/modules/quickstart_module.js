 ...
 *
 * HAND-MAINTAINED — no _build_quickstart_module.js build script exists yet.
 * quickstart_source.jsx is a parallel reference of the React component
 * body. Edits to one must be mirrored to the other. PAIR_DRIFT_TRIAGE.md
 * tracks the gap; a future commit may introduce a real build script.
 *
 * Source-pair reference: quickstart_source.jsx
 */
(function() {
  'use strict';
