...
var RosterKeyPanel = React.memo(({ isOpen, onClose, rosterKey, setRosterKey, onApplyGroup, onSyncToSession, onBatchGenerate, activeSessionCode, t, isParentMode, isIndependentMode }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: panelRef, role: "dialog", "aria-modal": "true", className: "fixed inset-0 z-[260] bg-slate-900/80 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] flex flex-col border-2 border-indigo-100 animate-in zoom-in-95 duration-200" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between p-5 border-b border-slate-100" }, /* @__PURE__ */ React.createElement("div", { "data-help-key": "roster_panel_header" }, /* @__PURE__ */ React.createElement("h2", { className: "text-lg font-black text-slate-800 flex items-center gap-2" }, /* @__PURE__ */ React.createElement(ClipboardList, { size: 20, className: "text-indigo-500" }), " ", isParentMode ? "Family Learning Profiles" : isIndependentMode ? "My Learning Profile" : t("roster.title") || "Class Roster & Progress Tracking"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-600 mt-0.5" }, isParentMode ? "Manage family member profiles and track learning progress" : isIndependentMode ? "Manage your learning profile and track your progress" : t("roster.subtitle") || "Organize student groups with differentiated profiles for instruction")), /* @__PURE__ */ React.createElement("button", { onClick: onClose, className: "p-2 rounded-full hover:bg-slate-100 transition-colors", "aria-label": t("common.close") }, /* @__PURE__ */ React.createElement(X, { size: 20, className: "text-slate-600" }))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 px-5 py-3 border-b border-slate-50 bg-slate-50/50" }, /* @__PURE__ */ React.createElement("button", { onClick: () => fileInputRef.current?.click(), className: "px-3 py-1.5 bg-indigo-50 text-indigo-700 rounded-lg text-xs font-bold hover:bg-indigo-100 transition-colors flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Upload, { size: 14 }), " ", t("roster.import") || "Import JSON"), /* @__PURE__ */ React.createElement("button", { onClick: handleExport, disabled: !rosterKey, className: "px-3 py-1.5 bg-green-50 text-green-700 rounded-lg text-xs font-bold hover:bg-green-100 transition-colors flex items-center gap-1.5 disabled:opacity-40" }, /* @__PURE__ */ React.createElement(Download, { size: 14 }), " ", t("roster.export") || "Export JSON"), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowBatchConfig(true), disabled: !rosterKey || Object.keys(rosterKey?.groups || {}).length === 0, className: "px-3 py-1.5 bg-amber-50 text-amber-700 rounded-lg text-xs font-bold hover:bg-amber-100 transition-colors flex items-center gap-1.5 disabled:opacity-40 border border-amber-200" }, /* @__PURE__ */ React.createElement(Layers, { size: 14 }), " ", t("roster.batch_generate") || "Differentiate by Group"), activeSessionCode && /* @__PURE__ */ React.createElement("button", { onClick: onSyncToSession, disabled: !rosterKey || groupIds.length === 0, className: "px-3 py-1.5 bg-purple-50 text-purple-700 rounded-lg text-xs font-bold hover:bg-purple-100 transition-colors flex items-center gap-1.5 disabled:opacity-40 ml-auto" }, /* @__PURE__ */ React.createElement(RefreshCw, { size: 14 }), " ", t("roster.sync_session") || "Sync to Live Session"), /* @__PURE__ */ React.createElement("input", { ref: fileInputRef, type: "file", accept: ".json", onChange: handleImport, className: "hidden" })), /* @__PURE__ */ React.createElement("div", { className: "flex-1 overflow-y-auto p-5 space-y-3 custom-scrollbar" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-bold text-slate-600 uppercase tracking-wider" }, t("roster.class_name") || "Class Name", ":"), /* @__PURE__ */ React.createElement(
    ...
    return /* @__PURE__ */ React.createElement("div", { key: gId, className: "border border-slate-200 rounded-xl overflow-hidden transition-all hover:border-indigo-200" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(ChevronDown, { size: 16, className: `text-slate-600 transition-transform ${isExpanded ? "rotate-180" : ""}` })
    ...
    "button",
    {
      ...
      className: `px-2 py-1 rounded-full font-bold transition-all ${!useCustomName ? "bg-teal-100 text-teal-800 border border-teal-300" : "text-slate-600 hover:text-slate-600"}`
    },
  ...
  )), rosterAdj && rosterAnimal && /* @__PURE__ */ React.createElement("div", { className: "text-xs text-teal-600 font-medium pl-1" }, useCustomName && newStudentName.trim() ? /* @__PURE__ */ React.createElement("span", null, "Codename: ", /* @__PURE__ */ React.createElement("strong", null, rosterAdj, " ", rosterAnimal), " \xB7 Display: ", /* @__PURE__ */ React.createElement("strong", null, newStudentName.trim())) : /* @__PURE__ */ React.createElement("span", null, "Codename: ", /* @__PURE__ */ React.createElement("strong", null, rosterAdj, " ", rosterAnimal))))), getUnassigned().length > 0 && /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-amber-50 border border-amber-200 rounded-xl mt-2" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-amber-700 uppercase tracking-wider mb-1.5" }, t("roster.unassigned_students") || "Unassigned Students"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5" }, getUnassigned().map((name) => /* @__PURE__ */ React.createElement("span", { key: name, className: "inline-flex items-center gap-1 px-2.5 py-1 bg-white text-amber-800 rounded-full text-xs font-medium border border-amber-200" }, name, rosterKey?.progressHistory?.[name]?.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] bg-amber-100 text-amber-800 px-1 py-0.5 rounded-full font-mono ml-0.5", title: `${rosterKey.progressHistory[name].length} sessions` }, rosterKey.progressHistory[name].length, "s"), /* @__PURE__ */ React.createElement(
    "select",
    {
      onChange: (e) => {
      ...
      className: "text-[11px] bg-transparent border-none focus:outline-none focus:ring-2 focus:ring-amber-300 rounded cursor-pointer text-amber-600 ml-1 w-4"
    },
    /* @__PURE__ */ React.createElement("option", { value: "" }, "\u2192"),
    groupIds.map((gId) => /* @__PURE__ */ React.createElement("option", { key: gId, value: gId }, groups[gId].name))
...
var StudentEscapeRoomOverlay = React.memo(({ sessionData, user, activeSessionCode, targetAppId, t, playSound }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { role: "dialog", "aria-modal": "true", className: "fixed inset-0 z-[9999] bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 overflow-auto" }, /* @__PURE__ */ React.createElement("div", { className: "sticky top-0 z-50 bg-slate-900/90 backdrop-blur-sm border-b border-purple-500/30 p-4" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-6xl mx-auto flex items-center justify-between flex-wrap gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement(DoorOpen, { className: "text-purple-400", size: 24 }), /* @__PURE__ */ React.createElement("span", { className: "text-white font-bold text-lg" }, escapeState.room?.theme || t("escape_room.title"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: `flex items-center gap-2 px-3 py-1.5 rounded-full ${myTeamColors.bg} text-white font-bold text-sm`, "data-help-key": "escape_room_team" }, /* @__PURE__ */ React.createElement(Users, { size: 14 }), t(`escape_room.team_${userTeam.toLowerCase()}`, { defaultValue: `${userTeam} Team` })), /* @__PURE__ */ React.createElement("div", { className: "text-white font-mono", "data-help-key": "escape_room_progress" }, /* @__PURE__ */ React.createElement("span", { className: "text-purple-400" }, solvedPuzzlesSet.size), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, "/", puzzles.length)), escapeState.maxLives < 99 && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 px-2 py-1 rounded-full bg-slate-700/50", title: t("escape_room.lives"), "data-help-key": "escape_room_lives" }, Array.from({ length: escapeState.maxLives }).map((_, i) => /* @__PURE__ */ React.createElement("span", { key: i, className: `text-sm ${i < (escapeState.lives || 0) ? "text-red-500" : "text-slate-600"}` }, "\u2764\uFE0F"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 px-2 py-1 rounded-full bg-slate-700/50", title: t("escape_room.hints_used") }, /* @__PURE__ */ React.createElement(Lightbulb, { size: 14, className: "text-yellow-400" }), /* @__PURE__ */ React.createElement("span", { className: "text-white text-xs font-bold" }, escapeState.hintsRemaining || 0)), (escapeState.streak || 0) >= 3 && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 px-2 py-1 rounded-full bg-orange-500/20 text-orange-800 font-bold text-xs animate-pulse", "data-help-key": "escape_room_streak" }, "\u{1F525} x", escapeState.streak), /* @__PURE__ */ React.createElement("div", { className: `px-3 py-1.5 rounded-full font-mono font-bold ${timeRemaining < 60 ? "bg-red-700 text-white animate-pulse" : "bg-slate-700 text-white"}`, "data-help-key": "escape_room_timer" }, /* @__PURE__ */ React.createElement(Clock, { size: 14, className: "inline mr-1" }), formatTime(timeRemaining))))), /* @__PURE__ */ React.createElement("div", { className: "fixed right-4 top-24 bg-slate-800/80 backdrop-blur-sm rounded-xl p-4 border border-purple-500/30 z-40", "data-help-key": "escape_room_leaderboard" }, /* @__PURE__ */ React.createElement("h4", { className: "text-xs font-bold text-slate-600 uppercase mb-3" }, t("escape_room.live_progress")), allTeams.map((team) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { key: team, className: `mb-2 ${team === userTeam ? "ring-2 ring-white/50 rounded-lg p-1" : ""}` }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between text-xs mb-1" }, /* @__PURE__ */ React.createElement("span", { className: `font-bold ${colors.text}` }, team), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, solved, "/", puzzles.length)), /* @__PURE__ */ React.createElement("div", { className: "w-32 h-2 bg-slate-700 rounded-full overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: `h-full ${colors.bg} transition-all duration-300`, style: { width: `${percent}%` } })), escaped && /* @__PURE__ */ React.createElement("span", { className: "text-xs text-green-400" }, "\u{1F3C6} ", t("escape_room.escaped")));
    ...
    t("escape_room.submit_answer")
  )), currentPuzzle.hint && /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-purple-400 text-sm italic" }, "\u{1F4A1} ", currentPuzzle.hint))), isPaused && /* @__PURE__ */ React.createElement("div", { role: "dialog", "aria-modal": "true", className: "fixed inset-0 z-[10001] bg-black/80 flex items-center justify-center backdrop-blur-sm" }, /* @__PURE__ */ React.createElement("div", { className: "text-center text-white animate-pulse" }, /* @__PURE__ */ React.createElement("div", { className: "text-8xl mb-6" }, "\u23F8\uFE0F"), /* @__PURE__ */ React.createElement("h2", { className: "text-4xl font-black mb-3" }, t("escape_room.game_paused")), /* @__PURE__ */ React.createElement("p", { className: "text-xl text-slate-600" }, t("escape_room.waiting_resume")))), teamEscapeToast && /* @__PURE__ */ React.createElement("div", { className: "fixed bottom-6 left-1/2 -translate-x-1/2 z-[10002] animate-in slide-in-from-bottom duration-300" }, /* @__PURE__ */ React.createElement("div", { className: `flex items-center gap-3 px-6 py-4 rounded-2xl shadow-2xl border-2 ${teamColors[teamEscapeToast]?.border || "border-purple-500"} bg-slate-900` }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl" }, "\u{1F6AA}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-white font-bold" }, t("escape_room.team_escaped", { team: teamEscapeToast })), /* @__PURE__ */ React.createElement("p", { className: "text-slate-600 text-sm" }, t("escape_room.hurry_up"))))));
});
...
var TeacherLiveQuizControls = React.memo(({ sessionData, generatedContent, activeSessionCode, appId: appId2, onGenerateImage, onRefineImage, onCreateGroup, onAssignStudent, onSetGroupResource, onSetGroupLanguage, onSetGroupProfile, onDeleteGroup }) => {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-[11px] uppercase font-bold text-slate-600" }, t("groups.language_label") || "Quiz Language"), /* @__PURE__ */ React.createElement(
    "select",
    {
      "aria-label": t("common.selection"),
...
var LongitudinalProgressChart = React.memo(({ logs }) => {
  const { t } = useContext(LanguageContext);
  if (!logs || logs.length < 2) return /* @__PURE__ */ React.createElement("div", { className: "w-full bg-white p-6 rounded-xl border border-slate-200 shadow-sm mt-4 flex flex-col items-center justify-center text-slate-600 italic gap-2" }, /* @__PURE__ */ React.createElement(History, { size: 24, className: "opacity-50" }), /* @__PURE__ */ React.createElement("span", { className: "text-xs" }, t("dashboard.progress_chart.empty_msg")));
  const width = 600;
  const height = 200;
  const padding = 30;
...
var LearnerProgressView = React.memo(({
  ...
  ].map((item) => /* @__PURE__ */ React.createElement("div", { key: item.label, className: `${item.color} rounded-lg px-3 py-2 text-center` }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black" }, item.icon, " ", item.value), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold uppercase tracking-wider opacity-80" }, item.label))))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-slate-200 shadow-sm p-5 hover:shadow-md transition-shadow" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-slate-600 uppercase tracking-wider mb-3 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Target, { size: 14 }), " Skills Progress"), stats.wsTotal === 0 && Object.keys(phonemeMastery).length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "text-center py-6 text-slate-600 italic text-sm" }, /* @__PURE__ */ React.createElement(BookOpen, { size: 32, className: "mx-auto mb-2 opacity-40" }), "Start practicing to see your skills grow!") : /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, stats.wsTotal > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold text-slate-600" }, t("learner.ws_accuracy")), /* @__PURE__ */ React.createElement("span", { className: `text-sm font-black ${stats.wsAccuracy >= 80 ? "text-green-600" : stats.wsAccuracy >= 60 ? "text-yellow-600" : "text-orange-500"}` }, stats.wsAccuracy, "%")), /* @__PURE__ */ React.createElement("div", { className: "w-full bg-slate-100 rounded-full h-2.5" }, /* @__PURE__ */ React.createElement(
    "div",
    {
