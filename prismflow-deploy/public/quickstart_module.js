...
(function() {
  ...
  (function() {
    ...
    liveRegion.id = 'allo-live-quickstart';
...
var QuickStartWizard = React.memo(({ isOpen, onClose, onComplete, onUpload, onLookupStandards, onCallGemini, onWebSearch, addToast, isParentMode, isIndependentMode, isHelpMode, setIsHelpMode }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "bg-white w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-300 border border-slate-200 max-h-[90vh]" }, /* @__PURE__ */ React.createElement("div", { className: "bg-slate-50 px-8 py-6 border-b border-slate-100 flex justify-between items-center shrink-0" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-black text-slate-800 flex items-center gap-2" }, /* @__PURE__ */ React.createElement(Sparkles, { className: "text-yellow-500 fill-current", size: 20 }), " ", t("wizard.title")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-1 mt-2" }, [1, 2, 3, 4].map((s) => /* @__PURE__ */ React.createElement("div", { key: s, className: `h-1.5 w-5 rounded-full transition-colors ${step >= s ? "bg-indigo-600" : "bg-slate-200"}` })))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "flex-grow flex gap-2" }, /* @__PURE__ */ React.createElement(
      "input",
      {
      ...
      isSearching ? /* @__PURE__ */ React.createElement(RefreshCw, { size: 20, className: "animate-spin" }) : /* @__PURE__ */ React.createElement(Search, { size: 20 }),
      t("wizard.find_button")
    )))), suggestedStandards.length > 0 && /* @__PURE__ */ React.createElement("div", { ref: standardsListRef, className: "space-y-2 animate-in slide-in-from-top-2" }, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-bold text-slate-700" }, t("wizard.standards_selection_label")), /* @__PURE__ */ React.createElement("div", { className: "max-h-[200px] overflow-y-auto custom-scrollbar p-1 border border-slate-100 rounded-xl bg-slate-50/50" }, suggestedStandards.map((std, i) => {
      ...
      isFetching ? /* @__PURE__ */ React.createElement(RefreshCw, { size: 20, className: "animate-spin" }) : /* @__PURE__ */ React.createElement(Download, { size: 20 }),
      t("wizard.fetch_action")
    )), localData.fetchedContent && /* @__PURE__ */ React.createElement("div", { className: "bg-green-50 border border-green-200 rounded-xl p-5 animate-in fade-in slide-in-from-top-2 shadow-sm" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-green-800 font-bold mb-2" }, /* @__PURE__ */ React.createElement(CheckCircle, { size: 20, className: "fill-green-100 text-green-600" }), " ", t("wizard.content_loaded")), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-green-700 mb-4 line-clamp-3 opacity-80 bg-white/50 p-2 rounded border border-green-100" }, localData.fetchedContent.substring(0, 300), "..."), /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    )))), localData.fetchedContent && /* @__PURE__ */ React.createElement("div", { className: "bg-green-50 border border-green-200 rounded-xl p-5 animate-in fade-in slide-in-from-top-2 shadow-sm" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-green-800 font-bold mb-2" }, /* @__PURE__ */ React.createElement(CheckCircle, { size: 20, className: "fill-green-100 text-green-600" }), " ", t("wizard.content_loaded")), localData.resourceMeta && /* @__PURE__ */ React.createElement("div", { className: "mb-3 pb-3 border-b border-green-200/50" }, /* @__PURE__ */ React.createElement("h4", { className: "font-bold text-green-900 text-sm" }, localData.resourceMeta.title), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-green-700 italic" }, localData.resourceMeta.description)), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-green-700 mb-4 line-clamp-3 opacity-80 bg-white/50 p-2 rounded border border-green-100" }, localData.fetchedContent.substring(0, 300), "..."), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        "aria-label": t("common.continue"),
      ...
      /* @__PURE__ */ React.createElement("option", { value: "Informative" }, t("wizard.tones.informative")),
      /* @__PURE__ */ React.createElement("option", { value: "Narrative" }, t("wizard.tones.narrative")),
      ...
      /* @__PURE__ */ React.createElement("option", { value: "200" }, t("wizard.lengths.short")),
      /* @__PURE__ */ React.createElement("option", { value: "500" }, t("wizard.lengths.medium")),
    ...
    )))), !isParentMode && /* @__PURE__ */ React.createElement("div", { className: "bg-slate-50 p-2 rounded-lg border border-slate-200" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs text-slate-600 font-bold flex items-center gap-1" }, /* @__PURE__ */ React.createElement(CheckCircle, { size: 12, className: "text-green-600" }), " ", isIndependentMode ? t("wizard.learning_goals") : t("wizard.target_standard")), !isIndependentMode && /* @__PURE__ */ React.createElement("div", { className: "flex bg-white rounded-md border border-slate-200 p-0.5 shadow-sm" }, /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    )), suggestedStandards.length > 0 && /* @__PURE__ */ React.createElement("div", { ref: standardsListRef, className: "max-h-32 overflow-y-auto custom-scrollbar border border-slate-200 rounded bg-white divide-y divide-slate-100 shadow-inner" }, suggestedStandards.map((std, idx) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: idx,
        onClick: () => {
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 bg-purple-50 p-3 rounded-xl border border-purple-100" }, /* @__PURE__ */ React.createElement(
      "input",
      {
    ...
    ), /* @__PURE__ */ React.createElement("label", { htmlFor: "wiz-verify", className: "text-sm font-bold text-slate-700 cursor-pointer flex items-center gap-2" }, /* @__PURE__ */ React.createElement(ShieldCheck, { size: 16, className: "text-purple-500" }), " ", t("wizard.verify_facts"))), /* @__PURE__ */ React.createElement(
      "button",
      {
        "aria-label": t("common.continue"),
        onClick: () => setStep(4),
    ...
    )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-bold text-slate-600 mb-1" }, t("wizard.output_languages_label")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mb-2" }, /* @__PURE__ */ React.createElement(
      "input",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { "data-help-key": "wizard_lang_common_select", value: "" }, t("wizard.quick_add_language")),
      /* @__PURE__ */ React.createElement("option", { value: "Spanish" }, t("languages_list.Spanish")),
      /* @__PURE__ */ React.createElement("option", { value: "French" }, t("languages_list.French")),
      /* @__PURE__ */ React.createElement("option", { value: "German" }, t("languages_list.German")),
      /* @__PURE__ */ React.createElement("option", { value: "Portuguese" }, t("languages_list.Portuguese")),
      /* @__PURE__ */ React.createElement("option", { value: "Mandarin" }, t("languages_list.Mandarin")),
      /* @__PURE__ */ React.createElement("option", { value: "Arabic" }, t("languages_list.Arabic")),
      /* @__PURE__ */ React.createElement("option", { value: "Vietnamese" }, t("languages_list.Vietnamese")),
      /* @__PURE__ */ React.createElement("option", { value: "Russian" }, t("languages_list.Russian")),
      /* @__PURE__ */ React.createElement("option", { value: "Japanese" }, t("languages_list.Japanese"))
    ), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 min-h-[40px] bg-slate-50 p-2 rounded-xl border border-slate-100" }, localData.languages.map((lang) => /* @__PURE__ */ React.createElement("span", { key: lang, className: "inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold bg-indigo-100 text-indigo-700 border border-indigo-200 animate-in zoom-in" }, lang, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React.createElement(Plus, { size: 20 })
    )), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 min-h-[40px] bg-slate-50 p-2 rounded-xl border border-slate-100" }, localData.interests.map((interest) => /* @__PURE__ */ React.createElement("span", { key: interest, className: "inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold bg-indigo-100 text-indigo-700 border border-indigo-200 animate-in zoom-in" }, interest, /* @__PURE__ */ React.createElement(
      "button",
      {
        "aria-label": t("common.close"),
    ...
    ))))), step < 4 && /* @__PURE__ */ React.createElement("div", { className: "p-6 border-t border-slate-100 bg-slate-50 flex justify-between items-center shrink-0" }, step > 1 ? /* @__PURE__ */ React.createElement(
      "button",
      {
        "aria-label": t("common.continue"),
        onClick: () => setStep((s) => s - 1),
      ...
      " ",
      t("common.back")
    ) : /* @__PURE__ */ React.createElement("div", null), step === 1 && /* @__PURE__ */ React.createElement(
      "button",
      {
