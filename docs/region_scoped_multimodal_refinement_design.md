...
- **Value:** high (real differentiator). **Risk:** low now (deterministic, triple-gated, adversarially hardened). **NEXT:** the AI "where would a callout/list help?" proposal pass (accept/revert plan), more vetted transforms, profile-aware defaults.
