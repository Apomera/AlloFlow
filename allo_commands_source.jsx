...
function buildAlloCommands(ctx, opts = {}) {
  ...
  const cmds = [
    ...
    { id: 'open_block_suggestions', icon: '💡', roles: 'teacher', when: (c) => typeof c.openExportPreview === 'function', label: t('cmd.open_block_suggestions', 'Get document block suggestions'), aliases: ['block suggestions', 'suggest blocks', 'what should i add to this document', 'document suggestions'], hint: t('cmd.open_block_suggestions_hint', 'Open the Document Builder, where suggestions sit at the top'), run: (c) => { c.openExportPreview(); return t('cmd.open_block_suggestions_done', 'Document Builder opened. Block suggestions are in the highlighted panel near the top.'); } },
