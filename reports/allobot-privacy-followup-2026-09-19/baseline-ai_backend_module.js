...
function publicSearchQuery(value) {
  ...
  const topics = ['orbital period & seasons', 'weather fronts', 'main idea', 'photosynthesis', 'water cycle', 'plate tectonics', 'fractions',
  ...
  return topics.includes(q.toLowerCase()) ? q.toLowerCase() : '';
}
