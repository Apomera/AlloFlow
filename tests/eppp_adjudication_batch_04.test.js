...
describe('EPPP claim-level adjudication batch 04', () => {
  ...
  it('keeps deployment artifacts identical to source artifacts', () => {
    expect(read('desktop/web-app/public/test_prep/eppp_legacy/adjudication_batch_04.json')).toEqual(read('test_prep/eppp_legacy/adjudication_batch_04.json'));
    expect(fs.readFileSync(resolve(root, 'desktop/web-app/public/test_prep/eppp_legacy/adjudication_batch_04.md'), 'utf8')).toBe(fs.readFileSync(resolve(root, 'test_prep/eppp_legacy/adjudication_batch_04.md'), 'utf8'));
  });
});
