          ...
          return h('div', {
            ...
            subtool === 'freqDyn' && (function() {
              ...
              return h('div', { className: 'p-4 rounded-xl bg-white border border-violet-200 shadow-sm' },
                ...
                h('textarea', { value: iq.hypothesis || '', onChange: function(e) { setIQ({ hypothesis: e.target.value }); }, 'aria-label': t('stem.punnett.hypothesis_input', 'Allele frequency hypothesis'), placeholder: 'Hypothesis (free text — no right answer):',
                ...
                h('div', { className: 'p-3 rounded bg-emerald-50 border border-emerald-200' },
                  ...
                  iq.understood && h('textarea', { value: iq.explanation || '', onChange: function(e) { setIQ({ explanation: e.target.value }); }, 'aria-label': t('stem.punnett.explanation_input', 'Explain allele selection and mutation'), placeholder: 'Explain how selection, mutation, and frequency interact.',
