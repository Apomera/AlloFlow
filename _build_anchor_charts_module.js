...
window.__anchorChartExports = { AnchorChartView, AnchorChartSection, _reorderSections, _markerFor, _jitterFor, _iconPromptBiased, _slugify, MARKER_PALETTE, ANCHOR_CHART_TYPE_META, _chartTypeMeta, _layoutForChartType, _badgeForChartType };
`;
