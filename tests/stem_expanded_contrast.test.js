...
// Files that live ONLY in desktop/web-app/public/stem_lab/ with no stem_lab/ source.
// stem_tool_art.js and stem_tool_creative.js were removed 2026-08-23: both were
// pre-extraction fossils superseded by stem_tool_artstudio.js and
// stem_tool_datastudio.js, and neither was ever referenced from AlloFlowANTI.txt.
// stem_tool_watersafety.js is NOT a fossil — it is a complete Water Safety Lab that
// was never wired into stem_lab/ or the ANTI tool list, so it audits but never loads.
const desktopExclusiveFiles = ['stem_tool_watersafety.js'];
