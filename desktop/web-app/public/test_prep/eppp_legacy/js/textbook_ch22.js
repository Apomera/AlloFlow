...
window.TextbookChapters.push({
    ...
    sections: [
        ...
        },
        {
            ...
            content: '<p>Major neurocognitive disorders can have overlapping or mixed pathologies. The table summarizes common patterns, but diagnosis requires decline from prior function, interference with independence for major NCD, history/examination, and appropriate testing. Onset and course guide triage but do not diagnose etiology, and delirium may be superimposed on preexisting neurocognitive disorder:</p>' +
                '<table>' +
