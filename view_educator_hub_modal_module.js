...
function EducatorHubModal(props) {
  ...
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("polls-signups") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "dynamic-assessment", "data-hub-label": "Dynamic Assessment", "data-hub-section": "teach" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_dynamic_assessment_card", onClick: () => {
    setShowEducatorHub(false);
  ...
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("community-catalog") ? "\u2605" : "\u2606")), !hideSchoolProfessional && /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "professional-development", "data-hub-label": "Professional Development", "data-hub-section": "extend" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_professional_dev_card", onClick: () => {
    setShowEducatorHub(false);
    try {
