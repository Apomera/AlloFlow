    ...
    tool.render = function (ctx) {
      ...
      if (isSandbox && data.worldActive) additions.push(h('aside', {
        ...
        !collapsed && h('div', { className: 'gwe-builder-body' },
          h('p', { className: 'gwe-builder-intro' }, 'Aim at your creation and choose Select build. The outlined build stays selected while you look around.'),
