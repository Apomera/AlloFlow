...
- Name: document_builder_responsive_keyboard.spec.ts >> Backup search: preview, cancel, restore and undo at 1440
...
Call log:
  ...
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      ...
      - done scrolling
      - <button type="button" aria-pressed="false" id="builder-track-changes" aria-keyshortcuts="Control+Shift+E" title="Toggle Track Changes (Ctrl+Shift+E)" class="h-8 rounded px-2.5 text-[11px] font-bold shadow-sm border border-violet-500 bg-white text-violet-800 hover:bg-violet-50">Track Changes: Off</button> from <div class="builder-controls">…</div> subtree intercepts pointer events
...
- generic [ref=e1]:
  ...
  - dialog "Document Builder" [ref=e3]:
    ...
    - generic [ref=e18]:
      ...
      - generic [ref=e20]:
        - generic [ref=e21]:
          ...
          - tablist "Document Builder ribbon" [ref=e34]:
            ...
            - button "Collapse ribbon" [expanded] [ref=e41] [cursor=pointer]
        - generic [ref=e42]:
          - generic [ref=e43]:
            - generic [ref=e44]: Review
            - button "Close ribbon tools" [ref=e45] [cursor=pointer]: Close
          - tabpanel "Review" [ref=e46]:
            - generic [ref=e47]:
              - button "♿ A11y Inspect" [ref=e48] [cursor=pointer]
              - button "Run export preflight checks" [ref=e49] [cursor=pointer]: Preflight
            - button "Accessibility audit & results" [ref=e50] [cursor=pointer]
            - group "Review tools" [ref=e51]:
              - 'button "Track Changes: Off" [ref=e52] [cursor=pointer]'
              - button "Changes (0)" [ref=e53] [cursor=pointer]
              - generic [ref=e54]: Markup view
              - combobox "Markup view" [ref=e55]:
                - option "Simple Markup"
                - option "All Markup" [selected]
                - option "No Markup"
                - option "Original"
              - button "Accept" [disabled] [ref=e56]
              - button "Reject" [disabled] [ref=e57]
              - button "New Comment" [ref=e59] [cursor=pointer]
              - button "Comments (0)" [ref=e60] [cursor=pointer]
              - button "Word Count" [ref=e61] [cursor=pointer]
              - generic [ref=e62]: 7 words · 1 min reading time
              - generic [ref=e63]: Ctrl+Shift+E track · Ctrl+Alt+M comment · Ctrl+Alt+F footnote · Ctrl+Shift+G word count
            - group [ref=e64]:
              - generic "Find / Replace | Heading Outline (1) No matches | Ctrl+F / Ctrl+H" [ref=e65] [cursor=pointer]:
                - text: Find / Replace | Heading Outline (1)
                - generic [ref=e66]: No matches | Ctrl+F / Ctrl+H
            - group [ref=e67]:
              - generic "Version History (2) Stored on this device" [ref=e68] [cursor=pointer]
              - generic [ref=e69]:
                - generic [ref=e70]:
                  - generic [ref=e71]: Recent restore points stay on this device.
                  - generic [ref=e72]:
                    - button "Open HTML backup" [active] [ref=e73] [cursor=pointer]
                    - button "Download HTML backup" [ref=e74] [cursor=pointer]
                    - button "Save snapshot" [ref=e75] [cursor=pointer]
                - generic [ref=e76]:
                  - paragraph [ref=e77]: Your previous document was saved as a restore point.
                  - generic [ref=e78]:
                    - button "Undo backup restore" [ref=e79] [cursor=pointer]
                    - button "Download previous document" [ref=e80] [cursor=pointer]
                - generic [ref=e81]:
                  - generic [ref=e82]:
                    - generic [ref=e83]:
                      - generic [ref=e84]: Restored draft
                      - time [ref=e85]: 9/19/2026, 9:48:24 PM
                    - button "Compare" [ref=e86] [cursor=pointer]
                    - button "Restore" [ref=e87] [cursor=pointer]
                  - generic [ref=e88]:
                    - generic [ref=e89]:
                      - generic [ref=e90]: Auto-save
                      - time [ref=e91]: 9/19/2026, 9:48:23 PM
                    - button "Compare" [ref=e92] [cursor=pointer]
                    - button "Restore" [ref=e93] [cursor=pointer]
      - iframe [ref=e96]:
        - main [ref=f1e2]:
      ...
      - generic "Document status bar" [ref=e97]:
        - generic [ref=e98]:
          - generic [ref=e99]: Editing enabled
          - status [ref=e100]: Saved on this device · 09:48 PM
          - 'button "Track: Off · 0 changes" [ref=e102] [cursor=pointer]'
          - 'button "Words: 7" [ref=e104] [cursor=pointer]'
          - generic [ref=e105]: Page 1 of 2
          - group [ref=e106]:
            - generic "Details & shortcuts" [ref=e107] [cursor=pointer]
        - generic [ref=e108]:
          - combobox "Preview zoom mode" [ref=e109]:
            - option "Fit width" [selected]
            - option "Fit page"
            - option "Custom zoom"
          - generic "Editor zoom controls" [ref=e110]:
            - button "Zoom out" [ref=e111] [cursor=pointer]: −
            - slider "Editor zoom" [ref=e112]: "165"
            - button "Zoom in" [ref=e113] [cursor=pointer]: +
            - button "Reset editor zoom to 100 percent" [ref=e114] [cursor=pointer]: 165%
```
...
> 536 |     await frame.locator('#restored-editable').click(); await page.keyboard.press('End'); await page.keyboard.type(' Still editable.');
  ...
  541 |     if (!(await history.getAttribute('open'))) await history.locator('summary').click();
