...
| --- | ---: | ---: | ---: | --- |
| scripted-pipeline | 2/2 | 18021.564 | 19253.836 | unavailable |
...
- scripted-pipeline trial 2: [result](trials/scripted-pipeline/trial-02/result.json), [execution](trials/scripted-pipeline/trial-02/execution.json), [log](trials/scripted-pipeline/trial-02/stderr.log)
