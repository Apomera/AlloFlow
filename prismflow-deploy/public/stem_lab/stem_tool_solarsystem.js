          ...
          return React.createElement("div", { className: "max-w-4xl mx-auto animate-in fade-in duration-200" },
            ...
            React.createElement("div", { className: "flex items-center gap-3 mb-3" },
              ...
              React.createElement("button", {
                onClick: function() { upd('orreryMode', !d.orreryMode); },
                'aria-label': d.orreryMode ? 'Switch to 3D Explorer' : 'Switch to Orrery Lab',
            ...
            d.orreryMode ? (function() {
              var ORRERY_BODIES = [
                { id: 'mercury', name: 'Mercury', emoji: '\u2638', color: '#94a3b8', a_au: 0.387, ecc: 0.2056, period_yr: 0.241, incl_deg: 7.0, mass_earth: 0.055, radius_km: 2440, type: 'planet', desc: 'Smallest planet, extreme temperature swings' },
                { id: 'venus', name: 'Venus', emoji: '\u2640', color: '#fbbf24', a_au: 0.723, ecc: 0.0068, period_yr: 0.615, incl_deg: 3.4, mass_earth: 0.815, radius_km: 6052, type: 'planet', desc: 'Hottest planet, runaway greenhouse' },
                { id: 'earth', name: 'Earth', emoji: '\uD83C\uDF0D', color: '#3b82f6', a_au: 1.000, ecc: 0.0167, period_yr: 1.000, incl_deg: 0.0, mass_earth: 1.000, radius_km: 6371, type: 'planet', desc: 'Our home, liquid water, magnetic field' },
                { id: 'mars', name: 'Mars', emoji: '\uD83D\uDD34', color: '#ef4444', a_au: 1.524, ecc: 0.0934, period_yr: 1.881, incl_deg: 1.9, mass_earth: 0.107, radius_km: 3390, type: 'planet', desc: 'Red planet, Olympus Mons, polar ice caps' },
                { id: 'ceres', name: 'Ceres', emoji: '\u26AA', color: '#a1a1aa', a_au: 2.767, ecc: 0.0758, period_yr: 4.600, incl_deg: 10.6, mass_earth: 0.00016, radius_km: 473, type: 'dwarf', desc: 'Largest asteroid belt object' },
                { id: 'jupiter', name: 'Jupiter', emoji: '\uD83E\uDE90', color: '#f97316', a_au: 5.203, ecc: 0.0489, period_yr: 11.86, incl_deg: 1.3, mass_earth: 317.8, radius_km: 69911, type: 'planet', desc: 'Largest planet, Great Red Spot, 95 moons' },
                { id: 'saturn', name: 'Saturn', emoji: '\uD83E\uDE90', color: '#eab308', a_au: 9.537, ecc: 0.0565, period_yr: 29.46, incl_deg: 2.5, mass_earth: 95.16, radius_km: 58232, type: 'planet', desc: 'Iconic rings, hexagonal polar storm' },
                { id: 'uranus', name: 'Uranus', emoji: '\u26AA', color: '#67e8f9', a_au: 19.19, ecc: 0.0457, period_yr: 84.01, incl_deg: 0.8, mass_earth: 14.54, radius_km: 25362, type: 'planet', desc: 'Ice giant tilted 98 degrees, diamond rain' },
                { id: 'neptune', name: 'Neptune', emoji: '\uD83D\uDD35', color: '#6366f1', a_au: 30.07, ecc: 0.0113, period_yr: 164.8, incl_deg: 1.8, mass_earth: 17.15, radius_km: 24622, type: 'planet', desc: 'Windiest planet, 2100 km/h winds' },
                { id: 'pluto', name: 'Pluto', emoji: '\u2B50', color: '#a78bfa', a_au: 39.48, ecc: 0.2488, period_yr: 247.9, incl_deg: 17.2, mass_earth: 0.0022, radius_km: 1188, type: 'dwarf', desc: 'Heart-shaped glacier, crosses Neptune orbit' },
                { id: 'haumea', name: 'Haumea', emoji: '\uD83E\uDE78', color: '#e879f9', a_au: 43.13, ecc: 0.1912, period_yr: 283.3, incl_deg: 28.2, mass_earth: 0.00066, radius_km: 816, type: 'dwarf', desc: 'Egg-shaped, fastest rotation (3.9h)' },
                { id: 'makemake', name: 'Makemake', emoji: '\uD83D\uDFE4', color: '#fb923c', a_au: 45.79, ecc: 0.1559, period_yr: 309.9, incl_deg: 29.0, mass_earth: 0.00050, radius_km: 715, type: 'dwarf', desc: 'Reddish surface, extremely cold' },
                { id: 'eris', name: 'Eris', emoji: '\u26AB', color: '#d4d4d8', a_au: 67.67, ecc: 0.4407, period_yr: 557.0, incl_deg: 44.0, mass_earth: 0.0028, radius_km: 1163, type: 'dwarf', desc: 'Most massive dwarf planet' },
                { id: 'halley', name: "Halley's Comet", emoji: '\u2604', color: '#67e8f9', a_au: 17.83, ecc: 0.9671, period_yr: 75.3, incl_deg: 162.3, mass_earth: 0, radius_km: 5.5, type: 'comet', desc: 'Returns every ~75 years' },
                { id: 'encke', name: "Encke's Comet", emoji: '\u2604', color: '#86efac', a_au: 2.215, ecc: 0.8483, period_yr: 3.3, incl_deg: 11.8, mass_earth: 0, radius_km: 2.4, type: 'comet', desc: 'Shortest period comet' },
                { id: 'sedna', name: 'Sedna', emoji: '\uD83D\uDD3A', color: '#f87171', a_au: 506.0, ecc: 0.8496, period_yr: 11400, incl_deg: 11.9, mass_earth: 0.00015, radius_km: 500, type: 'dwarf', desc: 'Extreme orbit, reddest solar system object' }
              ];
              ...
              var setBodyOverride = function(bodyId, param, val) {
                var ov = Object.assign({}, bodyOverrides);
                ov[bodyId] = Object.assign({}, ov[bodyId] || {}); ov[bodyId][param] = val;
                upd('bodyOverrides', ov);
              };
              ...
              return React.createElement("div", { className: "space-y-3" },
                ...
                React.createElement("div", { className: "flex flex-wrap gap-1 p-1.5 rounded-xl " + (isDark ? 'bg-slate-800' : 'bg-gradient-to-r from-indigo-50 to-purple-50') },
                  [
                    ...
                    { id: 'challenges', label: '\uD83E\uDDE0 Challenges', desc: 'Calculation practice' }
                  ].map(function(tab) {
                    var active = orreryTab === tab.id;
                    return React.createElement("button", {
                      key: tab.id,
                      onClick: function() {
                        upd('orreryTab', tab.id);
                        if (tab.id.indexOf('kepler') === 0) {
                          var seen = (d.orreryKeplerSeen || []).slice();
                          if (seen.indexOf(tab.id) === -1) { seen.push(tab.id); upd('orreryKeplerSeen', seen); }
                        }
                      },
                      'aria-label': tab.desc,
                ...
                orreryTab === 'fullOrrery' && React.createElement("div", { className: "space-y-3" },
                  React.createElement("div", { className: "flex flex-wrap items-center gap-2" },
                    ...
                    [{ type: 'planet', label: 'Planets', emoji: '\uD83C\uDF0D' }, { type: 'dwarf', label: 'Dwarf Planets', emoji: '\u26AA' }, { type: 'comet', label: 'Comets', emoji: '\u2604' }].map(function(f) {
                      ...
                      return React.createElement("button", { key: f.type, onClick: function() { var vt = Object.assign({}, visibleTypes); vt[f.type] = !vt[f.type]; upd('orreryVisibleTypes', vt); }, className: "px-2 py-0.5 rounded text-[10px] font-bold transition-all " + (on ? 'bg-indigo-600 text-white' : (isDark ? 'bg-slate-700 text-slate-500' : 'bg-slate-200 text-slate-400')) }, f.emoji + ' ' + f.label);
                    }),
                    React.createElement("div", { className: "ml-auto flex items-center gap-2" },
                      React.createElement("button", { onClick: function() { upd('orreryPaused', !orreryPaused); }, className: "px-2 py-0.5 rounded text-[10px] font-bold " + (orreryPaused ? 'bg-emerald-600 text-white' : 'bg-slate-200 text-slate-600') }, orreryPaused ? '\u25B6 Play' : '\u23F8 Pause'),
                      React.createElement("input", { type: 'range', min: 0.1, max: 50, step: 0.1, value: orrerySpeed, 'aria-label': 'Orrery speed', onChange: function(e) { upd('orrerySpeed', parseFloat(e.target.value)); }, className: "w-20 h-1.5 accent-purple-500" }),
                  ...
                  React.createElement("div", { className: "relative rounded-xl overflow-hidden border-2 " + (isDark ? 'border-indigo-900' : 'border-indigo-800/50') + " shadow-lg" },
                    React.createElement("canvas", {
                      ...
                      'aria-label': 'Top-down orrery showing all planetary orbits with real eccentricities',
                      tabIndex: 0, width: 800, height: 800,
                      style: { width: '100%', height: 'auto', display: 'block', cursor: 'grab' },
                      ref: function(cv) {
                        if (!cv || cv._orreryInit) return;
                        cv._orreryInit = true;
                        var oCtx = cv.getContext('2d'), oW = 800, oH = 800, tick = 0;
                        var viewZoom = 1.0, viewPanX = 0, viewPanY = 0;
                        var isDrag = false, dragSX = 0, dragSY = 0, panSX = 0, panSY = 0;
                        cv._orreryZoomMode = 'inner';
                        var bodyAngles = {};
                        ORRERY_BODIES.forEach(function(b) { bodyAngles[b.id] = Math.random() * Math.PI * 2; });
                        var hoveredBody = null, mouseX = 0, mouseY = 0;
                        function auToPx(au) { var m = cv._orreryZoomMode || 'inner'; var s = m === 'inner' ? 180 : m === 'outer' ? 5.5 : 12; return au * s * viewZoom; }
                        function w2s(wx, wy) { return { x: oW / 2 + (wx + viewPanX) * viewZoom, y: oH / 2 + (wy + viewPanY) * viewZoom }; }
                        cv.addEventListener('pointerdown', function(e) { isDrag = true; dragSX = e.offsetX; dragSY = e.offsetY; panSX = viewPanX; panSY = viewPanY; cv.style.cursor = 'grabbing'; });
                        cv.addEventListener('pointermove', function(e) {
                          mouseX = e.offsetX; mouseY = e.offsetY;
                          if (isDrag) { viewPanX = panSX + (e.offsetX - dragSX) / viewZoom; viewPanY = panSY + (e.offsetY - dragSY) / viewZoom; }
                          hoveredBody = null;
                          var rect = cv.getBoundingClientRect(), sc = oW / rect.width, mx = e.offsetX * sc, my = e.offsetY * sc;
                          ORRERY_BODIES.forEach(function(b) {
                            if (visibleTypes[b.type] === false) return;
                            var ecc = getBodyParam(b.id, 'ecc'), a_au = getBodyParam(b.id, 'a_au');
                            var a = auToPx(a_au), fo = a * ecc, angle = bodyAngles[b.id] || 0;
                            var r = a * (1 - ecc * ecc) / (1 + ecc * Math.cos(angle));
                            var s = w2s((r * Math.cos(angle) - fo) / viewZoom, r * Math.sin(angle) / viewZoom);
                            if (Math.sqrt((mx - s.x) * (mx - s.x) + (my - s.y) * (my - s.y)) < 12) hoveredBody = b;
                          });
                          cv.style.cursor = hoveredBody ? 'pointer' : (isDrag ? 'grabbing' : 'grab');
                        });
                        cv.addEventListener('pointerup', function() { isDrag = false; cv.style.cursor = hoveredBody ? 'pointer' : 'grab'; });
                        cv.addEventListener('click', function() { if (hoveredBody) upd('orrerySelected', hoveredBody.id); });
                        cv.addEventListener('wheel', function(e) { e.preventDefault(); viewZoom = Math.max(0.15, Math.min(8, viewZoom * (e.deltaY > 0 ? 0.9 : 1.1))); }, { passive: false });

                        function drawOrrery() {
                          tick++;
                          oCtx.clearRect(0, 0, oW, oH);
                          var paused = cv.dataset.paused === 'true', speed = parseFloat(cv.dataset.speed || '1');
                          // Background
                          oCtx.fillStyle = '#060818'; oCtx.fillRect(0, 0, oW, oH);
                          for (var si = 0; si < 120; si++) { oCtx.fillStyle = 'rgba(255,255,255,' + (0.05 + 0.12 * Math.sin(tick * 0.015 + si * 0.7)) + ')'; oCtx.fillRect((si * 127 + 31) % oW, (si * 191 + 47) % oH, 1, 1); }
                          // Sun
                          var sunS = w2s(0, 0), sunR = Math.max(4, 8 * viewZoom);
                          var sunGlow = oCtx.createRadialGradient(sunS.x, sunS.y, 0, sunS.x, sunS.y, sunR * 4);
                          sunGlow.addColorStop(0, 'rgba(255,220,50,0.3)'); sunGlow.addColorStop(1, 'rgba(255,150,0,0)');
                          oCtx.fillStyle = sunGlow; oCtx.fillRect(sunS.x - sunR * 4, sunS.y - sunR * 4, sunR * 8, sunR * 8);
                          var sG = oCtx.createRadialGradient(sunS.x, sunS.y, 0, sunS.x, sunS.y, sunR);
                          sG.addColorStop(0, '#fff'); sG.addColorStop(0.3, '#ffe066'); sG.addColorStop(1, '#f59e0b');
                          oCtx.beginPath(); oCtx.arc(sunS.x, sunS.y, sunR, 0, Math.PI * 2); oCtx.fillStyle = sG; oCtx.fill();
                          // Asteroid belt
                          oCtx.save(); oCtx.globalAlpha = 0.06;
                          for (var ai = 0; ai < 200; ai++) { var aAng = ai * 0.0314 + tick * 0.0001, aR2 = auToPx(2.1 + (ai * 17 % 100) / 100 * 1.2); var as2 = w2s(Math.cos(aAng) * aR2 / viewZoom, Math.sin(aAng) * aR2 / viewZoom); oCtx.fillStyle = '#94a3b8'; oCtx.fillRect(as2.x, as2.y, 1, 1); }
                          oCtx.restore();
                          // Bodies
                          ORRERY_BODIES.forEach(function(b) {
                            if (visibleTypes[b.type] === false) return;
                            var ecc = getBodyParam(b.id, 'ecc'), a_au = getBodyParam(b.id, 'a_au'), period = getBodyParam(b.id, 'period_yr');
                            var a = auToPx(a_au), bAx = a * Math.sqrt(1 - ecc * ecc), fo = a * ecc;
                            var cs = w2s(-fo / viewZoom, 0);
                            // Orbit ellipse
                            oCtx.beginPath(); oCtx.ellipse(cs.x, cs.y, a, bAx, 0, 0, Math.PI * 2);
                            var isSel = orrerySelected === b.id;
                            oCtx.strokeStyle = isSel ? b.color : (b.type === 'comet' ? 'rgba(103,232,249,0.15)' : b.type === 'dwarf' ? 'rgba(167,139,250,0.15)' : 'rgba(148,163,184,0.2)');
                            oCtx.lineWidth = isSel ? 1.5 : 0.6;
                            if (b.type === 'comet') { oCtx.save(); oCtx.setLineDash([4, 4]); }
                            oCtx.stroke();
                            if (b.type === 'comet') { oCtx.setLineDash([]); oCtx.restore(); }
                            // Kepler equation
                            if (!paused) { bodyAngles[b.id] = (bodyAngles[b.id] || 0) + (period > 0 ? 0.008 * speed / period : 0.008); }
                            var M = bodyAngles[b.id] || 0, E = M;
                            ...
                            var r = a * (1 - ecc * ecc) / (1 + ecc * Math.cos(ta));
                            var bSc = w2s((r * Math.cos(ta) - fo) / viewZoom, r * Math.sin(ta) / viewZoom);
                            var bSize = b.type === 'planet' ? Math.max(3, Math.min(7, Math.log(b.radius_km / 500 + 1) * 2.5)) : b.type === 'comet' ? 2 : 2.5;
                            if (isSel) bSize += 2;
                            // Comet tail
                            if (b.type === 'comet') { var tLen = Math.max(8, 30 / (r / a + 0.3)), tAng = Math.atan2(r * Math.sin(ta) / viewZoom, (r * Math.cos(ta) - fo) / viewZoom); oCtx.save(); oCtx.globalAlpha = 0.3; oCtx.beginPath(); oCtx.moveTo(bSc.x, bSc.y); oCtx.lineTo(bSc.x + Math.cos(tAng) * tLen, bSc.y + Math.sin(tAng) * tLen); oCtx.strokeStyle = b.color; oCtx.lineWidth = 2; oCtx.stroke(); oCtx.restore(); }
                            // Dot
                            oCtx.beginPath(); oCtx.arc(bSc.x, bSc.y, bSize, 0, Math.PI * 2);
                            var bG = oCtx.createRadialGradient(bSc.x - 1, bSc.y - 1, 0, bSc.x, bSc.y, bSize);
                            bG.addColorStop(0, '#fff'); bG.addColorStop(1, b.color); oCtx.fillStyle = bG; oCtx.fill();
                            if (isSel) { oCtx.strokeStyle = '#fff'; oCtx.lineWidth = 1; oCtx.stroke(); }
                            // Saturn rings
                            if (b.id === 'saturn' && bSize > 3) { oCtx.save(); oCtx.globalAlpha = 0.5; oCtx.beginPath(); oCtx.ellipse(bSc.x, bSc.y, bSize * 2, bSize * 0.6, 0, 0, Math.PI * 2); oCtx.strokeStyle = '#eab308'; oCtx.lineWidth = 1.2; oCtx.stroke(); oCtx.restore(); }
                            // Label
                          ...
                          oCtx.fillText('View: ' + (zm === 'inner' ? 'Inner' : zm === 'outer' ? 'Outer' : 'Full') + '  Zoom: ' + viewZoom.toFixed(1) + 'x', oW - 12, 18);
                          cv._orreryAnim = requestAnimationFrame(drawOrrery);
                        }
                        cv.dataset.paused = String(orreryPaused); cv.dataset.speed = String(orrerySpeed);
                        drawOrrery();
                      }
                    }),
                    (function() { var cv = document.querySelector('[data-orrery-canvas]'); if (cv) { cv.dataset.paused = String(orreryPaused); cv.dataset.speed = String(orrerySpeed); cv._orreryZoomMode = d.orreryZoomMode || 'inner'; } return null; })()
                  ),
                  // Zoom mode selector
                  React.createElement("div", { className: "flex items-center gap-2 justify-center" },
                    ['inner', 'full', 'outer'].map(function(mode) {
                      ...
                      return React.createElement("button", { key: mode, onClick: function() { upd('orreryZoomMode', mode); var cv = document.querySelector('[data-orrery-canvas]'); if (cv) cv._orreryZoomMode = mode; }, className: "px-2.5 py-1 rounded-lg text-[10px] font-bold transition-all " + ((d.orreryZoomMode || 'inner') === mode ? 'bg-indigo-600 text-white' : (isDark ? 'bg-slate-700 text-slate-400' : 'bg-slate-100 text-slate-500 hover:bg-slate-200')) }, labels[mode]);
                    })
                  ),
                  // Selected body info
                  selBody && React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-r from-indigo-50 to-purple-50 border-indigo-200') + " rounded-xl p-4 border space-y-3" },
                    React.createElement("div", { className: "flex items-center justify-between" },
                      ...
                      React.createElement("button", { onClick: function() { upd('orrerySelected', null); }, className: "p-1 hover:bg-slate-200 rounded" }, React.createElement(X, { size: 14, className: "text-slate-400" }))
                    ),
                    ...
                    React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-2" },
                      [
                        ...
                        { label: 'Period', value: selBody.period_yr < 1 ? (selBody.period_yr * 365.25).toFixed(0) + ' d' : selBody.period_yr.toFixed(1) + ' yr', icon: '\u23F1' },
                        ...
                        return React.createElement("div", { key: st.label, className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 text-center border " + (isDark ? 'border-slate-600' : 'border-indigo-100') },
                          React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, st.icon + ' ' + st.label),
                          React.createElement("div", { className: "text-xs font-bold " + (isDark ? 'text-white' : 'text-slate-800') + " mt-0.5" }, st.value)
                        );
                      })
                    ),
                    React.createElement("div", { className: (isDark ? 'bg-slate-900' : 'bg-white') + " rounded-lg p-3 border " + (isDark ? 'border-slate-700' : 'border-indigo-100') },
                      ...
                      React.createElement("div", { className: "grid grid-cols-2 gap-x-4 gap-y-1 text-[10px] font-mono " + (isDark ? 'text-slate-300' : 'text-slate-600') },
                        React.createElement("span", null, "v\u209A = " + (29.78 * Math.sqrt((1 + selBody.ecc) / ((1 - selBody.ecc) * selBody.a_au))).toFixed(1) + " km/s"),
                        React.createElement("span", null, "v\u2090 = " + (29.78 * Math.sqrt((1 - selBody.ecc) / ((1 + selBody.ecc) * selBody.a_au))).toFixed(1) + " km/s"),
                        React.createElement("span", null, "v\u2091\u209B\u209C = " + (29.78 * Math.sqrt(2 / selBody.a_au)).toFixed(1) + " km/s"),
                        React.createElement("span", null, "\u03B5 = " + (-66.25 / selBody.a_au).toFixed(2) + " km\u00B2/s\u00B2")
                      )
                    )
                  )
                ),

                // ══ TAB 2: KEPLER I — Ellipses ══
                orreryTab === 'keplerI' && React.createElement("div", { className: "space-y-3" },
                  React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-purple-50 border-purple-200') + " rounded-xl p-3 border" },
                    ...
                    React.createElement("p", { className: "text-[11px] " + (isDark ? 'text-slate-300' : 'text-slate-600') }, "Every planet moves in an ellipse with the Sun at one focus. e=0 is a circle; e\u21921 is extremely elongated.")
                  ),
                  React.createElement("div", { className: "flex items-center gap-2" },
                    React.createElement("span", { className: "text-[10px] font-bold w-24 " + (isDark ? 'text-slate-400' : 'text-purple-600') }, "Eccentricity:"),
                    React.createElement("input", { type: "range", min: 0, max: 0.98, step: 0.005, value: d._k1Ecc !== undefined ? d._k1Ecc : 0.5, 'aria-label': 'Eccentricity', onChange: function(e) { upd('_k1Ecc', parseFloat(e.target.value)); }, className: "flex-1 h-1.5 accent-purple-500" }),
                    React.createElement("span", { className: "text-[10px] font-mono w-10 " + (isDark ? 'text-purple-300' : 'text-purple-700') }, (d._k1Ecc !== undefined ? d._k1Ecc : 0.5).toFixed(3))
                  ),
                  React.createElement("div", { className: "flex flex-wrap gap-1" },
                    [{ label: 'Circle (e=0)', ecc: 0 }, { label: '\uD83C\uDF0D Earth (0.017)', ecc: 0.017 }, { label: '\u2638 Mercury (0.206)', ecc: 0.206 }, { label: '\u2B50 Pluto (0.249)', ecc: 0.249 }, { label: '\u2604 Halley (0.967)', ecc: 0.967 }].map(function(p) {
                      return React.createElement("button", { key: p.label, onClick: function() { upd('_k1Ecc', p.ecc); }, className: "px-2 py-0.5 rounded text-[10px] font-bold " + (isDark ? 'bg-slate-700 text-slate-300' : 'bg-white text-slate-600 border border-slate-200') }, p.label);
                    })
                  ),
                  React.createElement("canvas", {
                    'data-kepler1-canvas': true, 'aria-label': "Kepler's First Law visualization",
                    width: 600, height: 420, style: { width: '100%', height: 'auto', display: 'block', background: '#0f172a', borderRadius: '12px' },
                    ref: function(cv) {
                      if (!cv || cv._k1Init) return; cv._k1Init = true;
                      var c = cv.getContext('2d'), W = 600, H = 420, t = 0;
                      function draw() {
                        t++;
                        c.clearRect(0, 0, W, H); c.fillStyle = '#0f172a'; c.fillRect(0, 0, W, H);
                        for (var s = 0; s < 40; s++) { c.fillStyle = 'rgba(255,255,255,' + (0.06 + 0.1 * Math.sin(t * 0.02 + s)) + ')'; c.fillRect((s * 137 + 11) % W, (s * 199 + 3) % H, 1, 1); }
                        var ecc = parseFloat(cv.dataset.ecc || '0.5'), sA = 130, sB = sA * Math.sqrt(1 - ecc * ecc), fO = sA * ecc;
                        var cx = W * 0.5, cy = H * 0.42, sx = cx + fO, ex = cx - fO;
                        // Orbit
                        c.beginPath(); c.ellipse(cx, cy, sA, sB, 0, 0, Math.PI * 2); c.strokeStyle = 'rgba(168,85,247,0.4)'; c.lineWidth = 1.5; c.stroke();
                        // Axes
                        c.save(); c.globalAlpha = 0.2; c.setLineDash([4, 4]);
                        c.beginPath(); c.moveTo(cx - sA, cy); c.lineTo(cx + sA, cy); c.strokeStyle = '#a78bfa'; c.lineWidth = 1; c.stroke();
                        c.beginPath(); c.moveTo(cx, cy - sB); c.lineTo(cx, cy + sB); c.strokeStyle = '#60a5fa'; c.stroke(); c.setLineDash([]); c.restore();
                        // Planet
                        var M = t * 0.012, E2 = M;
                        ...
                        var r = sA * (1 - ecc * ecc) / (1 + ecc * Math.cos(ta));
                        var px = sx + r * Math.cos(ta + Math.PI), py = cy + r * Math.sin(ta + Math.PI);
                        // Distance lines r1+r2=2a
                        var r1 = Math.sqrt((px - sx) * (px - sx) + (py - cy) * (py - cy));
                        var r2 = Math.sqrt((px - ex) * (px - ex) + (py - cy) * (py - cy));
                        c.save(); c.globalAlpha = 0.35; c.setLineDash([3, 3]);
                        c.beginPath(); c.moveTo(sx, cy); c.lineTo(px, py); c.strokeStyle = '#fbbf24'; c.lineWidth = 1; c.stroke();
                        c.beginPath(); c.moveTo(ex, cy); c.lineTo(px, py); c.strokeStyle = '#f472b6'; c.stroke(); c.setLineDash([]); c.restore();
                        c.font = '7px monospace'; c.textAlign = 'center';
                        c.fillStyle = '#fbbf2490'; c.fillText('r\u2081=' + r1.toFixed(0), (sx + px) / 2 + 12, (cy + py) / 2 - 5);
                        c.fillStyle = '#f472b690'; c.fillText('r\u2082=' + r2.toFixed(0), (ex + px) / 2 - 12, (cy + py) / 2 - 5);
                        // Proof
                        c.font = 'bold 10px monospace'; c.fillStyle = '#22c55e'; c.textAlign = 'center';
                        c.fillText('r\u2081 + r\u2082 = ' + (r1 + r2).toFixed(0) + ' = 2a = ' + (sA * 2) + '  \u2713', cx, H - 30);
                        // Sun
                        var sG = c.createRadialGradient(sx, cy, 0, sx, cy, 8);
                        sG.addColorStop(0, '#fff'); sG.addColorStop(1, '#f59e0b');
                        c.beginPath(); c.arc(sx, cy, 8, 0, Math.PI * 2); c.fillStyle = sG; c.fill();
                        c.font = 'bold 8px Inter,sans-serif'; c.fillStyle = '#fbbf24'; c.fillText('\u2609 F\u2081', sx, cy + 18);
                        // Empty focus
                        c.save(); c.globalAlpha = 0.3; c.beginPath(); c.arc(ex, cy, 4, 0, Math.PI * 2); c.strokeStyle = '#f472b6'; c.lineWidth = 1; c.stroke();
                        c.font = '8px Inter,sans-serif'; c.fillStyle = '#f472b6'; c.fillText('F\u2082', ex, cy + 14); c.restore();
                        // Planet dot
                        c.beginPath(); c.arc(px, py, 5, 0, Math.PI * 2); var pG = c.createRadialGradient(px - 1, py - 1, 0, px, py, 5); pG.addColorStop(0, '#fff'); pG.addColorStop(1, '#a78bfa'); c.fillStyle = pG; c.fill();
                        // Labels
                        c.font = 'bold 8px Inter,sans-serif'; c.fillStyle = '#22c55e'; c.fillText('Perihelion', cx + sA, cy - 12);
                        c.fillStyle = '#ef4444'; c.fillText('Aphelion', cx - sA, cy - 12);
                        // Equation
                        c.fillStyle = 'rgba(15,23,42,0.7)'; c.fillRect(0, H - 55, W, 25);
                        c.font = '11px monospace'; c.fillStyle = '#e2e8f0'; c.textAlign = 'center';
                        c.fillText('r(\u03b8) = a(1 \u2212 e\u00B2) / (1 + e\u00B7cos\u03b8)    b = a\u221A(1\u2212e\u00B2)    c = ae', W / 2, H - 40);
                        // Title
                        c.font = 'bold 11px Inter,sans-serif'; c.fillStyle = 'rgba(255,255,255,0.7)'; c.textAlign = 'center';
                        c.fillText("Kepler\u2019s 1st Law: Planets orbit in ellipses with the Sun at one focus", W / 2, 16);
                        cv._k1Anim = requestAnimationFrame(draw);
                      }
                      cv.dataset.ecc = String(d._k1Ecc !== undefined ? d._k1Ecc : 0.5); draw();
                    }
                  }),
                  (function() { var cv = document.querySelector('[data-kepler1-canvas]'); if (cv) cv.dataset.ecc = String(d._k1Ecc !== undefined ? d._k1Ecc : 0.5); return null; })()
                ),

                // ══ TAB 3: KEPLER II — Equal Areas ══
                orreryTab === 'keplerII' && React.createElement("div", { className: "space-y-3" },
                  React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-emerald-50 border-emerald-200') + " rounded-xl p-3 border" },
                    ...
                    React.createElement("p", { className: "text-[11px] " + (isDark ? 'text-slate-300' : 'text-slate-600') }, "A line from Sun to planet sweeps equal areas in equal times. Planets move faster at perihelion, slower at aphelion. This is conservation of angular momentum: L = mr\u00B2\u03C9.")
                  ),
                  React.createElement("div", { className: "flex items-center gap-2" },
                    React.createElement("span", { className: "text-[10px] font-bold w-24 " + (isDark ? 'text-slate-400' : 'text-emerald-600') }, "Eccentricity:"),
                    React.createElement("input", { type: "range", min: 0.01, max: 0.95, step: 0.01, value: d._k2Ecc || 0.6, 'aria-label': 'Eccentricity', onChange: function(e) { upd('_k2Ecc', parseFloat(e.target.value)); }, className: "flex-1 h-1.5 accent-emerald-500" }),
                    React.createElement("span", { className: "text-[10px] font-mono " + (isDark ? 'text-emerald-300' : 'text-emerald-700') }, (d._k2Ecc || 0.6).toFixed(2))
                  ),
                  React.createElement("div", { className: "flex items-center gap-2" },
                    React.createElement("span", { className: "text-[10px] font-bold w-24 " + (isDark ? 'text-slate-400' : 'text-emerald-600') }, "Sectors:"),
                    React.createElement("input", { type: "range", min: 4, max: 16, step: 1, value: d._k2Sectors || 8, 'aria-label': 'Sectors', onChange: function(e) { upd('_k2Sectors', parseInt(e.target.value)); }, className: "flex-1 h-1.5 accent-emerald-500" }),
                    React.createElement("span", { className: "text-[10px] font-mono " + (isDark ? 'text-emerald-300' : 'text-emerald-700') }, (d._k2Sectors || 8) + ' sectors')
                  ),
                  React.createElement("canvas", {
                    'data-kepler2-canvas': true, 'aria-label': "Kepler's Second Law: equal area sectors",
                    width: 600, height: 420, style: { width: '100%', height: 'auto', display: 'block', background: '#0f172a', borderRadius: '12px' },
                    ref: function(cv) {
                      if (!cv || cv._k2Init) return; cv._k2Init = true;
                      var c = cv.getContext('2d'), W = 600, H = 420, t = 0;
                      var sColors = ['#22c55e', '#3b82f6', '#f59e0b', '#ef4444', '#a78bfa', '#ec4899', '#06b6d4', '#84cc16', '#f97316', '#6366f1', '#14b8a6', '#e879f9', '#fb7185', '#facc15', '#38bdf8', '#a3e635'];
                      function draw() {
                        t++;
                        c.clearRect(0, 0, W, H); c.fillStyle = '#0f172a'; c.fillRect(0, 0, W, H);
                        for (var s = 0; s < 40; s++) { c.fillStyle = 'rgba(255,255,255,' + (0.06 + 0.1 * Math.sin(t * 0.02 + s)) + ')'; c.fillRect((s * 137 + 11) % W, (s * 199 + 3) % H, 1, 1); }
                        var ecc = parseFloat(cv.dataset.ecc || '0.6'), nS = parseInt(cv.dataset.sectors || '8');
                        var sA = 140, sB = sA * Math.sqrt(1 - ecc * ecc), fO = sA * ecc;
                        var cx = W * 0.5, cy = H * 0.4, sx = cx + fO;
                        c.beginPath(); c.ellipse(cx, cy, sA, sB, 0, 0, Math.PI * 2); c.strokeStyle = 'rgba(255,255,255,0.15)'; c.lineWidth = 1; c.stroke();
                        // Equal-time sectors
                        for (var si = 0; si < nS; si++) {
                          var M1 = si * 2 * Math.PI / nS, M2 = (si + 1) * 2 * Math.PI / nS;
                          c.save(); c.globalAlpha = 0.18; c.beginPath(); c.moveTo(sx, cy);
                          for (var st = 0; st <= 25; st++) {
                            var Mi = M1 + st / 25 * (M2 - M1), Ei = Mi;
                            for (var n = 0; n < 5; n++) { Ei = Ei - (Ei - ecc * Math.sin(Ei) - Mi) / (1 - ecc * Math.cos(Ei)); }
                            var tai = 2 * Math.atan2(Math.sqrt(1 + ecc) * Math.sin(Ei / 2), Math.sqrt(1 - ecc) * Math.cos(Ei / 2));
                            var ri = sA * (1 - ecc * ecc) / (1 + ecc * Math.cos(tai));
                            c.lineTo(sx + ri * Math.cos(tai + Math.PI), cy + ri * Math.sin(tai + Math.PI));
                          }
                          c.closePath(); c.fillStyle = sColors[si % sColors.length]; c.fill(); c.restore();
                        }
                        // Animated planet
                        var M = t * 0.012, E = M;
                        for (var ni = 0; ni < 5; ni++) { E = E - (E - ecc * Math.sin(E) - M) / (1 - ecc * Math.cos(E)); }
                        ...
                        var px = sx + r * Math.cos(ta + Math.PI), py = cy + r * Math.sin(ta + Math.PI);
                        // Sweep line
                        c.save(); c.globalAlpha = 0.4; c.beginPath(); c.moveTo(sx, cy); c.lineTo(px, py); c.strokeStyle = '#fbbf24'; c.lineWidth = 1; c.stroke(); c.restore();
                        // Velocity
                        var spd = Math.sqrt(2 / r - 1 / sA) * 30, vA = ta + Math.PI + Math.PI / 2;
                        c.beginPath(); c.moveTo(px, py); c.lineTo(px + Math.cos(vA) * spd, py + Math.sin(vA) * spd); c.strokeStyle = '#fbbf24'; c.lineWidth = 1.5; c.stroke();
                        // Sun
                        var sGr = c.createRadialGradient(sx, cy, 0, sx, cy, 8); sGr.addColorStop(0, '#fff'); sGr.addColorStop(1, '#f59e0b');
                        c.beginPath(); c.arc(sx, cy, 8, 0, Math.PI * 2); c.fillStyle = sGr; c.fill();
                        // Planet
                        c.beginPath(); c.arc(px, py, 5, 0, Math.PI * 2); var pG = c.createRadialGradient(px - 1, py - 1, 0, px, py, 5); pG.addColorStop(0, '#fff'); pG.addColorStop(1, '#22c55e'); c.fillStyle = pG; c.fill();
                        // Equations
                        c.font = 'bold 9px Inter,sans-serif'; c.fillStyle = '#22c55e'; c.textAlign = 'left';
                        c.fillText('dA/dt = \u00BD r\u00B2 d\u03b8/dt = L/(2m) = constant', 12, H - 12);
                        c.font = '8px monospace'; c.fillStyle = 'rgba(255,255,255,0.3)'; c.textAlign = 'right';
                        c.fillText('L = mr\u00B2\u03C9  |  v\u209A/v\u2090 = (1+e)/(1\u2212e)', W - 12, H - 12);
                        c.font = 'bold 11px Inter,sans-serif'; c.fillStyle = 'rgba(255,255,255,0.7)'; c.textAlign = 'center';
                        c.fillText("Kepler\u2019s 2nd Law: Equal areas swept in equal time intervals", W / 2, 16);
                        c.font = '8px Inter,sans-serif'; c.fillStyle = 'rgba(255,255,255,0.3)';
                        c.fillText(nS + ' equal-time sectors \u2014 all colored areas are the same size', W / 2, 28);
                        cv._k2Anim = requestAnimationFrame(draw);
                      }
                      cv.dataset.ecc = String(d._k2Ecc || 0.6); cv.dataset.sectors = String(d._k2Sectors || 8); draw();
                    }
                  }),
                  (function() { var cv = document.querySelector('[data-kepler2-canvas]'); if (cv) { cv.dataset.ecc = String(d._k2Ecc || 0.6); cv.dataset.sectors = String(d._k2Sectors || 8); } return null; })()
                ),

                // ══ TAB 4: KEPLER III — T\u00B2 \u221D a\u00B3 ══
                orreryTab === 'keplerIII' && React.createElement("div", { className: "space-y-3" },
                  React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-amber-50 border-amber-200') + " rounded-xl p-3 border" },
                    ...
                    React.createElement("p", { className: "text-[11px] " + (isDark ? 'text-slate-300' : 'text-slate-600') }, "T\u00B2 = (4\u03C0\u00B2/GM)\u00B7a\u00B3. For solar system bodies, T\u00B2/a\u00B3 = 1 (years/AU). A log-log plot of T vs a gives slope 3/2.")
                  ),
                  React.createElement("canvas", {
                    'data-kepler3-canvas': true, 'aria-label': "Kepler's Third Law: T-squared vs a-cubed scatter plot",
                    width: 640, height: 420, style: { width: '100%', height: 'auto', display: 'block', background: '#0f172a', borderRadius: '12px' },
                    ref: function(cv) {
                      if (!cv || cv._k3Init) return; cv._k3Init = true;
                      var c = cv.getContext('2d'), W = 640, H = 420;
                      function draw() {
                        c.clearRect(0, 0, W, H); c.fillStyle = '#0f172a'; c.fillRect(0, 0, W, H);
                        var pL = 65, pR = W - 25, pT = 45, pB = H - 60, pW = pR - pL, pH = pB - pT;
                        c.fillStyle = 'rgba(15,23,42,0.5)'; c.fillRect(pL, pT, pW, pH);
                        c.strokeStyle = 'rgba(255,255,255,0.1)'; c.lineWidth = 0.5; c.strokeRect(pL, pT, pW, pH);
                        var minA = -0.5, maxA = 2.0, minT = -0.7, maxT = 3.2;
                        // Grid
                        c.save(); c.globalAlpha = 0.08;
                        for (var gx = 0; gx <= 10; gx++) { c.beginPath(); c.moveTo(pL + gx * pW / 10, pT); c.lineTo(pL + gx * pW / 10, pB); c.strokeStyle = '#fff'; c.stroke(); }
                        for (var gy = 0; gy <= 8; gy++) { c.beginPath(); c.moveTo(pL, pT + gy * pH / 8); c.lineTo(pR, pT + gy * pH / 8); c.stroke(); }
                        c.restore();
                        // Axis labels
                        c.font = '9px Inter,sans-serif'; c.fillStyle = 'rgba(255,255,255,0.5)'; c.textAlign = 'center';
                        c.fillText('log\u2081\u2080(a / AU)', (pL + pR) / 2, pB + 18);
                        c.save(); c.translate(15, (pT + pB) / 2); c.rotate(-Math.PI / 2); c.fillText('log\u2081\u2080(T / yr)', 0, 0); c.restore();
                        // T=a^(3/2) line
                        c.save(); c.globalAlpha = 0.3; c.beginPath();
                        for (var li = 0; li <= pW; li++) { var lA = minA + li / pW * (maxA - minA); var lT = 1.5 * lA; var ly = pB - (lT - minT) / (maxT - minT) * pH; if (ly < pT - 10 || ly > pB + 10) continue; if (li === 0) c.moveTo(pL + li, ly); else c.lineTo(pL + li, ly); }
                        c.strokeStyle = '#fbbf24'; c.lineWidth = 2; c.stroke(); c.restore();
                        c.font = 'bold 8px Inter,sans-serif'; c.fillStyle = '#fbbf24'; c.textAlign = 'left'; c.fillText('T = a^(3/2)', pL + pW * 0.65, pT + 15);
                        // Plot bodies
                        ORRERY_BODIES.forEach(function(b) {
                          if (b.period_yr <= 0 || b.a_au <= 0) return;
                          var lA = Math.log10(b.a_au), lT = Math.log10(b.period_yr);
                          var bx = pL + (lA - minA) / (maxA - minA) * pW, by = pB - (lT - minT) / (maxT - minT) * pH;
                          if (bx < pL - 5 || bx > pR + 5 || by < pT - 5 || by > pB + 5) return;
                          var dr = b.type === 'planet' ? 5 : 3.5;
                          c.save(); c.globalAlpha = 0.2; c.beginPath(); c.arc(bx, by, dr + 4, 0, Math.PI * 2); c.fillStyle = b.color; c.fill(); c.restore();
                          c.beginPath(); c.arc(bx, by, dr, 0, Math.PI * 2);
                          var dG = c.createRadialGradient(bx - 1, by - 1, 0, bx, by, dr); dG.addColorStop(0, '#fff'); dG.addColorStop(1, b.color); c.fillStyle = dG; c.fill();
                          c.font = '7px Inter,sans-serif'; c.fillStyle = 'rgba(255,255,255,0.6)'; c.textAlign = 'left'; c.fillText(b.emoji + ' ' + b.name, bx + dr + 3, by + 3);
                        });
                        // T\u00B2/a\u00B3 ratios
                        c.fillStyle = 'rgba(15,23,42,0.7)'; c.fillRect(0, pB + 25, W, 30);
                        c.font = 'bold 8px Inter,sans-serif'; c.fillStyle = '#f59e0b'; c.textAlign = 'left'; c.fillText('T\u00B2/a\u00B3 ratios:', 12, pB + 37);
                        var planets = ORRERY_BODIES.filter(function(b) { return b.type === 'planet'; });
                        var cW = (W - 100) / planets.length;
                        planets.forEach(function(p, i) { var ratio = (p.period_yr * p.period_yr) / (p.a_au * p.a_au * p.a_au); c.font = '7px monospace'; c.fillStyle = Math.abs(ratio - 1) < 0.05 ? '#22c55e' : '#fbbf24'; c.fillText(p.emoji + ratio.toFixed(3), 100 + i * cW, pB + 37); });
                        c.font = 'bold 11px Inter,sans-serif'; c.fillStyle = 'rgba(255,255,255,0.7)'; c.textAlign = 'center';
                        c.fillText("Kepler\u2019s 3rd Law: T\u00B2 = a\u00B3 (period\u00B2 \u221D distance\u00B3)", W / 2, 16);
                        c.font = '8px Inter,sans-serif'; c.fillStyle = 'rgba(255,255,255,0.3)';
                        c.fillText('All bodies fall on the same line \u2014 log(T) vs log(a) has slope 3/2', W / 2, 28);
                      }
                      draw();
                    }
                  }),
                  ...
                  React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-amber-100') + " rounded-xl p-3 border overflow-x-auto" },
                    React.createElement("table", { className: "w-full text-[10px] " + (isDark ? 'text-slate-300' : 'text-slate-600') },
                      React.createElement("thead", null, React.createElement("tr", { className: "text-left border-b " + (isDark ? 'border-slate-600' : 'border-amber-200') },
                        ['Body', 'a (AU)', 'T (yr)', 'T\u00B2', 'a\u00B3', 'T\u00B2/a\u00B3'].map(function(h) { return React.createElement("th", { key: h, className: "py-1 px-2 font-bold " + (isDark ? 'text-amber-300' : 'text-amber-700') }, h); })
                      )),
                      React.createElement("tbody", null,
                        ORRERY_BODIES.filter(function(b) { return b.type === 'planet'; }).map(function(b) {
                          var T2 = b.period_yr * b.period_yr, a3 = b.a_au * b.a_au * b.a_au, ratio = T2 / a3;
                          return React.createElement("tr", { key: b.id, className: "border-b " + (isDark ? 'border-slate-700' : 'border-slate-100') },
                            ...
                            React.createElement("td", { className: "py-1 px-2 font-mono font-bold " + (Math.abs(ratio - 1) < 0.05 ? 'text-emerald-500' : 'text-amber-500') }, ratio.toFixed(4))
                          );
                        })
                      )
                    )
                ...
                orreryTab === 'workshop' && React.createElement("div", { className: "space-y-3" },
                  React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-rose-50 border-rose-200') + " rounded-xl p-3 border" },
                    ...
                    React.createElement("p", { className: "text-[11px] " + (isDark ? 'text-slate-300' : 'text-slate-600') }, "What if Earth had Mercury\u2019s eccentricity? Modify any body\u2019s orbital parameters and see derived quantities update in real time.")
                  ),
                  React.createElement("button", { onClick: function() { upd('bodyOverrides', {}); }, className: "px-3 py-1 rounded-lg text-[10px] font-bold bg-rose-500 text-white hover:bg-rose-600" }, "\u21BA Reset All"),
                  React.createElement("div", { className: "flex flex-wrap gap-1" },
                    ORRERY_BODIES.filter(function(b) { return b.type === 'planet' || b.type === 'dwarf'; }).map(function(b) {
                      var isActive = (d._workshopBody || 'earth') === b.id;
                      var hasOv = bodyOverrides[b.id] && Object.keys(bodyOverrides[b.id]).length > 0;
                      return React.createElement("button", { key: b.id, onClick: function() { upd('_workshopBody', b.id); }, className: "px-2 py-1 rounded text-[10px] font-bold transition-all " + (isActive ? 'bg-rose-600 text-white shadow-md' : hasOv ? 'bg-amber-100 text-amber-700 border border-amber-300' : (isDark ? 'bg-slate-700 text-slate-400' : 'bg-white text-slate-500 border border-slate-200')) }, b.emoji + ' ' + b.name + (hasOv ? ' \u2022' : ''));
                    })
                  ),
                  (function() {
                    ...
                    if (!wb) return null;
                    var cE = getBodyParam(wbId, 'ecc'), cA = getBodyParam(wbId, 'a_au'), cI = getBodyParam(wbId, 'incl_deg');
                    var nP = Math.pow(cA, 1.5), peri = cA * (1 - cE), aph = cA * (1 + cE);
                    var vP = 29.78 * Math.sqrt((1 + cE) / ((1 - cE) * cA)), vAp = 29.78 * Math.sqrt((1 - cE) / ((1 + cE) * cA));
                    return React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-rose-100') + " rounded-xl p-3 border space-y-3" },
                      ...
                      React.createElement("div", { className: "flex items-center gap-2" },
                        ...
                        React.createElement("input", { type: "range", min: 0, max: 0.95, step: 0.001, value: cE, 'aria-label': 'Eccentricity', onChange: function(e) { setBodyOverride(wbId, 'ecc', parseFloat(e.target.value)); }, className: "flex-1 h-1.5 accent-rose-500" }),
                        React.createElement("span", { className: "text-[10px] font-mono w-12 text-right " + (isDark ? 'text-rose-300' : 'text-rose-700') }, cE.toFixed(4)),
                        React.createElement("span", { className: "text-[10px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, '(real: ' + wb.ecc.toFixed(4) + ')')
                      ),
                      React.createElement("div", { className: "flex items-center gap-2" },
                        React.createElement("span", { className: "text-[10px] font-bold w-32 " + (isDark ? 'text-slate-400' : 'text-rose-600') }, "Semi-major (AU):"),
                        React.createElement("input", { type: "range", min: 0.1, max: 80, step: 0.01, value: cA, 'aria-label': 'Semi-major axis', onChange: function(e) { setBodyOverride(wbId, 'a_au', parseFloat(e.target.value)); }, className: "flex-1 h-1.5 accent-amber-500" }),
                        React.createElement("span", { className: "text-[10px] font-mono w-12 text-right " + (isDark ? 'text-amber-300' : 'text-amber-700') }, cA.toFixed(3)),
                      ...
                      React.createElement("div", { className: "flex flex-wrap gap-1" },
                        ...
                        [{ label: 'Circular', fn: function() { setBodyOverride(wbId, 'ecc', 0); } }, { label: "Mercury's e", fn: function() { setBodyOverride(wbId, 'ecc', 0.2056); } }, { label: "Halley's e", fn: function() { setBodyOverride(wbId, 'ecc', 0.967); } }, { label: 'At 1 AU', fn: function() { setBodyOverride(wbId, 'a_au', 1.0); } }, { label: '2x distance', fn: function() { setBodyOverride(wbId, 'a_au', wb.a_au * 2); } }].map(function(p) {
                          return React.createElement("button", { key: p.label, onClick: p.fn, className: "px-2 py-0.5 rounded text-[10px] font-bold " + (isDark ? 'bg-slate-700 text-slate-300' : 'bg-rose-50 text-rose-600 border border-rose-200') }, p.label);
                        })
                      ),
                      React.createElement("div", { className: (isDark ? 'bg-slate-900 border-slate-700' : 'bg-rose-50 border-rose-100') + " rounded-lg p-2.5 border" },
                        React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-rose-300' : 'text-rose-600') + " mb-1.5" }, "\uD83D\uDCCA Derived Quantities:"),
                        React.createElement("div", { className: "grid grid-cols-2 gap-x-4 gap-y-1 text-[10px] font-mono " + (isDark ? 'text-slate-300' : 'text-slate-600') },
                          React.createElement("span", null, "Period T = " + nP.toFixed(2) + " yr"),
                          React.createElement("span", null, "Perihelion = " + peri.toFixed(3) + " AU"),
                          React.createElement("span", null, "Aphelion = " + aph.toFixed(3) + " AU"),
                          React.createElement("span", null, "v\u209A = " + vP.toFixed(1) + " km/s"),
                          React.createElement("span", null, "v\u2090 = " + vAp.toFixed(1) + " km/s"),
                          React.createElement("span", null, "T\u00B2/a\u00B3 = " + (nP * nP / (cA * cA * cA)).toFixed(4))
                        )
                      ),
                      React.createElement("div", { className: "text-[10px] font-bold text-center py-1.5 rounded-lg " + (peri >= 0.75 && aph <= 1.8 ? 'bg-green-100 text-green-700' : peri < 0.75 ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700') },
                        peri >= 0.75 && aph <= 1.8 ? '\u2600 Habitable zone! Liquid water possible.' : peri < 0.75 ? '\uD83D\uDD25 Too close at perihelion!' : '\u2744 Too far \u2014 frozen world.')
                    );
                  })()
                ),

                // ══ TAB 6: HOHMANN TRANSFERS ══
                orreryTab === 'transfers' && React.createElement("div", { className: "space-y-3" },
                  React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-cyan-50 border-cyan-200') + " rounded-xl p-3 border" },
                    ...
                    React.createElement("p", { className: "text-[11px] " + (isDark ? 'text-slate-300' : 'text-slate-600') }, "Most fuel-efficient transfer between circular orbits: two burns, an elliptical coast phase. This is how real spacecraft navigate between planets.")
                  ),
                  React.createElement("div", { className: "grid grid-cols-2 gap-3" },
                    React.createElement("div", null,
                      ...
                      React.createElement("div", { className: "flex flex-wrap gap-1" },
                        ORRERY_BODIES.filter(function(b) { return b.type === 'planet'; }).map(function(b) {
                          return React.createElement("button", { key: b.id, onClick: function() { upd('_transferOrigin', b.id); }, className: "px-1.5 py-0.5 rounded text-[10px] font-bold " + ((d._transferOrigin || 'earth') === b.id ? 'bg-cyan-600 text-white' : (isDark ? 'bg-slate-700 text-slate-400' : 'bg-white text-slate-500 border border-slate-200')) }, b.emoji);
                        })
                      )
                    ),
                    React.createElement("div", null,
                      ...
                      React.createElement("div", { className: "flex flex-wrap gap-1" },
                        ORRERY_BODIES.filter(function(b) { return b.type === 'planet'; }).map(function(b) {
                          return React.createElement("button", { key: b.id, onClick: function() { upd('_transferDest', b.id); }, className: "px-1.5 py-0.5 rounded text-[10px] font-bold " + ((d._transferDest || 'mars') === b.id ? 'bg-orange-600 text-white' : (isDark ? 'bg-slate-700 text-slate-400' : 'bg-white text-slate-500 border border-slate-200')) }, b.emoji);
                        })
                      )
                    )
                  ),
                  React.createElement("canvas", {
                    'data-transfer-canvas': true, 'aria-label': 'Hohmann transfer orbit visualization',
                    width: 600, height: 460, style: { width: '100%', height: 'auto', display: 'block', background: '#0f172a', borderRadius: '12px' },
                    ref: function(cv) {
                      if (!cv || cv._trInit) return; cv._trInit = true;
                      var c = cv.getContext('2d'), W = 600, H = 460, t = 0;
                      function draw() {
                        t++;
                        c.clearRect(0, 0, W, H); c.fillStyle = '#0f172a'; c.fillRect(0, 0, W, H);
                        for (var s = 0; s < 40; s++) { c.fillStyle = 'rgba(255,255,255,' + (0.05 + 0.08 * Math.sin(t * 0.015 + s)) + ')'; c.fillRect((s * 137 + 11) % W, (s * 199 + 3) % H, 1, 1); }
                        var oId = cv.dataset.origin || 'earth', dId = cv.dataset.dest || 'mars';
                        var ob = ORRERY_BODIES.find(function(b) { return b.id === oId; }) || ORRERY_BODIES[2];
                        var db = ORRERY_BODIES.find(function(b) { return b.id === dId; }) || ORRERY_BODIES[3];
                        var r1 = ob.a_au, r2 = db.a_au, out = r2 > r1;
                        var aT = (r1 + r2) / 2, tDays = Math.pow(aT, 1.5) * 0.5 * 365.25;
                        var vC1 = 29.78 / Math.sqrt(r1), vC2 = 29.78 / Math.sqrt(r2);
                        var vT1 = 29.78 * Math.sqrt(2 / r1 - 1 / aT), vT2 = 29.78 * Math.sqrt(Math.max(0.01, 2 / r2 - 1 / aT));
                        var dv1 = Math.abs(vT1 - vC1), dv2 = Math.abs(vC2 - vT2), dvT = dv1 + dv2;
                        var maxR = Math.max(r1, r2), scale = (Math.min(W, H) * 0.3) / maxR;
                        var cx = W * 0.45, cy = H * 0.38;
                        // Origin orbit
                        c.beginPath(); c.arc(cx, cy, r1 * scale, 0, Math.PI * 2); c.strokeStyle = ob.color; c.lineWidth = 1.2; c.globalAlpha = 0.4; c.stroke(); c.globalAlpha = 1;
                        // Dest orbit
                        c.beginPath(); c.arc(cx, cy, r2 * scale, 0, Math.PI * 2); c.strokeStyle = db.color; c.lineWidth = 1.2; c.globalAlpha = 0.4; c.stroke(); c.globalAlpha = 1;
                        // Transfer ellipse (half)
                        var eT = Math.abs(r2 - r1) / (r1 + r2), aTpx = aT * scale, bTpx = aTpx * Math.sqrt(1 - eT * eT);
                        c.save(); c.beginPath();
                        c.ellipse(cx + (out ? 1 : -1) * (aT - r1) * scale, cy, aTpx, bTpx, 0, out ? Math.PI : 0, out ? 0 : Math.PI, !out);
                        c.strokeStyle = '#fbbf24'; c.lineWidth = 2; c.setLineDash([6, 4]); c.stroke(); c.setLineDash([]); c.restore();
                        // Animated ship
                        var ph = (t * 0.005) % 1, scAng = out ? (Math.PI - ph * Math.PI) : (ph * Math.PI);
                        var scR = aTpx * (1 - eT * eT) / (1 + eT * Math.cos(scAng - (out ? 0 : Math.PI)));
                        var scX = cx + (out ? -1 : 1) * (aT - r1) * scale + scR * Math.cos(scAng);
                        var scY = cy + scR * Math.sin(scAng);
                        c.beginPath(); c.arc(scX, scY, 3, 0, Math.PI * 2); c.fillStyle = '#fbbf24'; c.fill();
                        c.font = '10px sans-serif'; c.fillText('\uD83D\uDE80', scX - 5, scY - 6);
                        // Sun
                        var sG = c.createRadialGradient(cx, cy, 0, cx, cy, 10); sG.addColorStop(0, '#fff'); sG.addColorStop(1, '#f59e0b');
                        c.beginPath(); c.arc(cx, cy, 10, 0, Math.PI * 2); c.fillStyle = sG; c.fill();
                        // Origin planet
                        var op = { x: cx - r1 * scale, y: cy }; c.beginPath(); c.arc(op.x, op.y, 5, 0, Math.PI * 2); c.fillStyle = ob.color; c.fill();
                        c.font = '8px Inter,sans-serif'; c.fillStyle = ob.color; c.textAlign = 'center'; c.fillText(ob.emoji + ' ' + ob.name, op.x, op.y - 10);
                        // Dest planet
                        var dp = { x: cx + r2 * scale, y: cy }; c.beginPath(); c.arc(dp.x, dp.y, 5, 0, Math.PI * 2); c.fillStyle = db.color; c.fill();
                        c.fillStyle = db.color; c.fillText(db.emoji + ' ' + db.name, dp.x, dp.y - 10);
                        // Burns
                        c.font = 'bold 8px Inter,sans-serif'; c.fillStyle = '#ef4444'; c.textAlign = 'left'; c.fillText('\u0394v\u2081=' + dv1.toFixed(2) + ' km/s', op.x + 10, op.y + 15);
                        c.fillStyle = '#22c55e'; c.textAlign = 'right'; c.fillText('\u0394v\u2082=' + dv2.toFixed(2) + ' km/s', dp.x - 10, dp.y + 15);
                        // Info
                        var iY = H - 110; c.fillStyle = 'rgba(15,23,42,0.8)'; c.fillRect(0, iY, W, H - iY);
                        c.font = 'bold 10px Inter,sans-serif'; c.fillStyle = '#67e8f9'; c.textAlign = 'left'; c.fillText('Hohmann: ' + ob.name + ' \u2192 ' + db.name, 15, iY + 16);
                        c.font = '9px monospace'; c.fillStyle = '#e2e8f0';
                        var lines = [
                          'a\u209C = (r\u2081+r\u2082)/2 = ' + aT.toFixed(3) + ' AU    Transit: ' + tDays.toFixed(0) + ' days',
                          '\u0394v\u2081 = |v\u209C\u2081 \u2212 v\u2091\u2081| = |' + vT1.toFixed(2) + ' \u2212 ' + vC1.toFixed(2) + '| = ' + dv1.toFixed(2) + ' km/s',
                          '\u0394v\u2082 = |v\u2091\u2082 \u2212 v\u209C\u2082| = |' + vC2.toFixed(2) + ' \u2212 ' + vT2.toFixed(2) + '| = ' + dv2.toFixed(2) + ' km/s',
                          'Total \u0394v = ' + dvT.toFixed(2) + ' km/s'
                        ];
                        for (var li = 0; li < lines.length; li++) c.fillText(lines[li], 15, iY + 32 + li * 14);
                        c.font = '8px monospace'; c.fillStyle = 'rgba(255,255,255,0.3)'; c.textAlign = 'right';
                        c.fillText('v = \u221A[GM(2/r \u2212 1/a)]  (vis-viva)', W - 15, iY + 32);
                        c.font = 'bold 11px Inter,sans-serif'; c.fillStyle = 'rgba(255,255,255,0.7)'; c.textAlign = 'center'; c.fillText('Hohmann Transfer Orbit', W / 2, 16);
                        cv._trAnim = requestAnimationFrame(draw);
                      }
                      cv.dataset.origin = d._transferOrigin || 'earth'; cv.dataset.dest = d._transferDest || 'mars'; draw();
                    }
                  }),
                  (function() { var cv = document.querySelector('[data-transfer-canvas]'); if (cv) { cv.dataset.origin = d._transferOrigin || 'earth'; cv.dataset.dest = d._transferDest || 'mars'; } return null; })(),
                  // Delta-v table
                  React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-cyan-100') + " rounded-xl p-3 border" },
                    React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-cyan-300' : 'text-cyan-600') + " mb-2" }, "\u0394v Budget from Earth:"),
                    React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-2" },
                      ORRERY_BODIES.filter(function(b) { return b.type === 'planet' && b.id !== 'earth'; }).map(function(b) {
                        var aT = (1.0 + b.a_au) / 2, vT1 = 29.78 * Math.sqrt(2 - 1 / aT), dv = Math.abs(vT1 - 29.78) + Math.abs(29.78 / Math.sqrt(b.a_au) - 29.78 * Math.sqrt(Math.max(0.01, 2 / b.a_au - 1 / aT)));
                        return React.createElement("div", { key: b.id, className: (isDark ? 'bg-slate-700' : 'bg-cyan-50') + " rounded-lg p-2 text-center border " + (isDark ? 'border-slate-600' : 'border-cyan-100') },
                          ...
                          React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, Math.round(Math.pow(aT, 1.5) * 0.5 * 365.25) + ' days')
                        );
                      })
                    )
                  )
                ...
                // ══ TAB 7: CALCULATION CHALLENGES ══
                orreryTab === 'challenges' && (function() {
                  // Grade-adaptive problem bank covering orbital mechanics
                  var grade = gradeLevel || 'middle school';
                  var isElem = grade === 'K-2' || grade === '3-5' || grade === 'elementary';
                  var isAdvanced = grade === 'College' || grade === '9-12' || grade === 'high school';

                  // Current challenge state
                  var chalIdx = d._chalIdx || 0;
                  var chalAnswered = d._chalAnswered || {};
                  var chalScore = d._chalScore || 0;
                  var chalShowHint = d._chalShowHint || false;
                  var chalShowWork = d._chalShowWork || false;

                  // ── PROBLEM BANK ──
                  // Each problem: question, hints (scaffolded), answer (number), unit, tolerance, explanation, law, difficulty (1-3)
                  var PROBLEMS = [
                    // === KEPLER'S THIRD LAW CALCULATIONS ===
                    {
                      id: 'k3_mars_period', law: 'III', difficulty: 1,
                      question: "Mars orbits at a = 1.524 AU from the Sun. Using Kepler's Third Law (T\u00B2 = a\u00B3), calculate Mars's orbital period in Earth years.",
                      hints: [
                        'Step 1: Write down Kepler\'s Third Law: T\u00B2 = a\u00B3',
                        'Step 2: Plug in a = 1.524: T\u00B2 = (1.524)\u00B3',
                        'Step 3: Calculate (1.524)\u00B3 = 1.524 \u00D7 1.524 \u00D7 1.524 = 3.540',
                        'Step 4: T = \u221A3.540'
                      ],
                      answer: 1.881, unit: 'years', tolerance: 0.05,
                      explanation: 'T\u00B2 = a\u00B3 = (1.524)\u00B3 = 3.540, so T = \u221A3.540 = 1.881 years (687 days). The real value is 1.881 years \u2014 Kepler nailed it!',
                      visual: 'mars'
                    },
                    {
                      id: 'k3_jupiter_period', law: 'III', difficulty: 1,
                      question: "Jupiter orbits at a = 5.203 AU. What is its orbital period? (T\u00B2 = a\u00B3)",
                      hints: [
                        'T\u00B2 = a\u00B3 = (5.203)\u00B3',
                        'Calculate: 5.203 \u00D7 5.203 = 27.07, then \u00D7 5.203 = 140.8',
                        'T\u00B2 = 140.8, so T = \u221A140.8'
                      ],
                      answer: 11.86, unit: 'years', tolerance: 0.15,
                      explanation: 'T\u00B2 = (5.203)\u00B3 = 140.8, so T = \u221A140.8 = 11.86 years. Jupiter takes nearly 12 Earth years to orbit the Sun once!',
                      visual: 'jupiter'
                    },
                    {
                      id: 'k3_find_distance', law: 'III', difficulty: 2,
                      question: "A newly discovered asteroid has an orbital period of 8.0 years. How far from the Sun does it orbit? (Solve for a in T\u00B2 = a\u00B3)",
                      hints: [
                        'Rearrange: a\u00B3 = T\u00B2, so a = T^(2/3)',
                        'T\u00B2 = 8.0\u00B2 = 64',
                        'a = \u00B3\u221A64 = 64^(1/3)',
                        'Think: what number cubed gives 64? 4\u00B3 = 64!'
                      ],
                      answer: 4.0, unit: 'AU', tolerance: 0.1,
                      explanation: 'a\u00B3 = T\u00B2 = 64, so a = \u00B3\u221A64 = 4.0 AU. This asteroid orbits between Mars and Jupiter, right in the asteroid belt!',
                      visual: 'ceres'
                    },
                    {
                      id: 'k3_verify_earth', law: 'III', difficulty: 1,
                      question: "Verify Kepler's Third Law for Earth: a = 1.000 AU, T = 1.000 year. What is T\u00B2/a\u00B3?",
                      hints: [
                        'T\u00B2 = 1.000\u00B2 = 1.000',
                        'a\u00B3 = 1.000\u00B3 = 1.000',
                        'Divide: T\u00B2/a\u00B3 = ?'
                      ],
                      answer: 1.000, unit: '(dimensionless)', tolerance: 0.01,
                      explanation: 'T\u00B2/a\u00B3 = 1.000/1.000 = 1.000 exactly. This is why we use years and AU \u2014 Earth defines the ratio as exactly 1! Every planet in our solar system has T\u00B2/a\u00B3 \u2248 1.000.',
                      visual: 'earth'
                    },
                    {
                      id: 'k3_saturn_verify', law: 'III', difficulty: 2,
                      question: "Saturn: a = 9.537 AU, T = 29.46 years. Compute T\u00B2/a\u00B3 to verify Kepler's Third Law. (Should be \u22481.0)",
                      hints: [
                        'T\u00B2 = (29.46)\u00B2 = 867.9',
                        'a\u00B3 = (9.537)\u00B3 = 9.537 \u00D7 9.537 \u00D7 9.537',
                        'a\u00B3 = 90.95 \u00D7 9.537 = 867.5',
                        'T\u00B2/a\u00B3 = 867.9/867.5 = ?'
                      ],
                      answer: 1.000, unit: '(ratio)', tolerance: 0.01,
                      explanation: 'T\u00B2 = 867.9, a\u00B3 = 867.5, ratio = 1.0005 \u2248 1.000. Kepler\'s law holds perfectly even for distant Saturn! The tiny deviation is from rounding.',
                      visual: 'saturn'
                    },

                    // === ORBITAL VELOCITY ===
                    {
                      id: 'vel_earth_circular', law: 'velocity', difficulty: 1,
                      question: "Earth's mean orbital velocity is v = 29.78/\u221Aa km/s for circular orbits (a in AU). What is Earth's orbital speed at a = 1 AU?",
                      hints: [
                        'v = 29.78 / \u221Aa',
                        'At a = 1 AU: v = 29.78 / \u221A1',
                        '\u221A1 = 1'
                      ],
                      answer: 29.78, unit: 'km/s', tolerance: 0.5,
                      explanation: 'v = 29.78/\u221A1 = 29.78 km/s. Earth zips around the Sun at nearly 30 km/s \u2014 that\'s 107,000 km/h or about 67,000 mph!',
                      visual: 'earth'
                    },
                    {
                      id: 'vel_mercury', law: 'velocity', difficulty: 1,
                      question: "Mercury orbits at a = 0.387 AU. What is its circular orbital speed? (v = 29.78/\u221Aa km/s)",
                      hints: [
                        'v = 29.78 / \u221A(0.387)',
                        '\u221A(0.387) = 0.622',
                        'v = 29.78 / 0.622'
                      ],
                      answer: 47.87, unit: 'km/s', tolerance: 1.0,
                      explanation: 'v = 29.78/\u221A0.387 = 29.78/0.622 = 47.9 km/s. Mercury is the fastest planet because it\'s closest to the Sun \u2014 this follows directly from Kepler\'s laws!',
                      visual: 'mercury'
                    },
                    {
                      id: 'vel_neptune', law: 'velocity', difficulty: 1,
                      question: "Neptune orbits at a = 30.07 AU. How fast does it move? (v = 29.78/\u221Aa km/s)",
                      hints: [
                        'v = 29.78 / \u221A(30.07)',
                        '\u221A(30.07) \u2248 5.48',
                        'v = 29.78 / 5.48'
                      ],
                      answer: 5.43, unit: 'km/s', tolerance: 0.2,
                      explanation: 'v = 29.78/\u221A30.07 = 5.43 km/s. Neptune crawls compared to Mercury (47.9 km/s)! Farther planets orbit more slowly \u2014 that\'s why Neptune takes 165 years for one orbit.',
                      visual: 'neptune'
                    },

                    // === PERIHELION / APHELION ===
                    {
                      id: 'peri_mars', law: 'I', difficulty: 1,
                      question: "Mars has a = 1.524 AU and e = 0.0934. What is its perihelion distance? (r\u2098\u2097\u2099 = a(1\u2212e))",
                      hints: [
                        'Formula: r\u2098\u2097\u2099 = a \u00D7 (1 \u2212 e)',
                        'r\u2098\u2097\u2099 = 1.524 \u00D7 (1 \u2212 0.0934)',
                        '1 \u2212 0.0934 = 0.9066',
                      ...
                      answer: 1.382, unit: 'AU', tolerance: 0.02,
                      explanation: 'r\u2098\u2097\u2099 = 1.524 \u00D7 (1 \u2212 0.0934) = 1.524 \u00D7 0.9066 = 1.382 AU. At closest approach Mars is 1.382 AU from the Sun. Its aphelion is a(1+e) = 1.666 AU \u2014 a 17% difference!',
                      visual: 'mars'
                    },
                    {
                      id: 'aph_mercury', law: 'I', difficulty: 1,
                      question: "Mercury has a = 0.387 AU and e = 0.2056. What is its aphelion distance? (r\u2098\u2090\u2093 = a(1+e))",
                      hints: [
                        'Formula: r\u2098\u2090\u2093 = a \u00D7 (1 + e)',
                        'r\u2098\u2090\u2093 = 0.387 \u00D7 (1 + 0.2056)',
                        '1 + 0.2056 = 1.2056'
                      ],
                      answer: 0.467, unit: 'AU', tolerance: 0.01,
                      explanation: 'r\u2098\u2090\u2093 = 0.387 \u00D7 1.2056 = 0.467 AU. Mercury\'s orbit is very eccentric \u2014 its perihelion is only 0.307 AU but aphelion is 0.467 AU. That\'s a 52% difference in distance from the Sun!',
                      visual: 'mercury'
                    },

                    // === KEPLER'S SECOND LAW ===
                    {
                      id: 'k2_speed_ratio', law: 'II', difficulty: 2,
                      question: "Mars (e = 0.0934): The ratio of perihelion speed to aphelion speed is v\u209A/v\u2090 = (1+e)/(1\u2212e). Calculate this ratio.",
                      hints: [
                        'v\u209A/v\u2090 = (1 + e) / (1 \u2212 e)',
                        'Numerator: 1 + 0.0934 = 1.0934',
                        'Denominator: 1 \u2212 0.0934 = 0.9066',
                        'Divide: 1.0934 / 0.9066'
                      ],
                      answer: 1.206, unit: '(ratio)', tolerance: 0.02,
                      explanation: 'v\u209A/v\u2090 = 1.0934/0.9066 = 1.206. Mars moves about 21% faster at perihelion than at aphelion! This is Kepler\'s Second Law in action \u2014 the planet speeds up when closer to the Sun to sweep equal areas.',
                      visual: 'mars'
                    },
                    {
                      id: 'k2_halley_ratio', law: 'II', difficulty: 2,
                      question: "Halley's Comet (e = 0.967): How many times faster does it move at perihelion vs. aphelion? v\u209A/v\u2090 = (1+e)/(1\u2212e)",
                      hints: [
                        '1 + 0.967 = 1.967',
                        '1 \u2212 0.967 = 0.033',
                        'Divide: 1.967 / 0.033'
                      ],
                      answer: 59.6, unit: '\u00D7 faster', tolerance: 2.0,
                      explanation: 'v\u209A/v\u2090 = 1.967/0.033 = 59.6\u00D7! Halley\'s Comet screams past the Sun at perihelion (54.5 km/s) then practically crawls at aphelion (0.9 km/s). This extreme ratio is why comets spend most of their time far from the Sun.',
                      visual: 'halley'
                    },

                    // === HOHMANN TRANSFER ===
                    {
                      id: 'hohmann_mars_time', law: 'transfer', difficulty: 2,
                      question: "A Hohmann transfer from Earth (1 AU) to Mars (1.524 AU): The transfer semi-major axis is a\u209C = (r\u2081+r\u2082)/2. Calculate a\u209C, then find the transfer time in days. (Transfer time = 0.5 \u00D7 T\u209C, where T\u209C\u00B2 = a\u209C\u00B3)",
                      hints: [
                        'Step 1: a\u209C = (1.000 + 1.524) / 2 = 1.262 AU',
                        'Step 2: T\u209C\u00B2 = a\u209C\u00B3 = (1.262)\u00B3 = 2.011',
                        'Step 3: T\u209C = \u221A2.011 = 1.418 years',
                        'Step 4: Transfer = 0.5 \u00D7 1.418 yr \u00D7 365.25 days/yr'
                      ],
                      answer: 259, unit: 'days', tolerance: 5,
                      explanation: 'a\u209C = 1.262 AU, T\u209C = 1.418 yr, transfer time = 0.709 yr = 259 days. This is the real transit time to Mars! NASA\'s Perseverance took 203 days (faster than Hohmann because it used extra fuel for a shorter trajectory).',
                      visual: 'mars'
                    },
                    {
                      id: 'hohmann_jupiter_time', law: 'transfer', difficulty: 2,
                      question: "Hohmann transfer Earth \u2192 Jupiter: r\u2081 = 1 AU, r\u2082 = 5.203 AU. Calculate a\u209C = (r\u2081+r\u2082)/2, then transfer time in days.",
                      hints: [
                        'a\u209C = (1 + 5.203) / 2 = 3.102 AU',
                        'T\u209C\u00B2 = (3.102)\u00B3 = 29.82',
                        'T\u209C = \u221A29.82 = 5.461 years',
                        'Transfer = 0.5 \u00D7 5.461 \u00D7 365.25 = ?'
                      ],
                      answer: 997, unit: 'days', tolerance: 15,
                      explanation: 'Transfer time = 997 days \u2248 2.73 years. That\'s a long trip! Juno spacecraft actually took about 5 years because it did a complex flyby maneuver.',
                      visual: 'jupiter'
                    },

                    // === ESCAPE VELOCITY ===
                    {
                      id: 'escape_ratio', law: 'velocity', difficulty: 2,
                      question: "Escape velocity is v\u2091\u209B\u209C = \u221A2 \u00D7 v\u2091\u2097\u2099\u2091 (circular velocity). If Earth's circular orbital speed is 29.78 km/s, what is the escape velocity from Earth's orbit?",
                      hints: [
                        'v\u2091\u209B\u209C = \u221A2 \u00D7 v\u2091\u2097\u2099\u2091',
                        '\u221A2 = 1.414',
                        'v\u2091\u209B\u209C = 1.414 \u00D7 29.78'
                      ],
                      answer: 42.12, unit: 'km/s', tolerance: 0.5,
                      explanation: 'v\u2091\u209B\u209C = \u221A2 \u00D7 29.78 = 42.1 km/s. To leave the solar system from Earth\'s orbit, you need to reach 42.1 km/s \u2014 only 41% more than orbital speed! The Voyager probes achieved this using gravity assists from Jupiter.',
                      visual: 'earth'
                    },

                    // === GRAVITY / ORBITAL ENERGY ===
                    {
                      id: 'energy_compare', law: 'energy', difficulty: 3,
                      question: "Specific orbital energy is \u03B5 = -GM/(2a). For our solar system, this simplifies to \u03B5 = -66.25/a km\u00B2/s\u00B2. Compare Earth (a=1 AU) and Mars (a=1.524 AU). How much less bound is Mars? Calculate |\u03B5\u2091\u2090\u2099\u209C\u2095|\u2212|\u03B5\u2098\u2090\u2099\u209B|.",
                      hints: [
                        '|\u03B5\u2091\u2090\u2099\u209C\u2095| = 66.25/1.000 = 66.25 km\u00B2/s\u00B2',
                        '|\u03B5\u2098\u2090\u2099\u209B| = 66.25/1.524 = 43.47 km\u00B2/s\u00B2',
                        'Difference = 66.25 \u2212 43.47'
                      ],
                      answer: 22.78, unit: 'km\u00B2/s\u00B2', tolerance: 0.5,
                      explanation: '\u0394\u03B5 = 66.25 \u2212 43.47 = 22.78 km\u00B2/s\u00B2. Mars is less gravitationally bound to the Sun because it\'s farther away. This energy difference is what a Hohmann transfer must provide (split across two burns).',
                      visual: 'mars'
                    },
                    {
                      id: 'semi_minor', law: 'I', difficulty: 2,
                      question: "Pluto has a = 39.48 AU and e = 0.2488. Calculate the semi-minor axis using b = a\u221A(1\u2212e\u00B2).",
                      hints: [
                        'e\u00B2 = (0.2488)\u00B2 = 0.06190',
                        '1 \u2212 e\u00B2 = 0.9381',
                        '\u221A(0.9381) = 0.9686',
                      ...
                      answer: 38.24, unit: 'AU', tolerance: 0.3,
                      explanation: 'b = 39.48 \u00D7 0.9686 = 38.24 AU. Even though Pluto has the highest eccentricity of the classical planets, b is only 3% smaller than a! An eccentricity of 0.25 barely squishes the ellipse visually.',
                      visual: 'pluto'
                    }
                  ];

                  // Filter by difficulty based on grade
                  var maxDiff = isElem ? 1 : isAdvanced ? 3 : 2;
                  var availProblems = PROBLEMS.filter(function(p) { return p.difficulty <= maxDiff; });
                  var currentProblem = availProblems[chalIdx % availProblems.length];
                  var ans = chalAnswered[currentProblem.id];
                  var isCorrect = ans && ans.correct;
                  var isWrong = ans && !ans.correct;

                  return React.createElement("div", { className: "space-y-3" },
                    // Header
                    React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-r from-violet-50 to-fuchsia-50 border-violet-200') + " rounded-xl p-3 border" },
                      React.createElement("div", { className: "flex items-center justify-between mb-1" },
                        React.createElement("div", { className: "text-sm font-bold " + (isDark ? 'text-violet-300' : 'text-violet-700') }, "\uD83E\uDDE0 Orbital Mechanics Challenges"),
                        React.createElement("div", { className: "flex items-center gap-2" },
                          React.createElement("span", { className: "text-[10px] font-bold px-2 py-0.5 rounded-full " + (isDark ? 'bg-violet-900 text-violet-300' : 'bg-violet-100 text-violet-600') }, '\u2B50 ' + chalScore + '/' + availProblems.length + ' solved'),
                          React.createElement("span", { className: "text-[10px] px-2 py-0.5 rounded-full " + (isDark ? 'bg-slate-700 text-slate-400' : 'bg-slate-100 text-slate-500') }, 'Difficulty: ' + (isElem ? '\u2605' : isAdvanced ? '\u2605\u2605\u2605' : '\u2605\u2605'))
                        )
                      ),
                      React.createElement("p", { className: "text-[11px] " + (isDark ? 'text-slate-300' : 'text-slate-600') }, "Apply the equations from the other tabs to solve real orbital mechanics problems. Use the hint system if you get stuck \u2014 each hint reveals one step of the solution.")
                    ),

                    // Problem navigation
                    React.createElement("div", { className: "flex flex-wrap gap-1" },
                      availProblems.map(function(p, i) {
                        var solved = chalAnswered[p.id] && chalAnswered[p.id].correct;
                        var attempted = chalAnswered[p.id] && !chalAnswered[p.id].correct;
                        var isCurrent = i === (chalIdx % availProblems.length);
                        var lawColors = { I: 'purple', II: 'emerald', III: 'amber', velocity: 'blue', transfer: 'cyan', energy: 'rose' };
                        var lc = lawColors[p.law] || 'slate';
                        return React.createElement("button", {
                          key: p.id,
                          onClick: function() { upd('_chalIdx', i); upd('_chalShowHint', false); upd('_chalShowWork', false); },
                          className: "w-7 h-7 rounded-lg text-[10px] font-bold transition-all " + (isCurrent ? 'ring-2 ring-offset-1 ring-violet-500 ' : '') + (solved ? 'bg-emerald-500 text-white' : attempted ? 'bg-amber-500 text-white' : (isDark ? 'bg-slate-700 text-slate-400' : 'bg-white text-slate-500 border border-slate-200'))
                        }, solved ? '\u2713' : (i + 1));
                      })
                    ),

                    // Current problem card
                    React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-violet-200') + " rounded-xl p-4 border space-y-3" },
                      // Problem header
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        React.createElement("span", { className: "px-2 py-0.5 rounded-full text-[10px] font-bold " + (currentProblem.law === 'III' ? 'bg-amber-100 text-amber-700' : currentProblem.law === 'II' ? 'bg-emerald-100 text-emerald-700' : currentProblem.law === 'I' ? 'bg-purple-100 text-purple-700' : currentProblem.law === 'transfer' ? 'bg-cyan-100 text-cyan-700' : 'bg-blue-100 text-blue-700') },
                          currentProblem.law === 'III' ? 'Kepler III' : currentProblem.law === 'II' ? 'Kepler II' : currentProblem.law === 'I' ? 'Kepler I' : currentProblem.law === 'transfer' ? 'Hohmann' : currentProblem.law === 'energy' ? 'Energy' : 'Velocity'
                        ),
                        React.createElement("span", { className: "text-[10px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, 'Problem ' + ((chalIdx % availProblems.length) + 1) + ' of ' + availProblems.length),
                        React.createElement("span", { className: "text-[10px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, '\u2605'.repeat(currentProblem.difficulty))
                      ),

                      // Question
                      React.createElement("div", { className: "text-[12px] font-medium " + (isDark ? 'text-white' : 'text-slate-800') + " leading-relaxed" }, currentProblem.question),

                      // Hint system (progressive reveal)
                      React.createElement("div", null,
                        React.createElement("button", {
                          onClick: function() { upd('_chalShowHint', !chalShowHint); },
                          className: "text-[10px] font-bold " + (isDark ? 'text-violet-400 hover:text-violet-300' : 'text-violet-600 hover:text-violet-800') + " transition-colors"
                        }, chalShowHint ? '\u25BC Hide hints' : '\uD83D\uDCA1 Show step-by-step hints'),
                        chalShowHint && React.createElement("div", { className: "mt-2 space-y-1.5" },
                          currentProblem.hints.map(function(hint, hi) {
                            var hintRevealed = (d._chalHintsRevealed || 0) > hi;
                            var isNext = (d._chalHintsRevealed || 0) === hi;
                            return React.createElement("div", { key: hi, className: "flex items-start gap-2" },
                              hintRevealed ? React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-violet-300' : 'text-violet-600') + " px-2.5 py-1.5 rounded-lg " + (isDark ? 'bg-violet-900/30' : 'bg-violet-50') + " border " + (isDark ? 'border-violet-800' : 'border-violet-200') + " flex-1 font-mono" }, hint) :
                              isNext ? React.createElement("button", {
                                onClick: function() { upd('_chalHintsRevealed', (d._chalHintsRevealed || 0) + 1); },
                                className: "text-[10px] font-bold px-2.5 py-1.5 rounded-lg " + (isDark ? 'bg-violet-800 text-violet-200 hover:bg-violet-700' : 'bg-violet-100 text-violet-700 hover:bg-violet-200') + " border " + (isDark ? 'border-violet-700' : 'border-violet-300') + " transition-all"
                              }, '\uD83D\uDD13 Reveal hint ' + (hi + 1) + ' of ' + currentProblem.hints.length) :
                              React.createElement("div", { className: "text-[10px] px-2.5 py-1.5 rounded-lg " + (isDark ? 'bg-slate-700/50 text-slate-600' : 'bg-slate-100 text-slate-400') + " border " + (isDark ? 'border-slate-700' : 'border-slate-200') }, '\uD83D\uDD12 Hint ' + (hi + 1) + ' (reveal previous first)')
                            );
                          })
                        )
                      ),
                      ...
                      // Answer input
                      !isCorrect && React.createElement("div", { className: "flex items-center gap-2" },
                        React.createElement("span", { className: "text-[10px] font-bold " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "Your answer:"),
                        React.createElement("input", {
                          ...
                          onChange: function(e) { upd('_chalInput', e.target.value); },
                          onKeyDown: function(e) {
                            if (e.key === 'Enter') {
                              var val = parseFloat(d._chalInput);
                              if (isNaN(val)) return;
                              var correct = Math.abs(val - currentProblem.answer) <= currentProblem.tolerance;
                              var newAnswered = Object.assign({}, chalAnswered);
                              newAnswered[currentProblem.id] = { value: val, correct: correct, attempts: (newAnswered[currentProblem.id] ? newAnswered[currentProblem.id].attempts + 1 : 1) };
                              var newScore = correct ? chalScore + 1 : chalScore;
                              updMulti({ _chalAnswered: newAnswered, _chalScore: newScore, _chalShowWork: true });
                              if (correct && awardStemXP) { awardStemXP('solarSystem', 10); }
                              if (correct && addToast) { addToast('\u2705 Correct! +10 XP', 'success'); }
                            }
                          },
                          className: "flex-1 px-3 py-1.5 rounded-lg text-sm font-mono " + (isDark ? 'bg-slate-700 text-white border-slate-600' : 'bg-slate-50 text-slate-800 border-slate-200') + " border focus:ring-2 focus:ring-violet-500 focus:outline-none" + (isWrong ? ' ring-2 ring-amber-500' : '')
                        }),
                        React.createElement("span", { className: "text-[10px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, currentProblem.unit),
                        React.createElement("button", {
                          onClick: function() {
                            var val = parseFloat(d._chalInput);
                            if (isNaN(val)) return;
                          ...
                          className: "px-3 py-1.5 rounded-lg text-[10px] font-bold bg-violet-600 text-white hover:bg-violet-700 transition-all"
                        }, 'Check')
                      ),

                      // Correct badge
                      isCorrect && React.createElement("div", { className: "flex items-center gap-2 px-3 py-2 rounded-lg bg-emerald-50 border border-emerald-200" },
                        React.createElement("span", { className: "text-lg" }, "\u2705"),
                        React.createElement("div", null,
                          React.createElement("div", { className: "text-xs font-bold text-emerald-700" }, "Correct!"),
                          React.createElement("div", { className: "text-[10px] text-emerald-600" }, "You answered: " + ans.value + " " + currentProblem.unit + (ans.attempts > 1 ? ' (attempt ' + ans.attempts + ')' : ' (first try!)'))
                        )
                      ),

                      // Wrong feedback
                      isWrong && React.createElement("div", { className: "flex items-center gap-2 px-3 py-2 rounded-lg bg-amber-50 border border-amber-200" },
                        React.createElement("span", { className: "text-lg" }, "\uD83E\uDD14"),
                        React.createElement("div", null,
                          React.createElement("div", { className: "text-xs font-bold text-amber-700" }, "Not quite \u2014 try again!"),
                          React.createElement("div", { className: "text-[10px] text-amber-600" }, "Your answer: " + ans.value + " " + currentProblem.unit + ". Expected: near " + currentProblem.answer.toFixed(2) + " \u00B1" + currentProblem.tolerance + ". " + (ans.attempts >= 2 ? 'Try using the hints!' : 'Check your arithmetic.'))
                        )
                      ),

                      // Show work / explanation (after answering)
                      (isCorrect || (isWrong && ans && ans.attempts >= 3)) && React.createElement("div", null,
                        React.createElement("button", {
                          onClick: function() { upd('_chalShowWork', !chalShowWork); },
                          className: "text-[10px] font-bold " + (isDark ? 'text-emerald-400' : 'text-emerald-600')
                        }, chalShowWork ? '\u25BC Hide solution' : '\uD83D\uDCD6 Show full solution'),
                        chalShowWork && React.createElement("div", { className: (isDark ? 'bg-emerald-900/20 border-emerald-800' : 'bg-emerald-50 border-emerald-200') + " rounded-lg p-3 border mt-2" },
                          React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-emerald-200' : 'text-emerald-800') + " leading-relaxed" }, currentProblem.explanation)
                        )
                      ),

                      // Navigation
                      React.createElement("div", { className: "flex items-center justify-between pt-2 border-t " + (isDark ? 'border-slate-700' : 'border-slate-100') },
                        React.createElement("button", {
                          onClick: function() { var ni = ((chalIdx % availProblems.length) - 1 + availProblems.length) % availProblems.length; upd('_chalIdx', ni); upd('_chalInput', ''); upd('_chalShowHint', false); upd('_chalShowWork', false); upd('_chalHintsRevealed', 0); },
                          className: "px-3 py-1 rounded-lg text-[10px] font-bold " + (isDark ? 'bg-slate-700 text-slate-300' : 'bg-slate-100 text-slate-600 hover:bg-slate-200')
                        }, '\u2190 Previous'),
                        React.createElement("button", {
                          onClick: function() { var ni = ((chalIdx % availProblems.length) + 1) % availProblems.length; upd('_chalIdx', ni); upd('_chalInput', ''); upd('_chalShowHint', false); upd('_chalShowWork', false); upd('_chalHintsRevealed', 0); },
                          className: "px-3 py-1 rounded-lg text-[10px] font-bold bg-violet-600 text-white hover:bg-violet-700"
                        }, 'Next \u2192')
                      )
                    ),

                    // Quick reference card
                    React.createElement("details", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-slate-50 border-slate-200') + " rounded-xl border overflow-hidden" },
                      React.createElement("summary", { className: "px-3 py-2 text-[11px] font-bold " + (isDark ? 'text-slate-300' : 'text-slate-700') + " cursor-pointer select-none hover:bg-slate-100/50" }, "\uD83D\uDCCB Equation Quick Reference (click to expand)"),
                      React.createElement("div", { className: "px-3 pb-3 grid grid-cols-2 gap-2 text-[10px] font-mono " + (isDark ? 'text-slate-300' : 'text-slate-600') },
                        React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-slate-200') },
                          React.createElement("div", { className: "font-bold text-purple-500 mb-1" }, "Kepler I \u2014 Ellipses"),
                          React.createElement("div", null, "r(\u03b8) = a(1\u2212e\u00B2)/(1+e\u00B7cos\u03b8)"),
                          React.createElement("div", null, "r\u2098\u2097\u2099 = a(1\u2212e)"),
                          React.createElement("div", null, "r\u2098\u2090\u2093 = a(1+e)"),
                          React.createElement("div", null, "b = a\u221A(1\u2212e\u00B2)"),
                          React.createElement("div", null, "c = ae (focus distance)")
                        ),
                        React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-slate-200') },
                          React.createElement("div", { className: "font-bold text-emerald-500 mb-1" }, "Kepler II \u2014 Areas"),
                          React.createElement("div", null, "dA/dt = L/(2m) = const"),
                          React.createElement("div", null, "v\u209A/v\u2090 = (1+e)/(1\u2212e)"),
                          React.createElement("div", null, "L = mr\u00B2\u03C9")
                        ),
                        React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-slate-200') },
                          React.createElement("div", { className: "font-bold text-amber-500 mb-1" }, "Kepler III \u2014 Periods"),
                          React.createElement("div", null, "T\u00B2 = a\u00B3 (yr, AU)"),
                          React.createElement("div", null, "T = a^(3/2)"),
                          React.createElement("div", null, "a = T^(2/3)")
                        ),
                        React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-slate-200') },
                          React.createElement("div", { className: "font-bold text-cyan-500 mb-1" }, "Velocity & Energy"),
                          React.createElement("div", null, "v = 29.78/\u221Aa km/s (circular)"),
                          React.createElement("div", null, "v\u2091\u209B\u209C = \u221A2 \u00D7 v\u2091\u2097\u2099\u2091"),
                          React.createElement("div", null, "\u03B5 = \u221266.25/a km\u00B2/s\u00B2"),
                          React.createElement("div", null, "a\u209C = (r\u2081+r\u2082)/2 (Hohmann)")
                        )
                      )
                    ),

                    // Progress summary
                    chalScore > 0 && React.createElement("div", { className: (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-r from-emerald-50 to-teal-50 border-emerald-200') + " rounded-xl p-3 border" },
                      React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-emerald-300' : 'text-emerald-700') + " mb-2" }, "\uD83C\uDFC6 Your Progress"),
                      React.createElement("div", { className: "flex gap-1 flex-wrap" },
                        availProblems.map(function(p) {
                          var solved = chalAnswered[p.id] && chalAnswered[p.id].correct;
                          var firstTry = solved && chalAnswered[p.id].attempts === 1;
                          return React.createElement("div", { key: p.id, className: "w-5 h-5 rounded flex items-center justify-center text-[8px] " + (solved ? (firstTry ? 'bg-emerald-500 text-white' : 'bg-emerald-300 text-emerald-800') : (isDark ? 'bg-slate-700' : 'bg-slate-200')) }, solved ? (firstTry ? '\u2605' : '\u2713') : '\u00B7');
                        })
                      ),
                      React.createElement("div", { className: "mt-1.5 text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') },
                        '\u2B50 ' + chalScore + ' solved' +
            ...
            // 3D Canvas container (only when not in Orrery mode)
            ...
            !d.orreryMode && sel && React.createElement("div", { className: "mt-3 bg-slate-50 rounded-xl border border-slate-200 p-4 animate-in slide-in-from-bottom duration-300" },
              ...
              (d.viewTab || 'overview') === 'overview' && React.createElement("div", null,
                ...
                sel.notableFeatures && React.createElement("div", { className: "bg-white rounded-lg p-3 border" },
                  ...
                  React.createElement("p", { className: "text-xs font-bold text-slate-600 mb-1.5" }, "\u2B50 Notable Features"),
              ...
              (d.viewTab) === 'surface' && React.createElement("div", { className: "space-y-3" },
                ...
                d.surfaceExplore === 'moons' && React.createElement("div", { className: "mt-2 bg-gradient-to-b from-slate-900 to-slate-800 rounded-xl p-3 border border-slate-700 animate-fadeIn" },
                  ...
                  NOTABLE_MOONS[sel.name] && NOTABLE_MOONS[sel.name].length > 0 ?
                    ...
                    React.createElement("p", { className: "text-xs text-slate-500 italic text-center py-3" },
                ...
                d.showHohmann && React.createElement("div", null,
                  ...
                  React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2.5 border " + (isDark ? 'border-slate-600' : 'border-rose-100') },
                    React.createElement("div", { className: "grid grid-cols-2 gap-2 text-[10px]" },
                      ...
                      React.createElement("div", { className: isDark ? 'text-slate-400' : 'text-slate-600' }, "\u23F1 Travel time:"),
                      ...
                      React.createElement("div", { className: isDark ? 'text-slate-400' : 'text-slate-600' }, "\uD83D\uDD04 Launch window every:"),
                      React.createElement("div", { className: "font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, HOHMANN[sel.name].window),
                      React.createElement("div", { className: isDark ? 'text-slate-400' : 'text-slate-600' }, "\u2696 Total \u0394v needed:"),
              ...
              !d.tutorialDismissed && React.createElement("div", { role: 'button', tabIndex: 0, onKeyDown: function(e) { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); e.target.click(); } },
                ...
                React.createElement("div", { className: "bg-white rounded-2xl p-6 max-w-md shadow-2xl mx-4" },
                  React.createElement("div", { className: "text-center mb-4" },
                    ...
                    React.createElement("p", { className: "text-sm text-slate-600 mt-1" }, "Your interactive guide to our cosmic neighborhood")
                  ),
