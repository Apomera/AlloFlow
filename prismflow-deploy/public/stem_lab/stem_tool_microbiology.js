            ...
            h('div', { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 } },
              h('div', null,
                h('div', { style: { fontSize: 12, fontWeight: 800, color: '#c4b5fd', marginBottom: 6, display: 'flex', justifyContent: 'space-between' } },
                  h('span', null, '🔬 Slide Smear (1000x Oil Immersion)'),
                ...
                h('svg', { viewBox: '0 0 200 150', style: { width: '100%', height: 160, display: 'block', background: '#070a13', borderRadius: 8, border: '1px solid #334155' } },
                  ...
                  h('g', null,
                    ...
                    h('text', { x: 50, y: 41, fill: posColor, fontSize: 5.5, fontWeight: 700, opacity: posOpacity }, 'Gram-positive (cocci)')
                  ),
                  h('g', null,
                    ...
                    h('text', { x: 110, y: 38, fill: negColor, fontSize: 5.5, fontWeight: 700, opacity: negOpacity }, 'Gram-negative (bacilli)')
                  )
                )
              ),
              h('div', { style: { display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 8 } },
                h('div', null,
                  h('div', { style: { fontSize: 11, fontWeight: 800, color: 'var(--allo-stem-text-soft, #94a3b8)', textTransform: 'uppercase', marginBottom: 6 } }, 'Reagents'),
                  h('div', { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6, marginBottom: 8 } },
                    [
                      { stepVal: 1, label: '🟣 Crystal Violet', desc: 'Primary Stain' },
                      { stepVal: 2, label: '🟤 Iodine', desc: 'Mordant' },
                      { stepVal: 3, label: '⚪ Alcohol Wash', desc: 'Decolorizer' },
                      { stepVal: 4, label: '🔴 Safranin', desc: 'Counterstain' }
                    ].map(function(btn) {
                ...
                h('div', { style: { padding: 8, borderRadius: 6, background: '#0a0e1a', border: '1px solid #1e293b' } },
                  h('div', { style: { fontSize: 9, fontWeight: 800, color: '#fbbf24', textTransform: 'uppercase', marginBottom: 2 } }, 'Stain chemistry'),
        ...
        return h('div', { style: { padding: 16 } },
              ...
              return h('div', null,
                ...
                h('div', { style: { marginTop: 14, padding: 12, borderRadius: 8, background: 'rgba(16,185,129,0.08)', border: '1px dashed rgba(16,185,129,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap' } },
                  h('div', { style: { flex: 1, minWidth: 200 } },
                    h('div', { style: { fontSize: 12, fontWeight: 800, color: '#6ee7b7', marginBottom: 2 } }, '🔬 Interactive CRISPR Gene Editor'),
                    h('div', { style: { fontSize: 11, color: 'var(--allo-stem-text-soft, #94a3b8)', lineHeight: 1.4 } }, 'Ready to perform a real gene edit? Use the full molecular editor in our DNA Lab to scan, find target PAM sites, and apply precise cuts and repairs.')
                  ),
                  h('button', {
                    onClick: function() {
          ...
          sectionCard('🟣 Gram stain - the foundational microbiology test',
            h('div', null,
              ...
              h('div', { style: { fontSize: 11, fontWeight: 800, color: 'var(--allo-stem-text-soft, #94a3b8)', textTransform: 'uppercase', marginBottom: 8 } }, 'Cell wall macromolecular structure reference:'),
