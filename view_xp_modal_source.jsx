...
function XPModal({
  ...
  const HistoryIcon = window.History && window.History !== browserHistoryConstructor
    ? window.History
    : (() => null);
  ...
  React.useEffect(() => {
    ...
    const onKeyDown = (event) => {
      if (!isTopTrap()) return;
      if (event.key === 'Escape') { event.preventDefault(); event.stopPropagation(); handleSetShowXPModalToFalse(); return; }
