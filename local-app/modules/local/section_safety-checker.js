    ...
    async aiCheck(text, source, apiKey, onFlag) {
        ...
        try {
            ...
            const resp = await fetch(url, {
                ...
                body: JSON.stringify({
                    model: window.__ollamaModel || 'default',
                    stream: false,
                    max_tokens: 100,
                    temperature: 0.1,
                    messages: [{ role: 'user', content: `You are a K-12 student safety classifier for an educational platform. Analyze this student message and respond with ONLY a JSON object. Be sensitive to context — educational discussions about difficult topics (history, health) are NOT flags.
