...
(async()=>{
 ...
 try{
  ...
  await page.screenshot({path:path.join(out,'builder-keyboard-desktop.png')});
  fs.writeFileSync(path.join(out,'keyboard-results.json'),JSON.stringify(result,null,2));
