...
function UniversalSettingsPanel(props) {
  ...
  const useSurpriseDirection = (direction, editedBrief) => {
    ...
    try {
      ...
      addToast("Standard attached. Copy the direction text manually.", "info");
    }
  };
