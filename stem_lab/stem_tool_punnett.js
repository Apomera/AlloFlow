    ...
    render: function(ctx) {
      ...
      if (!this._PunnettComponent) {
        this._PunnettComponent = function PunnettLab(props) {
          ...
          }, [crossCount, presetsUsed, d._testCrossDone, d._sexLinkedDone, d._genScore, d._pedigreeSolved, d._popSimDone, d._dnaDone, d._chalTotalScore, d._battleWon, d._visited]);
            ...
            subtool === 'dna2protein' && h('div', null,
              ...
              dnaSeq.length >= 3 && (function() {
                ...
                return h('div', null,
                  ...
                  // Color legend
                  h('div', { className: 'bg-slate-50 rounded-xl p-2' },
