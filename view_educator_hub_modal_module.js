...
function EducatorHubModal(props) {
  ...
  const [hubFavoriteIds, setHubFavoriteIds] = React.useState(() => {
    try {
      const parsed = JSON.parse(localStorage.getItem("alloflow_hub_educator_favorites") || "[]");
  ...
  const [hubRecentIds, setHubRecentIds] = React.useState(() => {
    try {
      const parsed = JSON.parse(localStorage.getItem("alloflow_hub_educator_recent") || "[]");
      return Array.isArray(parsed) ? parsed : [];
    } catch (_) {
      return [];
    }
  ...
  const [hubUsageCounts, setHubUsageCounts] = React.useState(() => {
    try {
      const parsed = JSON.parse(localStorage.getItem("alloflow_hub_educator_usage") || "{}");
  ...
  const [hubCollapsedSections, setHubCollapsedSections] = React.useState(() => {
    try {
      const parsed = JSON.parse(localStorage.getItem("alloflow_hub_educator_collapsed") || "[]");
      return Array.isArray(parsed) ? parsed : [];
    } catch (_) {
      return [];
    }
  ...
  const [hubRoleOverride, setHubRoleOverride] = React.useState(() => {
    try {
      const value = localStorage.getItem("alloflow_hub_educator_role");
  ...
  React.useEffect(() => {
    try {
      localStorage.setItem("alloflow_hub_educator_favorites", JSON.stringify(hubFavoriteIds));
    } catch (_) {
    }
  }, [hubFavoriteIds]);
  React.useEffect(() => {
    try {
      localStorage.setItem("alloflow_hub_educator_recent", JSON.stringify(hubRecentIds));
    } catch (_) {
    }
  }, [hubRecentIds]);
  React.useEffect(() => {
    try {
      localStorage.setItem("alloflow_hub_educator_usage", JSON.stringify(hubUsageCounts));
    } catch (_) {
    }
  }, [hubUsageCounts]);
  React.useEffect(() => {
    try {
      localStorage.setItem("alloflow_hub_educator_collapsed", JSON.stringify(hubCollapsedSections));
    } catch (_) {
    }
  }, [hubCollapsedSections]);
  React.useEffect(() => {
    try {
      localStorage.setItem("alloflow_hub_educator_role", hubRoleOverride);
    } catch (_) {
    }
  }, [hubRoleOverride]);
  React.useEffect(() => {
  ...
  React.useEffect(() => {
    ...
    shells.forEach((shell) => {
      ...
      if (visible) {
        visibleSections.add(shell.dataset.hubSection);
        count += 1;
      }
    });
  ...
  const hubRecommendedIds = Array.from(/* @__PURE__ */ new Set([...hubRoleRecommendations[hubRoleKey] || hubRoleRecommendations.educator, ...hubUsageRankedIds])).slice(0, 5);
  const recommendedCards = hubRecommendedIds.map((id) => hubCards.find((card) => card.id === id)).filter(Boolean);
  const quickCards = Array.from(/* @__PURE__ */ new Set([...hubFavoriteIds, ...hubRecentIds])).map((id) => hubCards.find((card) => card.id === id)).filter(Boolean);
  return /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-[260] bg-black/40 flex items-center justify-center overflow-y-auto p-3 sm:p-4", style: { zIndex: 260 }, role: "presentation", onClick: () => setShowEducatorHub(false) }, /* @__PURE__ */ React.createElement("div", { ref: dialogRef, tabIndex: -1, "data-help-key": "educator_hub_modal_panel", className: "allo-docsuite bg-white rounded-2xl shadow-2xl w-full max-w-2xl p-5 sm:p-8 max-h-[90vh] overflow-y-auto focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2", style: { maxHeight: "90vh" }, role: "dialog", "aria-modal": "true", "aria-labelledby": "educator-hub-title", "aria-describedby": "educator-hub-subtitle", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-6" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { id: "educator-hub-title", className: "text-xl font-bold text-slate-800 flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "\u{1F6E0}\uFE0F"), " ", t("educator_hub.title") || "Educator Tools"), /* @__PURE__ */ React.createElement("p", { id: "educator-hub-subtitle", className: "text-sm text-slate-600 mt-1" }, t("educator_hub.subtitle") || "Professional tools for educators and clinicians")), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => setShowEducatorHub(false), className: "min-w-11 min-h-11 p-2 inline-flex items-center justify-center rounded-lg text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-colors text-xl", "aria-label": t("educator_hub.close_aria") || "Close educator tools" }, "\u2715")), /* @__PURE__ */ React.createElement("div", { className: "mb-4 space-y-3", role: "search", "aria-label": tr("hub.search_label", "Search tools") }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row gap-2" }, /* @__PURE__ */ React.createElement("label", { htmlFor: "educator-hub-search", className: "sr-only" }, tr("hub.search_label", "Search tools")), /* @__PURE__ */ React.createElement("input", { id: "educator-hub-search", type: "search", value: hubQuery, onChange: (event) => setHubQuery(event.target.value), placeholder: tr("hub.search_placeholder", "Search tools by name, purpose, or workflow"), className: "min-h-11 flex-1 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" }), hubQuery && /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => setHubQuery(""), className: "min-h-11 px-3 rounded-xl border border-slate-300 bg-white text-sm font-bold text-slate-700 hover:bg-slate-50" }, tr("hub.clear_search", "Clear")), /* @__PURE__ */ React.createElement("button", { type: "button", "aria-pressed": hubFavoritesOnly, onClick: () => setHubFavoritesOnly((value) => !value), className: "min-h-11 px-3 rounded-xl border border-amber-300 bg-amber-50 text-sm font-bold text-amber-800 hover:bg-amber-100" }, hubFavoritesOnly ? "\u2605 " : "\u2606 ", tr("hub.favorites_only", "Favorites")), /* @__PURE__ */ React.createElement("button", { type: "button", "aria-expanded": hubManageFavorites, onClick: () => setHubManageFavorites((value) => !value), className: "min-h-11 px-3 rounded-xl border border-slate-300 bg-white text-sm font-bold text-slate-700 hover:bg-slate-50" }, tr("hub.manage_favorites", "Manage favorites"))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2" }, /* @__PURE__ */ React.createElement("label", { htmlFor: "educator-hub-role", className: "text-xs font-bold text-slate-600" }, tr("hub.role_label", "Recommendations for")), /* @__PURE__ */ React.createElement("select", { id: "educator-hub-role", value: hubRoleKey, onChange: (event) => setHubRoleOverride(event.target.value), className: "min-h-10 rounded-lg border border-slate-300 bg-white px-2 text-xs font-bold text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, /* @__PURE__ */ React.createElement("option", { value: "educator" }, tr("hub.role_educator", "Educators")), /* @__PURE__ */ React.createElement("option", { value: "clinician" }, tr("hub.role_clinician", "Clinicians")), /* @__PURE__ */ React.createElement("option", { value: "leader" }, tr("hub.role_leader", "Leaders")), /* @__PURE__ */ React.createElement("option", { value: "student" }, tr("hub.role_student", "Students")), /* @__PURE__ */ React.createElement("option", { value: "family" }, tr("hub.role_family", "Families")))), recommendedCards.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border border-emerald-200 bg-emerald-50 p-3", role: "region", "aria-label": tr("hub.recommended", "Recommended tools") }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-2 mb-2" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-black uppercase tracking-wide text-emerald-800" }, tr("hub.recommended", "Recommended tools")), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-emerald-700" }, tr("hub.recommended_for", "For"), " ", hubRoleLabel)), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, recommendedCards.map((card) => /* @__PURE__ */ React.createElement("button", { key: card.id, type: "button", onClick: () => activateHubCard(card.id), className: "min-h-10 rounded-lg border border-emerald-200 bg-white px-3 text-left text-xs font-bold text-emerald-800 hover:bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-emerald-500" }, card.label))), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-emerald-700 mt-2" }, tr("hub.recommended_hint", "Based on your role and local tool use"))), hubManageFavorites && hubCards.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border border-slate-200 bg-slate-50 p-3", role: "region", "aria-label": tr("hub.manage_favorites", "Manage favorites") }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2" }, hubCards.map((card) => /* @__PURE__ */ React.createElement("div", { key: card.id, className: "flex items-center gap-2 rounded-lg bg-white border border-slate-200 p-2" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => activateHubCard(card.id), className: "min-h-10 flex-1 text-left text-sm font-semibold text-slate-700 hover:text-indigo-700" }, card.label), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes(card.id), "aria-label": hubFavoriteIds.includes(card.id) ? tr("hub.remove_favorite", "Remove from favorites") + ": " + card.label : tr("hub.add_favorite", "Add to favorites") + ": " + card.label, onClick: () => toggleHubFavorite(card.id), className: "min-w-9 min-h-9 rounded-full text-amber-600 text-lg hover:bg-amber-50" }, hubFavoriteIds.includes(card.id) ? "\u2605" : "\u2606"))))), quickCards.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border border-indigo-200 bg-indigo-50 p-3", role: "region", "aria-label": tr("hub.quick_access", "Quick access") }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-2 mb-2" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-black uppercase tracking-wide text-indigo-800" }, tr("hub.quick_access", "Quick access")), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-indigo-700" }, tr("hub.quick_access_hint", "Recent and favorite tools"))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, quickCards.map((card) => /* @__PURE__ */ React.createElement("div", { key: card.id, className: "inline-flex items-center rounded-lg border border-indigo-200 bg-white shadow-sm" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => activateHubCard(card.id), className: "min-h-10 px-3 text-left text-xs font-bold text-indigo-800 hover:bg-indigo-50" }, card.label), /* @__PURE__ */ React.createElement("button", { type: "button", "aria-pressed": hubFavoriteIds.includes(card.id), "aria-label": hubFavoriteIds.includes(card.id) ? tr("hub.remove_favorite", "Remove from favorites") + ": " + card.label : tr("hub.add_favorite", "Add to favorites") + ": " + card.label, onClick: () => toggleHubFavorite(card.id), className: "min-w-9 min-h-10 border-l border-indigo-200 text-amber-600 text-lg hover:bg-amber-50" }, hubFavoriteIds.includes(card.id) ? "\u2605" : "\u2606"))))), /* @__PURE__ */ React.createElement("p", { className: "sr-only", "aria-live": "polite" }, hubVisibleCount, " ", tr("hub.tools_available", "tools available"))), /* @__PURE__ */ React.createElement("div", { ref: hubGridRef, className: "grid grid-cols-1 sm:grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "col-span-full mt-1 mb-[-0.25rem]", "data-hub-section-heading": "start" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-black uppercase tracking-wide text-indigo-800" }, tr("educator_hub.section_start_title", "Start here")), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 mt-1" }, tr("educator_hub.section_start_desc", "Plan the next lesson, gather evidence, and prepare the materials students will use."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-section-toggle": "start", "aria-expanded": !hubCollapsedSections.includes("start"), "aria-label": hubCollapsedSections.includes("start") ? tr("hub.expand_section", "Expand section") : tr("hub.collapse_section", "Collapse section"), onClick: () => toggleHubSection("start"), className: "min-h-11 min-w-11 rounded-lg border border-slate-300 bg-white text-slate-700 text-lg font-black hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubCollapsedSections.includes("start") ? "+" : "-"))), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "lesson", "data-hub-label": "Help me build a lesson", "data-hub-section": "start" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_lesson_builder_card", onClick: () => {
    setShowEducatorHub(false);
    startLessonFlow();
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-indigo-50 to-violet-50 border border-indigo-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1FA84}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "inline-flex items-center rounded-full bg-indigo-100 px-2 py-0.5 text-[10px] font-black uppercase tracking-wide text-indigo-700" }, t("educator_hub.blueprint_mode_badge") || "Blueprint Mode"), /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-indigo-800" }, t("educator_hub.lesson_builder_title") || "Help me build a lesson"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-indigo-600 mt-1" }, t("educator_hub.lesson_builder_desc") || "Answer a few questions, then build a differentiated lesson step by step with AlloBot."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("lesson"), "aria-label": hubFavoriteIds.includes("lesson") ? tr("hub.remove_favorite", "Remove from favorites") + ": Help me build a lesson" : tr("hub.add_favorite", "Add to favorites") + ": Help me build a lesson", title: hubFavoriteIds.includes("lesson") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("lesson");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("lesson") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "lumen", "data-hub-label": "Lumen", "data-hub-section": "start" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_lumen_card", onClick: () => {
    setShowEducatorHub(false);
    setLabToolData((prev) => ({ ...prev, lumen: { ...prev && prev.lumen || {}, mode: "home" } }));
    setStemLabTool("lumen");
    setShowStemLab(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-amber-50 to-yellow-50 border border-amber-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F4A1}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-amber-800" }, t("educator_hub.lumen_title") || "Lumen"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-amber-600 mt-1" }, t("educator_hub.lumen_desc") || "Research sources or explore data in one evidence workspace. Cite exact passages and keep uncertainty and provenance visible."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("lumen"), "aria-label": hubFavoriteIds.includes("lumen") ? tr("hub.remove_favorite", "Remove from favorites") + ": Lumen" : tr("hub.add_favorite", "Add to favorites") + ": Lumen", title: hubFavoriteIds.includes("lumen") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("lumen");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("lumen") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "document", "data-hub-label": "Document Hub", "data-hub-section": "start" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_document_hub_card", onClick: () => {
    setShowEducatorHub(false);
    openExportPreview("print");
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F4C4}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-emerald-800" }, t("educator_hub.document_hub_title") || "Document Hub"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-emerald-600 mt-1" }, t("educator_hub.document_hub_desc") || "Build polished documents, audit accessibility, and export to PDF, HTML, worksheets, or slides."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("document"), "aria-label": hubFavoriteIds.includes("document") ? tr("hub.remove_favorite", "Remove from favorites") + ": Document Hub" : tr("hub.add_favorite", "Add to favorites") + ": Document Hub", title: hubFavoriteIds.includes("document") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("document");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("document") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "whiteboard", "data-hub-label": "Whiteboard", "data-hub-section": "start" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_whiteboard_card", onClick: () => {
    setShowEducatorHub(false);
    try {
      openWhiteboard();
    } catch (_e) {
    }
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-indigo-50 to-violet-50 border border-indigo-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u270F\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-indigo-800" }, t("educator_hub.whiteboard_title") || "Whiteboard"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-indigo-600 mt-1" }, t("educator_hub.whiteboard_desc") || "Sketch ideas, build diagrams, and map thinking with graphic organizers and one-click image export."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("whiteboard"), "aria-label": hubFavoriteIds.includes("whiteboard") ? tr("hub.remove_favorite", "Remove from favorites") + ": Whiteboard" : tr("hub.add_favorite", "Add to favorites") + ": Whiteboard", title: hubFavoriteIds.includes("whiteboard") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("whiteboard");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("whiteboard") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "col-span-full mt-1 mb-[-0.25rem]", "data-hub-section-heading": "plan" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-black uppercase tracking-wide text-indigo-800" }, tr("educator_hub.section_plan_title", "Plan and create")), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 mt-1" }, tr("educator_hub.section_plan_desc", "Turn ideas and evidence into lessons, documents, and accessible learning materials."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-section-toggle": "plan", "aria-expanded": !hubCollapsedSections.includes("plan"), "aria-label": hubCollapsedSections.includes("plan") ? tr("hub.expand_section", "Expand section") : tr("hub.collapse_section", "Collapse section"), onClick: () => toggleHubSection("plan"), className: "min-h-11 min-w-11 rounded-lg border border-slate-300 bg-white text-slate-700 text-lg font-black hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubCollapsedSections.includes("plan") ? "+" : "-"))), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "throughline", "data-hub-label": "Learning Web: Unit Path", "data-hub-section": "plan" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", onClick: () => {
    setShowEducatorHub(false);
    setShowMindMap(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F9F5}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-amber-800" }, t("educator_hub.throughline_title") || "Learning Web: Unit Path"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-amber-700 mt-1" }, t("educator_hub.throughline_desc") || "Arrange lessons into a teachable sequence, then inspect linked standards and evidence in the shared Learning Web."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("throughline"), "aria-label": hubFavoriteIds.includes("throughline") ? tr("hub.remove_favorite", "Remove from favorites") + ": Learning Web: Unit Path" : tr("hub.add_favorite", "Add to favorites") + ": Learning Web: Unit Path", title: hubFavoriteIds.includes("throughline") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("throughline");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("throughline") ? "\u2605" : "\u2606")), "              ", /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "page-designer", "data-hub-label": "Page Designer", "data-hub-section": "plan" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_allo_studio_card", onClick: () => {
    setShowEducatorHub(false);
    setIsAlloStudioOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-rose-50 to-orange-50 border border-rose-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F3A8}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-rose-800" }, t("educator_hub.allo_studio_title") || "Page Designer"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-rose-600 mt-1" }, t("educator_hub.allo_studio_desc") || "Create flyers, worksheets, posters, and slide decks with accessible exports, reading order, alt text, and a hand/AI process record."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("page-designer"), "aria-label": hubFavoriteIds.includes("page-designer") ? tr("hub.remove_favorite", "Remove from favorites") + ": Page Designer" : tr("hub.add_favorite", "Add to favorites") + ": Page Designer", title: hubFavoriteIds.includes("page-designer") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("page-designer");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("page-designer") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "video-studio", "data-hub-label": "Video Studio", "data-hub-section": "plan" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_video_studio_card", onClick: () => {
    setShowEducatorHub(false);
    setIsVideoStudioOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-sky-50 to-indigo-50 border border-sky-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F3A5}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-sky-800" }, t("educator_hub.video_studio_title") || "Video Studio"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-sky-600 mt-1" }, t("educator_hub.video_studio_desc") || "Record, trim, caption, and export short videos, with prompt tools for NotebookLM and other AI video tools."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("video-studio"), "aria-label": hubFavoriteIds.includes("video-studio") ? tr("hub.remove_favorite", "Remove from favorites") + ": Video Studio" : tr("hub.add_favorite", "Add to favorites") + ": Video Studio", title: hubFavoriteIds.includes("video-studio") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("video-studio");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("video-studio") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "symbol-studio", "data-hub-label": "Symbol Studio", "data-hub-section": "plan" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_symbol_studio_card", onClick: () => {
    setShowEducatorHub(false);
    setIsSymbolStudioOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1FAA7}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-purple-800" }, t("educator_hub.symbol_studio_title") || "Symbol Studio"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-purple-600 mt-1" }, t("educator_hub.symbol_studio_desc") || "Create PCS-style icons for visual supports, AAC boards, and schedules \u2014 then edit them with image-to-image tools."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("symbol-studio"), "aria-label": hubFavoriteIds.includes("symbol-studio") ? tr("hub.remove_favorite", "Remove from favorites") + ": Symbol Studio" : tr("hub.add_favorite", "Add to favorites") + ": Symbol Studio", title: hubFavoriteIds.includes("symbol-studio") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("symbol-studio");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("symbol-studio") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "allosheet", "data-hub-label": "AlloSheet", "data-hub-section": "plan" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_allosheet_card", onClick: _openAlloSheet, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-emerald-50 to-cyan-50 border border-emerald-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F4CA}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-emerald-800" }, t("educator_hub.allosheet_title") || "AlloSheet (Pilot)"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-emerald-700 mt-1" }, t("educator_hub.allosheet_desc") || "Explore educator data with agent assistance, review every change before applying it, and run local audits."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("allosheet"), "aria-label": hubFavoriteIds.includes("allosheet") ? tr("hub.remove_favorite", "Remove from favorites") + ": AlloSheet" : tr("hub.add_favorite", "Add to favorites") + ": AlloSheet", title: hubFavoriteIds.includes("allosheet") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("allosheet");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("allosheet") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "col-span-full mt-1 mb-[-0.25rem]", "data-hub-section-heading": "teach" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-black uppercase tracking-wide text-indigo-800" }, tr("educator_hub.section_teach_title", "Teach and assess")), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 mt-1" }, tr("educator_hub.section_teach_desc", "Run activities, collect evidence, and respond to learner needs."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-section-toggle": "teach", "aria-expanded": !hubCollapsedSections.includes("teach"), "aria-label": hubCollapsedSections.includes("teach") ? tr("hub.expand_section", "Expand section") : tr("hub.collapse_section", "Collapse section"), onClick: () => toggleHubSection("teach"), className: "min-h-11 min-w-11 rounded-lg border border-slate-300 bg-white text-slate-700 text-lg font-black hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubCollapsedSections.includes("teach") ? "+" : "-"))), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "polls-signups", "data-hub-label": "Polls & Sign-ups", "data-hub-section": "teach" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_activities_card", onClick: () => {
    setShowEducatorHub(false);
    setShowRecentQrShares(true);
  }, className: "flex items-start gap-3 rounded-xl border border-teal-200 bg-teal-50 p-4 text-left transition-colors hover:bg-teal-100" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F5D3}\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-teal-800" }, t("educator_hub.activities_title") || "Polls & Sign-ups"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-teal-600 mt-1" }, t("educator_hub.activities_desc") || "Schedule a meeting, collect sign-ups, or run a quick word cloud or rating. Share by link or QR code \u2014 no account required."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("polls-signups"), "aria-label": hubFavoriteIds.includes("polls-signups") ? tr("hub.remove_favorite", "Remove from favorites") + ": Polls &amp; Sign-ups" : tr("hub.add_favorite", "Add to favorites") + ": Polls &amp; Sign-ups", title: hubFavoriteIds.includes("polls-signups") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("polls-signups");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("polls-signups") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "assessment-center", "data-hub-label": "Assessment Center", "data-hub-section": "teach" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_assessment_center_card", onClick: () => {
    setShowEducatorHub(false);
    setShowClassAnalytics(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-violet-50 to-indigo-50 border border-violet-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F5D2}\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-violet-800" }, t("educator_hub.assessment_center_title") || "Assessment Center"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-violet-600 mt-1" }, t("educator_hub.assessment_center_desc") || "Screening batteries, CBM probes, RTI decision aids, intervention logs, and student progress."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("assessment-center"), "aria-label": hubFavoriteIds.includes("assessment-center") ? tr("hub.remove_favorite", "Remove from favorites") + ": Assessment Center" : tr("hub.add_favorite", "Add to favorites") + ": Assessment Center", title: hubFavoriteIds.includes("assessment-center") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("assessment-center");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("assessment-center") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "dynamic-assessment", "data-hub-label": "Dynamic Assessment", "data-hub-section": "teach" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_dynamic_assessment_card", onClick: () => {
    setShowEducatorHub(false);
    setIsDynamicAssessmentOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1FA7A}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-blue-800" }, t("educator_hub.dynamic_assessment_title") || "Dynamic Assessment"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-blue-600 mt-1" }, t("educator_hub.dynamic_assessment_desc") || "Run test-teach-retest probes with graduated prompts, modifiability scoring, IEP goals, and family/teacher handoffs."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("dynamic-assessment"), "aria-label": hubFavoriteIds.includes("dynamic-assessment") ? tr("hub.remove_favorite", "Remove from favorites") + ": Dynamic Assessment" : tr("hub.add_favorite", "Add to favorites") + ": Dynamic Assessment", title: hubFavoriteIds.includes("dynamic-assessment") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("dynamic-assessment");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("dynamic-assessment") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "behavior-lens", "data-hub-label": "BehaviorLens", "data-hub-section": "teach" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_behavior_lens_card", onClick: () => {
    setShowEducatorHub(false);
    setShowBehaviorLens(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F441}\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-indigo-800" }, t("educator_hub.behavior_lens_title") || "BehaviorLens"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-indigo-600 mt-1" }, t("educator_hub.behavior_lens_desc") || "Collect ABC observations, build FBA/BIP data, and use 60+ tools for behavior support."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("behavior-lens"), "aria-label": hubFavoriteIds.includes("behavior-lens") ? tr("hub.remove_favorite", "Remove from favorites") + ": BehaviorLens" : tr("hub.add_favorite", "Add to favorites") + ": BehaviorLens", title: hubFavoriteIds.includes("behavior-lens") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("behavior-lens");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("behavior-lens") ? "\u2605" : "\u2606")), !hideSchoolProfessional && /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "report-writer", "data-hub-label": "Report Writer", "data-hub-section": "teach" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_report_writer_card", onClick: () => {
    setShowEducatorHub(false);
    setShowReportWriter(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-violet-50 to-purple-50 border border-violet-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F4DD}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-violet-800" }, t("educator_hub.report_writer_title") || "Report Writer"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-violet-600 mt-1" }, t("educator_hub.report_writer_desc") || "Draft clinical reports with fact chunks, accuracy checks, and developmental norms."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("report-writer"), "aria-label": hubFavoriteIds.includes("report-writer") ? tr("hub.remove_favorite", "Remove from favorites") + ": Report Writer" : tr("hub.add_favorite", "Add to favorites") + ": Report Writer", title: hubFavoriteIds.includes("report-writer") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("report-writer");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("report-writer") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "col-span-full mt-1 mb-[-0.25rem]", "data-hub-section-heading": "access" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-black uppercase tracking-wide text-indigo-800" }, tr("educator_hub.section_access_title", "Access and review")), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 mt-1" }, tr("educator_hub.section_access_desc", "Verify that materials work for every learner before sharing them."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-section-toggle": "access", "aria-expanded": !hubCollapsedSections.includes("access"), "aria-label": hubCollapsedSections.includes("access") ? tr("hub.expand_section", "Expand section") : tr("hub.collapse_section", "Collapse section"), onClick: () => toggleHubSection("access"), className: "min-h-11 min-w-11 rounded-lg border border-slate-300 bg-white text-slate-700 text-lg font-black hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubCollapsedSections.includes("access") ? "+" : "-"))), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "pdf-accessibility", "data-hub-label": "PDF Accessibility", "data-hub-section": "access" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", disabled: !!pdfBatchIntakeProgress, "data-help-key": "educator_hub_pdf_accessibility_card", onClick: () => {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "accessibility-lab", "data-hub-label": "Accessibility Lab", "data-hub-section": "access" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_accessibility_lab_card", onClick: () => {
    setShowEducatorHub(false);
    setIsAccessibilityLabOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-rose-50 to-amber-50 border border-rose-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F50D}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-rose-800" }, t("educator_hub.accessibility_lab_title") || "Accessibility Lab"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-rose-700 mt-1" }, t("educator_hub.accessibility_lab_desc") || "Check the student experience with student preview, keyboard and screen-reader checks, a live WCAG audit, and disability simulations."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("accessibility-lab"), "aria-label": hubFavoriteIds.includes("accessibility-lab") ? tr("hub.remove_favorite", "Remove from favorites") + ": Accessibility Lab" : tr("hub.add_favorite", "Add to favorites") + ": Accessibility Lab", title: hubFavoriteIds.includes("accessibility-lab") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("accessibility-lab");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("accessibility-lab") ? "\u2605" : "\u2606")), /* @__PURE__ */ React.createElement("div", { className: "col-span-full mt-1 mb-[-0.25rem]", "data-hub-section-heading": "extend" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-black uppercase tracking-wide text-indigo-800" }, tr("educator_hub.section_extend_title", "Extend and discover")), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 mt-1" }, tr("educator_hub.section_extend_desc", "Find community resources, professional learning, and leadership-level tools."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-section-toggle": "extend", "aria-expanded": !hubCollapsedSections.includes("extend"), "aria-label": hubCollapsedSections.includes("extend") ? tr("hub.expand_section", "Expand section") : tr("hub.collapse_section", "Collapse section"), onClick: () => toggleHubSection("extend"), className: "min-h-11 min-w-11 rounded-lg border border-slate-300 bg-white text-slate-700 text-lg font-black hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubCollapsedSections.includes("extend") ? "+" : "-"))), /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "community-catalog", "data-hub-label": "Community Catalog", "data-hub-section": "extend" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_community_catalog_card", onClick: () => {
    setShowEducatorHub(false);
    setIsCommunityCatalogOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F5C2}\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-amber-800" }, t("educator_hub.community_catalog_title") || "Community Catalog"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-amber-700 mt-1" }, t("educator_hub.community_catalog_desc") || "Browse open-licensed lessons, or submit your own for community review."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("community-catalog"), "aria-label": hubFavoriteIds.includes("community-catalog") ? tr("hub.remove_favorite", "Remove from favorites") + ": Community Catalog" : tr("hub.add_favorite", "Add to favorites") + ": Community Catalog", title: hubFavoriteIds.includes("community-catalog") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("community-catalog");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("community-catalog") ? "\u2605" : "\u2606")), !hideSchoolProfessional && /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "research-suite", "data-hub-label": "Research Suite", "data-hub-section": "extend" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_research_suite_card", onClick: () => {
    setShowEducatorHub(false);
    setIsResearchSuiteOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-purple-50 to-fuchsia-50 border border-purple-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F4C7}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-purple-800" }, t("educator_hub.research_suite_title") || "Research Suite"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-purple-700 mt-1" }, t("educator_hub.research_suite_desc") || "Run a named study: IRB tracking, consent provenance, Likert instruments, fidelity logs, and the study bundle export."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("research-suite"), "aria-label": hubFavoriteIds.includes("research-suite") ? tr("hub.remove_favorite", "Remove from favorites") + ": Research Suite" : tr("hub.add_favorite", "Add to favorites") + ": Research Suite", title: hubFavoriteIds.includes("research-suite") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("research-suite");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("research-suite") ? "\u2605" : "\u2606")), !hideSchoolProfessional && /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "professional-development", "data-hub-label": "Professional Development", "data-hub-section": "extend" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_professional_dev_card", onClick: () => {
    setShowEducatorHub(false);
    try {
    ...
    setIsCommunityCatalogOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-sky-50 to-indigo-50 border border-sky-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F393}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-sky-800" }, t("educator_hub.professional_dev_title") || "Professional Development"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-sky-700 mt-1" }, t("educator_hub.professional_dev_desc") || "Work through short, self-paced modules, take a knowledge check, and download a completion record."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("professional-development"), "aria-label": hubFavoriteIds.includes("professional-development") ? tr("hub.remove_favorite", "Remove from favorites") + ": Professional Development" : tr("hub.add_favorite", "Add to favorites") + ": Professional Development", title: hubFavoriteIds.includes("professional-development") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("professional-development");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("professional-development") ? "\u2605" : "\u2606")), !hideSchoolProfessional && /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "leadership-hub", "data-hub-label": "Leadership Hub", "data-hub-section": "extend" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_admin_hub_card", onClick: () => {
    setShowEducatorHub(false);
  ...
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("school-rewards") ? "\u2605" : "\u2606")), !hideSchoolProfessional && /* @__PURE__ */ React.createElement("div", { className: "relative group", "data-hub-id": "communications-studio", "data-hub-label": "Communications Studio", "data-hub-section": "extend" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-launch": "true", "data-help-key": "educator_hub_communications_studio_card", onClick: () => {
    setShowEducatorHub(false);
    openCommunicationsStudio();
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-sky-50 to-indigo-50 border border-sky-700 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u2709\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-sky-900" }, t("educator_hub.communications_studio_title") || "Communications Studio"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-sky-800 mt-1" }, t("educator_hub.communications_studio_desc") || "Family updates, batch report-card comments, recommendation letters and replies to families, drafted only from your notes. Codenames only, plain-language check, optional translation draft, send to your Drive. Nothing is emailed from here."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-hub-favorite": "true", "aria-pressed": hubFavoriteIds.includes("communications-studio"), "aria-label": hubFavoriteIds.includes("communications-studio") ? tr("hub.remove_favorite", "Remove from favorites") + ": Communications Studio" : tr("hub.add_favorite", "Add to favorites") + ": Communications Studio", title: hubFavoriteIds.includes("communications-studio") ? tr("hub.remove_favorite", "Remove from favorites") : tr("hub.add_favorite", "Add to favorites"), onClick: (event) => {
    event.stopPropagation();
    toggleHubFavorite("communications-studio");
  }, className: "absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-600 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" }, hubFavoriteIds.includes("communications-studio") ? "\u2605" : "\u2606")))));
}
