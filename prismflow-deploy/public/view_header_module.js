...
function HeaderBar(props) {
  ...
  return /* @__PURE__ */ React.createElement("header", { "aria-label": t("common.main_application_header"), className: `p-6 md:py-8 md:px-10 shadow-2xl no-print relative z-50 transition-all duration-500 ${theme === "contrast" ? "bg-black border-b-4 border-yellow-400" : "bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-purple-900 via-indigo-950 to-slate-900 text-white"}` }, /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-[98%] mx-auto relative" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: `text-3xl md:text-4xl font-black tracking-tight flex items-center gap-3 ${theme === "contrast" ? "text-yellow-400" : "text-white drop-shadow-sm"}` }, /* @__PURE__ */ React.createElement(Layers, { className: "w-10 h-10", "aria-hidden": "true" }), t("header.app_name"), /* @__PURE__ */ React.createElement("div", { className: `hidden md:flex items-center gap-1 ml-4 p-1 rounded-full border backdrop-blur-md shadow-sm select-none pointer-events-none ${theme === "contrast" ? "border-yellow-400 bg-black" : "bg-white/10 border-white/20"}` }, /* @__PURE__ */ React.createElement("div", { className: `px-3 py-1 rounded-full flex items-center gap-1.5 ${theme === "contrast" ? "text-yellow-400" : "text-green-200"}` }, /* @__PURE__ */ React.createElement(CheckCircle2, { size: 12, className: "fill-current opacity-50", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-black uppercase tracking-widest opacity-90" }, t("header.equitable"))), /* @__PURE__ */ React.createElement("div", { className: `w-px h-3 ${theme === "contrast" ? "bg-yellow-400" : "bg-white/10"}` }), /* @__PURE__ */ React.createElement("div", { className: `px-3 py-1 rounded-full flex items-center gap-1.5 ${theme === "contrast" ? "text-yellow-400" : "text-teal-200"}` }, /* @__PURE__ */ React.createElement(CheckCircle2, { size: 12, className: "fill-current opacity-50", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-black uppercase tracking-widest opacity-90" }, t("header.accessible"))), /* @__PURE__ */ React.createElement("div", { className: `w-px h-3 ${theme === "contrast" ? "bg-yellow-400" : "bg-white/10"}` }), /* @__PURE__ */ React.createElement("div", { className: `px-3 py-1 rounded-full flex items-center gap-1.5 ${theme === "contrast" ? "text-yellow-400" : "text-purple-200"}` }, /* @__PURE__ */ React.createElement(CheckCircle2, { size: 12, className: "fill-current opacity-50", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-black uppercase tracking-widest opacity-90" }, t("header.scaffolded"))))), /* @__PURE__ */ React.createElement("p", { className: `mt-2 text-sm font-medium opacity-90 ${theme === "contrast" ? "text-yellow-400" : "text-indigo-100"}` }, t("header.tagline")), /* @__PURE__ */ React.createElement("p", { className: `text-[11px] mt-1 ${theme === "contrast" ? "text-yellow-400" : "text-indigo-300/80"}` }, t("header.rights")), /* @__PURE__ */ React.createElement("p", { className: `text-[11px] mt-1 font-medium flex items-center gap-1 ${theme === "contrast" ? "text-red-400" : "text-orange-200"}` }, /* @__PURE__ */ React.createElement(AlertCircle, { size: 10 }), " ", t("header.pii_warning"))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-end gap-4 w-full lg:w-auto" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4 flex-wrap justify-end relative" }, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: `p-1.5 rounded-md ${focusMode ? "bg-indigo-500 text-white" : "bg-slate-200 text-slate-300 dark:bg-slate-600"}` }, /* @__PURE__ */ React.createElement(Eye, { size: 16 })), /* @__PURE__ */ React.createElement("div", { className: "text-left" }, /* @__PURE__ */ React.createElement("span", { className: "block text-xs font-bold" }, t("settings.text.bionic")), /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] opacity-70" }, t("settings.text.bionic_sub")))),
  ...
  ), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-bold flex items-center gap-1 text-slate-300 dark:text-slate-600" }, t("settings.text.size")), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-mono bg-slate-100 dark:bg-slate-700 px-1.5 py-0.5 rounded" }, baseFontSize, "px")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3", "data-help-key": "header_settings_text_size" }, /* @__PURE__ */ React.createElement("button", { onClick: () => {
  ...
  }, className: "p-1 rounded hover:bg-slate-100 dark:hover:bg-slate-700" }, /* @__PURE__ */ React.createElement(Maximize, { size: 14 })))), /* @__PURE__ */ React.createElement("div", { className: "border-t border-slate-100 dark:border-slate-700 pt-3 mt-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-bold flex items-center gap-1 text-slate-300 dark:text-slate-600" }, t("settings.text.line_height")), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-mono bg-slate-100 dark:bg-slate-700 px-1.5 py-0.5 rounded" }, lineHeight)), /* @__PURE__ */ React.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-bold flex items-center gap-1 text-slate-300 dark:text-slate-600" }, t("settings.text.spacing")), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-mono bg-slate-100 dark:bg-slate-700 px-1.5 py-0.5 rounded" }, letterSpacing, "em")), /* @__PURE__ */ React.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-bold flex items-center gap-1 text-slate-300 dark:text-slate-600" }, t("settings.reading_theme") || "\u{1F3A8} Reading Theme"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-mono bg-slate-100 dark:bg-slate-700 px-1.5 py-0.5 rounded" }, readingTheme === "default" ? "Default" : readingTheme)), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-300 mb-2" }, t("settings.reading_theme_desc") || "Background & text color for all content views"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-5 gap-1.5", role: "radiogroup", "aria-label": t("header.reading_theme_aria") || "Reading theme" }, [
  ...
  ), _isCanvasEnv && selectedVoice && selectedVoice.includes("_") && window._kokoroTTS && /* @__PURE__ */ React.createElement("div", { className: "mt-2 p-2 rounded-lg bg-slate-50 dark:bg-slate-700/50 border border-slate-400 dark:border-slate-600" }, /* @__PURE__ */ React.createElement("label", { className: "text-[11px] uppercase font-bold text-slate-300 block mb-1.5" }, t("header.voice_quality_label") || "Voice Quality"), /* @__PURE__ */ React.createElement("div", { className: "flex gap-1" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
        window._kokoroTTS.setQuality("fast");
      },
      className: `flex-1 text-[11px] font-bold px-2 py-1.5 rounded-md transition-all ${!window._kokoroTTS.quality || window._kokoroTTS.quality === "fast" ? "bg-indigo-500 text-white shadow-sm" : "bg-slate-200 dark:bg-slate-600 text-slate-300 dark:text-slate-300 hover:bg-slate-300"}`
    },
    "\u26A1 Fast (~43MB)"
  ), /* @__PURE__ */ React.createElement(
    "button",
  ...
  ), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] leading-tight" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-300 dark:text-slate-200 block" }, t("header.browser_tts_fallback_label") || "Browser-voice fallback"), /* @__PURE__ */ React.createElement("span", { className: "text-slate-300 dark:text-slate-400" }, t("header.browser_tts_fallback_desc") || "Read refused/failed sentences with the system voice instead of skipping.")))), _isCanvasEnv && leveledTextLanguage && leveledTextLanguage !== "English" && /* @__PURE__ */ React.createElement("div", { className: "mt-2 p-2 rounded-lg bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] uppercase font-bold text-blue-600 dark:text-blue-400" }, "Active TTS: ", leveledTextLanguage), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-blue-800 dark:text-blue-200 mt-0.5" }, window._piperTTS?.supportsLanguage(languageToTTSCode(leveledTextLanguage)) ? "Piper Neural Voice \u2014 auto-selected" : "Browser fallback \u2014 language not yet supported"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-blue-500/70 dark:text-blue-400/70 mt-0.5" }, t("header.kokoro_english_only") || "Kokoro voice applies to English content")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mt-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-[11px] uppercase font-bold text-slate-300 block mb-1" }, "Speed: ", voiceSpeed, "x"), /* @__PURE__ */ React.createElement(
    "input",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "flex-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-[11px] uppercase font-bold text-slate-300 block mb-1" }, "Volume: ", Math.round(voiceVolume * 100), "%"), /* @__PURE__ */ React.createElement(
    "input",
    {
      "aria-label": t("common.range_slider"),
      type: "range",
  ...
  ), isJoinPopoverOpen && /* @__PURE__ */ React.createElement("div", { className: "absolute top-full right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl p-3 border border-slate-400 z-[100] animate-in fade-in zoom-in-95" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-[11px] font-bold text-slate-300 mb-1 uppercase" }, t("session.host_id_optional")), /* @__PURE__ */ React.createElement(
    "input",
    {
