...
describe('wiring pins', () => {
    it('ships the panel and the testing seams, identically to the public mirror', () => {
        ...
        expect(Object.keys(T).sort()).toEqual(['CS_BATCH_SIZE', 'CS_DISCLOSURE', 'CS_FAMILY_TARGET_GRADE', 'CS_GRID_MAX', 'CS_LANGUAGES', 'CS_TEMPLATES', 'CS_TONES', 'csBatchTable', 'csBuildEvidence', 'csBuildPrompt', 'csBuildTranslateBatchPrompt', 'csChunk', 'csDraftToHtml', 'csEvidenceGaps', 'csEvidenceLine','csFindLikelyNames', 'csFlagSensitive', 'csGradeLabel', 'csJoinBatch', 'csLocalDate', 'csNormalizeCodename', 'csNumbersIn', 'csParseBatch', 'csParseGrid', 'csPrintHtml','csReadTeacherComments', 'csReadability', 'csReconcileBatch', 'csReplaceNames', 'csReplaceNamesInGrid', 'csRollupLine', 'csRosterIndex', 'csRowEvidence', 'csRowStats', 'csRowTranslation', 'csScrubPII', 'csSummarizeDashboardStudent', 'csTextStats', 'csUnknownGridCodenames']);
