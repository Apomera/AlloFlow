...
describe('Praxis School Psychologist 5403 diagnostic bank', () => {
  it('registers two ready 100-item batches with the exact ETS 32/23/20/25 diagnostic blueprint', () => {
  ...
  it('publishes zero-finding QA and exact deployment mirrors', () => {
    ...
    expect(qa.diagnosticBatch).toMatchObject({ batchCount: 2, batchSize: 100, categories: { 'permeating-practices': 32, 'student-level-services': 23, 'systems-level-services': 20, foundations: 25 } });
