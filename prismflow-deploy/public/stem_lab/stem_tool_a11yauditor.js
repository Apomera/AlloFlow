        ...
        tab === 'audit' && h('div', { className: 'space-y-4' },
          ...
          h('div', { role: 'button', tabIndex: 0, onKeyDown: function(e) { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); e.target.click(); } }, className: 'bg-white rounded-2xl border-2 border-teal-200 p-5 space-y-3' },
            ...
            auditInputMode === 'url' && h('div', null,
              ...
              h('p', { className: 'text-[10px] text-slate-500 mt-1' }, 'The AI will analyze the website\u2019s accessibility based on its known structure and common patterns.'),
              // Quick suggestions
            ...
            auditInputMode === 'html' && h('div', null,
              ...
              h('p', { className: 'text-[10px] text-slate-500 mt-1' }, 'Paste any HTML code \u2014 from a school project, a webpage, or generated by a coding tool. The AI will check it for accessibility issues.')
            ),
            ...
            auditInputMode === 'pdf' && h('div', { className: 'text-center py-4' },
              ...
              h('p', { className: 'text-[10px] text-slate-500 mb-3' }, 'The AI will check for: tagged structure, reading order, alt text on images, form labels, color contrast, language declaration, and heading hierarchy.'),
            ...
            auditInputMode === 'screenshot' && h('div', { className: 'text-center py-4' },
              ...
              h('p', { className: 'text-[10px] text-slate-500 mb-3' }, 'The AI will visually analyze the screenshot for: color contrast issues, missing labels, layout problems, text readability, and visual accessibility barriers.'),
          ...
          auditInputMode === 'social' && h('div', { className: 'bg-white rounded-2xl border-2 border-pink-200 p-5 space-y-3' },
            ...
            h('p', { className: 'text-[10px] text-slate-600' }, 'Checks: alt text, captions, CamelCase hashtags, emoji placement, readability, contrast, and text-in-images.')
          ),
          ...
          auditInputMode === 'gov' && h('div', { className: 'bg-white rounded-2xl border-2 border-amber-200 p-5 space-y-3' },
            ...
            h('p', { className: 'text-[10px] text-slate-500 mt-1' }, 'Checks WCAG 2.1 AA + ADA Coordinator info, accessibility statement, grievance procedure, PDF tagging, form accessibility, captions, and third-party tools.')
          ),
