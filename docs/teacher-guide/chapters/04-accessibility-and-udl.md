...
Offer supports in a way that does not announce who “needs” them. Normalize the use of tools, allow private choice or routing when possible, and avoid recording support choices as deficit data. Follow [Privacy and responsible AI](07-privacy-and-responsible-ai.md) and local policy.
...
For delivery planning, return to [Prepare a lesson](02-prepare-a-lesson.md) or continue to [Live sessions](03-live-sessions.md). For reusable classroom patterns, see [Classroom workflows](06-classroom-workflows.md).
