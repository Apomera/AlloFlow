...
function GuidedModeBanner({
  ...
  const _computedDone = step.id === "source-input" ? (inputText || "").trim().length > 20 : GUIDED_CLICK_STEPS.indexOf(step.id) !== -1 ? !!guidedEngaged : _generatedDone;
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("style", null, `@keyframes alloGuidedRingPulse{0%,100%{box-shadow:0 0 0 2px rgba(99,102,241,.7),0 0 22px rgba(99,102,241,.45)}50%{box-shadow:0 0 0 3px rgba(129,140,248,.95),0 0 36px rgba(99,102,241,.65)}}@media (prefers-reduced-motion: reduce){.allo-guided-ring{animation:none !important}.allo-guided-banner *,.allo-guided-dialog *{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important;scroll-behavior:auto !important}}`), guidedRect && guidedRect.width > 0 && !wizardOpen && /* @__PURE__ */ React.createElement("div", { "aria-hidden": "true", className: "allo-guided-ring", style: {
    position: "fixed",
