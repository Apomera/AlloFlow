...
(function () {
  ...
  function showcaseBuild(ctx) {
    ...
    function createStudioLook() {
      ...
      var poolTexture=new THREE.CanvasTexture(poolCanvas);poolTexture.encoding=THREE.sRGBEncoding;
      ...
      var contactTexture=new THREE.CanvasTexture(contactMap.canvas);contactTexture.encoding=THREE.sRGBEncoding;contactTexture.generateMipmaps=false;
    ...
    tool.render = function (ctx) {
      ...
      React.useEffect(function () {
        ...
        function refresh(){
          ...
          // Refresh a visible inspector, but keep an explicitly closed one closed.
          if(currentData.measureResult != null)refreshPatch.measureResult=m;
      ...
      var measured = data.measureResult && data.measureResult.isComplete !== false ? data.measureResult : retainedSelectionSummary(engine, retainedMeasurementRef);
