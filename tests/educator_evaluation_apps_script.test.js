...
function makeAppsScriptHarness() {
  ...
  class MockFile {
    constructor(id, name, content = '') { this.id = id; this.name = name; this.content = String(content); this.sharingAccess = 'PRIVATE'; }
    getId() { return this.id; }
  ...
  return {
    invoke, invokeError, rows, appendSheetRow, setSheetCell, sentMail, properties, driveFiles,
