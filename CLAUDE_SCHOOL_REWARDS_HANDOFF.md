...
- 2026-09-05: wrapper a11y probe (`scratch/school-rewards-wrapper-a11y-check.cjs`): 37/37 text elements pass in light/dark/forced; keyboard walk clean. Tour box gained `[data-tour="focus"]` ("Go to the highlighted control", Spanish "Ir al control resaltado") and `aria-labelledby="practice-tour-title"`; onboarding test added.
