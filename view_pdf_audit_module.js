...
function PdfAuditView(props) {
  ...
  return /* @__PURE__ */ React.createElement(
    "div",
    {
      ...
      role: "dialog",
      "aria-modal": "true",
      "aria-label": "PDF Accessibility Audit",
      tabIndex: -1,
      onClick: (e) => {
    ...
    /* @__PURE__ */ React.createElement("div", { className: "relative bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[92vh] overflow-y-auto border-2 border-indigo-200" }, /* @__PURE__ */ React.createElement("div", { className: "sticky top-0 z-20 flex justify-end p-2 bg-gradient-to-b from-white via-white/95 to-transparent pointer-events-none" }, /* @__PURE__ */ React.createElement(
    ...
    }, className: `px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${pdfWebMode ? "bg-white shadow text-indigo-700" : "text-slate-600 hover:text-slate-700"}` }, "\u{1F310} Website / HTML"))), pdfWebMode ? /* @__PURE__ */ React.createElement("div", { className: "text-left space-y-4" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-black text-slate-800 mb-1 text-center" }, "\u{1F310} Website & HTML Accessibility"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-600 text-center" }, "Audit a website URL or paste HTML for full WCAG 2.1 AA audit + remediation"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase", htmlFor: "web-audit-url" }, "Website URL"), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mt-1" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "url",
        id: "web-audit-url",
    ...
    }, className: "px-4 py-2.5 bg-indigo-600 text-white rounded-lg font-bold text-sm hover:bg-indigo-700 transition-colors", "aria-label": "Fetch website HTML" }, "\u{1F50D} Fetch")), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600 mt-1" }, "Or paste HTML source code directly below")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase", htmlFor: "web-audit-html" }, "HTML Source"), /* @__PURE__ */ React.createElement(
      "textarea",
      {
        id: "web-audit-html",
        rows: 8,
        placeholder: "Paste HTML source code here, or use Fetch above...",
      ...
      /* @__PURE__ */ React.createElement("p", { className: "text-sm font-bold text-indigo-600" }, "Drag & drop PDFs here"),
      ...
      /* @__PURE__ */ React.createElement("label", { htmlFor: "batch-pdf-input", className: "inline-block mt-2 px-4 py-1.5 bg-indigo-100 text-indigo-700 rounded-lg text-xs font-bold cursor-pointer hover:bg-indigo-200 transition-colors" }, "Browse Files")
    ), pdfBatchQueue.length > 0 && !pdfBatchSummary && /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs font-bold text-slate-600" }, pdfBatchQueue.length, " file", pdfBatchQueue.length !== 1 ? "s" : "", " queued"), !pdfBatchProcessing && /* @__PURE__ */ React.createElement("button", { onClick: () => setPdfBatchQueue([]), className: "text-xs text-red-400 hover:text-red-600 font-bold" }, "Clear All")), /* @__PURE__ */ React.createElement("div", { className: "max-h-40 overflow-y-auto space-y-1" }, pdfBatchQueue.map((item, idx) => /* @__PURE__ */ React.createElement("div", { key: item.id, className: `flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs ${item.status === "done" ? "bg-green-50" : item.status === "failed" ? "bg-red-50" : item.status === "processing" ? "bg-indigo-50 animate-pulse" : "bg-slate-50"}` }, /* @__PURE__ */ React.createElement("span", null, item.status === "done" ? "\u2705" : item.status === "failed" ? "\u274C" : item.status === "processing" ? "\u23F3" : "\u23F8\uFE0F"), /* @__PURE__ */ React.createElement("span", { className: "flex-1 truncate font-medium" }, item.fileName), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, (item.fileSize / (1024 * 1024)).toFixed(1), "MB"), item.result && /* @__PURE__ */ React.createElement("span", { className: `font-bold ${(item.result.afterScore || 0) >= 90 ? "text-green-600" : (item.result.afterScore || 0) >= 70 ? "text-amber-600" : "text-red-600"}` }, item.result.beforeScore, "\u2192", item.result.afterScore), item.error && /* @__PURE__ */ React.createElement("span", { className: "text-red-500 truncate max-w-[100px]", title: item.error }, "\u274C"), !pdfBatchProcessing && item.status === "pending" && /* @__PURE__ */ React.createElement("button", { onClick: () => setPdfBatchQueue((prev) => prev.filter((q) => q.id !== item.id)), className: "text-slate-300 hover:text-red-400" }, "\u2715"))))), pdfBatchProcessing && /* @__PURE__ */ React.createElement("div", { className: "mb-4 p-4 bg-indigo-50 rounded-xl border border-indigo-200" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-2" }, /* @__PURE__ */ React.createElement("span", { className: "animate-spin" }, "\u23F3"), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold text-indigo-700" }, "Processing ", pdfBatchCurrentIndex + 1, "/", pdfBatchQueue.length)), /* @__PURE__ */ React.createElement("div", { className: "w-full bg-indigo-200 rounded-full h-2 mb-2", role: "progressbar", "aria-label": "Batch remediation progress", "aria-valuenow": pdfBatchCurrentIndex + 1, "aria-valuemin": 0, "aria-valuemax": pdfBatchQueue.length }, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-600 h-2 rounded-full transition-all duration-500", style: { width: `${(pdfBatchCurrentIndex + 1) / pdfBatchQueue.length * 100}%` } })), /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-3" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs text-indigo-600 flex-1", role: "status", "aria-live": "polite" }, pdfBatchStep), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
          try {
...
<div class="footer">
  Generated by AlloFlow Accessibility Pipeline \xB7 ${date} \xB7 <a href="https://github.com/Apomera/AlloFlow" style="color:#6366f1">AlloFlow</a>
    ...
    }, className: "px-4 py-3 bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-xl text-sm font-bold hover:from-violet-700 hover:to-indigo-700 transition-all shadow-lg flex items-center gap-2" }, "\u{1F4CA} Dashboard")))) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "text-5xl mb-4" }, "\u{1F4C4}"), /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-black text-slate-800 mb-2" }, "PDF Uploaded: ", pdfAuditResult.fileName), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-600 mb-1" }, (pdfAuditResult.fileSize / (1024 * 1024)).toFixed(1), " MB"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-600 mb-4" }, "Choose how to process this PDF:"), /* @__PURE__ */ React.createElement("details", { open: true, className: "text-left mb-4 bg-slate-50 rounded-xl p-3 border border-slate-400" }, /* @__PURE__ */ React.createElement("summary", { className: "text-[11px] font-bold text-slate-600 uppercase tracking-widest cursor-pointer hover:text-indigo-600" }, "\u2699\uFE0F Pipeline Settings"), /* @__PURE__ */ React.createElement("div", { className: "mt-2 space-y-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[11px]" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-600" }, "Audit Passes: ", pdfAuditorCount), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, pdfAuditorCount <= 2 ? "Fast" : pdfAuditorCount <= 5 ? "Balanced" : pdfAuditorCount <= 7 ? "Thorough" : "Research-grade")), /* @__PURE__ */ React.createElement("input", { type: "range", min: "1", max: "10", value: pdfAuditorCount, onChange: (e) => setPdfAuditorCount(parseInt(e.target.value)), className: "w-full", "aria-label": "Number of audit passes" }), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[11px] text-slate-600" }, /* @__PURE__ */ React.createElement("span", null, "1 (quick)"), /* @__PURE__ */ React.createElement("span", null, "5 (default)"), /* @__PURE__ */ React.createElement("span", null, "10 (max)"))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[11px]" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-600" }, "Target Score: ", pdfTargetScore), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, pdfTargetScore >= 95 ? "Near-perfect" : pdfTargetScore >= 90 ? "Excellent" : pdfTargetScore >= 80 ? "Good" : "Minimum")), /* @__PURE__ */ React.createElement("input", { type: "range", min: "60", max: "100", step: "5", value: pdfTargetScore, onChange: (e) => setPdfTargetScore(parseInt(e.target.value)), className: "w-full", "aria-label": "Target accessibility score" }), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[11px] text-slate-600" }, /* @__PURE__ */ React.createElement("span", null, "60 (min)"), /* @__PURE__ */ React.createElement("span", null, "90 (default)"), /* @__PURE__ */ React.createElement("span", null, "100"))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[11px]" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-600" }, "Max Fix Passes: ", pdfAutoFixPasses), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, pdfAutoFixPasses === 0 ? "Disabled" : pdfAutoFixPasses <= 3 ? "Quick" : pdfAutoFixPasses <= 5 ? "Standard" : pdfAutoFixPasses <= 8 ? "Thorough" : "Maximum")), /* @__PURE__ */ React.createElement("input", { type: "range", min: "0", max: "15", value: pdfAutoFixPasses, onChange: (e) => setPdfAutoFixPasses(parseInt(e.target.value)), className: "w-full", "aria-label": "Max fix pass count" }), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[11px] text-slate-600" }, /* @__PURE__ */ React.createElement("span", null, "0 (off)"), /* @__PURE__ */ React.createElement("span", null, "8 (default)"), /* @__PURE__ */ React.createElement("span", null, "15 (max)"))), /* @__PURE__ */ React.createElement("label", { className: "flex items-start gap-2 text-[11px] text-slate-700 cursor-pointer bg-indigo-50 rounded-lg p-2 border border-indigo-200" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: pdfAutoContinue, onChange: (e) => setPdfAutoContinue(e.target.checked), className: "mt-0.5 rounded", "aria-label": "Auto-continue remediation until target score" }), /* @__PURE__ */ React.createElement("span", null, "\u{1F501} ", /* @__PURE__ */ React.createElement("b", null, "Auto-continue"), " until score \u2265 ", /* @__PURE__ */ React.createElement("b", null, pdfTargetScore), " \u2014 runs up to 3 extra rounds of fixes automatically, stopping early when no more progress is possible.")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[11px]" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-600" }, "Polish Passes: ", pdfPolishPasses), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, pdfPolishPasses === 0 ? "None" : pdfPolishPasses === 1 ? "Standard" : "Extra polish")), /* @__PURE__ */ React.createElement("input", { type: "range", min: "0", max: "3", value: pdfPolishPasses, onChange: (e) => setPdfPolishPasses(parseInt(e.target.value)), className: "w-full", "aria-label": "Polish pass count" }), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[11px] text-slate-600" }, /* @__PURE__ */ React.createElement("span", null, "0"), /* @__PURE__ */ React.createElement("span", null, "2 (default)"), /* @__PURE__ */ React.createElement("span", null, "3"))))), /* @__PURE__ */ React.createElement("details", { className: "bg-slate-50 rounded-lg border border-slate-400 overflow-hidden mb-3" }, /* @__PURE__ */ React.createElement("summary", { className: "px-3 py-2 text-[11px] font-bold text-slate-600 uppercase tracking-widest cursor-pointer hover:bg-slate-100 transition-colors" }, "\u2728 Output Style & Branding (optional)"), /* @__PURE__ */ React.createElement("div", { className: "px-3 pb-3 pt-1 space-y-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase mb-0.5" }, "Brand Colors"), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600 mb-1" }, "Where do the colors come from?"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-700" }, "\u{1F3A8} Match Original"),
      /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600" }, "Extract colors from this PDF")
      ...
      /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-700" }, "\u{1F4CE} Upload Brand Guide"),
      /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600" }, "Use a different doc/logo"),
...
{"headingColor":"hex","accentColor":"hex","bgColor":"hex","headerBg":"hex","headerText":"hex","tableBg":"hex","tableBorder":"hex","bodyFont":"CSS font-family","headingFont":"CSS font-family"}`,
      ...
      /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-700" }, "\u2B1C No Branding"),
      /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600" }, "Use default palette")
    )), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] text-slate-600 italic mt-1.5 leading-snug" }, `Tip: If you pick a specific Style Seed below (not "Match Original"), that seed's colors override your branding choice. To use your brand colors, pair them with the Match Original seed.`)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase mb-0.5" }, "Style Seed"), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600 mb-1.5" }, "What design style should the AI apply? WCAG compliance guaranteed by deterministic sanitizer."), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1" }, [
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, savedKeys.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "mt-2" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 font-bold mb-1" }, "Your Custom Styles"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1" }, savedKeys.map((k) => {
        var s = saved[k];
        ...
        }, className: "px-1 py-1.5 border border-l-0 border-slate-200 rounded-r-lg text-[11px] text-red-400 hover:text-red-600 hover:bg-red-50" }, "\u2715"));
      }))), /* @__PURE__ */ React.createElement("details", { className: "mt-2" }, /* @__PURE__ */ React.createElement("summary", { className: "text-[11px] font-bold text-indigo-500 cursor-pointer hover:text-indigo-700" }, "+ Create Custom Style"), /* @__PURE__ */ React.createElement("div", { className: "mt-2 bg-slate-50 rounded-lg p-3 border border-slate-400 space-y-2" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { htmlFor: "custom-style-name", className: "text-[11px] text-slate-600 font-bold" }, "Style Name"), /* @__PURE__ */ React.createElement("input", { id: "custom-style-name", type: "text", placeholder: "My Style", "aria-label": "Custom style name", className: "w-full px-2 py-1 text-[11px] border border-slate-400 rounded" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { htmlFor: "custom-style-font", className: "text-[11px] text-slate-600 font-bold" }, "Font"), /* @__PURE__ */ React.createElement("select", { id: "custom-style-font", "aria-label": "Font family", className: "w-full px-2 py-1 text-[11px] border border-slate-400 rounded" }, /* @__PURE__ */ React.createElement("option", { value: "'Inter', system-ui, sans-serif" }, "Inter (Clean)"), /* @__PURE__ */ React.createElement("option", { value: "'Georgia', serif" }, "Georgia (Serif)"), /* @__PURE__ */ React.createElement("option", { value: "'Atkinson Hyperlegible', sans-serif" }, "Atkinson (A11y)"), /* @__PURE__ */ React.createElement("option", { value: "'Lexend', sans-serif" }, "Lexend (Readable)"), /* @__PURE__ */ React.createElement("option", { value: "'Comic Sans MS', cursive" }, "Comic Sans (Fun)"), /* @__PURE__ */ React.createElement("option", { value: "'Times New Roman', serif" }, "Times (Classic)"), /* @__PURE__ */ React.createElement("option", { value: "'OpenDyslexic', sans-serif" }, "OpenDyslexic")))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { htmlFor: "custom-style-heading", className: "text-[11px] text-slate-600 font-bold" }, "Heading Color"), /* @__PURE__ */ React.createElement("input", { id: "custom-style-heading", type: "color", defaultValue: "#1e3a5f", "aria-label": "Heading color", className: "w-full h-6 rounded border border-slate-400 cursor-pointer" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { htmlFor: "custom-style-accent", className: "text-[11px] text-slate-600 font-bold" }, "Accent Color"), /* @__PURE__ */ React.createElement("input", { id: "custom-style-accent", type: "color", defaultValue: "#2563eb", "aria-label": "Accent color", className: "w-full h-6 rounded border border-slate-400 cursor-pointer" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { htmlFor: "custom-style-bg", className: "text-[11px] text-slate-600 font-bold" }, "Background"), /* @__PURE__ */ React.createElement("input", { id: "custom-style-bg", type: "color", defaultValue: "#ffffff", "aria-label": "Background color", className: "w-full h-6 rounded border border-slate-400 cursor-pointer" }))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
      ...
      return /* @__PURE__ */ React.createElement("div", { className: "mt-2 bg-gradient-to-br from-slate-50 to-indigo-50 border border-indigo-200 rounded-xl p-3 text-xs" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-black text-indigo-700 uppercase tracking-wider" }, "\u{1F4CB} Pre-flight triage"), /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-slate-500" }, "based on the audit above, no extra API calls")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-2 mb-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-slate-400 rounded-lg px-2 py-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider" }, "Pages"), /* @__PURE__ */ React.createElement("div", { className: "text-sm font-black text-slate-800" }, pc)), /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-slate-400 rounded-lg px-2 py-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider" }, "Source type"), /* @__PURE__ */ React.createElement("div", { className: `text-sm font-black ${isScanned ? "text-amber-700" : "text-emerald-700"}` }, isScanned ? "Scanned" : "Text layer")), /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-slate-400 rounded-lg px-2 py-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider" }, "Images"), /* @__PURE__ */ React.createElement("div", { className: "text-sm font-black text-slate-800" }, hasImg ? "Yes" : "\u2014")), /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-slate-400 rounded-lg px-2 py-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider" }, "Tables"), /* @__PURE__ */ React.createElement("div", { className: "text-sm font-black text-slate-800" }, hasTbl ? "Yes" : "\u2014"))), critCount + seriousCount + moderateCount + minorCount > 0 && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 flex-wrap text-[11px] mb-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 font-bold" }, "Issues to fix:"), critCount > 0 && /* @__PURE__ */ React.createElement("span", { className: "px-1.5 py-0.5 bg-red-100 text-red-700 rounded font-bold" }, critCount, " critical"), seriousCount > 0 && /* @__PURE__ */ React.createElement("span", { className: "px-1.5 py-0.5 bg-amber-100 text-amber-700 rounded font-bold" }, seriousCount, " serious"), moderateCount > 0 && /* @__PURE__ */ React.createElement("span", { className: "px-1.5 py-0.5 bg-yellow-100 text-yellow-700 rounded font-bold" }, moderateCount, " moderate"), minorCount > 0 && /* @__PURE__ */ React.createElement("span", { className: "px-1.5 py-0.5 bg-slate-100 text-slate-600 rounded font-bold" }, minorCount, " minor")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 flex-wrap text-[11px] mb-2.5" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 font-bold" }, "Estimated remediation time:"), /* @__PURE__ */ React.createElement("span", { className: "px-2 py-0.5 bg-indigo-100 text-indigo-800 rounded font-black" }, fmt(estLow), "\u2013", fmt(estHigh)), isScanned && /* @__PURE__ */ React.createElement("span", { className: "text-amber-700 text-[10px]" }, "\u2191 scanned PDFs take longer (OCR required)")), /* @__PURE__ */ React.createElement("div", { className: "pt-2 border-t border-indigo-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-600 font-bold uppercase tracking-wider mb-1.5" }, "Post-fix mode"), /* @__PURE__ */ React.createElement("div", { className: "flex gap-1.5 flex-wrap", role: "radiogroup", "aria-label": "Post-fix mode" }, [
        ...
        m.label
      )), /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-slate-500 self-center italic" }, pdfFixMode === "auto" ? "Fix & Verify runs, result commits." : pdfFixMode === "review" ? "Fix & Verify runs, then opens Diff view." : "Fix & Verify runs, then opens Document Builder."))), /* @__PURE__ */ React.createElement("div", { className: "pt-2 mt-2 border-t border-indigo-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-600 font-bold uppercase tracking-wider mb-1.5" }, "Quick downloads (no remediation needed)"), /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: async () => {
            try {
      ...
      _closePdfAuditModal();
    }, className: "text-xs text-slate-600 hover:text-slate-600 font-bold" }, "Cancel"))) : pdfAuditLoading ? /* @__PURE__ */ React.createElement("div", { className: "p-12 text-center", role: "status", "aria-live": "polite" }, /* @__PURE__ */ React.createElement("div", { className: "text-5xl mb-4 animate-pulse", "aria-hidden": "true" }, "\u267F"), /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-black text-slate-800 mb-2" }, "Auditing PDF Accessibility..."), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-600" }, "Running 5 parallel WCAG 2.1 AA audits with triangulation. This may take 15-30 seconds."), /* @__PURE__ */ React.createElement("div", { className: "mt-4 w-56 h-2.5 bg-slate-200 rounded-full mx-auto overflow-hidden", role: "progressbar", "aria-label": "Audit in progress", "aria-valuemin": 0, "aria-valuemax": 100 }, /* @__PURE__ */ React.createElement("div", { className: "h-full bg-gradient-to-r from-indigo-500 via-purple-500 to-violet-500 rounded-full", style: { animation: "auditProgress 25s ease-out forwards" } })), /* @__PURE__ */ React.createElement("style", null, `@keyframes auditProgress { 0% { width: 5%; } 20% { width: 30%; } 50% { width: 55%; } 75% { width: 75%; } 90% { width: 85%; } 100% { width: 92%; } } @keyframes fadeInUp { from { opacity: 0; transform: translateY(12px); } to { opacity: 1; transform: translateY(0); } }`), /* @__PURE__ */ React.createElement("div", { className: "mt-6 text-left bg-gradient-to-br from-white via-indigo-50/50 to-violet-50/40 border border-indigo-200/70 rounded-2xl p-5 space-y-3 mx-auto max-w-lg", style: { animation: "fadeInUp 0.9s ease-out 3s both" } }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "shrink-0 w-11 h-11 rounded-xl bg-gradient-to-br from-indigo-600 to-violet-700 flex items-center justify-center shadow-lg shadow-indigo-200" }, /* @__PURE__ */ React.createElement("span", { className: "text-white font-black text-base" }, "K")), /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold text-slate-800" }, "Knowbility"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold text-indigo-600 bg-indigo-100 px-1.5 py-0.5 rounded-full uppercase tracking-wider" }, "Accessibility Partner"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold text-emerald-600 bg-emerald-100 px-1.5 py-0.5 rounded-full uppercase tracking-wider" }, "501(c)(3) Nonprofit")), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600 leading-relaxed mt-1.5" }, /* @__PURE__ */ React.createElement("strong", { className: "text-slate-700" }, "Creating an inclusive digital world for people with disabilities"), " \u2014 Knowbility is a nonprofit organization based in Austin, TX, and an award-winning leader in accessible information technology since 1999."))), /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-200 p-3 space-y-2", style: { animation: "fadeInUp 0.7s ease-out 5s both" } }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-amber-800 uppercase tracking-wider flex items-center gap-1.5" }, "\u2696\uFE0F Why Digital Accessibility Matters"), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-700 leading-relaxed" }, /* @__PURE__ */ React.createElement("strong", { className: "text-amber-900" }, "The Americans with Disabilities Act (ADA) Title II"), " requires state and local governments to make their digital services accessible to people with disabilities. In April 2024, the Department of Justice published ", /* @__PURE__ */ React.createElement("strong", null, "final regulations"), " mandating ", /* @__PURE__ */ React.createElement("strong", null, "WCAG 2.1 Level AA"), " compliance for all web content and mobile applications, with compliance deadlines ranging from ", /* @__PURE__ */ React.createElement("strong", null, "April 2026 to April 2027"), " depending on population size."), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600 leading-relaxed" }, "But compliance is just the baseline. Accessible documents benefit ", /* @__PURE__ */ React.createElement("strong", null, "everyone"), " \u2014 not just the 1 in 4 Americans living with a disability:"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white/90 rounded-lg p-2 border border-amber-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-emerald-700" }, "\u{1F30D} Broader Reach"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Accessible content works on any device, any bandwidth, any assistive technology \u2014 reaching more users")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/90 rounded-lg p-2 border border-amber-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-blue-700" }, "\u{1F50D} Better SEO & Findability"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Structured headings, alt text, and semantic HTML improve search ranking and content discovery")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/90 rounded-lg p-2 border border-amber-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-violet-700" }, "\u{1F9E0} Cognitive Clarity"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Clear navigation, consistent layouts, and plain language help all users \u2014 especially in high-cognitive-load contexts")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/90 rounded-lg p-2 border border-amber-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-rose-700" }, "\u26A1 Future-Proofing"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "WCAG-compliant content adapts to new devices, AI readers, and emerging assistive technologies"))), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-amber-700 italic leading-relaxed" }, "WCAG 2.1 AA isn't just about avoiding litigation \u2014 it's about building documents that are perceivable, operable, understandable, and robust for every human being.")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-indigo-100 p-2.5 space-y-0.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-indigo-600 uppercase tracking-wider" }, "\u{1F50D} Auditing & Testing"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Expert WCAG audits and document remediation by certified professionals")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-indigo-100 p-2.5 space-y-0.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-indigo-600 uppercase tracking-wider" }, "\u267F AccessWorks"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Real-world usability testing by people who use assistive technology daily")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-indigo-100 p-2.5 space-y-0.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-indigo-600 uppercase tracking-wider" }, "\u{1F4C4} Document Remediation"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Specialist team for PDF and MS Office docs \u2014 full usability with assistive technology")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-indigo-100 p-2.5 space-y-0.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-indigo-600 uppercase tracking-wider" }, "\u{1F393} Training & AccessU"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Annual conference and on-demand courses \u2014 beginner to advanced accessibility skills"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white/70 rounded-lg border border-indigo-100 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "flex gap-4 justify-center text-center" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase" }, "Web"), /* @__PURE__ */ React.createElement("a", { href: "https://knowbility.org?utm_source=alloflow&utm_medium=referral&utm_campaign=expert_remediation", target: "_blank", rel: "noopener noreferrer", className: "text-[11px] font-bold text-indigo-600 hover:text-indigo-800 underline decoration-indigo-300" }, "knowbility.org")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase" }, "Email"), /* @__PURE__ */ React.createElement("a", { href: "mailto:knowbility@knowbility.org", className: "text-[11px] font-bold text-indigo-600 hover:text-indigo-800 underline decoration-indigo-300" }, "knowbility@knowbility.org")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase" }, "Phone"), /* @__PURE__ */ React.createElement("a", { href: "tel:+15125273138", className: "text-[11px] font-bold text-slate-700 hover:text-indigo-700" }, "512-527-3138"))), /* @__PURE__ */ React.createElement("div", { className: "mt-2 pt-2 border-t border-indigo-100 text-center" }, /* @__PURE__ */ React.createElement("a", { href: "https://knowbility.org/services/project-inquiry", target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-1.5 px-4 py-1.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-full text-[11px] font-bold hover:from-indigo-700 hover:to-violet-700 transition-all shadow-md shadow-indigo-200" }, "Request a Project Inquiry \u2192"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex-1 border-t border-indigo-100" }), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-indigo-600 font-medium uppercase tracking-wider" }, "W3C/WAI \xB7 IAAP-Certified \xB7 Clinton White House Recognized \xB7 FCC Innovation Award"), /* @__PURE__ */ React.createElement("div", { className: "flex-1 border-t border-indigo-100" })))) : pdfAuditResult && pdfAuditResult.score < 0 ? /* @__PURE__ */ React.createElement("div", { role: "alert", className: "rounded-2xl overflow-hidden border border-slate-400 shadow-lg" }, /* @__PURE__ */ React.createElement("div", { className: "p-6 text-center bg-gradient-to-r from-slate-600 to-slate-700 text-white" }, /* @__PURE__ */ React.createElement("div", { className: "text-4xl mb-2" }, "\u26A0\uFE0F"), /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-bold" }, "Audit Unavailable"), /* @__PURE__ */ React.createElement("p", { className: "text-sm opacity-80 mt-1" }, "The AI accessibility audit could not complete. This is usually caused by a temporary API issue, rate limiting, or a very large/complex PDF.")), /* @__PURE__ */ React.createElement("div", { className: "p-4 bg-white space-y-3" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-600 text-center" }, "You can still proceed \u2014 Fix & Verify will transform the document and run a full audit afterward."), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 justify-center" }, /* @__PURE__ */ React.createElement("button", { onClick: async () => {
      setPdfAuditResult(null);
      ...
      return /* @__PURE__ */ React.createElement("details", { className: "bg-slate-50 rounded-lg border border-slate-400 overflow-hidden", open: true }, /* @__PURE__ */ React.createElement("summary", { className: "px-3 py-2 text-[11px] font-bold text-slate-700 uppercase tracking-widest cursor-pointer hover:bg-slate-100 transition-colors" }, "Score Breakdown"), /* @__PURE__ */ React.createElement("div", { className: "px-3 pb-3 text-[11px] text-slate-700 space-y-2 mt-1" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-lg border border-slate-400 p-2.5 space-y-1" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between" }, /* @__PURE__ */ React.createElement("span", null, "Total checks performed"), /* @__PURE__ */ React.createElement("span", { className: "font-bold" }, totalChecks)), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-green-700 font-bold" }, /* @__PURE__ */ React.createElement("span", null, "Passed"), /* @__PURE__ */ React.createElement("span", null, passCount, " (", passRate, "%)")), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-red-700 font-bold" }, /* @__PURE__ */ React.createElement("span", null, "Issues found"), /* @__PURE__ */ React.createElement("span", null, totalIssues)), totalIssues > 0 && /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 pl-2" }, [critCount > 0 && `${critCount} critical`, seriousCount > 0 && `${seriousCount} serious`, modCount > 0 && `${modCount} moderate`, minCount > 0 && `${minCount} minor`].filter(Boolean).join(", "))), /* @__PURE__ */ React.createElement("div", { className: `grid ${isBlended ? "grid-cols-2" : "grid-cols-1"} gap-2` }, /* @__PURE__ */ React.createElement("div", { className: "bg-purple-100 rounded-lg border-2 border-purple-300 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-baseline mb-1" }, /* @__PURE__ */ React.createElement("span", { className: "font-black text-purple-900 text-sm" }, aiScore, /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold text-purple-500" }, "/100")), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-black text-purple-600 uppercase" }, "AI Rubric")), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-purple-800 space-y-0.5" }, /* @__PURE__ */ React.createElement("div", null, "Starts at 100, deducts per issue type"), totalIssues > 0 && /* @__PURE__ */ React.createElement("div", null, totalIssues, " issues found"), passBenefit > 0 && /* @__PURE__ */ React.createElement("div", { className: "text-green-700 font-bold" }, passCount, " passes recovered +", passBenefit, " pts")), /* @__PURE__ */ React.createElement("details", { className: "mt-1 text-[11px]" }, /* @__PURE__ */ React.createElement("summary", { className: "cursor-pointer text-purple-500 hover:text-purple-800 font-bold" }, "How AI scores"), /* @__PURE__ */ React.createElement("div", { className: "mt-1 space-y-0.5 text-purple-700" }, /* @__PURE__ */ React.createElement("div", null, "Critical: -15 each (lang, title, alt, landmark, contrast)"), /* @__PURE__ */ React.createElement("div", null, "Major: -10 each (headings, tables, forms)"), /* @__PURE__ */ React.createElement("div", null, "Minor: -5 each (skip-nav, landmarks, links, lists)"), /* @__PURE__ */ React.createElement("div", null, "Passes reduce total deductions proportionally")))), isBlended && axeAudit && /* @__PURE__ */ React.createElement("div", { className: "bg-blue-100 rounded-lg border-2 border-blue-300 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-baseline mb-1" }, /* @__PURE__ */ React.createElement("span", { className: "font-black text-blue-900 text-sm" }, axeScore, /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold text-blue-500" }, "/100")), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-black text-blue-600 uppercase" }, "axe-core")), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-blue-800 space-y-0.5" }, /* @__PURE__ */ React.createElement("div", null, "Deque automated WCAG 2.1 AA checker"), /* @__PURE__ */ React.createElement("div", null, axeAudit.totalViolations, " violation", axeAudit.totalViolations !== 1 ? "s" : "", ", ", axeAudit.totalPasses, " passed")), /* @__PURE__ */ React.createElement("details", { className: "mt-1 text-[11px]" }, /* @__PURE__ */ React.createElement("summary", { className: "cursor-pointer text-blue-500 hover:text-blue-800 font-bold" }, "How axe-core scores"), /* @__PURE__ */ React.createElement("div", { className: "mt-1 space-y-0.5 text-blue-700" }, /* @__PURE__ */ React.createElement("div", null, "100 - (critical x15) - (serious x10) - (moderate x5) - (minor x2)"), (axeAudit.critical || []).length > 0 && /* @__PURE__ */ React.createElement("div", { className: "text-red-600" }, axeAudit.critical.length, " critical: ", axeAudit.critical.map((v) => v.id).join(", ")), (axeAudit.serious || []).length > 0 && /* @__PURE__ */ React.createElement("div", { className: "text-amber-600" }, axeAudit.serious.length, " serious: ", axeAudit.serious.map((v) => v.id).join(", ")), (axeAudit.moderate || []).length > 0 && /* @__PURE__ */ React.createElement("div", null, axeAudit.moderate.length, " moderate: ", axeAudit.moderate.map((v) => v.id).join(", ")), (axeAudit.minor || []).length > 0 && /* @__PURE__ */ React.createElement("div", null, axeAudit.minor.length, " minor: ", axeAudit.minor.map((v) => v.id).join(", ")), axeAudit.totalViolations === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-green-700 font-bold" }, "No violations detected"))))), isBlended && /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-lg border-2 border-slate-300 p-2.5 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-sm" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, "("), /* @__PURE__ */ React.createElement("span", { className: "text-purple-800 font-black" }, aiScore), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 mx-1" }, "+"), /* @__PURE__ */ React.createElement("span", { className: "text-blue-800 font-black" }, axeScore), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, ")"), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 mx-1" }, "/"), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 font-bold" }, "2"), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 mx-2" }, "="), /* @__PURE__ */ React.createElement("span", { className: "font-black text-slate-900 text-lg" }, displayedScore), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 text-xs" }, "/100")), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 mt-0.5" }, "Average of both engines (equal weight)"))));
      ...
      return /* @__PURE__ */ React.createElement("div", { className: "mt-3 bg-white rounded-xl border border-slate-400 p-3 space-y-2", role: "region", "aria-label": "Pipeline progress tracker" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5 text-[11px]" }, steps.map((s, i) => {
      ...
      })), context && /* @__PURE__ */ React.createElement("div", { className: "text-[11px] bg-gradient-to-r from-slate-50 to-indigo-50 rounded-xl px-4 py-3 border border-slate-400 space-y-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-slate-800 font-semibold leading-relaxed whitespace-pre-line" }, "\u{1F504} ", context.what), /* @__PURE__ */ React.createElement("div", { className: "text-slate-600 leading-relaxed border-t border-slate-200 pt-1.5" }, "\u{1F4A1} ", /* @__PURE__ */ React.createElement("span", { className: "font-medium" }, "Why this matters:"), " ", context.why)));
    })(), boringPalettePrompt && /* @__PURE__ */ React.createElement("div", { className: "mt-3 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-xl border border-amber-200 p-3 animate-in fade-in duration-300" }, /* @__PURE__ */ React.createElement("div", { className: "text-xs font-bold text-amber-800 mb-1.5" }, "\u{1F3A8} The original document has minimal styling"), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-amber-700 mb-2" }, "Would you like to keep the original look or apply a theme?"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5" }, [
      ...
      return /* @__PURE__ */ React.createElement("div", { key: ci, className: `flex items-center gap-x-2 gap-y-1 px-3 py-2 rounded-lg border text-xs flex-wrap ${isWorking ? "bg-indigo-50 border-indigo-200 animate-pulse" : chunk.score >= 80 ? "bg-green-50 border-green-200" : chunk.score >= 60 ? "bg-amber-50 border-amber-200" : "bg-red-50 border-red-200"}` }, /* @__PURE__ */ React.createElement("span", null, isWorking ? "\u23F3" : chunk.score >= 80 ? "\u2705" : chunk.score >= 60 ? "\u{1F7E1}" : "\u{1F534}"), /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-800" }, "\xA7", (chunk.index || ci) + 1), !isWorking && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "text-slate-400", "aria-hidden": "true" }, "\xB7"), /* @__PURE__ */ React.createElement("span", { className: "text-slate-700" }, "WCAG"), /* @__PURE__ */ React.createElement("span", { className: `font-black ${scoreColor}` }, chunk.score, "/100"), totalFixes > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "text-slate-400", "aria-hidden": "true" }, "\xB7"), /* @__PURE__ */ React.createElement(
        ...
        totalFixes !== 1 ? "es" : "",
        " applied"
      )), totalFixes === 0 && !chunk.usedOriginal && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "text-slate-400", "aria-hidden": "true" }, "\xB7"), chunk.score >= 80 ? /* @__PURE__ */ React.createElement("span", { className: "text-emerald-700 italic", title: "This section already meets WCAG accessibility standards \u2014 no fixes were needed." }, "\u2713 no fixes needed") : chunk.score >= 60 ? /* @__PURE__ */ React.createElement("span", { className: "text-amber-700 italic", title: `Score ${chunk.score}/100 \u2014 the section has WCAG issues, but none of them are ones this pipeline can fix automatically. Manual review recommended (e.g. complex tables, color-meaning, decorative-vs-informative images).` }, "\u26A0 no auto-fix available \xB7 manual review") : /* @__PURE__ */ React.createElement("span", { className: "text-red-700 italic", title: `Score ${chunk.score}/100 \u2014 significant WCAG issues remain. The pipeline couldn't auto-fix them; this section needs manual remediation before publishing.` }, "\u26A0 manual remediation required")), chunk.wasRetried && /* @__PURE__ */ React.createElement("span", { className: "text-amber-700 font-bold", title: "AI had to retry this section once after the first attempt failed integrity or token-preservation checks." }, "\u21BB retried"), chunk.aiVerified && !chunk.usedOriginal && /* @__PURE__ */ React.createElement("span", { className: "text-emerald-700", title: "AI content-preservation check passed \u2014 the section's text content was preserved through the rewrite." }, "\u2713 content verified"), chunk.usedOriginal && /* @__PURE__ */ React.createElement("span", { className: "text-red-700 font-bold", title: "AI rewrite failed or was rejected for this section \u2014 only deterministic (rule-based) fixes were applied. The section is still more accessible than the original, just less so than successfully AI-fixed sections." }, "AI skipped \xB7 rule-based only")), isWorking && /* @__PURE__ */ React.createElement("span", { className: "ml-auto text-indigo-600 font-bold" }, "Fixing..."));
    }))), /* @__PURE__ */ React.createElement("div", { className: "mt-4 bg-gradient-to-br from-sky-50 via-blue-50/40 to-indigo-50/30 border border-sky-200/60 rounded-2xl p-5 space-y-3", style: { animation: "fadeInUp 0.9s ease-out 1.5s both" } }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-sky-500 to-blue-600 flex items-center justify-center shadow-lg shadow-sky-200" }, /* @__PURE__ */ React.createElement("span", { className: "text-white text-lg", "aria-hidden": "true" }, "\u267F")), /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0" }, /* @__PURE__ */ React.createElement("h4", { className: "text-sm font-bold text-slate-800" }, "Why Accessible Documents Matter"), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600 leading-relaxed mt-1" }, "Over ", /* @__PURE__ */ React.createElement("strong", { className: "text-slate-700" }, "1 billion people worldwide"), " live with some form of disability. When digital documents lack proper structure, alt text, or sufficient contrast, they become invisible walls that exclude students, employees, and community members from information everyone else takes for granted. Accessibility isn't just about compliance \u2014 it's about ensuring ", /* @__PURE__ */ React.createElement("strong", { className: "text-slate-700" }, "equal participation in education, employment, and civic life"), "."))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-sky-100 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-sky-700 uppercase tracking-wider mb-0.5" }, "\u{1F393} Equitable Education"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Accessible materials support Universal Design for Learning (UDL) \u2014 benefiting ", /* @__PURE__ */ React.createElement("em", null, "all"), " learners regardless of ability, language, or learning style")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-sky-100 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-sky-700 uppercase tracking-wider mb-0.5" }, "\u{1F465} Better User Experience (UX) for Everyone"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Clear headings, logical structure, and sufficient contrast make documents easier to read for ", /* @__PURE__ */ React.createElement("em", null, "all"), " users \u2014 including on mobile and in bright sunlight")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-sky-100 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-sky-700 uppercase tracking-wider mb-0.5" }, "\u{1F50D} Improved SEO & Findability"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Semantic HTML, alt text, and proper headings help search engines index content \u2014 boosting discoverability and organic reach")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-sky-100 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-sky-700 uppercase tracking-wider mb-0.5" }, "\u{1F4A1} Innovation Driver"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Voice recognition, closed captioning, and screen readers all began as accessibility features \u2014 then became essential tools used by millions"))), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600 text-center leading-relaxed italic" }, "Accessibility is the digital expression of equity. When we design for the margins, we create better experiences for the center.")), /* @__PURE__ */ React.createElement("div", { className: "mt-3 bg-gradient-to-br from-amber-50/80 via-orange-50/40 to-rose-50/30 border border-amber-200/60 rounded-2xl p-5 space-y-3", style: { animation: "fadeInUp 0.9s ease-out 4s both" } }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-lg shadow-amber-200" }, /* @__PURE__ */ React.createElement("span", { className: "text-white text-lg", "aria-hidden": "true" }, "\u2696\uFE0F")), /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement("h4", { className: "text-sm font-bold text-slate-800" }, "ADA Title II & WCAG 2.1 AA"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold text-rose-600 bg-rose-100 px-1.5 py-0.5 rounded-full uppercase tracking-wider animate-pulse" }, "Deadline: April 24, 2026")), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600 leading-relaxed mt-1" }, "The U.S. Department of Justice finalized a rule under ", /* @__PURE__ */ React.createElement("strong", { className: "text-slate-700" }, "Title II of the Americans with Disabilities Act (ADA)"), " requiring all state and local government entities to make their web content and digital documents conform to ", /* @__PURE__ */ React.createElement("strong", { className: "text-slate-700" }, "WCAG 2.1 Level AA"), ". This applies to websites, mobile apps, PDFs, Word documents, and social media content."))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-amber-100 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-amber-700 uppercase tracking-wider mb-0.5" }, "\u{1F4C5} Compliance Deadlines"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, /* @__PURE__ */ React.createElement("strong", { className: "text-rose-700" }, "April 24, 2026"), " \u2014 entities serving 50,000+ people", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("strong", { className: "text-amber-700" }, "April 26, 2027"), " \u2014 entities serving fewer than 50,000 and special districts")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-amber-100 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-amber-700 uppercase tracking-wider mb-0.5" }, "\u{1F4CB} What's Covered"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Public-facing websites, mobile apps, digital documents (PDFs, Word, Excel, PowerPoint), and social media published by government entities")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-amber-100 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-amber-700 uppercase tracking-wider mb-0.5" }, "\u{1F3DB}\uFE0F Who Must Comply"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "All state and local government entities \u2014 including public schools, universities, courts, libraries, transit agencies, and municipal services")), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-amber-100 p-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-black text-amber-700 uppercase tracking-wider mb-0.5" }, "\u{1F3AF} Why It Matters"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 leading-snug" }, "Beyond legal compliance: accessible documents ensure people with disabilities can equally access education, public services, employment, and civic participation"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white/80 rounded-lg border border-amber-100 p-2.5 text-center" }, /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600 leading-snug" }, /* @__PURE__ */ React.createElement("strong", { className: "text-amber-800" }, "The standard AlloFlow targets \u2014 WCAG 2.1 Level AA \u2014 is the exact standard required by this federal rule."), " ", "This remediation pipeline helps ensure your documents meet the technical requirements set by the DOJ."), /* @__PURE__ */ React.createElement("a", { href: "https://www.ada.gov/resources/web-guidance/", target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-1 mt-1.5 text-[11px] font-bold text-amber-700 hover:text-amber-900 underline decoration-amber-300" }, "Read the official guidance on ADA.gov \u2192"))), extractionData && (extractionData.images.length > 0 || extractionData.metadata) && /* @__PURE__ */ React.createElement("div", { className: "mt-4 bg-gradient-to-b from-white to-slate-50 rounded-2xl border-2 border-slate-200 p-5 space-y-4", style: { animation: "fadeInUp 0.5s ease" } }, extractionData.metadata && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 pb-3 border-b border-slate-100" }, /* @__PURE__ */ React.createElement("span", { className: "text-2xl" }, "\u{1F4CB}"), /* @__PURE__ */ React.createElement("div", { className: "flex-1" }, /* @__PURE__ */ React.createElement("h4", { className: "text-sm font-bold text-slate-800" }, "Document Details"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-x-4 gap-y-1 mt-1 text-[11px] text-slate-600" }, /* @__PURE__ */ React.createElement("span", null, "\u{1F4C4} ", extractionData.metadata.pageCount, " pages"), /* @__PURE__ */ React.createElement("span", null, "\u{1F4DD} ", Math.round(extractionData.metadata.extractedChars / 1e3), "K characters"), extractionData.metadata.hasImages && /* @__PURE__ */ React.createElement("span", null, "\u{1F5BC}\uFE0F ", extractionData.images.length, " images"), extractionData.metadata.hasTables && /* @__PURE__ */ React.createElement("span", null, "\u{1F4CA} Contains tables"), /* @__PURE__ */ React.createElement("span", null, "\u{1F310} Language: ", extractionData.metadata.language === "en" ? "English" : extractionData.metadata.language === "ar" ? "Arabic" : extractionData.metadata.language === "zh" ? "Chinese" : extractionData.metadata.language === "ru" ? "Russian" : extractionData.metadata.language)))), extractionData.images.length > 0 && (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-2 flex-wrap" }, /* @__PURE__ */ React.createElement("span", { className: "text-lg" }, "\u{1F5BC}\uFE0F"), /* @__PURE__ */ React.createElement("h4", { className: "text-sm font-bold text-slate-800" }, "Review Image Descriptions"), /* @__PURE__ */ React.createElement(
        "button",
        {
        ...
        "\u2B07 Download"
      )), /* @__PURE__ */ React.createElement("div", { className: "flex-1 space-y-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] font-bold text-slate-500 uppercase" }, "Image ", imgIdx + 1), img.isRegenerated && /* @__PURE__ */ React.createElement("span", { className: "text-[9px] bg-amber-100 text-amber-700 px-1.5 py-0.5 rounded font-bold" }, "AI Generated"), img.type === "decorative" && /* @__PURE__ */ React.createElement("span", { className: "text-[9px] bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded font-bold" }, "Decorative")), /* @__PURE__ */ React.createElement(
        "textarea",
        {
      ...
      return /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, pdfFixResult && (() => {
        ...
        if (_pct == null) {
          ...
          return /* @__PURE__ */ React.createElement("div", { className: "mb-2 bg-slate-50 border border-slate-400 rounded-xl px-3 py-2 text-xs text-slate-700 flex items-center gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-500" }, "\u2139"), /* @__PURE__ */ React.createElement("span", { className: "font-bold" }, "Content integrity unverified"), /* @__PURE__ */ React.createElement("span", { className: "text-slate-500 text-[11px]" }, "(ground-truth extraction unavailable \u2014 use Diff view to inspect source \u2194 HTML manually, or Re-check to retry)"), /* @__PURE__ */ React.createElement("div", { className: "ml-auto inline-flex items-center gap-1 shrink-0" }, /* @__PURE__ */ React.createElement(
            "button",
            {
              onClick: async () => {
                try {
        ...
        return /* @__PURE__ */ React.createElement("details", { open: true, className: "mb-2 bg-slate-50 border border-slate-400 rounded-xl text-[11px]" }, /* @__PURE__ */ React.createElement("summary", { className: "cursor-pointer font-bold text-slate-700 select-none px-3 py-1.5 hover:bg-slate-100 rounded-xl inline-flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", null, "\u{1F4CB}"), /* @__PURE__ */ React.createElement("span", null, "Verification details"), /* @__PURE__ */ React.createElement("span", { className: "text-slate-500 font-normal text-[10px]" }, "\u2014 char + word coverage, recovery stages, source method")), /* @__PURE__ */ React.createElement("div", { className: "px-3 pb-3 pt-1 grid grid-cols-2 sm:grid-cols-4 gap-2 text-slate-700" }, _charPct != null && /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-slate-400 rounded-lg px-2 py-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider" }, "Char coverage"), /* @__PURE__ */ React.createElement("div", { className: `text-sm font-black ${_charPct >= 98 ? "text-emerald-600" : _charPct >= 95 ? "text-amber-600" : "text-rose-600"}` }, _charPct, "%")), _wordPct != null && /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-slate-400 rounded-lg px-2 py-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider" }, "Word coverage"), /* @__PURE__ */ React.createElement("div", { className: `text-sm font-black ${_wordPct >= 98 ? "text-emerald-600" : _wordPct >= 95 ? "text-amber-600" : "text-rose-600"}` }, _wordPct, "%")), _totalSrc != null && /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-slate-400 rounded-lg px-2 py-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider" }, "Source words"), /* @__PURE__ */ React.createElement("div", { className: "text-sm font-black text-slate-700" }, _totalSrc.toLocaleString())), _totalMissing != null && /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-slate-400 rounded-lg px-2 py-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider" }, "Unmatched"), /* @__PURE__ */ React.createElement("div", { className: `text-sm font-black ${_totalMissing === 0 ? "text-emerald-600" : _totalMissing < 10 ? "text-amber-600" : "text-rose-600"}` }, _totalMissing.toLocaleString())), /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-slate-400 rounded-lg px-2 py-1.5 col-span-2 sm:col-span-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider mb-1" }, "Recovery stages applied"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-x-3 gap-y-1 text-[11px]" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-indigo-700" }, _stagesRan.retry || 0), " AI retry"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-indigo-700" }, _stagesRan.sentence || 0), " deterministic sentence"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-indigo-700" }, _stagesRan.fuzzy || 0), " fuzzy anchor"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-indigo-700" }, _stagesRan.dedup || 0), " duplicate collapsed"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white border border-slate-400 rounded-lg px-2 py-1.5 col-span-2 sm:col-span-4 flex items-center gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider mr-1" }, "Ground truth:"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-mono text-slate-700" }, _method)), _verifiedAt && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-slate-500 font-bold uppercase tracking-wider mr-1" }, "Verified:"), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-slate-700" }, _verifiedAt.toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }))), pdfFixResult.sourceText && pdfFixResult.finalText && /* @__PURE__ */ React.createElement(
          "button",
          {
            onClick: async () => {
              try {
        ...
        return /* @__PURE__ */ React.createElement("div", { key: `ai-${i}`, className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "font-mono text-[10px] bg-red-100 text-red-800 px-1.5 py-0.5 rounded shrink-0" }, "#", idx), /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-slate-700 shrink-0" }, "Dropped by AI pass"), /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-slate-500 italic truncate flex-1" }, (desc || "").substring(0, 80)), /* @__PURE__ */ React.createElement(
          "button",
          {
      ...
      }), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] text-slate-500 italic mt-2" }, "Click Regenerate to recreate an image via AI using its stored description, or use Upload/Replace inside the figure in the preview."))), autoRestoreSummary && /* @__PURE__ */ React.createElement("div", { className: "mb-2 bg-emerald-50 border border-emerald-200 rounded-xl px-2.5 py-1.5 text-[11px] text-emerald-900 flex items-center gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold" }, "\u2728 Restore applied:"), /* @__PURE__ */ React.createElement("span", null, autoRestoreSummary.restored.length, " word", autoRestoreSummary.restored.length === 1 ? "" : "s", " spliced back", autoRestoreSummary.unplaceable.length > 0 ? ` \xB7 ${autoRestoreSummary.unplaceable.length} in Content Recovery appendix` : ""), autoRestoreSummary.beforeFidelity != null && fidelityResult && /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-emerald-700 ml-auto" }, autoRestoreSummary.beforeFidelity, "% \u2192 ", fidelityResult.fidelity, "%")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-2 flex-wrap" }, /* @__PURE__ */ React.createElement("span", { className: "text-lg" }, "\u{1F50D}"), /* @__PURE__ */ React.createElement("h4", { className: "text-sm font-bold text-slate-800" }, "Verify Text Fidelity"), /* @__PURE__ */ React.createElement("span", { className: "text-[9px] bg-slate-100 text-slate-600 px-1.5 py-0.5 rounded font-bold uppercase" }, "via ", String(method).replace("+", " + ")), /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: _runCheck,
      ...
      "Start Fresh"
    ))))), (liveChunkSessionActive || liveChunkStream.length > 0) && /* @__PURE__ */ React.createElement("div", { id: "live-remediation-panel", className: "mt-4 bg-gradient-to-b from-white to-indigo-50 rounded-2xl border-2 border-indigo-300 p-5 space-y-3 animate-in slide-in-from-bottom duration-300", role: "region", "aria-label": "Live chunk remediation review" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-xl", "aria-hidden": "true" }, "\u{1F52C}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h4", { className: "text-sm font-bold text-indigo-800" }, "Live Remediation Review"), /* @__PURE__ */ React.createElement("div", { className: "text-xs text-indigo-700" }, "Watch each section get fixed in real time \u2014 reject or re-fix anything that looks wrong"))), /* @__PURE__ */ React.createElement("div", { className: "text-xs bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded-full font-bold", role: "status", "aria-live": "polite", "aria-atomic": "true" }, liveChunkStream.filter((c) => c.status === "complete").length, "/", liveChunkStream.length, " complete")), /* @__PURE__ */ React.createElement("div", { className: "w-full bg-indigo-100 rounded-full h-1.5 overflow-hidden", role: "progressbar", "aria-label": "Live remediation progress", "aria-valuenow": liveChunkStream.filter((c) => c.status === "complete").length, "aria-valuemin": 0, "aria-valuemax": liveChunkStream.length || 1 }, /* @__PURE__ */ React.createElement("div", { className: "h-full bg-gradient-to-r from-indigo-500 to-violet-500 rounded-full transition-all duration-500", style: { width: liveChunkStream.length > 0 ? `${liveChunkStream.filter((c) => c.status === "complete").length / liveChunkStream.length * 100}%` : "0%" } })), /* @__PURE__ */ React.createElement("div", { className: "space-y-2 max-h-[480px] overflow-y-auto pr-1" }, liveChunkStream.map((chunk, ci) => {
      const isWorking = chunk.status === "working";
      ...
      return /* @__PURE__ */ React.createElement("div", { key: chunk.index, className: `border-2 rounded-xl transition-all duration-300 ${isRejected ? "bg-slate-50 border-slate-300 opacity-60" : isWorking ? "bg-indigo-50 border-indigo-200" : scoreBg}` }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 p-2" }, /* @__PURE__ */ React.createElement("div", { className: `w-7 h-7 rounded-full flex items-center justify-center text-[11px] font-black text-white shrink-0 ${isWorking ? "bg-indigo-500 animate-pulse" : scoreDot}` }, isWorking ? /* @__PURE__ */ React.createElement("span", { className: "animate-spin", "aria-hidden": "true" }, "\u23F3") : chunk.index + 1), /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5 flex-wrap" }, /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold text-slate-700" }, "Section ", chunk.index + 1), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-slate-600" }, chunk.sizeKB || "?", "KB"), isWorking && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] bg-indigo-100 text-indigo-700 px-1.5 py-0.5 rounded font-bold animate-pulse" }, "Fixing..."), !isWorking && chunk.deterministicFixCount > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded font-bold", title: "Rule-based (deterministic) regex fixes applied \u2014 always safe, no AI involved" }, chunk.deterministicFixCount, " rule-based"), !isWorking && chunk.surgicalFixCount > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] bg-purple-100 text-purple-700 px-1.5 py-0.5 rounded font-bold", title: "AI-diagnosed targeted micro-fixes applied via deterministic tools (content-preserving)" }, chunk.surgicalFixCount, " targeted"), !isWorking && chunk.usedOriginal && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] bg-amber-100 text-amber-700 px-1.5 py-0.5 rounded font-bold", title: "AI rewrite failed or was rejected for this section \u2014 only rule-based fixes were applied. Still more accessible than the original." }, "AI skipped"), !isWorking && chunk.wasRetried && !chunk.usedOriginal && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] bg-slate-200 text-slate-600 px-1.5 py-0.5 rounded font-bold" }, "retried"), !isWorking && chunk.aiVerified && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] bg-green-100 text-green-700 px-1.5 py-0.5 rounded font-bold", title: "AI verified content preserved" }, "\u2713 verified"), !isWorking && chunk.integrityPassed && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] bg-emerald-100 text-emerald-700 px-1.5 py-0.5 rounded font-bold", title: "Word overlap integrity check passed" }, "integrity \u2713"), isRejected && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] bg-slate-300 text-slate-700 px-1.5 py-0.5 rounded font-bold" }, "rejected"))), !isWorking && /* @__PURE__ */ React.createElement("div", { className: `text-base font-black shrink-0 ${scoreText}` }, chunk.score, /* @__PURE__ */ React.createElement("span", { className: "text-[11px] opacity-60" }, "/100"))), !isWorking && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 px-2 pb-2 flex-wrap" }, /* @__PURE__ */ React.createElement(
        ...
        "\u21B6 Restore"
      )), !isWorking && isExpanded && /* @__PURE__ */ React.createElement("div", { className: "px-2 pb-2 space-y-2" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-lg border border-slate-400 p-2" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase mb-1" }, "Before (original)"), /* @__PURE__ */ React.createElement("pre", { className: "text-[11px] text-slate-700 whitespace-pre-wrap break-all max-h-40 overflow-y-auto font-mono" }, (chunk.originalHtml || "").substring(0, 2e3), (chunk.originalHtml || "").length > 2e3 ? "\n... (truncated)" : "")), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-lg border border-emerald-200 p-2" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-emerald-600 uppercase mb-1" }, "After (fixed)"), /* @__PURE__ */ React.createElement("pre", { className: "text-[11px] text-slate-700 whitespace-pre-wrap break-all max-h-40 overflow-y-auto font-mono" }, (chunk.fixedHtml || "").substring(0, 2e3), (chunk.fixedHtml || "").length > 2e3 ? "\n... (truncated)" : ""))), chunk.integrityReason && chunk.integrityReason !== "ok" && /* @__PURE__ */ React.createElement("div", { className: "text-[11px] bg-amber-50 border border-amber-200 rounded p-1.5 text-amber-800" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold" }, "Integrity note:"), " ", chunk.integrityReason), chunk.violationInstructions && /* @__PURE__ */ React.createElement("details", { className: "bg-slate-50 border border-slate-400 rounded p-1.5" }, /* @__PURE__ */ React.createElement("summary", { className: "text-[11px] font-bold text-slate-600 cursor-pointer" }, "Violations targeted in this pass"), /* @__PURE__ */ React.createElement("pre", { className: "text-[11px] text-slate-600 whitespace-pre-wrap mt-1" }, chunk.violationInstructions))));
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement("div", { className: `text-3xl font-black ${(blendedBefore || 0) < 50 ? "text-red-600" : (blendedBefore || 0) < 80 ? "text-amber-600" : "text-green-600"}` }, beforeDisplay, /* @__PURE__ */ React.createElement("span", { className: "text-sm opacity-60" }, "/100")), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase" }, "Before")), /* @__PURE__ */ React.createElement("div", { className: "text-2xl text-slate-300" }, "\u2192"), /* @__PURE__ */ React.createElement("div", { className: "text-center" }, /* @__PURE__ */ React.createElement("div", { className: `text-3xl font-black ${(blendedAfter || 0) < 50 ? "text-red-600" : (blendedAfter || 0) < 80 ? "text-amber-600" : "text-green-600"}` }, afterDisplay, /* @__PURE__ */ React.createElement("span", { className: "text-sm opacity-60" }, "/100")), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase" }, "After")), gain > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-bold" }, "+", gain)), /* @__PURE__ */ React.createElement("div", { className: "text-center mt-1 text-[11px]" }, /* @__PURE__ */ React.createElement("div", { className: "inline-flex items-center gap-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, "("), /* @__PURE__ */ React.createElement("span", { className: "text-purple-700 font-bold", title: "AI Rubric" }, "AI: ", initialAi ?? "?", "\u2192", afterAi ?? "?"), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, "+"), /* @__PURE__ */ React.createElement("span", { className: "text-blue-700 font-bold", title: "axe-core" }, "axe: ", initialAxe ?? "?", "\u2192", afterAxe ?? "?"), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, ") / 2"))));
    })(), pdfFixResult.verificationAudit && /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement("div", { className: "text-xs text-emerald-700 font-medium" }, pdfFixResult.verificationAudit.summary), (pdfFixResult.verificationAudit.issues || []).length > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-amber-50 rounded-lg p-2 border border-amber-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-amber-600 uppercase mb-1" }, "Remaining Issues (", pdfFixResult.verificationAudit.issues.length, ")"), pdfFixResult.verificationAudit.issues.map((issue, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "text-[11px] text-amber-800 mb-0.5" }, "\u2022 ", issue.issue, " ", /* @__PURE__ */ React.createElement("span", { className: "text-amber-500" }, "(", issue.wcag, ")")))), (pdfFixResult.verificationAudit.passes || []).length > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-green-50 rounded-lg p-2 border border-green-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-green-600 uppercase mb-1" }, "Verified Accessible"), pdfFixResult.verificationAudit.passes.map((pass, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "text-[11px] text-green-700 mb-0.5" }, "\u2713 ", pass)))), pdfFixResult.axeAudit && /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl border-2 border-indigo-200 p-3 space-y-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-lg" }, "\u{1F52C}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-xs font-bold text-indigo-800" }, "axe-core Automated WCAG Checker"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-indigo-500" }, "Industry-standard engine (Deque) v", pdfFixResult.axeAudit.version, " \u2014 WCAG 2.1 AA"))), /* @__PURE__ */ React.createElement("div", { className: `text-2xl font-black ${pdfFixResult.axeAudit.totalViolations === 0 ? "text-green-600" : pdfFixResult.axeAudit.totalViolations <= 3 ? "text-amber-600" : "text-red-600"}` }, pdfFixResult.axeAudit.totalViolations === 0 ? "\u2705" : pdfFixResult.axeAudit.totalViolations, " ", pdfFixResult.axeAudit.totalViolations === 0 ? "" : "violations")), pdfFixResult.axeAudit.totalViolations === 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-green-100 rounded-lg p-2 border border-green-300 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-sm font-bold text-green-800" }, "Zero WCAG violations detected"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-green-600" }, pdfFixResult.axeAudit.totalPasses, " accessibility checks passed")), pdfFixResult.axeAudit.critical.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-red-50 rounded-lg p-2 border border-red-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-red-600 uppercase mb-1" }, "Critical (", pdfFixResult.axeAudit.critical.length, ")"), pdfFixResult.axeAudit.critical.map((v, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "text-[11px] text-red-800 mb-0.5" }, "\u{1F534} ", v.description, " ", /* @__PURE__ */ React.createElement("span", { className: "text-red-400" }, "(", v.id, ", ", v.nodes, " element", v.nodes > 1 ? "s" : "", ")")))), pdfFixResult.axeAudit.serious.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-orange-50 rounded-lg p-2 border border-orange-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-orange-600 uppercase mb-1" }, "Serious (", pdfFixResult.axeAudit.serious.length, ")"), pdfFixResult.axeAudit.serious.map((v, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "text-[11px] text-orange-800 mb-0.5" }, "\u{1F7E0} ", v.description, " ", /* @__PURE__ */ React.createElement("span", { className: "text-orange-400" }, "(", v.id, ", ", v.nodes, " element", v.nodes > 1 ? "s" : "", ")")))), pdfFixResult.axeAudit.moderate.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-amber-50 rounded-lg p-2 border border-amber-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-amber-600 uppercase mb-1" }, "Moderate (", pdfFixResult.axeAudit.moderate.length, ")"), pdfFixResult.axeAudit.moderate.map((v, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "text-[11px] text-amber-800 mb-0.5" }, "\u{1F7E1} ", v.description, " ", /* @__PURE__ */ React.createElement("span", { className: "text-amber-400" }, "(", v.id, ")")))), pdfFixResult.axeAudit.minor.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-slate-50 rounded-lg p-2 border border-slate-400" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase mb-1" }, "Minor (", pdfFixResult.axeAudit.minor.length, ")"), pdfFixResult.axeAudit.minor.map((v, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "text-[11px] text-slate-600 mb-0.5" }, "\u26AA ", v.description))), pdfFixResult.axeAudit.passes && pdfFixResult.axeAudit.passes.length > 0 && /* @__PURE__ */ React.createElement("details", { className: "w-full" }, /* @__PURE__ */ React.createElement("summary", { className: "text-[11px] font-bold text-green-600 cursor-pointer hover:text-green-800 transition-colors" }, "\u2705 ", pdfFixResult.axeAudit.totalPasses, " accessibility checks passed (click to view)"), /* @__PURE__ */ React.createElement("div", { className: "mt-1 max-h-40 overflow-y-auto bg-green-50 rounded-lg p-2 border border-green-200 space-y-0.5" }, pdfFixResult.axeAudit.passes.map((p, pi) => /* @__PURE__ */ React.createElement("div", { key: pi, className: "text-[11px] text-green-800 flex items-start gap-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-green-500 shrink-0" }, "\u2713"), /* @__PURE__ */ React.createElement("span", { className: "font-medium" }, typeof p === "string" ? p : p.description), p.id && /* @__PURE__ */ React.createElement("span", { className: "text-green-400 shrink-0 font-mono" }, "(", p.id, ")"), p.wcag && /* @__PURE__ */ React.createElement("span", { className: "text-green-400 shrink-0" }, "[", p.wcag, "]"))))), (() => {
      const WCAG_LABELS = {
...
<body><nav epub:type="toc"><h1>Table of Contents</h1><ol>${navItems}</ol></nav></body>
    ...
    }, className: "w-full px-3 py-2 bg-white border border-teal-600 rounded-lg text-xs font-bold text-teal-700 hover:bg-teal-50 transition-colors flex items-center gap-2" }, "\u{1F4CB} Markdown (LMS, wiki, docs)"))), /* @__PURE__ */ React.createElement("details", { open: true, className: "bg-gradient-to-r from-slate-800 to-slate-900 border border-slate-600 rounded-xl group" }, /* @__PURE__ */ React.createElement("summary", { className: "cursor-pointer p-3 text-[11px] font-bold text-purple-300 uppercase tracking-widest flex items-center gap-2 list-none select-none hover:bg-slate-800/50 rounded-xl" }, /* @__PURE__ */ React.createElement("span", { className: "inline-block transition-transform group-open:rotate-90 text-slate-400" }, "\u25B8"), "\u{1F916} Expert Workbench", isAgentRunning && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-amber-300 animate-pulse ml-1" }, "Running..."), /* @__PURE__ */ React.createElement("span", { className: "ml-auto text-[10px] text-slate-500 font-normal normal-case tracking-normal" }, agentActivityLog.length > 0 ? `${agentActivityLog.length} event${agentActivityLog.length === 1 ? "" : "s"}` : "idle")), /* @__PURE__ */ React.createElement("div", { className: "px-3 pb-3 space-y-2" }, /* @__PURE__ */ React.createElement("form", { className: "flex gap-1", onSubmit: async (e) => {
      e.preventDefault();
...
Return ONLY the plain language summary in ${lang}.`, false);
      ...
      /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 border-2 border-amber-300" }, /* @__PURE__ */ React.createElement("h3", { id: "pdf-close-confirm-title", className: "text-lg font-bold text-slate-800 mb-2" }, "Close without saving?"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-600 mb-5 leading-relaxed" }, "This audit hasn't been saved as a ", /* @__PURE__ */ React.createElement("strong", null, "Project"), " file. If you close, your remediated HTML and audit results won't survive a browser reload."), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col-reverse sm:flex-row gap-2 sm:justify-end" }, /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
    ...
    ), pdfPreviewOpen && pdfFixResult && /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-[70] bg-black/50 flex items-stretch", role: "dialog", "aria-modal": "true", "aria-label": "Accessible document preview and editor" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-1 m-4 gap-0 animate-in fade-in duration-200" }, /* @__PURE__ */ React.createElement("div", { className: "w-72 bg-white rounded-l-2xl border-2 border-r-0 border-indigo-600 p-4 flex flex-col gap-3 overflow-y-auto shrink-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-bold text-indigo-800" }, "\u267F Preview & Edit"), /* @__PURE__ */ React.createElement("button", { onClick: () => setPdfPreviewOpen(false), className: "p-1 hover:bg-slate-100 rounded-lg transition-colors", "aria-label": "Close preview" }, /* @__PURE__ */ React.createElement(X, { size: 18 }))), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600" }, "Click anywhere in the preview to edit text directly. Use the controls below to customize appearance."), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase tracking-widest mb-1" }, "Style"), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600 mb-1" }, "WCAG compliance guaranteed \u2014 sanitizer runs on every style change."), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-1" }, Object.entries(STYLE_SEEDS).filter(([, s]) => s.cssVars || s.name === "Match Original").map(([key, s]) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key,
        onClick: () => {
...
{"headingColor":"hex","accentColor":"hex","bgColor":"hex","textColor":"hex","headerBg":"hex or CSS gradient","headerText":"hex","tableBg":"hex","tableBorder":"hex","bodyFont":"CSS font-family string","headingFont":"CSS font-family string","extraCSS":"any additional CSS rules to match the brand style"}`,
      ...
      /* @__PURE__ */ React.createElement("option", { value: "system-ui, sans-serif" }, "System (Default)"),
      /* @__PURE__ */ React.createElement("option", { value: "'Inter', sans-serif" }, "Inter"),
      /* @__PURE__ */ React.createElement("option", { value: "'Georgia', serif" }, "Georgia (Serif)"),
      /* @__PURE__ */ React.createElement("option", { value: "'Times New Roman', serif" }, "Times New Roman"),
      /* @__PURE__ */ React.createElement("option", { value: "'Atkinson Hyperlegible', sans-serif" }, "Atkinson Hyperlegible"),
      ...
      /* @__PURE__ */ React.createElement("option", { value: "'Comic Sans MS', cursive" }, "Comic Sans"),
      /* @__PURE__ */ React.createElement("option", { value: "'Courier New', monospace" }, "Courier (Mono)")
    ...
    ), pdfPreviewA11yInspect && /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-slate-600 space-y-0.5 bg-slate-50 rounded-lg p-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "inline-block w-3 h-2 bg-violet-600 rounded mr-1" }), " Headings (H1-H6)"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "inline-block w-3 h-2 bg-blue-600 rounded mr-1" }), " Images + alt text"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "inline-block w-3 h-2 bg-emerald-600 rounded mr-1" }), " Tables + headers"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "inline-block w-3 h-2 bg-cyan-600 rounded mr-1" }), " Figures + captions"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "inline-block w-3 h-2 bg-green-600 rounded mr-1" }), " Main landmark"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "inline-block w-3 h-2 bg-orange-600 rounded mr-1" }), " ARIA roles")), /* @__PURE__ */ React.createElement("button", { onClick: () => {
      const doc = pdfPreviewRef.current?.contentDocument;
      if (!doc) return;
    ...
    }, className: "w-full mt-1 px-2 py-1.5 bg-indigo-100 text-indigo-700 rounded-lg text-[11px] font-bold hover:bg-indigo-200 transition-colors" }, "\u2728 Generate & Insert")), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-600" }, "Click an image in the preview to select it, then:"), /* @__PURE__ */ React.createElement("button", { onClick: async () => {
    ...
    }, className: "w-full px-2 py-1.5 bg-violet-100 text-violet-700 rounded-lg text-[11px] font-bold hover:bg-violet-200 transition-colors" }, "\u270F\uFE0F Edit Selected Image (AI)"))), /* @__PURE__ */ React.createElement("details", { className: "group" }, /* @__PURE__ */ React.createElement("summary", { className: "text-[11px] font-bold text-slate-600 uppercase tracking-widest cursor-pointer hover:text-indigo-600 transition-colors flex items-center gap-1" }, "\u{1F4D0} Layout & Design ", /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-slate-600 group-open:hidden" }, "\u25B8")), /* @__PURE__ */ React.createElement("div", { className: "mt-1.5 space-y-1.5 bg-slate-50 rounded-lg p-2 border border-slate-400" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase" }, "Insert Blocks"), (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", { ref: insertBlockPickerRef, className: "space-y-1.5", onKeyDown: _onPickerKey }, /* @__PURE__ */ React.createElement(
        ...
        return /* @__PURE__ */ React.createElement("div", { key: cat }, /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("span", null, _ct(cat), " ", /* @__PURE__ */ React.createElement("span", { className: "text-slate-400 font-normal" }, "(", catBlocks.length, ")")),
      ...
      }), /* @__PURE__ */ React.createElement("div", { className: "text-[9px] text-slate-400 italic px-1 pt-0.5", "aria-hidden": "true" }, "\u2191\u2193\u2190\u2192 Home End to navigate \xB7 Enter to insert"));
      ...
      sp.label
    ))), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase mt-2" }, "Header / Branding"), /* @__PURE__ */ React.createElement("button", { onClick: () => {
      const doc = pdfPreviewRef.current?.contentDocument;
      if (!doc) return;
...
`;
      ...
      }, className: "w-full text-[11px] font-bold text-amber-700 py-1.5 bg-amber-50 border border-amber-600 rounded-lg hover:bg-amber-100 transition-colors text-left px-2 flex items-center justify-between" }, /* @__PURE__ */ React.createElement("span", null, "\u{1F4D0} ", tmpl.name), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-amber-400" }, tmpl.structure?.filter((s) => s.type === "heading").length || 0, " sections"))))) : null;
      ...
      "\u{1F512} ",
      wm.label
    )), /* @__PURE__ */ React.createElement("div", { className: "border-t border-slate-200 pt-1.5 mt-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-bold text-slate-600 uppercase mb-1" }, "Version Stamp"), [
    ...
    }, className: "w-full text-[11px] text-slate-600 hover:text-slate-600 font-bold text-center py-1" }, "Close Preview"))), /* @__PURE__ */ React.createElement("div", { className: "flex-1 bg-white rounded-r-2xl border-2 border-l border-indigo-600 overflow-hidden flex flex-col" }, /* @__PURE__ */ React.createElement("div", { className: "px-3 py-2 bg-slate-50 border-b border-slate-200 flex items-center gap-2 text-[11px] text-slate-600 shrink-0" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-700" }, "Live Preview"), /* @__PURE__ */ React.createElement("span", null, "\u2014 select text, then use the toolbar to format"), /* @__PURE__ */ React.createElement("span", { className: "ml-auto font-mono" }, pendingPdfFile?.name || "document.pdf")), /* @__PURE__ */ React.createElement("div", { className: "px-2 py-1.5 bg-white border-b border-slate-200 flex items-center gap-0.5 flex-wrap shrink-0", role: "toolbar", "aria-label": "Text formatting" }, [
      ...
      {
        ref: pdfPreviewRef,
        title: "Accessible document preview",
