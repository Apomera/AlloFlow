...
describe('Praxis Audiology 5343 diagnostic bank', () => {
  it('registers two ready 100-item batches with the exact ETS category proportions', () => {
  ...
  it('publishes zero-finding QA and exact deployment mirrors', () => {
    ...
    expect(qa.diagnosticBatch).toMatchObject({ batchCount: 2, batchSize: 100, categories: { 'foundations-audiology': 20, 'prevention-screening': 10, assessment: 35, intervention: 25, 'professional-ethical': 10 } });
