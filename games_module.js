...
const GlossaryPrintStyles = () => /* @__PURE__ */ React.createElement("style", null, `
...
var GAME_EMOJI_SEQUENCE_RE = new RegExp(
  "(?:[#*0-9]\\uFE0F?\\u20E3|[\\u{1F1E6}-\\u{1F1FF}]{2}|\\p{Extended_Pictographic}" + GAME_EMOJI_MODIFIERS + "(?:\\u200D\\p{Extended_Pictographic}" + GAME_EMOJI_MODIFIERS + ")*)",
  "gu"
);
var GAME_EMOJI_JOINER_RE = new RegExp("[\\u200D\\uFE0E\\uFE0F]", "g");
var stripGameEmoji = function(value) {
  if (value === null || value === void 0) return "";
  return String(value).replace(GAME_EMOJI_SEQUENCE_RE, "").replace(GAME_EMOJI_JOINER_RE, "");
};
...
var gameGraphemes = function(value) {
  ...
  if (!text) return [];
  if (_gameSegmenter === void 0) {
    try {
      _gameSegmenter = typeof Intl !== "undefined" && typeof Intl.Segmenter === "function" ? new Intl.Segmenter(void 0, { granularity: "grapheme" }) : null;
    } catch (_e) {
      _gameSegmenter = null;
    }
  }
  if (_gameSegmenter) {
    try {
      return Array.from(_gameSegmenter.segment(text), function(part) {
        return part.segment;
      });
    } catch (_e) {
    }
...
var gameTermParts = function(rawTerm) {
  var display = (rawTerm === null || rawTerm === void 0 ? "" : String(rawTerm)).trim();
...
var gameNormalizeGridLetters = function(value, scriptId) {
  ...
  if (!letters) return "";
  if (scriptId === "arabic") {
    letters = letters.replace(GAME_ARABIC_MARKS_RE, "").replace(GAME_ARABIC_ALEF_RE, GAME_ARABIC_BARE_ALEF).replace(GAME_ARABIC_YEH_RE, GAME_ARABIC_BARE_YEH);
  } else if (scriptId === "hebrew") {
    letters = letters.replace(GAME_HEBREW_MARKS_RE, "").replace(GAME_HEBREW_FINALS_RE, function(ch) {
      return GAME_HEBREW_FINALS[ch] || ch;
    });
  }
...
const gameMessage = (t, key, fallback) => {
  const value = t(key);
...
const GameReviewScreen = ({ score, title, items, onPlayAgain, onClose, t }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { role: "region", "aria-labelledby": reviewTitleId, className: `mt-4 bg-white rounded-2xl border-2 border-indigo-100 shadow-lg overflow-hidden${useReducedMotion() ? "" : " animate-in fade-in slide-in-from-bottom-2 duration-300"}` }, /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-r from-indigo-600 to-purple-600 p-4 text-white text-center" }, /* @__PURE__ */ React.createElement("h3", { id: reviewTitleId, className: "text-xl font-black" }, title || "Review"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-center gap-4 mt-2" }, /* @__PURE__ */ React.createElement("span", { className: "bg-white/20 px-3 py-1 rounded-full text-sm font-bold" }, score, " pts"), /* @__PURE__ */ React.createElement("span", { className: "bg-white/20 px-3 py-1 rounded-full text-sm font-bold" }, correct, "/", total, " ", t("common.correct") || "correct"))), /* @__PURE__ */ React.createElement("div", { className: "max-h-[300px] overflow-y-auto custom-scrollbar p-3" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, items.map((item, idx) => /* @__PURE__ */ React.createElement("div", { key: idx, className: `flex items-center gap-3 p-3 rounded-xl border-2 transition-all ${item.status === "correct" ? "bg-green-50 border-green-200" : "bg-red-50 border-red-200"}` }, /* @__PURE__ */ React.createElement("div", { "aria-hidden": "true", className: `w-6 h-6 rounded-full flex items-center justify-center shrink-0 text-xs font-black ${item.status === "correct" ? "bg-green-700 text-white" : "bg-red-700 text-white"}` }, item.status === "correct" ? "\u2713" : "\u2717"), /* @__PURE__ */ React.createElement("span", { className: "sr-only" }, item.status === "correct" ? t("common.correct") || "Correct" : t("common.incorrect") || "Incorrect"), /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "font-bold text-sm text-slate-800 break-words" }, item.label), item.detail && /* @__PURE__ */ React.createElement("div", { className: "text-sm leading-relaxed text-slate-600 break-words" }, item.detail)), /* @__PURE__ */ React.createElement(SpeakButton, { text: item.label, size: 12 }))))), /* @__PURE__ */ React.createElement("div", { className: "p-3 border-t border-slate-200 flex gap-2 justify-center" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: onPlayAgain, className: "min-h-11 px-5 py-2 rounded-full text-xs font-bold bg-indigo-600 text-white hover:bg-indigo-700 transition-colors flex items-center gap-2 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" }, /* @__PURE__ */ React.createElement(RefreshCw, { size: 14, "aria-hidden": "true" }), " ", t("memory.play_again") || "Play Again"), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: onClose, className: "min-h-11 px-5 py-2 rounded-full text-xs font-bold text-slate-600 hover:bg-slate-100 transition-colors focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" }, t("common.close") || "Close")));
};
const MemoryGame = React.memo(({ data, onClose, onScoreUpdate, onGameComplete }) => {
  ...
  useEffect(() => () => clearTimeout(pairTimerRef.current), []);
  ...
  const initializeGame = () => {
    ...
    const deck = gameItems.flatMap((item, index) => {
      ...
      if (!item.def && item.image) strategy = "term-image";
      let content1, type1, isTerm1, accessibleLabel1;
      let content2, type2, isTerm2, accessibleLabel2;
      const imageDescription = item.imageAlt || item.imageDescription || "";
      const meaningfulImageLabel = imageDescription ? `Picture for ${item.term}: ${imageDescription}` : `Picture representing ${item.term}`;
      switch (strategy) {
        case "term-def":
          content1 = item.term;
          type1 = "text";
          isTerm1 = true;
          accessibleLabel1 = `Term: ${item.term}`;
          content2 = item.def;
          type2 = "text";
          isTerm2 = false;
          accessibleLabel2 = `Definition: ${item.def}`;
          break;
        case "image-def":
          content1 = item.image;
          type1 = "image";
          isTerm1 = false;
          accessibleLabel1 = meaningfulImageLabel;
          content2 = item.def;
          type2 = "text";
          isTerm2 = false;
          accessibleLabel2 = `Definition: ${item.def}`;
        ...
        default:
          ...
          type2 = "image";
          isTerm2 = false;
          accessibleLabel2 = meaningfulImageLabel;
          break;
      }
      const card1 = {
        id: `p${index}-1`,
  ...
  const handleCardClick = (index) => {
    if (!cards[index] || flippedIndices.includes(index) || matchedPairs.has(cards[index].pairId) || flippedIndices.length >= 2) return;
    const newFlipped = [...flippedIndices, index];
    setFlippedIndices(newFlipped);
    const cardContent = cards[index].accessibleLabel || cards[index].content;
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    isWon ? (() => {
      ...
      cards.map((card, index) => {
        ...
        if (isMatched) {
          ariaLabel += `, ${t("memory.matched_suffix")}: ${card.accessibleLabel || card.content}`;
        } else if (isFlipped) {
          ariaLabel += `, ${t("memory.face_up_suffix")}: ${card.accessibleLabel || card.content}`;
        } else {
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("div", { className: `w-full h-full ${!useReducedMotion() ? "transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]" : ""} transform-style-3d rounded-xl border-2 ${isFlipped ? `rotate-y-180 ${isMismatch ? "border-red-400 shadow-lg shadow-red-200" : isMatched ? "border-green-400 shadow-lg shadow-green-200" : "border-indigo-300 shadow-md"}` : "rotate-y-0 border-slate-200 bg-white shadow-sm group-hover:shadow-md"}` }, /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 backface-hidden flex items-center justify-center rounded-xl overflow-hidden bg-gradient-to-br from-indigo-100 via-indigo-100 to-indigo-200 group-hover:from-indigo-200 group-hover:to-indigo-300 transition-colors" }, /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 opacity-40", style: {
            ...
            "img",
            {
              loading: "lazy",
              src: card.content,
              alt: card.accessibleLabel || t("games.memory.card_alt") || "memory card",
...
const MatchingGame = React.memo(({ data, onClose, playSound, onScoreUpdate, onGameComplete }) => {
  ...
  const checkAnswers = () => {
    ...
    setIsChecked(true);
    const correctCount = connections.filter((c) => isCorrectConnection(c)).length;
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: matchingDialogRef, tabIndex: -1, role: "dialog", "aria-modal": "true", "aria-labelledby": "matching-game-title", className: `allo-glossary-print-dialog glossary-matching-dialog fixed inset-0 z-[100] bg-slate-50 flex flex-col overflow-hidden${useReducedMotion() ? "" : " animate-in fade-in duration-300"}` }, /* @__PURE__ */ React.createElement(GlossaryPrintStyles, null), /* @__PURE__ */ React.createElement("section", { className: "glossary-matching-sheet" }, /* @__PURE__ */ React.createElement("h2", null, t("matching.print_title")), /* @__PURE__ */ React.createElement("p", null, t("matching.print_name"), ": ____________________ \xA0 ", t("matching.print_date"), ": ______________"), /* @__PURE__ */ React.createElement("p", null, t("matching.print_instructions")), /* @__PURE__ */ React.createElement("table", null, /* @__PURE__ */ React.createElement("tbody", null, items.map((item, index) => /* @__PURE__ */ React.createElement("tr", { key: item.id }, /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("strong", null, index + 1, ". ", item.term), " ", /* @__PURE__ */ React.createElement("span", null, "_____")), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("strong", null, String.fromCharCode(65 + index), "."), " ", rightCol[index]?.text)))))), /* @__PURE__ */ React.createElement("div", { className: "sr-only", role: "status", "aria-live": "polite" }, announcement), /* @__PURE__ */ React.createElement("div", { className: "bg-white border-b border-slate-200 p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 shadow-sm no-print z-20 relative" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { id: "matching-game-title", className: "font-bold text-lg flex items-center gap-2 text-indigo-900" }, /* @__PURE__ */ React.createElement(GitMerge, { size: 20, className: "text-orange-500" }), " ", t("matching.title")), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-600" }, t("matching.instructions")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-1.5 mt-1.5" }, /* @__PURE__ */ React.createElement("span", { className: "inline-flex items-center gap-1 text-[11px] font-bold bg-slate-100 text-slate-700 border border-slate-400 px-2 py-0.5 rounded-full" }, /* @__PURE__ */ React.createElement(GitMerge, { size: 10, className: "text-slate-600" }), " ", t("matching.pairs") || "Pairs", ": ", connections.length, "/", items.length), isChecked && /* @__PURE__ */ React.createElement("span", { className: `inline-flex items-center gap-1 text-[11px] font-bold border px-2 py-0.5 rounded-full ${score === items.length * 25 ? "bg-emerald-100 text-emerald-700 border-emerald-200" : "bg-indigo-100 text-indigo-700 border-indigo-200"} ${!useReducedMotion() ? "animate-in zoom-in duration-300" : ""}` }, /* @__PURE__ */ React.createElement(Trophy, { size: 10, className: "text-yellow-500" }), " ", t("matching.score_display"), ": ", score, " pts"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 p-1 rounded-full bg-slate-50 border border-slate-400 shadow-sm self-end sm:self-auto" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => window.print(), "data-help-key": "matching_print_btn", disabled: !items.length, className: "min-h-11 inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-indigo-700 rounded-full focus:ring-2 focus:ring-indigo-500" }, /* @__PURE__ */ React.createElement(Printer, { size: 14, "aria-hidden": "true" }), " ", t("common.print")), /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      "div",
      {
        className: "relative min-h-full p-3 sm:p-8"
      },
      /* @__PURE__ */ React.createElement("div", { className: "hidden print:block mb-8 text-center" }, /* @__PURE__ */ React.createElement("h2", { className: "text-2xl font-bold text-slate-800 mb-2" }, t("matching.print_title")), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-sm border-b-2 border-slate-800 pb-2 mb-4" }, /* @__PURE__ */ React.createElement("span", null, t("matching.print_name"), ": _______________________"), /* @__PURE__ */ React.createElement("span", null, t("matching.print_date"), ": _______________________"), /* @__PURE__ */ React.createElement("span", null, t("matching.print_score"), ": _______ / ", items.length * 25)), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-600 italic" }, t("matching.print_instructions"))),
      /* @__PURE__ */ React.createElement(
        "div",
        {
          ref: canvasRef,
        ...
        /* @__PURE__ */ React.createElement("svg", { className: "absolute inset-0 w-full h-full pointer-events-none z-10 print:hidden" }, /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement("filter", { id: "matching-glow", x: "-50%", y: "-50%", width: "200%", height: "200%" }, /* @__PURE__ */ React.createElement("feGaussianBlur", { stdDeviation: "2", result: "blur" }), /* @__PURE__ */ React.createElement("feMerge", null, /* @__PURE__ */ React.createElement("feMergeNode", { in: "blur" }), /* @__PURE__ */ React.createElement("feMergeNode", { in: "SourceGraphic" })))), connections.map((conn) => {
          ...
          let color = "#6366f1";
          if (isChecked) {
            color = isCorrectConnection(conn) ? "#22c55e" : "#ef4444";
          }
          const isCorrect = isChecked && isCorrectConnection(conn);
          const isIncorrect = isChecked && !isCorrectConnection(conn);
        ...
        /* @__PURE__ */ React.createElement("div", { className: "flex justify-between gap-3 sm:gap-12 h-full" }, /* @__PURE__ */ React.createElement("div", { className: "w-2/5 sm:w-1/3 min-w-0 space-y-6" }, items.map((item) => /* @__PURE__ */ React.createElement("div", { key: item.id, className: "flex items-center justify-between h-28 sm:h-24 group relative z-20" }, /* @__PURE__ */ React.createElement(
          "div",
          {
            ...
            className: `bg-indigo-50 border-2 border-indigo-100 p-3 rounded-lg w-full shadow-sm text-sm font-bold text-indigo-900 flex items-center justify-center text-center h-full break-words overflow-y-auto print:border-slate-300 print:bg-white print:text-black select-none cursor-pointer hover:bg-indigo-100 focus:ring-2 focus:ring-indigo-400 transition-all ${keyboardSelectedTerm === item.id ? "ring-4 ring-yellow-200 border-yellow-400 bg-yellow-50" : ""}`,
    ...
    "div",
    {
      ...
      role: "progressbar",
      "aria-label": gameMessage(t, "matching.pairs", "Pairs"),
      "aria-valuemin": 0,
...
const ConceptSortGame = React.memo(({ data, onClose, playSound, onGenerateItem, onScoreUpdate, onGameComplete, onExplainIncorrect, imageScale, onImageScaleChange, allowAddItems = true }) => {
  const _imgScale = typeof imageScale === "number" && imageScale >= 0.5 && imageScale <= 3 ? imageScale : 2;
  ...
  const [lockedIds, setLockedIds] = useState(() => /* @__PURE__ */ new Set());
  const [explanations, setExplanations] = useState({});
  ...
  const handleDrop = (e, targetContainerId) => {
    e.preventDefault();
    if (isChecked || !draggedItem || lockedIds.has(draggedItem.id)) return;
  ...
  const handleCardKeyDown = (e, item) => {
    if (isChecked || lockedIds.has(item.id)) return;
    if (e.key === "Enter" || e.key === " ") {
      e.preventDefault();
  ...
  const reset = () => {
    ...
    setAttempts((prev) => prev + 1);
    setExplanations({});
    setLockedIds(/* @__PURE__ */ new Set());
    setAnnouncement(t("concept_sort.announce.reset") || "Board reset. All items returned to deck.");
  };
  const retryIncorrect = () => {
    if (!isChecked) return;
    const correctIds = new Set(items.filter((i) => i.currentContainer !== "deck" && i.currentContainer === i.categoryId).map((i) => i.id));
    const returned = items.filter((i) => i.currentContainer !== "deck" && i.currentContainer !== i.categoryId);
    if (!returned.length) return;
    const nextItems = items.map((i) => correctIds.has(i.id) ? i : { ...i, currentContainer: "deck" });
    setItems(nextItems);
    ...
    setKeyboardSelectedItemId(null);
    const tmpl = t("concept_sort.announce.retry_incorrect");
    setAnnouncement(tmpl ? tmpl.replace("{kept}", String(correctIds.size)).replace("{returned}", String(returned.length)) : `${correctIds.size} correct card${correctIds.size === 1 ? "" : "s"} kept in place. ${returned.length} returned to the deck to sort again.`);
    if (playSound) playSound("click");
  };
  const incorrectPlacedCount = isChecked ? items.filter((i) => i.currentContainer !== "deck" && i.currentContainer !== i.categoryId).length : 0;
  const renderCard = (item) => {
    ...
    if (locked && !isChecked) statusClass = "border-green-500 bg-green-50 ring-2 ring-green-200 cursor-default";
    return /* @__PURE__ */ React.createElement(
      "div",
      {
        key: item.id,
        "data-locked": locked ? "true" : void 0,
        draggable: !isChecked && !locked,
        ...
        tabIndex: isChecked || locked ? -1 : 0,
        role: "button",
        "aria-pressed": keyboardSelectedItemId === item.id,
        "aria-label": locked ? `${item.content}. ${t("concept_sort.locked_aria") || "Correct and locked in place."}` : `${item.content}. ${item.currentContainer === "deck" ? t("concept_sort.unsorted_aria") : t("concept_sort.sorted_aria")}. ${t("concept_sort.move_aria")}`,
        className: `
...
var isCrosswordLetterKey = function(key) {
  ...
  if (gameGraphemes(key).length !== 1) return false;
...
const CrosswordGame = React.memo(({ data, onClose, playSound, onScoreUpdate, onGameComplete }) => {
  ...
  const crosswordTouchInputRef = useRef(null);
  ...
  useEffect(() => {
    ...
    const occupied = [];
    tempGrid.forEach((row, r) => row.forEach((cell, c) => {
      if (cell) occupied.push({ r, c });
    }));
    const minRow = Math.min(...occupied.map((cell) => cell.r));
    const maxRow = Math.max(...occupied.map((cell) => cell.r));
    const minCol = Math.min(...occupied.map((cell) => cell.c));
    const maxCol = Math.max(...occupied.map((cell) => cell.c));
    const compactGrid = tempGrid.slice(minRow, maxRow + 1).map((row) => row.slice(minCol, maxCol + 1));
    for (const direction2 of ["across", "down"]) newClues[direction2] = newClues[direction2].map((clue) => ({ ...clue, row: clue.row - minRow, col: clue.col - minCol }));
    setGrid(compactGrid);
    setClues(newClues);
  ...
  useEffect(() => {
    if (selectedCell) crosswordGridRef.current?.querySelector("#crossword-cell-" + selectedCell.r + "-" + selectedCell.c)?.scrollIntoView?.({ block: "nearest", inline: "nearest" });
  }, [selectedCell]);
  const handleCellClick = (r, c) => {
    if (!grid[r][c]) return;
    crosswordTouchInputRef.current?.focus();
  ...
  const handleKeyDown = (e) => {
    if (!selectedCell || isWon || e.isComposing || e.keyCode === 229) return;
    if (e.key === "Backspace" || e.key.startsWith("Arrow") || isCrosswordLetterKey(e.key)) e.preventDefault();
    ...
    if (e.key === "Backspace") {
      ...
      if (direction === "across") {
        let nextC = c + 1;
        while (nextC < grid[r].length && !grid[r][nextC]) nextC++;
        if (nextC < grid[r].length && grid[r][nextC]) setSelectedCell({ r, c: nextC });
      } else {
        let nextR = r + 1;
        while (nextR < grid.length && !grid[nextR][c]) nextR++;
        if (nextR < grid.length && grid[nextR][c]) setSelectedCell({ r: nextR, c });
      }
      ...
      if (forward) {
        let nextC = c + 1;
        while (nextC < grid[r].length && !grid[r][nextC]) nextC++;
        if (nextC < grid[r].length && grid[r][nextC]) {
      ...
      let nextR = r + 1;
      while (nextR < grid.length && !grid[nextR][c]) nextR++;
      if (nextR < grid.length && grid[nextR][c]) {
  ...
  const handleTouchInputKeyDown = (e) => {
    if (e.key === "Backspace" || e.key.startsWith("Arrow") || e.key === "Enter" || e.key === " ") handleKeyDown(e);
  };
  const checkPuzzle = () => {
    if (isWon || wasRevealed) return;
    ...
    currentScore = Math.max(0, currentScore - hintsUsed);
    if (correct) {
      setIsWon(true);
  ...
  const revealPuzzle = () => {
    if (isWon || !grid.some((row) => row.some(Boolean))) return;
    const autoFill = {};
    for (let r = 0; r < grid.length; r++) {
      for (let c = 0; c < grid[r].length; c++) {
        if (grid[r][c]) {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: crosswordDialogRef, tabIndex: -1, role: "dialog", "aria-modal": "true", "aria-labelledby": "crossword-game-title", className: "allo-glossary-print-dialog glossary-crossword-dialog fixed inset-0 z-[100] bg-white flex flex-col motion-safe:animate-in motion-safe:fade-in motion-safe:duration-300", "data-help-key": "crossword_game_container" }, /* @__PURE__ */ React.createElement(GlossaryPrintStyles, null), /* @__PURE__ */ React.createElement("div", { className: "sr-only", role: "status", "aria-live": "polite" }, announcement), /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-600 p-4 text-white flex flex-wrap justify-between items-center gap-3 shadow-md shrink-0 no-print" }, /* @__PURE__ */ React.createElement("h2", { id: "crossword-game-title", className: "text-xl font-bold flex items-center gap-2" }, /* @__PURE__ */ React.createElement(Gamepad2, { "aria-hidden": "true" }), " ", t("games.crossword_title")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-3" }, isWon && /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-800 px-4 py-1 rounded-full text-yellow-300 text-sm font-bold border border-indigo-500 animate-in motion-reduce:animate-none zoom-in" }, t("common.score"), ": ", score), !isWon && score > 0 && /* @__PURE__ */ React.createElement("div", { className: "text-indigo-200 text-xs font-medium" }, t("games.crossword.current_score", { score })), availableLangs.length > 0 && /* @__PURE__ */ React.createElement(
    "select",
    {
      "aria-label": t("common.selection"),
      value: crosswordLang,
  ...
  ), /* @__PURE__ */ React.createElement(GameThemeToggle, null), /* @__PURE__ */ React.createElement("button", { ref: crosswordCloseRef, type: "button", "data-help-key": "crossword_close_btn", onClick: onClose, className: "min-w-11 min-h-11 hover:bg-indigo-500 p-2 rounded-full focus:ring-2 focus:ring-offset-2 focus:ring-white focus:ring-offset-indigo-700 transition-colors", "aria-label": t("games.crossword.close_puzzle_aria") }, /* @__PURE__ */ React.createElement(X, { size: 24, "aria-hidden": "true" })))), /* @__PURE__ */ React.createElement("div", { className: "flex-grow overflow-hidden flex flex-col md:flex-row" }, /* @__PURE__ */ React.createElement("div", { className: "flex-grow p-4 overflow-auto bg-slate-100 flex flex-col items-center gap-3 relative print:bg-white print:overflow-visible print:p-0" }, isWon && !wasRevealed && !reducedMotion && /* @__PURE__ */ React.createElement(ConfettiExplosion, null), /* @__PURE__ */ React.createElement("div", { className: "hidden print:block w-full mb-6 text-center" }, /* @__PURE__ */ React.createElement("h2", { className: "text-2xl font-bold text-slate-800 mb-2" }, t("games.crossword_title")), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-sm border-b-2 border-slate-800 pb-2 mb-2" }, /* @__PURE__ */ React.createElement("span", null, t("matching.print_name"), ": _______________________"), /* @__PURE__ */ React.createElement("span", null, t("matching.print_date"), ": _______________________"))), grid.length === 0 ? /* @__PURE__ */ React.createElement("div", { role: "status", className: "max-w-md rounded-xl border border-amber-300 bg-amber-50 p-5 text-amber-900 no-print" }, /* @__PURE__ */ React.createElement("p", { className: "font-bold" }, t("games.crossword.empty_title") || "This word list cannot be laid out on a crossword grid."), /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm" }, t("games.crossword.empty_body") || "A crossword needs terms of at least three letters that share letters with each other. Try Matching, Memory, or Bingo, which work with any word list.")) : null, /* @__PURE__ */ React.createElement("label", { className: "no-print inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-white px-3 py-2 text-xs font-bold text-indigo-900 shadow-sm" }, /* @__PURE__ */ React.createElement("span", null, t("games.crossword.selected_square_label") || "Selected square"), /* @__PURE__ */ React.createElement("input", { ref: crosswordTouchInputRef, type: "text", inputMode: "text", autoComplete: "off", autoCorrect: "off", spellCheck: false, maxLength: 4, readOnly: isWon, "aria-disabled": !selectedCell || isWon, onChange: handleTouchInputChange, onCompositionEnd: handleTouchInputChange, onKeyDown: handleTouchInputKeyDown, "aria-label": t("games.crossword.selected_square_aria") || "Enter a letter for the selected crossword square", className: "h-11 w-14 rounded-lg border-2 border-indigo-300 bg-white text-center text-xl font-black text-indigo-900 focus:ring-2 focus:ring-indigo-500" })), layout.isRtl && grid.length > 0 && /* @__PURE__ */ React.createElement("p", { className: "no-print max-w-md text-center text-xs font-medium text-slate-700" }, t("games.crossword.rtl_note") || "This puzzle reads right to left. Each square holds one letter on its own, so letters are not joined the way they are inside a written word."), /* @__PURE__ */ React.createElement("div", { className: "max-w-full overflow-x-auto shrink-0 p-1 print:overflow-visible" }, /* @__PURE__ */ React.createElement(
    "div",
    {
    ...
    grid.map((row, r) => /* @__PURE__ */ React.createElement("div", { key: `crossword-row-${r}`, role: "row", className: "contents" }, row.map((cell, c) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        cell.number && /* @__PURE__ */ React.createElement("span", { className: "absolute top-0.5 start-0.5 text-[11px] sm:text-[11px] leading-none text-slate-600 font-normal print:text-slate-700" }, cell.number),
        userChar && /* @__PURE__ */ React.createElement("span", { key: userChar, className: "crossword-entered-letter inline-block animate-in motion-reduce:animate-none zoom-in duration-200" }, userChar)
      );
    })))
  ))), /* @__PURE__ */ React.createElement("div", { className: "w-full md:w-1/3 bg-white border-s border-slate-200 flex flex-col h-1/2 md:h-full print:w-full print:h-auto print:border-0 print:break-inside-avoid", "data-help-key": "crossword_clues_list" }, /* @__PURE__ */ React.createElement("div", { className: "p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50 print:hidden" }, /* @__PURE__ */ React.createElement("div", { className: "text-sm font-bold text-slate-600" }, /* @__PURE__ */ React.createElement("div", null, clues.across.length + clues.down.length, " ", t("games.crossword.clues")), layout.placed > 0 && layout.considered > layout.placed && /* @__PURE__ */ React.createElement("div", { className: "mt-0.5 text-[11px] font-medium text-slate-600" }, t("games.crossword.placed_count", { placed: layout.placed, total: layout.considered }) || layout.placed + " of " + layout.considered + " terms fit this grid")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2", "data-help-key": "crossword_controls" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: printCrossword, className: "min-h-11 px-3 py-2 bg-slate-100 text-slate-700 rounded text-xs font-bold hover:bg-slate-200 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 flex items-center gap-1", "aria-label": t("glossary.print_puzzle") || "Print puzzle" }, /* @__PURE__ */ React.createElement(Printer, { size: 12, "aria-hidden": "true" }), " ", t("glossary.print_puzzle") || "Print"), !isWon && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: revealHint, className: "min-h-11 px-3 py-2 bg-amber-100 text-amber-800 rounded text-xs font-bold hover:bg-amber-200 focus:ring-2 focus:ring-amber-600 focus:ring-offset-2 flex items-center gap-1", "aria-label": t("games.crossword.reveal_letter_hint_aria") || "Reveal one letter hint" }, /* @__PURE__ */ React.createElement(HelpCircle, { size: 12, "aria-hidden": "true" }), " ", t("games.crossword.hint_button") || "Hint", hintsUsed > 0 ? ` (${hintsUsed})` : ""), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: checkPuzzle, className: "min-h-11 px-3 py-2 bg-indigo-100 text-indigo-800 rounded text-xs font-bold hover:bg-indigo-200 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" }, t("games.crossword.check")), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: revealPuzzle, className: "min-h-11 px-3 py-2 bg-red-100 text-red-800 rounded text-xs font-bold hover:bg-red-200 focus:ring-2 focus:ring-red-500 focus:ring-offset-2" }, t("games.crossword.reveal"))))), /* @__PURE__ */ React.createElement("div", { className: "flex-grow overflow-y-auto p-4 space-y-6 print:overflow-visible print:columns-2 print:gap-8" }, /* @__PURE__ */ React.createElement("div", { className: "print:break-inside-avoid" }, /* @__PURE__ */ React.createElement("h4", { className: "font-bold text-indigo-900 uppercase tracking-wider text-xs mb-2 border-b pb-1 print:text-black" }, t("games.crossword.across")), /* @__PURE__ */ React.createElement("ul", { className: "space-y-2 text-sm" }, clues.across.map((c) => /* @__PURE__ */ React.createElement("li", { key: "a-" + c.number, className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    " ",
    c.clue
  ), /* @__PURE__ */ React.createElement("span", { className: "no-print" }, /* @__PURE__ */ React.createElement(SpeakButton, { text: c.clue, size: 11 })))))), /* @__PURE__ */ React.createElement("div", { className: "print:break-inside-avoid" }, /* @__PURE__ */ React.createElement("h4", { className: "font-bold text-indigo-900 uppercase tracking-wider text-xs mb-2 border-b pb-1 print:text-black" }, t("games.crossword.down")), /* @__PURE__ */ React.createElement("ul", { className: "space-y-2 text-sm" }, clues.down.map((c) => /* @__PURE__ */ React.createElement("li", { key: "d-" + c.number, className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    " ",
    c.clue
  ), /* @__PURE__ */ React.createElement("span", { className: "no-print" }, /* @__PURE__ */ React.createElement(SpeakButton, { text: c.clue, size: 11 }))))))), /* @__PURE__ */ React.createElement("div", { className: "p-2 bg-slate-50 text-[11px] text-center text-slate-600 border-t no-print" }, t("games.crossword.footer_tip")), showAnswerKey && /* @__PURE__ */ React.createElement("div", { className: "hidden print:block break-before-page p-4" }, /* @__PURE__ */ React.createElement("h2", { className: "text-2xl font-bold text-slate-800 mb-4 text-center" }, t("glossary.print_answer_key") || "Answer key"), /* @__PURE__ */ React.createElement("div", { className: "columns-2 gap-8 text-sm" }, [["across", clues.across], ["down", clues.down]].map(([dirKey, list]) => /* @__PURE__ */ React.createElement("div", { key: dirKey, className: "break-inside-avoid mb-4" }, /* @__PURE__ */ React.createElement("h4", { className: "font-bold uppercase tracking-wider text-xs mb-2 border-b pb-1" }, dirKey === "across" ? t("games.crossword.across") : t("games.crossword.down")), /* @__PURE__ */ React.createElement("ul", { className: "space-y-1" }, list.map((c) => /* @__PURE__ */ React.createElement("li", { key: dirKey + "-key-" + c.number }, /* @__PURE__ */ React.createElement("span", { className: "font-bold me-1" }, c.number, "."), /* @__PURE__ */ React.createElement("span", { className: "font-bold" }, c.original || c.word), /* @__PURE__ */ React.createElement("span", { className: "ms-2 text-slate-600" }, c.clue)))))))), isWon && /* @__PURE__ */ React.createElement("div", { className: "p-3 no-print" }, /* @__PURE__ */ React.createElement(GameReviewScreen, { score, title: t("games.crossword_title"), items: [...clues.across, ...clues.down].map((c) => ({ label: c.word, detail: c.clue, status: wasRevealed ? "incorrect" : "correct" })), onPlayAgain: () => {
    setIsWon(false);
    setWasRevealed(false);
    setScore(0);
    setHintsUsed(0);
...
const syntaxTokens = (sentence) => {
  if (/\s/.test(sentence.trim())) return sentence.trim().split(/\s+/);
  try {
    const tokens = [];
    for (const part of new Intl.Segmenter(void 0, { granularity: "word" }).segment(sentence)) {
      if (part.isWordLike) tokens.push(part.segment);
      else if (tokens.length) tokens[tokens.length - 1] += part.segment;
...
const syntaxSentences = (text) => {
  ...
  for (const line of clean.split(/\n+/).filter((s) => s.trim())) {
    try {
      candidates.push(...Array.from(new Intl.Segmenter(void 0, { granularity: "sentence" }).segment(line), (s) => s.segment));
    } catch (_) {
      candidates.push(...line.match(/[^.!?。！？؟।]+[.!?。！？؟।]*["'”’]?/gu) || []);
    }
  }
  return [...new Set(candidates.map((s) => s.trim().replace(/\s+/g, " ")))].filter((s) => {
    const words = syntaxTokens(s);
    return words.length > 3 && s.length < 150 && new Set(words).size > 1;
  });
};
const SyntaxScramble = React.memo(({ text, onClose, playSound, onScoreUpdate, onGameComplete }) => {
  ...
  const syntaxRoundRef = useRef(false);
  const syntaxCompleteRef = useRef(false);
  useGameDialogFocus(syntaxDialogRef, syntaxCloseRef, onClose);
  useEffect(() => {
    if (gameStatus === "complete") syntaxFinishRef.current?.focus();
  }, [gameStatus]);
  useEffect(() => {
    syntaxCompleteRef.current = false;
    syntaxRoundRef.current = false;
    setSentences(fisherYatesShuffle(syntaxSentences(text)).slice(0, 10));
  ...
  useEffect(() => {
    if (sentences.length > 0 && currentSentenceIndex < sentences.length) {
      const words = syntaxTokens(sentences[currentSentenceIndex]).map((word, id) => ({ id, text: word }));
      let shuffled = fisherYatesShuffle(words);
      if (shuffled.every((word, i) => word.text === words[i].text)) shuffled = [...words.slice(1), words[0]];
      syntaxRoundRef.current = false;
  ...
  useEffect(() => {
    if (gameStatus !== "complete" || syntaxCompleteRef.current) return;
    syntaxCompleteRef.current = true;
    if (playSound) playSound("correct");
    if (onGameComplete) onGameComplete("syntaxScramble", {
      score,
      sentencesCompleted: sentences.length,
      totalSentences: sentences.length
    });
  }, [gameStatus, score, sentences.length, playSound, onGameComplete]);
  const handleWordClick = (word, fromPool) => {
    if (syntaxRoundRef.current || gameStatus === "complete") return;
    if (playSound) playSound("click");
    setGameStatus("playing");
    setAnnouncement("");
    if (fromPool) {
    ...
    requestAnimationFrame(() => {
      const selector = fromPool ? '[data-help-key="syntax_pool_word"]' : '[data-help-key="syntax_dropped_word"]';
      (syntaxDialogRef.current?.querySelector(selector) || syntaxDialogRef.current?.querySelector('[data-help-key="syntax_check"]'))?.focus();
    });
  };
  const checkAnswer = () => {
    if (syntaxRoundRef.current || !sentences[currentSentenceIndex] || shuffledWords.length > 0) return;
    const target = syntaxTokens(sentences[currentSentenceIndex]).join(" ").normalize("NFC");
    const answer = userOrder.map((w) => w.text).join(" ").normalize("NFC");
    if (answer === target) {
      syntaxRoundRef.current = true;
      setGameStatus("correct");
      setScore((s) => s + 40);
      setAnnouncement(gameMessage(t, "games.scramble.correct", "Correct!"));
      if (playSound) playSound("correct");
      if (onScoreUpdate) onScoreUpdate(40, "Syntax Scramble");
    } else {
      setGameStatus("incorrect");
      setAnnouncement(gameMessage(t, "games.syntax.try_again", "Try again. Select a word in your sentence to return it to the word bank."));
      if (playSound) playSound("incorrect");
    }
  };
  const nextRound = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", { role: "presentation", className: `fixed inset-0 z-[100] bg-slate-900/95 backdrop-blur-sm flex items-center justify-center p-4${useReducedMotion() ? "" : " animate-in zoom-in-95"}` }, /* @__PURE__ */ React.createElement("div", { ref: syntaxDialogRef, tabIndex: -1, role: "dialog", "aria-modal": "true", "aria-labelledby": "syntax-game-title", className: "bg-white w-full max-w-3xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]" }, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-600 p-4 text-white flex flex-wrap gap-3 justify-between items-center" }, /* @__PURE__ */ React.createElement("h3", { id: "syntax-game-title", className: "font-bold text-xl flex items-center gap-2" }, /* @__PURE__ */ React.createElement(Layout, { size: 24, "aria-hidden": "true" }), " ", t("games.syntax.title")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-800 px-3 py-1 rounded-full text-xs font-bold text-yellow-300 border border-indigo-500" }, t("memory.score"), ": ", score), /* @__PURE__ */ React.createElement(GameThemeToggle, null), /* @__PURE__ */ React.createElement("button", { ref: syntaxCloseRef, type: "button", "data-help-key": "syntax_close", onClick: onClose, className: "min-w-11 min-h-11 inline-flex items-center justify-center hover:bg-indigo-500 rounded-full focus:ring-2 focus:ring-white", "aria-label": t("common.close") }, /* @__PURE__ */ React.createElement(X, { size: 24, "aria-hidden": "true" })))), /* @__PURE__ */ React.createElement("div", { className: "p-4 sm:p-8 flex-grow flex flex-col items-center bg-slate-50 gap-5 overflow-y-auto" }, sentences.length === 0 ? /* @__PURE__ */ React.createElement("p", { role: "status", className: "w-full rounded-xl border border-amber-300 bg-amber-50 p-5 text-amber-900" }, gameMessage(t, "games.syntax.empty", "Add a sentence with at least four words and fewer than 150 characters to play Syntax Scramble.")) : gameStatus === "complete" ? /* @__PURE__ */ React.createElement("div", { role: "status", "aria-labelledby": "syntax-complete-title", className: `text-center${useReducedMotion() ? "" : " animate-in zoom-in"}` }, !useReducedMotion() && /* @__PURE__ */ React.createElement(ConfettiExplosion, null), /* @__PURE__ */ React.createElement(Trophy, { size: 64, className: "text-yellow-500 mx-auto mb-4", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("h2", { id: "syntax-complete-title", className: "text-3xl font-black text-slate-800 mb-2" }, t("games.syntax.complete")), /* @__PURE__ */ React.createElement("p", { className: "text-slate-600 mb-6" }, t("games.syntax.summary", { count: sentences.length })), /* @__PURE__ */ React.createElement("button", { ref: syntaxFinishRef, type: "button", "data-help-key": "syntax_finish", onClick: onClose, className: "bg-indigo-600 text-white px-8 py-3 rounded-full font-bold hover:scale-105 transition-transform focus:ring-2 focus:ring-indigo-300" }, t("games.syntax.finish"))) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "w-full flex flex-wrap gap-2 justify-between text-xs font-bold text-slate-600 uppercase tracking-wider" }, /* @__PURE__ */ React.createElement("span", null, t("games.syntax.progress", { current: currentSentenceIndex + 1, total: sentences.length })), /* @__PURE__ */ React.createElement("span", null, t("games.syntax.subtitle"))), /* @__PURE__ */ React.createElement("div", { dir: "auto", className: `w-full min-h-[80px] p-4 rounded-xl border-2 border-dashed flex flex-wrap gap-2 items-center justify-center transition-colors ${gameStatus === "correct" ? "bg-green-50 border-green-400" : "bg-white border-slate-300"}` }, userOrder.length === 0 && /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 italic pointer-events-none select-none" }, t("games.syntax.empty_zone")), userOrder.map((word) => /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      "aria-label": word.text + ". " + gameMessage(t, "games.syntax.remove_word", "Return to word bank"),
      disabled: gameStatus === "correct",
      key: `placed-${word.id}`,
      "data-help-key": "syntax_dropped_word",
      onClick: () => handleWordClick(word, false),
      className: `px-3 py-2 rounded-lg min-h-11 break-words font-bold shadow-sm transition-all animate-in motion-reduce:animate-none zoom-in duration-200 ${gameStatus === "correct" ? "bg-green-100 text-green-800 border border-green-200 cursor-default" : "bg-indigo-100 text-indigo-800 border border-indigo-200 hover:bg-red-100 hover:text-red-800 hover:border-red-200"}`
    },
    word.text
  ))), /* @__PURE__ */ React.createElement("p", { role: "status", "aria-live": "polite", "aria-atomic": "true", className: "min-h-6 text-center text-sm font-bold text-slate-700" }, announcement), /* @__PURE__ */ React.createElement("div", { className: "min-h-12" }, gameStatus === "correct" ? /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    "button",
    {
      ...
      onClick: checkAnswer,
      disabled: shuffledWords.length > 0 || userOrder.length === 0,
  ...
  )), /* @__PURE__ */ React.createElement("div", { dir: "auto", className: "flex flex-wrap gap-3 justify-center p-4 bg-slate-200/50 rounded-xl w-full border border-slate-400 min-h-[100px]" }, shuffledWords.map((word) => /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      key: word.id,
      "aria-label": word.text + ". " + gameMessage(t, "games.syntax.add_word", "Add to sentence"),
      "data-help-key": "syntax_pool_word",
      onClick: () => handleWordClick(word, true),
      className: "bg-white text-slate-700 border-b-4 border-slate-300 px-4 py-2 min-h-11 break-words rounded-lg min-h-11 break-words font-bold shadow-sm hover:bg-indigo-50 hover:border-indigo-300 motion-safe:hover:-translate-y-1 active:border-b-0 motion-safe:active:translate-y-0 transition-all"
    },
    word.text
  )))))));
});
const BingoGame = React.memo(({ data, onClose, settings, setSettings, onGenerate, bingoState, setBingoState, onGenerateAudio, selectedVoice, alloBotRef }) => {
  ...
  const callerPlaybackSessionRef = useRef(0);
  const stopCallerPlayback = () => {
    callerPlaybackSessionRef.current += 1;
  ...
  const handleExitCaller = () => {
    stopCallerPlayback();
    setIsCallerMode(false);
  };
  const handleCloseBingo = () => {
    stopCallerPlayback();
    onClose();
  };
  useGameDialogFocus(bingoDialogRef, bingoCloseRef, handleCloseBingo);
  const startCaller = () => {
    stopCallerPlayback();
    const queue = fisherYatesShuffle((Array.isArray(data) ? data : []).filter((item) => item && item.term && item.def));
  ...
  const playCurrentClue = async (index) => {
    ...
    if (item.translations) {
      Object.values(item.translations).forEach((trans) => {
        ...
        const colon = trans.indexOf(":");
        const defPart = colon >= 0 ? trans.slice(colon + 1).trim() : trans;
        textToRead += ". " + defPart;
      });
    }
    if (callerAudioRef.current) {
    ...
    const sessionId = ++callerPlaybackSessionRef.current;
    setIsAudioPlaying(true);
    try {
      if (onGenerateAudio) {
        let url = null;
        if (typeof window !== "undefined" && typeof window.__alloResolveGlossaryAudio === "function") {
          const resolved = await window.__alloResolveGlossaryAudio({ entryId: item.entryId || item.id || null, field: "definition", language: item.definitionLanguage || "English", spokenText: textToRead });
          url = typeof resolved === "string" ? resolved : resolved?.audioUrl || resolved?.url || resolved?.src || null;
        }
        if (callerPlaybackSessionRef.current !== sessionId) return;
        if (!url) url = await onGenerateAudio(textToRead, selectedVoice);
        if (callerPlaybackSessionRef.current !== sessionId) return;
        if (!url) {
          setIsAudioPlaying(false);
          return;
        ...
        if (playPromise !== void 0) await playPromise;
      } else {
        setIsAudioPlaying(false);
      }
    } catch (e) {
  ...
  const toggleAutoPlay = () => {
    ...
    if (!newState && autoPlayTimerRef.current) {
      clearTimeout(autoPlayTimerRef.current);
      autoPlayTimerRef.current = null;
    }
  ...
  useEffect(() => {
    if (!isAudioPlaying && isAutoPlaying && currentCallIndex >= callerQueue.length - 1) {
      setIsAutoPlaying(false);
      return;
    }
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: bingoDialogRef, tabIndex: -1, role: "dialog", "aria-modal": "true", "aria-labelledby": "bingo-generator-title", className: "allo-glossary-print-dialog glossary-bingo-dialog fixed inset-0 z-[100] bg-slate-900/90 backdrop-blur-sm flex items-center justify-center p-4 motion-safe:animate-in motion-safe:fade-in motion-safe:duration-300" }, /* @__PURE__ */ React.createElement(GlossaryPrintStyles, null), /* @__PURE__ */ React.createElement("div", { className: "bg-white w-full max-w-6xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[95vh] p-6 relative bingo-modal-container" }, /* @__PURE__ */ React.createElement("div", { className: "sr-only", role: "status", "aria-live": "polite" }, announcement), /* @__PURE__ */ React.createElement(
  ...
  )) : /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-3 w-full justify-between" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      onClick: handleExitCaller,
    ...
    " ",
    t("bingo.exit_caller")
  ), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 bg-white px-3 py-1.5 rounded-lg border border-slate-400 shadow-sm" }, /* @__PURE__ */ React.createElement("label", { htmlFor: "bingo-call-speed", className: "text-xs font-bold text-slate-600 uppercase" }, t("bingo.speed")), /* @__PURE__ */ React.createElement(
    "input",
    {
      id: "bingo-call-speed",
      type: "range",
...
const StudentBingoGame = React.memo(({ data, onClose, playSound, onGameComplete }) => {
  ...
  const checkWin = (currentMarks) => {
    ...
    setIsWon(win);
    if (win && !bingoCompleteFiredRef.current) {
      bingoCompleteFiredRef.current = true;
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: studentBingoDialogRef, tabIndex: -1, role: "dialog", "aria-modal": "true", "aria-labelledby": "student-bingo-title", className: "fixed inset-0 z-[100] bg-slate-900/95 backdrop-blur-md flex flex-col items-center justify-center p-2 sm:p-4 motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-95 motion-safe:duration-300" }, /* @__PURE__ */ React.createElement("div", { className: "sr-only", role: "status", "aria-live": "polite" }, announcement), isWon && !reducedMotion && /* @__PURE__ */ React.createElement(ConfettiExplosion, null), /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden border-4 border-indigo-500 flex flex-col max-h-[90vh]" }, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-600 p-4 text-white flex flex-wrap justify-between items-center gap-3 shrink-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white/20 p-2 rounded-full" }, /* @__PURE__ */ React.createElement(Gamepad2, { size: 24, "aria-hidden": "true" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { id: "student-bingo-title", className: "font-black text-xl sm:text-2xl uppercase tracking-wider sm:tracking-widest break-words" }, t("bingo.student_title")), /* @__PURE__ */ React.createElement("p", { className: "text-indigo-200 text-xs font-bold" }, t("bingo.click_hint")))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement(
    ...
    {
      type: "button",
      "data-help-key": "bingo_new_card",
      onClick: () => setCardVersion((value) => value + 1),
  ...
  ), /* @__PURE__ */ React.createElement(GameThemeToggle, null), /* @__PURE__ */ React.createElement("button", { ref: studentBingoCloseRef, type: "button", onClick: onClose, className: "min-w-11 min-h-11 p-2 hover:bg-indigo-500 rounded-full transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-white focus:ring-offset-indigo-700", "aria-label": t("bingo.close_game_aria") }, /* @__PURE__ */ React.createElement(X, { size: 24, "aria-hidden": "true" })))), /* @__PURE__ */ React.createElement("div", { className: "p-2 sm:p-6 overflow-auto custom-scrollbar bg-indigo-50 flex-grow flex items-center justify-center" }, grid.length === 0 && /* @__PURE__ */ React.createElement("p", { role: "status", className: "rounded-xl border border-amber-300 bg-amber-50 p-4 text-amber-900" }, gameMessage(t, "games.bingo.empty", "Add glossary terms to create a Bingo card.")), /* @__PURE__ */ React.createElement("div", { role: "group", "aria-label": t("bingo.student_title"), className: "grid grid-cols-5 gap-2 w-full aspect-square max-w-[600px]" }, grid.map((row, r) => row.map((cell, c) => {
    const key = `${r}-${c}`;
    const isMarked = marks.has(key);
    const cellContent = /* @__PURE__ */ React.createElement(React.Fragment, null, showImages && cell.imageUrl && /* @__PURE__ */ React.createElement("img", { src: cell.imageUrl, alt: "", "aria-hidden": "true", className: `w-8 h-8 sm:w-10 sm:h-10 object-contain rounded mb-0.5 ${isMarked && cell.type !== "free" ? "opacity-100" : ""}` }), /* @__PURE__ */ React.createElement("span", { style: { overflowWrap: "anywhere" }, className: `w-full text-[11px] sm:text-xs font-bold leading-tight break-words ${isMarked && cell.type !== "free" ? "opacity-100" : ""}` }, cell.text), isMarked && /* @__PURE__ */ React.createElement("span", { className: "absolute top-1 right-1 flex items-center justify-center z-10 pointer-events-none", "aria-hidden": "true" }, cell.type === "free" ? /* @__PURE__ */ React.createElement(Star, { size: 32, className: "text-yellow-500 fill-yellow-400 drop-shadow-sm motion-safe:animate-in motion-safe:zoom-in motion-safe:duration-300" }) : /* @__PURE__ */ React.createElement("span", { className: "w-4 h-4 rounded-full bg-indigo-700 text-white flex items-center justify-center text-xs font-black" }, "\u2713")));
    const cellClasses = `relative min-w-11 min-h-11 border-2 rounded-lg flex flex-col items-center justify-center text-center p-1 select-none shadow-sm ${cell.type === "free" ? "cursor-default bg-indigo-200 border-indigo-400 text-indigo-800 font-black" : `cursor-pointer focus:ring-4 focus:ring-indigo-600 focus:ring-offset-2 ${isMarked ? "bg-indigo-50 border-indigo-500" : "bg-white border-slate-200 hover:border-indigo-300 hover:shadow-md"}`}`;
    if (cell.type === "free") {
...
const WordScrambleGame = React.memo(({ data, onClose, playSound, onScoreUpdate, onGameComplete }) => {
  ...
  useEffect(() => () => clearTimeout(scrambleTimerRef.current), []);
  const scrambleItems = React.useMemo(() => (Array.isArray(data) ? data : []).map((item) => {
  ...
  const handleCheck = () => {
    if (roundLockedRef.current || isGameOver || !guess.trim()) return;
    clearTimeout(scrambleTimerRef.current);
  ...
  const handleSkip = () => {
    if (roundLockedRef.current || isGameOver) return;
    roundLockedRef.current = true;
    clearTimeout(scrambleTimerRef.current);
    const currentItem = gameItems[currentIndex];
    if (currentItem) {
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: scrambleDialogRef, tabIndex: -1, role: "dialog", "aria-modal": "true", "aria-labelledby": "word-scramble-title", className: "fixed inset-0 z-[100] bg-slate-900/95 backdrop-blur-sm flex items-center justify-center p-4 motion-safe:animate-in motion-safe:zoom-in-95" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col relative max-h-[95vh] overflow-y-auto p-4 sm:p-8 text-center border-4 border-indigo-500" }, /* @__PURE__ */ React.createElement("div", { className: "sr-only", role: "status", "aria-live": "polite" }, announcement), /* @__PURE__ */ React.createElement(
  ...
  )) : eligibleTermCount === 0 ? /* @__PURE__ */ React.createElement("div", { role: "status", className: "max-w-md rounded-xl border border-amber-300 bg-amber-50 p-5 text-amber-900" }, /* @__PURE__ */ React.createElement("p", { className: "font-bold" }, t("games.scramble.empty_title") || "No terms are available for Word Scramble."), /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm" }, t("games.scramble.empty_body") || "Add a glossary term with at least three letters, not counting emoji or punctuation, then try again.")) : gameItems.length > 0 ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between w-full px-4 border-b border-slate-200 pb-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs font-bold text-slate-600 uppercase tracking-wider" }, t("games.scramble.progress", { current: currentIndex + 1, total: gameItems.length })), /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full font-bold text-sm" }, t("flashcards.score_label"), " ", score)), /* @__PURE__ */ React.createElement("div", { className: "bg-white p-4 rounded-xl border border-slate-400 shadow-sm max-w-lg w-full" }, /* @__PURE__ */ React.createElement("h4", { className: "text-xs font-bold text-slate-600 uppercase tracking-wider mb-2 flex items-center gap-1 justify-center" }, /* @__PURE__ */ React.createElement(Search, { size: 12, "aria-hidden": "true" }), " ", t("games.scramble.hint_label")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-center gap-2" }, gameItems[currentIndex].emoji && /* @__PURE__ */ React.createElement("span", { className: "text-2xl shrink-0", "aria-hidden": "true" }, gameItems[currentIndex].emoji), /* @__PURE__ */ React.createElement("p", { className: "text-lg font-medium text-slate-700 leading-relaxed" }, '"', gameItems[currentIndex].def, '"'), /* @__PURE__ */ React.createElement(SpeakButton, { text: gameItems[currentIndex].def }))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap justify-center gap-2" }, gameGraphemes(scrambled).map((char, idx) => /* @__PURE__ */ React.createElement(
    "div",
    {
    ...
    char
  ))), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-600" }, gameMessage(t, "games.scramble.word_points", "Points available for this word"), ": ", /* @__PURE__ */ React.createElement("strong", null, Math.max(0, 10 - hintLevel * 3)), " \xB7 ", gameMessage(t, "games.scramble.hint_cost_note", "Each hint reduces this word by 3 points, down to 0.")), hintText && /* @__PURE__ */ React.createElement("div", { className: "bg-amber-50 border-2 border-amber-300 text-amber-800 px-4 py-2 rounded-xl font-mono text-xl tracking-[0.3em] font-bold motion-safe:animate-in motion-safe:fade-in" }, hintText), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-3 w-full max-w-xs motion-safe:animate-in motion-safe:slide-in-from-bottom-4 motion-safe:fade-in" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      ...
      onKeyDown: (e) => {
        if (e.key === "Enter" && !e.nativeEvent.isComposing) handleCheck();
      },
  ...
  ), /* @__PURE__ */ React.createElement("p", { role: "status", className: "min-h-6 text-sm font-bold text-slate-700" }, feedback === "correct" ? gameMessage(t, "games.scramble.correct", "Correct!") : feedback === "incorrect" ? gameMessage(t, "games.scramble.incorrect", "Try again. Use the clue or ask for a hint.") : ""), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 w-full" }, /* @__PURE__ */ React.createElement("button", { type: "button", disabled: feedback === "correct" || hintLevel >= Math.max(1, hintCells.length - 1), onClick: useHint, className: "flex-1 py-3 rounded-xl font-bold text-amber-800 bg-amber-50 hover:bg-amber-100 border border-amber-200 transition-colors flex items-center justify-center gap-1 focus:ring-2 focus:ring-amber-600 focus:ring-offset-2", "aria-label": t("games.scramble.get_hint_aria") || "Get a hint" }, /* @__PURE__ */ React.createElement(HelpCircle, { size: 14, "aria-hidden": "true" }), " ", t("games.scramble.hint_button") || "Hint"), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
...
const DefinitionDetectiveGame = React.memo(({ data, onClose, onScoreUpdate, onGameComplete, playSound }) => {
  ...
  const stopAudio = () => {
    stopOwnedAudio();
    setAudioState({ text: "", status: "idle", error: false });
  };
  const close = () => {
    stopAudio();
    onClose?.();
  ...
  useEffect(() => {
    const sync = (event) => {
      ...
      setAudioState((previous) => owned && state.currentId === owned.id ? { text: owned.text, status: state.status || (state.isPlaying ? "playing" : "idle"), error: state.status === "error" } : { ...previous, text: "", status: "idle" });
    };
    window.addEventListener("allo-speech-state", sync);
    return () => {
      window.removeEventListener("allo-speech-state", sync);
      stopOwnedAudio();
    };
  }, []);
  const readAloud = (text) => {
    ...
    if (!player || typeof player.speak !== "function" || typeof player.getCurrentId !== "function") {
      setAudioState({ text: "", status: "error", error: true });
      return;
    }
  ...
  const audioButton = (text, label) => {
    ...
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        "data-help-key": "detective_read_aloud",
      ...
      active ? /* @__PURE__ */ React.createElement(StopCircle, { size: 18, "aria-hidden": "true" }) : /* @__PURE__ */ React.createElement(Volume2, { size: 18, "aria-hidden": "true" }),
  ...
  const dataKey = JSON.stringify((Array.isArray(data) ? data : []).filter((item) => item && typeof item.term === "string" && typeof item.def === "string" && keyFor(item.term) && keyFor(item.def)).map((item) => ({ term: item.term.trim(), def: item.def.trim() })));
  ...
  const buildRounds = () => {
    const terms = /* @__PURE__ */ new Map(), definitions = /* @__PURE__ */ new Map();
    entries.forEach((item) => {
      ...
      if (!definitions.has(definitionKey)) definitions.set(definitionKey, { key: definitionKey, def: item.def, accepted: /* @__PURE__ */ new Set() });
  ...
  useEffect(() => {
    ...
    if (practice) return;
    const correctCount2 = results.filter((result) => result.correct).length;
    callbacksRef.current.onScoreUpdate?.(correctCount2 * 10, "Definition Detective Complete");
    callbacksRef.current.onGameComplete?.("definitionDetective", {
      score: correctCount2 * 10,
      correctCount: correctCount2,
      correctPlacements: correctCount2,
      totalItems: rounds.length,
      isPerfect: correctCount2 === rounds.length
    });
  ...
  return /* @__PURE__ */ React.createElement(
    "div",
    {
      ...
      role: "dialog",
      "aria-modal": "true",
      "aria-labelledby": "definition-detective-title",
      "aria-describedby": "detective-instructions",
      className: "fixed inset-0 z-[100] bg-slate-900/90 backdrop-blur-sm flex items-center justify-center p-2 sm:p-5"
    },
    /* @__PURE__ */ React.createElement("div", { className: "bg-white w-full max-w-3xl max-h-[94vh] overflow-y-auto overscroll-contain rounded-2xl shadow-2xl border border-indigo-200 " + (largeText ? "detective-large-text" : "") }, /* @__PURE__ */ React.createElement("style", null, ".detective-large-text [data-detective-reading]{font-size:1.5rem;line-height:1.75}.detective-large-text [data-help-key=detective_choice]{font-size:1.375rem;line-height:1.6}[data-help-key=detective_choice]:disabled{opacity:1}@media(forced-colors:active){[data-help-key=detective_choice][data-answer-state=correct]{outline:3px solid Highlight;outline-offset:-5px}[data-help-key=detective_choice][data-answer-state=wrong]{border-style:dashed}}"), /* @__PURE__ */ React.createElement("header", { className: "flex items-start justify-between gap-3 bg-indigo-700 text-white p-4 sm:p-6 rounded-t-2xl" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs font-bold uppercase tracking-widest text-indigo-100 mb-2" }, message("eyebrow", "Vocabulary \u2022 meaning practice")), /* @__PURE__ */ React.createElement("h2", { id: "definition-detective-title", className: "text-2xl sm:text-3xl font-black break-words" }, title), /* @__PURE__ */ React.createElement("p", { id: "detective-instructions", className: "mt-2 text-sm text-indigo-100" }, message("instructions", "Read the clue, choose a term, and check its meaning. Take your time."))), /* @__PURE__ */ React.createElement("div", { className: "flex shrink-0 gap-1" }, /* @__PURE__ */ React.createElement(GameThemeToggle, null), /* @__PURE__ */ React.createElement(
      "button",
      {
        ref: closeRef,
        type: "button",
        onClick: close,
        "aria-label": gameMessage(t, "common.close", "Close"),
        className: "min-w-11 min-h-11 rounded-full hover:bg-indigo-600 focus-visible:ring-2 focus-visible:ring-white"
      },
      /* @__PURE__ */ React.createElement(X, { size: 22, "aria-hidden": "true", className: "mx-auto" })
    ))), /* @__PURE__ */ React.createElement("div", { className: "p-4 sm:p-7" }, /* @__PURE__ */ React.createElement("div", { className: "mb-4 flex flex-wrap items-center gap-3" }, /* @__PURE__ */ React.createElement("button", { type: "button", "aria-pressed": largeText, onClick: () => setLargeText((value) => !value), className: "min-h-11 rounded-lg border border-slate-400 bg-white text-slate-800 px-3 py-2 font-bold focus-visible:ring-4 focus-visible:ring-indigo-500" }, message("larger_text", "Larger text")), /* @__PURE__ */ React.createElement("span", { className: "text-sm text-slate-600" }, message("no_timer", "No timer. Read or listen at your own pace."))), /* @__PURE__ */ React.createElement("p", { role: "status", "aria-live": "polite", "aria-atomic": "true", className: "text-sm text-slate-700 mb-3" }, audioState.error ? message("audio_unavailable", "Audio is unavailable. Check your sound settings and try again. You can keep reading on screen.") : audioState.status === "generating" ? message("audio_preparing", "Preparing audio. Use Stop reading to cancel.") : audioState.status === "playing" ? message("audio_playing", "Reading aloud.") : ""), !rounds.length ? /* @__PURE__ */ React.createElement("p", { role: "status", className: "rounded-xl border border-amber-300 bg-amber-50 p-5 text-amber-900" }, message("empty", "Add at least two terms with different definitions to play. Terms with the same meaning will not be used as misleading answer choices.")) : phase === "complete" ? /* @__PURE__ */ React.createElement("section", { "aria-labelledby": "detective-summary-title" }, /* @__PURE__ */ React.createElement("h3", { ref: promptRef, tabIndex: -1, id: "detective-summary-title", "aria-describedby": "detective-summary-count", className: "text-2xl font-black text-slate-900" }, practice ? message("practice_complete", "Practice complete") : message("complete", "Case closed!")), /* @__PURE__ */ React.createElement("p", { id: "detective-summary-count", className: "mt-3 text-lg text-slate-700" }, /* @__PURE__ */ React.createElement("strong", null, correctCount, " / ", rounds.length), " ", message("correct", "correct")), !practice && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-slate-600" }, message("score", "Points"), ": ", correctCount * 10), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-slate-700" }, missed.length ? message("review_prompt", "These meanings are worth another look:") : message("all_correct", "You matched every clue. Try explaining one of these terms in your own words.")), !!missed.length && /* @__PURE__ */ React.createElement("ul", { className: "mt-3 space-y-3" }, missed.map((result) => /* @__PURE__ */ React.createElement("li", { key: result.key, className: "rounded-xl bg-amber-50 border border-amber-200 p-4" }, /* @__PURE__ */ React.createElement("strong", { "data-detective-reading": true, className: "text-slate-900 break-words", dir: "auto" }, result.target.term), /* @__PURE__ */ React.createElement("p", { "data-detective-reading": true, className: "mt-1 text-slate-700 break-words", dir: "auto" }, result.def)))), /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex flex-wrap gap-3" }, !!missed.length && audioButton(missed.map((result) => result.target.term + ". " + result.def).join(". "), message("read_review", "Read review aloud")), !!missed.length && /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        "data-help-key": "detective_practice_missed",
        onClick: () => start(mix(missed.map(({ choice, correct, ...round }) => ({ ...round, choices: mix(round.choices) }))), true),
        className: "min-h-11 rounded-lg bg-indigo-700 text-white px-4 py-3 font-bold focus-visible:ring-4 focus-visible:ring-indigo-400"
      },
      message("practice_missed", "Practise missed clues")
    ), /* @__PURE__ */ React.createElement("button", { type: "button", "data-help-key": "detective_new_round", onClick: () => start(buildRounds()), className: "min-h-11 rounded-lg border border-slate-300 bg-white text-slate-800 px-4 py-3 font-bold focus-visible:ring-4 focus-visible:ring-indigo-400" }, message("play_again", "New round"))), !!missed.length && /* @__PURE__ */ React.createElement("p", { className: "mt-2 text-xs text-slate-600" }, message("practice_note", "Practice helps you learn; it does not add points or another completion record."))) : current && /* @__PURE__ */ React.createElement("section", { "aria-labelledby": "detective-clue" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap justify-between gap-3 text-sm font-bold text-indigo-800 mb-3" }, /* @__PURE__ */ React.createElement("span", { id: "detective-position" }, practice ? message("practice", "Practice") : message("clue", "Clue"), " ", index + 1, " / ", rounds.length), /* @__PURE__ */ React.createElement("span", null, message("answered", "Answered"), ": ", results.length, " / ", rounds.length)), /* @__PURE__ */ React.createElement("progress", { "aria-label": message("progress", "Clues answered"), max: rounds.length, value: results.length, className: "w-full h-2 accent-indigo-600 mb-5" }), /* @__PURE__ */ React.createElement("div", { className: "rounded-2xl border border-indigo-200 bg-indigo-50 p-5 sm:p-6" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs font-bold uppercase tracking-wider text-indigo-700 mb-3" }, message("question", "Which term matches this definition?")), /* @__PURE__ */ React.createElement("h3", { ref: promptRef, tabIndex: -1, id: "detective-clue", "data-detective-reading": true, "aria-describedby": "detective-position", dir: "auto", className: "text-lg sm:text-2xl leading-relaxed font-semibold text-slate-900 break-words" }, current.def)), /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, audioButton(clueAudio, message("read_clue", "Read clue and choices aloud"))), /* @__PURE__ */ React.createElement("div", { className: "mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3", role: "group", "aria-label": message("choices", "Answer choices"), "aria-describedby": "detective-clue" }, current.choices.map((choice) => {
      ...
      return /* @__PURE__ */ React.createElement(
        "button",
        {
          key: choice.key,
          type: "button",
          "data-help-key": "detective_choice",
          "data-answer-state": correct ? "correct" : wrong ? "wrong" : void 0,
        ...
        /* @__PURE__ */ React.createElement("span", { dir: "auto" }, choice.term),
        correct && /* @__PURE__ */ React.createElement("span", { className: "block mt-1 text-xs" }, "\u2713 ", message("correct_answer", "Correct answer")),
        wrong && /* @__PURE__ */ React.createElement("span", { className: "block mt-1 text-xs" }, "\xD7 ", message("your_choice", "Your choice"))
      );
    })), phase === "question" && /* @__PURE__ */ React.createElement("button", { type: "button", "data-help-key": "detective_not_sure", onClick: () => choose(null), className: "mt-4 min-h-11 rounded-lg border border-slate-400 bg-white text-slate-800 px-4 py-3 font-bold focus-visible:ring-4 focus-visible:ring-indigo-500" }, message("not_sure", "Not sure yet \u2014 show the meaning")), answer && /* @__PURE__ */ React.createElement("div", { className: "mt-5" }, /* @__PURE__ */ React.createElement("div", { role: "region", "aria-labelledby": "detective-feedback-title", className: "rounded-xl border border-slate-200 bg-slate-50 p-4 text-slate-800" }, /* @__PURE__ */ React.createElement("h4", { ref: feedbackRef, tabIndex: -1, id: "detective-feedback-title", "aria-describedby": "detective-feedback-meaning", className: "font-bold text-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-600" }, answer.skipped ? message("learn_meaning", "Let\u2019s learn this meaning") : answer.correct ? message("well_done", "That is the match!") : message("compare", "Compare the meanings:")), /* @__PURE__ */ React.createElement("div", { id: "detective-feedback-meaning", "data-detective-reading": true }, /* @__PURE__ */ React.createElement("p", { className: "mt-2 break-words", dir: "auto" }, /* @__PURE__ */ React.createElement("strong", null, current.target.term), " \u2014 ", current.def), !answer.correct && answer.choice && /* @__PURE__ */ React.createElement("p", { className: "mt-2 break-words", dir: "auto" }, /* @__PURE__ */ React.createElement("strong", null, answer.choice.term), " \u2014 ", answer.choice.defs.join(" / "))), /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, audioButton(feedbackAudio, message("read_feedback", "Read feedback aloud")))), /* @__PURE__ */ React.createElement("button", { ref: nextRef, type: "button", "data-help-key": "detective_next", onClick: next, className: "mt-4 min-h-11 w-full sm:w-auto rounded-lg bg-indigo-700 hover:bg-indigo-800 text-white px-6 py-3 font-bold focus-visible:ring-4 focus-visible:ring-indigo-400" }, index + 1 === rounds.length ? message("review", "See my review") : message("next", "Next clue"), " ", /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "\u2192"))))))
  );
});
...
window.AlloModules.GameTextUtils = {
  ...
  window.AlloModules.DefinitionDetectiveGame = DefinitionDetectiveGame;
  ...
  console.log('[GamesBundle] 22 game components registered');
})();
