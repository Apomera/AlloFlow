...
(function () {
  ...
  var QUIZ = [
    ...
    { q: 'The quickest way to flip an electromagnet’s north and south poles is to…', a: ['Reverse the current direction', 'Add more battery cells in series', 'Use thicker wire', 'Cool it down'], c: 0,
    ...
    { q: 'In a DC motor, what keeps the loop turning the same way instead of just jiggling?', a: ['The commutator flips the current each half-turn', 'The magnets get stronger', 'Gravity', 'The battery pulses on its own at the loop\'s natural frequency'], c: 0,
    ...
    { q: 'Earth behaves like a giant bar magnet. Its magnetic poles are…', a: ['Near, but not exactly at, the geographic poles', 'Exactly at the geographic poles, by definition of the poles', 'At the equator', 'On the Moon'], c: 0,
    ...
    { q: 'Over Earth’s history the magnetic poles have…', a: ['Reversed many times, at irregular intervals', 'Never moved', 'Reversed exactly every 1000 years, like a clock', 'Only moved once'], c: 0,
      why: 'The field flips north↔south irregularly over geologic time; the last full reversal was about 780,000 years ago.' },
    { q: 'You hold a strong magnet perfectly still inside a coil of wire. The voltmeter reads…', a: ['Zero — only CHANGING flux makes voltage', 'A steady high voltage', 'Higher the stronger the magnet, even when it is still', 'It slowly charges up'], c: 0,
    ...
    { q: 'A transformer has 100 primary turns and 300 secondary turns. 120 V AC goes in. What comes out?', a: ['360 V — stepped up 3×', '40 V — stepped down to a third', '120 V — unchanged', '0 V — nothing'], c: 0,
      why: 'V₂/V₁ = N₂/N₁ = 300/100 = 3, so 120 V becomes 360 V. Trade: the current steps DOWN by the same factor — power is conserved.' },
    { q: 'A magnet falls in slow motion through a copper tube, yet copper is not magnetic. Why?', a: ['The falling magnet induces eddy currents that push back on it', 'Copper is slightly magnetic after all, once a strong magnet is close enough', 'Air pressure builds inside the tube', 'Gravity is weaker inside metal'], c: 0,
    ...
    { q: 'You heat an iron magnet past its Curie temperature (770°C). It…', a: ['Loses its magnetism — the domains scramble', 'Gets much stronger', 'Flips north and south', 'Starts to glow magnetically as the domains heat up'], c: 0,
    ...
    { q: 'Earth’s “north magnetic pole” (up near the Arctic) is, magnetically speaking…', a: ['A south pole — that’s why compass red ends point toward it', 'A north pole, as the name says, which is why a compass needle points to it', 'Neither — it has no polarity', 'Both at once'], c: 0,
    ...
    { q: 'You reverse BOTH the current direction and the winding direction of an electromagnet. Its poles…', a: ['Stay in their original places', 'Swap once', 'Disappear', 'Become equally north at both ends'], c: 0,
      why: 'Either reversal alone swaps the poles. Two reversals cancel, so the original field direction returns.' },
    { q: 'You reverse BOTH the supply current and the magnetic field in a DC motor. Its rotation…', a: ['Keeps its original direction', 'Reverses', 'Stops permanently, since the two reversals cancel', 'Becomes random'], c: 0,
    ...
    { q: 'A rotating generator coil spins twice as fast with the same turns and field. Its waveform has…', a: ['Twice the frequency and twice the voltage amplitude', 'Twice the frequency but the same voltage, since the field is unchanged', 'The same frequency and voltage', 'Half the frequency'], c: 0,
