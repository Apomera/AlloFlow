    ...
    sections: [
        ...
        },
        {
            ...
            interactiveDiagram: {
                ...
                svg: '<svg viewBox="0 0 800 300" width="100%" role="img" aria-labelledby="ch6LegalTitle ch6LegalDesc" xmlns="http://www.w3.org/2000/svg"><title id="ch6LegalTitle">Two legal questions across two timeframes</title><desc id="ch6LegalDesc">Mental state at the alleged act is evaluated under the jurisdiction\'s insanity rule. Present adjudicative abilities are evaluated under Dusky and jurisdiction-specific law. In both, the evaluator informs the legal decision maker rather than deciding the legal question.</desc><rect x="30" y="42" width="350" height="185" rx="16" fill="#4c1d1d" stroke="#f87171" stroke-width="2"/><text x="205" y="72" text-anchor="middle" fill="#fecaca" font-weight="bold" font-size="17">THEN: alleged act</text><text x="205" y="103" text-anchor="middle" fill="#fff" font-size="14">Jurisdiction\'s insanity rule</text><text x="205" y="130" text-anchor="middle" fill="#e2e8f0" font-size="12">Mental state + rule-specific abilities</text><path d="M205 145v30" stroke="#fca5a5" stroke-width="3"/><path d="M198 168l7 9 7-9" fill="none" stroke="#fca5a5" stroke-width="3"/><text x="205" y="202" text-anchor="middle" fill="#fecaca" font-size="12">Evaluator informs judge / fact finder</text><rect x="420" y="42" width="350" height="185" rx="16" fill="#172554" stroke="#60a5fa" stroke-width="2"/><text x="595" y="72" text-anchor="middle" fill="#bfdbfe" font-weight="bold" font-size="17">NOW: proceedings</text><text x="595" y="103" text-anchor="middle" fill="#fff" font-size="14">Dusky + jurisdiction-specific law</text><text x="595" y="130" text-anchor="middle" fill="#e2e8f0" font-size="12">Understanding + ability to assist counsel</text><path d="M595 145v30" stroke="#93c5fd" stroke-width="3"/><path d="M588 168l7 9 7-9" fill="none" stroke="#93c5fd" stroke-width="3"/><text x="595" y="202" text-anchor="middle" fill="#bfdbfe" font-size="12">Evaluator informs the court</text><rect x="115" y="247" width="570" height="38" rx="10" fill="#0f172a" stroke="#94a3b8"/><text x="400" y="271" text-anchor="middle" fill="#e2e8f0" font-size="12">Legal decisions and dispositions vary by jurisdiction; neither outcome is automatic.</text></svg>'
            },
            knowledgeCheck: {
