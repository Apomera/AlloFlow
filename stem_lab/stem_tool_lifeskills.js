...
(function() {
  ...
  var LEARN_TOPICS = [
    ...
    { title: 'Cooking & Food Safety', icon: '\uD83C\uDF73', tryIt: 'cooking', content: {
      ...
      '3-5': 'Food safety is super important! Keep hot food hot (above 140\u00B0F) and cold food cold (below 40\u00B0F). Always wash hands before cooking. Use a thermometer to check meat is fully cooked \u2014 chicken and turkey need to reach 165\u00B0F, and burgers 160\u00B0F. And reading nutrition labels helps you make healthy choices!',
      '6-8': 'Kitchen science: Maillard reaction (browning at 280\u00B0F), caramelization (320\u00B0F), protein denaturation (160\u00B0F). Food safety: minimum safe internal temperatures \u2014 165\u00B0F poultry and leftovers, 160\u00B0F ground meat and egg dishes, 145\u00B0F whole cuts and fish. Those are safety thresholds, not the same thing as the 160\u00B0F where protein denatures. The Danger Zone (40-140\u00B0F where bacteria double every 20 min), the 2-hour rule (discard food left out >2 hrs), and cross-contamination prevention. Recipe math: scaling ratios, unit conversions, and nutrition label literacy.',
      '9-12': 'Advanced food science: why the USDA minimums differ by cut \u2014 165\u00B0F for poultry and 160\u00B0F for ground meat, because grinding spreads surface bacteria all through the meat, while a whole cut is safe at 145\u00B0F with a 3-minute rest. pH and food preservation (acids inhibit bacteria), water activity and shelf stability, smoke points of different oils, emulsification (mayo = oil + water + lecithin), and leavening chemistry (baking soda = base, baking powder = base + acid). FDA nutrition labeling: Daily Values (%DV), added sugars vs natural, and why "serving size" is the food industry\'s greatest marketing trick.'
    }},
