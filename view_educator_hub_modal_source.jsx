...
function EducatorHubModal(props) {
  const {
    ...
    setShowBehaviorLens, setShowClassAnalytics = (() => {}), setIsResearchSuiteOpen = (() => {}), setShowEducatorHub, setShowMindMap = (() => {}), setShowReportWriter, setShowCinematicStudio = (() => {}), showEducatorHub, t,
    userRole = '',
          ...
          <div ref={dialogRef} tabIndex={-1} data-help-key="educator_hub_modal_panel" className="allo-docsuite bg-white rounded-2xl shadow-2xl w-full max-w-2xl p-5 sm:p-8 max-h-[90vh] overflow-y-auto focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" style={{ maxHeight: '90vh' }} role="dialog" aria-modal="true" aria-labelledby="educator-hub-title" aria-describedby="educator-hub-subtitle" onClick={(e) => e.stopPropagation()}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {hubCards.map((card) => (
                      <div key={card.id} className="flex items-center gap-2 rounded-lg bg-white border border-slate-200 p-2">
                        ...
                        <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes(card.id)} aria-label={hubFavoriteIds.includes(card.id) ? tr('hub.remove_favorite', 'Remove from favorites') + ': ' + card.label : tr('hub.add_favorite', 'Add to favorites') + ': ' + card.label} onClick={() => toggleHubFavorite(card.id)} className="min-w-9 min-h-9 rounded-full text-amber-800 text-lg hover:bg-amber-50">{hubFavoriteIds.includes(card.id) ? '★' : '☆'}</button>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {quickCards.map((card) => (
                      <div key={card.id} className="inline-flex items-center rounded-lg border border-indigo-200 bg-white shadow-sm">
                        ...
                        <button type="button" aria-pressed={hubFavoriteIds.includes(card.id)} aria-label={hubFavoriteIds.includes(card.id) ? tr('hub.remove_favorite', 'Remove from favorites') + ': ' + card.label : tr('hub.add_favorite', 'Add to favorites') + ': ' + card.label} onClick={() => toggleHubFavorite(card.id)} className="min-w-9 min-h-10 border-l border-indigo-200 text-amber-800 text-lg hover:bg-amber-50">{hubFavoriteIds.includes(card.id) ? '★' : '☆'}</button>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div ref={hubGridRef} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="relative group" data-hub-id="lesson" data-hub-label="Help me build a lesson" data-hub-section="start">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('lesson')} aria-label={hubFavoriteIds.includes('lesson') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Help me build a lesson' : tr('hub.add_favorite', 'Add to favorites') + ': Help me build a lesson'} title={hubFavoriteIds.includes('lesson') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('lesson'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('lesson') ? '★' : '☆'}</button>
              </div>
              <div className="relative group" data-hub-id="lumen" data-hub-label="Lumen" data-hub-section="start">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('lumen')} aria-label={hubFavoriteIds.includes('lumen') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Lumen' : tr('hub.add_favorite', 'Add to favorites') + ': Lumen'} title={hubFavoriteIds.includes('lumen') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('lumen'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('lumen') ? '★' : '☆'}</button>
              </div>
              <div className="relative group" data-hub-id="document" data-hub-label="Document Hub" data-hub-section="start">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('document')} aria-label={hubFavoriteIds.includes('document') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Document Hub' : tr('hub.add_favorite', 'Add to favorites') + ': Document Hub'} title={hubFavoriteIds.includes('document') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('document'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('document') ? '★' : '☆'}</button>
              </div>
              <div className="relative group" data-hub-id="whiteboard" data-hub-label="Whiteboard" data-hub-section="start">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('whiteboard')} aria-label={hubFavoriteIds.includes('whiteboard') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Whiteboard' : tr('hub.add_favorite', 'Add to favorites') + ': Whiteboard'} title={hubFavoriteIds.includes('whiteboard') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('whiteboard'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('whiteboard') ? '★' : '☆'}</button>
              </div>
              ...
              <div className="relative group" data-hub-id="throughline" data-hub-label="Learning Web: Unit Path" data-hub-section="plan">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('throughline')} aria-label={hubFavoriteIds.includes('throughline') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Learning Web: Unit Path' : tr('hub.add_favorite', 'Add to favorites') + ': Learning Web: Unit Path'} title={hubFavoriteIds.includes('throughline') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('throughline'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('throughline') ? '★' : '☆'}</button>
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('page-designer')} aria-label={hubFavoriteIds.includes('page-designer') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Page Designer' : tr('hub.add_favorite', 'Add to favorites') + ': Page Designer'} title={hubFavoriteIds.includes('page-designer') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('page-designer'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('page-designer') ? '★' : '☆'}</button>
              </div>
              <div className="relative group" data-hub-id="video-studio" data-hub-label="Video Studio" data-hub-section="plan">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('video-studio')} aria-label={hubFavoriteIds.includes('video-studio') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Video Studio' : tr('hub.add_favorite', 'Add to favorites') + ': Video Studio'} title={hubFavoriteIds.includes('video-studio') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('video-studio'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('video-studio') ? '★' : '☆'}</button>
              </div>
              <div className="relative group" data-hub-id="symbol-studio" data-hub-label="Symbol Studio" data-hub-section="plan">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('symbol-studio')} aria-label={hubFavoriteIds.includes('symbol-studio') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Symbol Studio' : tr('hub.add_favorite', 'Add to favorites') + ': Symbol Studio'} title={hubFavoriteIds.includes('symbol-studio') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('symbol-studio'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('symbol-studio') ? '★' : '☆'}</button>
              </div>
              <div className="relative group" data-hub-id="allosheet" data-hub-label="AlloSheet" data-hub-section="plan">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('allosheet')} aria-label={hubFavoriteIds.includes('allosheet') ? tr('hub.remove_favorite', 'Remove from favorites') + ': AlloSheet' : tr('hub.add_favorite', 'Add to favorites') + ': AlloSheet'} title={hubFavoriteIds.includes('allosheet') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('allosheet'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('allosheet') ? '★' : '☆'}</button>
              </div>
              ...
              <div className="relative group" data-hub-id="report-writer" data-hub-label="Report Writer" data-hub-section="teach">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('report-writer')} aria-label={hubFavoriteIds.includes('report-writer') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Report Writer' : tr('hub.add_favorite', 'Add to favorites') + ': Report Writer'} title={hubFavoriteIds.includes('report-writer') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('report-writer'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('report-writer') ? '★' : '☆'}</button>
              </div>
              )}
              ...
              <div className="relative group" data-hub-id="pdf-accessibility" data-hub-label="PDF Accessibility" data-hub-section="access">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('pdf-accessibility')} aria-label={hubFavoriteIds.includes('pdf-accessibility') ? tr('hub.remove_favorite', 'Remove from favorites') + ': PDF Accessibility' : tr('hub.add_favorite', 'Add to favorites') + ': PDF Accessibility'} title={hubFavoriteIds.includes('pdf-accessibility') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('pdf-accessibility'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('pdf-accessibility') ? '★' : '☆'}</button>
              </div>
              ...
              <div className="relative group" data-hub-id="accessibility-lab" data-hub-label="Accessibility Lab" data-hub-section="access">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('accessibility-lab')} aria-label={hubFavoriteIds.includes('accessibility-lab') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Accessibility Lab' : tr('hub.add_favorite', 'Add to favorites') + ': Accessibility Lab'} title={hubFavoriteIds.includes('accessibility-lab') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('accessibility-lab'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('accessibility-lab') ? '★' : '☆'}</button>
              </div>
              ...
              <div className="relative group" data-hub-id="research-suite" data-hub-label="Research Suite" data-hub-section="extend">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('research-suite')} aria-label={hubFavoriteIds.includes('research-suite') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Research Suite' : tr('hub.add_favorite', 'Add to favorites') + ': Research Suite'} title={hubFavoriteIds.includes('research-suite') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('research-suite'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('research-suite') ? '★' : '☆'}</button>
              </div>
              )}
              {!hideSchoolProfessional && (
              <div className="relative group" data-hub-id="professional-development" data-hub-label="Professional Development" data-hub-section="extend">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('professional-development')} aria-label={hubFavoriteIds.includes('professional-development') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Professional Development' : tr('hub.add_favorite', 'Add to favorites') + ': Professional Development'} title={hubFavoriteIds.includes('professional-development') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('professional-development'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('professional-development') ? '★' : '☆'}</button>
              </div>
              )}
              {!hideSchoolProfessional && (
              <div className="relative group" data-hub-id="leadership-hub" data-hub-label="Leadership Hub" data-hub-section="extend">
                ...
                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('leadership-hub')} aria-label={hubFavoriteIds.includes('leadership-hub') ? tr('hub.remove_favorite', 'Remove from favorites') + ': Leadership Hub' : tr('hub.add_favorite', 'Add to favorites') + ': Leadership Hub'} title={hubFavoriteIds.includes('leadership-hub') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('leadership-hub'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('leadership-hub') ? '★' : '☆'}</button>
              </div>
              )}
              {!hideSchoolProfessional && (
              <div className="relative group" data-hub-id="school-rewards" data-hub-label="School Rewards & Store" data-hub-section="extend">
                <button type="button" data-hub-launch="true" data-help-key="educator_hub_school_rewards_card" onClick={() => { setShowEducatorHub(false); openSchoolRewards(); }} className="flex items-start gap-3 p-4 bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-700 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left">
                <span className="text-3xl mt-1" aria-hidden="true">{'\uD83C\uDF9F\uFE0F'}</span>
                <div>
                  <h3 className="font-bold text-emerald-900">{t('educator_hub.school_rewards_title') || 'School Rewards & Store'}</h3>
                  <p className="text-xs text-emerald-800 mt-1">{t('educator_hub.school_rewards_desc') || 'Award recognition points and open the school-owned rewards ledger and prize store. The ledger lives in your school Google Workspace; the staff share link and setup checklist are inside.'}</p>
                </div>
              </button>

                <button type="button" data-hub-favorite="true" aria-pressed={hubFavoriteIds.includes('school-rewards')} aria-label={hubFavoriteIds.includes('school-rewards') ? tr('hub.remove_favorite', 'Remove from favorites') + ': School Rewards & Store' : tr('hub.add_favorite', 'Add to favorites') + ': School Rewards & Store'} title={hubFavoriteIds.includes('school-rewards') ? tr('hub.remove_favorite', 'Remove from favorites') : tr('hub.add_favorite', 'Add to favorites')} onClick={(event) => { event.stopPropagation(); toggleHubFavorite('school-rewards'); }} className="absolute top-2 right-2 z-10 min-w-9 min-h-9 rounded-full bg-white/90 border border-slate-300 text-amber-800 text-lg leading-none shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">{hubFavoriteIds.includes('school-rewards') ? '★' : '☆'}</button>
              </div>
              )}
              {!hideSchoolProfessional && (
