...
const root=process.cwd(),out=path.join(root,'reports/circuit-enhancement/energy33-layout-qa');
(async()=>{
...
function Host(){
const [data,setData]=React.useState({_circuit:{pauseMotion:true},_circuitNetwork:{boardOverlay:"energy"}});
