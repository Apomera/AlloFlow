...
const INCLUDE = [
  ...
  'export_css', 'export_odt', 'epub', 'rawhtml', 'expert_direct', 'skip_link', 'residual', 'restoration', 'palette', 'region_select', 'contrast_pair', 'footnote', 'sanitize_style', 'brand_profile', 'verapdf',
