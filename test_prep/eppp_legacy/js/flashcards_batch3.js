...
(function() {
    ...
    const batch3 = {
        1: [ // Bio — Psychopharmacology Quick-Reference
            ...
            {front: "Clozapine: unique properties", back: "Most effective antipsychotic for treatment-resistant schizophrenia (30% of patients). Mechanism: D4 > D2 blockade + 5-HT2A. Minimal EPS and tardive dyskinesia risk. Fatal risk: agranulocytosis (1%) — requires weekly/biweekly CBC monitoring. Also: metabolic syndrome, seizures, myocarditis."},
