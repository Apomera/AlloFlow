...
![The AlloFlow Launch Pad, offering Guided Mode, Full Platform, Learning Tools, and Educator Tools](../assets/screenshots/10-launch-pad.png)
...
![The full AlloFlow workspace: header strip, left settings and tool column, centre workspace, and the AlloBot panel](../assets/screenshots/11-workspace-overview.png)
...
![The AlloFlow header strip showing the breadcrumb, session controls, and the personal-information note](../assets/screenshots/12-header.png)
...
![The Find a tool panel with its purpose filters and the tool list](../assets/screenshots/13-sidebar-tools.png)
...
![The Auto-Configure card at the foot of the tool list, with its size selector and the Plan full pack control](../assets/screenshots/17-full-pack.png)
...
![The AlloBot panel with the Auto-Fill Settings toggle that turns on Blueprint Mode](../assets/screenshots/16-allobot-autofill.png)
...
If a lesson matters, save the project. Browser data clearing removes on-device work, and the project file is what survives it. [Saving, loading, and managing storage](24-saving-and-storage.md) covers the whole picture, including the recovery key and how to stop AlloFlow running out of room.
...
Now that the screen makes sense, [Prepare a lesson](02-prepare-a-lesson.md) shows how to use it well, [Universal Settings](11-universal-settings.md) goes deeper on the settings panel, and [AlloBot](14-allobot-assistant.md) covers talking to the assistant beyond Blueprint Mode. Keep [Quick reference](18-quick-reference.md) beside you until the shortcuts are habit.
