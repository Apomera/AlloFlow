  ...
  window.StemLab.registerTool('moneyMath', {
    ...
    render: function(ctx) {
      ...
      // ── Inline body follows (adapted from hub) ──
            ...
            const CURRENCIES = {
              USD: { symbol: '$', name: t('stem.money.us_dollar', 'US Dollar'), code: 'USD', flag: '\uD83C\uDDFA\uD83C\uDDF8',
                coins: [
                  { name: t('stem.money.penny', 'Penny'), value: 0.01, color: '#b87333', size: 28, label: '1\u00A2' },
                  { name: t('stem.money.nickel', 'Nickel'), value: 0.05, color: '#C0C0C0', size: 32, label: '5\u00A2' },
                  { name: t('stem.money.dime', 'Dime'), value: 0.10, color: '#C0C0C0', size: 26, label: '10\u00A2' },
                  { name: t('stem.money.quarter', 'Quarter'), value: 0.25, color: '#C0C0C0', size: 36, label: '25\u00A2' },
                  { name: t('stem.money.half_dollar', 'Half Dollar'), value: 0.50, color: '#C0C0C0', size: 40, label: '50\u00A2' },
                  { name: t('stem.money.dollar_coin', 'Dollar Coin'), value: 1.00, color: '#FFD700', size: 38, label: '$1' }
                ],
                bills: [
                  { name: t('stem.money.1_bill', '$1 Bill'), value: 1, color: '#85bb65' },
                  { name: t('stem.money.5_bill', '$5 Bill'), value: 5, color: '#85bb65' },
                  { name: t('stem.money.10_bill', '$10 Bill'), value: 10, color: '#85bb65' },
                  { name: t('stem.money.20_bill', '$20 Bill'), value: 20, color: '#85bb65' },
                  { name: t('stem.money.50_bill', '$50 Bill'), value: 50, color: '#85bb65' },
                  { name: t('stem.money.100_bill', '$100 Bill'), value: 100, color: '#85bb65' }
                ]
              },
              EUR: { symbol: '\u20AC', name: t('stem.money.euro', 'Euro'), code: 'EUR', flag: '\uD83C\uDDEA\uD83C\uDDFA',
                coins: [
                  { name: t('stem.money.1_cent', '1 Cent'), value: 0.01, color: '#b87333', size: 24, label: '1c' },
                  { name: t('stem.money.2_cent', '2 Cent'), value: 0.02, color: '#b87333', size: 26, label: '2c' },
                  { name: t('stem.money.5_cent', '5 Cent'), value: 0.05, color: '#b87333', size: 28, label: '5c' },
                  { name: t('stem.money.10_cent', '10 Cent'), value: 0.10, color: '#FFD700', size: 28, label: '10c' },
                  { name: t('stem.money.20_cent', '20 Cent'), value: 0.20, color: '#FFD700', size: 30, label: '20c' },
                  { name: t('stem.money.50_cent', '50 Cent'), value: 0.50, color: '#FFD700', size: 32, label: '50c' },
              ...
              GBP: { symbol: '\u00A3', name: t('stem.money.british_pound', 'British Pound'), code: 'GBP', flag: '\uD83C\uDDEC\uD83C\uDDE7',
                coins: [
              ...
              CAD: { symbol: 'C$', name: t('stem.money.canadian_dollar', 'Canadian Dollar'), code: 'CAD', flag: '\uD83C\uDDE8\uD83C\uDDE6',
                coins: [
                  ...
                  { name: t('stem.money.loonie', 'Loonie'), value: 1.00, color: '#FFD700', size: 34, label: '$1' },
                  { name: t('stem.money.toonie', 'Toonie'), value: 2.00, color: '#C0C0C0', size: 36, label: '$2' }
                ],
                bills: [
              ...
              JPY: { symbol: '\u00A5', name: t('stem.money.japanese_yen', 'Japanese Yen'), code: 'JPY', flag: '\uD83C\uDDEF\uD83C\uDDF5',
                coins: [
              ...
              MXN: { symbol: 'MX$', name: t('stem.money.mexican_peso', 'Mexican Peso'), code: 'MXN', flag: '\uD83C\uDDF2\uD83C\uDDFD',
                coins: [
              ...
              AUD: { symbol: 'A$', name: t('stem.money.australian_dollar', 'Australian Dollar'), code: 'AUD', flag: '\uD83C\uDDE6\uD83C\uDDFA',
                coins: [
              ...
              INR: { symbol: '\u20B9', name: t('stem.money.indian_rupee', 'Indian Rupee'), code: 'INR', flag: '\uD83C\uDDEE\uD83C\uDDF3',
                coins: [
                  { name: '\u20B91', value: 1, color: '#C0C0C0', size: 28, label: '\u20B91' },
            ...
            const GRADE_CONFIG = {
              elementary: { label: t('stem.money.elementary_k_5', '\uD83C\uDFEB Elementary (K\u20135)'), maxPrice: 10, coinsOnly: false, includePercent: false, includeTax: false, maxItems: 4, wordProblemLevel: 'simple' },
              middle: { label: t('stem.money.middle_6_8', '\uD83C\uDFEB Middle (6\u20138)'), maxPrice: 50, coinsOnly: false, includePercent: true, includeTax: false, maxItems: 6, wordProblemLevel: 'moderate' },
              high: { label: t('stem.money.high_school_9_12', '\uD83C\uDFEB High School (9\u201312)'), maxPrice: 200, coinsOnly: false, includePercent: true, includeTax: true, maxItems: 8, wordProblemLevel: 'advanced' },
              college: { label: t('stem.money.college', '\uD83C\uDFEB College'), maxPrice: 1000, coinsOnly: false, includePercent: true, includeTax: true, maxItems: 10, wordProblemLevel: 'expert' }
            };
            ...
            if (!storeItems) {
              var baseItems = [
                // 🥬 Produce — per-pound
                { name: t('stem.money.apples', '\uD83C\uDF4E Apples'), price: 1.49, cat: 'Produce', pricePer: 'lb' },
                { name: t('stem.money.bananas', '\uD83C\uDF4C Bananas'), price: 0.59, cat: 'Produce', pricePer: 'lb' },
                { name: t('stem.money.grapes', '\uD83C\uDF47 Grapes'), price: 2.49, cat: 'Produce', pricePer: 'lb' },
                { name: t('stem.money.lettuce', '\uD83E\uDD6C Lettuce'), price: 1.99, cat: 'Produce', pricePer: 'each' },
                { name: t('stem.money.tomatoes', '\uD83C\uDF45 Tomatoes'), price: 1.79, cat: 'Produce', pricePer: 'lb' },
                { name: t('stem.money.onions', '\uD83E\uDDC5 Onions'), price: 1.29, cat: 'Produce', pricePer: 'lb' },
                { name: t('stem.money.potatoes', '\uD83E\uDD54 Potatoes'), price: 0.99, cat: 'Produce', pricePer: 'lb' },
                { name: t('stem.money.avocados', '\uD83E\uDD51 Avocados'), price: 1.25, cat: 'Produce', pricePer: 'each' },
                { name: t('stem.money.broccoli', '\uD83E\uDD66 Broccoli'), price: 1.99, cat: 'Produce', pricePer: 'lb' },
                { name: t('stem.money.carrots', '\uD83E\uDD55 Carrots'), price: 1.29, cat: 'Produce', pricePer: 'lb' },
                { name: t('stem.money.lemons', '\uD83C\uDF4B Lemons'), price: 0.69, cat: 'Produce', pricePer: 'each' },
                { name: t('stem.money.garlic', '🧄 Garlic'), price: 0.75, cat: 'Produce', pricePer: 'each' },
                // 🥩 Meat & Fish — per-pound
                { name: t('stem.money.chicken_breast', '\uD83C\uDF57 Chicken Breast'), price: 3.99, cat: 'Meat', pricePer: 'lb' },
                { name: t('stem.money.ground_beef', '\uD83E\uDD69 Ground Beef'), price: 5.49, cat: 'Meat', pricePer: 'lb' },
                { name: t('stem.money.salmon_fillet', '\uD83D\uDC1F Salmon Fillet'), price: 9.99, cat: 'Meat', pricePer: 'lb' },
                { name: t('stem.money.bacon_1_lb', '\uD83E\uDD53 Bacon (1 lb)'), price: 6.49, cat: 'Meat', pricePer: 'each' },
                { name: t('stem.money.pork_chops', '\uD83C\uDF56 Pork Chops'), price: 4.49, cat: 'Meat', pricePer: 'lb' },
                // 🧀 Dairy
                { name: t('stem.money.milk_gal', '\uD83E\uDD5B Milk (gal)'), price: 3.49, cat: 'Dairy', pricePer: 'each' },
                { name: t('stem.money.cheddar_cheese', '\uD83E\uDDC0 Cheddar Cheese'), price: 4.99, cat: 'Dairy', pricePer: 'each' },
                { name: t('stem.money.butter', '\uD83E\uDDC8 Butter'), price: 3.99, cat: 'Dairy', pricePer: 'each' },
                { name: t('stem.money.yogurt', '\uD83E\uDD5B Yogurt'), price: 1.25, cat: 'Dairy', pricePer: 'each' },
                { name: t('stem.money.eggs_dozen', '\uD83E\uDD5A Eggs (dozen)'), price: 3.29, cat: 'Dairy', pricePer: 'each' },
                { name: t('stem.money.heavy_cream', '\uD83E\uDD5B Heavy Cream'), price: 4.29, cat: 'Dairy', pricePer: 'each' },
                // 🍞 Bakery
                { name: t('stem.money.bread', '\uD83C\uDF5E Bread'), price: 2.99, cat: 'Bakery', pricePer: 'each' },
                { name: t('stem.money.bagels_6pk', '\uD83E\uDD6F Bagels (6pk)'), price: 3.49, cat: 'Bakery', pricePer: 'each' },
                { name: t('stem.money.tortillas_10pk', '\uD83C\uDF2F Tortillas (10pk)'), price: 2.79, cat: 'Bakery', pricePer: 'each' },
                // 🥫 Pantry
                { name: t('stem.money.rice_2_lb', '\uD83C\uDF5A Rice (2 lb)'), price: 2.99, cat: 'Pantry', pricePer: 'each' },
                { name: t('stem.money.pasta_1_lb', '\uD83C\uDF5D Pasta (1 lb)'), price: 1.49, cat: 'Pantry', pricePer: 'each' },
                { name: t('stem.money.canned_beans', '\uD83E\uDD6B Canned Beans'), price: 1.09, cat: 'Pantry', pricePer: 'each' },
                { name: t('stem.money.sugar_4_lb', '\uD83C\uDF6F Sugar (4 lb)'), price: 3.49, cat: 'Pantry', pricePer: 'each' },
                { name: t('stem.money.flour_5_lb', '\uD83C\uDF3E Flour (5 lb)'), price: 3.99, cat: 'Pantry', pricePer: 'each' },
                { name: t('stem.money.olive_oil', '\uD83E\uDED2 Olive Oil'), price: 6.99, cat: 'Pantry', pricePer: 'each' },
                { name: t('stem.money.peanut_butter', '\uD83E\uDD5C Peanut Butter'), price: 3.75, cat: 'Pantry', pricePer: 'each' },
                { name: t('stem.money.pasta_sauce', '\uD83C\uDF45 Pasta Sauce'), price: 2.49, cat: 'Pantry', pricePer: 'each' },
                // 🧊 Frozen
                { name: t('stem.money.frozen_pizza', '\uD83C\uDF55 Frozen Pizza'), price: 5.49, cat: 'Frozen', pricePer: 'each' },
                { name: t('stem.money.ice_cream', '\uD83C\uDF66 Ice Cream'), price: 4.99, cat: 'Frozen', pricePer: 'each' },
                { name: t('stem.money.frozen_veggies', '\uD83E\uDD66 Frozen Veggies'), price: 2.49, cat: 'Frozen', pricePer: 'each' },
                // 🥤 Drinks
                { name: t('stem.money.orange_juice', '\uD83E\uDDC3 Orange Juice'), price: 3.99, cat: 'Drinks', pricePer: 'each' },
                { name: t('stem.money.soda_2l', '\uD83E\uDD64 Soda (2L)'), price: 1.99, cat: 'Drinks', pricePer: 'each' },
                { name: t('stem.money.water_24pk', '\uD83D\uDCA7 Water (24pk)'), price: 4.99, cat: 'Drinks', pricePer: 'each' },
                { name: t('stem.money.coffee_12oz', '\u2615 Coffee (12oz)'), price: 7.99, cat: 'Drinks', pricePer: 'each' },
                // 🍫 Snacks
                { name: t('stem.money.chocolate_bar', '\uD83C\uDF6B Chocolate Bar'), price: 1.25, cat: 'Snacks', pricePer: 'each' },
                { name: t('stem.money.chips', '\uD83C\uDF5F Chips'), price: 3.49, cat: 'Snacks', pricePer: 'each' },
                { name: t('stem.money.granola_bars', '\uD83E\uDD5C Granola Bars'), price: 4.29, cat: 'Snacks', pricePer: 'each' },
                { name: t('stem.money.popcorn', '\uD83C\uDF7F Popcorn'), price: 2.99, cat: 'Snacks', pricePer: 'each' }
              ];
            ...
            var RECIPES = [
              { name: t('stem.money.spaghetti_bolognese', '\uD83C\uDF5D Spaghetti Bolognese'), icon: '\uD83C\uDF5D', serves: 4, ingredients: [
              ...
              { name: t('stem.money.tacos', '\uD83C\uDF2E Tacos'), icon: '\uD83C\uDF2E', serves: 4, ingredients: [
              ...
              { name: t('stem.money.pancakes', '\uD83C\uDF73 Pancakes'), icon: '\uD83C\uDF73', serves: 4, ingredients: [
              ...
              { name: t('stem.money.caesar_salad', '\uD83E\uDD57 Caesar Salad'), icon: '\uD83E\uDD57', serves: 4, ingredients: [
              ...
              { name: t('stem.money.chicken_stir_fry', '\uD83C\uDF5C Chicken Stir-Fry'), icon: '\uD83C\uDF5C', serves: 4, ingredients: [
              ...
              { name: t('stem.money.grilled_cheese', '\uD83E\uDD6A Grilled Cheese'), icon: '\uD83E\uDD6A', serves: 4, ingredients: [
              ...
              { name: t('stem.money.mac_cheese', '\uD83E\uDDC0 Mac & Cheese'), icon: '\uD83E\uDDC0', serves: 4, ingredients: [
                { item: 'Pasta (1 lb)', qty: 1, unit: 'box' }, { item: 'Cheddar Cheese', qty: 1, unit: 'pkg' },
                { item: 'Milk (gal)', qty: 1, unit: 'gal' }, { item: 'Butter', qty: 1, unit: 'stick' },
                { item: 'Flour (5 lb)', qty: 1, unit: 'bag' }
              ]},
              { name: t('stem.money.chocolate_chip_cookies', '\uD83C\uDF6A Chocolate Chip Cookies'), icon: '\uD83C\uDF6A', serves: 4, ingredients: [
              ...
              { name: t('stem.money.banana_bread', '\uD83C\uDF4C Banana Bread'), icon: '\uD83C\uDF4C', serves: 4, ingredients: [
              ...
              { name: t('stem.money.veggie_soup', '\uD83C\uDF72 Veggie Soup'), icon: '\uD83C\uDF72', serves: 4, ingredients: [
              ...
              { name: t('stem.money.beef_stew', '\uD83C\uDF73 Beef Stew'), icon: '\uD83C\uDF73', serves: 4, ingredients: [
              ...
              { name: t('stem.money.quesadillas', '\uD83E\uDED3 Quesadillas'), icon: '\uD83E\uDED3', serves: 4, ingredients: [
              ...
              { name: t('stem.money.pesto_pasta', '\uD83C\uDF5D Pesto Pasta'), icon: '\uD83C\uDF5D', serves: 4, ingredients: [
              ...
              { name: t('stem.money.apple_pie', '\uD83E\uDD67 Apple Pie'), icon: '\uD83E\uDD67', serves: 4, ingredients: [
                { item: 'Apples', qty: 2, unit: 'lb' }, { item: 'Flour (5 lb)', qty: 1, unit: 'bag' },
                { item: 'Sugar (4 lb)', qty: 1, unit: 'bag' }, { item: 'Butter', qty: 1, unit: 'stick' },
                { item: 'Lemons', qty: 1, unit: 'each' }
              ]},
              { name: t('stem.money.chili', '\uD83C\uDF36 Chili'), icon: '\uD83C\uDF36', serves: 4, ingredients: [
              ...
              { name: t('stem.money.salmon_dinner', '\uD83D\uDC1F Salmon Dinner'), icon: '\uD83D\uDC1F', serves: 4, ingredients: [
              ...
              { name: t('stem.money.pizza_night', '\uD83C\uDF55 Pizza Night'), icon: '\uD83C\uDF55', serves: 4, ingredients: [
                { item: 'Frozen Pizza', qty: 2, unit: 'pizzas' }, { item: 'Soda (2L)', qty: 1, unit: 'bottle' },
                { item: 'Ice Cream', qty: 1, unit: 'tub' }
              ]},
              { name: t('stem.money.breakfast_sandwich', '\uD83E\uDD6F Breakfast Sandwich'), icon: '\uD83E\uDD6F', serves: 4, ingredients: [
            ...
            var CR_CUSTOMERS = [
              { name: t('stem.money.mrs_johnson', 'Mrs. Johnson'), emoji: '\uD83D\uDC69\u200D\uD83C\uDFEB' },
              { name: t('stem.money.coach_miller', 'Coach Miller'), emoji: '\uD83E\uDDD1\u200D\uD83C\uDFEB' },
              { name: t('stem.money.grandma_rose', 'Grandma Rose'), emoji: '\uD83D\uDC75' },
              { name: t('stem.money.officer_davis', 'Officer Davis'), emoji: '\uD83D\uDC6E' },
              { name: t('stem.money.dr_patel', 'Dr. Patel'), emoji: '\uD83D\uDC69\u200D\u2695\uFE0F' },
              { name: t('stem.money.mr_garcia', 'Mr. Garcia'), emoji: '\uD83D\uDC68\u200D\uD83C\uDF73' },
              { name: t('stem.money.nurse_kim', 'Nurse Kim'), emoji: '\uD83D\uDC69\u200D\u2695\uFE0F' },
              { name: t('stem.money.farmer_jim', 'Farmer Jim'), emoji: '\uD83E\uDDD1\u200D\uD83C\uDF3E' },
              { name: t('stem.money.teen_tyler', 'Teen Tyler'), emoji: '\uD83E\uDDD2' },
              { name: t('stem.money.chef_anna', 'Chef Anna'), emoji: '\uD83D\uDC69\u200D\uD83C\uDF73' },
              { name: t('stem.money.pastor_brown', 'Pastor Brown'), emoji: '\uD83E\uDDD1' },
              { name: t('stem.money.ms_rivera', 'Ms. Rivera'), emoji: '\uD83D\uDC69\u200D\uD83D\uDCBC' },
              { name: t('stem.money.old_man_pete', 'Old Man Pete'), emoji: '\uD83D\uDC74' },
              { name: t('stem.money.firefighter_sam', 'Firefighter Sam'), emoji: '\uD83E\uDDD1\u200D\uD83D\uDE92' },
              { name: t('stem.money.little_timmy', 'Little Timmy'), emoji: '\uD83D\uDC66' },
              { name: t('stem.money.librarian_wells', 'Librarian Wells'), emoji: '\uD83E\uDDD1\u200D\uD83D\uDCBB' }
            ];
            ...
            var startCashierRush = function () {
              ...
              if (!crSeenIntro && crBotCoachOn) {
                var greetMsg = crDifficulty === 'easy'
                  ? { text: t('stem.money.power_s_out_cash_register_is_dead_cust', 'Power\'s out. Cash register is dead. Customers need you to add the prices up — they\'re all rounded to nice numbers so you can practice clean.'), kind: 'intro', ts: Date.now() }
                  : { text: t('stem.money.power_s_out_cash_register_is_dead_cust_2', 'Power\'s out. Cash register is dead. Customers need you to add it up in your head.'), kind: 'intro', ts: Date.now() };
            ...
            var submitCashierAnswer = function () {
              ...
              if (!perfect && newWrong === 1) {
                botMsg = { text: t('stem.money.try_this_ignore_the_cents_round_each_p', 'Try this: ignore the cents. Round each price up. Then estimate.'), kind: 'hint', ts: Date.now() };
                newMood = 'concerned';
                ...
                botMsg = { text: t('stem.money.nice_flow_you_re_getting_fast', 'Nice flow. You\'re getting fast.'), kind: 'praise', ts: Date.now() };
                newMood = 'happy';
            ...
            var budgetCats = d.budgetCats || [
              { name: t('stem.money.housing', '\uD83C\uDFE0 Housing'), pct: 30, color: '#3b82f6' },
              { name: t('stem.money.food', '\uD83C\uDF5E Food'), pct: 20, color: '#10b981' },
              { name: t('stem.money.transport', '\uD83D\uDE97 Transport'), pct: 15, color: '#f59e0b' },
              { name: t('stem.money.education', '\uD83D\uDCDA Education'), pct: 10, color: '#8b5cf6' },
              { name: t('stem.money.entertainment', '\uD83C\uDFAE Entertainment'), pct: 10, color: '#ec4899' },
              { name: t('stem.money.savings', '\uD83D\uDCB0 Savings'), pct: 10, color: '#06b6d4' },
              { name: t('stem.money.other', '\u2764\uFE0F Other'), pct: 5, color: 'var(--allo-stem-text-soft, #94a3b8)' }
            ];
            ...
            var genUnitPriceProblem = function () {
              var items = [
                { name: t('stem.money.apples_2', '\uD83C\uDF4E Apples'), unit: 'lb' }, { name: t('stem.money.bananas_2', '\uD83C\uDF4C Bananas'), unit: 'lb' },
                { name: t('stem.money.milk', '\uD83E\uDD5B Milk'), unit: 'gallon' }, { name: t('stem.money.juice', '\uD83E\uDDC3 Juice'), unit: 'oz' },
                { name: t('stem.money.bread_2', '\uD83C\uDF5E Bread'), unit: 'loaf' }, { name: t('stem.money.cereal', '\uD83C\uDF6B Cereal'), unit: 'oz' },
                { name: t('stem.money.paper_towels', '\uD83E\uDDFB Paper Towels'), unit: 'roll' }, { name: t('stem.money.coffee', '\u2615 Coffee'), unit: 'oz' }
              ];
            ...
            var STRUCT_PROBLEMS = [
              { template: 'You buy {q1} {item1} at {p1} each and {q2} {item2} at {p2} each. What is the total cost?', fields: ['total'], compute: function (v) { return [{ val: v.q1 * v.p1 + v.q2 * v.p2, label: t('stem.money.total', 'Total') }]; }, gen: function () { var q1 = Math.floor(Math.random() * 5) + 1; var q2 = Math.floor(Math.random() * 4) + 1; var p1 = Math.round((Math.random() * 4 + 0.5) * 100) / 100; var p2 = Math.round((Math.random() * 3 + 0.25) * 100) / 100; return { q1: q1, q2: q2, p1: p1, p2: p2, item1: ['\uD83C\uDF4E apples', '\uD83C\uDF4C bananas', '\uD83E\uDD5A eggs'][Math.floor(Math.random() * 3)], item2: ['\uD83C\uDF5E loaves of bread', '\uD83E\uDD5B cartons of milk', '\uD83C\uDF6B candy bars'][Math.floor(Math.random() * 3)] }; } },
              { template: 'A shirt costs {original}. It\'s on sale for {pct}% off. What do you pay?', fields: ['salePrice'], compute: function (v) { return [{ val: Math.round(v.original * (1 - v.pct / 100) * 100) / 100, label: t('stem.money.sale_price', 'Sale Price') }]; }, gen: function () { return { original: Math.round((Math.random() * 40 + 10) * 100) / 100, pct: [10, 15, 20, 25, 30, 40, 50][Math.floor(Math.random() * 7)] }; } },
              { template: 'You have {have}. You want to buy something that costs {want}. How much more do you need?', fields: ['need'], compute: function (v) { return [{ val: Math.round(Math.max(0, v.want - v.have) * 100) / 100, label: t('stem.money.amount_needed', 'Amount Needed') }]; }, gen: function () { var want = Math.round((Math.random() * 20 + 5) * 100) / 100; return { have: Math.round((Math.random() * want * 0.8) * 100) / 100, want: want }; } },
              { template: 'Dinner costs {bill}. You want to leave a {tipPct}% tip. What is the tip amount? What is the total with tip?', fields: ['tip', 'total'], compute: function (v) { var tip = Math.round(v.bill * v.tipPct / 100 * 100) / 100; return [{ val: tip, label: 'Tip' }, { val: Math.round((v.bill + tip) * 100) / 100, label: t('stem.money.total_2', 'Total') }]; }, gen: function () { return { bill: Math.round((Math.random() * 60 + 10) * 100) / 100, tipPct: [10, 15, 18, 20, 25][Math.floor(Math.random() * 5)] }; } },
              { template: 'You earn {hourly}/hour and work {hours} hours. After {taxPct}% tax, what is your take-home pay?', fields: ['gross', 'takeHome'], compute: function (v) { var gross = Math.round(v.hourly * v.hours * 100) / 100; return [{ val: gross, label: t('stem.money.gross_pay', 'Gross Pay') }, { val: Math.round(gross * (1 - v.taxPct / 100) * 100) / 100, label: 'Take-Home' }]; }, gen: function () { return { hourly: [8, 10, 12, 15, 20][Math.floor(Math.random() * 5)], hours: Math.floor(Math.random() * 30) + 10, taxPct: [10, 15, 20, 22, 25][Math.floor(Math.random() * 5)] }; } },
              { template: '{friends} friends split a {bill} bill equally. How much does each person pay?', fields: ['each'], compute: function (v) { return [{ val: Math.round(v.bill / v.friends * 100) / 100, label: t('stem.money.each_pays', 'Each Pays') }]; }, gen: function () { var friends = Math.floor(Math.random() * 5) + 2; return { friends: friends, bill: Math.round(friends * (Math.random() * 15 + 5) * 100) / 100 }; } }
            ];
            ...
            var FIN_QUIZZES = [
              { q: 'If you invest $1,000 at 7% annual compound interest for 10 years, approximately how much will you have?', choices: ['$1,700', '$1,967', '$2,500', '$3,000'], correct: 1, explanation: t('stem.money.1_000_1_07_1_967_compound_interest_gro', '$1,000 \u00D7 (1.07)\u00B9\u2070 \u2248 $1,967. Compound interest grows exponentially over time.') },
              { q: 'Which costs more total: a $20,000 loan at 5% for 5 years, or at 3% for 10 years?', choices: ['5% for 5 years', '3% for 10 years', 'They cost the same', 'Can\'t determine'], correct: 1, explanation: t('stem.money.at_5_5yr_2_645_interest_at_3_10yr_3_17', 'At 5%/5yr: ~$2,645 interest. At 3%/10yr: ~$3,174 interest. Lower rate but longer term costs more in total interest.') },
              { q: 'Starting to invest $200/month at age 25 vs. age 35 (retire at 65, 7% return). How much more does the early starter have?', choices: ['About $50,000 more', 'About $130,000 more', 'About $260,000 more', 'More than $300,000 more'], correct: 2, explanation: t('stem.money.age_25_262k_age_35_122k_that_s_140k_di', 'Age 25: ~$262K. Age 35: ~$122K. That\'s ~$140K difference! Time is the most powerful factor in investing.') },
              { q: 'You have $500 in credit card debt at 22% APR. Paying $25/month, roughly how long to pay off?', choices: ['About 1 year', 'About 2 years', 'About 5 years', 'Never (minimum too low)'], correct: 1, explanation: t('stem.money.at_25_month_and_22_apr_it_takes_about_', 'At $25/month and 22% APR, it takes about 24 months and you pay ~$95 in interest. High-interest debt is expensive!') },
              { q: 'The "Rule of 72" estimates how long to double your money. At 6% interest, roughly how many years?', choices: ['6 years', '8 years', '10 years', '12 years'], correct: 3, explanation: t('stem.money.72_6_12_years_the_rule_of_72_divide_72', '72 \u00F7 6 = 12 years. The Rule of 72: divide 72 by your interest rate to estimate doubling time.') },
              { q: 'An emergency fund should ideally cover how many months of expenses?', choices: ['1-2 months', '3-6 months', '12 months', '24 months'], correct: 1, explanation: t('stem.money.financial_advisors_recommend_3_6_month', 'Financial advisors recommend 3-6 months of expenses. This covers most unexpected events like job loss or medical emergencies.') }
            ];
            ...
            var loanPresets = {
              auto: { label: t('stem.money.auto_loan', '\uD83D\uDE97 Auto Loan'), amt: 25000, rate: 5, term: 60 },
              student: { label: t('stem.money.student_loan', '\uD83C\uDF93 Student Loan'), amt: 35000, rate: 5.5, term: 120 },
              mortgage: { label: t('stem.money.mortgage', '\uD83C\uDFE0 Mortgage'), amt: 250000, rate: 6.5, term: 360 },
              credit: { label: t('stem.money.credit_card', '\uD83D\uDCB3 Credit Card'), amt: 5000, rate: 22, term: 60 }
            };
            ...
            var sgGoals = {
              car: { label: t('stem.money.car', '\uD83D\uDE97 Car'), target: 15000, emoji: '\uD83D\uDE97' },
              college: { label: t('stem.money.college_fund', '\uD83C\uDF93 College Fund'), target: 50000, emoji: '\uD83C\uDF93' },
              house: { label: t('stem.money.house_down_payment', '\uD83C\uDFE0 House Down Payment'), target: 60000, emoji: '\uD83C\uDFE0' },
              emergency: { label: t('stem.money.emergency_fund', '\uD83D\uDEE1\uFE0F Emergency Fund'), target: 10000, emoji: '\uD83D\uDEE1\uFE0F' },
              vacation: { label: t('stem.money.vacation', '\u2708\uFE0F Vacation'), target: 3000, emoji: '\u2708\uFE0F' },
              custom: { label: t('stem.money.custom_goal', '\u2B50 Custom Goal'), target: 5000, emoji: '\u2B50' }
            };
            ...
            // ── TABS ──
            var tabs = [
              { id: 'coins', label: t('stem.money.coins_bills', '\uD83E\uDE99 Coins & Bills'), icon: '\uD83E\uDE99' },
              { id: 'change', label: t('stem.money.making_change', '\uD83D\uDCB5 Making Change'), icon: '\uD83D\uDCB5' },
              { id: 'tips', label: t('stem.money.tips_discounts', '\uD83D\uDCB3 Tips & Discounts'), icon: '\uD83D\uDCB3' },
              { id: 'store', label: t('stem.money.grocery_store', '\uD83D\uDED2 Grocery Store'), icon: '\uD83D\uDED2' },
              { id: 'budget', label: t('stem.money.budget', '\uD83D\uDCCA Budget'), icon: '\uD83D\uDCCA' },
              { id: 'cents', label: t('stem.money.common_cents', '\uD83E\uDE99 Common Cents'), icon: '\uD83E\uDE99' },
              { id: 'word', label: t('stem.money.word_problems', '\uD83D\uDCDD Word Problems'), icon: '\uD83D\uDCDD' },
              { id: 'exchange', label: t('stem.money.currency_exchange', '\uD83C\uDF0D Currency Exchange'), icon: '\uD83C\uDF0D' },
              { id: 'finance', label: t('stem.money.personal_finance', '\uD83D\uDCB0 Personal Finance'), icon: '\uD83D\uDCB0' },
              { id: 'inquiry', label: t('stem.money.compound_inquiry', '\uD83D\uDD2C Compound Inquiry'), icon: '\uD83D\uDD2C' }
            ];
            ...
            return React.createElement("div", { className: "space-y-4 max-w-4xl mx-auto animate-in fade-in duration-200" },
              ...
              React.createElement("div", { className: "bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 rounded-2xl p-5 text-white shadow-xl" },
                React.createElement("div", { className: "flex items-center justify-between flex-wrap gap-3" },
                  React.createElement("div", null,
                    React.createElement("h2", { className: "text-xl font-black flex items-center gap-2" }, t('stem.money.money_math', "\uD83D\uDCB5 Money Math")),
                    React.createElement("p", { className: "text-emerald-100 text-xs mt-1" }, t('stem.money.master_coins_bills_change_budgeting_cu', "Master coins, bills, change, budgeting & currency exchange"))
                  ),
                  React.createElement("div", { className: "flex gap-2 flex-wrap items-center" },
                    ...
                    React.createElement("select", { value: grade, onChange: function (e) { upd('grade', e.target.value); upd('storeItems', null); upd('cart', []); },
                      'aria-label': t('stem.money.grade_level', 'Grade level'),
                    ...
                    React.createElement("select", { value: currency, onChange: function (e) { upd('currency', e.target.value); upd('placed', []); upd('storeItems', null); upd('cart', []); },
                      'aria-label': t('stem.money.currency', 'Currency'),
                      className: "px-3 py-1.5 rounded-lg text-xs font-bold bg-white/20 text-white border border-white/30 backdrop-blur-sm outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1 cursor-pointer"
              ...
              // ── TAB BAR ──
              React.createElement("div", { className: "flex gap-1 bg-slate-100 rounded-xl p-1", role: 'tablist', 'aria-label': t('stem.money.money_tool_sections', 'Money Tool sections') },
                tabs.map(function (t) {
              ...
              (function() {
                var TAB_META = {
                  coins:    { accent: '#d97706', soft: 'rgba(217,119,6,0.10)', icon: '\uD83E\uDE99', title: t('stem.money.coins_bills_2', 'Coins & bills'),          hint: t('stem.money.build_a_counting_board_coin_face_value', 'Build a counting board. Coin face values are arbitrary \u2014 a quarter is worth 25\u00a2 because we agree it is, not because of the metal.') },
                  change:   { accent: '#16a34a', soft: 'rgba(22,163,74,0.10)', icon: '\uD83D\uDCB5', title: t('stem.money.making_change_2', 'Making change'),          hint: t('stem.money.count_up_from_the_price_to_the_amount_', 'Count UP from the price to the amount paid \u2014 the way cashiers actually do it. Faster + more accurate than subtraction by hand.') },
                  tips:     { accent: '#0ea5e9', soft: 'rgba(14,165,233,0.10)', icon: '\uD83D\uDCB3', title: t('stem.money.tips_discounts_2', 'Tips & discounts'),       hint: t('stem.money.15_tip_10_move_decimal_half_of_that_20', '15% tip = 10% (move decimal) + half of that. 20% off = take the price, divide by 5, subtract. Mental-math shortcuts beat the calculator for sanity-checking.') },
                  store:    { accent: '#a855f7', soft: 'rgba(168,85,247,0.10)', icon: '\uD83D\uDED2', title: t('stem.money.grocery_store_2', 'Grocery store'),          hint: t('stem.money.unit_price_cost_per_ounce_or_item_is_t', 'Unit price (cost per ounce or item) is the only honest comparison \u2014 package sizes are designed to defeat eyeball math.') },
                  budget:   { accent: '#22c55e', soft: 'rgba(34,197,94,0.10)',  icon: '\uD83D\uDCCA', title: t('stem.money.budget_2', 'Budget'),                 hint: t('stem.money.50_30_20_needs_wants_save_debt_most_pe', '50/30/20: needs / wants / save+debt. Most people misclassify recurring subscriptions as needs \u2014 if it auto-renews, it is a want until you opt back in.') },
                  cents:    { accent: '#f59e0b', soft: 'rgba(245,158,11,0.10)', icon: '\uD83E\uDE99', title: t('stem.money.common_cents_2', 'Common cents'),           hint: t('stem.money.quick_mental_shortcuts_25_4_1_10_5_1_1', 'Quick mental shortcuts: 25\u00a2 \u00d7 4 = $1, 10\u00a2 + 5\u00a2 + 1\u00a2 = 16\u00a2. Arithmetic with money is faster than the same arithmetic with abstract numbers because the unit is concrete.') },
                  word:     { accent: '#3b82f6', soft: 'rgba(59,130,246,0.10)', icon: '\uD83D\uDCDD', title: t('stem.money.word_problems_2', 'Word problems'),          hint: t('stem.money.translate_the_sentence_to_an_equation_', 'Translate the sentence to an equation BEFORE computing. "How much" = an unknown variable. "Total" = sum. "Each" or "per" = multiplication.') },
                  exchange: { accent: '#8b5cf6', soft: 'rgba(139,92,246,0.10)', icon: '\uD83C\uDF0D', title: t('stem.money.currency_exchange_2', 'Currency exchange'),      hint: t('stem.money.exchange_rates_change_daily_cards_usua', 'Exchange rates change daily. Cards usually beat cash for travel \u2014 cash exchange shops mark up 5\u201310% over interbank rates.') },
                  finance:  { accent: '#dc2626', soft: 'rgba(220,38,38,0.10)',  icon: '\uD83D\uDCB0', title: t('stem.money.personal_finance_2', 'Personal finance'),       hint: t('stem.money.compound_interest_100_at_7_30_yrs_760_', 'Compound interest: $100 at 7% \u00d7 30 yrs = $760. Pay credit-card statement balance in full each cycle = no interest. Carry a balance = APR roughly doubles your debt every 5 yrs.') },
                  inquiry:  { accent: '#06b6d4', soft: 'rgba(6,182,212,0.10)',  icon: '\uD83D\uDD2C', title: t('stem.money.compound_interest_inquiry', 'Compound Interest Inquiry'), hint: t('stem.money.vary_the_principal_rate_and_time_and_w', 'Vary the principal, rate, and time and watch how compound growth pulls ahead of the contributions alone. An open exploration \u2014 no score, no single right answer.') }
                };
              ...
              tab === 'coins' && React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4" },
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-4 border border-amber-200" },
                  ...
                  React.createElement("p", { className: "text-[11px] text-amber-700 mb-3" }, t('stem.money.click_coins_to_add_them_to_your_counti', "Click coins to add them to your counting board.")),
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-slate-50 to-white rounded-xl p-4 border border-slate-400" },
                  React.createElement("div", { className: "flex items-center justify-between mb-3" },
                    React.createElement("h3", { className: "text-sm font-bold text-slate-700" }, t('stem.money.counting_board', "\uD83E\uDDEE Counting Board")),
                  ...
                  challengeMode && placed.length > 0 && React.createElement("div", { className: "mt-3 pt-3 border-t border-amber-200 bg-amber-50 rounded-lg p-3" },
                    React.createElement("p", { className: "text-xs font-bold text-amber-700 mb-2" }, t('stem.money.what_s_the_total_add_up_all_the_coins_', '\uD83C\uDFAF What\'s the total? Add up all the coins and bills!')),
                    React.createElement("div", { className: "flex items-center gap-2" },
                      ...
                      React.createElement("button", { "aria-label": t('stem.money.check', "Check"), onClick: function () {
                      ...
                      }, disabled: d.coinGuess == null, className: "px-4 py-2 bg-amber-700 text-white font-bold rounded-lg hover:bg-amber-600 transition-all text-xs disabled:opacity-40" }, t('stem.money.check_2', '\u2714 Check'))
                    ),
              ...
              tab === 'change' && React.createElement("div", { className: "bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-200" },
                React.createElement("h3", { className: "text-base font-bold text-blue-800 mb-4" }, t('stem.money.making_change_practice', "\uD83D\uDCB5 Making Change Practice")),
                !changePrice
                  ? React.createElement("div", { className: "text-center py-8" },
                      ...
                      React.createElement("button", { "aria-label": t('stem.money.generate_problem', "Generate Problem"), onClick: genChangeProblem,
                      ...
                      }, t('stem.money.generate_problem_2', "\u2728 Generate Problem"))
                    )
                  : React.createElement("div", { className: "space-y-4" },
                      React.createElement("div", { className: "bg-white rounded-xl p-4 shadow-sm border border-blue-100" },
                        React.createElement("div", { className: "grid grid-cols-3 gap-4 text-center" },
                          React.createElement("div", null,
                            React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.price', "Price")),
                            React.createElement("p", { className: "text-2xl font-black text-red-500" }, fmt(changePrice))
                          ),
                          React.createElement("div", null,
                            React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.customer_pays', "Customer Pays")),
                            React.createElement("p", { className: "text-2xl font-black text-blue-500" }, fmt(changePaid))
                          ),
                          React.createElement("div", null,
                            React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.change_due', "Change Due")),
                      ...
                      React.createElement("div", { className: "flex items-center gap-3" },
                        React.createElement("label", { className: "text-sm font-bold text-slate-600" }, t('stem.money.your_answer', "Your answer:")),
                        ...
                        React.createElement("button", { "aria-label": t('stem.money.check_3', "Check"), onClick: function () {
                      ...
                      changeFeedback && (function() {
                        ...
                        return React.createElement("div", { className: "bg-white border-2 border-blue-200 rounded-xl p-3 mt-1" },
                          React.createElement("p", { className: "text-[11px] font-bold text-blue-700 uppercase tracking-wider mb-2 text-center" }, t('stem.money.subtraction_step', "\uD83D\uDCD0 Subtraction step")),
                      ...
                      React.createElement("button", { "aria-label": t('stem.money.next_problem', "Next Problem"), onClick: genChangeProblem,
                        className: "px-4 py-2 bg-slate-100 text-slate-600 font-bold rounded-xl hover:bg-slate-200 transition-all text-xs"
                      }, t('stem.money.next_problem_2', "\u21BB Next Problem"))
                    )
              ),
              ...
              tab === 'store' && React.createElement("div", { className: "space-y-4" },
                ...
                React.createElement("div", { className: "flex items-center justify-between bg-zinc-900 text-white rounded-xl p-3 shadow-md border border-zinc-700 mx-1 mt-1" },
                  React.createElement("div", { className: "flex items-center gap-2" },
                    ...
                    React.createElement("div", null,
                      React.createElement("h3", { className: "text-sm font-black text-amber-500 leading-tight" }, t('stem.money.power_outage_cashier_rush', "Power Outage Cashier Rush")),
                      React.createElement("p", { className: "text-[11px] text-zinc-400 font-bold" }, t('stem.money.registers_are_down_calculate_by_hand', "Registers are down! Calculate by hand!"))
                    )
                  ),
                ...
                crActive ? React.createElement("div", { className: "bg-zinc-900 rounded-2xl p-4 border border-zinc-700 shadow-2xl relative overflow-hidden" },
                  ...
                  crIntro ? React.createElement("div", { className: "relative z-10 text-center py-6" },
                    ...
                    React.createElement("h2", { className: "text-xl font-black text-amber-400 mb-2 uppercase tracking-wide" }, t('stem.money.code_black_power_outage', "Code Black: Power Outage!")),
                    React.createElement("p", { className: "text-sm text-zinc-300 mb-6 max-w-sm mx-auto" },
                      t('stem.money.the_registers_are_completely_dead_food', "The registers are completely dead. Food is starting to spoil. We need you to manually calculate customer totals as fast as you can. "),
                      React.createElement("span", { className: "text-amber-400 font-bold" }, t('stem.money.speed_and_accuracy', "Speed and accuracy")), t('stem.money.are_everything_right_now', " are everything right now.")
                    ),
                    ...
                    React.createElement("div", { className: "mb-5 inline-block bg-zinc-800/80 rounded-xl px-4 py-3 border border-zinc-700" },
                      React.createElement("p", { className: "text-[11px] font-bold text-zinc-400 mb-2 uppercase tracking-wider" }, t('stem.money.difficulty', "Difficulty")),
                      React.createElement("div", { className: "flex gap-2 justify-center" },
                        [
                          { id: 'easy',      label: t('stem.money.easy', '\uD83D\uDFE2 Easy'),      sub: 'Round prices, no tax' },
                          { id: 'standard',  label: t('stem.money.standard', '\uD83D\uDFE1 Standard'),  sub: 'Real prices, tax W2+' },
                          { id: 'challenge', label: t('stem.money.challenge', '\uD83D\uDD34 Challenge'), sub: 'Coupons + tax' }
                        ].map(function(dm) {
                    ...
                    grade !== 'elementary' && crDifficulty !== 'easy' ? React.createElement("div", { className: "mb-6 inline-block bg-zinc-800 rounded-lg px-4 py-2 border border-zinc-700 text-left" },
                      React.createElement("p", { className: "text-xs text-zinc-400 mb-1" }, t('stem.money.management_notes', "\u26A0\uFE0F Management notes:")),
                      React.createElement("ul", { className: "text-xs text-zinc-300 list-disc list-inside space-y-1" },
                        React.createElement("li", null, t('stem.money.watch_out_for_per_lb_items', "Watch out for per-lb items")),
                        React.createElement("li", null, "Waves 2+: Add " + (taxRate*100) + "% Sales Tax"),
                        (grade === 'high' || crDifficulty === 'challenge') ? React.createElement("li", null, t('stem.money.waves_3_apply_customer_coupons_first_b', "Waves 3+: Apply customer coupons FIRST, before tax")) : null
                      )
                    ) : null,
                    crDifficulty === 'easy' ? React.createElement("div", { className: "mb-6 inline-block bg-emerald-900/30 rounded-lg px-4 py-2 border border-emerald-700/50 text-left" },
                      React.createElement("p", { className: "text-xs text-emerald-300 mb-1" }, t('stem.money.easy_mode', "\uD83D\uDFE2 Easy mode:")),
                      React.createElement("ul", { className: "text-xs text-emerald-200 list-disc list-inside space-y-1" },
                        React.createElement("li", null, t('stem.money.all_prices_in_0_50_increments', "All prices in $0.50 increments")),
                        React.createElement("li", null, t('stem.money.no_tax_no_coupons', "No tax, no coupons")),
                        React.createElement("li", null, t('stem.money.2_3_items_per_customer', "2-3 items per customer")),
                        React.createElement("li", null, t('stem.money.practice_clean_addition_first', "Practice clean addition first"))
                      )
                    ) : null,
                    React.createElement("div", { className: "text-center" },
                      React.createElement("button", { "aria-label": t('stem.money.i_m_ready', "I'm Ready"), onClick: function() { upd('crIntro', false); genCashierRound(); },
                      ...
                      }, t('stem.money.i_m_ready_2', "I'm Ready \u2192"))
                    )
                  ) : null,
                  ...
                  !crIntro && !crGameOver && crCustomer ? React.createElement("div", { className: "relative z-10 space-y-4" },
                    ...
                    React.createElement("div", { className: "flex justify-between items-end" },
                      ...
                      React.createElement("div", { className: "text-right" },
                        React.createElement("p", { className: "text-[11px] text-zinc-400 font-bold uppercase" }, t('stem.money.session_score', "Session Score")),
                    ...
                    React.createElement("div", { className: "bg-zinc-800 rounded-xl p-4 shadow-lg border border-zinc-700 relative overflow-hidden" },
                      ...
                      React.createElement("div", { className: "flex items-center gap-3 mb-4 relative z-0" },
                        ...
                        React.createElement("div", { className: "flex-1" },
                          ...
                          React.createElement("p", { className: "text-zinc-400 text-[11px] font-bold" }, t('stem.money.waiting_for_total', "Waiting for total..."))
                        ),
                      ...
                      crBotCoachOn && crBotMessage && React.createElement("div", {
                        role: 'region', 'aria-label': t('stem.money.allobot_coach', 'AlloBot coach'),
                      ...
                      React.createElement("div", { className: "bg-[#fffbc8] text-zinc-800 p-4 rounded-sm shadow-inner font-mono text-sm relative z-0" },
                        ...
                        React.createElement("div", { className: "text-center pb-2 border-b-2 border-dashed border-zinc-400 mb-2 mt-1 opacity-80" },
                          React.createElement("p", { className: "font-bold text-xs flex justify-center items-center gap-1" }, React.createElement("span", null, "\u26A1"), React.createElement("span", null, t('stem.money.allofood_mkt', "ALLOFOOD MKT")), React.createElement("span", null, "\u26A1")),
                          React.createElement("p", { className: "text-[11px]" }, t('stem.money.system_offline', "SYSTEM OFFLINE"))
                        ),
                        ...
                        grade !== 'elementary' ? React.createElement("div", { className: "mt-2 pt-2 border-t border-dashed border-zinc-400 text-xs flex justify-between text-zinc-600" },
                          React.createElement("span", null, t('stem.money.subtotal', "Subtotal")), React.createElement("span", null, "$" + crCustomer.subtotal.toFixed(2))
                        ) : null,
                    ...
                    crFb ? React.createElement("div", { className: "animate-in slide-in-from-bottom flex flex-col items-center mt-2" },
                      React.createElement("div", { className: "flex gap-2 my-2 text-xs w-full justify-center" },
                        React.createElement("div", { className: "text-center bg-zinc-800 rounded-lg px-2 py-2 border border-zinc-700 shadow-inner w-20" }, React.createElement("p", { className: "text-zinc-500 text-[11px] uppercase font-bold" }, t('stem.money.accuracy', "Accuracy")), React.createElement("p", { className: "text-emerald-400 font-black text-lg leading-tight" }, "+" + crFb.accuracy)),
                        React.createElement("div", { className: "text-center bg-zinc-800 rounded-lg px-2 py-2 border border-zinc-700 shadow-inner w-20" }, React.createElement("p", { className: "text-zinc-500 text-[11px] uppercase font-bold" }, t('stem.money.speed', "Speed")), React.createElement("p", { className: "text-sky-400 font-black text-lg leading-tight" }, "+" + crFb.speed)),
                        React.createElement("div", { className: "text-center bg-zinc-800 rounded-lg px-2 py-2 border border-amber-900/50 shadow-inner w-20" }, React.createElement("p", { className: "text-amber-500/70 text-[11px] uppercase font-bold" }, t('stem.money.total_3', "Total")), React.createElement("p", { className: "text-amber-400 font-black text-lg leading-tight" }, "+" + crFb.score))
                      ),
                      React.createElement("button", { "aria-label": t('stem.money.next_customer', "Next Customer"), onClick: genCashierRound, className: "w-full py-4 bg-amber-500 text-zinc-900 font-black rounded-xl hover:bg-amber-400 hover:scale-105 transition-all text-sm shadow-[0_0_15px_rgba(251,191,36,0.3)] mt-2" }, t('stem.money.next_customer_2', "Next Customer \u2192"))
                    ) :
                    React.createElement("div", { className: "flex gap-2 relative z-20 mt-2" },
                      React.createElement("div", { className: "relative flex-1" },
                        ...
                        React.createElement("input", {
                          ...
                          'aria-label': t('stem.money.cashier_register_answer', 'Cashier register answer'),
                  ...
                  crGameOver ? React.createElement("div", { className: "relative z-10 text-center py-6" },
                    ...
                    React.createElement("h2", { className: "text-2xl font-black text-red-500 mb-2 uppercase tracking-wide drop-shadow-md" }, t('stem.money.shift_over', "Shift Over!")),
                    React.createElement("p", { className: "text-sm text-zinc-300 mb-6 max-w-sm mx-auto" },
                      t('stem.money.you_ran_out_of_time_still_you_served', "You ran out of time! Still, you served "), React.createElement("span", { className: "text-amber-400 font-bold" }, crServed), " customers."
                    ),
                    React.createElement("div", { className: "bg-zinc-800/80 rounded-2xl p-6 border border-zinc-600 mb-8 inline-block shadow-xl shadow-black/50" },
                      React.createElement("p", { className: "text-[11px] text-zinc-400 font-bold uppercase mb-1 tracking-widest gap-2" }, t('stem.money.final_score', "Final Score")),
                      React.createElement("p", { className: "text-5xl font-black text-amber-500 drop-shadow-md" }, crScore),
                      crBest > 0 && crScore >= crBest && crScore > 0 ? React.createElement("p", { className: "text-xs text-emerald-400 font-bold mt-2 animate-pulse" }, t('stem.money.new_high_score', "\uD83C\uDFC6 NEW HIGH SCORE!")) : null
                    ),
                    React.createElement("div", { className: "flex flex-col items-center space-y-3 w-full" }, 
                      React.createElement("button", { onClick: startCashierRush, className: "px-8 py-3 bg-amber-500 text-zinc-900 font-black text-lg rounded-xl hover:bg-amber-400 transition-all shadow-[0_0_15px_rgba(251,191,36,0.5)] w-full max-w-[280px]" }, t('stem.money.play_again', "Play Again \u21BB")),
                      React.createElement("button", { "aria-label": t('stem.money.exit_emergency', "Exit Emergency"), onClick: function() { upd('crActive', false); }, className: "px-8 py-3 bg-transparent text-zinc-400 font-black text-sm rounded-xl hover:text-white hover:bg-zinc-800 transition-all w-full max-w-[280px] border border-zinc-700" }, t('stem.money.exit_emergency_2', "Exit Emergency"))
                    )
                  ) : null
                ...
                grade !== 'elementary' && React.createElement("div", { className: "flex items-center justify-between flex-wrap gap-2" },
                  React.createElement("button", { "aria-label": t('stem.money.select_a_recipe', "Select a Recipe"), onClick: function () { upd('recipeMode', !recipeMode); upd('activeRecipe', null); },
                ...
                recipeMode && React.createElement("div", { className: "bg-gradient-to-br from-purple-50 to-fuchsia-50 rounded-xl p-4 border border-purple-200" },
                  React.createElement("h4", { className: "text-sm font-bold text-purple-800 mb-3" }, t('stem.money.select_a_recipe_2', "\uD83D\uDCCB Select a Recipe")),
                  // Recipe selector
                  ...
                  selectedRecipe && React.createElement("div", { className: "space-y-3" },
                    React.createElement("div", { className: "flex items-center gap-3 bg-white rounded-lg p-3 border border-purple-100" },
                      React.createElement("label", { className: "text-xs font-bold text-purple-700" }, t('stem.money.servings', "\uD83C\uDF7D Servings:")),
                      React.createElement("input", { type: "range", min: 1, max: 12, value: recipeServings, 'aria-label': t('stem.money.number_of_servings', 'Number of servings'), onChange: function (e) { upd('recipeServings', parseInt(e.target.value)); },
                    ...
                    React.createElement("div", { className: "flex gap-2" },
                      React.createElement("button", { "aria-label": t('stem.money.check_recipe_cart', "Check Recipe Cart"), onClick: function () {
                ...
                React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4" },
                  ...
                  React.createElement("div", { className: "md:col-span-2 bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-4 border border-orange-200" },
                    React.createElement("div", { className: "flex items-center justify-between mb-3 flex-wrap gap-2" },
                      ...
                      React.createElement("div", { className: "flex gap-1 items-center bg-white/70 rounded-lg px-2 py-1 border border-orange-200" },
                        ...
                        [
                          { id: 'easy',      label: t('stem.money.round', '\uD83D\uDFE2 Round'),  title: t('stem.money.round_prices_in_0_50_increments', 'Round prices in $0.50 increments') },
                          { id: 'standard',  label: t('stem.money.real', '\uD83D\uDFE1 Real'),   title: t('stem.money.real_world_cents_precision_prices', 'Real-world cents-precision prices') },
                          { id: 'challenge', label: t('stem.money.hard', '\uD83D\uDD34 Hard'),   title: t('stem.money.real_prices_harder_mental_math', 'Real prices + harder mental math') }
                        ].map(function(sd) {
                      ...
                      filteredStoreItems.map(function (item, ii) {
                        ...
                        return React.createElement("div", { key: ii, className: "relative" },
                          ...
                          isAdding && React.createElement("div", { className: "absolute z-20 left-0 right-0 -bottom-2 translate-y-full bg-white rounded-xl p-3 shadow-xl border-2 border-orange-300 space-y-2" },
                            ...
                            React.createElement("button", { "aria-label": t('stem.money.add_to_cart_2', "Add to Cart"), onClick: function () {
                            ...
                            }, className: "w-full px-3 py-1.5 bg-orange-700 text-white text-xs font-bold rounded-lg hover:bg-orange-600 transition-all" }, t('stem.money.add_to_cart_3', "\uD83D\uDED2 Add to Cart"))
                          )
                        );
                      })
                    )
                  ...
                  React.createElement("div", { className: "bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl p-4 border border-emerald-200" },
                    ...
                    challengeMode && cart.length > 0 && React.createElement("div", { className: "mt-3 pt-3 border-t border-amber-200 space-y-2" },
                      ...
                      React.createElement("button", { "aria-label": t('stem.money.check_my_math', "Check My Math"), onClick: function () {
                    ...
                    !challengeMode && cart.length > 0 && React.createElement("div", { className: "mt-3 pt-3 border-t border-emerald-200 space-y-1" },
                      React.createElement("div", { className: "flex justify-between text-xs" },
                        React.createElement("span", { className: "text-slate-600" }, t('stem.money.subtotal_2', "Subtotal")),
                      ...
                      gc.includeTax && React.createElement("div", { className: "flex justify-between text-xs" },
                        React.createElement("span", { className: "text-slate-600" }, t('stem.money.tax_8_2', "Tax (8%)")),
                      ...
                      React.createElement("div", { className: "flex justify-between text-sm font-black" },
                        React.createElement("span", { className: "text-slate-700" }, t('stem.money.total_4', "Total")),
                        React.createElement("span", { className: "text-emerald-600" }, fmt(cartGrand))
                      ),
                      React.createElement("button", { "aria-label": t('stem.money.checkout', "Checkout"), onClick: function () {
              ...
              tab === 'word' && React.createElement("div", { className: "bg-gradient-to-br from-violet-50 to-purple-50 rounded-xl p-5 border border-violet-200" },
                React.createElement("h3", { className: "text-base font-bold text-violet-800 mb-2" }, t('stem.money.money_word_problems', "\uD83D\uDCDD Money Word Problems")),
                ...
                !d.wpProblem && !d.wpLoading
                  ? React.createElement("div", { className: "text-center py-8" },
                      React.createElement("button", { "aria-label": t('stem.money.generate_word_problem', "Generate Word Problem"), onClick: genWordProblem,
                      ...
                      }, t('stem.money.generate_word_problem_2', "\u2728 Generate Word Problem"))
                    )
                  : d.wpLoading
                    ? React.createElement("div", { className: "text-center py-8" },
                        React.createElement("div", { className: "animate-spin text-3xl mb-2" }, "\u2699\uFE0F"),
                        React.createElement("p", { className: "text-xs text-violet-500 font-bold" }, t('stem.money.generating_problem', "Generating problem..."))
                      )
                    : React.createElement("div", { className: "space-y-4" },
                        ...
                        React.createElement("div", { className: "flex items-center gap-3" },
                          React.createElement("input", { type: "number", step: isJPY ? "1" : "0.01", placeholder: t('stem.money.your_answer_2', "Your answer..."),
                            'aria-label': t('stem.money.word_problem_answer', 'Word problem answer'),
                          ...
                          React.createElement("button", { "aria-label": t('stem.money.check_5', "Check"), onClick: function () {
                        ...
                        d.wpFeedback && !d.wpFeedback.ok && d.wpProblem.explanation && React.createElement("div", { className: "bg-slate-50 rounded-xl p-3 border border-slate-400" },
                          React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase mb-1" }, t('stem.money.solution', "Solution")),
                          React.createElement("p", { className: "text-xs text-slate-600 leading-relaxed whitespace-pre-line" }, d.wpProblem.explanation)
                        ),
                        React.createElement("button", { "aria-label": t('stem.money.new_problem', "New Problem"), onClick: genWordProblem,
                          className: "px-4 py-2 bg-slate-100 text-slate-600 font-bold rounded-xl hover:bg-slate-200 transition-all text-xs"
                        }, t('stem.money.new_problem_2', "\u21BB New Problem"))
                      )
                  )
              ),
              ...
              tab === 'exchange' && React.createElement("div", { className: "bg-gradient-to-br from-sky-50 to-cyan-50 rounded-xl p-5 border border-sky-200" },
                React.createElement("h3", { className: "text-base font-bold text-sky-800 mb-2" }, t('stem.money.currency_exchange_3', "\uD83C\uDF0D Currency Exchange")),
                React.createElement("p", { className: "text-xs text-sky-500 mb-4" }, t('stem.money.practice_converting_between_world_curr', "Practice converting between world currencies (approximate rates)")),
                // Exchange rate reference
                React.createElement("div", { className: "bg-white rounded-xl p-3 border border-sky-100 mb-4" },
                  React.createElement("p", { className: "text-[11px] font-bold text-sky-400 uppercase mb-2" }, t('stem.money.reference_rates_vs_1_usd', "Reference Rates (vs 1 USD)")),
                ...
                !d.exchFrom
                  ? React.createElement("div", { className: "text-center py-6" },
                      React.createElement("button", { "aria-label": t('stem.money.generate_conversion_problem', "Generate Conversion Problem"), onClick: genExchangeProblem,
                      ...
                      }, t('stem.money.generate_conversion_problem_2', "\u2728 Generate Conversion Problem"))
                    )
                  : React.createElement("div", { className: "space-y-4" },
                      ...
                      React.createElement("div", { className: "flex items-center gap-3" },
                        React.createElement("input", { type: "number", step: "0.01", placeholder: CURRENCIES[d.exchTo].symbol + "...",
                          'aria-label': t('stem.money.currency_exchange_answer', 'Currency exchange answer'),
                        ...
                        React.createElement("button", { "aria-label": t('stem.money.check_7', "Check"), onClick: function () {
                      ...
                      React.createElement("button", { "aria-label": t('stem.money.next_problem_3', "Next Problem"), onClick: genExchangeProblem,
                        className: "px-4 py-2 bg-slate-100 text-slate-600 font-bold rounded-xl hover:bg-slate-200 transition-all text-xs"
                      }, t('stem.money.next_problem_4', "\u21BB Next Problem"))
                    )
              ),
              ...
              tab === 'tips' && React.createElement("div", { className: "space-y-4" },
                React.createElement("div", { className: "bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl p-5 border border-pink-200" },
                  React.createElement("h3", { className: "text-base font-bold text-pink-800 mb-3" }, t('stem.money.tips_discounts_3', "\uD83D\uDCB3 Tips & Discounts")),
                  React.createElement("div", { className: "flex gap-2 mb-4" },
                    React.createElement("button", { onClick: genTipProblem, className: "flex-1 px-4 py-2 rounded-xl text-xs font-bold transition-all " + ((d.tipMode || 'tip') === 'tip' ? 'bg-pink-600 text-white shadow-md' : 'bg-white text-pink-600 border border-pink-600 hover:bg-pink-50') }, t('stem.money.tip_calculator', "\uD83C\uDF7D Tip Calculator")),
                    React.createElement("button", { "aria-label": t('stem.money.discount_shopping', "Discount Shopping"), onClick: genDiscountProblem, className: "flex-1 px-4 py-2 rounded-xl text-xs font-bold transition-all " + (d.tipMode === 'discount' ? 'bg-pink-600 text-white shadow-md' : 'bg-white text-pink-600 border border-pink-600 hover:bg-pink-50') }, t('stem.money.discount_shopping_2', "\uD83C\uDFF7\uFE0F Discount Shopping"))
                  ),
                  // Tip mode
                  (d.tipMode || 'tip') === 'tip' && (!d.tipBill
                    ? React.createElement("div", { className: "text-center py-6" },
                        React.createElement("p", { className: "text-sm text-slate-600 mb-3" }, t('stem.money.practice_calculating_restaurant_tips_a', "Practice calculating restaurant tips and splitting bills")),
                        React.createElement("button", { "aria-label": t('stem.money.generate_tip_problem', "Generate Tip Problem"), onClick: genTipProblem, className: "px-6 py-3 bg-gradient-to-r from-pink-500 to-rose-500 text-white font-bold rounded-xl hover:from-pink-600 hover:to-rose-600 transition-all shadow-lg text-sm" }, t('stem.money.generate_tip_problem_2', "\u2728 Generate Tip Problem"))
                      )
                    : React.createElement("div", { className: "space-y-4" },
                        React.createElement("div", { className: "bg-white rounded-xl p-4 shadow-sm border border-pink-100" },
                          React.createElement("div", { className: "grid grid-cols-3 gap-3 text-center" },
                            React.createElement("div", null, React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.bill_total', "Bill Total")), React.createElement("p", { className: "text-xl font-black text-pink-600" }, fmt(d.tipBill))),
                            React.createElement("div", null, React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.tip', "Tip %")), React.createElement("p", { className: "text-xl font-black text-amber-500" }, d.tipPct + '%')),
                            React.createElement("div", null, React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.diners', "Diners")), React.createElement("p", { className: "text-xl font-black text-blue-500" }, d.tipDiners))
                          ),
                        ...
                        React.createElement("div", { className: "flex items-center gap-3" },
                          React.createElement("input", { type: "number", step: isJPY ? '1' : '0.01', placeholder: t('stem.money.per_person', 'Per person...'),
                            'aria-label': t('stem.money.tip_per_person_answer', 'Tip per person answer'),
                          ...
                          React.createElement("button", { "aria-label": t('stem.money.check_9', "Check"), onClick: function () {
                        ...
                        React.createElement("button", { "aria-label": t('stem.money.next_problem_5', "Next Problem"), onClick: genTipProblem, className: "px-4 py-2 bg-slate-100 text-slate-600 font-bold rounded-xl hover:bg-slate-200 transition-all text-xs" }, t('stem.money.next_problem_6', "\u21BB Next Problem"))
                      )
                  ),
                  // Discount mode
                  d.tipMode === 'discount' && (!d.discOriginal
                    ? React.createElement("div", { className: "text-center py-6" },
                        ...
                        React.createElement("button", { "aria-label": t('stem.money.generate_discount_problem', "Generate Discount Problem"), onClick: genDiscountProblem, className: "px-6 py-3 bg-gradient-to-r from-pink-500 to-rose-500 text-white font-bold rounded-xl hover:from-pink-600 hover:to-rose-600 transition-all shadow-lg text-sm" }, t('stem.money.generate_discount_problem_2', "\u2728 Generate Discount Problem"))
                      )
                    : React.createElement("div", { className: "space-y-4" },
                        React.createElement("div", { className: "bg-white rounded-xl p-4 shadow-sm border border-pink-100" },
                          React.createElement("div", { className: "text-center" },
                            React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.original_price', "Original Price")),
                        ...
                        React.createElement("div", { className: "flex items-center gap-3" },
                          React.createElement("input", { type: "number", step: isJPY ? '1' : '0.01', placeholder: t('stem.money.sale_price_2', 'Sale price...'),
                            'aria-label': t('stem.money.sale_price_answer', 'Sale price answer'),
                            value: d.discAnswer != null ? d.discAnswer : '', onChange: function (e) { upd('discAnswer', e.target.value === '' ? null : parseFloat(e.target.value)); },
                            className: "px-4 py-2 border border-slate-400 rounded-xl text-sm font-bold w-36 focus:ring-2 focus:ring-pink-400 outline-none"
                          }),
                          React.createElement("button", { "aria-label": t('stem.money.check_11', "Check"), onClick: function () {
                        ...
                        React.createElement("button", { "aria-label": t('stem.money.next_problem_7', "Next Problem"), onClick: genDiscountProblem, className: "px-4 py-2 bg-slate-100 text-slate-600 font-bold rounded-xl hover:bg-slate-200 transition-all text-xs" }, t('stem.money.next_problem_8', "\u21BB Next Problem"))
                      )
                  )
                )
              ),
              ...
              tab === 'budget' && React.createElement("div", { className: "bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-5 border border-indigo-200" },
                React.createElement("h3", { className: "text-base font-bold text-indigo-800 mb-2" }, t('stem.money.budget_planner', "\uD83D\uDCCA Budget Planner")),
                React.createElement("p", { className: "text-xs text-indigo-500 mb-4" }, t('stem.money.allocate_your_monthly_income_across_sp', "Allocate your monthly income across spending categories")),
                // Income input
                React.createElement("div", { className: "flex items-center gap-3 mb-4" },
                  React.createElement("label", { className: "text-sm font-bold text-slate-600" }, t('stem.money.monthly_income', "Monthly Income:")),
                  React.createElement("input", { type: "number", value: budgetIncome,
                    'aria-label': t('stem.money.monthly_income_2', 'Monthly income'),
                ...
                React.createElement("div", { className: "bg-white rounded-xl p-4 border border-indigo-100" },
                  React.createElement("p", { className: "text-xs font-bold text-slate-600 uppercase mb-2" }, t('stem.money.budget_summary', "Budget Summary")),
                  ...
                  budgetUsed === 100 && React.createElement("p", { className: "text-xs font-bold text-emerald-500 text-center mt-3" }, t('stem.money.perfectly_balanced_budget', "\u2705 Perfectly balanced budget!"))
                )
              ),

              // ═══ CHALLENGES TAB ═══
              tab === 'cents' && React.createElement("div", { className: "space-y-4" },
                React.createElement("h3", { className: "text-base font-bold text-amber-800 mb-2" }, t('stem.money.common_cents_3', "\uD83E\uDE99 Common Cents")),
                // Fewest Coins challenge
                React.createElement("div", { className: "bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-4 border border-amber-200" },
                  React.createElement("div", { className: "flex items-center justify-between mb-3" },
                    React.createElement("h4", { className: "text-sm font-bold text-amber-800" }, t('stem.money.fewest_coins_bills_challenge', "\uD83E\uDE99 Fewest Coins & Bills Challenge")),
                    React.createElement("button", { "aria-label": t('stem.money.make_this_amount_with_the_fewest_coins', "Make this amount with the FEWEST coins & bills"), onClick: genFewestCoinsChallenge, className: "px-3 py-1.5 bg-amber-700 text-white text-xs font-bold rounded-lg hover:bg-amber-600 transition-all" }, !d.fcTarget ? '\u2728 Start' : '\u21BB New')
                  ),
                  d.fcTarget && React.createElement("div", { className: "space-y-3" },
                    React.createElement("div", { className: "bg-white rounded-xl p-4 text-center border border-amber-100" },
                      React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.make_this_amount_with_the_fewest_coins_2', "Make this amount with the FEWEST coins & bills")),
                    ...
                    (d.fcPlaced || []).length > 0 && React.createElement("div", { className: "bg-white rounded-lg p-3 border border-slate-400" },
                      ...
                      React.createElement("div", { className: "flex gap-2" },
                        React.createElement("button", { "aria-label": t('stem.money.check_13', "Check"), onClick: function () {
                        ...
                        }, className: "flex-1 px-4 py-2 bg-amber-700 text-white font-bold rounded-xl hover:bg-amber-600 transition-all text-xs" }, t('stem.money.check_14', "\u2714 Check")),
                        React.createElement("button", { "aria-label": t('stem.money.reset_coin_selection', "Reset coin selection"), onClick: function () { upd('fcPlaced', []); }, className: "px-4 py-2 bg-slate-100 text-slate-600 font-bold rounded-xl hover:bg-slate-200 transition-all text-xs" }, t('stem.money.reset', "\u21BA Reset"))
                      ),
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-teal-50 to-emerald-50 rounded-xl p-4 border border-teal-200" },
                  React.createElement("div", { className: "flex items-center justify-between mb-3" },
                    React.createElement("h4", { className: "text-sm font-bold text-teal-800" }, t('stem.money.best_deal_unit_pricing', "\uD83D\uDED2 Best Deal: Unit Pricing")),
                    React.createElement("button", { "aria-label": t('stem.money.gen_unit_price_problem', "Gen Unit Price Problem"), onClick: genUnitPriceProblem, className: "px-3 py-1.5 bg-teal-700 text-white text-xs font-bold rounded-lg hover:bg-teal-600 transition-all" }, !d.upItem ? '\u2728 Start' : '\u21BB New')
                  ),
                  d.upItem && d.upA && d.upB && React.createElement("div", { className: "space-y-3" },
                    ...
                    React.createElement("div", { className: "grid grid-cols-2 gap-3" },
                      React.createElement("button", { "aria-label": t('stem.money.option_a', "Option A"), onClick: function () { upd('upAnswer', 'A'); },
                        ...
                        React.createElement("p", { className: "text-[11px] text-slate-600 mt-1" }, t('stem.money.option_a_2', 'Option A'))
                      ),
                      React.createElement("button", { "aria-label": t('stem.money.option_b', "Option B"), onClick: function () { upd('upAnswer', 'B'); },
                        ...
                        React.createElement("p", { className: "text-[11px] text-slate-600 mt-1" }, t('stem.money.option_b_2', 'Option B'))
                      )
                    ),
                    d.upAnswer && React.createElement("button", { "aria-label": t('stem.money.check_my_answer', "Check My Answer"), onClick: function () {
                    ...
                    }, className: "w-full px-4 py-2 bg-teal-700 text-white font-bold rounded-xl hover:bg-teal-600 transition-all text-sm" }, t('stem.money.check_my_answer_2', "\u2714 Check My Answer")),
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-4 border border-indigo-200" },
                  React.createElement("div", { className: "flex items-center justify-between mb-3" },
                    React.createElement("h4", { className: "text-sm font-bold text-indigo-800" }, t('stem.money.estimate_the_total', "\uD83E\uDDFE Estimate the Total")),
                    React.createElement("button", { "aria-label": t('stem.money.gen_estimate_total', "Gen Estimate Total"), onClick: genEstimateTotal, className: "px-3 py-1.5 bg-indigo-500 text-white text-xs font-bold rounded-lg hover:bg-indigo-600 transition-all" }, !d.estItems ? '\u2728 Start' : '\u21BB New')
                  ),
                  d.estItems && React.createElement("div", { className: "space-y-2" },
                    React.createElement("div", { className: "bg-white rounded-lg border border-indigo-100 p-3 space-y-1" },
                      ...
                      React.createElement("div", { className: "border-t border-dashed border-indigo-200 pt-1 mt-1" },
                        React.createElement("p", { className: "text-xs text-indigo-600 font-bold text-center" }, t('stem.money.what_is_the_total', "What is the total?"))
                      )
                    ),
                    React.createElement("div", { className: "flex items-center gap-2" },
                      ...
                      React.createElement("button", { "aria-label": t('stem.money.gen_change_check', "Gen Change Check"), onClick: function () {
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-rose-50 to-pink-50 rounded-xl p-4 border border-rose-200" },
                  React.createElement("div", { className: "flex items-center justify-between mb-3" },
                    React.createElement("h4", { className: "text-sm font-bold text-rose-800" }, t('stem.money.check_the_change', "\uD83E\uDDD0 Check the Change")),
                    React.createElement("button", { "aria-label": t('stem.money.item_costs', "Item costs:"), onClick: genChangeCheck, className: "px-3 py-1.5 bg-rose-700 text-white text-xs font-bold rounded-lg hover:bg-rose-600 transition-all" }, d.ccPrice == null ? '\u2728 Start' : '\u21BB New')
                  ),
                  d.ccPrice != null && React.createElement("div", { className: "space-y-3" },
                    React.createElement("div", { className: "bg-white rounded-lg border border-rose-100 p-4 text-center space-y-1" },
                      ...
                      React.createElement("p", { className: "text-xs text-slate-600" }, t('stem.money.item_costs_2', "Item costs:")),
                      React.createElement("p", { className: "text-lg font-black text-rose-700" }, fmt(d.ccPrice)),
                      React.createElement("p", { className: "text-xs text-slate-600 mt-1" }, t('stem.money.paid_with', "Paid with:")),
                      React.createElement("p", { className: "text-lg font-black text-slate-700" }, fmt(d.ccPaid)),
                      React.createElement("p", { className: "text-xs text-slate-600 mt-2" }, t('stem.money.cashier_gives_you', "Cashier gives you:")),
                      React.createElement("p", { className: "text-2xl font-black text-amber-600" }, fmt(d.ccProposed)),
                      React.createElement("p", { className: "text-xs font-bold text-rose-600 mt-2" }, t('stem.money.is_this_the_right_change', "Is this the right change? \uD83E\uDD14"))
                    ),
                    React.createElement("div", { className: "grid grid-cols-2 gap-2" },
                      React.createElement("button", { onClick: function () { upd('ccAnswer', true); upd('ccFb', null); }, className: "py-2 rounded-xl font-bold text-sm transition-all " + (d.ccAnswer === true ? 'bg-green-700 text-white shadow-md' : 'bg-white border border-green-600 text-green-600 hover:bg-green-50') }, t('stem.money.correct', "\u2705 Correct!")),
                      React.createElement("button", { onClick: function () { upd('ccAnswer', false); upd('ccFb', null); }, className: "py-2 rounded-xl font-bold text-sm transition-all " + (d.ccAnswer === false ? 'bg-red-700 text-white shadow-md' : 'bg-white border border-red-600 text-red-600 hover:bg-red-50') }, t('stem.money.wrong', "\u274C Wrong!"))
                    ),
                    d.ccAnswer != null && React.createElement("button", { "aria-label": t('stem.money.submit', "Submit"), onClick: function () {
                    ...
                    }, className: "w-full px-4 py-2 bg-rose-700 text-white font-bold rounded-xl hover:bg-rose-600 transition-all text-sm" }, t('stem.money.submit_2', "\u2714 Submit")),
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-fuchsia-50 to-purple-50 rounded-xl p-4 border border-fuchsia-200" },
                  React.createElement("div", { className: "flex items-center justify-between mb-3" },
                    React.createElement("h4", { className: "text-sm font-bold text-fuchsia-800" }, t('stem.money.coupon_stack', "\uD83C\uDFF7 Coupon Stack")),
                    React.createElement("button", { "aria-label": t('stem.money.original_price_2', "Original price:"), onClick: genCouponStack, className: "px-3 py-1.5 bg-fuchsia-700 text-white text-xs font-bold rounded-lg hover:bg-fuchsia-600 transition-all" }, d.csOriginal == null ? '\u2728 Start' : '\u21BB New')
                  ),
                  d.csOriginal != null && React.createElement("div", { className: "space-y-3" },
                    React.createElement("div", { className: "bg-white rounded-lg border border-fuchsia-100 p-4 space-y-2" },
                      React.createElement("p", { className: "text-xs text-slate-600 text-center" }, t('stem.money.original_price_3', "Original price:")),
                      React.createElement("p", { className: "text-2xl font-black text-fuchsia-700 text-center" }, fmt(d.csOriginal)),
                      React.createElement("p", { className: "text-xs text-slate-600 text-center mt-2" }, t('stem.money.apply_these_discounts_in_order', "Apply these discounts in order:")),
                    ...
                    React.createElement("div", { className: "flex items-center gap-2" },
                      React.createElement("label", { className: "text-xs font-bold text-slate-600" }, t('stem.money.final_price', "Final price:")),
                      ...
                      React.createElement("button", { "aria-label": t('stem.money.gen_structured_problem', "Gen Structured Problem"), onClick: function () {
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-cyan-50 to-sky-50 rounded-xl p-4 border border-cyan-200" },
                  React.createElement("div", { className: "flex items-center justify-between mb-3" },
                    React.createElement("h4", { className: "text-sm font-bold text-cyan-800" }, t('stem.money.word_problems_3', "\uD83D\uDCDD Word Problems")),
                    React.createElement("button", { "aria-label": t('stem.money.gen_structured_problem_2', "Gen Structured Problem"), onClick: genStructuredProblem, className: "px-3 py-1.5 bg-cyan-700 text-white text-xs font-bold rounded-lg hover:bg-cyan-600 transition-all" }, !d.spText ? '\u2728 Start' : '\u21BB New')
                  ),
                  d.spText && d.spAnswers && React.createElement("div", { className: "space-y-3" },
                    ...
                    React.createElement("button", { "aria-label": t('stem.money.check_my_answers', "Check My Answers"), onClick: function () {
                    ...
                    }, className: "w-full px-4 py-2 bg-cyan-700 text-white font-bold rounded-xl hover:bg-cyan-600 transition-all text-sm" }, t('stem.money.check_my_answers_2', "\u2714 Check My Answers")),
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-4 border border-amber-200" },
                  React.createElement("div", { className: "flex items-center justify-between mb-3" },
                    React.createElement("h4", { className: "text-sm font-bold text-amber-800" }, t('stem.money.coin_drop', "\uD83E\uDE99 Coin Drop")),
                    React.createElement("div", { className: "flex items-center gap-2" },
                      ...
                      React.createElement("button", { "aria-label": t('stem.money.timer_running', "Timer running..."), onClick: genCoinDrop, className: "px-3 py-1.5 bg-amber-700 text-white text-xs font-bold rounded-lg hover:bg-amber-600 transition-all shadow-sm" }, cdTarget === 0 ? '\u2728 Start' : '\u21BB New')
                    )
                  ),
                  cdTarget > 0 && React.createElement("div", { className: "space-y-3" },
                    ...
                    React.createElement("div", { className: "bg-white rounded-xl p-4 border border-amber-100 text-center" },
                      React.createElement("p", { className: "text-[11px] text-slate-600 font-bold uppercase tracking-wider" }, t('stem.money.target_amount', "\uD83C\uDFAF Target Amount")),
                      React.createElement("p", { className: "text-3xl font-black text-amber-600 mt-1" }, fmt(cdTarget)),
                      challengeMode && cdStartTime && React.createElement("p", { className: "text-[11px] text-slate-600 mt-1" }, t('stem.money.timer_running_2', '\u23F1 Timer running...'))
                    ),
                    ...
                    React.createElement("div", { className: "relative bg-gradient-to-b from-amber-100 to-amber-200 rounded-xl p-3 min-h-[120px] overflow-hidden border border-amber-300" },
                      ...
                      cdDropped.length === 0 && React.createElement("p", { className: "text-center text-xs text-amber-800 font-bold py-6 relative z-10" }, t('stem.money.drop_coins_here', '\uD83D\uDC37 Drop coins here!'))
                    ),
                    // Running total
                    React.createElement("div", { className: "flex items-center justify-between bg-white rounded-lg px-3 py-2 border border-amber-100" },
                      React.createElement("span", { className: "text-xs font-bold text-slate-600" }, t('stem.money.your_total', "Your total:")),
                    ...
                    cdFb && React.createElement("div", { className: "space-y-2" },
                      ...
                      React.createElement("button", { "aria-label": t('stem.money.next_round', "Next Round"), onClick: genCoinDrop, className: "w-full px-4 py-2 bg-amber-700 text-white font-bold rounded-xl hover:bg-amber-600 transition-all text-sm shadow-md" }, t('stem.money.next_round_2', '\u27A1 Next Round'))
                    )
                  )
                ),
                ...
                React.createElement("div", { className: "bg-gradient-to-r from-violet-50 to-purple-50 rounded-xl p-3 border border-violet-200 text-center" },
                  React.createElement("p", { className: "text-[11px] font-bold text-violet-500" }, t('stem.money.complete_challenges_across_all_tabs_to', "\uD83C\uDFC6 Complete challenges across all tabs to earn XP and build real-world money skills!"))
                )
              ),
              ...
              tab === 'finance' && React.createElement("div", { className: "space-y-4" },
                ...
                React.createElement("div", { className: "flex flex-wrap gap-2 mb-2" },
                  [{ id: 'compound', label: t('stem.money.compound_interest', '\uD83D\uDCC8 Compound Interest') }, { id: 'retire', label: t('stem.money.retirement', '\uD83C\uDFD6\uFE0F Retirement') }, { id: 'loans', label: t('stem.money.loans_debt', '\uD83C\uDFE6 Loans & Debt') }, { id: 'goals', label: t('stem.money.savings_goals', '\uD83C\uDFAF Savings Goals') }, { id: 'quiz', label: t('stem.money.fin_quiz', '\uD83E\uDDE0 Fin. Quiz') }].map(function (s) {
                    return React.createElement("button", { "aria-label": t('stem.money.compound_interest_visualizer', "Compound Interest Visualizer"), key: s.id, onClick: function () { upd('finSub', s.id); },
                ...
                finSub === 'compound' && React.createElement("div", { className: "bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-200" },
                  React.createElement("h3", { className: "text-base font-bold text-blue-800 mb-1" }, t('stem.money.compound_interest_visualizer_2', "\uD83D\uDCC8 Compound Interest Visualizer")),
                  React.createElement("p", { className: "text-xs text-blue-500 mb-4" }, t('stem.money.see_how_your_money_grows_simple_vs_com', "See how your money grows \u2014 simple vs compound interest")),
                  // Controls
                  React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4" },
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.principal', "Principal")),
                      React.createElement("input", { type: "number", value: ciPrincipal, 'aria-label': t('stem.money.principal_amount', 'Principal amount'), onChange: function (e) { upd('ciPrincipal', Math.max(0, parseFloat(e.target.value) || 0)); },
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.annual_rate', "Annual Rate %")),
                      React.createElement("input", { type: "number", step: "0.5", value: ciRate, 'aria-label': t('stem.money.annual_interest_rate', 'Annual interest rate'), onChange: function (e) { upd('ciRate', Math.max(0, parseFloat(e.target.value) || 0)); },
                        className: "w-full px-3 py-2 border border-slate-400 rounded-lg text-sm font-bold focus:ring-2 focus:ring-blue-400 outline-none mt-1" })
                    ),
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.years', "Years")),
                      React.createElement("input", { type: "number", value: ciYears, 'aria-label': t('stem.money.number_of_years', 'Number of years'), onChange: function (e) { upd('ciYears', Math.min(50, Math.max(1, parseInt(e.target.value) || 1))); },
                        className: "w-full px-3 py-2 border border-slate-400 rounded-lg text-sm font-bold focus:ring-2 focus:ring-blue-400 outline-none mt-1" })
                    ),
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.compounding', "Compounding")),
                      React.createElement("select", { value: ciFreq, 'aria-label': t('stem.money.compounding_frequency', 'Compounding frequency'), onChange: function (e) { upd('ciFreq', e.target.value); },
                        className: "w-full px-3 py-2 border border-slate-400 rounded-lg text-sm font-bold focus:ring-2 focus:ring-blue-400 outline-none mt-1" },
                        React.createElement("option", { value: "yearly" }, t('stem.money.yearly', "Yearly")),
                        React.createElement("option", { value: "quarterly" }, t('stem.money.quarterly', "Quarterly")),
                        React.createElement("option", { value: "monthly" }, t('stem.money.monthly', "Monthly")),
                        React.createElement("option", { value: "daily" }, t('stem.money.daily', "Daily"))
                      )
                    )
                  ),
                  // Results summary
                  React.createElement("div", { className: "grid grid-cols-2 gap-3 mb-4" },
                    React.createElement("div", { className: "bg-white rounded-xl p-4 border border-blue-100 text-center" },
                      React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.compound_interest_2', "Compound Interest")),
                    ...
                    React.createElement("div", { className: "bg-white rounded-xl p-4 border border-slate-100 text-center" },
                      React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.simple_interest', "Simple Interest")),
                  ...
                  React.createElement("div", { className: "bg-white rounded-xl border border-slate-400 overflow-hidden" },
                    React.createElement("table", { className: "w-full text-xs" },
                      React.createElement("caption", { className: "sr-only" }, t('stem.money.money_data_table', "money data table")), React.createElement("thead", null,
                        React.createElement("tr", { className: "bg-slate-50" },
                          React.createElement("th", { scope: "col", className: "px-3 py-2 text-left font-bold text-slate-600" }, t('stem.money.year', "Year")),
                          React.createElement("th", { scope: "col", className: "px-3 py-2 text-right font-bold text-blue-600" }, t('stem.money.compound', "Compound")),
                          React.createElement("th", { scope: "col", className: "px-3 py-2 text-right font-bold text-slate-600" }, t('stem.money.simple', "Simple")),
                          React.createElement("th", { scope: "col", className: "px-3 py-2 text-right font-bold text-emerald-500" }, t('stem.money.advantage', "Advantage"))
                        )
                      ),
                ...
                finSub === 'retire' && React.createElement("div", { className: "bg-gradient-to-br from-violet-50 to-purple-50 rounded-xl p-5 border border-violet-200" },
                  React.createElement("h3", { className: "text-base font-bold text-violet-800 mb-1" }, t('stem.money.retirement_savings_planner', "\uD83C\uDFD6\uFE0F Retirement Savings Planner")),
                  React.createElement("p", { className: "text-xs text-violet-500 mb-4" }, t('stem.money.see_why_starting_early_makes_a_massive', "See why starting early makes a massive difference")),
                  // Controls
                  React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-3 mb-4" },
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.start_age', "Start Age")),
                      React.createElement("input", { type: "range", min: 18, max: 55, value: retAge, 'aria-label': t('stem.money.retirement_start_age', 'Retirement start age'), onChange: function (e) { upd('retAge', parseInt(e.target.value)); },
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.monthly_contribution', "Monthly Contribution")),
                      React.createElement("input", { type: "number", value: retMonthly, 'aria-label': t('stem.money.monthly_contribution_2', 'Monthly contribution'), onChange: function (e) { upd('retMonthly', Math.max(0, parseFloat(e.target.value) || 0)); },
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.employer_match', "Employer Match %")),
                      React.createElement("input", { type: "number", value: retMatch, 'aria-label': t('stem.money.employer_match_percentage', 'Employer match percentage'), onChange: function (e) { upd('retMatch', Math.max(0, parseFloat(e.target.value) || 0)); },
                        className: "w-full px-3 py-2 border border-slate-400 rounded-lg text-sm font-bold focus:ring-2 focus:ring-violet-400 outline-none mt-1" })
                    )
                  ),
                  ...
                  React.createElement("div", { className: "bg-white rounded-xl border border-slate-400 overflow-hidden mt-4" },
                    React.createElement("table", { className: "w-full text-xs" },
                      React.createElement("caption", { className: "sr-only" }, t('stem.money.money_data_table_2', "money data table")), React.createElement("thead", null,
                        React.createElement("tr", { className: "bg-slate-50" },
                          React.createElement("th", { scope: "col", className: "px-3 py-2 text-left font-bold text-slate-600" }, "Age"),
                          React.createElement("th", { scope: "col", className: "px-3 py-2 text-right font-bold text-violet-600" }, t('stem.money.early_start', "Early Start")),
                          React.createElement("th", { scope: "col", className: "px-3 py-2 text-right font-bold text-slate-600" }, t('stem.money.late_start', "Late Start"))
                        )
                      ),
                      React.createElement("tbody", null,
                ...
                finSub === 'loans' && React.createElement("div", { className: "bg-gradient-to-br from-rose-50 to-red-50 rounded-xl p-5 border border-rose-200" },
                  React.createElement("h3", { className: "text-base font-bold text-rose-800 mb-1" }, t('stem.money.loan_debt_calculator', "\uD83C\uDFE6 Loan & Debt Calculator")),
                  React.createElement("p", { className: "text-xs text-rose-500 mb-4" }, t('stem.money.understand_what_loans_really_cost_the_', "Understand what loans really cost \u2014 the total interest is eye-opening")),
                  // Loan type presets
                  React.createElement("div", { className: "flex flex-wrap gap-2 mb-4" },
                    Object.keys(loanPresets).map(function (k) {
                      return React.createElement("button", { "aria-label": t('stem.money.loan_amount', "Loan Amount"), key: k, onClick: function () {
                  ...
                  React.createElement("div", { className: "grid grid-cols-3 gap-3 mb-4" },
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.loan_amount_2', "Loan Amount")),
                      React.createElement("input", { type: "number", value: loanAmt, 'aria-label': t('stem.money.loan_amount_3', 'Loan amount'), onChange: function (e) { upd('loanAmt', Math.max(0, parseFloat(e.target.value) || 0)); },
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.interest_rate', "Interest Rate %")),
                      React.createElement("input", { type: "number", step: "0.25", value: loanRate, 'aria-label': t('stem.money.loan_interest_rate', 'Loan interest rate'), onChange: function (e) { upd('loanRate', Math.max(0, parseFloat(e.target.value) || 0)); },
                        className: "w-full px-3 py-2 border border-slate-400 rounded-lg text-sm font-bold focus:ring-2 focus:ring-rose-400 outline-none mt-1" })
                    ),
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.term_months', "Term (months)")),
                      React.createElement("input", { type: "number", value: loanTerm, 'aria-label': t('stem.money.loan_term_in_months', 'Loan term in months'), onChange: function (e) { upd('loanTerm', Math.max(1, parseInt(e.target.value) || 1)); },
                        className: "w-full px-3 py-2 border border-slate-400 rounded-lg text-sm font-bold focus:ring-2 focus:ring-rose-400 outline-none mt-1" })
                    )
                  ),
                  // Results
                  React.createElement("div", { className: "grid grid-cols-3 gap-3 mb-4" },
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-rose-100" },
                      React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.monthly_payment', "Monthly Payment")),
                    ...
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-red-200" },
                      React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.total_interest', "Total Interest")),
                    ...
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-slate-100" },
                      React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.total_paid', "Total Paid")),
                  ...
                  React.createElement("div", { className: "mb-4" },
                    React.createElement("p", { className: "text-[11px] font-bold text-slate-600 mb-1" }, t('stem.money.what_you_re_really_paying', "What you're really paying:")),
                    React.createElement("div", { className: "h-6 rounded-full overflow-hidden flex" },
                      React.createElement("div", { style: { width: Math.round(loanAmt / loanTotalPaid * 100) + '%', background: 'linear-gradient(90deg, #3b82f6, #6366f1)' }, className: "h-full flex items-center justify-center text-[11px] text-white font-bold" }, t('stem.money.principal_2', "Principal")),
                      React.createElement("div", { style: { width: Math.round(loanTotalInterest / loanTotalPaid * 100) + '%', background: 'linear-gradient(90deg, #ef4444, #dc2626)' }, className: "h-full flex items-center justify-center text-[11px] text-white font-bold" }, t('stem.money.interest', "Interest"))
                    )
                  ),
                  // Amortization highlights
                  React.createElement("div", { className: "bg-white rounded-xl border border-slate-400 overflow-hidden" },
                    React.createElement("table", { className: "w-full text-xs" },
                      React.createElement("caption", { className: "sr-only" }, t('stem.money.money_data_table_3', "money data table")), React.createElement("thead", null,
                        React.createElement("tr", { className: "bg-slate-50" },
                          React.createElement("th", { scope: "col", className: "px-2 py-2 text-left font-bold text-slate-600" }, t('stem.money.month', "Month")),
                          React.createElement("th", { scope: "col", className: "px-2 py-2 text-right font-bold text-slate-600" }, t('stem.money.payment', "Payment")),
                          React.createElement("th", { scope: "col", className: "px-2 py-2 text-right font-bold text-blue-500" }, t('stem.money.principal_3', "Principal")),
                          React.createElement("th", { scope: "col", className: "px-2 py-2 text-right font-bold text-red-500" }, t('stem.money.interest_2', "Interest")),
                          React.createElement("th", { scope: "col", className: "px-2 py-2 text-right font-bold text-slate-600" }, t('stem.money.balance', "Balance"))
                        )
                      ),
                      React.createElement("tbody", null,
                ...
                finSub === 'goals' && React.createElement("div", { className: "bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl p-5 border border-emerald-200" },
                  React.createElement("h3", { className: "text-base font-bold text-emerald-800 mb-1" }, t('stem.money.savings_goal_planner', "\uD83C\uDFAF Savings Goal Planner")),
                  React.createElement("p", { className: "text-xs text-emerald-500 mb-4" }, t('stem.money.pick_a_goal_and_see_exactly_how_much_t', "Pick a goal and see exactly how much to save each day, week, or month")),
                  // Goal picker
                  React.createElement("div", { className: "flex flex-wrap gap-2 mb-4" },
                    Object.keys(sgGoals).map(function (k) {
                      return React.createElement("button", { "aria-label": t('stem.money.target_amount_2', "Target Amount"), key: k, onClick: function () {
                  ...
                  React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4" },
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.target_amount_3', "Target Amount")),
                      React.createElement("input", { type: "number", value: sgTarget, 'aria-label': t('stem.money.savings_target_amount', 'Savings target amount'), onChange: function (e) { upd('sgTarget', Math.max(0, parseFloat(e.target.value) || 0)); },
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.already_saved', "Already Saved")),
                      React.createElement("input", { type: "number", value: sgHave, 'aria-label': t('stem.money.amount_already_saved', 'Amount already saved'), onChange: function (e) { upd('sgHave', Math.max(0, parseFloat(e.target.value) || 0)); },
                        className: "w-full px-3 py-2 border border-slate-400 rounded-lg text-sm font-bold focus:ring-2 focus:ring-emerald-400 outline-none mt-1" })
                    ),
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.timeline_months', "Timeline (months)")),
                      React.createElement("input", { type: "number", value: sgMonths, 'aria-label': t('stem.money.savings_timeline_in_months', 'Savings timeline in months'), onChange: function (e) { upd('sgMonths', Math.max(1, parseInt(e.target.value) || 1)); },
                        className: "w-full px-3 py-2 border border-slate-400 rounded-lg text-sm font-bold focus:ring-2 focus:ring-emerald-400 outline-none mt-1" })
                    ),
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.savings_rate', "Savings Rate %")),
                      React.createElement("input", { type: "number", step: "0.5", value: sgRate, 'aria-label': t('stem.money.savings_interest_rate', 'Savings interest rate'), onChange: function (e) { upd('sgRate', Math.max(0, parseFloat(e.target.value) || 0)); },
                        className: "w-full px-3 py-2 border border-slate-400 rounded-lg text-sm font-bold focus:ring-2 focus:ring-emerald-400 outline-none mt-1" })
                    )
                  ),
                  // Progress bar
                  ...
                  React.createElement("div", { className: "grid grid-cols-3 gap-3 mb-4" },
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-emerald-100" },
                      React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.per_day', "Per Day")),
                      ...
                      React.createElement("p", { className: "text-[11px] text-slate-600" }, t('stem.money.skip_a_coffee', "\u2248 skip a coffee"))
                    ),
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border-2 border-emerald-300" },
                      React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.per_week', "Per Week")),
                      React.createElement("p", { className: "text-lg font-black text-emerald-600" }, cur.symbol + Math.round(sgWeeklyNeeded).toLocaleString())
                    ),
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-emerald-100" },
                      React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase" }, t('stem.money.per_month', "Per Month")),
                  ...
                  React.createElement("div", { className: "bg-white rounded-xl p-4 border border-emerald-100" },
                    React.createElement("p", { className: "text-[11px] font-bold text-slate-600 uppercase mb-2" }, t('stem.money.what_if_scenarios', "\uD83D\uDCA1 What If Scenarios")),
                    React.createElement("div", { className: "space-y-2" },
                      ...
                      React.createElement("p", { className: "text-xs text-slate-600" }, t('stem.money.double_your_savings_reach_goal_in', "\u2022 Double your savings? Reach goal in "), React.createElement("strong", { className: "text-emerald-600" }, Math.max(1, Math.round(sgMonths / 2)) + " months"))
                    )
                  )
                ),
                ...
                finSub === 'quiz' && React.createElement("div", { className: "bg-gradient-to-br from-yellow-50 to-amber-50 rounded-xl p-5 border border-yellow-200 space-y-4" },
                  React.createElement("div", { className: "flex items-center justify-between" },
                    React.createElement("h3", { className: "text-base font-bold text-amber-800" }, t('stem.money.financial_literacy_quiz', "\uD83E\uDDE0 Financial Literacy Quiz")),
                    React.createElement("button", { "aria-label": t('stem.money.gen_fin_quiz', "Gen Fin Quiz"), onClick: genFinQuiz, className: "px-3 py-1.5 bg-amber-700 text-white text-xs font-bold rounded-lg hover:bg-amber-600 transition-all" }, d.fqIdx == null ? '\u2728 Start Quiz' : '\u21BB Next Question')
                  ),
                  d.fqIdx != null && (function () {
                    ...
                    return React.createElement("div", { className: "space-y-3" },
                      ...
                      d.fqAnswer != null && !d.fqFb && React.createElement("button", { "aria-label": t('stem.money.submit_answer', "Submit Answer"), onClick: function () {
                      ...
                      }, className: "w-full px-4 py-2 bg-amber-700 text-white font-bold rounded-xl hover:bg-amber-600 transition-all text-sm" }, t('stem.money.submit_answer_2', "\u2714 Submit Answer")),
                      ...
                      d.fqFb && React.createElement("button", { "aria-label": t('stem.money.next_question', "Next Question"), onClick: genFinQuiz, className: "w-full px-4 py-2 bg-amber-700 text-white font-bold rounded-xl hover:bg-amber-600 transition-all text-sm" }, t('stem.money.next_question_2', "\u27A1\uFE0F Next Question"))
                    );
                  })()
                )
              ),
              ...
              tab === 'inquiry' && (function() {
                ...
                var sm = ({
                  flat: { label: t('stem.money.flat', 'Flat'), color: '#94a3b8', bg: '#1e293b', border: '#475569', desc: t('stem.money.almost_no_growth_either_zero_rate_or_v', 'Almost no growth. Either zero rate or very short horizon.') },
                  modest: { label: t('stem.money.modest', 'Modest'), color: '#22d3ee', bg: '#0a1f2e', border: '#0891b2', desc: t('stem.money.money_grows_by_50_comparable_to_a_bond', 'Money grows by ~50%. Comparable to a bond fund or savings ladder.') },
                  compounding: { label: t('stem.money.compounding_2', 'Compounding'), color: '#4ade80', bg: '#0a2e1a', border: '#16a34a', desc: t('stem.money.money_doubles_or_triples_the_textbook_', 'Money doubles or triples. The textbook "magic of compound interest" zone.') },
                  exponential: { label: t('stem.money.exponential', 'Exponential'), color: '#facc15', bg: '#2a2410', border: '#eab308', desc: t('stem.money.money_grows_3_8x_long_horizon_good_rat', 'Money grows 3-8x. Long horizon + good rate. This is what 401(k) advice optimizes for.') },
                  astronomic: { label: t('stem.money.astronomic', 'Astronomic'), color: '#fb923c', bg: '#2a1a0a', border: '#ea580c', desc: t('stem.money.money_grows_8x_long_horizons_40_years_', 'Money grows 8x+. Long horizons (40+ years) at 8-10% start producing fortune-class outcomes.') }
                })[state];
                // SVG: growth curve
                var pts = [];
                ...
                return React.createElement("div", { className: "p-3 rounded-xl", style: { background: sm.bg, border: '1px solid ' + sm.border, color: '#e8f0f5' } },
                  React.createElement("h4", { className: "text-xs font-black uppercase tracking-wider mb-1", style: { color: sm.color } }, t('stem.money.compound_interest_inquiry_2', '🔬 Compound Interest Inquiry')),
                  React.createElement("p", { className: "text-[10px] opacity-85 mb-2 leading-snug" }, t('stem.money.set_starting_balance_rate_time_horizon', 'Set starting balance, rate, time horizon, and monthly contribution. Predict the growth ratio before reading it. No score, no reveal.')),
                  ...
                  React.createElement("div", { className: "grid grid-cols-3 gap-2 mb-2" },
                    [
                      { label: t('stem.money.future_value', 'Future value'), val: '$' + fv.toFixed(0) },
                      { label: t('stem.money.total_contributed', 'Total contributed'), val: '$' + totalContrib.toFixed(0) },
                      { label: t('stem.money.interest_earned', 'Interest earned'), val: '$' + interest.toFixed(0) }
                    ].map(function(m) {
                  ...
                  React.createElement("div", { className: "grid grid-cols-2 gap-2 mb-2" },
                    React.createElement("label", { className: "text-[10px]" },
                      React.createElement("div", { className: "flex justify-between mb-0.5" }, React.createElement("span", null, t('stem.money.starting_balance', 'Starting balance ($)')), React.createElement("span", { className: "font-mono font-bold", style: { color: sm.color } }, iq.principal)),
                    ...
                    React.createElement("label", { className: "text-[10px]" },
                      React.createElement("div", { className: "flex justify-between mb-0.5" }, React.createElement("span", null, t('stem.money.annual_rate_2', 'Annual rate (%)')), React.createElement("span", { className: "font-mono font-bold", style: { color: sm.color } }, iq.ratePct.toFixed(1))),
                    ...
                    React.createElement("label", { className: "text-[10px]" },
                      React.createElement("div", { className: "flex justify-between mb-0.5" }, React.createElement("span", null, t('stem.money.years_2', 'Years')), React.createElement("span", { className: "font-mono font-bold", style: { color: sm.color } }, iq.years)),
                    ...
                    React.createElement("label", { className: "text-[10px]" },
                      React.createElement("div", { className: "flex justify-between mb-0.5" }, React.createElement("span", null, t('stem.money.monthly_add', 'Monthly add ($)')), React.createElement("span", { className: "font-mono font-bold", style: { color: sm.color } }, iq.contribMonthly)),
                  ...
                  React.createElement("div", { className: "flex gap-2 mb-2" },
                    ...
                    }, className: "flex-1 px-2 py-1 rounded text-[10px] font-bold", style: { background: sm.bg, color: sm.color, border: '1px solid ' + sm.border, cursor: 'pointer' } }, t('stem.money.log_this_scenario', '📋 Log this scenario')),
                    React.createElement("button", { onClick: function() { setIQ({ principal: 1000, ratePct: 7, years: 30, contribMonthly: 100 }); }, className: "px-2 py-1 rounded text-[10px]", style: { background: '#0a0a1a', color: '#94a3b8', border: '1px solid #1e293b', cursor: 'pointer' } }, t('stem.money.reset_2', 'Reset'))
                  ),
                  ...
                  React.createElement("label", { className: "block text-[10px] font-bold opacity-85 mb-1" }, t('stem.money.your_hypothesis_which_lever_rate_time_', 'Your hypothesis (which lever — rate, time, or contribution — has the most asymmetric power?)')),
                  React.createElement("textarea", { value: iq.hypothesis, onChange: function(e) { setIQ({ hypothesis: e.target.value }); }, rows: 2, placeholder: t('stem.money.e_g_starting_10_years_earlier_with_0_s', 'e.g., starting 10 years earlier with $0 still beats waiting 10 years and starting with $20k...'), className: "w-full p-1.5 rounded text-[10px] mb-2", style: { background: '#0a0a1a', border: '1px solid ' + sm.border, color: '#e8f0f5', resize: 'vertical' } }),
                  !iq.stuckRevealed && React.createElement("button", { onClick: function() { setIQ({ stuckRevealed: true }); }, className: "px-2 py-1 rounded text-[10px] font-bold mb-2", style: { background: '#0a0a1a', color: sm.color, border: '1px solid #1e293b', cursor: 'pointer' } }, t('stem.money.i_m_stuck_show_open_questions', "🤔 I'm stuck - show open questions")),
                  iq.stuckRevealed && React.createElement("div", { className: "p-2 rounded text-[10px] mb-2", style: { background: '#0a0a1a', border: '1px dashed ' + sm.border, lineHeight: 1.5 } },
                    React.createElement("div", { className: "font-bold mb-1", style: { color: sm.color } }, t('stem.money.open_questions_no_answer_key', 'Open questions (no answer key)')),
                    React.createElement("ul", { className: "pl-4 m-0" },
                      React.createElement("li", null, t('stem.money.rule_of_72_years_to_double_72_rate_che', 'Rule of 72: years to double = 72/rate. Check it at r=6% (should be 12 yrs).')),
                      React.createElement("li", null, t('stem.money.starting_at_25_with_200_mo_vs_45_with_', 'Starting at 25 with $200/mo vs 45 with $400/mo at age 65 — which gives more? Why?')),
                      React.createElement("li", null, t('stem.money.when_does_inflation_eat_your_gains_rea', 'When does inflation eat your gains? (Real rate = nominal rate - inflation.)')),
                      React.createElement("li", null, t('stem.money.why_is_the_gap_between_dashed_and_soli', 'Why is the gap between dashed and solid line so much bigger in the last 10 years than the first 10?'))
                    )
                  ),
                  React.createElement("label", { className: "flex items-center gap-2 text-[10px] font-bold cursor-pointer mb-1" },
                    ...
                    React.createElement("span", null, t('stem.money.i_can_explain_why_this_principal_rate_', 'I can explain why this principal/rate/time/contribution combination produces this growth state.'))
                  ),
                  iq.understood && React.createElement("textarea", { value: iq.explanation, onChange: function(e) { setIQ({ explanation: e.target.value }); }, rows: 2, placeholder: t('stem.money.explain_in_your_own_words', 'Explain in your own words...'), className: "w-full p-1.5 rounded text-[10px] mb-1", style: { background: '#0a0a1a', border: '1px solid ' + sm.border, color: '#e8f0f5', resize: 'vertical' } }),
                  React.createElement("p", { className: "m-0 text-[9px] italic opacity-60" }, t('stem.money.inquiry_widget_no_score_no_reveal_no_a', 'Inquiry widget - no score, no reveal, no answer dump. Compound interest assumes constant rate, no taxes, no inflation. Real-world returns are volatile (sequence-of-returns risk) and net of taxes + inflation.'))
                );
              })(),
              ...
              React.createElement("div", { className: "bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-3 border border-emerald-200 text-center" },
                React.createElement("p", { className: "text-[11px] text-emerald-600" }, "\uD83C\uDF1F ", React.createElement("strong", null, t('stem.money.financial_literacy', "Financial literacy")), t('stem.money.is_one_of_the_most_important_life_skil', " is one of the most important life skills. Practice with real-world scenarios to build confidence with money!")),
                React.createElement("p", { className: "text-[11px] text-slate-600 mt-1" }, t('stem.money.exchange_rates_are_approximate_and_for', "Exchange rates are approximate and for educational purposes only."))
              ),

              // ═══ DOLLAR ANATOMY ═══
              React.createElement('div', { className: 'mt-5 rounded-2xl border border-emerald-300 bg-white p-3 shadow-sm' },
                React.createElement('h4', { className: 'text-sm font-bold text-emerald-700 mb-2' }, t('stem.money.dollar_bill_anti_counterfeit_features', '💵 Dollar Bill — Anti-counterfeit features')),
                React.createElement('div', { className: 'rounded-xl overflow-hidden border border-emerald-200', style: { background: '#022c22', aspectRatio: '16/5' } },
                  React.createElement('canvas', {
                    'role': 'img',
                    'aria-label': t('stem.money.detailed_view_of_a_us_dollar_bill', 'Detailed view of a US dollar bill.'),
                    ref: function(cvEl) {
                      if (!cvEl) return;
                      ...
                      function drawDb() {
                        ...
                        var features = [
                          { color: '#fb7185', label: t('stem.money.microprinting', 'Microprinting') },
                          { color: '#fbbf24', label: t('stem.money.portrait_watermark', 'Portrait watermark') },
                          { color: '#67e8f9', label: t('stem.money.color_shifting_ink', 'Color-shifting ink') },
                          { color: '#a855f7', label: t('stem.money.security_thread_uv', 'Security thread (UV)') }
                        ];
