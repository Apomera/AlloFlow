...
const out = path.join(root, 'reports/directions-resource-review-2026-09-07');
...
const generate = new Function('exportConfig', 'isRtlLang', 'leveledTextLanguage', 'getDefaultTitle', 't', doc.slice(generatorStart, generatorEnd) + ';return generateResourceHTML;')({}, () => false, 'English', value => value, () => '');
results.export = {
...
results.parserComparison = { preview: preview(sample), loadedDocumentParser: full(sample) };
