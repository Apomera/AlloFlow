...
var RosterKeyPanel = React.memo(({ isOpen, onClose, rosterKey, setRosterKey, onApplyGroup, onSyncToSession, onBatchGenerate, activeSessionCode, t, isParentMode, isIndependentMode }) => {
  ...
  const ProfileField = ({ label, value, field, gId, type = "text", options }) => /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-500 w-24 shrink-0" }, label, ":"), type === "select" ? /* @__PURE__ */ React.createElement(
    "select",
    {
      value: value || "",
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: panelRef, role: "dialog", "aria-modal": "true", className: "fixed inset-0 z-[260] bg-slate-900/80 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] flex flex-col border-2 border-indigo-100 animate-in zoom-in-95 duration-200" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between p-5 border-b border-slate-100" }, /* @__PURE__ */ React.createElement("div", { "data-help-key": "roster_panel_header" }, /* @__PURE__ */ React.createElement("h2", { className: "text-lg font-black text-slate-800 flex items-center gap-2" }, /* @__PURE__ */ React.createElement(ClipboardList, { size: 20, className: "text-indigo-500" }), " ", isParentMode ? "Family Learning Profiles" : isIndependentMode ? "My Learning Profile" : t("roster.title") || "Class Roster & Progress Tracking"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 mt-0.5" }, isParentMode ? "Manage family member profiles and track learning progress" : isIndependentMode ? "Manage your learning profile and track your progress" : t("roster.subtitle") || "Organize student groups with differentiated profiles for instruction")), /* @__PURE__ */ React.createElement("button", { onClick: onClose, className: "p-2 rounded-full hover:bg-slate-100 transition-colors", "aria-label": t("common.close") }, /* @__PURE__ */ React.createElement(X, { size: 20, className: "text-slate-500" }))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 px-5 py-3 border-b border-slate-50 bg-slate-50/50" }, /* @__PURE__ */ React.createElement("button", { onClick: () => fileInputRef.current?.click(), className: "px-3 py-1.5 bg-indigo-50 text-indigo-700 rounded-lg text-xs font-bold hover:bg-indigo-100 transition-colors flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Upload, { size: 14 }), " ", t("roster.import") || "Import JSON"), /* @__PURE__ */ React.createElement("button", { onClick: handleExport, disabled: !rosterKey, className: "px-3 py-1.5 bg-green-50 text-green-700 rounded-lg text-xs font-bold hover:bg-green-100 transition-colors flex items-center gap-1.5 disabled:opacity-40" }, /* @__PURE__ */ React.createElement(Download, { size: 14 }), " ", t("roster.export") || "Export JSON"), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowBatchConfig(true), disabled: !rosterKey || Object.keys(rosterKey?.groups || {}).length === 0, className: "px-3 py-1.5 bg-amber-50 text-amber-700 rounded-lg text-xs font-bold hover:bg-amber-100 transition-colors flex items-center gap-1.5 disabled:opacity-40 border border-amber-200" }, /* @__PURE__ */ React.createElement(Layers, { size: 14 }), " ", t("roster.batch_generate") || "Differentiate by Group"), activeSessionCode && /* @__PURE__ */ React.createElement("button", { onClick: onSyncToSession, disabled: !rosterKey || groupIds.length === 0, className: "px-3 py-1.5 bg-purple-50 text-purple-700 rounded-lg text-xs font-bold hover:bg-purple-100 transition-colors flex items-center gap-1.5 disabled:opacity-40 ml-auto" }, /* @__PURE__ */ React.createElement(RefreshCw, { size: 14 }), " ", t("roster.sync_session") || "Sync to Live Session"), /* @__PURE__ */ React.createElement("input", { ref: fileInputRef, type: "file", accept: ".json", onChange: handleImport, className: "hidden" })), /* @__PURE__ */ React.createElement("div", { className: "flex-1 overflow-y-auto p-5 space-y-3 custom-scrollbar" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider" }, t("roster.class_name") || "Class Name", ":"), /* @__PURE__ */ React.createElement(
    ...
    return /* @__PURE__ */ React.createElement("div", { key: gId, className: "border border-slate-200 rounded-xl overflow-hidden transition-all hover:border-indigo-200" }, /* @__PURE__ */ React.createElement(
      "button",
      {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "mt-4 pt-4 border-t border-slate-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-xs font-bold text-slate-600 uppercase tracking-wider mb-2 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Users, { size: 14 }), " ", t("roster.manage_students") || "Manage Students"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-[10px]" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
  ...
  ), /* @__PURE__ */ React.createElement("button", { onClick: randomizeRosterName, title: t("common.randomize") || "Randomize", className: "p-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-500 transition-colors" }, /* @__PURE__ */ React.createElement(RefreshCw, { size: 12 }))), useCustomName && /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
  ...
  )), rosterAdj && rosterAnimal && /* @__PURE__ */ React.createElement("div", { className: "text-xs text-teal-600 font-medium pl-1" }, useCustomName && newStudentName.trim() ? /* @__PURE__ */ React.createElement("span", null, "Codename: ", /* @__PURE__ */ React.createElement("strong", null, rosterAdj, " ", rosterAnimal), " \xB7 Display: ", /* @__PURE__ */ React.createElement("strong", null, newStudentName.trim())) : /* @__PURE__ */ React.createElement("span", null, "Codename: ", /* @__PURE__ */ React.createElement("strong", null, rosterAdj, " ", rosterAnimal))))), getUnassigned().length > 0 && /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-amber-50 border border-amber-200 rounded-xl mt-2" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-amber-700 uppercase tracking-wider mb-1.5" }, t("roster.unassigned_students") || "Unassigned Students"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5" }, getUnassigned().map((name) => /* @__PURE__ */ React.createElement("span", { key: name, className: "inline-flex items-center gap-1 px-2.5 py-1 bg-white text-amber-800 rounded-full text-xs font-medium border border-amber-200" }, name, rosterKey?.progressHistory?.[name]?.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-[9px] bg-amber-100 text-amber-800 px-1 py-0.5 rounded-full font-mono ml-0.5", title: `${rosterKey.progressHistory[name].length} sessions` }, rosterKey.progressHistory[name].length, "s"), /* @__PURE__ */ React.createElement(
    "select",
    {
      onChange: (e) => {
      ...
      value: "",
      "aria-label": "Move student to group",
      className: "text-[10px] bg-transparent border-none focus:outline-none focus:ring-2 focus:ring-amber-300 rounded cursor-pointer text-amber-600 ml-1 w-4"
    },
    /* @__PURE__ */ React.createElement("option", { value: "" }, "\u2192"),
    groupIds.map((gId) => /* @__PURE__ */ React.createElement("option", { key: gId, value: gId }, groups[gId].name))
  ), /* @__PURE__ */ React.createElement("button", { onClick: () => handleRemoveStudent(name), className: "hover:text-red-500 transition-colors", "aria-label": "Remove " + name }, /* @__PURE__ */ React.createElement(X, { size: 12 })))))), rosterKey && /* @__PURE__ */ React.createElement("div", { className: "flex gap-4 pt-3 border-t border-slate-100 text-[10px] text-slate-500 font-medium" }, /* @__PURE__ */ React.createElement("span", null, groupIds.length, " group", groupIds.length !== 1 ? "s" : ""), /* @__PURE__ */ React.createElement("span", null, Object.keys(students).length, " student", Object.keys(students).length !== 1 ? "s" : ""), /* @__PURE__ */ React.createElement("span", null, getUnassigned().length, " unassigned"), /* @__PURE__ */ React.createElement("span", { className: "ml-auto flex items-center gap-1" }, /* @__PURE__ */ React.createElement(ShieldCheck, { size: 10, className: "text-green-500" }), " Local only")))));
});
var SimpleBarChart = React.memo(({ data, color = "indigo" }) => {
  ...
  if (!data || data.length === 0) return /* @__PURE__ */ React.createElement("div", { className: "text-xs text-slate-500 italic text-center py-8" }, t("dashboard.empty.no_data"));
...
var SimpleDonutChart = ({ percentage, label, color = "indigo" }) => {
  const size = 100;
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 flex flex-col items-center justify-center" }, /* @__PURE__ */ React.createElement("span", { className: `text-xl font-black text-${color}-600` }, Math.round(safePercent), "%"))), /* @__PURE__ */ React.createElement("span", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider mt-2 text-center leading-tight" }, label));
};
var ConfettiEffect = ({ isActive }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { role: "dialog", "aria-modal": "true", className: "fixed inset-0 pointer-events-none z-[10001] overflow-hidden" }, /* @__PURE__ */ React.createElement("style", null, `
...
var StudentEscapeRoomOverlay = React.memo(({ sessionData, user, activeSessionCode, targetAppId, t, playSound }) => {
  ...
  return /* @__PURE__ */ React.createElement("div", { role: "dialog", "aria-modal": "true", className: "fixed inset-0 z-[9999] bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 overflow-auto" }, /* @__PURE__ */ React.createElement("div", { className: "sticky top-0 z-50 bg-slate-900/90 backdrop-blur-sm border-b border-purple-500/30 p-4" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-6xl mx-auto flex items-center justify-between flex-wrap gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement(DoorOpen, { className: "text-purple-400", size: 24 }), /* @__PURE__ */ React.createElement("span", { className: "text-white font-bold text-lg" }, escapeState.room?.theme || t("escape_room.title"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: `flex items-center gap-2 px-3 py-1.5 rounded-full ${myTeamColors.bg} text-white font-bold text-sm`, "data-help-key": "escape_room_team" }, /* @__PURE__ */ React.createElement(Users, { size: 14 }), t(`escape_room.team_${userTeam.toLowerCase()}`, { defaultValue: `${userTeam} Team` })), /* @__PURE__ */ React.createElement("div", { className: "text-white font-mono", "data-help-key": "escape_room_progress" }, /* @__PURE__ */ React.createElement("span", { className: "text-purple-400" }, solvedPuzzlesSet.size), /* @__PURE__ */ React.createElement("span", { className: "text-slate-400" }, "/", puzzles.length)), escapeState.maxLives < 99 && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 px-2 py-1 rounded-full bg-slate-700/50", title: t("escape_room.lives"), "data-help-key": "escape_room_lives" }, Array.from({ length: escapeState.maxLives }).map((_, i) => /* @__PURE__ */ React.createElement("span", { key: i, className: `text-sm ${i < (escapeState.lives || 0) ? "text-red-500" : "text-slate-600"}` }, "\u2764\uFE0F"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 px-2 py-1 rounded-full bg-slate-700/50", title: t("escape_room.hints_used") }, /* @__PURE__ */ React.createElement(Lightbulb, { size: 14, className: "text-yellow-400" }), /* @__PURE__ */ React.createElement("span", { className: "text-white text-xs font-bold" }, escapeState.hintsRemaining || 0)), (escapeState.streak || 0) >= 3 && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 px-2 py-1 rounded-full bg-orange-500/20 text-orange-800 font-bold text-xs animate-pulse", "data-help-key": "escape_room_streak" }, "\u{1F525} x", escapeState.streak), /* @__PURE__ */ React.createElement("div", { className: `px-3 py-1.5 rounded-full font-mono font-bold ${timeRemaining < 60 ? "bg-red-700 text-white animate-pulse" : "bg-slate-700 text-white"}`, "data-help-key": "escape_room_timer" }, /* @__PURE__ */ React.createElement(Clock, { size: 14, className: "inline mr-1" }), formatTime(timeRemaining))))), /* @__PURE__ */ React.createElement("div", { className: "fixed right-4 top-24 bg-slate-800/80 backdrop-blur-sm rounded-xl p-4 border border-purple-500/30 z-40", "data-help-key": "escape_room_leaderboard" }, /* @__PURE__ */ React.createElement("h4", { className: "text-xs font-bold text-slate-500 uppercase mb-3" }, t("escape_room.live_progress")), allTeams.map((team) => {
    ...
    "button",
    {
      ...
      className: `flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-colors whitespace-nowrap ${(escapeState.hintsRemaining || 0) > 0 ? "bg-yellow-500/20 text-yellow-300 hover:bg-yellow-500/30 border border-yellow-500/40" : "bg-slate-700 text-slate-500 cursor-not-allowed"}`
    },
    ...
    "input",
    {
      ...
      className: "w-full p-4 bg-slate-700 text-white rounded-xl border-2 border-slate-600 focus:border-purple-400 focus:ring-2 focus:ring-purple-300 focus:outline-none"
    }
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        className: `w-full p-3 rounded-lg text-left font-medium transition-all focus:outline-none focus:ring-2 focus:ring-purple-400 ${isMatched ? "bg-green-700 text-white opacity-60" : isSelected ? "bg-purple-700 text-white ring-2 ring-purple-300" : "bg-slate-700 text-white hover:bg-slate-600"}`
      },
      item
    );
  ...
  }))), matchingPairs.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-slate-900 p-3 rounded-lg", role: "list", "aria-label": t("escape_room.matched_pairs") || "Matched pairs" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-400 mb-2", "aria-hidden": "true" }, t("escape_room.matched_pairs")), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, matchingPairs.map((pair, idx) => /* @__PURE__ */ React.createElement("div", { key: idx, role: "listitem", className: "text-sm text-green-400" }, "\u2713 ", pair.left, " \u2194 ", pair.right)))), matchingPairs.length >= (currentPuzzle.pairs?.length || 4) && /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    t("escape_room.submit_answer")
  )), currentPuzzle.hint && /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-purple-400 text-sm italic" }, "\u{1F4A1} ", currentPuzzle.hint))), isPaused && /* @__PURE__ */ React.createElement("div", { role: "dialog", "aria-modal": "true", className: "fixed inset-0 z-[10001] bg-black/80 flex items-center justify-center backdrop-blur-sm" }, /* @__PURE__ */ React.createElement("div", { className: "text-center text-white animate-pulse" }, /* @__PURE__ */ React.createElement("div", { className: "text-8xl mb-6" }, "\u23F8\uFE0F"), /* @__PURE__ */ React.createElement("h2", { className: "text-4xl font-black mb-3" }, t("escape_room.game_paused")), /* @__PURE__ */ React.createElement("p", { className: "text-xl text-slate-400" }, t("escape_room.waiting_resume")))), teamEscapeToast && /* @__PURE__ */ React.createElement("div", { className: "fixed bottom-6 left-1/2 -translate-x-1/2 z-[10002] animate-in slide-in-from-bottom duration-300" }, /* @__PURE__ */ React.createElement("div", { className: `flex items-center gap-3 px-6 py-4 rounded-2xl shadow-2xl border-2 ${teamColors[teamEscapeToast]?.border || "border-purple-500"} bg-slate-900` }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl" }, "\u{1F6AA}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-white font-bold" }, t("escape_room.team_escaped", { team: teamEscapeToast })), /* @__PURE__ */ React.createElement("p", { className: "text-slate-500 text-sm" }, t("escape_room.hurry_up"))))));
});
...
var TeacherLiveQuizControls = React.memo(({ sessionData, generatedContent, activeSessionCode, appId: appId2, onGenerateImage, onRefineImage, onCreateGroup, onAssignStudent, onSetGroupResource, onSetGroupLanguage, onSetGroupProfile, onDeleteGroup }) => {
  const { t } = useContext(LanguageContext);
  ...
  const renderAnalytics = () => /* @__PURE__ */ React.createElement("div", { className: "flex flex-col h-full w-full animate-in fade-in duration-300" }, /* @__PURE__ */ React.createElement("div", { className: "w-full h-48 mb-6 shrink-0" }, /* @__PURE__ */ React.createElement(SimpleBarChart, { data: detailedStats, color: "indigo" })), /* @__PURE__ */ React.createElement("div", { className: "flex-grow overflow-y-auto pr-1 custom-scrollbar space-y-2" }, detailedStats.map((stat, i) => /* @__PURE__ */ React.createElement(
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "text-right min-w-[50px]" }, /* @__PURE__ */ React.createElement("div", { className: "font-black text-slate-800 text-sm" }, stat.value), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 font-mono" }, stat.percent, "%")))
  ))), /* @__PURE__ */ React.createElement("div", { className: "mt-4 pt-3 border-t border-slate-100 flex justify-between items-center text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-500 uppercase tracking-wider" }, t("quiz.total_responses")), /* @__PURE__ */ React.createElement("span", { className: "font-mono font-black text-lg text-indigo-600 bg-indigo-50 px-3 py-0.5 rounded-full border border-indigo-100" }, answeredCount)));
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden mb-6 animate-in slide-in-from-top-4 duration-500" }, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-900 text-white p-4 flex justify-between items-center flex-wrap gap-4" }, /* @__PURE__ */ React.createElement("h3", { className: "font-bold flex items-center gap-2" }, /* @__PURE__ */ React.createElement(MonitorPlay, { size: 20, className: "text-teal-400" }), " ", t("quiz.live_control_center")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement(
    "select",
    {
    ...
    total: totalStudents,
    percent: percentage
  })), /* @__PURE__ */ React.createElement("button", { onClick: handleEndQuiz, className: "text-xs bg-red-500 hover:bg-red-600 px-3 py-1.5 rounded-full font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-white" }, t("quiz.end_quiz")))), /* @__PURE__ */ React.createElement("div", { className: "w-full h-1.5 bg-slate-100 relative" }, /* @__PURE__ */ React.createElement("div", { role: "progressbar", "aria-valuemin": "0", "aria-valuemax": "100", className: "bg-teal-500 h-full transition-all duration-500 ease-out", style: { width: `${percentage}%` } })), /* @__PURE__ */ React.createElement("div", { className: "bg-slate-50 border-b border-slate-200 p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col md:flex-row gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex-1" }, /* @__PURE__ */ React.createElement("h4", { className: "text-xs font-bold text-slate-500 uppercase mb-2" }, t("groups.title")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mb-3" }, /* @__PURE__ */ React.createElement(
    "input",
    {
    ...
    "+ ",
    t("groups.add_button")
  )), /* @__PURE__ */ React.createElement("div", { className: "space-y-2 max-h-40 overflow-y-auto custom-scrollbar" }, activeGroups.map(([gid, group]) => /* @__PURE__ */ React.createElement("div", { key: gid, className: "bg-white p-2 rounded border border-indigo-100 shadow-sm flex flex-col gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold text-indigo-900" }, group.name), /* @__PURE__ */ React.createElement("button", { onClick: () => handleDeleteGroup(gid), className: "text-[10px] text-red-400 hover:text-red-600 font-bold focus:outline-none focus:ring-2 focus:ring-red-400 rounded" }, t("groups.remove_button")))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] uppercase font-bold text-slate-500" }, t("groups.resource_label")), /* @__PURE__ */ React.createElement(
    "select",
    {
      "aria-label": t("common.selection"),
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] uppercase font-bold text-slate-500" }, t("groups.language_label") || "Quiz Language"), /* @__PURE__ */ React.createElement(
    "select",
    {
      "aria-label": t("common.selection"),
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] uppercase font-bold text-slate-500" }, t("groups.reading_level_label") || "Reading Level"), /* @__PURE__ */ React.createElement(
    "select",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] uppercase font-bold text-slate-500" }, t("groups.visual_density_label") || "Visuals"), /* @__PURE__ */ React.createElement(
    "select",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] uppercase font-bold text-slate-500" }, t("groups.tts_speed_label") || "TTS Speed"), /* @__PURE__ */ React.createElement(
    "select",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement("label", { className: "flex items-center gap-1 text-[10px] font-bold text-slate-500 cursor-pointer", title: t("groups.karaoke_tooltip") || "Auto-enable word highlighting for this group" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: group.karaokeMode || false, onChange: (e) => handleSetGroupProfile(gid, "karaokeMode", e.target.checked), className: "rounded border-slate-300 text-indigo-500 focus:ring-indigo-400" }), t("groups.karaoke_label") || "Karaoke Mode"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mt-1" }, /* @__PURE__ */ React.createElement("label", { className: "flex items-center gap-1 text-[10px] font-bold text-slate-500 cursor-pointer", title: t("common.toggle_emoji_usage_for_this_group") }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: g.profile?.useEmojis || false, onChange: (e) => handleSetGroupProfile(gid, "useEmojis", e.target.checked), className: "rounded border-slate-300 text-indigo-500 focus:ring-indigo-400" }), t("roster.emojis_label") || "Use Emojis"), /* @__PURE__ */ React.createElement("select", { "aria-label": t("common.text_format"), value: g.profile?.textFormat || "Standard Text", onChange: (e) => handleSetGroupProfile(gid, "textFormat", e.target.value), className: "text-[10px] p-1 rounded border border-slate-200 bg-slate-50" }, /* @__PURE__ */ React.createElement("option", { value: "Standard Text" }, t("roster.format_standard") || "Standard"), /* @__PURE__ */ React.createElement("option", { value: "Bullet Points" }, t("roster.format_bullets") || "Bullets"), /* @__PURE__ */ React.createElement("option", { value: "Outline" }, t("roster.format_outline") || "Outline")))))), activeGroups.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-xs text-slate-500 italic text-center py-2" }, t("groups.no_groups")))), /* @__PURE__ */ React.createElement("div", { className: "flex-[2] border-l border-slate-200 pl-4" }, /* @__PURE__ */ React.createElement("h4", { className: "text-xs font-bold text-slate-500 uppercase mb-2" }, t("groups.roster_title")), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded border border-slate-200 p-3 max-h-52 overflow-y-auto custom-scrollbar" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2" }, Object.entries(roster || {}).map(([uid, student]) => {
    const groupId = student.groupId;
    const groupName = groupId && groups[groupId] ? groups[groupId].name : null;
    return /* @__PURE__ */ React.createElement("div", { key: uid, className: `relative p-2 rounded border text-xs ${groupName ? "bg-indigo-50 border-indigo-200" : "bg-slate-50 border-slate-100"}` }, /* @__PURE__ */ React.createElement("div", { className: "font-bold truncate", title: student.displayName }, student.displayName || "Anonymous"), /* @__PURE__ */ React.createElement("div", { className: `mt-1 text-[10px] font-mono truncat ${groupName ? "text-indigo-600" : "text-slate-500"}` }, groupName || t("groups.main_class")), /* @__PURE__ */ React.createElement(
      "select",
      {
        "aria-label": t("common.selection"),
  ...
  })), (!roster || Object.keys(roster).length === 0) && /* @__PURE__ */ React.createElement("div", { className: "text-center text-slate-500 italic py-4" }, t("groups.waiting_students")))))), /* @__PURE__ */ React.createElement("div", { className: "p-6 grid grid-cols-1 lg:grid-cols-2 gap-8" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col justify-between h-full" }, /* @__PURE__ */ React.createElement("div", { className: "mb-6" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs font-bold text-slate-500 uppercase tracking-widest block mb-2" }, t("quiz.question_progress", {
    ...
    ), /* @__PURE__ */ React.createElement("span", { className: "mt-2 text-xs font-bold uppercase text-slate-500" }, t(`quiz.teams.${team.toLowerCase()}`)), phase === "revealed" && sessionData.quizState.lastRoundStats?.[team]?.points > 0 && /* @__PURE__ */ React.createElement("div", { className: "absolute -top-8 left-1/2 -translate-x-1/2 bg-yellow-300 text-indigo-900 text-xs font-black px-2 py-1 rounded shadow-sm animate-bounce whitespace-nowrap z-10" }, "+", sessionData.quizState.lastRoundStats[team].points));
  })), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 font-bold uppercase tracking-wider" }, t("quiz.team_leaderboard"))) : null), phase === "revealed" && /* @__PURE__ */ React.createElement("div", { className: "mt-6 w-full bg-green-100 border border-green-200 text-green-800 p-4 rounded-xl text-center animate-in slide-in-from-bottom-2 shadow-sm z-10" }, /* @__PURE__ */ React.createElement("span", { className: "block text-[10px] font-black uppercase tracking-widest text-green-600 mb-1" }, t("quiz.correct_answer_label")), /* @__PURE__ */ React.createElement("span", { className: "text-lg font-bold" }, question.correctAnswer)))));
});
var calculateAnalyticsMetrics = (dashboardData) => {
...
var LongitudinalProgressChart = React.memo(({ logs }) => {
  const { t } = useContext(LanguageContext);
  if (!logs || logs.length < 2) return /* @__PURE__ */ React.createElement("div", { className: "w-full bg-white p-6 rounded-xl border border-slate-200 shadow-sm mt-4 flex flex-col items-center justify-center text-slate-500 italic gap-2" }, /* @__PURE__ */ React.createElement(History, { size: 24, className: "opacity-50" }), /* @__PURE__ */ React.createElement("span", { className: "text-xs" }, t("dashboard.progress_chart.empty_msg")));
  const width = 600;
  const height = 200;
  const padding = 30;
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "w-full bg-white p-6 rounded-xl border border-slate-200 shadow-sm mt-6 animate-in slide-in-from-bottom-2" }, /* @__PURE__ */ React.createElement("h4", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider mb-6 flex items-center gap-2" }, /* @__PURE__ */ React.createElement(Trophy, { size: 14, className: "text-yellow-500" }), " ", t("dashboard.progress_chart.title")), /* @__PURE__ */ React.createElement("div", { className: "w-full overflow-x-auto" }, /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${width} ${height}`, className: "w-full h-auto min-w-[500px] overflow-visible" }, /* @__PURE__ */ React.createElement("line", { x1: padding, y1: height - padding, x2: width - padding, y2: height - padding, stroke: "#e2e8f0", strokeWidth: "2" }), /* @__PURE__ */ React.createElement("line", { x1: padding, y1: padding, x2: padding, y2: height - padding, stroke: "#e2e8f0", strokeWidth: "2" }), /* @__PURE__ */ React.createElement(
    ...
    const x = padding + (new Date(l.timestamp).getTime() - minTime) / timeSpan * (width - padding * 2);
    const y = height - padding - l.xp / maxXP * (height - padding * 2);
    return /* @__PURE__ */ React.createElement("g", { key: i, className: "group cursor-pointer" }, /* @__PURE__ */ React.createElement("circle", { cx: x, cy: y, r: "5", className: "fill-white stroke-indigo-600 stroke-2 transition-all duration-300 group-hover:r-7 group-hover:fill-indigo-50" }), /* @__PURE__ */ React.createElement("foreignObject", { x: Math.min(width - 120, Math.max(0, x - 60)), y: y - 50, width: "120", height: "50", className: "opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10" }, /* @__PURE__ */ React.createElement("div", { className: "bg-slate-800 text-white text-[10px] px-3 py-2 rounded-lg text-center shadow-xl" }, /* @__PURE__ */ React.createElement("div", { className: "font-bold" }, new Date(l.timestamp).toLocaleDateString()), /* @__PURE__ */ React.createElement("div", { className: "text-yellow-300 font-mono" }, l.xp, " XP"))));
  }))), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[10px] text-slate-500 font-medium mt-2 px-2" }, /* @__PURE__ */ React.createElement("span", null, t("dashboard.progress_chart.label_start"), ": ", new Date(logs[0].timestamp).toLocaleDateString()), /* @__PURE__ */ React.createElement("span", null, t("dashboard.progress_chart.label_current"), ": ", new Date(logs[logs.length - 1].timestamp).toLocaleDateString())));
});
var LearnerProgressView = React.memo(({
  globalPoints = 0,
  globalLevel = 1,
  globalProgress = 0,
  currentLevelXP = 0,
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "max-w-4xl mx-auto p-4 md:p-6 space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-500" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { className: "text-2xl md:text-3xl font-black text-slate-800 flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg" }, /* @__PURE__ */ React.createElement(TrendingUp, { size: 22, className: "text-white" })), heading), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-500 mt-1 font-medium" }, isParentMode ? "Track your family's learning growth" : "Track your learning growth over time")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement(
    ...
    child.name,
    child.sessionCount > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-[10px] bg-indigo-100 text-indigo-600 px-1.5 py-0.5 rounded-full font-mono" }, child.sessionCount, " sessions")
  )))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-slate-200 shadow-sm p-5 hover:shadow-md transition-shadow" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "w-14 h-14 bg-yellow-400 rounded-full flex items-center justify-center border-4 border-indigo-900 shadow-lg relative" }, /* @__PURE__ */ React.createElement(Trophy, { size: 28, className: "text-indigo-900 fill-current" }), /* @__PURE__ */ React.createElement("div", { className: "absolute -bottom-2 bg-indigo-900 text-yellow-400 text-[10px] font-black px-2 py-0.5 rounded-full border border-white" }, "Lvl ", globalLevel)), /* @__PURE__ */ React.createElement("div", { className: "flex-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider" }, t("learner.total_xp")), /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-black text-indigo-900" }, globalPoints.toLocaleString())), stats.trend > 0 && /* @__PURE__ */ React.createElement("div", { className: "text-xs font-bold text-green-800 bg-green-50 px-2 py-1 rounded-full flex items-center gap-1" }, /* @__PURE__ */ React.createElement(TrendingUp, { size: 12 }), " +", stats.trend, " XP")), !isTeacherMode && (wordSoundsScore?.streak > 0 || (() => {
    ...
    return dayStreak >= 2;
  })()) && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-2 px-3 py-2 bg-gradient-to-r from-orange-50 to-red-50 rounded-xl border border-orange-100" }, wordSoundsScore?.streak > 0 && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-lg" }, "\u{1F525}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-sm font-black text-orange-600" }, wordSoundsScore.streak, " Streak"), /* @__PURE__ */ React.createElement("div", { className: "text-[9px] text-orange-400 font-bold uppercase" }, t("learner.current_run")))), (() => {
    const days = /* @__PURE__ */ new Set();
    pointHistory.forEach((e) => {
      if (e.timestamp) days.add(new Date(e.timestamp).toDateString());
    });
    ...
    return dayStreak >= 2 ? /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 ml-auto" }, /* @__PURE__ */ React.createElement("span", { className: "text-lg" }, "\u{1F4C5}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-sm font-black text-red-600" }, dayStreak, " Days"), /* @__PURE__ */ React.createElement("div", { className: "text-[9px] text-red-400 font-bold uppercase" }, t("learner.daily_streak")))) : null;
  })()), /* @__PURE__ */ React.createElement("div", { className: "space-y-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[10px] font-bold text-slate-500 uppercase" }, /* @__PURE__ */ React.createElement("span", null, "Level ", globalLevel), /* @__PURE__ */ React.createElement("span", null, Math.round(globalProgress), "%")), /* @__PURE__ */ React.createElement("div", { className: "w-full bg-slate-100 rounded-full h-3 overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { role: "progressbar", "aria-valuemin": "0", "aria-valuemax": "100", className: "h-full bg-gradient-to-r from-yellow-400 to-orange-500 transition-all duration-1000 rounded-full", style: { width: `${Math.max(5, globalProgress)}%` } })), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-[10px] font-mono text-slate-500" }, /* @__PURE__ */ React.createElement("span", null, currentLevelXP, " XP"), /* @__PURE__ */ React.createElement("span", null, globalXPNext, " XP to next")))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-slate-200 shadow-sm p-5 hover:shadow-md transition-shadow" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider mb-4 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Activity, { size: 14 }), " Activities Completed"), /* @__PURE__ */ React.createElement("div", { className: "text-3xl font-black text-slate-800 mb-4" }, stats.totalActivities), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2" }, [
  ...
  ].map((item) => /* @__PURE__ */ React.createElement("div", { key: item.label, className: `${item.color} rounded-lg px-3 py-2 text-center` }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black" }, item.icon, " ", item.value), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold uppercase tracking-wider opacity-80" }, item.label))))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-slate-200 shadow-sm p-5 hover:shadow-md transition-shadow" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Target, { size: 14 }), " Skills Progress"), stats.wsTotal === 0 && Object.keys(phonemeMastery).length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "text-center py-6 text-slate-500 italic text-sm" }, /* @__PURE__ */ React.createElement(BookOpen, { size: 32, className: "mx-auto mb-2 opacity-40" }), "Start practicing to see your skills grow!") : /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, stats.wsTotal > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold text-slate-600" }, t("learner.ws_accuracy")), /* @__PURE__ */ React.createElement("span", { className: `text-sm font-black ${stats.wsAccuracy >= 80 ? "text-green-600" : stats.wsAccuracy >= 60 ? "text-yellow-600" : "text-orange-500"}` }, stats.wsAccuracy, "%")), /* @__PURE__ */ React.createElement("div", { className: "w-full bg-slate-100 rounded-full h-2.5" }, /* @__PURE__ */ React.createElement(
    "div",
    {
  ...
  ))), stats.masteredPhonemes.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-green-600 uppercase tracking-wider mb-1.5" }, "\u2728 ", stats.masteredPhonemes.length, " Sounds Mastered"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1" }, stats.masteredPhonemes.slice(0, 12).map(([phoneme]) => /* @__PURE__ */ React.createElement("span", { key: phoneme, className: "px-2 py-0.5 bg-green-50 text-green-700 text-xs font-bold rounded-full border border-green-200" }, "/", phoneme, "/")), stats.masteredPhonemes.length > 12 && /* @__PURE__ */ React.createElement("span", { className: "px-2 py-0.5 bg-green-50 text-green-600 text-xs font-bold rounded-full" }, "+", stats.masteredPhonemes.length - 12, " more"))), showDiagnostics && stats.practicingPhonemes.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-amber-600 uppercase tracking-wider mb-1.5" }, "\u{1F504} ", stats.practicingPhonemes.length, " Sounds In Progress"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1" }, stats.practicingPhonemes.slice(0, 8).map(([phoneme, data]) => /* @__PURE__ */ React.createElement("span", { key: phoneme, className: "px-2 py-0.5 bg-amber-50 text-amber-700 text-xs font-bold rounded-full border border-amber-200", title: `${Math.round(data.accuracy)}% accuracy` }, "/", phoneme, "/ ", /* @__PURE__ */ React.createElement("span", { className: "opacity-60" }, Math.round(data.accuracy), "%"))))))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-slate-200 shadow-sm p-5 hover:shadow-md transition-shadow" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Award, { size: 14 }), " Achievements"), (() => {
    const milestones = [
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, earned.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, earned.map((m) => /* @__PURE__ */ React.createElement("div", { key: m.name, className: "bg-yellow-50 border border-yellow-200 rounded-xl px-3 py-2 text-center min-w-[80px] hover:shadow-sm transition-shadow", title: m.desc }, /* @__PURE__ */ React.createElement("div", { className: "text-xl" }, m.icon), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-yellow-800 mt-0.5" }, m.name)))), earned.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-center py-4 text-slate-500 italic text-sm" }, "Complete activities to earn achievements! \u{1F31F}"), showDiagnostics && locked.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1.5" }, t("learner.coming_up")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5" }, locked.slice(0, 4).map((m) => /* @__PURE__ */ React.createElement("div", { key: m.name, className: "bg-slate-50 border border-slate-200 rounded-lg px-2 py-1.5 text-center opacity-50", title: m.desc }, /* @__PURE__ */ React.createElement("div", { className: "text-sm grayscale" }, m.icon), /* @__PURE__ */ React.createElement("div", { className: "text-[9px] font-bold text-slate-500" }, m.name))))));
  })())), (() => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-100 p-5" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-blue-600 uppercase tracking-wider mb-3 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Clock, { size: 14 }), " Today's Activity"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-3 mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-blue-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-blue-700" }, todayXP.reduce((s2, e) => s2 + (e.points || 0), 0)), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-blue-400 uppercase" }, t("learner.xp_earned"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-blue-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-blue-700" }, todayXP.length), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-blue-400 uppercase" }, "Activities")), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-blue-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-blue-700" }, todayWords.filter((w) => w.correct).length, "/", todayWords.length), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-blue-400 uppercase" }, t("learner.words_today")))), todayXP.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "space-y-1 max-h-24 overflow-y-auto" }, todayXP.slice(0, 8).map((entry, i) => /* @__PURE__ */ React.createElement("div", { key: entry.id || i, className: "flex justify-between items-center text-xs px-2 py-1 rounded bg-white/60" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 font-medium truncate max-w-[220px]" }, entry.activity), /* @__PURE__ */ React.createElement("span", { className: "font-bold text-green-600 whitespace-nowrap" }, "+", entry.points, " XP")))));
  })(), (() => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl border border-emerald-100 p-5" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-emerald-600 uppercase tracking-wider mb-3 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Calendar, { size: 14 }), " This Week's Progress"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3 mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-emerald-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-emerald-700" }, weekTotalXP), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-emerald-400 uppercase" }, t("learner.xp_this_week")), xpDelta !== 0 && /* @__PURE__ */ React.createElement("div", { className: `text-[10px] font-bold mt-0.5 ${xpDelta > 0 ? "text-green-500" : "text-red-400"}` }, xpDelta > 0 ? "\u2191" : "\u2193", " ", Math.abs(xpDelta), " vs last week")), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-emerald-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-emerald-700" }, weekXP.length), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-emerald-400 uppercase" }, "Activities")), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-emerald-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-emerald-700" }, weekWords.filter((w) => w.correct).length, "/", weekWords.length), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-emerald-400 uppercase" }, t("learner.words_this_week"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-emerald-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-emerald-700" }, weekAccuracy !== null ? weekAccuracy + "%" : "\u2014"), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-emerald-400 uppercase" }, "Accuracy"))), weekGames.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "text-xs text-emerald-600 font-medium bg-white/60 rounded-lg px-3 py-2" }, "\u{1F3AE} ", weekGames.length, " game", weekGames.length !== 1 ? "s" : "", " played this week"));
  })(), studentProgressLog.length >= 2 && /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-slate-200 shadow-sm p-5 hover:shadow-md transition-shadow" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(TrendingUp, { size: 14 }), " Growth Over Time"), /* @__PURE__ */ React.createElement(LongitudinalProgressChart, { logs: studentProgressLog })), showDiagnostics && /* @__PURE__ */ React.createElement("div", { className: "bg-slate-50 rounded-2xl border border-slate-200 p-5 space-y-4 animate-in slide-in-from-top-2 duration-300" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(BarChart3, { size: 14 }), " Detailed Metrics"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 border border-slate-200 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-slate-700" }, stats.wsCorrect, "/", stats.wsTotal), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, t("learner.words_correct"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 border border-slate-200 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-slate-700" }, Object.keys(phonemeMastery).length), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, t("learner.phonemes_touched"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 border border-slate-200 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-slate-700" }, stats.sessionCount), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, "Sessions")), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 border border-slate-200 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-slate-700" }, stats.labelChallenges), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, t("learner.label_challenges")))), pointHistory.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h4", { className: "text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2" }, t("learner.recent_activity")), /* @__PURE__ */ React.createElement("div", { className: "space-y-1 max-h-32 overflow-y-auto" }, pointHistory.slice(0, 10).map((entry, i) => /* @__PURE__ */ React.createElement("div", { key: entry.id || i, className: "flex justify-between items-center text-xs px-2 py-1 rounded hover:bg-white" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 font-medium truncate max-w-[200px]" }, entry.activity), /* @__PURE__ */ React.createElement("span", { className: "font-bold text-green-600" }, "+", entry.points, " XP")))))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap justify-center gap-3 pt-2" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
...
var TeacherDashboard = React.memo(({ onClose, dashboardData = [], setDashboardData, addToast: addToast2, setSelectedStudentId, setDashboardView, dashboardView, selectedStudentId, generateResourceHTML, onOpenBehaviorLens }) => {
  const { t } = useContext(LanguageContext);
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex-grow p-6 overflow-y-auto bg-slate-100" }, dashboardView === "detail" && selectedStudent ? /* @__PURE__ */ React.createElement("div", { className: "max-w-5xl mx-auto h-full flex flex-col animate-in slide-in-from-right-8 duration-300" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-6 mb-6 border-b border-slate-200 pb-6 sticky top-0 bg-slate-50 z-10 pt-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-6" }, /* @__PURE__ */ React.createElement(
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "w-1/2 flex flex-col justify-center gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-slate-50 rounded-lg border border-slate-100 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-black text-indigo-900" }, studentAvg, "%"), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, t("dashboard.charts.student_avg"))), /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-slate-50 rounded-lg border border-slate-100 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-xl font-bold text-slate-600" }, analytics.averageScore, "%"), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, t("dashboard.charts.class_avg")))))), /* @__PURE__ */ React.createElement("div", { className: "bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-center" }, /* @__PURE__ */ React.createElement("h4", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider mb-2" }, t("dashboard.charts.quiz_participation")), /* @__PURE__ */ React.createElement("div", { className: "flex items-end gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-4xl font-black text-slate-800" }, quizHistory.length), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium text-slate-500 mb-1" }, t("dashboard.charts.quizzes_taken"))))), (selectedStudent.probeHistory || selectedStudent.interventionLogs || selectedStudent.surveyResponses || selectedStudent.fluencyAssessments) && /* @__PURE__ */ React.createElement("div", { className: "bg-white p-6 rounded-xl border border-slate-200 shadow-sm mb-6 mt-6" }, /* @__PURE__ */ React.createElement("h4", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider mb-4 flex items-center gap-2" }, "\u{1F4CA} Assessment & Research Data"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" }, selectedStudent.probeHistory && Object.keys(selectedStudent.probeHistory).length > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-amber-50 rounded-xl p-4 border border-amber-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-black text-amber-700" }, Object.values(selectedStudent.probeHistory).flat().length), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-amber-600 uppercase mt-1" }, t("probes.probe_results")), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 mt-2" }, Object.keys(selectedStudent.probeHistory).map((name) => /* @__PURE__ */ React.createElement("div", { key: name, className: "flex justify-between" }, /* @__PURE__ */ React.createElement("span", null, name), /* @__PURE__ */ React.createElement("span", { className: "font-bold" }, selectedStudent.probeHistory[name].length, " probes"))))), selectedStudent.interventionLogs && selectedStudent.interventionLogs.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-blue-50 rounded-xl p-4 border border-blue-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-black text-blue-700" }, selectedStudent.interventionLogs.length), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-blue-600 uppercase mt-1" }, t("research.intervention_logs"))), selectedStudent.surveyResponses && selectedStudent.surveyResponses.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-purple-50 rounded-xl p-4 border border-purple-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-black text-purple-700" }, selectedStudent.surveyResponses.length), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-purple-600 uppercase mt-1" }, t("research.survey_responses")), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 mt-2" }, selectedStudent.surveyResponses.slice(-1).map((r, i) => /* @__PURE__ */ React.createElement("div", { key: i }, "Latest: ", r.type || "survey", " (", new Date(r.timestamp || Date.now()).toLocaleDateString(), ")")))), selectedStudent.sessionCounter !== void 0 && /* @__PURE__ */ React.createElement("div", { className: "bg-emerald-50 rounded-xl p-4 border border-emerald-200" }, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-black text-emerald-700" }, selectedStudent.sessionCounter), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-emerald-600 uppercase mt-1" }, t("research.sessions_completed")), selectedStudent.fidelityLog && selectedStudent.fidelityLog.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "text-[10px] text-slate-500 mt-2" }, selectedStudent.fidelityLog.length, " fidelity records"))), selectedStudent.probeHistory && Object.keys(selectedStudent.probeHistory).length > 0 && /* @__PURE__ */ React.createElement("div", { className: "mt-4 space-y-2" }, /* @__PURE__ */ React.createElement("h5", { className: "text-[10px] font-bold text-slate-500 uppercase" }, t("research.recent_probe_results")), /* @__PURE__ */ React.createElement("div", { className: "space-y-1.5" }, Object.entries(selectedStudent.probeHistory).flatMap(
      ([name, probes]) => probes.slice(-3).map((p, i) => /* @__PURE__ */ React.createElement("div", { key: name + "-" + i, className: "flex items-center justify-between bg-slate-50 rounded-lg px-3 py-2 border border-slate-100 text-xs" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-700" }, name), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-500" }, p.probeType || p.type || "Probe"), p.wcpm !== void 0 && /* @__PURE__ */ React.createElement("span", { className: "font-mono font-bold text-amber-700" }, p.wcpm, " WCPM"), p.dcpm !== void 0 && /* @__PURE__ */ React.createElement("span", { className: "font-mono font-bold text-amber-700" }, p.dcpm, " DCPM"), p.accuracy !== void 0 && /* @__PURE__ */ React.createElement("span", { className: "font-mono font-bold text-emerald-700" }, Math.round(p.accuracy * 100), "%"), p.score !== void 0 && /* @__PURE__ */ React.createElement("span", { className: "font-mono font-bold text-indigo-700" }, p.score), /* @__PURE__ */ React.createElement("span", { className: "text-slate-500" }, new Date(p.timestamp || p.date || Date.now()).toLocaleDateString()))))
    ))), selectedStudent.externalCBMScores && Object.keys(selectedStudent.externalCBMScores).length > 0 && /* @__PURE__ */ React.createElement("div", { className: "mt-4" }, /* @__PURE__ */ React.createElement("h5", { className: "text-[10px] font-bold text-slate-500 uppercase mb-2" }, t("research.external_cbm_scores")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-2" }, Object.entries(selectedStudent.externalCBMScores).map(([source, scores]) => /* @__PURE__ */ React.createElement("div", { key: source, className: "bg-slate-50 rounded-lg px-3 py-2 border border-slate-100" }, /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-600 uppercase" }, source), Array.isArray(scores) ? scores.slice(-1).map((s2, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "text-sm font-bold text-slate-800" }, s2.score || s2.value || JSON.stringify(s2))) : /* @__PURE__ */ React.createElement("div", { className: "text-sm font-bold text-slate-800" }, JSON.stringify(scores))))))), /* @__PURE__ */ React.createElement("div", { className: "flex-grow overflow-y-auto custom-scrollbar space-y-6 pb-10" }, (selectedStudent.history || []).map((item, idx) => /* @__PURE__ */ React.createElement("div", { key: item.id || idx, className: "bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:border-indigo-300 transition-colors" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-start mb-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-lg text-slate-800" }, item.title || "Untitled Resource"), /* @__PURE__ */ React.createElement("span", { className: "text-xs font-bold text-indigo-600 uppercase tracking-wider bg-indigo-50 px-2 py-0.5 rounded border border-indigo-100" }, item.type)), /* @__PURE__ */ React.createElement("span", { className: "text-xs text-slate-500 font-mono" }, new Date(item.timestamp).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }))), item.meta && /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-500 italic border-l-2 border-slate-200 pl-3 mb-4" }, item.meta), /* @__PURE__ */ React.createElement("div", { className: "bg-slate-50 rounded-lg p-4 border border-slate-100 overflow-x-auto" }, /* @__PURE__ */ React.createElement(
      "div",
      {
    ...
    )))), selectedStudent.history.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-center py-12 text-slate-500 italic" }, t("dashboard.empty.no_history")))) : /* @__PURE__ */ React.createElement(React.Fragment, null, dashboardData.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "relative flex flex-col items-center justify-center h-full text-slate-500 gap-4 border-4 border-dashed border-slate-300 rounded-3xl hover:bg-slate-100 hover:border-indigo-300 hover:text-indigo-500 transition-all cursor-pointer group min-h-[400px] bg-white" }, /* @__PURE__ */ React.createElement("div", { className: "bg-slate-50 p-6 rounded-full shadow-sm mb-2 group-hover:scale-110 transition-transform" }, /* @__PURE__ */ React.createElement(Upload, { size: 48, className: "text-slate-500 group-hover:text-indigo-500" })), /* @__PURE__ */ React.createElement("h3", { className: "text-2xl font-black text-slate-500 group-hover:text-indigo-700" }, t("dashboard.drop_files")), /* @__PURE__ */ React.createElement("p", { className: "text-sm font-bold opacity-70 bg-slate-200 px-3 py-1 rounded-full group-hover:bg-indigo-100 group-hover:text-indigo-600 transition-colors" }, t("dashboard.batch_supported")), /* @__PURE__ */ React.createElement(
      "input",
      {
    ...
    )) : /* @__PURE__ */ React.createElement(React.Fragment, null, activeTab === "students" && /* @__PURE__ */ React.createElement("div", { className: "max-w-6xl mx-auto space-y-6 animate-in fade-in slide-in-from-left-4" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white p-4 rounded-xl shadow-sm border border-slate-200 flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-blue-100 p-3 rounded-full text-blue-600" }, /* @__PURE__ */ React.createElement(Users, { size: 24 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-2xl font-black text-slate-800" }, dashboardData.length), /* @__PURE__ */ React.createElement("div", { className: "text-xs font-bold text-slate-500 uppercase" }, t("dashboard.stats.students_loaded")))), /* @__PURE__ */ React.createElement("div", { className: "bg-white p-4 rounded-xl shadow-sm border border-slate-200 flex items-center gap-4 relative group cursor-pointer hover:border-indigo-300 transition-colors" }, /* @__PURE__ */ React.createElement("div", { className: "bg-green-100 p-3 rounded-full text-green-600" }, /* @__PURE__ */ React.createElement(Upload, { size: 24 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-sm font-bold text-green-700" }, t("dashboard.stats.add_files")), /* @__PURE__ */ React.createElement("div", { className: "text-xs text-slate-500" }, t("dashboard.stats.click_upload"))), /* @__PURE__ */ React.createElement(
      "input",
      {
        "aria-label": t("common.upload_json_file"),
        type: "file",
      ...
      count,
      ")"
    ))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-sm border border-slate-200 overflow-x-auto" }, /* @__PURE__ */ React.createElement("table", { className: "w-full text-left text-sm text-slate-600 min-w-[600px]" }, /* @__PURE__ */ React.createElement("caption", { className: "sr-only" }, "teacher module data table"), React.createElement("thead", { className: "bg-slate-50 text-xs uppercase font-bold text-slate-500" }, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { scope: "col", className: "p-4" }, t("dashboard.header_nickname")), /* @__PURE__ */ React.createElement("th", { className: "p-4" }, t("dashboard.header_date")), /* @__PURE__ */ React.createElement("th", { className: "p-4" }, t("dashboard.header_progress")), /* @__PURE__ */ React.createElement("th", { className: "p-4" }, t("dashboard.header_level")), /* @__PURE__ */ React.createElement("th", { className: "p-4 text-right" }, t("dashboard.header_actions")))), /* @__PURE__ */ React.createElement("tbody", { className: "divide-y divide-slate-100" }, dashboardData.map((student, idx) => {
      const level = getStudentLevel(student.history);
      const isGraded = gradedIds.has(student.id);
      return /* @__PURE__ */ React.createElement("tr", { key: idx, className: `hover:bg-slate-50 transition-colors ${isGraded ? "bg-green-50/30" : ""}` }, /* @__PURE__ */ React.createElement("td", { className: "p-4 font-bold text-indigo-900 flex items-center gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement("div", { className: "w-8 h-8 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center text-xs" }, student.studentNickname.charAt(0).toUpperCase()), isGraded && /* @__PURE__ */ React.createElement("div", { className: "absolute -bottom-1 -right-1 bg-green-700 text-white rounded-full p-0.5 border border-white shadow-sm" }, /* @__PURE__ */ React.createElement(CheckCircle2, { size: 8 }))), student.studentNickname, isGraded && /* @__PURE__ */ React.createElement("span", { className: "text-[10px] font-bold text-green-700 bg-green-100 px-1.5 py-0.5 rounded ml-2 uppercase tracking-wider" }, t("dashboard.table.graded")), student.probeHistory && Object.keys(student.probeHistory).length > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-[10px] font-bold text-amber-700 bg-amber-50 px-1.5 py-0.5 rounded ml-1 border border-amber-200", title: Object.values(student.probeHistory).flat().length + " probes" }, "\u{1F4CA}"), student.surveyResponses && student.surveyResponses.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-[10px] font-bold text-purple-700 bg-purple-50 px-1.5 py-0.5 rounded ml-1 border border-purple-200", title: student.surveyResponses.length + " surveys" }, "\u{1F4DD}"), student.sessionCounter > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-[10px] font-bold text-cyan-700 bg-cyan-50 px-1.5 py-0.5 rounded ml-1 border border-cyan-200", title: student.sessionCounter + " sessions" }, "\u{1F504}")), /* @__PURE__ */ React.createElement("td", { className: "p-4 text-slate-500 font-mono text-xs" }, new Date(student.timestamp).toLocaleDateString(), " ", /* @__PURE__ */ React.createElement("span", { className: "hidden sm:inline" }, new Date(student.timestamp).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }))), /* @__PURE__ */ React.createElement("td", { className: "p-4" }, /* @__PURE__ */ React.createElement("span", { className: "bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full font-bold border border-green-200" }, calculateScore(student.history))), /* @__PURE__ */ React.createElement("td", { className: "p-4" }, level !== "N/A" ? /* @__PURE__ */ React.createElement("span", { className: "bg-purple-100 text-purple-800 text-xs px-2 py-1 rounded-full font-bold border border-purple-200 flex items-center gap-1 w-fit" }, /* @__PURE__ */ React.createElement(MapIcon, { size: 10 }), " Lvl ", level) : /* @__PURE__ */ React.createElement("span", { className: "text-slate-500 text-xs" }, "-")), /* @__PURE__ */ React.createElement("td", { className: "p-4 text-right" }, /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: () => {
    ...
    }))))), activeTab === "insights" && /* @__PURE__ */ React.createElement("div", { className: "max-w-6xl mx-auto space-y-6 animate-in fade-in slide-in-from-right-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center bg-white p-4 rounded-xl shadow-sm border border-slate-200" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-lg text-slate-800" }, t("dashboard.insights.class_performance")), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500" }, t("dashboard.insights.generated_date"), " ", (/* @__PURE__ */ new Date()).toLocaleDateString())), /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-bold text-slate-500 uppercase tracking-wider mb-4" }, t("dashboard.insights.avg_score")), /* @__PURE__ */ React.createElement(
      SimpleDonutChart,
      {
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-bold text-slate-500 uppercase tracking-wider mb-4" }, t("dashboard.insights.quiz_completion")), /* @__PURE__ */ React.createElement(
      SimpleDonutChart,
      {
    ...
    ), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 mt-2 text-center" }, t("dashboard.insights.students_participating"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-center" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-bold text-slate-500 uppercase tracking-wider mb-2" }, t("dashboard.insights.avg_adv_level")), /* @__PURE__ */ React.createElement("div", { className: "text-5xl font-black text-purple-600 text-center mb-2" }, analytics.avgAdventureLevel.toFixed(1)), /* @__PURE__ */ React.createElement("div", { className: "w-full bg-slate-100 rounded-full h-2 overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { role: "progressbar", "aria-valuemin": "0", "aria-valuemax": "100", className: "bg-purple-500 h-full", style: { width: `${Math.min(100, analytics.avgAdventureLevel / 10 * 100)}%` } })), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 mt-2 text-center" }, t("dashboard.insights.adv_level_desc")))), /* @__PURE__ */ React.createElement("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-slate-200" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-bold text-slate-800 mb-4 flex items-center gap-2" }, /* @__PURE__ */ React.createElement(AlertCircle, { size: 20, className: "text-red-500" }), " ", t("dashboard.insights.misconceptions_title")), misconceptionChartData.length > 0 ? /* @__PURE__ */ React.createElement("div", { className: "flex flex-col md:flex-row gap-8 items-center" }, /* @__PURE__ */ React.createElement("div", { className: "flex-1 w-full" }, /* @__PURE__ */ React.createElement(SimpleBarChart, { data: misconceptionChartData, color: "red" })), /* @__PURE__ */ React.createElement("div", { className: "flex-1 w-full" }, /* @__PURE__ */ React.createElement("ul", { className: "space-y-3" }, analytics.misconceptions.map((m, i) => /* @__PURE__ */ React.createElement("li", { key: i, className: "text-sm bg-red-50 p-3 rounded-lg border border-red-100" }, /* @__PURE__ */ React.createElement("div", { className: "font-bold text-red-800 mb-1 flex justify-between" }, /* @__PURE__ */ React.createElement("span", null, "Question ", i + 1), /* @__PURE__ */ React.createElement("span", { className: "bg-white px-2 rounded text-red-600 border border-red-200" }, m.count, " ", t("dashboard.insights.misses"))), /* @__PURE__ */ React.createElement("p", { className: "text-slate-600 italic line-clamp-2" }, '"', m.question, '"')))))) : /* @__PURE__ */ React.createElement("div", { className: "text-center py-10 text-slate-500 italic" }, t("dashboard.insights.no_misconceptions"))), (() => {
        ...
        allProbes.length > 2 && React.createElement(
          ...
          (() => {
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                ...sorted.map((p, i) => {
                  ...
                  return React.createElement(
                    ...
                    React.createElement(
                      "div",
                      { className: "text-[8px] text-slate-500 mt-1 text-center", style: { width: barW + "px" } },
              ...
              React.createElement(
                "div",
                { className: "flex items-center gap-4 text-[10px] text-slate-500" },
    ...
    })()), activeTab === "behavior" && /* @__PURE__ */ React.createElement("div", { className: "max-w-6xl mx-auto space-y-6 animate-in fade-in slide-in-from-right-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white p-8 rounded-2xl shadow-sm border border-slate-200 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-5xl mb-4" }, "\u{1F50D}"), /* @__PURE__ */ React.createElement("h3", { className: "text-2xl font-black text-slate-800 mb-2" }, t("behavior_lens.hub.title") || "BehaviorLens"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-500 mb-6 max-w-md mx-auto" }, t("behavior_lens.hub.subtitle") || "Functional Behavior Assessment, ABC data collection, and Behavior Intervention Plan tools."), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
    ...
    ))), activeTab === "stems" && /* @__PURE__ */ React.createElement("div", { className: "max-w-6xl mx-auto space-y-6 animate-in fade-in slide-in-from-right-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-slate-200" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-black text-slate-800 flex items-center gap-2 mb-4" }, "\u{1F52C} STEM Station Activity"), (() => {
      ...
      if (stations.length === 0) {
        return /* @__PURE__ */ React.createElement("div", { className: "text-center py-8" }, /* @__PURE__ */ React.createElement("div", { className: "text-4xl mb-3" }, "\u{1F4CC}"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-slate-500" }, "No STEM Stations created yet."), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-500 mt-1" }, "Generate a lesson plan to get AI-recommended STEM tools."));
      }
  ...
  return /* @__PURE__ */ React.createElement("span", { key: toolId, className: "bg-white text-slate-600 text-[10px] font-medium px-2 py-1 rounded-lg border border-slate-200" }, "\u{1F9EA} ", meta ? meta.name : toolId);
    ...
    showClearConfirm && /* @__PURE__ */ React.createElement("div", { role: "button", tabIndex: 0, className: "fixed inset-0 z-[300] bg-black/50 flex items-center justify-center animate-in fade-in duration-200", onClick: () => setShowClearConfirm(false) }, /* @__PURE__ */ React.createElement("div", { role: "button", tabIndex: 0, onKeyDown: function(e) { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); e.target.click(); } },  className: "bg-white rounded-2xl shadow-2xl p-6 max-w-sm mx-4 animate-in zoom-in-95 duration-200", role: "dialog", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-red-100 p-3 rounded-full" }, /* @__PURE__ */ React.createElement(Trash2, { size: 24, className: "text-red-600" })), /* @__PURE__ */ React.createElement("h3", { className: "text-lg font-bold text-slate-800" }, t("dashboard.clear_all"))), /* @__PURE__ */ React.createElement("p", { className: "text-slate-600 mb-6" }, t("dashboard.clear_confirm")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-3" }, /* @__PURE__ */ React.createElement(
      "button",
      {
