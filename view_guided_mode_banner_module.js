...
function GuidedModeBanner({
  ...
  const _onTabKeyDown = (e) => {
    ...
    e.preventDefault();
    const target = e.key === "Home" ? _tabHowRef.current : e.key === "End" ? _tabExampleRef.current : document.activeElement === _tabHowRef.current ? _tabExampleRef.current : _tabHowRef.current;
    try {
  ...
  })()), showFullLesson && /* @__PURE__ */ React.createElement("div", { role: "presentation", onClick: () => setShowFullLesson(false), style: { position: "fixed", inset: 0, zIndex: 1e5, background: "rgba(2,6,23,0.82)", backdropFilter: "blur(6px)", WebkitBackdropFilter: "blur(6px)", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" } }, /* @__PURE__ */ React.createElement("div", { ref: _modalRef, tabIndex: -1, role: "dialog", "aria-modal": "true", "aria-labelledby": "guided-full-lesson-title", onClick: (e) => e.stopPropagation(), style: { background: "linear-gradient(150deg, #0f172a, #1e1b4b)", border: "1px solid rgba(99,102,241,0.3)", borderRadius: "20px", width: "100%", maxWidth: "760px", maxHeight: "88vh", display: "flex", flexDirection: "column", boxShadow: "0 25px 70px rgba(0,0,0,0.55)", outline: "none" } }, /* @__PURE__ */ React.createElement("div", { style: { flexShrink: 0, padding: "18px 22px", borderBottom: "1px solid rgba(99,102,241,0.22)", display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "12px" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { id: "guided-full-lesson-title", style: { fontSize: "16px", fontWeight: 800, color: "white", margin: 0 } }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "\u{1F4D6}"), " ", t("guided.full_lesson_title") || "The full worked lesson"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "11px", color: "#c7d2fe", marginTop: "3px", lineHeight: "1.5" } }, t("guided.full_lesson_sub") || "One consistent example \u2014 a photosynthesis passage \u2014 carried through every Guided step, end to end.")), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowFullLesson(false), "aria-label": t("common.close") || "Close", style: { flexShrink: 0, width: "32px", height: "32px", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.18)", background: "rgba(255,255,255,0.08)", color: "white", fontSize: "16px", cursor: "pointer", lineHeight: 1 } }, "\u2715")), /* @__PURE__ */ React.createElement("div", { tabIndex: 0, role: "region", "aria-label": t("guided.full_lesson_scroll") || "Worked lesson steps", style: { overflowY: "auto", padding: "16px 22px" } }, (GUIDED_STEPS || []).map((s, i) => {
