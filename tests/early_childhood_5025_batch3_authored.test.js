...
const deployedPack = JSON.parse(fs.readFileSync(path.join(root, 'prismflow-deploy', 'public', 'test_prep', 'early_childhood_5025_pack.json'), 'utf8'));
const standalone = JSON.parse(fs.readFileSync(path.join(root, 'test_prep', 'early_childhood_5025_items.json'), 'utf8'));
const deployedStandalone = JSON.parse(fs.readFileSync(path.join(root, 'prismflow-deploy', 'public', 'test_prep', 'early_childhood_5025_items.json'), 'utf8'));
