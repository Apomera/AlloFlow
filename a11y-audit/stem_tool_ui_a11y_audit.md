...
Generated: 2026-07-01T19:15:24.632Z
...
| --- | ---: |
| Total findings | 256 |
| High-confidence errors | 59 |
| Tool-level warnings | 180 |
| Review notices | 17 |
| Tools with any finding | 85 |
| Tools with high-confidence errors | 19 |
...
| --- | --- | ---: | ---: | --- | --- |
| error | `control-name` | 33 | 13 | a11yAuditor, autoRepair, base10, cyberDefense, dataPlot, dataStudio, economicsLab, fractionViz, fractions, graphCalc, learningLab, spaceColony | Add a specific aria-label/title or visible text to icon-only controls. |
| error | `field-name` | 26 | 8 | ecosystem, fractionViz, fractions, lifeSkills, musicSynth, numberline, plateTectonics, waterCycle | Pair each field with a label/aria-label that names what the value controls. |
| warning | `canvas-focus` | 34 | 26 | anatomy, areamodel, artStudio, beehive, brainAtlas, chemBalance, climateExplorer, codingPlayground, companionPlanting, epidemicSim, fractionViz, fractions | If a canvas supports interaction, make it keyboard-focusable and expose keyboard alternatives. |
| warning | `tiny-text` | 24 | 24 | areamodel, birdLab, brainAtlas, cell, chemBalance, circuit, codingPlayground, dataStudio, dissection, dnaLab, inequality, molecule | Avoid persistent 8px/9px instructional text; keep small labels at 10px+ with clear line height. |
| warning | `heading` | 19 | 19 | aquacultureLab, astronomy, bridgeLab, cellularLab, cephalopodLab, dinoLab, fisherLab, flightSim, funcGrapher, geoSandbox, geometryWorld, graphCalc | Start each tool with a semantic heading so screen-reader users can orient quickly. |
| warning | `canvas-name` | 22 | 18 | anatomy, areamodel, chemBalance, dissection, dnaLab, economicsLab, epidemicSim, fractionViz, fractions, graphCalc, musicSynth, plateTectonics | Give each canvas a tool-specific role and aria-label, not only the host fallback. |
| warning | `inline-contrast` | 78 | 15 | algebraCAS, appLab, atcTower, cellularLab, dataStudio, echoTrainer, fireEcology, kitchenLab, llmLiteracy, playlab, probability, skatelab | Adjust inline foreground/background colors to meet at least 4.5:1 contrast for body text. |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `a11yAuditor` Digital Accessibility Lab | coding | standard | 19 | 1 | 0 | 1 | 0 | 0 | control-name x1 |
...
| `anatomy` Human Anatomy Explorer | science | standard | 63 | 1 | 1 | 0 | 2 | 0 | canvas-focus x1, canvas-name x1 |
...
| `archStudio` Architecture Studio | explore | standard | 85 | 7 | 0 | 0 | 0 | 1 | metadata x1 |
...
| `autoRepair` Auto Repair Shop | life-skills | standard | 38 | 0 | 0 | 1 | 0 | 0 | control-name x1 |
| `bakingScience` Baking Lab | science | standard | 12 | 0 | 0 | 0 | 0 | 0 |  |
| `base10` Math Manipulatives | math | standard | 51 | 1 | 0 | 4 | 0 | 0 | control-name x4 |
| `beehive` Beehive Simulator | science | standard | 64 | 5 | 1 | 0 | 1 | 0 | canvas-focus x1 |
| `behaviorLab` Behavior Lab | science | standard | 24 | 5 | 0 | 0 | 0 | 0 |  |
| `bikeLab` BikeLab: Physics & Repair | life-skills | standard | 11 | 0 | 0 | 0 | 0 | 0 |  |
| `birdLab` BirdLab — I-Spy Ornithology | general | standard | 125 | 0 | 0 | 0 | 2 | 2 | horizontal-overflow-risk x1, metadata x1, svg-name x1, tiny-text x1 |
| `brainAtlas` Brain Atlas Explorer | science | standard | 30 | 8 | 1 | 0 | 2 | 0 | canvas-focus x1, tiny-text x1 |
...
| `cellularLab` Cellular Automaton Lab | math | standard | 18 | 1 | 0 | 0 | 4 | 0 | inline-contrast x3, heading x1 |
...
| `circuit` Circuit Builder | science | standard | 82 | 1 | 0 | 0 | 1 | 0 | tiny-text x1 |
| `climateExplorer` Climate Explorer | science | standard | 36 | 0 | 1 | 0 | 1 | 0 | canvas-focus x1 |
| `codingPlayground` codingPlayground | creative | standard | 58 | 8 | 1 | 0 | 2 | 1 | canvas-focus x1, metadata x1, tiny-text x1 |
...
| `cyberDefense` Cyber Defense Lab | tech | standard | 20 | 0 | 0 | 1 | 0 | 1 | control-name x1, metadata x1 |
| `dataPlot` Data Plotter | creative | standard | 31 | 10 | 0 | 2 | 0 | 0 | control-name x2 |
| `dataStudio` Data Studio | creative | standard | 31 | 10 | 0 | 5 | 7 | 0 | inline-contrast x6, control-name x5, tiny-text x1 |
...
| `economicsLab` Economics Lab | science | standard | 26 | 6 | 1 | 1 | 1 | 0 | canvas-name x1, control-name x1 |
| `ecosystem` Ecosystem Simulator | science | standard | 29 | 8 | 1 | 1 | 0 | 0 | field-name x1 |
| `epidemicSim` Epidemic Modeling Lab | Life Science | standard | 22 | 4 | 1 | 0 | 2 | 0 | canvas-focus x1, canvas-name x1 |
...
| `fractionViz` Fraction Lab | math | standard | 33 | 2 | 1 | 9 | 2 | 0 | control-name x7, field-name x2, canvas-focus x1, canvas-name x1 |
| `fractions` Fraction Lab | math | standard | 33 | 2 | 1 | 9 | 2 | 0 | control-name x7, field-name x2, canvas-focus x1, canvas-name x1 |
| `funcGrapher` Function Grapher | math | standard | 0 | 0 | 0 | 0 | 1 | 0 | heading x1 |
| `galaxy` Galaxy Explorer | science | standard | 27 | 2 | 1 | 0 | 0 | 0 |  |
...
| `graphCalc` graphCalc | math | standard | 26 | 7 | 1 | 1 | 2 | 0 | canvas-name x1, control-name x1, heading x1 |
...
| `learningLab` Learning Lab | life-skills | standard | 134 | 0 | 0 | 1 | 0 | 0 | control-name x1 |
| `lifeSkills` Life Skills Lab | Life Skills | standard | 15 | 5 | 0 | 2 | 0 | 0 | field-name x2 |
...
| `musicSynth` Music Synthesizer | creative | standard | 90 | 19 | 2 | 12 | 4 | 0 | field-name x12, canvas-focus x2, canvas-name x2 |
| `numberline` Number Line | math | standard | 15 | 5 | 1 | 3 | 1 | 0 | field-name x3, canvas-focus x1 |
| `nutritionLab` NutritionLab — Nutrition Science | general | standard | 15 | 0 | 0 | 0 | 0 | 1 | metadata x1 |
| `opticsLab` Optics Lab | science | standard | 41 | 0 | 0 | 0 | 0 | 0 |  |
...
| `plateTectonics` Plate Tectonics | science | standard | 22 | 5 | 6 | 1 | 8 | 1 | canvas-focus x4, canvas-name x4, field-name x1, horizontal-overflow-risk x1 |
| `playlab` PlayLab | science | standard | 169 | 5 | 1 | 0 | 14 | 1 | inline-contrast x14, horizontal-overflow-risk x1 |
...
| `renewablesLab` Renewables Lab | physics-chemistry | standard | 32 | 0 | 0 | 0 | 0 | 0 |  |
...
| `skatelab` SkateLab | science | standard | 57 | 10 | 1 | 0 | 3 | 1 | canvas-focus x1, canvas-name x1, horizontal-overflow-risk x1, inline-contrast x1 |
| `solarSystem` Solar System Explorer | science | standard | 13 | 1 | 1 | 0 | 1 | 0 | tiny-text x1 |
| `spaceColony` Kepler Colony | strategy | standard | 13 | 7 | 0 | 1 | 0 | 0 | control-name x1 |
...
| `throwlab` ThrowLab | science | standard | 52 | 8 | 1 | 0 | 16 | 1 | inline-contrast x15, horizontal-overflow-risk x1, tiny-text x1 |
...
| `waterCycle` Water Cycle | science | standard | 17 | 4 | 1 | 3 | 4 | 0 | field-name x3, canvas-focus x1, canvas-name x1, inline-contrast x1, tiny-text x1 |
...
| `worldBuilder` WriteCraft | creative | standard | 14 | 10 | 0 | 1 | 1 | 0 | control-name x1, tiny-text x1 |
