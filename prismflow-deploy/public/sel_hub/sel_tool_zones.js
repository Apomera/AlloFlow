...
(function() {
  ...
  (function() {
    if (document.getElementById('allo-live-zones')) return;
    var liveRegion = document.createElement('div');
    liveRegion.id = 'allo-live-zones';
    ...
    render: function(ctx) {
      ...
      var tabBar = h('div', {
        ...
        h('button', { 'aria-label': '\uD83C\uDFC5 ' + Object.keys(earnedBadges).length + '/' + BADGES.length,
          ...
          title: 'View badges',
          style: { padding: '7px 10px', borderRadius: 8, border: 'none', cursor: 'pointer', background: showBadgesPanel ? '#7c3aed33' : 'transparent', color: '#9ca3af', fontSize: 14, flexShrink: 0 }
      ...
      if (activeTab === 'checkin') {
        checkinContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
          ...
          h('p', { style: { textAlign: 'center', color: '#cbd5e1', fontSize: 12, marginBottom: 24 } },
              ...
              return h('button', {
                ...
                h('div', { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 } },
                  ...
                  h('div', null,
                    ...
                    h('div', { style: { fontSize: 11, color: '#cbd5e1' } }, zone.feeling)
                  )
                ),
                ...
                h('div', { style: { marginTop: 8, display: 'flex', flexWrap: 'wrap', gap: 4 } },
                  zone.bodyAreas.slice(0, 2).map(function(area) {
                    return h('span', { key: area, style: { fontSize: 11, padding: '1px 6px', borderRadius: 6, background: '#334155', color: '#cbd5e1' } }, area);
                  })
                )
              );
            })
          ...
          selectedZone && h('div', { style: { marginTop: 20 } },
            ...
            h('div', { style: { marginBottom: 16 } },
              ...
              h('div', { style: { display: 'flex', alignItems: 'center', gap: 12 } },
                h('span', { style: { fontSize: 11, color: '#9ca3af', minWidth: 24 } }, '1'),
                h('input', {
                ...
                h('span', { style: { fontSize: 11, color: '#9ca3af', minWidth: 24, textAlign: 'right' } }, '10'),
                h('span', {
                  style: {
            ...
            selectedZone !== 'green' && h('button', { 'aria-label': 'Need help calming down? Try a breathing exercise',
              ...
              style: { marginTop: 8, width: '100%', padding: '10px 0', borderRadius: 10, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', fontWeight: 600, fontSize: 12, cursor: 'pointer' }
          ...
          ZONES.map(function(zone) {
            ...
            return h('div', {
              ...
              h('div', { style: { display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 } },
                h('span', { style: { fontSize: 32 } }, zone.emoji),
                h('div', { style: { flex: 1 } },
                  h('h4', { style: { margin: 0, color: zone.color, fontSize: 16 } }, zone.label),
                  h('p', { style: { margin: 0, fontSize: 12, color: '#cbd5e1' } }, zone.feeling)
                ),
      ...
      if (activeTab === 'breathe') {
        // Pattern selection
        if (!breathingPattern) {
          breatheContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
            h('h3', { style: { textAlign: 'center', marginBottom: 8, color: '#f1f5f9', fontSize: 18 } },
              ...
              BREATHING_PATTERNS.map(function(pat) {
                ...
                return h('button', { 'aria-label': pat.name,
                  ...
                  h('div', { style: { flex: 1 } },
                    ...
                    h('div', { style: { fontSize: 12, color: '#cbd5e1', marginBottom: 6, lineHeight: 1.4 } }, pat.desc),
                    h('div', { style: { display: 'flex', gap: 6, flexWrap: 'wrap' } },
                      h('span', { style: { fontSize: 10, padding: '2px 8px', borderRadius: 6, background: '#334155', color: '#cbd5e1' } }, pat.cycles + ' cycles'),
                      h('span', { style: { fontSize: 10, padding: '2px 8px', borderRadius: 6, background: '#334155', color: '#cbd5e1' } }, '~' + totalTime + 's'),
            ...
            // Completed count
            breathingComplete > 0 && h('p', { style: { textAlign: 'center', color: '#9ca3af', fontSize: 12, marginTop: 16 } },
          ...
          if (currentPattern) {
            ...
            breatheContent = h('div', { style: { padding: 20, maxWidth: 500, margin: '0 auto', textAlign: 'center' } },
              ...
              h('p', { style: { color: '#9ca3af', fontSize: 12, marginBottom: 20 } },
              ...
              isComplete && h('div', { style: { padding: 30 } },
                ...
                h('p', { style: { color: '#cbd5e1', fontSize: 13 } },
              ...
              // Progress bar
              h('div', { style: { height: 6, borderRadius: 3, background: '#1e293b', marginBottom: 20, overflow: 'hidden' } },
                h('div', { style: { height: '100%', width: progressPct + '%', background: isComplete ? '#22c55e' : '#7c3aed', borderRadius: 3, transition: 'width 0.5s' } })
              ),
              ...
              h('div', { style: { display: 'flex', gap: 10, justifyContent: 'center' } },
                ...
                h('button', { 'aria-label': 'Try Another',
                  ...
                  style: { padding: '12px 24px', borderRadius: 10, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', fontWeight: 600, fontSize: 14, cursor: 'pointer' }
      ...
      if (activeTab === 'body') {
        ...
        if (bodyScanActive) {
          ...
          bodyContent = h('div', { style: { padding: 20, maxWidth: 500, margin: '0 auto', textAlign: 'center' } },
            ...
            h('p', { style: { color: '#9ca3af', fontSize: 12, marginBottom: 8 } },
            ...
            // Current area
            h('div', { style: { fontSize: 48, marginBottom: 8 } }, scanArea.emoji),
            h('h4', { style: { color: '#f1f5f9', fontSize: 20, marginBottom: 12 } }, scanArea.label),
            h('p', { style: { color: '#cbd5e1', fontSize: 13, marginBottom: 20 } },
            ...
            scanSelection.sensation && scanSelection.sensation !== 'nothing' && h('div', { style: { marginBottom: 20 } },
              h('p', { style: { fontSize: 12, color: '#cbd5e1', marginBottom: 8 } },
            ...
            h('div', { style: { display: 'flex', gap: 10, justifyContent: 'center' } },
              bodyScanStep > 0 && h('button', { 'aria-label': 'Back',
                ...
                style: { padding: '10px 20px', borderRadius: 8, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', fontWeight: 600, cursor: 'pointer' }
              }, '\u2190 Back'),
      ...
      if (activeTab === 'scenarios') {
        ...
        scenarioContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
          ...
          h('div', { style: { display: 'flex', justifyContent: 'center', gap: 16, marginBottom: 16 } },
            h('span', { style: { fontSize: 12, color: '#cbd5e1' } }, 'Score: ' + scenarioScore.correct + '/' + scenarioScore.total),
            h('span', { style: { fontSize: 12, color: scenarioStreak >= 3 ? '#f59e0b' : '#64748b' } },
              '\uD83D\uDD25 Streak: ' + scenarioStreak + (scenarioBestStreak > 0 ? ' (best: ' + scenarioBestStreak + ')' : '')
            )
          ),

          // Scenario card
          h('div', { style: { padding: 24, borderRadius: 14, background: '#1e293b', border: '1px solid #334155', marginBottom: 20, textAlign: 'center' } },
            h('p', { style: { fontSize: 11, color: '#9ca3af', marginBottom: 8, textTransform: 'uppercase', letterSpacing: '0.05em' } },
            ...
            band === 'elementary' && callTTS && h('button', { 'aria-label': 'Read Aloud',
              ...
              style: { marginTop: 10, padding: '6px 14px', borderRadius: 8, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', cursor: 'pointer', fontSize: 12 }
            }, '\uD83D\uDD0A Read Aloud')
          ),
          ...
          scenarioFeedback && h('div', {
            ...
            scenarioFeedback !== 'correct' && scenarioAnswer && h('p', { style: { fontSize: 12, color: '#cbd5e1', marginBottom: 8 } },
      ...
      if (activeTab === 'toolbox') {
        ...
        toolboxContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
          h('h3', { style: { textAlign: 'center', marginBottom: 8, color: '#f1f5f9', fontSize: 18 } },
            '\uD83E\uDDF0 My Toolbox'
          ),
          h('p', { style: { textAlign: 'center', color: '#cbd5e1', fontSize: 12, marginBottom: 20 } },
          ...
          h('div', { style: { marginBottom: 24 } },
            h('h4', { style: { fontSize: 13, color: '#cbd5e1', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 12 } }, 'Quick Tools'),
            h('div', { style: { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10 } },
              ...
              h('button', { 'aria-label': 'Breathing',
                ...
                h('div', { style: { fontSize: 12, fontWeight: 700, color: '#3b82f6' } }, 'Breathing'),
                h('div', { style: { fontSize: 10, color: '#9ca3af' } }, 'Guided exercises')
              ),
              // Body scan shortcut
              h('button', { 'aria-label': 'Body Scan',
                ...
                h('div', { style: { fontSize: 10, color: '#9ca3af' } }, 'Check your body')
              )
            )
          ),

          // 5-4-3-2-1 Grounding Exercise
          h('div', { style: { marginBottom: 24, padding: 20, borderRadius: 14, border: '1px solid #334155', background: '#1e293b' } },
            h('div', { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 } },
              h('h4', { style: { margin: 0, fontSize: 14, color: '#f1f5f9' } }, '\u270B 5-4-3-2-1 Grounding'),
              groundingComplete > 0 && h('span', { style: { fontSize: 10, color: '#9ca3af' } }, 'Completed ' + groundingComplete + 'x')
            ),
            h('p', { style: { fontSize: 12, color: '#cbd5e1', marginBottom: 16 } },
              ...
              : h('div', null,
                  ...
                  (function() {
                    ...
                    return h('div', { style: { textAlign: 'center' } },
                      ...
                      h('p', { style: { fontSize: 12, color: '#cbd5e1', marginBottom: 16 } }, step.prompt),
                      // Input fields
                      ...
                      h('div', { style: { display: 'flex', gap: 10, justifyContent: 'center', marginTop: 12 } },
                        groundingStep > 0 && h('button', { 'aria-label': 'Back',
                          ...
                          style: { padding: '8px 16px', borderRadius: 8, border: '1px solid #334155', background: 'transparent', color: '#cbd5e1', cursor: 'pointer' }
                        }, '\u2190 Back'),
          ...
          // Saved strategies
          h('h4', { style: { fontSize: 13, color: '#cbd5e1', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 12 } },
            'Saved Strategies (' + myToolbox.length + ')'
          ),
          myToolbox.length === 0
            ? h('div', { style: { textAlign: 'center', padding: 32, color: '#9ca3af', background: '#1e293b', borderRadius: 14 } },
            ...
            : h('div', { style: { display: 'flex', flexDirection: 'column', gap: 8 } },
                ...
                Object.keys(typeColors).map(function(type) {
                  ...
                  return h('div', { key: type },
                    h('div', { style: { display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6, marginTop: 8 } },
                      h('span', null, typeIcons[type] || ''),
                      h('span', { style: { fontSize: 11, fontWeight: 700, color: typeColors[type], textTransform: 'uppercase', letterSpacing: '0.05em' } }, type)
                    ),
                    inType.map(function(s, i) {
                      return h('div', {
                        ...
                        h('button', { 'aria-label': 'My Check-In History',
                          ...
                          style: { padding: '3px 8px', borderRadius: 6, border: 'none', background: '#334155', color: '#cbd5e1', cursor: 'pointer', fontSize: 10, flexShrink: 0 }
                        }, '\u2715')
                      );
                    })
                  );
          ...
          log.length === 0
            ...
            : h('div', { style: { display: 'flex', flexDirection: 'column', gap: 16 } },
                ...
                h('div', { style: { padding: 16, borderRadius: 14, background: '#1e293b', border: '1px solid #334155' } },
                  h('h4', { style: { margin: '0 0 12px 0', fontSize: 13, color: '#cbd5e1' } }, 'Zone Distribution'),
                  h('div', { style: { display: 'flex', gap: 8, justifyContent: 'center', marginBottom: 12 } },
                    ZONES.map(function(zone) {
                      ...
                      return h('div', {
                        ...
                        h('div', { style: { fontSize: 10, color: '#9ca3af' } }, pct + '%')
                      );
                    })
                  ),
                  h('p', { style: { textAlign: 'center', fontSize: 11, color: '#9ca3af', margin: 0 } },
                ...
                log.length >= 3 && h('div', { style: { padding: 16, borderRadius: 14, background: '#1e293b', border: '1px solid #334155' } },
                  h('h4', { style: { margin: '0 0 12px 0', fontSize: 13, color: '#cbd5e1' } }, 'Intensity Trend (recent)'),
                  ...
                  h('div', { style: { display: 'flex', justifyContent: 'space-between', marginTop: 4 } },
                    h('span', { style: { fontSize: 11, color: '#9ca3af' } }, 'Older'),
                ...
                log.length >= 2 && h('div', { style: { padding: 16, borderRadius: 14, background: '#1e293b', border: '1px solid #334155' } },
                  h('h4', { style: { margin: '0 0 12px 0', fontSize: 13, color: '#cbd5e1' } }, 'Zone Flow'),
                  ...
                  h('p', { style: { textAlign: 'center', fontSize: 10, color: '#9ca3af', marginTop: 8 } },
                    band === 'elementary' ? 'This shows how your zones changed over time!' : 'Your emotional trajectory across recent check-ins'
                  )
                ),

                // Log entries (newest first)
                h('h4', { style: { fontSize: 13, color: '#cbd5e1', textTransform: 'uppercase', letterSpacing: '0.05em', margin: '8px 0' } }, 'Log Entries'),
                  ...
                  return h('div', {
                    ...
                    h('div', { style: { flex: 1 } },
                      h('div', { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4, flexWrap: 'wrap' } },
                        ...
                        h('span', { style: { fontSize: 10, color: '#9ca3af' } }, time.toLocaleDateString() + ' ' + time.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }))
                      ),
