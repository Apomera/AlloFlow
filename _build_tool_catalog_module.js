...
const DEPLOY_OUT = path.join(ROOT, 'desktop/web-app', 'public', 'tool_catalog_module.js');
...
try {
    ...
    console.warn('[ToolCatalog] Could not sync to desktop/web-app/public/:', e.message);
}
