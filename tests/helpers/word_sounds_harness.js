...
export const ACTIVITIES = ['rhyming', 'blending', 'segmentation', 'isolation', 'manipulation', 'syllable_blending', 'syllable_counting', 'sound_sort', 'word_families', 'orthography', 'letter_tracing', 'spelling_bee', 'mapping', 'counting', 'decoding', 'read_sentence', 'read_passage', 'sentence_match'];
