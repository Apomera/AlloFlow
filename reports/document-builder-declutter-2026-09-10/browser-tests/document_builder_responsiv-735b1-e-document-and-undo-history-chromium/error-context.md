...
- Name: document_builder_responsive_keyboard.spec.ts >> desktop settings, ribbon, and Focus mode preserve the live document and undo history
- Location: tests\e2e\document_builder_responsive_keyboard.spec.ts:243:5
...
Call log:
  - waiting for getByRole('button', { name: 'Undo (Ctrl+Z)', exact: true })

```

```
Tearing down "context" exceeded the test timeout of 35000ms.
```
  ...
  - dialog "Document Builder" [ref=e3]:
    - banner [ref=e4]:
      ...
      - generic [ref=e8]:
        ...
        - button "Focus mode" [active] [ref=e10] [cursor=pointer]:
          - generic [ref=e11]: ↗
          - text: Focus mode
        - group [ref=e12]:
    ...
    - generic [ref=e18]:
      ...
      - generic [ref=e21]:
        ...
        - tablist "Document Builder ribbon" [ref=e33]:
          - tab "Home" [ref=e34] [cursor=pointer]
          ...
          - tab "🤖 Expert Workbench" [selected] [ref=e39] [cursor=pointer]
          - button "Expand ribbon" [ref=e40] [cursor=pointer]
      - iframe [ref=e43]:
        - main [ref=f1e2]:
          - heading "Classroom handout" [level=1] [ref=f1e3]
          - paragraph [ref=f1e4]: Original lesson text. Preserved edit.
          - button "Run lesson action" [ref=f1e5]: Run
      - generic "Document status bar" [ref=e44]:
        - generic [ref=e45]:
          - generic [ref=e46]: Editing enabled
          - status [ref=e47]: Saved on this device · 06:22 PM
          - 'button "Track: Off · 0 changes" [ref=e49] [cursor=pointer]'
          - 'button "Words: 8" [ref=e51] [cursor=pointer]'
          - generic [ref=e52]: Page 1 of 2
          - group [ref=e53]:
            - generic "Details & shortcuts" [ref=e54] [cursor=pointer]
        - generic [ref=e55]:
          - combobox "Preview zoom mode" [ref=e56]:
            - option "Fit width" [selected]
            - option "Fit page"
            - option "Custom zoom"
          - generic "Editor zoom controls" [ref=e57]:
            - button "Zoom out" [ref=e58] [cursor=pointer]: −
            - slider "Editor zoom" [ref=e59]: "165"
            - button "Zoom in" [ref=e60] [cursor=pointer]: +
            - button "Reset editor zoom to 100 percent" [ref=e61] [cursor=pointer]: 165%
```