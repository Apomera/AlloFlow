...
function LearningHubModal(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-[60] bg-black/40 flex items-center justify-center p-4", onClick: () => setShowLearningHub(false), role: "button", tabIndex: 0, onKeyDown: (e) => {
    ...
    setShowLearningHub(false);
    setShowMindMap(true);
  }, className: "flex flex-col items-center gap-3 p-5 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all text-center" }, /* @__PURE__ */ React.createElement("span", { className: "text-4xl" }, "\u{1F9E9}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-amber-800" }, t("learning_hub.mindmap_title") || "Mind Map"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-amber-700 mt-1" }, t("learning_hub.mindmap_desc") || "Build a knowledge graph that grows with you \u2014 concepts, connections, mnemonics"))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    setShowLearningHub(false);
