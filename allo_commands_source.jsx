...
const CMD_GROUP = {
  ...
  filter_glossary:'create', generate_anchor_chart:'create', generate_brainstorm:'create', generate_concept_sort:'create', generate_faq:'create', generate_note_taking:'create', generate_source_text:'create',
