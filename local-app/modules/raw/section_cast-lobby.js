...
// Module: modules/cast
// Source lines: 16621–23673 (7053 lines)
// Hash: 716113c4a74c402d
...
Return ONLY the hint text as a single paragraph (no JSON, no markdown). Keep it under 2 sentences. Be encouraging.`;
  ...
  React.useEffect(() => {
    ...
    (function() {
      ...
      s.src = url;
      s.crossOrigin = 'anonymous';
      s.onload = () => { _upgradeAIBackend(); console.log('[CDN] AIBackend loaded + shims upgraded'); };
      s.onerror = () => {
        ...
        fb.onload = () => { _upgradeAIBackend(); console.log('[CDN-FALLBACK] AIBackend loaded + shims upgraded'); };
