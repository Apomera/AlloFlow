...
const WIDGETS = [
  ...
  // B17
  { file: 'stem_lab/stem_tool_lumen.js', toolId: 'lumen', data: { lumen: { mode: 'data', observations: [{ x: 1, y: 50, phase: 'baseline' }, { x: 2, y: 52, phase: 'baseline' }, { x: 3, y: 55, phase: 'baseline' }], showInquiry: true } } }, // mode:'data' — the workspace-modes home screen would otherwise render; showInquiry: the Evidence-Inquiry sandbox is gated behind a default-closed disclosure (needs >=3 obs + the toggle)
