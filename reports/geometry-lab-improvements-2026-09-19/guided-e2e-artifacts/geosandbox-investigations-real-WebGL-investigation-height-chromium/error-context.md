...
- Name: geosandbox-investigations.spec.ts >> real WebGL investigation: height
...
- tabpanel "📐 Stretch mode":
  ...
  - tabpanel "Learn":
    ...
    - strong: 16.00 u³
    - paragraph: "|u · (v × w)|"
    - paragraph: Surface Area 40.00 u²
    - region "Prism measurement explanations":
      - paragraph: "Volume = base area × perpendicular height: 4 × 4 = 16 u³"
    ...
    - region "Guided experiments":
      ...
      - strong: Double only the height
      - paragraph: 1. Predict → 2. Change → 3. Compare and explain
      - paragraph: Predict the changes in volume and surface area when only the perpendicular height doubles.
      ...
      - status: Did volume and surface area grow by the same factor? Use the before-and-after measurements as evidence.
    - group:
        ...
        - 'table "Object #1 · Investigation prism"':
          ...
          - rowgroup:
            - row "Volume 8 u³ 16 u³":
              ...
              - cell "8 u³"
              - cell "16 u³"
            - row "Surface area 24 u² 40 u²":
              - rowheader "Surface area"
              - cell "24 u²"
              - cell "40 u²"
        - paragraph: "Volume: +8 u³ · ×2"
        - paragraph: "Surface area: +16 u² · ×1.67"
      - text: Investigation title
      - textbox "Investigation title": Double only the height
      ...
      - textbox "What did you change?": Doubled the perpendicular height while keeping the base and sideways offset fixed.
    ...
    - text: Edge 2.00 → 4.00 (×k¹ = ×2.00) Surface 40.00 → 160.00 (×k² = ×4.00) Volume 16.00 → 128.00 (×k³ = ×8.00)
