> **Superseded historical assessment.** See the [current VPAT](../../../VPAT-2.5-WCAG-AlloFlow.md) and [current audit](../../../a11y-audit/WCAG-2.2-current-audit.md).
