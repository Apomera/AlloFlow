...
const WORD_SOUNDS_STRINGS = {
    ...
    'word_sounds.syllable_counting_prompt': 'How many syllables do you hear? Clap for each one',
    'word_sounds.decoding_prompt': 'Read the word, then tap its picture!',
    'word_sounds.decoding_drag_prompt': 'Drag the picture onto the word, or tap the picture',
    ...
    'word_sounds.band_hard': 'Hard',
    'word_sounds.band_compare_caveat': 'Compare like with like: a shift in word difficulty (not a skill change) can move the overall number.',
    ...
    'word_sounds.level_up_trickier': '🌟 LEVEL {{level}}! Words are getting trickier! 🌟',
    'word_sounds.level_up_star': '🚀 LEVEL {{level}}! You\'re a phonics star! 🌟',
    'word_sounds.level_up_challenge': '🏆 LEVEL {{level}}! Challenge mode activated! 🌟',
    'word_sounds.anchor_compact_letter': 'Anchor: letter ',
    'word_sounds.anchor_compact_says': ' says ',
    'word_sounds.anchor_compact_like': ', like ',
    'word_sounds.anchor_like': 'like ',
    'word_sounds.anchor_hear_sound': 'Hear the sound ',
    'word_sounds.anchor_expand': 'Expand anchor',
    'word_sounds.anchor_hide': 'Hide anchor',
    'word_sounds.anchor_card_for_sound': 'Anchor card for the sound ',
    'word_sounds.anchor_card_spelled': ', spelled ',
    'word_sounds.anchor_card_like_word': ', like the word ',
    'word_sounds.anchor_reviewing': '. Reviewing this letter sound.',
    'word_sounds.anchor_badge': 'Anchor',
    'word_sounds.anchor_switch_compact': 'Switch to compact anchor view',
    'word_sounds.anchor_compact_btn': 'Compact',
    'word_sounds.anchor_hide_btn': 'Hide',
    'word_sounds.anchor_key_word': 'Key word:',
    'word_sounds.anchor_in_the_word': ' in the word ',
    'word_sounds.anchor_highlighted': 'highlighted: ',
    'word_sounds.anchor_other_spellings': 'Other spellings:',
    'word_sounds.anchor_teacher_note': 'Teacher note:',
    'word_sounds.option_label': 'Option',
    'word_sounds.sr_listen_instruction': 'Listen to instruction',
    'word_sounds.sr_hear': 'Hear ',
    'word_sounds.sr_tap_count_syllables': 'Tap to count syllables',
    'word_sounds.drag_letters_hint': 'Drag letters to spell the word, or click to hear them!',
    'word_sounds.sr_tracing_canvas': 'Letter tracing canvas. Use mouse or touch to trace the letter shape. Use the surrounding controls to skip, get a hint, or hear the letter sound.',
    'word_sounds.hear_real_recording': 'Hear a real recording',
    'word_sounds.real_recording': 'Real recording',
    'word_sounds.sr_option': 'option',
    'word_sounds.activity_decoding': 'Read & Match',
    'word_sounds.decoding_desc': 'Read the word and tap its picture',
    'word_sounds.activity_read_sentence': 'Finish the Sentence',
    'word_sounds.read_sentence_desc': 'Read a sentence and pick its missing word',
    'word_sounds.read_sentence_prompt': 'Read the sentence. Which word finishes it?',
    ...
    'word_sounds.read_sentence_word_hint': 'Your word:',
        ...
        'word_sounds.words_prepared_count': '{{count}} words prepared',
        'word_sounds.preparation_options': 'Preparation and taught spellings',
        'word_sounds.prepare_scope': 'Activities to prepare',
        'word_sounds.prepare_all': 'All activities (allows switching)',
        'word_sounds.prepare_lesson': 'Selected lesson only (less audio to prepare)',
        'word_sounds.taught_spellings_help': 'Optional spelling coverage check. Enter taught letters and adjacent letter groups, separated by commas; list known whole words separately. Review sound values and irregular spellings with the learner.',
        'word_sounds.taught_patterns': 'Taught letters and letter groups',
        'word_sounds.known_words': 'Known whole words',
        'word_sounds.pattern_review_words': 'Words to review against taught spellings: {{words}}',
        'word_sounds.none': 'None',
        'word_sounds.matching_practice': 'Match your word to a choice.',
        'word_sounds.picture_cloze_practice': 'Use the picture to choose a word.',
        'word_sounds.coverage_review': 'Check taught spellings: {{words}}',
    ...
    'word_sounds.activity_sentence_match': 'Picture the Sentence',
    'word_sounds.sentence_match_desc': 'Read a sentence and place its pictures in order',
    'word_sounds.sentence_match_prompt': 'Read the sentence. Match the pictures to it.',
    ...
    'word_sounds.edit_spelling_word': 'Edit Spelling Word',
    'word_sounds.for_word': 'for',
    'word_sounds.editing_word_family': 'Editing Word Family',
    'word_sounds.family_members': 'Family Members',
    'word_sounds.distractors': 'Distractors',
    'word_sounds.hear_all_words': 'Hear All Words',
    'word_sounds.practice_missed_words': 'Practice Missed Words',
    'word_sounds.sound_n': 'Sound {{n}}',
    'word_sounds.option_n': 'Option {{n}}',
    'word_sounds.level_n': '⭐ Level {{n}}',
    'word_sounds.items_done_of': '{{done}}/{{goal}} items',
    'word_sounds.word_n_of_m': 'Word {{n}} of {{m}}',
    'word_sounds.correct_of_total': '{{correct}} correct / {{total}} total',
    'word_sounds.review_panel_loading': '📋 Review Panel (loading...)',
    'word_sounds.building_swap_task': 'Building your Sound Swap task…',
    'word_sounds.loading_task': 'Loading task…',
    'word_sounds.listen_again': 'Listen Again',
    'word_sounds.building_syllable_activity': 'Building syllable activity…',
    'word_sounds.listen_to_syllables': 'Listen to the syllables',
    'word_sounds.play_syllables': '▶ Play Syllables',
    'word_sounds.speak_or_tap_mic': 'Speak your answer or tap the mic below',
    'word_sounds.getting_ready': 'Getting ready…',
    'word_sounds.tap_each_syllable': 'Tap once for each syllable you hear',
    'word_sounds.reset': 'Reset',
    'word_sounds.submit': 'Submit ✓',
    'word_sounds.add_word': '+ Add Word',
    'word_sounds.add_distractor': '+ Add Distractor',
    'word_sounds.difficulty_auto_paren': '(Auto)',
    'word_sounds.mystery_word': 'Mystery Word',
    'word_sounds.drop': 'Drop',
    'word_sounds.edit_sounds': 'Edit Sounds',
    'word_sounds.check_answer': 'Check Answer ✓',
    'word_sounds.bonus': 'Bonus!',
    'word_sounds.skip_lowercase': 'Skip lowercase →',
    'word_sounds.word_recap': 'Word Recap',
    'word_sounds.processing': 'Processing...',
    'word_sounds.active': 'Active',
    'word_sounds.resume_activity': 'Resume Activity',
    'word_sounds.studio_title': '🔤 Word Sounds Studio',
    'word_sounds.review_words': '✏️ Review Words',
    // Direct Instruction lesson script (printable teacher script). The script
    // BODY is generated in English only, by design; this chrome is still
    // localized because the pack language and the teacher's UI language are
    // independent, so a Spanish-UI teacher can be running an English word set.
    'word_sounds.di_script_button': '📄 Lesson script',
    'word_sounds.di_script_open': 'Open the lesson script',
    'word_sounds.di_script_title': 'Lesson script',
    'word_sounds.di_script_print': 'Print or save as PDF',
    'word_sounds.di_heading_objective': 'Objective',
    'word_sounds.di_heading_materials': 'Materials',
    'word_sounds.di_heading_word_list': 'Word list',
    'word_sounds.di_heading_caveats': 'Before you teach this',
    'word_sounds.di_timing': 'About {{minutes}} minutes. Mastery: {{mastery}} consecutive correct.',
    'word_sounds.di_minutes': '{{n}} min',
    'word_sounds.di_col_word': 'Word',
    'word_sounds.di_col_sounds': 'Sounds',
    'word_sounds.di_col_count': 'Count',
    'word_sounds.di_col_shape': 'Shape',
    'word_sounds.di_col_syllable_type': 'Syllable type',
    'word_sounds.di_estimated': '(estimated)',
    'word_sounds.help': 'Help',
    'word_sounds.difficulty_auto_emoji': '🤖 Auto',
    'word_sounds.sequential': '📝 Sequential',
    'word_sounds.difficulty_easy_emoji': '🟢 Easy',
    'word_sounds.difficulty_medium_emoji': '🟡 Medium',
    'word_sounds.difficulty_hard_emoji': '🔴 Hard',
    'word_sounds.garden_lesson_ready': 'Word Garden phonics lesson ready!',
    'word_sounds.use_garden_words': '📖 Use Garden Words',
    'word_sounds.home_practice_mode': 'Home Practice Mode',
    'word_sounds.home_practice': '🏠 Home Practice',
    'word_sounds.probe_mode_badge': '📊 PROBE MODE',
    'word_sounds.retry': 'Retry',
    'word_sounds.parent_summary_title': 'Home Practice Summary ({{date}})',
    'word_sounds.parent_summary_activity': 'Activity: {{activity}}',
    'word_sounds.parent_summary_score': 'Score: {{correct}}/{{total}} ({{pct}}%)',
    'word_sounds.parent_summary_words': 'Words practiced:',
    'word_sounds.parent_summary_copied': 'Summary copied! Paste it into a message for the teacher.',
    'word_sounds.parent_summary_copy_failed': 'Copy failed, try long-pressing the summary.',
    'word_sounds.parent_copy_button': 'Copy Summary for Teacher',
    'word_sounds.sr_try_again': 'Try again',
    'word_sounds.audio_ask_teacher_resend': 'Ask teacher to resend',
    'word_sounds.audio_blocked_message': 'Your browser stopped the sound from playing. Your place is saved; tap Try sound again to continue.',
    'word_sounds.audio_check': 'Audio check',
    'word_sounds.audio_checking_message': 'Checking {{ready}} of {{total}} prepared audio clips before the activity starts.',
    'word_sounds.audio_checking_title': 'Checking audio playback...',
    'word_sounds.audio_damaged_message': '{{failed}} of {{total}} required clips appear to be damaged. Ask your teacher to review and resend the audio.',
    'word_sounds.audio_damaged_requested_message': '{{failed}} of {{total}} required clips appear to be damaged. Your teacher has been asked to resend this activity.',
    'word_sounds.audio_damaged_title': 'Some audio cannot be played',
    'word_sounds.audio_enable_title': 'Tap to enable audio',
    'word_sounds.audio_manage_for_student': 'Manage Word Sounds audio for {{student}}',
    'word_sounds.audio_missing_message': '{{missing}} of {{total}} required audio clips did not arrive. Ask your teacher to prepare the missing audio and resend this activity.',
    'word_sounds.audio_missing_requested_message': '{{missing}} of {{total}} required audio clips did not arrive. Your teacher has been asked to resend this activity.',
    'word_sounds.audio_open_resource_missing_toast': 'Open the Word Sounds resource, then review its missing audio.',
    'word_sounds.audio_open_resource_review_toast': 'Open the Word Sounds resource, then review its audio.',
    'word_sounds.audio_preflight_detail': 'Missing audio: {{clips}}.',
    'word_sounds.audio_preflight_detail_more': 'Missing audio: {{clips}}, plus {{remaining}} more.',
    'word_sounds.audio_preflight_message_send': '{{missing}} of {{total}} required audio clips are missing. Students with live AI disabled may hear silence. Review and prepare the missing audio, or send anyway.',
    'word_sounds.audio_preflight_message_start': '{{missing}} of {{total}} required audio clips are missing. Students with live AI disabled may hear silence. Review and prepare the missing audio, or start anyway.',
    'word_sounds.audio_preflight_review': 'Review audio',
    'word_sounds.audio_preflight_send_anyway': 'Send anyway',
    'word_sounds.audio_preflight_start_anyway': 'Start anyway',
    'word_sounds.audio_preflight_title': 'Some activity audio is not ready',
    'word_sounds.audio_request_sent': 'Request sent',
    'word_sounds.audio_resend': 'Resend audio',
    'word_sounds.audio_retry_mailbox_update': 'Your teacher needs the latest Class Mailbox before resend requests can be sent.',
    'word_sounds.audio_retry_request_failed': 'The resend request could not be sent. Ask your teacher directly.',
    'word_sounds.audio_retry_request_sent': 'Your teacher has been asked to resend the activity.',
    'word_sounds.audio_retry_teacher_needed': 'Ask your teacher to resend the Word Sounds activity.',
    'word_sounds.audio_review': 'Review audio',
    'word_sounds.audio_review_repair_aria': 'Review and repair audio for {{student}}',
    'word_sounds.audio_review_repair_title': 'Open the Word Sounds audio review to replace a persistently damaged clip.',
    'word_sounds.audio_unavailable': "Sound didn't load — check your connection, then tap the sound again.",
    'word_sounds.audio_retry': '🔊 Try again',
    'word_sounds.audio_status_blocked': 'Playback blocked — student must tap',
    'word_sounds.audio_status_checking': 'Checking audio {{ready}}/{{total}}',
    'word_sounds.audio_status_damaged': 'Audio damaged',
    'word_sounds.audio_status_missing': 'Audio missing {{ready}}/{{total}}',
    'word_sounds.audio_status_no_response': 'No audio response — resend',
    'word_sounds.audio_status_requested': 'Resend requested',
    'word_sounds.audio_status_resending': 'Resending audio...',
    'word_sounds.audio_status_unsupported': 'Audio unsupported',
    'word_sounds.audio_teacher_blocked_title': 'The learner must tap Try sound again on their device.',
    'word_sounds.audio_teacher_resend_title': 'Resend prepared audio to this learner, or open audio review if the source pack is incomplete.',
    'word_sounds.audio_teacher_unsupported_title': "This learner's browser cannot play the prepared format. Open audio review and regenerate compatible clips.",
    'word_sounds.audio_testing_message': 'Silently testing {{ready}} of {{total}} prepared audio clips before the activity starts.',
    'word_sounds.audio_try_again': 'Try sound again',
    'word_sounds.audio_unsupported_message': '{{failed}} of {{total}} required clips use an audio format this browser cannot play. Ask your teacher to review and resend the audio.',
    'word_sounds.audio_unsupported_requested_message': '{{failed}} of {{total}} required clips use an audio format this browser cannot play. Your teacher has been asked to resend this activity.',
    'word_sounds.audio_unsupported_title': 'This audio format is not supported',
    'word_sounds.audio_waiting_title': 'Audio is not available yet',
    'word_sounds.session_type': 'Session Type',
    'word_sounds.mode_practice': 'Practice',
    'word_sounds.mode_assessment': 'Assessment',
    'word_sounds.assessment_note': 'Timed, no hints — a single-skill probe for progress monitoring, not practice. Lesson plans are turned off in this mode.',
    'word_sounds.probe_skill': 'Probe skill',
    'word_sounds.act_segmentation': 'Segmentation',
    'word_sounds.act_isolation': 'Sound Isolation',
    'word_sounds.act_blending': 'Blending',
    'word_sounds.act_rhyming': 'Rhyming',
    'word_sounds.act_counting': 'Sound Counting',
    ...
    'word_sounds.auto_select_hint': 'Auto-selects words from your sources',
    ...
    'word_sounds.ml_correct': '🎉 Correct letter!',
    'word_sounds.ml_hint_position': '🔍 Hint: It\'s letter #{{n}} in the word. Listen carefully!',
    'word_sounds.ml_try_again': 'Not quite! Listen again 🔊',
    'word_sounds.fb_streak_row': '🔥 {{n}} in a row!',
    'word_sounds.scramble_correct': '🎉 Unscrambled!',
    'word_sounds.scramble_try_again': 'Not quite! Try again 🔀',
    'word_sounds.tap_to_hear': 'Tap to hear',
    'word_sounds.minimized_generating': 'You can continue working. Sound generation is running in the background.',
    'word_sounds.minimized_ready': 'Ready to play!',
    'word_sounds.choose_activity_prompt': 'Choose an activity below to get started!',
    'word_sounds.ai_gen_failed': 'AI Generation Failed.',
    'word_sounds.ai_gen_fallback': 'Using basic data.',
    'word_sounds.wf_edit_hint': 'Modify the family members and distractors below.',
    'word_sounds.parent_amazing': 'Amazing progress! 🌟',
    'word_sounds.parent_great': 'Great effort today!',
    'word_sounds.parent_summary': 'Your child practiced {{total}} word(s) today — share this summary with their teacher!',
