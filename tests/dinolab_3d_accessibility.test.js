...
describe('Dino Lab 3D Field Station accessibility contract', () => {
  it('supports focused keyboard rotation with live status and cleanup', () => {
    ...
    expect(source).toContain('var yawRef = React.useRef({ speciesId: props.species.id, value: -0.35 });');
    ...
    expect(source).toContain('3D evidence view updated. Camera angle preserved.');
