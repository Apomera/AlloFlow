...
For a first lesson, begin with [Start here](01-start-here.md). For a practical teaching need, use [Classroom workflows](06-classroom-workflows.md).
...
Save Project is the dependable teacher-controlled backup when available, but it is not a substitute for a district record system. See [Privacy and responsible AI](07-privacy-and-responsible-ai.md).
...
For recovery steps, see [Troubleshooting](08-troubleshooting.md). For safe interpretation of dashboard and live evidence, see [Review evidence and plan next steps](05-review-and-next-steps.md).
