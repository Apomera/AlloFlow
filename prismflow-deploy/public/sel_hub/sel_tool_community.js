    ...
    render: function(ctx) {
      return (function() {
        ...
        var tabBar = h('div', {
          ...
          h('button', { 'aria-label': 'Toggle panel', onClick: function() { upd({ soundEnabled: !soundEnabled }); }, style: { marginLeft: 'auto', background: 'none', border: 'none', cursor: 'pointer', fontSize: 14, padding: '4px 6px', color: '#9ca3af' }, title: soundEnabled ? 'Mute' : 'Unmute' }, soundEnabled ? '\uD83D\uDD0A' : '\uD83D\uDD07'),
          h('button', { 'aria-label': 'Toggle panel', onClick: function() { upd({ showBadgesPanel: !showBadgesPanel }); }, style: { background: 'none', border: 'none', cursor: 'pointer', fontSize: 14, padding: '4px 6px', color: '#9ca3af', position: 'relative' } },
            '\uD83C\uDFC5',
        ...
        if (showBadgePopup) {
          ...
          if (popBadge) {
            badgePopup = h('div', { role: 'dialog', 'aria-modal': 'true', 'aria-label': 'Badge details', tabIndex: -1, onKeyDown: function(e) { if (e.key === 'Escape') e.currentTarget.click(); }, style: { position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, background: 'rgba(0,0,0,0.6)' }, onClick: function() { upd({ showBadgePopup: null }); } },
        ...
        if (showBadgesPanel) {
          badgePopup = h('div', { role: 'dialog', 'aria-modal': 'true', 'aria-label': 'Badge details', tabIndex: -1, onKeyDown: function(e) { if (e.key === 'Escape') e.currentTarget.click(); }, style: { position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9998, background: 'rgba(0,0,0,0.5)' }, onClick: function() { upd({ showBadgesPanel: false }); } },
        ...
        if (activeTab === 'explore') {
          ...
          exploreContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
                ...
                return h('div', { key: item.id, style: { borderRadius: 14, background: isExpanded ? '#1e293b' : '#0f172a', border: '1px solid ' + (isExplored ? ACCENT_MED : '#334155'), overflow: 'hidden', transition: 'all 0.2s' } },
                  h('button', { 'aria-label': 'Explore topic',
                    ...
                    h('div', { style: { flex: 1 } },
                      ...
                      !isExpanded && h('div', { style: { fontSize: 11, color: '#9ca3af', marginTop: 2 } }, item.desc.slice(0, 60) + '...')
                    ),
                    isExplored && h('span', { style: { fontSize: 12, color: ACCENT } }, '\u2713'),
                    h('span', { style: { fontSize: 12, color: '#9ca3af', transform: isExpanded ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' } }, '\u25BC')
                  ),
            ...
            h('div', { style: { textAlign: 'center', marginTop: 16, fontSize: 12, color: '#9ca3af' } },
        ...
        if (activeTab === 'identity') {
          ...
          identityContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
            ...
            h('div', { style: { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12, marginBottom: 20 } },
              IDENTITY_CATEGORIES.map(function(cat) {
                ...
                return h('div', { key: cat.id, style: { padding: 14, borderRadius: 14, background: isFilled ? '#1e293b' : '#0f172a', border: '1px solid ' + (isFilled ? ACCENT_MED : '#334155'), transition: 'all 0.2s' } },
                  ...
                  h('p', { style: { fontSize: 10, color: '#9ca3af', marginBottom: 6, lineHeight: 1.4 } }, cat.prompt),
                  h('textarea', {
                    value: value,
            ...
            h('div', { style: { textAlign: 'center', marginBottom: 16, padding: '8px 16px', borderRadius: 10, background: '#0f172a', border: '1px solid #334155' } },
              ...
              h('div', { style: { fontSize: 11, color: '#9ca3af', marginTop: 4 } }, filledCount + ' of 8 areas explored')
            ),
            // Cultural Superpower
            ...
            h('div', { style: { marginTop: 24 } },
                  ...
                  return h('div', { key: card.id, style: { padding: 14, borderRadius: 12, background: isDone ? '#1e293b' : '#0f172a', border: '1px solid ' + (isDone ? '#22c55e44' : '#334155'), transition: 'all 0.2s' } },
                    h('div', { style: { display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 } },
                      ...
                      h('div', { style: { flex: 1 } },
                        ...
                        h('div', { style: { fontSize: 11, color: '#cbd5e1', marginTop: 2, lineHeight: 1.4 } }, card.detail)
                      ),
              ...
              h('div', { style: { textAlign: 'center', marginTop: 12, fontSize: 12, color: '#9ca3af' } },
        ...
        if (activeTab === 'scenarios') {
          ...
          scenariosContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
            ...
            h('div', { style: { padding: 20, borderRadius: 16, background: '#1e293b', border: '1px solid #334155', marginBottom: 16 } },
              ...
              callTTS ? h('button', { 'aria-label': 'Read aloud', onClick: function() { speak(scenario.setup); }, style: { marginBottom: 12, background: 'none', border: 'none', color: '#9ca3af', fontSize: 11, cursor: 'pointer' } }, '\uD83D\uDD0A Read aloud') : null,
              // Choices
            ...
            h('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' } },
              ...
              h('span', { style: { fontSize: 12, color: '#9ca3af' } }, scCompleted + ' completed'),
        ...
        if (activeTab === 'quiz') {
          ...
          quizContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
            ...
            !quizFinished ? h('div', null,
              h('div', { style: { padding: 20, borderRadius: 16, background: '#1e293b', border: '1px solid #334155', marginBottom: 16 } },
                h('div', { style: { fontSize: 11, color: '#9ca3af', marginBottom: 8 } }, 'Question ' + ((quizIdx % quizItems.length) + 1) + ' of ' + quizItems.length),
              ...
              h('div', { style: { fontSize: 13, color: '#cbd5e1', marginBottom: 16 } }, quizScore >= 8 ? 'Outstanding cultural knowledge!' : quizScore >= 5 ? 'Great job! Keep exploring to learn more.' : 'Keep learning! Every question you missed is a chance to grow.'),
        ...
        if (activeTab === 'privilege' && band !== 'elementary') {
          ...
          privilegeContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
            ...
            !pwFinished ? h('div', null,
              ...
              // Statement card
              h('div', { style: { padding: 20, borderRadius: 16, background: '#1e293b', border: '1px solid #334155', marginBottom: 16 } },
                h('div', { style: { fontSize: 11, color: '#9ca3af', marginBottom: 8 } }, 'Statement ' + (pwIdx + 1) + ' of ' + totalPW),
                ...
                h('div', { style: { textAlign: 'center', marginTop: 10, fontSize: 10, color: '#9ca3af', fontStyle: 'italic' } },
              ...
              h('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' } },
                ...
                h('span', { style: { fontSize: 12, color: '#9ca3af' } }, answeredPWCount + '/' + totalPW + ' answered'),
                h('button', { 'aria-label': 'Next',
        ...
        if (activeTab === 'microagg' && band !== 'elementary') {
          ...
          microaggContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
            ...
            h('div', { style: { textAlign: 'center', marginBottom: 16, fontSize: 12, color: '#9ca3af' } },
            ...
            currentMA && h('div', { style: { borderRadius: 16, background: '#1e293b', border: '1px solid #334155', overflow: 'hidden', marginBottom: 16 } },
              ...
              h('div', { style: { padding: '20px 20px 16px', borderBottom: '1px solid #33415544', background: '#0f172a' } },
                h('div', { style: { fontSize: 11, color: '#9ca3af', marginBottom: 6 } }, (maIdx + 1) + ' of ' + MICROAGGRESSIONS.length),
                ...
                h('div', { style: { marginBottom: 16 } },
                  ...
                  !maBystanderDone[currentMA.id] ? h('div', null,
                    ...
                    h('div', { style: { padding: '8px 12px', borderRadius: 8, background: '#0f172a', border: '1px solid #334155', fontSize: 12, color: '#cbd5e1', marginBottom: 8, lineHeight: 1.5 } },
                      h('div', { style: { fontSize: 10, color: '#9ca3af', marginBottom: 4 } }, 'Your response:'),
                    ...
                    h('div', { style: { padding: '8px 12px', borderRadius: 8, background: ACCENT_DIM, border: '1px solid ' + ACCENT_MED, fontSize: 12, color: ACCENT, lineHeight: 1.5 } },
                      h('div', { style: { fontSize: 10, color: '#9ca3af', marginBottom: 4 } }, 'Example bystander response:'),
            ...
            h('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' } },
              ...
              h('span', { style: { fontSize: 12, color: '#9ca3af' } }, maReviewedCount + '/' + MICROAGGRESSIONS.length + ' reviewed'),
              h('button', { 'aria-label': 'Next',
        ...
        if (activeTab === 'heritage') {
          ...
          heritageContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
            ...
            h('div', { style: { display: 'flex', flexDirection: 'column', gap: 14, marginBottom: 20 } },
              HERITAGE_SECTIONS.map(function(sec) {
                ...
                return h('div', { key: sec.id, style: { padding: 16, borderRadius: 14, background: filled ? '#1e293b' : '#0f172a', border: '1px solid ' + (filled ? ACCENT_MED : '#334155'), transition: 'all 0.2s' } },
                  ...
                  h('p', { style: { fontSize: 11, color: '#9ca3af', marginBottom: 8, lineHeight: 1.5 } }, sec.prompt),
                  h('textarea', {
            ...
            h('div', { style: { textAlign: 'center', marginBottom: 16, padding: '8px 16px', borderRadius: 10, background: '#0f172a', border: '1px solid #334155' } },
              ...
              h('div', { style: { fontSize: 11, color: '#9ca3af', marginTop: 4 } }, hFilled + ' of ' + HERITAGE_SECTIONS.length + ' sections completed')
            ),
            // Visual Cultural Map
              ...
              h('div', { style: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10 } },
                HERITAGE_SECTIONS.map(function(sec) {
                  ...
                  return h('div', { key: sec.id, style: { padding: 12, borderRadius: 10, background: filled ? '#0f172a' : '#0f172a55', border: '1px solid ' + (filled ? ACCENT_MED : '#33415555'), textAlign: 'center', opacity: filled ? 1 : 0.4 } },
                    ...
                    filled && h('div', { style: { fontSize: 10, color: '#cbd5e1', marginTop: 4, lineHeight: 1.4, maxHeight: 42, overflow: 'hidden', textOverflow: 'ellipsis' } }, val.slice(0, 80) + (val.length > 80 ? '...' : ''))
                  );
                })
              )
            ),
            ...
            h('div', { style: { display: 'flex', flexDirection: 'column', gap: 12 } },
              tipItems.map(function(tip) {
                ...
                return h('div', { key: tip.id,
                  ...
                  !isRead && h('div', { style: { marginTop: 8, fontSize: 10, color: '#9ca3af', fontStyle: 'italic' } }, 'Tap to mark as read')
                );
              })
            ),
            // Completion message
          ...
          battleContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
            ...
            !battleFinished ? h('div', null,
              h('div', { style: { padding: 20, borderRadius: 16, background: '#1e293b', border: '1px solid #ec489944', marginBottom: 16 } },
                h('div', { style: { fontSize: 11, color: '#9ca3af', marginBottom: 8 } }, 'Question ' + ((battleIdx % battleItems.length) + 1) + ' of ' + battleItems.length),
              ...
              h('div', { style: { fontSize: 13, color: '#cbd5e1', marginBottom: 16 } }, battleScore >= 4 ? 'Battle Victor! Impressive quick thinking!' : 'Keep training! Try again to improve your score.'),
              ...
              h('div', { style: { display: 'flex', flexDirection: 'column', gap: 6 } },
                practiceLog.slice(-8).reverse().map(function(entry, i) {
                  ...
                  return h('div', { key: i, style: { padding: '8px 12px', borderRadius: 8, background: '#0f172a', display: 'flex', alignItems: 'center', gap: 8, fontSize: 12 } },
                    ...
                    h('span', { style: { marginLeft: 'auto', color: '#9ca3af', fontSize: 11 } }, new Date(entry.timestamp).toLocaleString())
                  );
                })
              )
            )
