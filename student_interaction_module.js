...
var StudentSubmitModal = React.memo(({ isOpen, onClose, onSubmit, history = [], currentNickname = "" }) => {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "text-center mb-6 relative" }, /* @__PURE__ */ React.createElement("div", { className: "w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-4 border-2 border-indigo-200" }, /* @__PURE__ */ React.createElement(Send, { size: 32, className: "text-indigo-600 ml-1" })), /* @__PURE__ */ React.createElement("h2", { className: "text-2xl font-black text-slate-800 mb-1" }, t("modals.submit_title")), /* @__PURE__ */ React.createElement("p", { className: "text-slate-500 text-sm font-medium" }, t("modals.submit_ready"))), /* @__PURE__ */ React.createElement("div", { className: "mb-6" }, /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 text-center" }, t("modals.student_name_label")), /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-50 p-4 rounded-xl border border-indigo-100" }, /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mb-3" }, /* @__PURE__ */ React.createElement(
    "select",
    {
      value: selectedAdj,
  ...
  ), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-center text-slate-500 font-medium px-4" }, t("modals.upload_instruction")), /* @__PURE__ */ React.createElement(
    "button",
    {
      "aria-label": t("common.close"),
      onClick: onClose,
...
var DraftFeedbackInterface = React.memo(({
  ...
  const renderRubric = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "bg-slate-50 p-4 border-b border-slate-200 flex justify-between items-center" }, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-slate-700" }, t("mastery.feedback"), " & ", t("mastery.score")), /* @__PURE__ */ React.createElement("div", { className: `px-4 py-1 rounded-full text-sm font-black border ${status === "mastery" ? "bg-yellow-100 text-yellow-700 border-yellow-300" : "bg-blue-100 text-blue-700 border-blue-200"}` }, t("mastery.score"), ": ", gradingDetails.rawScore, "/100")), /* @__PURE__ */ React.createElement("div", { className: "divide-y divide-slate-100" }, gradingDetails.breakdown.map((grade, idx) => {
      return /* @__PURE__ */ React.createElement("div", { key: idx, className: "p-4 md:p-6" }, /* @__PURE__ */ React.createElement("div", { className: "mb-3 flex justify-between items-end" }, /* @__PURE__ */ React.createElement("h4", { className: "font-bold text-indigo-900 text-sm uppercase tracking-wider" }, grade.criterion || "Criterion"), /* @__PURE__ */ React.createElement("span", { className: "text-xs font-medium text-slate-500" }, t("mastery.achieved_level"), ": ", grade.score, "/", grade.max || 5)), grade.reason && /* @__PURE__ */ React.createElement("div", { className: `mt-2 text-sm p-3 rounded-lg border-l-4 ${grade.score >= (grade.max || 5) * 0.8 ? "bg-green-50 border-green-400 text-green-800" : "bg-orange-50 border-orange-400 text-orange-800"}` }, /* @__PURE__ */ React.createElement("span", { className: "font-bold mr-1" }, t("mastery.feedback"), ":"), " ", grade.reason));
    })));
  };
  if (status === "writing") {
  ...
  if (status === "grading") {
    return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center justify-center h-96 p-8" }, /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement("div", { className: "w-20 h-20 border-4 border-indigo-100 rounded-full" }), /* @__PURE__ */ React.createElement("div", { className: "w-20 h-20 border-4 border-t-indigo-600 border-r-indigo-600 border-b-transparent border-l-transparent rounded-full animate-spin absolute top-0 left-0" }), /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 flex items-center justify-center text-indigo-600" }, /* @__PURE__ */ React.createElement(RefreshCw, { size: 24, className: "animate-spin" }))), /* @__PURE__ */ React.createElement("h3", { className: "mt-6 text-xl font-bold text-slate-700 animate-pulse" }, t("mastery.analyzing")), /* @__PURE__ */ React.createElement("p", { className: "text-slate-500 mt-2" }, t("mastery.criteria_check")));
  }
  if (status === "revision") {
    return /* @__PURE__ */ React.createElement("div", { className: "max-w-6xl mx-auto p-4 md:p-6 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center bg-orange-50 border border-orange-200 p-4 rounded-xl" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "bg-orange-100 p-2 rounded-full text-orange-600" }, /* @__PURE__ */ React.createElement(RefreshCw, { size: 24 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-black text-orange-800" }, t("mastery.revision_required")), /* @__PURE__ */ React.createElement("p", { className: "text-orange-700/80 text-sm" }, t("mastery.revision_desc")))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "hidden sm:flex items-center gap-2 px-4 py-2 bg-white rounded-lg border border-orange-200 shadow-sm mr-2" }, /* @__PURE__ */ React.createElement(Star, { size: 16, className: "text-yellow-500 fill-current" }), /* @__PURE__ */ React.createElement("span", { className: "text-xs font-bold text-slate-600" }, t("mastery.current_progress"), ": ", gradingDetails?.rawScore, "/100")), /* @__PURE__ */ React.createElement("button", { onClick: onCancel, className: "p-2 text-slate-500 hover:text-slate-600", "aria-label": t("common.close") }, /* @__PURE__ */ React.createElement(X, { size: 20 })))), renderRubric(), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider flex items-center gap-2" }, /* @__PURE__ */ React.createElement(History, { size: 14 }), " ", t("mastery.locked_draft", { count: draftCount })), /* @__PURE__ */ React.createElement("div", { className: "bg-slate-100 text-slate-500 p-6 rounded-xl border border-slate-200 h-96 overflow-y-auto font-serif relative whitespace-pre-wrap" }, /* @__PURE__ */ React.createElement("div", { className: "absolute top-4 right-4 text-slate-500" }, /* @__PURE__ */ React.createElement(Lock, { size: 20 })), previousDraft)), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-bold text-indigo-600 uppercase tracking-wider flex items-center gap-2" }, /* @__PURE__ */ React.createElement(BookOpen, { size: 14 }), " ", t("mastery.new_draft", { count: draftCount + 1 })), /* @__PURE__ */ React.createElement("div", { className: "relative h-96" }, /* @__PURE__ */ React.createElement(
      "textarea",
      {
        value: draftText,
        onChange: (e) => setDraftText(e.target.value),
