    ...
    render: function (ctx) {
      ...
      return h('div', { id: 'particle-lab-root', className: 'max-w-7xl mx-auto space-y-4 animate-in fade-in duration-300' },
        h('style', null, `
          ...
          #particle-workspace { display: grid; grid-template-columns: minmax(0, 1fr) 17rem; grid-template-areas: "scene readouts"; height: clamp(520px, 62vh, 780px); min-width: 0; }
          ...
          #particle-workspace[data-dock="left"] { grid-template-columns: 17rem minmax(0, 1fr); grid-template-areas: "readouts scene"; }
...
`),
        ...
        h('div', { className: 'grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]' },
          h('section', { id: 'particle-stage', 'data-fullscreen': fsActive ? 'true' : 'false', ref: stageRef, onKeyDown: onStageKeyDown, className: 'relative min-w-0 overflow-hidden border border-cyan-500/30 bg-slate-950 shadow-2xl shadow-cyan-950/40 ring-1 ring-white/5 ' + (fsActive ? 'h-screen rounded-none flex flex-col' : 'rounded-[24px]'), style: cssFullscreen ? { position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, width: '100vw', height: '100dvh', zIndex: 99990, borderRadius: 0 } : undefined, 'aria-label': 'Three-dimensional particle simulation', 'aria-busy': ready ? 'false' : 'true' },
            ...
            h('div', { id: 'particle-workspace', 'data-dock': readoutsPosition, 'data-readouts': showHud && readoutsOpen ? 'open' : 'closed' },
              h('div', { id: 'particle-viewport', className: 'relative overflow-hidden bg-slate-950' },
              ...
              showHud && h('aside', { id: 'particle-readouts', hidden: !readoutsOpen, tabIndex: 0, 'aria-label': 'Chamber readouts', className: 'bg-slate-900 p-3 text-slate-200' },
                ...
                h('p', { className: 'text-[11px] text-slate-300' }, 'Move or collapse this panel with the controls below the chamber, or press D while the chamber has focus.'),
