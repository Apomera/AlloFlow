...
(async()=>{
 ...
 await page.screenshot({path:'reports/video-studio-caption-recovery-2026-09-08/export/start-desktop.png',fullPage:false});
 ...
 await page.screenshot({path:'reports/video-studio-caption-recovery-2026-09-08/export/editor-desktop.png'});
 ...
 await download.saveAs('reports/video-studio-caption-recovery-2026-09-08/export/export-fixture.webm');
 ...
 await page.screenshot({path:'reports/video-studio-caption-recovery-2026-09-08/export/editor-mobile.png'});
 await page.locator('#trimStart').scrollIntoViewIfNeeded();await page.screenshot({path:'reports/video-studio-caption-recovery-2026-09-08/export/trim-mobile.png'});
 assert.deepEqual(errors,[]);
 fs.writeFileSync('reports/video-studio-caption-recovery-2026-09-08/export/browser-results.json',JSON.stringify({passed:true,checks:['hidden recovery banners','specialist workflow disclosure','decimal trim typing','empty states','source-dependent camera controls','recording before advanced tools','real WebM import','per-take trims','bounded trim input','trim at playhead and reset','draft recovery after reload','narration and visual workflow visibility','prepare and download actual video','mobile overflow','no page errors'],errors},null,2));
