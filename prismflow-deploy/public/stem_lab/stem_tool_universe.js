...
if (!window.StemLab.isRegistered('universe')) {
          ...
          return React.createElement("div", { className: "max-w-4xl mx-auto animate-in fade-in duration-200" },
            ...
            React.createElement("div", { className: "mt-4 bg-gradient-to-r from-violet-50 to-indigo-50 rounded-xl p-3 border border-violet-200" },
              React.createElement("div", { className: "flex items-center justify-between mb-1" },
                ...
                React.createElement("span", { className: "text-[10px] text-violet-400" }, completedChallenges.length + "/" + CHALLENGES.length + " challenges")
              ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-amber-50 border-amber-200') + " rounded-xl p-3 border" },
              ...
              d.showStarLife && React.createElement("div", { className: "space-y-2" },
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-1" }, "Every star follows a lifecycle determined by its mass. Low-mass stars end gently; massive stars end violently."),
                // Two tracks diagram
                React.createElement("div", { className: "flex gap-4 mb-2" },
                  React.createElement("div", { className: "flex-1 text-center" },
                    React.createElement("div", { className: "text-[9px] font-bold text-amber-600 mb-1" }, "Low Mass (< 8 M\u2609)"),
                    React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "Cloud \u2192 Protostar \u2192 Main Seq \u2192 Red Giant \u2192 Nebula \u2192 White Dwarf")
                  ),
                  React.createElement("div", { className: "flex-1 text-center" },
                    React.createElement("div", { className: "text-[9px] font-bold text-red-600 mb-1" }, "High Mass (> 8 M\u2609)"),
                    React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "Cloud \u2192 Protostar \u2192 Main Seq \u2192 Red Giant \u2192 Supernova \u2192 Neutron Star / Black Hole")
                  )
                ),
                STAR_STAGES.map(function(stage, si) {
                  ...
                  return React.createElement("div", {
                    ...
                    React.createElement("div", { className: "flex items-center gap-2" },
                      ...
                      React.createElement("span", { className: "ml-auto text-[9px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, stage.duration)
                    ),
                    isActive && React.createElement("div", { className: "mt-2 space-y-1" },
                      React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-300' : 'text-slate-600') }, stage.desc),
                      React.createElement("div", { className: "flex gap-3 text-[9px] mt-1" },
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-blue-50 border-blue-200') + " rounded-xl p-3 border" },
              ...
              d.showHR && React.createElement("div", null,
                ...
                React.createElement("div", { className: "mt-2 text-[9px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, "The Sun is a G2V main-sequence star. It will become a red giant in ~5 billion years, then shrink to a white dwarf.")
              )
            ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-emerald-50 border-emerald-200') + " rounded-xl p-3 border" },
              ...
              d.showDistance && React.createElement("div", { className: "space-y-1.5" },
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-1" }, "Astronomers use a chain of methods to measure distances across the universe:"),
                DISTANCE_LADDER.map(function(rung, ri) {
                  return React.createElement("div", { key: ri, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-emerald-100') + " rounded-lg p-2 border" },
                    React.createElement("div", { className: "flex items-center gap-2" },
                      ...
                      React.createElement("div", { className: "flex-1" },
                        React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, rung.name),
                        React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, rung.dist + " \u2022 " + rung.light)
                      ),
                      React.createElement("span", { className: "text-[8px] px-1.5 py-0.5 rounded-full " + (isDark ? 'bg-emerald-900 text-emerald-300' : 'bg-emerald-100 text-emerald-600') }, rung.method)
                    )
                  );
                })
              )
            ...
            React.createElement("div", { className: "mt-3 bg-gradient-to-r from-violet-50 to-fuchsia-50 rounded-xl p-3 border border-violet-200" },
              ...
              React.createElement("div", { className: "flex flex-wrap gap-1 mb-2" },
                [
                  ...
                  return React.createElement("button", { key: qi, onClick: function() { askCosmosTutor(q); }, className: "text-[10px] px-2 py-0.5 rounded-full bg-violet-100 text-violet-600 hover:bg-violet-200 transition-colors" }, q);
                })
              ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-orange-50 border-orange-200') + " rounded-xl p-3 border" },
              ...
              d.showElements && React.createElement("div", { className: "space-y-1.5" },
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-1" }, "Every atom in your body was made in a star, supernova, or the Big Bang itself!"),
                ELEMENT_ORIGINS.map(function(el, ei2) {
                  return React.createElement("div", { key: ei2, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-orange-100') + " rounded-lg p-2 border flex items-center gap-2" },
                    ...
                    React.createElement("div", { className: "flex-1" },
                      React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, el.name + " \u2014 " + el.origin),
                      React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, el.note)
                    ),
                    React.createElement("span", { className: "text-[9px] font-mono " + (isDark ? 'text-slate-500' : 'text-slate-400') }, el.pct)
                  );
                })
              )
            ),
              ...
              d.showStructures && React.createElement("div", { className: "space-y-1" },
                COSMIC_STRUCTURES.map(function(cs, csi) {
                  return React.createElement("div", { key: csi, className: "flex items-center gap-2 " + (isDark ? 'text-slate-300' : 'text-slate-600') },
                    ...
                    React.createElement("div", { className: "flex-1" },
                      React.createElement("span", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, cs.name),
                      React.createElement("span", { className: "text-[9px] " + (isDark ? 'text-slate-500' : 'text-slate-400') + " ml-1" }, "(" + cs.example + ")"),
                      React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, cs.size + " \u2022 " + cs.desc)
                    )
                  );
                })
              )
                ...
                TELESCOPES.map(function(tel, ti) {
                  return React.createElement("div", { key: ti, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-teal-100') + " rounded-lg p-2 border" },
                    React.createElement("div", { className: "flex items-center gap-2" },
                      ...
                      React.createElement("div", { className: "flex-1" },
                        React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, tel.name + " (" + tel.year + ")"),
                        React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, tel.type)
                      )
                    ),
                    React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-300' : 'text-slate-600') + " mt-1 italic" }, tel.achievement)
                  );
                })
              )
            ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-pink-50 border-pink-200') + " rounded-xl p-3 border" },
              ...
              d.showQuiz && (function() {
                ...
                return React.createElement("div", null,
                  React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " mb-1" }, "Question " + (qi + 1) + "/" + COSMIC_QUIZ.length + " \u2022 Score: " + qScore),
                  ...
                  React.createElement("div", { className: "grid grid-cols-2 gap-1.5" },
                    cq.options.map(function(opt, oi) {
                      ...
                      var btnClass = "text-[10px] py-1.5 px-2 rounded-lg border font-medium text-left transition-all ";
                      if (answered) {
                        ...
                        else btnClass += (isDark ? 'bg-slate-700 border-slate-600 text-slate-400' : 'bg-slate-100 border-slate-200 text-slate-400');
                      } else {
              ...
              d.showNumbers && React.createElement("div", { className: "grid grid-cols-2 gap-1.5" },
                COSMIC_NUMBERS.map(function(cn, cni) {
                  return React.createElement("div", { key: cni, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-indigo-100') + " rounded-lg p-2 border text-center" },
                    ...
                    React.createElement("div", { className: "text-[9px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, cn.value),
                    React.createElement("div", { className: "text-[8px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, cn.label)
                  );
                })
              )
            ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-blue-50 to-indigo-50 border-indigo-200') + " rounded-xl p-3 border" },
              ...
              d.showCalendar && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "If all 13.8 billion years were compressed into one calendar year, human history would fit in the last second of December 31st."),
                  ...
                  COSMIC_CALENDAR.map(function(cc, cci) {
                    return React.createElement("div", { key: cci, className: "relative" },
                      ...
                      React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-300' : 'text-slate-600') },
                        ...
                        React.createElement("span", { className: " ml-1 " + (isDark ? 'text-slate-500' : 'text-slate-400') }, "(" + cc.real + ")")
                      )
                    );
                  })
                ),
                React.createElement("div", { className: "mt-2 text-center text-[9px] font-bold " + (isDark ? 'text-indigo-400' : 'text-indigo-600') }, "All of recorded human history = last 14 seconds of Dec 31!")
              )
            ),
                ...
                GALAXY_TYPES.map(function(gt, gti) {
                  return React.createElement("div", { key: gti, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-violet-100') + " rounded-lg p-2.5 border" },
                    React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                      ...
                      React.createElement("span", { className: "ml-auto text-[9px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, gt.example)
                    ),
                    React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-300' : 'text-slate-600') }, gt.desc),
                    React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-violet-400' : 'text-violet-500') + " mt-1 font-medium" }, "Structure: " + gt.features)
                  );
                })
              )
            ),
                ...
                BLACK_HOLE_PARTS.map(function(part, pi) {
                  return React.createElement("div", { key: pi, className: "flex items-start gap-2" },
                    ...
                    React.createElement("div", null,
                      React.createElement("span", { className: "text-[10px] font-bold text-white" }, part.name),
                      React.createElement("div", { className: "text-[9px] text-slate-400" }, part.desc)
                    )
                  );
                })
              )
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-green-50 border-green-200') + " rounded-xl p-3 border" },
              ...
              d.showDrake && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "N = R* \u00D7 fp \u00D7 ne \u00D7 fl \u00D7 fi \u00D7 fc \u00D7 L"),
                  ...
                  [
                    ...
                    return React.createElement("div", { key: param.key },
                      React.createElement("div", { className: "flex items-center justify-between" },
                        React.createElement("label", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, param.label + ": " + val),
                        React.createElement("span", { className: "text-[8px] " + (isDark ? 'text-slate-600' : 'text-slate-400') }, param.desc)
                      ),
                      React.createElement("input", { type: "range", min: param.min, max: param.max, step: param.step, value: val, onChange: function(e) { upd(param.key, parseFloat(e.target.value)); }, className: "w-full h-1 bg-green-200 rounded-lg appearance-none" })
                    );
                  })
                ),
                // Result
                (function() {
                  ...
                  return React.createElement("div", { className: "mt-2 text-center p-2 rounded-lg " + (isDark ? 'bg-slate-700' : 'bg-green-100') },
                    ...
                    React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "Estimated detectable civilizations in our galaxy right now"),
                    N > 1000 ? React.createElement("div", { className: "text-[9px] text-green-500 mt-1 font-bold" }, "\uD83D\uDC7D That\'s a lot! So where is everybody? (Fermi Paradox)") :
                    N < 1 ? React.createElement("div", { className: "text-[9px] text-orange-500 mt-1 font-bold" }, "\uD83D\uDE14 We might be alone in the Milky Way...") :
                    React.createElement("div", { className: "text-[9px] text-blue-500 mt-1 font-bold" }, "\uD83E\uDD14 A handful of civilizations \u2014 but space is very, very big")
                  );
                })()
              )
            ),
                ...
                SUPERNOVA_TYPES.map(function(sn, sni) {
                  return React.createElement("div", { key: sni, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-red-100') + " rounded-lg p-2.5 border" },
                    React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                      ...
                      React.createElement("span", { className: "ml-auto text-[9px] " + (isDark ? 'text-red-400' : 'text-red-500') + " font-bold" }, "Peak: " + sn.brightness)
                    ),
                    React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " mb-1" }, "\u26A1 Trigger: " + sn.trigger),
                    React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-300' : 'text-slate-600') + " mb-1" }, sn.mechanism),
                    React.createElement("div", { className: "text-[9px] font-medium " + (isDark ? 'text-amber-400' : 'text-amber-600') }, "\uD83D\uDCA1 " + sn.importance)
                  );
                })
              )
            ),
                ...
                ASTRONOMERS.map(function(ast, asti) {
                  return React.createElement("div", { key: asti, className: "relative" },
                    ...
                    React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-300' : 'text-slate-600') },
                      ...
                      React.createElement("span", { className: " \u2014 " + (isDark ? 'text-slate-400' : 'text-slate-500') }, " \u2014 " + ast.contribution)
                    )
                  );
                })
              )
              ...
              d.showObservable && React.createElement("div", { className: "space-y-2" },
                React.createElement("div", { className: "grid grid-cols-3 gap-1.5 text-center" },
                  React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-fuchsia-100') },
                    React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, "Radius"),
                    React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, OBSERVABLE_UNIVERSE.radius)
                  ),
                  React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-fuchsia-100') },
                    React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, "Diameter"),
                    React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, OBSERVABLE_UNIVERSE.diameter)
                  ),
                  React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-fuchsia-100') },
                    React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, "Age"),
                    React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, OBSERVABLE_UNIVERSE.age)
                  )
                ),
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-300' : 'text-slate-600') + " space-y-1.5" },
                  React.createElement("div", null, "\u2753 **Why is it 93 billion light-years if the universe is only 13.8 billion years old?**"),
                  React.createElement("div", { className: isDark ? 'text-slate-400' : 'text-slate-500' }, OBSERVABLE_UNIVERSE.whyBigger),
                  React.createElement("div", null, "\u2753 **Is there more beyond what we can see?**"),
                  React.createElement("div", { className: isDark ? 'text-slate-400' : 'text-slate-500' }, OBSERVABLE_UNIVERSE.beyondIt)
                )
              )
            ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-emerald-50 border-emerald-200') + " rounded-xl p-3 border" },
              ...
              d.showExoplanets && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "We have discovered 5,700+ exoplanets. They come in dazzling variety \u2014 many unlike anything in our Solar System."),
                    ...
                    return React.createElement("div", { key: epi, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-emerald-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("div", { className: "flex-1" },
                          ...
                          React.createElement("span", { className: "text-[9px] ml-1.5 " + (isDark ? 'text-slate-500' : 'text-slate-400') }, ep2.example)
                        ),
                        React.createElement("span", { className: "text-[8px] px-1.5 py-0.5 rounded-full font-bold " + (ep2.habitable === 'Best candidate' ? (isDark ? 'bg-green-900 text-green-300' : 'bg-green-100 text-green-600') : ep2.habitable === 'Possible' ? (isDark ? 'bg-yellow-900 text-yellow-300' : 'bg-yellow-100 text-yellow-600') : (isDark ? 'bg-slate-600 text-slate-400' : 'bg-slate-100 text-slate-500')) }, typeof ep2.habitable === 'string' ? ep2.habitable : (ep2.habitable ? 'Habitable' : 'Not habitable'))
                      ),
                      React.createElement("div", { className: "grid grid-cols-3 gap-1 mb-1.5" },
                        React.createElement("div", { className: "text-[8px] text-center " + (isDark ? 'text-slate-500' : 'text-slate-400') },
                      ...
                      React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, ep2.desc),
                      React.createElement("button", {
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-sky-50 to-blue-50 border-blue-200') + " rounded-xl p-3 border" },
              ...
              d.showMissions && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "Key moments in humanity's journey to explore the cosmos:"),
                    ...
                    return React.createElement("div", { key: smi, className: "relative" },
                      ...
                      React.createElement("div", { className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-blue-100') + " rounded-lg p-2 border" },
                        React.createElement("div", { className: "flex items-center gap-2 mb-0.5" },
                          ...
                          React.createElement("span", { className: "ml-auto text-[9px] font-bold " + (isDark ? 'text-blue-400' : 'text-blue-500') }, sm.year),
                          React.createElement("span", { className: "text-[8px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, sm.agency)
                        ),
                        React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, sm.desc)
                      )
                    );
                  })
                )
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-amber-50 border-amber-200') + " rounded-xl p-3 border" },
              ...
              d.showFermi && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " mb-2" }, "If the universe is so vast and old, and the conditions for life aren't rare, why haven't we found evidence of alien civilizations? Physicist Enrico Fermi asked this in 1950 over lunch. Here are the leading proposed answers:"),
                React.createElement("div", { className: "space-y-2" },
                  FERMI_SOLUTIONS.map(function(fs, fsi) {
                    ...
                    return React.createElement("div", { key: fsi, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-amber-100') + " rounded-lg p-2.5 border" },
                      ...
                      React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, fs.desc),
                      React.createElement("button", {
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-900 border-slate-700' : 'bg-slate-900') + " rounded-xl p-3 border border-indigo-700" },
              ...
              d.showLensing && React.createElement("div", { className: "space-y-2" },
                React.createElement("div", { className: "text-[10px] text-slate-400 italic mb-1" }, "Einstein predicted that massive objects bend light. This gravitational lensing lets us see behind galaxies, magnify distant objects, and map invisible dark matter."),
                ...
                React.createElement("div", { className: "space-y-1.5" },
                  LENSING_EXAMPLES.map(function(le, lei) {
                    return React.createElement("div", { key: lei, className: "flex items-start gap-2" },
                      ...
                      React.createElement("div", null,
                        React.createElement("span", { className: "text-[10px] font-bold text-white" }, le.name),
                        React.createElement("span", { className: "text-[8px] ml-1.5 px-1 py-0.5 rounded " + (le.type === 'Strong lensing' ? 'bg-indigo-900 text-indigo-300' : le.type === 'Weak lensing' ? 'bg-purple-900 text-purple-300' : 'bg-cyan-900 text-cyan-300') }, le.type),
                        React.createElement("div", { className: "text-[9px] text-slate-400" }, le.desc)
                      )
                    );
                  })
                )
                ...
                React.createElement("div", { className: "space-y-2" },
                  COSMIC_MYSTERIES.map(function(cm, cmi) {
                    ...
                    return React.createElement("div", { key: cmi, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-rose-100') + " rounded-lg p-2.5 border" },
                      ...
                      React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, cm.desc),
                      React.createElement("button", {
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-purple-50 to-violet-50 border-purple-200') + " rounded-xl p-3 border" },
              ...
              d.showMultiverse && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "Is our universe all there is? Several serious scientific frameworks suggest it may be one of infinitely many."),
                React.createElement("div", { className: "space-y-2" },
                    ...
                    return React.createElement("div", { key: mti, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-purple-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("div", { className: "flex-1" },
                          ...
                          React.createElement("div", { className: "text-[8px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, mt2.source)
                        )
                      ),
                      React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " mb-1" }, mt2.desc),
                      React.createElement("div", { className: "text-[9px] font-medium " + (isDark ? 'text-purple-400' : 'text-purple-600') }, "\uD83D\uDD2C Evidence: " + mt2.evidence),
                      React.createElement("button", {
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-900 border-slate-700' : 'bg-slate-900') + " rounded-xl p-3 border border-red-700" },
              ...
              d.showRedshift && React.createElement("div", { className: "space-y-2" },
                ...
                // Explanation text
                React.createElement("div", { className: "space-y-1.5 text-[10px] text-slate-300" },
                ...
                React.createElement("div", { className: "bg-slate-800 rounded-lg p-2 text-center border border-slate-700 mt-1" },
                  ...
                  React.createElement("div", { className: "text-[9px] text-slate-500 mt-0.5" }, "z > 0 = redshift (receding) \u2022 z < 0 = blueshift (approaching) \u2022 z = 1 means wavelength doubled")
                ),
                // Real examples
                    ...
                    return React.createElement("div", { key: rei, className: "flex items-start gap-2 bg-slate-800 rounded-lg p-2 border border-slate-700" },
                      ...
                      React.createElement("div", { className: "flex-1" },
                        React.createElement("div", { className: "flex items-center gap-1.5" },
                          React.createElement("span", { className: "text-[10px] font-bold text-white" }, re.name),
                          React.createElement("span", { className: "text-[8px] px-1.5 py-0.5 rounded-full font-bold " + (re.type === 'blueshift' ? 'bg-blue-900 text-blue-300' : 'bg-red-900 text-red-300') }, re.type + " z=" + re.z)
                        ),
                        React.createElement("div", { className: "text-[9px] text-slate-500" }, "Velocity: " + re.vel),
                        React.createElement("div", { className: "text-[9px] text-slate-400" }, re.desc)
                      )
                    );
                  })
                ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-pink-50 to-purple-50 border-pink-200') + " rounded-xl p-3 border" },
              ...
              d.showNurseries && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "Stars are born in vast clouds of gas and dust called nebulae. When regions become dense enough, gravity wins and collapse begins."),
                React.createElement("div", { className: "grid grid-cols-1 gap-2" },
                    ...
                    return React.createElement("div", { key: sni, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-pink-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("div", { className: "flex-1" },
                          ...
                          React.createElement("div", { className: "flex gap-2 text-[8px] " + (isDark ? 'text-slate-500' : 'text-slate-400') },
                            React.createElement("span", null, "\uD83D\uDCCF " + sn.dist),
                            React.createElement("span", null, "\u2194 " + sn.size)
                          )
                        )
                      ),
                      React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " mb-1" }, sn.desc),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-cyan-50 to-teal-50 border-cyan-200') + " rounded-xl p-3 border" },
              ...
              d.showPNebulae && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "When low-mass stars (like our Sun) die, they shed their outer layers into gorgeous expanding shells of glowing gas. The hot white dwarf core illuminates them from within. Despite the name, they have nothing to do with planets!"),
                React.createElement("div", { className: "grid grid-cols-1 gap-2" },
                  PLANETARY_NEBULAE.map(function(pn, pni) {
                    return React.createElement("div", { key: pni, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-cyan-100') + " rounded-lg p-2.5 border" },
                      ...
                      React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, pn.desc)
                    );
                  })
                )
              )
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-orange-50 to-red-50 border-orange-200') + " rounded-xl p-3 border" },
              ...
              d.showCatastrophes && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "The universe is not always peaceful. Here are some of the most violent events that can occur in space:"),
                React.createElement("div", { className: "space-y-2" },
                  COSMIC_CATASTROPHES.map(function(cc, cci) {
                    return React.createElement("div", { key: cci, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-orange-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("span", { className: "ml-auto text-[8px] px-1.5 py-0.5 rounded-full font-bold " + (isDark ? 'bg-red-900 text-red-300' : 'bg-red-100 text-red-600') }, cc.energy)
                      ),
                      React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " mb-1" }, cc.desc),
                      React.createElement("div", { className: "flex items-center gap-2 text-[8px]" },
                        React.createElement("span", { className: (isDark ? 'text-amber-400' : 'text-amber-600') + " font-bold" }, "\u26A0 Danger: " + cc.danger),
                        React.createElement("span", { className: isDark ? 'text-slate-600' : 'text-slate-400' }, "\u2022 Frequency: " + cc.freq)
                      ),
                      React.createElement("button", {
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-slate-900') + " rounded-xl p-3 border border-indigo-600" },
              ...
              d.showSpectrum && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] text-slate-400 italic mb-2" }, "Astronomers observe the universe across the entire electromagnetic spectrum. Each type of light reveals different cosmic phenomena invisible to our eyes."),
                  ...
                  EM_SPECTRUM.map(function(em, emi) {
                    ...
                    return React.createElement("div", {
                      ...
                      isActive && React.createElement("div", { className: "mt-1.5 space-y-1" },
                        React.createElement("div", { className: "text-[9px] text-slate-400" }, em.desc),
                        React.createElement("div", { className: "text-[9px] text-indigo-300" }, "\uD83D\uDD2D Sees: " + em.sees),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-violet-50 to-indigo-50 border-violet-200') + " rounded-xl p-3 border" },
              ...
              d.showScale && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "From quarks to the observable universe \u2014 a journey across 44 orders of magnitude:"),
                // Zoom slider
                React.createElement("div", { className: "flex items-center gap-2 mb-2" },
                  React.createElement("span", { className: "text-[8px] " + (isDark ? 'text-violet-400' : 'text-violet-500') }, "Quarks"),
                  React.createElement("input", {
                  ...
                  React.createElement("span", { className: "text-[8px] " + (isDark ? 'text-violet-400' : 'text-violet-500') }, "Universe")
                ),
                ...
                (function() {
                  ...
                  return React.createElement("div", { className: "text-center p-3 rounded-xl " + (isDark ? 'bg-slate-700' : 'bg-white') + " border " + (isDark ? 'border-slate-600' : 'border-violet-200') + (isHuman ? ' ring-2 ring-violet-400' : '') },
                    ...
                    React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, cs.desc),
                    isHuman && React.createElement("div", { className: "text-[9px] font-bold text-violet-500 mt-1" }, "\u2B50 You are here!")
                  );
                })(),
                // Scale ladder
                    ...
                    COSMIC_SCALES.map(function(cs2, csi) {
                      ...
                      return React.createElement("div", { key: csi,
                        ...
                        React.createElement("div", { className: "flex items-center gap-1.5" },
                          ...
                          React.createElement("span", { className: "text-[9px] font-bold " + (isDark ? (isActive ? 'text-white' : 'text-slate-400') : (isActive ? 'text-slate-800' : 'text-slate-500')) }, cs2.name),
                          React.createElement("span", { className: "text-[8px] font-mono " + (isDark ? 'text-slate-600' : 'text-slate-400') }, "10^" + cs2.power + " m")
                        )
                      );
                    })
                  )
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-indigo-50 to-red-50 border-indigo-200') + " rounded-xl p-3 border" },
              ...
              d.showSpectral && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-1" }, "Stars are classified by surface temperature into spectral types: O, B, A, F, G, K, M."),
                React.createElement("div", { className: "text-center text-[10px] font-bold mb-2 py-1 rounded-lg " + (isDark ? 'bg-slate-700 text-indigo-300' : 'bg-indigo-100 text-indigo-700') }, "\uD83D\uDCA1 Mnemonic: \"Oh Be A Fine Girl/Guy, Kiss Me\""),
                // Color bar
                ...
                React.createElement("div", { className: "flex justify-between text-[7px] " + (isDark ? 'text-slate-500' : 'text-slate-400') + " mb-2" },
                  ...
                  return React.createElement("div", { className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-indigo-100') + " rounded-xl p-3 border-2 transition-all", style: { borderColor: sc.color } },
                    React.createElement("div", { className: "flex items-center gap-3 mb-2" },
                      ...
                      React.createElement("div", { className: "flex-1" },
                        ...
                        React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, "Example: " + sc.example + " \u2022 " + sc.pct + " of all stars")
                      )
                    ),
                    React.createElement("div", { className: "grid grid-cols-4 gap-1.5 mb-2" },
                      [
                        ...
                        return React.createElement("div", { key: stat.label, className: "text-center text-[8px] p-1 rounded " + (isDark ? 'bg-slate-600' : 'bg-slate-50') },
                          React.createElement("div", { className: "font-bold " + (isDark ? 'text-slate-200' : 'text-slate-700') }, stat.val),
                          React.createElement("div", { className: isDark ? 'text-slate-500' : 'text-slate-400' }, stat.label)
                        );
                      })
                    ),
                    React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-300' : 'text-slate-600') }, sc.desc),
                    sc.class === 'G' && React.createElement("div", { className: "mt-1 text-[9px] font-bold text-amber-500" }, "\u2600\uFE0F Our Sun is a G2V star!"),
                    React.createElement("button", {
                ...
                React.createElement("div", { className: "flex gap-1 mt-2 justify-center" },
                  SPECTRAL_CLASSES.map(function(sc, sci) {
                    ...
                    return React.createElement("button", { key: sci,
                      onClick: function() { upd('spectralIdx', sci); playBeep(); },
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-green-50 to-emerald-50 border-green-200') + " rounded-xl p-3 border" },
              ...
              d.showGravity && React.createElement("div", null,
                React.createElement("div", { className: "flex items-center gap-2 mb-2" },
                  React.createElement("label", { className: "text-[10px] font-bold " + (isDark ? 'text-slate-300' : 'text-slate-600') }, "Your weight on Earth (kg):"),
                  React.createElement("input", {
                  ...
                  React.createElement("span", { className: "text-[9px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, "(" + Math.round((d.earthWeight || 70) * 2.205) + " lbs)")
                ),
                React.createElement("div", { className: "grid grid-cols-2 gap-1.5" },
                  GRAVITY_BODIES.map(function(gb, gbi) {
                    ...
                    return React.createElement("div", { key: gbi, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-green-100') + " rounded-lg p-2 border text-center " + (isEarth ? 'ring-2 ring-green-400' : '') },
                      ...
                      React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, gb.name),
                      React.createElement("div", { className: "text-sm font-black " + (isDark ? 'text-green-300' : 'text-green-600') }, gb.g > 1000 ? 'N/A' : w.toFixed(1) + " kg"),
                      React.createElement("div", { className: "text-[8px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, gb.g < 100 ? gb.g + "g" : gb.g.toExponential(1) + "g"),
                      React.createElement("div", { className: "text-[8px] " + (isDark ? 'text-slate-500' : 'text-slate-400') + " italic" }, gb.desc)
                    );
                  })
                )
              )
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-sky-50 to-indigo-50 border-sky-200') + " rounded-xl p-3 border" },
              ...
              d.showImages && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "These photographs didn't just capture light \u2014 they transformed humanity's understanding of our place in the cosmos."),
                React.createElement("div", { className: "space-y-2" },
                  FAMOUS_IMAGES.map(function(fi, fii) {
                    ...
                    return React.createElement("div", { key: fii,
                      ...
                      React.createElement("div", { className: "flex items-center gap-2" },
                        ...
                        React.createElement("span", { className: "ml-auto text-[8px] px-1.5 py-0.5 rounded-full " + (isDark ? 'bg-sky-900 text-sky-300' : 'bg-sky-100 text-sky-600') }, fi.mission)
                      ),
                      isActive && React.createElement("div", { className: "mt-2 space-y-1" },
                        React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-300' : 'text-slate-600') }, fi.desc),
                        React.createElement("div", { className: "text-[9px] font-bold " + (isDark ? 'text-sky-400' : 'text-sky-600') }, "\uD83D\uDCA1 Impact: " + fi.impact),
                        React.createElement("button", {
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-amber-50 to-yellow-50 border-amber-200') + " rounded-xl p-3 border" },
              ...
              d.showSpeeds && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "How does your walking speed compare to the speed of light? Spoiler: not great."),
                React.createElement("div", { className: "space-y-1.5" },
                  COSMIC_SPEEDS.map(function(cs, csi) {
                    ...
                    return React.createElement("div", { key: csi, className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-amber-100') },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("span", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') + " flex-1" }, cs.name),
                        React.createElement("span", { className: "text-[9px] font-mono " + (isDark ? 'text-amber-300' : 'text-amber-600') }, cs.speed)
                      ),
                      React.createElement("div", { className: "flex items-center gap-1.5" },
                        ...
                        React.createElement("span", { className: "text-[8px] font-mono w-16 text-right " + (isDark ? 'text-slate-500' : 'text-slate-400') }, cs.frac + " c")
                      )
                    );
                  })
                ),
                React.createElement("div", { className: "mt-2 text-center text-[9px] " + (isDark ? 'text-amber-400' : 'text-amber-600') + " font-bold" }, "\u26A1 At walking speed, reaching the nearest star would take ~1 million years. Light does it in 4.24 years.")
              )
            ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-teal-50 to-cyan-50 border-teal-200') + " rounded-xl p-3 border" },
              ...
              d.showCitizenSci && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "You don't need a PhD to contribute to real astronomical research! These projects let students and anyone with a browser help make real discoveries:"),
                React.createElement("div", { className: "space-y-2" },
                    ...
                    return React.createElement("div", { key: csi, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-teal-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("div", { className: "flex-1" },
                          ...
                          React.createElement("span", { className: "ml-1.5 text-[8px] px-1.5 py-0.5 rounded-full " + (isDark ? 'bg-teal-900 text-teal-300' : 'bg-teal-100 text-teal-600') }, cs.field)
                        )
                      ),
                      React.createElement("div", { className: "text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " mb-1" }, cs.desc),
                      React.createElement("div", { className: "text-[8px] font-mono " + (isDark ? 'text-teal-400' : 'text-teal-600') }, "\uD83C\uDF10 " + cs.url)
                    );
                  })
                )
              )
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-stone-50 to-slate-50 border-stone-200') + " rounded-xl p-3 border" },
              ...
              d.showGlossary && React.createElement("div", null,
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic mb-2" }, "Key terms every aspiring cosmologist should know:"),
                React.createElement("div", { className: "space-y-1 max-h-72 overflow-y-auto" },
                  COSMO_GLOSSARY.map(function(gl, gli) {
                    ...
                    return React.createElement("div", { key: gli,
                      ...
                      React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, gl.term),
                      isActive && React.createElement("div", { className: "mt-1 text-[9px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, gl.def)
                    );
                  })
                )
              )
            ...
            React.createElement("div", { className: "mt-3 flex items-center justify-between" },
              ...
              React.createElement("span", { className: "text-[10px] " + (isDark ? 'text-slate-500' : 'text-slate-400') }, "\uD83C\uDF20 Epochs visited: " + epochsVisited.length + "/9")
            ),
