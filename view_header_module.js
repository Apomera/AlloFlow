...
function HeaderBar(props) {
  ...
  ), isLiveStatusOpen && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { ref: _liveStatusRef, tabIndex: -1, role: "dialog", "aria-modal": "true", "aria-labelledby": "header-live-status-title", "data-live-status-dialog": "", className: "absolute top-full right-0 mt-2 w-72 max-w-[calc(100vw-1.5rem)] bg-white rounded-xl shadow-2xl border border-slate-200 p-3 z-[100] text-left text-slate-800" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-2 border-b border-slate-200 pb-2 mb-2" }, /* @__PURE__ */ React.createElement("h2", { id: "header-live-status-title", className: "text-sm font-black text-slate-800" }, _isHomeworkStatus ? "Homework" : "Live session"), /* @__PURE__ */ React.createElement("button", { type: "button", "data-autofocus": true, onClick: handleCloseLiveStatus, "aria-label": t("common.close") || "Close", className: "min-w-6 min-h-6 rounded text-slate-500 hover:text-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-500" }, "\u2715")), /* @__PURE__ */ React.createElement("div", { className: "space-y-1.5 text-xs" }, !_isHomeworkStatus && /* @__PURE__ */ React.createElement("div", { className: "flex items-baseline justify-between gap-3" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-600" }, t("session.code") || "Class code"), /* @__PURE__ */ React.createElement("span", { className: "font-mono font-bold" }, activeSessionCode)), /* @__PURE__ */ React.createElement("div", { className: "flex items-baseline justify-between gap-3" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-600" }, "Codename"), /* @__PURE__ */ React.createElement("span", { className: "truncate" }, liveStatus && liveStatus.nickname || "Student")), /* @__PURE__ */ React.createElement("div", { className: "flex items-baseline justify-between gap-3" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-600" }, "AI"), /* @__PURE__ */ React.createElement("span", null, _liveAiLabel)), !_isHomeworkStatus && /* @__PURE__ */ React.createElement("div", { className: "flex items-baseline justify-between gap-3" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-slate-600" }, "Connection"), /* @__PURE__ */ React.createElement("span", { className: _liveConnected ? "font-bold text-emerald-700" : "font-bold text-amber-800", role: "status" }, _liveConnectionLabel))), liveStatus && liveStatus.signals && Array.isArray(liveStatus.signals.options) && liveStatus.signals.options.length > 0 && /* @__PURE__ */ React.createElement("fieldset", { className: "mt-3 rounded-lg border border-slate-200 bg-slate-50 p-2", "data-live-signals": "" }, /* @__PURE__ */ React.createElement("legend", { className: "px-1 text-[11px] font-bold uppercase tracking-wide text-slate-600" }, t("live_signals.title") || "Send your teacher a signal"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-1.5" }, liveStatus.signals.options.map((opt) => /* @__PURE__ */ React.createElement("button", { key: opt.id, type: "button", "aria-pressed": _liveSignalCurrent ? _liveSignalCurrent.id === opt.id : false, onClick: () => {
    liveStatus.signals.send(opt.id);
    handleCloseLiveStatus();
  }, className: `min-h-9 rounded-lg border px-2.5 py-1.5 text-left text-xs font-semibold leading-tight ${_liveSignalCurrent && _liveSignalCurrent.id === opt.id ? "border-amber-400 bg-amber-100 text-amber-900" : "border-slate-300 bg-white text-slate-800 hover:bg-slate-100"}` }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, opt.emoji, " "), opt.label))), _liveSignalCurrent && /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => liveStatus.signals.clear(), className: "mt-1.5 text-[11px] font-bold text-indigo-700 hover:text-indigo-900" }, t("live_signals.clear") || "Clear my signal"), /* @__PURE__ */ React.createElement("p", { className: "mt-1.5 text-[10px] leading-snug text-slate-500" }, liveStatus.signals.privacyNote)), /* @__PURE__ */ React.createElement("div", { className: "mt-3 flex flex-wrap gap-2" }, liveStatus && typeof liveStatus.changeCodename === "function" && /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => {
    handleCloseLiveStatus();
