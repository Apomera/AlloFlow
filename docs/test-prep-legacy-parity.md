...
| Learning chapters, diagrams, checks, flashcards, and memory aids | Structurally migrated; flashcard first pass complete | All 49 EPPP chapters and all 415 legacy flashcards have source-review records. Flashcard review retained 336 distinct rewritten targets and explicitly retired 79 redundant cards. Independent qualified expert validation and release decisions remain pending, and memory aids, term definitions, and diagrams retain separate review gates. |
...
- Flashcard review wave 04 completed the remaining 106-card first pass across all eight domains. All 106 were accuracy-rewritten and source-aligned; 27 distinct targets were retained and 79 duplicate targets were explicitly retired rather than used to inflate the learner bank. The full 415-card legacy collection now has source-review provenance, with 336 retained candidates and 79 retired duplicates; every card remains learner-hidden pending independent qualified expert validation and release decisions.
