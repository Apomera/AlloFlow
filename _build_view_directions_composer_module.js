...
function build({ writeFile = fs.writeFileSync } = {}) {
  ...
  for (const file of ['view_directions_composer_module.js', 'desktop/web-app/public/view_directions_composer_module.js']) writeFile(path.join(__dirname, file), output);
  return output;
}
