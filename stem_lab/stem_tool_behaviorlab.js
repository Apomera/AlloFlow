            ...
            return React.createElement("div", { className: "behaviorlab-tool-shell behaviorlab-intro space-y-4", role: "main", "aria-label": __alloT('stem.behaviorlab.behavior_lab', "Behavior Lab"), "data-behaviorlab-tool": "intro" },
              ...
              (function() {
                ...
                return React.createElement("div", { style: { marginTop: 14, padding: 12, borderRadius: 12, background: sm.bg, border: '1px solid ' + sm.border, color: '#e8f0f5' } },
                  React.createElement("h4", { style: { margin: '0 0 4px', fontSize: 12, fontWeight: 800, color: sm.color, textTransform: 'uppercase', letterSpacing: 1 } }, __alloT('stem.behaviorlab.reinforcement_inquiry_predict_persiste', '\uD83D\uDD2C Reinforcement Inquiry \u2014 Explore Persistence')),
                  React.createElement("p", { style: { margin: '0 0 6px', fontSize: 10, opacity: 0.85, lineHeight: 1.4 } }, __alloT('stem.behaviorlab.set_schedule_reinforcer_strength_alter', 'Set schedule, reinforcer strength, alternatives, and extinction time, then observe how the persistence band changes. The result updates live; record a hypothesis or pattern you notice.')),
