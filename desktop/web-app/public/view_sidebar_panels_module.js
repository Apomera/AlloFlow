...
function SimplifiedPanel(props) {
  ...
  ), /* @__PURE__ */ React.createElement("label", { htmlFor: "includeCharts", className: "text-xs font-medium text-slate-700 cursor-pointer select-none flex items-center gap-1" }, /* @__PURE__ */ React.createElement(Layout, { size: 12, className: "text-indigo-500" }), " ", t("simplified.data_visuals"))))), /* @__PURE__ */ React.createElement("p", { className: "my-3 text-sm text-slate-700" }, "Read the original with supports, or create a companion to preview ideas and build context for reading the original."), /* @__PURE__ */ React.createElement("button", { type: "button", "data-read-original": true, onClick: () => handleReadOriginal && handleReadOriginal(), disabled: !hasSourceOrAnalysis || isProcessing, className: SIDEBAR_PANEL_UI.primaryAction }, "Read original with supports"), !aiTextAvailable && /* @__PURE__ */ React.createElement(AiSetupNotice, { t }), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
