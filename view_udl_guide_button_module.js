...
function UDLGuideButton({ handleToggleShowUDLGuide, showUDLGuide, t, subtitle }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: `p-2 rounded-2xl ${showUDLGuide ? "bg-indigo-700" : "bg-indigo-100 text-indigo-600"}` }, /* @__PURE__ */ React.createElement(MessageSquare, { size: 20, "aria-hidden": "true" })), /* @__PURE__ */ React.createElement("div", { className: "text-left" }, /* @__PURE__ */ React.createElement("div", { className: "font-bold text-sm" }, t("sidebar.ai_guide")), /* @__PURE__ */ React.createElement("div", { className: `text-xs ${showUDLGuide ? "text-indigo-200" : "text-slate-600"}` }, subtitle || t("sidebar.ai_guide_sub")))),
    showUDLGuide ? /* @__PURE__ */ React.createElement(ChevronDown, { size: 20, "aria-hidden": "true" }) : /* @__PURE__ */ React.createElement(ArrowRight, { size: 20, "aria-hidden": "true", className: "opacity-50 group-hover:opacity-100 transition-opacity" })
  );
}
