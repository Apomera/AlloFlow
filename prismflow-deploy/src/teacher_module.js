...
var LongitudinalProgressChart = React.memo(({ logs }) => {
  const { t } = useContext(LanguageContext);
  if (!logs || logs.length < 2) return /* @__PURE__ */ React.createElement("div", { className: "w-full bg-white p-6 rounded-xl border border-slate-400 shadow-sm mt-4 flex flex-col items-center justify-center text-slate-500 italic gap-2" }, /* @__PURE__ */ React.createElement(History, { size: 24, className: "opacity-50" }), /* @__PURE__ */ React.createElement("span", { className: "text-xs" }, t("dashboard.progress_chart.empty_msg")));
  const width = 600;
  const height = 200;
  const padding = 30;
...
var LearnerProgressView = React.memo(({
  ...
  ].map((item) => /* @__PURE__ */ React.createElement("div", { key: item.label, className: `${item.color} rounded-lg px-3 py-2 text-center` }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black" }, item.icon, " ", item.value), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold uppercase tracking-wider opacity-80" }, item.label))))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-slate-400 shadow-sm p-5 hover:shadow-md transition-shadow" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Target, { size: 14 }), " Skills Progress"), stats.wsTotal === 0 && Object.keys(phonemeMastery).length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "text-center py-6 text-slate-500 italic text-sm" }, /* @__PURE__ */ React.createElement(BookOpen, { size: 32, className: "mx-auto mb-2 opacity-40" }), "Start practicing to see your skills grow!") : /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, stats.wsTotal > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-1" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold text-slate-600" }, t("learner.ws_accuracy")), /* @__PURE__ */ React.createElement("span", { className: `text-sm font-black ${stats.wsAccuracy >= 80 ? "text-green-600" : stats.wsAccuracy >= 60 ? "text-yellow-600" : "text-orange-500"}` }, stats.wsAccuracy, "%")), /* @__PURE__ */ React.createElement("div", { className: "w-full bg-slate-100 rounded-full h-2.5" }, /* @__PURE__ */ React.createElement(
    "div",
    {
  ...
  })(), studentProgressLog.length >= 2 && /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-slate-400 shadow-sm p-5 hover:shadow-md transition-shadow" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(TrendingUp, { size: 14 }), " Growth Over Time"), /* @__PURE__ */ React.createElement(LongitudinalProgressChart, { logs: studentProgressLog })), showDiagnostics && /* @__PURE__ */ React.createElement("div", { className: "bg-slate-50 rounded-2xl border border-slate-400 p-5 space-y-4 animate-in slide-in-from-top-2 duration-300" }, /* @__PURE__ */ React.createElement("h3", { className: "text-xs font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(BarChart3, { size: 14 }), " Detailed Metrics"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 border border-slate-400 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-slate-700" }, stats.wsCorrect, "/", stats.wsTotal), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, t("learner.words_correct"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 border border-slate-400 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-slate-700" }, Object.keys(phonemeMastery).length), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, t("learner.phonemes_touched"))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 border border-slate-400 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-slate-700" }, stats.sessionCount), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, "Sessions")), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl p-3 border border-slate-400 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "text-lg font-black text-slate-700" }, stats.labelChallenges), /* @__PURE__ */ React.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, t("learner.label_challenges")))), pointHistory.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h4", { className: "text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2" }, t("learner.recent_activity")), /* @__PURE__ */ React.createElement("div", { className: "space-y-1 max-h-32 overflow-y-auto" }, pointHistory.slice(0, 10).map((entry, i) => /* @__PURE__ */ React.createElement("div", { key: entry.id || i, className: "flex justify-between items-center text-xs px-2 py-1 rounded hover:bg-white" }, /* @__PURE__ */ React.createElement("span", { className: "text-slate-600 font-medium truncate max-w-[200px]" }, entry.activity), /* @__PURE__ */ React.createElement("span", { className: "font-bold text-green-600" }, "+", entry.points, " XP")))))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap justify-center gap-3 pt-2" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
...
var TeacherDashboard = React.memo(({ onClose, dashboardData = [], setDashboardData, addToast: addToast2, setSelectedStudentId, setDashboardView, dashboardView, selectedStudentId, generateResourceHTML, onOpenBehaviorLens }) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-slate-400 flex flex-col items-center" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-bold text-slate-500 uppercase tracking-wider mb-4" }, t("dashboard.insights.avg_score")), /* @__PURE__ */ React.createElement(
      SimpleDonutChart,
      {
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-slate-400 flex flex-col items-center" }, /* @__PURE__ */ React.createElement("h3", { className: "text-sm font-bold text-slate-500 uppercase tracking-wider mb-4" }, t("dashboard.insights.quiz_completion")), /* @__PURE__ */ React.createElement(
      SimpleDonutChart,
      {
  ...
  return /* @__PURE__ */ React.createElement("span", { key: toolId, className: "bg-white text-slate-600 text-[10px] font-medium px-2 py-1 rounded-lg border border-slate-400" }, "\u{1F9EA} ", meta ? meta.name : toolId);
