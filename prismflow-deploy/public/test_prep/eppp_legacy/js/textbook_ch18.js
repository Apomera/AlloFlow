    ...
    sections: [
        ...
        },
        {
            ...
            interactiveDiagram: {
                ...
                svg: '<svg viewBox="0 0 800 300" width="100%" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="robertsTitle robertsDesc"><title id="robertsTitle">Roberts seven-stage crisis intervention framework</title><desc id="robertsDesc">An educational seven-stage framework moves through assessment, rapport, problem identification, emotional exploration, alternatives, action, and follow-up. In practice stages can overlap, recur, or change order when immediate safety requires action.</desc><defs><linearGradient id="robGrad" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#ef4444"/><stop offset="100%" stop-color="#3b82f6"/></linearGradient></defs><text x="400" y="25" text-anchor="middle" fill="#cbd5e1" font-weight="bold" font-size="16">Roberts\' Seven-Stage Crisis Intervention Staircase</text><g transform="translate(40, 60)"><rect x="0" y="180" width="95" height="40" rx="6" fill="#ef4444" opacity="0.9"/><text x="47" y="198" text-anchor="middle" fill="#fff" font-weight="bold" font-size="14">1. Assess</text><text x="47" y="213" text-anchor="middle" fill="#fecaca" font-size="9">Lethality/Safety</text><rect x="100" y="150" width="95" height="70" rx="6" fill="#f97316" opacity="0.9"/><text x="147" y="178" text-anchor="middle" fill="#fff" font-weight="bold" font-size="14">2. Rapport</text><text x="147" y="193" text-anchor="middle" fill="#fed7aa" font-size="9">Establish quickly</text><rect x="200" y="120" width="95" height="100" rx="6" fill="#f59e0b" opacity="0.9"/><text x="247" y="148" text-anchor="middle" fill="#fff" font-weight="bold" font-size="14">3. Identify</text><text x="247" y="163" text-anchor="middle" fill="#fde68a" font-size="9">Major Problem</text><rect x="300" y="90" width="95" height="130" rx="6" fill="#84cc16" opacity="0.9"/><text x="347" y="118" text-anchor="middle" fill="#fff" font-weight="bold" font-size="14">4. Feelings</text><text x="347" y="133" text-anchor="middle" fill="#d9f99d" font-size="9">Explore emotions</text><rect x="400" y="60" width="95" height="160" rx="6" fill="#10b981" opacity="0.9"/><text x="447" y="88" text-anchor="middle" fill="#fff" font-weight="bold" font-size="14">5. Options</text><text x="447" y="103" text-anchor="middle" fill="#a7f3d0" font-size="9">Generate alternatives</text><rect x="500" y="30" width="95" height="190" rx="6" fill="#06b6d4" opacity="0.9"/><text x="547" y="58" text-anchor="middle" fill="#fff" font-weight="bold" font-size="14">6. Action</text><text x="547" y="73" text-anchor="middle" fill="#cffafe" font-size="9">Implement plan</text><rect x="600" y="0" width="95" height="220" rx="6" fill="#3b82f6" opacity="0.9"/><text x="647" y="28" text-anchor="middle" fill="#fff" font-weight="bold" font-size="14">7. Follow-up</text><text x="647" y="43" text-anchor="middle" fill="#bfdbfe" font-size="9">Check resolution</text><path d="M47,175 L147,145 L247,115 L347,85 L447,55 L547,25 L647,-5" fill="none" stroke="#fff" stroke-width="2" stroke-dasharray="4,4" opacity="0.5"/></g><text x="400" y="285" text-anchor="middle" fill="#94a3b8" font-size="11" font-style="italic">Framework, not a rigid staircase: urgent safety action and assessment may occur together</text></svg>'
            }
        },
        {
