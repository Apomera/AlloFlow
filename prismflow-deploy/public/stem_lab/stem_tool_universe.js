          ...
          return React.createElement("div", { className: "max-w-6xl mx-auto animate-in fade-in duration-200" },
              ...
              d.showStarLife && React.createElement("div", { className: "space-y-2" },
                ...
                React.createElement("div", { className: "flex gap-4 mb-2" },
                  React.createElement("div", { className: "flex-1 text-center" },
                    ...
                    React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "Cloud \u2192 Protostar \u2192 Main Seq \u2192 Red Giant \u2192 Nebula \u2192 White Dwarf")
                  ),
                  React.createElement("div", { className: "flex-1 text-center" },
                    React.createElement("div", { className: "text-[11px] font-bold text-red-600 mb-1" }, "High Mass (> 8 M\u2609)"),
                    React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "Cloud \u2192 Protostar \u2192 Main Seq \u2192 Red Giant \u2192 Supernova \u2192 Neutron Star / Black Hole")
                  )
                ),
                STAR_STAGES.map(function(stage, si) {
                  ...
                  return React.createElement("div", { role: 'button', tabIndex: 0, onKeyDown: function(e) { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); e.target.click(); } },
                    ...
                    React.createElement("div", { className: "flex items-center gap-2" },
                      ...
                      React.createElement("span", { className: "ml-auto text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, stage.duration)
                    ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-blue-50 border-blue-200') + " rounded-xl p-3 border" },
              ...
              d.showHR && React.createElement("div", null,
                ...
                React.createElement("div", { className: "mt-2 text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "The Sun is a G2V main-sequence star. It will become a red giant in ~5 billion years, then shrink to a white dwarf.")
              )
            ),
                  ...
                  return React.createElement("div", { key: ri, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-emerald-100') + " rounded-lg p-2 border" },
                    React.createElement("div", { className: "flex items-center gap-2" },
                      ...
                      React.createElement("div", { className: "flex-1" },
                        ...
                        React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, rung.dist + " \u2022 " + rung.light)
                      ),
                      React.createElement("span", { className: "text-[10px] px-1.5 py-0.5 rounded-full " + (isDark ? 'bg-emerald-900 text-emerald-300' : 'bg-emerald-100 text-emerald-600') }, rung.method)
                    )
                  );
                })
              )
                ...
                ELEMENT_ORIGINS.map(function(el, ei2) {
                  return React.createElement("div", { key: ei2, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-orange-100') + " rounded-lg p-2 border flex items-center gap-2" },
                    ...
                    React.createElement("div", { className: "flex-1" },
                      ...
                      React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, el.note)
                    ),
                    React.createElement("span", { className: "text-[11px] font-mono " + (isDark ? 'text-slate-400' : 'text-slate-500') }, el.pct)
                  );
                })
              )
            ),
                ...
                COSMIC_STRUCTURES.map(function(cs, csi) {
                  return React.createElement("div", { key: csi, className: "flex items-center gap-2 " + (isDark ? 'text-slate-300' : 'text-slate-600') },
                    ...
                    React.createElement("div", { className: "flex-1" },
                      ...
                      React.createElement("span", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " ml-1" }, "(" + cs.example + ")"),
                      React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, cs.size + " \u2022 " + cs.desc)
                    )
                  );
                })
              )
                  ...
                  return React.createElement("div", { key: ti, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-teal-100') + " rounded-lg p-2 border" },
                    React.createElement("div", { className: "flex items-center gap-2" },
                      ...
                      React.createElement("div", { className: "flex-1" },
                        ...
                        React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, tel.type)
                      )
                    ),
              ...
              d.showNumbers && React.createElement("div", { className: "grid grid-cols-2 gap-1.5" },
                COSMIC_NUMBERS.map(function(cn, cni) {
                  return React.createElement("div", { key: cni, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-indigo-100') + " rounded-lg p-2 border text-center" },
                    ...
                    React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, cn.label)
                  );
                })
              )
            ),
                ...
                GALAXY_TYPES.map(function(gt, gti) {
                  return React.createElement("div", { key: gti, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-violet-100') + " rounded-lg p-2.5 border" },
                    React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                      ...
                      React.createElement("span", { className: "ml-auto text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, gt.example)
                    ),
                ...
                BLACK_HOLE_PARTS.map(function(part, pi) {
                  return React.createElement("div", { key: pi, className: "flex items-start gap-2" },
                    ...
                    React.createElement("div", null,
                      ...
                      React.createElement("div", { className: "text-[11px] text-slate-400" }, part.desc)
                    )
                  );
                })
              )
                  ...
                  [
                    ...
                    return React.createElement("div", { key: param.key },
                      React.createElement("div", { className: "flex items-center justify-between" },
                        React.createElement("label", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, param.label + ": " + val),
                        React.createElement("span", { className: "text-[10px] " + (isDark ? 'text-slate-600' : 'text-slate-400') }, param.desc)
                      ),
              ...
              d.showObservable && React.createElement("div", { className: "space-y-2" },
                React.createElement("div", { className: "grid grid-cols-3 gap-1.5 text-center" },
                  React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-fuchsia-100') },
                    React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "Radius"),
                    React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, OBSERVABLE_UNIVERSE.radius)
                  ),
                  React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-fuchsia-100') },
                    React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "Diameter"),
                    React.createElement("div", { className: "text-[10px] font-bold " + (isDark ? 'text-white' : 'text-slate-800') }, OBSERVABLE_UNIVERSE.diameter)
                  ),
                  React.createElement("div", { className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-fuchsia-100') },
                    React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "Age"),
                ...
                React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-300' : 'text-slate-600') + " space-y-1.5" },
                  ...
                  React.createElement("div", { className: isDark ? 'text-slate-400' : 'text-slate-600' }, OBSERVABLE_UNIVERSE.whyBigger),
                  React.createElement("div", null, "\u2753 **Is there more beyond what we can see?**"),
                  React.createElement("div", { className: isDark ? 'text-slate-400' : 'text-slate-600' }, OBSERVABLE_UNIVERSE.beyondIt)
                )
              )
            ),
                    ...
                    return React.createElement("div", { key: epi, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-emerald-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("div", { className: "flex-1" },
                          ...
                          React.createElement("span", { className: "text-[11px] ml-1.5 " + (isDark ? 'text-slate-400' : 'text-slate-500') }, ep2.example)
                        ),
                        React.createElement("span", { className: "text-[10px] px-1.5 py-0.5 rounded-full font-bold " + (ep2.habitable === 'Best candidate' ? (isDark ? 'bg-green-900 text-green-300' : 'bg-green-100 text-green-600') : ep2.habitable === 'Possible' ? (isDark ? 'bg-yellow-900 text-yellow-300' : 'bg-yellow-100 text-yellow-600') : (isDark ? 'bg-slate-600 text-slate-400' : 'bg-slate-100 text-slate-500')) }, typeof ep2.habitable === 'string' ? ep2.habitable : (ep2.habitable ? 'Habitable' : 'Not habitable'))
                      ),
                      React.createElement("div", { className: "grid grid-cols-3 gap-1 mb-1.5" },
                        React.createElement("div", { className: "text-[10px] text-center " + (isDark ? 'text-slate-400' : 'text-slate-500') },
                    ...
                    return React.createElement("div", { key: smi, className: "relative" },
                      ...
                      React.createElement("div", { className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-blue-100') + " rounded-lg p-2 border" },
                        React.createElement("div", { className: "flex items-center gap-2 mb-0.5" },
                          ...
                          React.createElement("span", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, sm.agency)
                        ),
                        React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, sm.desc)
                      )
                    );
                  })
                )
                  ...
                  FERMI_SOLUTIONS.map(function(fs, fsi) {
                    ...
                    return React.createElement("div", { key: fsi, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-amber-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("span", { className: "ml-auto text-[10px] px-1.5 py-0.5 rounded-full font-bold " + (typeColors[fs.type] || 'text-slate-400') + " " + (isDark ? 'bg-slate-600' : 'bg-slate-100') }, fs.type)
                      ),
                  ...
                  LENSING_EXAMPLES.map(function(le, lei) {
                    return React.createElement("div", { key: lei, className: "flex items-start gap-2" },
                      ...
                      React.createElement("div", null,
                        ...
                        React.createElement("span", { className: "text-[10px] ml-1.5 px-1 py-0.5 rounded " + (le.type === 'Strong lensing' ? 'bg-indigo-900 text-indigo-300' : le.type === 'Weak lensing' ? 'bg-purple-900 text-purple-300' : 'bg-cyan-900 text-cyan-300') }, le.type),
                        React.createElement("div", { className: "text-[11px] text-slate-400" }, le.desc)
                      )
                    );
                  })
                )
                  ...
                  COSMIC_MYSTERIES.map(function(cm, cmi) {
                    ...
                    return React.createElement("div", { key: cmi, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-rose-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("span", { className: "ml-auto text-[10px] px-1.5 py-0.5 rounded-full font-bold " + uc }, cm.urgency)
                      ),
                    ...
                    return React.createElement("div", { key: mti, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-purple-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("div", { className: "flex-1" },
                          ...
                          React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, mt2.source)
                        )
                      ),
                    ...
                    return React.createElement("div", { key: rei, className: "flex items-start gap-2 bg-slate-800 rounded-lg p-2 border border-slate-700" },
                      ...
                      React.createElement("div", { className: "flex-1" },
                        React.createElement("div", { className: "flex items-center gap-1.5" },
                          ...
                          React.createElement("span", { className: "text-[10px] px-1.5 py-0.5 rounded-full font-bold " + (re.type === 'blueshift' ? 'bg-blue-900 text-blue-300' : 'bg-red-900 text-red-300') }, re.type + " z=" + re.z)
                        ),
                        React.createElement("div", { className: "text-[11px] text-slate-500" }, "Velocity: " + re.vel),
                        React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, re.desc)
                      )
                    );
                  })
                ),
                    ...
                    return React.createElement("div", { key: sni, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-pink-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("div", { className: "flex-1" },
                          ...
                          React.createElement("div", { className: "flex gap-2 text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') },
                      ...
                      React.createElement("div", { className: "text-[10px] font-medium " + (isDark ? 'text-pink-400' : 'text-pink-600') }, "\u2B50 Features: " + sn.features),
                ...
                React.createElement("div", { className: "grid grid-cols-1 gap-2" },
                  PLANETARY_NEBULAE.map(function(pn, pni) {
                    return React.createElement("div", { key: pni, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-cyan-100') + " rounded-lg p-2.5 border" },
                      ...
                      React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, pn.desc)
                    );
                  })
                )
              )
                  ...
                  COSMIC_CATASTROPHES.map(function(cc, cci) {
                    return React.createElement("div", { key: cci, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-orange-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("span", { className: "ml-auto text-[10px] px-1.5 py-0.5 rounded-full font-bold " + (isDark ? 'bg-red-900 text-red-300' : 'bg-red-100 text-red-600') }, cc.energy)
                      ),
                      React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " mb-1" }, cc.desc),
                      React.createElement("div", { className: "flex items-center gap-2 text-[10px]" },
                        ...
                        React.createElement("span", { className: isDark ? 'text-slate-400' : 'text-slate-600' }, "\u2022 Frequency: " + cc.freq)
                      ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-violet-50 to-indigo-50 border-violet-200') + " rounded-xl p-3 border" },
              ...
              d.showScale && React.createElement("div", null,
                ...
                // Zoom slider
                React.createElement("div", { className: "flex items-center gap-2 mb-2" },
                  React.createElement("span", { className: "text-[10px] " + (isDark ? 'text-violet-400' : 'text-violet-500') }, "Quarks"),
                  React.createElement("input", {
                  ...
                  React.createElement("span", { className: "text-[10px] " + (isDark ? 'text-violet-400' : 'text-violet-500') }, "Universe")
                ),
                    ...
                    COSMIC_SCALES.map(function(cs2, csi) {
                      ...
                      return React.createElement("div", { role: "button", tabIndex: 0, onKeyDown: function(e) { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); e.target.click(); } },  key: csi,
                        ...
                        React.createElement("div", { className: "flex items-center gap-1.5" },
                          ...
                          React.createElement("span", { className: "text-[11px] font-bold " + (isDark ? (isActive ? 'text-white' : 'text-slate-400') : (isActive ? 'text-slate-800' : 'text-slate-500')) }, cs2.name),
                          React.createElement("span", { className: "text-[10px] font-mono " + (isDark ? 'text-slate-600' : 'text-slate-400') }, "10^" + cs2.power + " m")
                        )
                      );
                    })
                  )
                  ...
                  return React.createElement("div", { className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-indigo-100') + " rounded-xl p-3 border-2 transition-all", style: { borderColor: sc.color } },
                    React.createElement("div", { className: "flex items-center gap-3 mb-2" },
                      ...
                      React.createElement("div", { className: "flex-1" },
                        ...
                        React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "Example: " + sc.example + " \u2022 " + sc.pct + " of all stars")
                      )
                    ),
                    React.createElement("div", { className: "grid grid-cols-4 gap-1.5 mb-2" },
                      [
                        ...
                        return React.createElement("div", { key: stat.label, className: "text-center text-[10px] p-1 rounded " + (isDark ? 'bg-slate-600' : 'bg-slate-50') },
                          React.createElement("div", { className: "font-bold " + (isDark ? 'text-slate-200' : 'text-slate-700') }, stat.val),
                          React.createElement("div", { className: isDark ? 'text-slate-400' : 'text-slate-600' }, stat.label)
                        );
                      })
                    ),
            ...
            React.createElement("div", { className: "mt-3 " + (isDark ? 'bg-slate-800 border-slate-700' : 'bg-gradient-to-b from-green-50 to-emerald-50 border-green-200') + " rounded-xl p-3 border" },
              ...
              d.showGravity && React.createElement("div", null,
                React.createElement("div", { className: "flex items-center gap-2 mb-2" },
                  ...
                  React.createElement("span", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, "(" + Math.round((d.earthWeight || 70) * 2.205) + " lbs)")
                ),
                React.createElement("div", { className: "grid grid-cols-2 gap-1.5" },
                  GRAVITY_BODIES.map(function(gb, gbi) {
                    ...
                    return React.createElement("div", { key: gbi, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-green-100') + " rounded-lg p-2 border text-center " + (isEarth ? 'ring-2 ring-green-400' : '') },
                      ...
                      React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, gb.g < 100 ? gb.g + "g" : gb.g.toExponential(1) + "g"),
                      React.createElement("div", { className: "text-[10px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " italic" }, gb.desc)
                    );
                  })
                )
              )
                  ...
                  FAMOUS_IMAGES.map(function(fi, fii) {
                    ...
                    return React.createElement("div", { role: "button", tabIndex: 0, onKeyDown: function(e) { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); e.target.click(); } },  key: fii,
                      ...
                      React.createElement("div", { className: "flex items-center gap-2" },
                        ...
                        React.createElement("span", { className: "ml-auto text-[10px] px-1.5 py-0.5 rounded-full " + (isDark ? 'bg-sky-900 text-sky-300' : 'bg-sky-100 text-sky-600') }, fi.mission)
                      ),
                      isActive && React.createElement("div", { className: "mt-2 space-y-1" },
                  ...
                  COSMIC_SPEEDS.map(function(cs, csi) {
                    ...
                    return React.createElement("div", { key: csi, className: (isDark ? 'bg-slate-700' : 'bg-white') + " rounded-lg p-2 border " + (isDark ? 'border-slate-600' : 'border-amber-100') },
                      ...
                      React.createElement("div", { className: "flex items-center gap-1.5" },
                        ...
                        React.createElement("span", { className: "text-[10px] font-mono w-16 text-right " + (isDark ? 'text-slate-400' : 'text-slate-500') }, cs.frac + " c")
                      )
                    );
                  })
                ),
                    ...
                    return React.createElement("div", { key: csi, className: (isDark ? 'bg-slate-700 border-slate-600' : 'bg-white border-teal-100') + " rounded-lg p-2.5 border" },
                      React.createElement("div", { className: "flex items-center gap-2 mb-1" },
                        ...
                        React.createElement("div", { className: "flex-1" },
                          ...
                          React.createElement("span", { className: "ml-1.5 text-[10px] px-1.5 py-0.5 rounded-full " + (isDark ? 'bg-teal-900 text-teal-300' : 'bg-teal-100 text-teal-600') }, cs.field)
                        )
                      ),
                      React.createElement("div", { className: "text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') + " mb-1" }, cs.desc),
                      React.createElement("div", { className: "text-[10px] font-mono " + (isDark ? 'text-teal-400' : 'text-teal-600') }, "\uD83C\uDF10 " + cs.url)
                    );
                  })
                )
              )
                ...
                React.createElement("div", { className: "space-y-1 max-h-72 overflow-y-auto" },
                  COSMO_GLOSSARY.map(function(gl, gli) {
                    ...
                    return React.createElement("div", { role: "button", tabIndex: 0, onKeyDown: function(e) { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); e.target.click(); } },  key: gli,
                      ...
                      isActive && React.createElement("div", { className: "mt-1 text-[11px] " + (isDark ? 'text-slate-400' : 'text-slate-500') }, gl.def)
                    );
                  })
                )
              )
