...
console.log('[ResearchLaneEngineering] Compiling ...');
try {
...
console.log(`[ResearchLaneEngineering] Built ${OUTPUT} (${cleaned.split('\n').length} lines)`);
console.log(`[ResearchLaneEngineering] Mirrored to ${MIRROR}`);
