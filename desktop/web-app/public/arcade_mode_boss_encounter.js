        ...
        if (ctx.isHost) {
          ...
          return h('button', {
            ...
            style: {
              ...
              borderRadius: '8px',
              cursor: (disabled || deckSize < 3) ? 'not-allowed' : 'pointer',
              fontFamily: 'inherit',
              color: palette.text || '#e2e8f0',
              textAlign: 'left',
              marginBottom: '10px',
              opacity: (disabled || deckSize < 3) ? 0.6 : 1
            }
          },
            ...
            h('span', { style: { flex: 1 } },
              ...
              h('div', { style: { fontSize: '11px', color: palette.textDim || '#cbd5e1', marginTop: '2px' } },
                'Pick a topic; students in session ' + ctx.sessionCode + ' can join at no token cost.')
            )
          );
        }
        // Student
          ...
          return h('button', {
            ...
            h('span', { style: { flex: 1 } },
              ...
              h('div', { style: { fontSize: '11px', color: palette.textDim || '#cbd5e1', marginTop: '2px' } },
                ...
                + 'Hosted class play has no token cost. Solo still works below.')
            )
          );
        }
