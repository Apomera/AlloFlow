                  ...
                  : React.createElement("div", { className: "space-y-4" },
                      React.createElement("div", { className: "bg-white rounded-xl p-4 shadow-sm border border-blue-100" },
                        React.createElement("div", { className: "grid grid-cols-3 gap-4 text-center" },
                          React.createElement("div", null,
                            React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Price"),
                            React.createElement("p", { className: "text-2xl font-black text-red-500" }, fmt(changePrice))
                          ),
                          React.createElement("div", null,
                            React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Customer Pays"),
                            React.createElement("p", { className: "text-2xl font-black text-blue-500" }, fmt(changePaid))
                          ),
                          React.createElement("div", null,
                            React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Change Due"),
                ...
                React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4" },
                  ...
                  React.createElement("div", { className: "md:col-span-2 bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-4 border border-orange-200" },
                    React.createElement("div", { className: "flex items-center justify-between mb-3" },
                      ...
                      React.createElement("span", { className: "text-[10px] text-slate-600 font-bold" }, filteredStoreItems.length + " items")
                    ),
                        ...
                        return React.createElement("div", { key: ii, className: "relative" },
                          ...
                          isAdding && React.createElement("div", { className: "absolute z-20 left-0 right-0 -bottom-2 translate-y-full bg-white rounded-xl p-3 shadow-xl border-2 border-orange-300 space-y-2" },
                            ...
                            React.createElement("div", { className: "flex items-center gap-1.5" },
                              ...
                              React.createElement("span", { className: "text-[10px] text-slate-600 font-bold" }, item.pricePer)
                            ),
                          ...
                          cart.map(function (item, ci) {
                            ...
                            return React.createElement("div", { key: ci, className: "flex items-center justify-between bg-white rounded-lg px-2 py-1.5 border border-emerald-100" },
                              React.createElement("div", { className: "flex-1 min-w-0" },
                                ...
                                isWeighted && React.createElement("p", { className: "text-[10px] text-slate-600" }, qtyLabel)
                              ),
                              challengeMode
                  ...
                  : d.wpLoading
                    ...
                    : React.createElement("div", { className: "space-y-4" },
                        ...
                        d.wpFeedback && !d.wpFeedback.ok && d.wpProblem.explanation && React.createElement("div", { className: "bg-slate-50 rounded-xl p-3 border border-slate-200" },
                          React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase mb-1" }, "Solution"),
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl p-5 border border-pink-200" },
                    ...
                    : React.createElement("div", { className: "space-y-4" },
                        React.createElement("div", { className: "bg-white rounded-xl p-4 shadow-sm border border-pink-100" },
                          React.createElement("div", { className: "grid grid-cols-3 gap-3 text-center" },
                            React.createElement("div", null, React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Bill Total"), React.createElement("p", { className: "text-xl font-black text-pink-600" }, fmt(d.tipBill))),
                            React.createElement("div", null, React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Tip %"), React.createElement("p", { className: "text-xl font-black text-amber-500" }, d.tipPct + '%')),
                            React.createElement("div", null, React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Diners"), React.createElement("p", { className: "text-xl font-black text-blue-500" }, d.tipDiners))
                          ),
                  ...
                  d.tipMode === 'discount' && (!d.discOriginal
                    ...
                    : React.createElement("div", { className: "space-y-4" },
                        React.createElement("div", { className: "bg-white rounded-xl p-4 shadow-sm border border-pink-100" },
                          React.createElement("div", { className: "text-center" },
                            React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Original Price"),
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-4 border border-amber-200" },
                  ...
                  d.fcTarget && React.createElement("div", { className: "space-y-3" },
                    React.createElement("div", { className: "bg-white rounded-xl p-4 text-center border border-amber-100" },
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Make this amount with the FEWEST coins & bills"),
                      React.createElement("p", { className: "text-3xl font-black text-amber-600" }, fmt(d.fcTarget)),
                      React.createElement("p", { className: "text-[10px] text-slate-600 mt-1" }, "Optimal solution uses " + d.fcOptimal + " pieces")
                    ),
                  ...
                  d.upItem && d.upA && d.upB && React.createElement("div", { className: "space-y-3" },
                    ...
                    React.createElement("div", { className: "grid grid-cols-2 gap-3" },
                      React.createElement("button", { "aria-label": "Option A", onClick: function () { upd('upAnswer', 'A'); },
                        ...
                        React.createElement("p", { className: "text-[10px] text-slate-600 mt-1" }, 'Option A')
                      ),
                      React.createElement("button", { "aria-label": "Option B", onClick: function () { upd('upAnswer', 'B'); },
                        ...
                        React.createElement("p", { className: "text-[10px] text-slate-600 mt-1" }, 'Option B')
                      )
                    ),
                ...
                React.createElement("div", { className: "bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-4 border border-amber-200" },
                  ...
                  cdTarget > 0 && React.createElement("div", { className: "space-y-3" },
                    ...
                    React.createElement("div", { className: "bg-white rounded-xl p-4 border border-amber-100 text-center" },
                      React.createElement("p", { className: "text-[10px] text-slate-600 font-bold uppercase tracking-wider" }, "\uD83C\uDFAF Target Amount"),
                      React.createElement("p", { className: "text-3xl font-black text-amber-600 mt-1" }, fmt(cdTarget)),
                      challengeMode && cdStartTime && React.createElement("p", { className: "text-[10px] text-slate-600 mt-1" }, '\u23F1 Timer running...')
                    ),
              ...
              tab === 'finance' && React.createElement("div", { className: "space-y-4" },
                ...
                finSub === 'compound' && React.createElement("div", { className: "bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-200" },
                  ...
                  React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4" },
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Principal"),
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Annual Rate %"),
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Years"),
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Compounding"),
                  ...
                  React.createElement("div", { className: "grid grid-cols-2 gap-3 mb-4" },
                    React.createElement("div", { className: "bg-white rounded-xl p-4 border border-blue-100 text-center" },
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Compound Interest"),
                    ...
                    React.createElement("div", { className: "bg-white rounded-xl p-4 border border-slate-100 text-center" },
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Simple Interest"),
                ...
                finSub === 'retire' && React.createElement("div", { className: "bg-gradient-to-br from-violet-50 to-purple-50 rounded-xl p-5 border border-violet-200" },
                  ...
                  React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-3 mb-4" },
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Start Age"),
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Monthly Contribution"),
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Employer Match %"),
                  ...
                  React.createElement("div", { className: "grid grid-cols-2 gap-3 mb-4" },
                    React.createElement("div", { className: "bg-white rounded-xl p-4 border-2 border-violet-300 text-center" },
                      ...
                      React.createElement("p", { className: "text-[10px] text-slate-600" }, "Contributed: " + cur.symbol + Math.round(retResult.contributed).toLocaleString()),
                    ...
                    React.createElement("div", { className: "bg-white rounded-xl p-4 border border-slate-200 text-center opacity-75" },
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Start at " + (retAge + 10)),
                      ...
                      React.createElement("p", { className: "text-[10px] text-slate-600" }, "Contributed: " + cur.symbol + Math.round(retLateResult.contributed).toLocaleString()),
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600" }, "Growth: " + cur.symbol + Math.round(retLateResult.growth).toLocaleString())
                    )
                  ),
                ...
                finSub === 'loans' && React.createElement("div", { className: "bg-gradient-to-br from-rose-50 to-red-50 rounded-xl p-5 border border-rose-200" },
                  ...
                  React.createElement("div", { className: "grid grid-cols-3 gap-3 mb-4" },
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Loan Amount"),
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Interest Rate %"),
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Term (months)"),
                  ...
                  React.createElement("div", { className: "grid grid-cols-3 gap-3 mb-4" },
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-rose-100" },
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Monthly Payment"),
                    ...
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-red-200" },
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Total Interest"),
                    ...
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-slate-100" },
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Total Paid"),
                  ...
                  React.createElement("div", { className: "mb-4" },
                    React.createElement("p", { className: "text-[10px] font-bold text-slate-600 mb-1" }, "What you're really paying:"),
                ...
                finSub === 'goals' && React.createElement("div", { className: "bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl p-5 border border-emerald-200" },
                  ...
                  React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4" },
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Target Amount"),
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Already Saved"),
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Timeline (months)"),
                    ...
                    React.createElement("div", null,
                      React.createElement("label", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Savings Rate %"),
                  ...
                  React.createElement("div", { className: "mb-4" },
                    React.createElement("div", { className: "flex items-center justify-between mb-1" },
                      React.createElement("span", { className: "text-[10px] font-bold text-slate-600" }, "Progress"),
                  ...
                  React.createElement("div", { className: "grid grid-cols-3 gap-3 mb-4" },
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-emerald-100" },
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Per Day"),
                    ...
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border-2 border-emerald-300" },
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Per Week"),
                      React.createElement("p", { className: "text-lg font-black text-emerald-600" }, cur.symbol + Math.round(sgWeeklyNeeded).toLocaleString())
                    ),
                    React.createElement("div", { className: "bg-white rounded-xl p-3 text-center border border-emerald-100" },
                      React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase" }, "Per Month"),
                  ...
                  React.createElement("div", { className: "bg-white rounded-xl p-4 border border-emerald-100" },
                    React.createElement("p", { className: "text-[10px] font-bold text-slate-600 uppercase mb-2" }, "\uD83D\uDCA1 What If Scenarios"),
                    React.createElement("div", { className: "space-y-2" },
