          ...
          var VIEWS = {
            ...
            medial: {
              ...
              regions: [
                ...
                { id: 'septum_pell', name: 'Septum Pellucidum', x: 0.40, y: 0.30, w: 0.06, fn: 'Thin membrane of two laminae separating the two lateral ventricles. Contains septal nuclei (part of limbic system). Septal nuclei project to hippocampus (medial septum: cholinergic/GABAergic input for theta rhythm), hypothalamus, and brainstem. Connected to nucleus accumbens (reward/motivation circuitry).', brodmann: 'N/A (septal region)', blood: 'Anterior cerebral artery branches', conditions: 'Cavum septum pellucidum (CSP): persistent fluid-filled cavity between laminae, normal variant in ~20% of adults, more common in boxers and TBI patients. Septal lesions can cause rage reactions (septal rage syndrome in animal models). CSP associated with schizophrenia in some studies.', damage: 'Septal lesion effects include emotional dysregulation, hyperemotionality, and impaired pleasure/reward processing.' }
                ...
                React.createElement("div", { className: "p-3" },
                    ...
                    React.createElement("div", { className: "flex gap-1" },
                      ...
                      ['delta', 'theta', 'alpha', 'beta', 'gamma'].map(function (waveType) {
                        ...
                        var WAVE_META = {
                          ...
                          alpha: { label: '\u03B1 Alpha', freq: '8\u201313 Hz', color: '#c084fc', desc: 'Relaxed alertness, calm focus, mindfulness. Prominent over occipital cortex; attenuates when the eyes open (Berger effect).' },
                  ...
                  (function () {
                    ...
                    var WAVE_META = {
                      ...
                      alpha: { label: '\u03B1 Alpha', freq: '8\u201313 Hz', color: '#c084fc', desc: 'Relaxed alertness, calm focus, mindfulness. Prominent over occipital cortex; attenuates with eye opening.', amp: 'Medium (30\u201350 \u00B5V)', states: 'Eyes closed, relaxed, calm alertness, mindfulness', eeg: 'Posterior (occipital), attenuates with eye opening' },
                  ...
                  React.createElement("p", { className: "text-[11px] text-white/55 mt-2 italic text-center" }, (function () {
                    ...
                    var WAVE_META = {
                      ...
                      alpha: { desc: 'Relaxed alertness, calm focus. Prominent over occipital cortex during relaxed, eyes-closed wakefulness. Blocked by opening eyes (Berger effect).' },
