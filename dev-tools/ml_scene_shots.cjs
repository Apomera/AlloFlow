...
const SHOTS = [
  ...
  // Waves 9-10: the apex ring and its drop line on the previewed arc, the
  // second beads and their ground track, and the chaff drifting downwind past
  // the engine. Both need ambient on.
