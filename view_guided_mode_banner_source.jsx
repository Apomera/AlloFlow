  ...
  return (
    <>
      ...
      <div className="allo-guided-banner" role="region" aria-label={t('guided.indicator_title') || 'Guided mode'} style={{ background: 'linear-gradient(135deg, #312e81, #1e3a5f)', borderRadius: '20px', padding: '16px', marginBottom: '16px', border: '1px solid rgba(99,102,241,0.3)', flexShrink: 0 }}>
        ...
        {phaseCheckpointReady && <section ref={_phaseCheckpointRef} tabIndex={-1} role="status" aria-live="polite" className="allo-guided-phase-checkpoint" aria-labelledby="guided-phase-checkpoint-title" style={{ marginBottom: '10px', padding: '12px', borderRadius: '12px', background: 'linear-gradient(135deg, rgba(16,185,129,.2), rgba(79,70,229,.2))', border: '1px solid rgba(167,243,208,.45)' }}>
