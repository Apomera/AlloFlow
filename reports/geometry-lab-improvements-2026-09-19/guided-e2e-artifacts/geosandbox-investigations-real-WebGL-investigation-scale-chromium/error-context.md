...
- Name: geosandbox-investigations.spec.ts >> real WebGL investigation: scale
- Location: tests\e2e\geosandbox-investigations.spec.ts:124:35
...
- tabpanel "📐 Stretch mode":
  ...
  - tabpanel "Learn":
    ...
    - strong: 64.00 u³
    - paragraph: "|u · (v × w)|"
    - paragraph: Surface Area 96.00 u²
    - region "Prism measurement explanations":
      - paragraph: "Volume = base area × perpendicular height: 16 × 4 = 64 u³"
      - button "Highlight base area": Base area · 16 u²
      - button "Highlight perpendicular height": Perpendicular height · 4 u
      - button "Highlight side edge": Side edge · 4 u
    ...
    - region "Guided experiments":
      ...
      - strong: Double every dimension
      - paragraph: 1. Predict → 2. Change → 3. Compare and explain
      - paragraph: Predict the area and volume factors when all three edge vectors double.
      - paragraph: Each guided change starts from your captured prism. Other objects stay in place.
      - button "Double every dimension"
      - button "Restore starting prism"
      - status: Compare the length factor with the area and volume factors. Explain why they differ.
    - group:
        ...
        - 'table "Object #1 · Investigation prism"':
          ...
          - rowgroup:
            - row "Volume 8 u³ 64 u³":
              ...
              - cell "8 u³"
              - cell "64 u³"
            - row "Surface area 24 u² 96 u²":
              - rowheader "Surface area"
              - cell "24 u²"
              - cell "96 u²"
        - paragraph: "Volume: +56 u³ · ×8"
        - paragraph: "Surface area: +72 u² · ×4"
      - text: Investigation title
      - textbox "Investigation title": Double every dimension
      ...
      - textbox "What did you change?": Doubled all three edge vectors, keeping the shape similar.
    ...
    - text: Edge 4.00 → 8.00 (×k¹ = ×2.00) Surface 96.00 → 384.00 (×k² = ×4.00) Volume 64.00 → 512.00 (×k³ = ×8.00)
