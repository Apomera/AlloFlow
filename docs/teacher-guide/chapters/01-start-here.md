...
![AlloFlow Quick Start with grade and learning-goal setup](../assets/screenshots/05-quick-start.png)
...
Use the accessibility process in [Accessibility and UDL](04-accessibility-and-udl.md) for a fuller check.
...
For a systematic recovery sequence, see [Troubleshooting](08-troubleshooting.md). For planning a fuller package, continue to [Prepare a lesson](02-prepare-a-lesson.md). To teach it synchronously, continue to [Live sessions](03-live-sessions.md).
