 ...
 * plus the main-content JSX region of ANTI. Union 1096 tokens,
 * plus 543 state-variant tokens (hover/focus/active/
...
.theme-dark .allo-docsuite [class~="active:bg-indigo-100"]:active, .theme-dark .allo-docsuite [class~="focus-visible:bg-indigo-50/60"]:focus-visible, .theme-dark .allo-docsuite [class~="focus:bg-indigo-300"]:focus, .theme-dark .allo-docsuite [class~="focus:bg-indigo-50"]:focus, .theme-dark .allo-docsuite [class~="hover:bg-indigo-100"]:hover, .theme-dark .allo-docsuite [class~="hover:bg-indigo-100/30"]:hover, .theme-dark .allo-docsuite [class~="hover:bg-indigo-100/60"]:hover, .theme-dark .allo-docsuite [class~="hover:bg-indigo-200"]:hover, .theme-dark .allo-docsuite [class~="hover:bg-indigo-300"]:hover, .theme-dark .allo-docsuite [class~="hover:bg-indigo-50"]:hover, .theme-dark .allo-docsuite [class~="hover:bg-indigo-50/30"]:hover, .theme-dark .allo-docsuite [class~="hover:bg-indigo-50/40"]:hover, .theme-dark .allo-docsuite [class~="hover:bg-indigo-50/50"]:hover, .theme-dark .allo-docsuite [class~="hover:bg-indigo-50/60"]:hover { background-color:#1e1b4b !important; }
