    ...
    render: function(ctx) {
      ...
      function jumpSculptSection(name) {
        ...
        if(summary){
          ...
          var panel=section.closest('.geo-panel-content');
          if(panel&&window.getComputedStyle(panel).overflowY!=='visible'&&panel.scrollHeight>panel.clientHeight){
            panel.scrollTop+=section.getBoundingClientRect().top-panel.getBoundingClientRect().top-12;
      ...
      function renderSculptMaterialEditor(part) {
        ...
        return h('details',{id:'geo-sculpt-section-material',className:'geo-sculpt-section'},h('summary',null,sculptLabel('sculpt_material','Color & material')),
      ...
      function renderExactPartEditor() {
        ...
        return h('div',{id:'geo-part-inspector',tabIndex:-1,className:'geo-sculpt-inspector'},
          ...
          h('details',{id:'geo-sculpt-section-position',className:'geo-sculpt-section'},h('summary',null,sculptLabel('sculpt_position','Position & movement')),
          ...
          h('details',{id:'geo-sculpt-section-rotation',className:'geo-sculpt-section'},h('summary',null,sculptLabel('sculpt_rotation_angles','Rotation')),
