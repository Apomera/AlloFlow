...
function FluencyModePanel(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-[200] bg-slate-900/95 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-300" }, showFluencyConfetti && /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 pointer-events-none z-[250] flex items-center justify-center" }, /* @__PURE__ */ React.createElement(ConfettiExplosion, null)), /* @__PURE__ */ React.createElement(
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "mt-8 pt-6 border-t border-slate-100 w-full" }, /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-300 font-bold uppercase tracking-widest text-center mb-3" }, t("fluency.analysis_key")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap justify-center gap-3 sm:gap-5 text-xs font-medium text-slate-300" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement("span", { className: "px-2 py-0.5 rounded text-green-600 font-medium bg-green-50/50" }, t("fluency.legend_word")), /* @__PURE__ */ React.createElement("span", null, t("fluency.legend_correct"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement("span", { className: "px-2 py-0.5 rounded bg-yellow-100 text-yellow-300" }, t("fluency.legend_word")), /* @__PURE__ */ React.createElement("span", null, t("fluency.legend_hesitation"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement("span", { className: "px-2 py-0.5 rounded bg-blue-100 text-blue-300 border-b-2 border-blue-400" }, t("fluency.legend_word")), /* @__PURE__ */ React.createElement("span", null, t("fluency.legend_self_corrected"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement("span", { className: "px-2 py-0.5 rounded bg-red-100 text-red-300 border-b-2 border-red-400" }, t("fluency.legend_word")), /* @__PURE__ */ React.createElement("span", null, t("fluency.legend_mispronounced"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement("span", { className: "px-2 py-0.5 rounded bg-red-700 text-white" }, t("fluency.legend_word")), /* @__PURE__ */ React.createElement("span", null, t("fluency.legend_missed"))))), /* @__PURE__ */ React.createElement("div", { className: "mt-6 pt-4 border-t border-slate-100 flex justify-center gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement(
      "button",
      {
