...
function AppliedChallengeView(props) {
  ...
  const renderValidationCycle = (cycle, index) => {
    ...
    }, className: "applied-validation-cycle rounded-2xl border border-blue-200 bg-white" }, /* @__PURE__ */ React.createElement("summary", { className: "cursor-pointer rounded-2xl px-4 py-3 text-sm font-black text-blue-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600" }, "Check ", cycleNumber, ": ", APPLIED_CHALLENGE_VALIDATION_SOURCES[cycle.source], " \xB7 ", progress.complete ? "Complete" : progress.stage === "review" ? "Review the challenge" : progress.stage === "plan" ? "Plan" : progress.stage === "observe" ? "Observe" : "Decide", " \xB7 ", progress.completedSteps, "/", progress.totalSteps), /* @__PURE__ */ React.createElement("div", { className: "border-t border-blue-100 p-4" }, testedEarlierDraft && /* @__PURE__ */ React.createElement("p", { className: "mb-3 rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs font-bold text-amber-950" }, "This check began from an earlier draft. That is expected when evidence leads to revision."), cycle.source !== "ai" && /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "Where this check came from", /* @__PURE__ */ React.createElement("select", { "aria-label": "Check " + cycleNumber + " source", value: cycle.source, onChange: (event) => updateValidationCycle(cycle.id, { source: event.target.value }), className: "mt-1 min-h-11 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-900" }, Object.entries(APPLIED_CHALLENGE_VALIDATION_SOURCES).filter(([id]) => id !== "ai").map(([id, label]) => /* @__PURE__ */ React.createElement("option", { key: id, value: id }, label)))), cycle.source === "ai" && /* @__PURE__ */ React.createElement("section", { "aria-labelledby": "validation-ai-review-" + cycle.id, className: "rounded-2xl border border-fuchsia-200 bg-fuchsia-50 p-4" }, /* @__PURE__ */ React.createElement("h4", { id: "validation-ai-review-" + cycle.id, className: "text-sm font-black text-fuchsia-950" }, "First, decide how to use the AI pressure point"), cycle.importedChallenge.challenge && /* @__PURE__ */ React.createElement("p", { className: "mt-2 whitespace-pre-wrap text-sm text-slate-800" }, /* @__PURE__ */ React.createElement("strong", null, "Challenge:"), " ", cycle.importedChallenge.challenge), /* @__PURE__ */ React.createElement("div", { className: "mt-3 grid gap-3 md:grid-cols-2" }, /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "Your choice", /* @__PURE__ */ React.createElement("select", { "aria-label": "Check " + cycleNumber + " AI challenge choice", value: cycle.disposition, onChange: (event) => updateValidationCycle(cycle.id, { disposition: event.target.value }), className: "mt-1 min-h-11 w-full rounded-xl border border-fuchsia-300 bg-white px-3 py-2 text-sm font-medium text-slate-900" }, Object.entries(APPLIED_CHALLENGE_VALIDATION_DISPOSITIONS).map(([id, label]) => /* @__PURE__ */ React.createElement("option", { key: id, value: id }, label)))), /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "Why?", /* @__PURE__ */ React.createElement("textarea", { "aria-label": "Check " + cycleNumber + " reason for AI challenge choice", value: cycle.dispositionReason, onChange: (event) => updateValidationCycle(cycle.id, { dispositionReason: event.target.value }), rows: 2, placeholder: "Explain why you will use, adapt, or decline this advice.", className: "mt-1 w-full rounded-xl border border-fuchsia-300 bg-white px-3 py-2 text-sm text-slate-900" }))), cycle.disposition === "decline" && /* @__PURE__ */ React.createElement("p", { className: "mt-3 text-xs font-bold text-fuchsia-950" }, "Declining is a valid decision. Explain your reason above; no test plan is required for this cycle.")), stagesAvailable && /* @__PURE__ */ React.createElement("div", { className: "mt-4 grid gap-4" }, /* @__PURE__ */ React.createElement("fieldset", { className: "rounded-2xl border border-sky-200 bg-sky-50/60 p-4" }, /* @__PURE__ */ React.createElement("legend", { className: "px-1 text-sm font-black text-sky-950" }, "1. Plan the check"), /* @__PURE__ */ React.createElement("div", { className: "grid gap-3 md:grid-cols-2" }, /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "Check method", /* @__PURE__ */ React.createElement("select", { "aria-label": "Check " + cycleNumber + " method", value: cycle.plan.methodId, onChange: (event) => updateValidationCyclePart(cycle.id, "plan", { methodId: event.target.value }), className: "mt-1 min-h-11 w-full rounded-xl border border-sky-300 bg-white px-3 py-2 text-sm font-medium text-slate-900" }, APPLIED_CHALLENGE_VALIDATION_METHODS[cycle.family].map((method) => /* @__PURE__ */ React.createElement("option", { key: method.id, value: method.id }, method.label)))), /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "Evidence form", /* @__PURE__ */ React.createElement("select", { "aria-label": "Check " + cycleNumber + " evidence form", value: cycle.plan.evidenceMode, onChange: (event) => updateValidationCyclePart(cycle.id, "plan", { evidenceMode: event.target.value }), className: "mt-1 min-h-11 w-full rounded-xl border border-sky-300 bg-white px-3 py-2 text-sm font-medium text-slate-900" }, Object.entries(APPLIED_CHALLENGE_EVIDENCE_MODES).map(([id, label]) => /* @__PURE__ */ React.createElement("option", { key: id, value: id }, label)))), /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700 md:col-span-2" }, "What exactly will you check?", /* @__PURE__ */ React.createElement("textarea", { "aria-label": "Check " + cycleNumber + " test question", value: cycle.plan.testQuestion, onChange: (event) => updateValidationCyclePart(cycle.id, "plan", { testQuestion: event.target.value }), rows: 2, placeholder: "Write a question that the check could actually inform.", className: "mt-1 w-full rounded-xl border border-sky-300 bg-white px-3 py-2 text-sm text-slate-900" })), /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "Criterion or constraint ", /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-500" }, "(optional)"), /* @__PURE__ */ React.createElement("textarea", { "aria-label": "Check " + cycleNumber + " criterion or constraint", value: cycle.plan.criterion, onChange: (event) => updateValidationCyclePart(cycle.id, "plan", { criterion: event.target.value }), rows: 2, className: "mt-1 w-full rounded-xl border border-sky-300 bg-white px-3 py-2 text-sm text-slate-900" })), /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "What do you expect? ", /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-500" }, "(a prediction, not a result)"), /* @__PURE__ */ React.createElement("textarea", { "aria-label": "Check " + cycleNumber + " expected finding", value: cycle.plan.expectedFinding, onChange: (event) => updateValidationCyclePart(cycle.id, "plan", { expectedFinding: event.target.value }), rows: 2, className: "mt-1 w-full rounded-xl border border-sky-300 bg-white px-3 py-2 text-sm text-slate-900" })), /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700 md:col-span-2" }, "What result could change your mind or draft?", /* @__PURE__ */ React.createElement("textarea", { "aria-label": "Check " + cycleNumber + " change threshold", value: cycle.plan.changeThreshold, onChange: (event) => updateValidationCyclePart(cycle.id, "plan", { changeThreshold: event.target.value }), rows: 2, placeholder: "Name the evidence that would lead you to keep, revise, or replace the current direction.", className: "mt-1 w-full rounded-xl border border-sky-300 bg-white px-3 py-2 text-sm text-slate-900" })))), /* @__PURE__ */ React.createElement("fieldset", { className: "rounded-2xl border border-amber-200 bg-amber-50/60 p-4" }, /* @__PURE__ */ React.createElement("legend", { className: "px-1 text-sm font-black text-amber-950" }, "2. Observe or gather evidence"), /* @__PURE__ */ React.createElement("p", { className: "mb-3 text-xs text-slate-600" }, "Report only what you actually observed or encountered. Summarize feedback without naming participants or including private details."), /* @__PURE__ */ React.createElement("div", { className: "grid gap-3 md:grid-cols-2" }, /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "Outcome", /* @__PURE__ */ React.createElement("select", { "aria-label": "Check " + cycleNumber + " outcome", value: cycle.observation.outcome, onChange: (event) => updateValidationCyclePart(cycle.id, "observation", { outcome: event.target.value }), className: "mt-1 min-h-11 w-full rounded-xl border border-amber-300 bg-white px-3 py-2 text-sm font-medium text-slate-900" }, Object.entries(APPLIED_CHALLENGE_VALIDATION_OUTCOMES).map(([id, label]) => /* @__PURE__ */ React.createElement("option", { key: id, value: id }, label)))), /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700 md:col-span-2" }, "What evidence or observation did you actually encounter?", /* @__PURE__ */ React.createElement("textarea", { "aria-label": "Check " + cycleNumber + " observed evidence", value: cycle.observation.evidence, onChange: (event) => updateValidationCyclePart(cycle.id, "observation", { evidence: event.target.value }), rows: 4, className: "mt-1 w-full rounded-xl border border-amber-300 bg-white px-3 py-2 text-sm text-slate-900" })))), /* @__PURE__ */ React.createElement("fieldset", { className: "rounded-2xl border border-emerald-200 bg-emerald-50/60 p-4" }, /* @__PURE__ */ React.createElement("legend", { className: "px-1 text-sm font-black text-emerald-950" }, "3. Decide and revise"), /* @__PURE__ */ React.createElement("div", { className: "grid gap-3 md:grid-cols-2" }, /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "Decision", /* @__PURE__ */ React.createElement("select", { "aria-label": "Check " + cycleNumber + " decision", value: cycle.decision.action, onChange: (event) => updateValidationCyclePart(cycle.id, "decision", { action: event.target.value }), className: "mt-1 min-h-11 w-full rounded-xl border border-emerald-300 bg-white px-3 py-2 text-sm font-medium text-slate-900" }, Object.entries(APPLIED_CHALLENGE_VALIDATION_DECISIONS).map(([id, label]) => /* @__PURE__ */ React.createElement("option", { key: id, value: id }, label)))), /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700 md:col-span-2" }, "Why does the evidence support that decision?", /* @__PURE__ */ React.createElement("textarea", { "aria-label": "Check " + cycleNumber + " decision reasoning", value: cycle.decision.reasoning, onChange: (event) => updateValidationCyclePart(cycle.id, "decision", { reasoning: event.target.value }), rows: 3, className: "mt-1 w-full rounded-xl border border-emerald-300 bg-white px-3 py-2 text-sm text-slate-900" })), /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "What changed in your response? ", /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-500" }, "(optional)"), /* @__PURE__ */ React.createElement("textarea", { "aria-label": "Check " + cycleNumber + " revision summary", value: cycle.decision.revisionSummary, onChange: (event) => updateValidationCyclePart(cycle.id, "decision", { revisionSummary: event.target.value }), rows: 2, className: "mt-1 w-full rounded-xl border border-emerald-300 bg-white px-3 py-2 text-sm text-slate-900" })), /* @__PURE__ */ React.createElement("label", { className: "block text-xs font-black text-slate-700" }, "Next check or action ", /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-500" }, "(optional)"), /* @__PURE__ */ React.createElement("textarea", { "aria-label": "Check " + cycleNumber + " next step", value: cycle.decision.nextStep, onChange: (event) => updateValidationCyclePart(cycle.id, "decision", { nextStep: event.target.value }), rows: 2, className: "mt-1 w-full rounded-xl border border-emerald-300 bg-white px-3 py-2 text-sm text-slate-900" }))))), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => removeValidationCycle(cycle.id), className: "applied-challenge-no-print mt-4 min-h-11 rounded-xl border border-rose-300 bg-white px-3 py-2 text-xs font-black text-rose-800" }, "Remove check ", cycleNumber)));
  };
