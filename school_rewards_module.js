...
function SchoolRewardsPanel(props) {
  ...
  const focusGuideSection = () => {
    ...
    if (path === "setup") {
      setShowSetup(true);
      setSetupRoute(guideStep.target === "handoff" ? "it" : "guided");
    }
  ...
  )))), /* @__PURE__ */ React.createElement("details", { className: "rounded-xl border border-slate-200 bg-slate-50 p-4", "data-help-key": "schoolrewards_add_later" }, /* @__PURE__ */ React.createElement("summary", { className: "cursor-pointer font-black text-slate-900" }, tt("schoolrewards.add_later", "Add later: class links, printing, email and reporting")), /* @__PURE__ */ React.createElement("p", { className: "mt-3 text-sm text-slate-700" }, tt("schoolrewards.add_later_help", "Start with staff access, a roster, recognition categories, prizes and a shopping window inside the Store. Add classroom links, Print Lab, guardian email and SIS snapshot imports after the basic award and purchase workflow is working. District reports currently summarize one Store; cross-school administration and live SIS synchronization are not included.")), /* @__PURE__ */ React.createElement("div", { className: "mb-4 rounded-xl border border-sky-200 bg-sky-50 p-4 text-sm text-slate-900", role: "note", "data-help-key": "schoolrewards_voice_boundary" }, /* @__PURE__ */ React.createElement("h3", { className: "font-black" }, tt("schoolrewards.voice_boundary_title", "Voice awards belong inside the signed-in Store")), /* @__PURE__ */ React.createElement("p", { className: "mt-2" }, tt("schoolrewards.voice_boundary_body", "Open recognition, load your reviewed class links, and select a class and category. The Store can use on-device speech to fill a draft when the browser supports it. Review the student and confirm the award separately. If local speech is unavailable or blocked, type instead. Do not use the ordinary Allobot microphone for student awards; its selected engine may use remote transcription.")), /* @__PURE__ */ React.createElement("p", { className: "mt-2" }, tt("schoolrewards.voice_pathways", "Canvas and desktop are launchers, not the points ledger. Classroom authorization only imports rosters. The managed Store records official points; practice uses fictional data. Educator Evaluation has its own personnel records and permissions, and receives no award transcript."))), /* @__PURE__ */ React.createElement(SrRosterBridge, { tt, addToast }), /* @__PURE__ */ React.createElement(SrRecognitionWorksheet, { recognition: props.recognition || null, tt, addToast }))))));
}
