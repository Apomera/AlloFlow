  ...
  window.StemLab.registerTool('archStudio', {
    ...
    return el('div', {
      ...
      el('div', { style: { display: 'flex', alignItems: 'center', gap: 6, padding: '8px 12px', background: 'linear-gradient(90deg,#1e293b,#0f172a)', borderBottom: '1px solid #334155', flexWrap: 'wrap' } },
        ...
        // Screenshot + Sound
        el('button', { onClick: takeScreenshot, title: 'Screenshot', 'aria-label': 'Take screenshot', style: { background: 'rgba(71,85,105,.3)', border: '1px solid #475569', color: '#94a3b8', borderRadius: 20, padding: '4px 10px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, '\uD83D\uDCF8'),
