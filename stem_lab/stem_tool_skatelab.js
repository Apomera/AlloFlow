      ...
      return h('div', { className: 'skatelab-shell', style: { color: 'var(--allo-stem-text, #f1f5f9)', fontFamily: 'system-ui, sans-serif', maxWidth: '58rem', margin: '0 auto', padding: 16 } },
        ...
        h('details', {
          ...
          return h('div', { style: { background: sm.bg, border: '1px solid ' + sm.border, borderRadius: 12, padding: 14, marginBottom: 12, color: '#e8f0f5' } },
            ...
            h('textarea', { value: iq.hypothesis, onChange: function(e) { setIQ({ hypothesis: e.target.value }); }, 'aria-label': __alloT('stem.skatelab.hypothesis_input', 'Skate flight hang-time hypothesis'), rows: 2, placeholder: __alloT('stem.skatelab.e_g_angle_gives_diminishing_returns_pa', 'e.g., angle gives diminishing returns past 60° because horizontal speed vanishes...'), style: { width: '100%', padding: 6, borderRadius: 6, border: '1px solid ' + sm.border, background: '#0a0a1a', color: '#e8f0f5', fontSize: 11, marginBottom: 10, resize: 'vertical' } }),
