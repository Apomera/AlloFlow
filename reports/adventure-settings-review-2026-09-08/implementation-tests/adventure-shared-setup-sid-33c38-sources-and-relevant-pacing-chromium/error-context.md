...
- Name: adventure-shared-setup.spec.ts >> sidebar exposes social focus, manual resources and relevant pacing
...
- main [ref=e2]:
  - generic [ref=e4]:
    - generic [ref=e5]:
      - region "Essential setup" [ref=e6]:
        - heading "Essential setup" [level=3] [ref=e7]
        - generic [ref=e8]:
          - generic [ref=e9]:
            - text: Interaction mode
            - combobox "Interaction mode" [ref=e10]:
              - option "Standard Adventure Mode" [selected]
              - option "Debate"
              - option "Systems simulation"
          - generic [ref=e11]:
            - text: Adventure language
            - combobox "Adventure language Story language follows this control; the translation language follows Universal Settings." [ref=e12]:
              - option "English only" [selected]
              - option "Spanish"
              - option "Spanish · with translation"
            - generic [ref=e13]: Story language follows this control; the translation language follows Universal Settings.
          - generic [ref=e14]:
            - text: Student responses
            - combobox "Student responses" [ref=e15]:
        ...
        - generic [ref=e17]:
          - generic [ref=e18]:
            - generic [ref=e19]:
              - text: Episode length
              - combobox "Episode length" [ref=e20]:
            ...
            - generic [ref=e21]:
              ...
              - combobox "Choices per decision" [ref=e22]:
                - option "2"
                - option "3"
                - option "4" [selected]
                - option "5"
                - option "6"
          - paragraph [ref=e23]: Length counts decisions, not minutes. The final challenge fits inside a set episode. Energy depletion can end a run earlier.
          - generic [ref=e24] [cursor=pointer]:
            - checkbox "Include a final challenge" [checked] [ref=e25]
            - text: Include a final challenge
        - generic [ref=e26]:
          - text: Social skill to practise
          - textbox "Social skill to practise" [active] [ref=e27]:
            - /placeholder: e.g., Sharing toys, Dealing with frustration
            - text: Resolving disagreements
      - group [ref=e28]:
        - 'generic "Learning supportsReading practice: Off" [ref=e29] [cursor=pointer]'
      - group [ref=e30]:
        - 'generic "Story & game rulesChance: Off" [ref=e31] [cursor=pointer]'
        - option "Story"
        - option "Normal" [selected]
        - option "Hard"
        - option "Hardcore"
      - group [ref=e32]:
        - 'generic "VisualsArt style: auto" [ref=e33] [cursor=pointer]'
        ...
        - option "Custom"
      - group [ref=e34]:
        - generic "Story guidanceNo custom instructions" [ref=e35] [cursor=pointer]
      - group [ref=e36]:
        - 'generic "Saving & permissionsCloud images: Off" [ref=e37] [cursor=pointer]'
      - region "Setup summary" [ref=e38]:
        - strong [ref=e39]: "Setup summary:"
        - text: Standard Adventure Mode · 12 decisions · 4 suggested choices · English only
    - button "common.next" [ref=e40]:
      - generic [ref=e41]: adventure.start
```
