  ...
  return /* @__PURE__ */ React.createElement("div", { ref: pipelineDialogRef, tabIndex: -1, role: "dialog", "aria-modal": "true", "aria-labelledby": "pipeline-game-title", className: `fixed inset-0 z-[200] bg-slate-50 flex flex-col${useReducedMotion() ? "" : " animate-in zoom-in-95"}` }, /* @__PURE__ */ React.createElement("div", { className: "sr-only", role: "status", "aria-live": "polite" }, announcement), /* @__PURE__ */ React.createElement("div", { className: "bg-gradient-to-r from-indigo-700 via-purple-700 to-indigo-700 p-4 text-white flex justify-between items-center shadow-md z-30" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { id: "pipeline-game-title", className: "font-bold text-xl flex items-center gap-2" }, /* @__PURE__ */ React.createElement(GitMerge, { size: 24 }), " ", t("games.pipeline.title") || "Pipeline Builder"), topicTitle && /* @__PURE__ */ React.createElement("p", { className: "text-xs text-white/70 mt-0.5" }, topicTitle)), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white/30 px-4 py-1 rounded-full font-bold text-yellow-200 border border-white/40" }, t("common.score") || "Score", ": ", score), /* @__PURE__ */ React.createElement("div", { className: "text-xs text-white/70 font-bold" }, connections.length, "/", totalRequired, " connections"), /* @__PURE__ */ React.createElement(GameThemeToggle, null), /* @__PURE__ */ React.createElement(
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: `absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full border-[3px] z-20 transition-all flex items-center justify-center
                  ...
                  ` }, /* @__PURE__ */ React.createElement(ArrowRight, { size: 12, className: `${isSource || connFrom ? "text-white" : "text-slate-600"}` })),
      ...
      isComplete && /* @__PURE__ */ React.createElement("div", { className: "absolute -top-3 -left-1 bg-green-700 text-white text-[11px] font-black w-6 h-6 rounded-full flex items-center justify-center shadow-md border-2 border-white" }, step.originalIndex + 1)
    );
...
const syntaxProse = (text) => (typeof text === "string" ? text : "").split("--- ENGLISH TRANSLATION ---")[0].replace(/\[\[CHART:[\s\S]*?\]\]/g, "\n").split(/\r?\n/).filter((line) => {
  if (SYNTAX_SKIP_LINE.test(line)) return false;
  const label = line.match(/^\s*(\*{1,2}|_{1,2})([^*_\n]+)\1\s*$/);
  return !(label && !/[.!?。！？؟।]$/.test(label[2].trim()));
}).map((line) => line.replace(/^\s*(?:>\s?)*(?:(?:[-+*]|\d+[.)])\s+)?/, "").replace(/\[([^\]]*)\]\([^)]*\)/g, (_m, label) => /\p{L}/u.test(label) ? label : "")).join("\n");
const syntaxSentences = (text) => {
  ...
  return [...new Set(candidates.map((s) => s.trim().replace(/\s+/g, " ")))].filter((s) => {
    ...
    return words.length > 3 && s.length < 150 && new Set(words).size > 1 && !/https?:\/\/|www\./i.test(s);
  });
};
