...
function AtlasTab({ t }) {
  ...
  )), /* @__PURE__ */ React.createElement("p", { id: "atlas-search-status", role: "status", "aria-live": "polite", className: "text-[10px] text-slate-500 mt-2" }, isSearching ? resultStats.tools ? resultStats.tools + (resultStats.tools === 1 ? " matching tool" : " matching tools") + " across " + resultStats.areas + (resultStats.areas === 1 ? " area." : " areas.") : "No Atlas matches found." : "Browse the full directory or search to narrow it.")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 pt-1" }, /* @__PURE__ */ React.createElement("span", { className: "h-px flex-1 bg-slate-200", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("h5", { id: "atlas-directory-title", className: "text-[10px] font-black uppercase tracking-[0.18em] text-slate-400" }, "Complete directory"), /* @__PURE__ */ React.createElement("span", { className: "h-px flex-1 bg-slate-200", "aria-hidden": "true" })), /* @__PURE__ */ React.createElement("section", { "aria-labelledby": "atlas-directory-title" }, visibleHubs.length ? /* @__PURE__ */ React.createElement("div", { className: "space-y-2.5" }, visibleHubs.map((hub) => /* @__PURE__ */ React.createElement(
    AtlasHubCard,
    {
      key: hub.hub,
      hub,
...
function InfoModal({
  ...
  return /* @__PURE__ */ React.createElement("div", { role: "presentation", className: "fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-[300] flex items-center justify-center p-4 animate-in fade-in duration-200", onClick: handleSetShowInfoModalToFalse }, /* @__PURE__ */ React.createElement("div", { ref: dialogRef, tabIndex: -1, className: "bg-white rounded-2xl shadow-2xl max-w-4xl w-full overflow-hidden flex flex-col max-h-[90vh] focus:outline-none", role: "dialog", "aria-modal": "true", "aria-labelledby": "info-modal-title", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-700 p-4 text-white flex justify-between items-center shrink-0" }, /* @__PURE__ */ React.createElement("h3", { id: "info-modal-title", className: "font-bold text-lg flex items-center gap-2" }, /* @__PURE__ */ React.createElement(Layers, { size: 20 }), " ", t("about.title")), /* @__PURE__ */ React.createElement("button", { onClick: handleSetShowInfoModalToFalse, className: "p-2 rounded-full hover:bg-indigo-600 focus:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors", "aria-label": t("common.close") }, /* @__PURE__ */ React.createElement(X, { size: 20 }))), /* @__PURE__ */ React.createElement("div", { className: "flex border-b border-slate-200 bg-slate-50 shrink-0 overflow-x-auto", role: "tablist", "aria-label": t("about.title") }, /* @__PURE__ */ React.createElement(
    "button",
    {
      id: "info-tab-about",
      role: "tab",
