...
const entry = `/* global React */\n\n${source}\n\nwindow.__alloCommandsExports = { AlloCommandPalette, buildAlloCommands, scoreCommand, routeUtterance, runCommandById, findReadingMatches, normalizeReadingRequest, readingMatchReasons, readingMatchWhyText, createVoiceLoop, looksMultiStep, getCommandContract, validatePlan, planUtterance, runPlan };\n`;
