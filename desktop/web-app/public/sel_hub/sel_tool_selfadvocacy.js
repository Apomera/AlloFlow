...
(function() {
  ...
  var INTERSECTION_EXAMPLES = [
    ...
    { lens: 'Gender + disability', body: 'Autistic girls and other neurodivergent girls (including girls with ADHD) are systematically under-diagnosed because diagnostic criteria were built on male presentations. Disabled women face higher rates of intimate partner violence and lower employment.' },
  ...
  window.SelHub.registerTool('selfAdvocacy', {
    ...
    render: function(ctx) {
      ...
      function renderMenu() {
        var cards = [
          { id: 'profile', icon: '\uD83D\uDC64', title: 'My Learning Profile', body: 'Build a one-page summary of who you are as a learner — your strengths, what helps you, what gets in the way, and what you want teachers to know. Print it and share it with new teachers. Start here.', color: 'from-violet-700 to-indigo-700' },
          { id: 'rights', icon: '\u2696\uFE0F', title: 'Know Your Rights', body: 'The laws that protect you: IDEA, Section 504, FAPE, LRE, FERPA. Plain-language explanations of what they mean for how school works for you.', color: 'from-blue-700 to-cyan-700' },
          { id: 'iep', icon: '\uD83D\uDCC4', title: 'Your IEP or 504', body: 'Learn to read your own plan document. What each section means, whose goals are really in there, how to prepare for your meeting, what to do if you don\'t have a plan but think you need one.', color: 'from-purple-700 to-pink-700' },
          { id: 'request', icon: '\uD83D\uDD28', title: 'Request Accommodations', body: 'When and how to ask for what you need. Scripts for common situations. How to document requests so your asks don\'t disappear.', color: 'from-emerald-700 to-teal-700' },
          { id: 'disclose', icon: '\uD83D\uDD11', title: 'Disclosure Decisions', body: 'You never have to share your diagnosis with anyone. Decide what to share, with whom, and when. Audience-specific scripts at different disclosure depths.', color: 'from-amber-700 to-orange-700' },
          { id: 'escalate', icon: '\uD83D\uDEA8', title: 'When Things Go Wrong', body: 'What to do when accommodations are denied, delayed, or not implemented. Escalation levels from a direct conversation through OCR complaints. Know what each level costs and what it gets you.', color: 'from-rose-700 to-red-700' },
          { id: 'transition', icon: '\uD83C\uDF9F\uFE0F', title: 'Transition to Adulthood', body: 'Age of majority, college disability services, workplace ADA rights. Planning for the moment when rights transfer and you\'re driving.', color: 'from-sky-700 to-blue-800' },
          { id: 'practice', icon: '\uD83C\uDFAF', title: 'Practice Scenarios', body: 'Realistic scenarios to practice self-advocacy. Pick a situation, write your response, and get AI coaching feedback.', color: 'from-fuchsia-700 to-rose-700' },
          { id: 'meeting', icon: '\uD83D\uDCDD', title: 'Meeting Prep', body: 'Fill in a worksheet before your IEP, 504, or parent-teacher meeting. Print it and bring it with you. Includes conversation starters for when you need them.', color: 'from-teal-700 to-cyan-700' },
          ...
          { id: 'resources', icon: '\uD83D\uDCDA', title: 'Resource Library', body: 'Crisis lines, national advocacy orgs, federal agencies, Maine-specific resources, self-advocacy tools, transition prep, and recommended reading. All in one place.', color: 'from-slate-700 to-stone-700' },
          { id: 'quiz', icon: '\uD83E\uDDE0', title: 'Rights Quiz', body: '12 multiple-choice questions to check what you know. Get instant feedback with explanations. Test yourself or use as a classroom check-in.', color: 'from-cyan-700 to-blue-700' },
          { id: 'friend', icon: '\uD83E\uDD1D', title: 'Helping a Friend', body: '6 scenarios where a friend is facing something hard. Pick how you\'d respond. Learn what supportive peer advocacy looks like versus well-intended responses that overstep.', color: 'from-pink-700 to-rose-700' },
          { id: 'journey', icon: '\uD83D\uDDFA\uFE0F', title: 'My Advocacy Journey', body: 'Your personal space. Check off developmental milestones across 5 stages. Log what you tried, how it went, what you learned. Track your growth over months and years.', color: 'from-violet-700 to-fuchsia-700' },
          { id: 'card', icon: '\uD83D\uDCB3', title: 'Accommodation Card', body: 'A wallet-sized printable card listing your key accommodations. Keep it in your backpack. Hand it to a sub teacher or anyone who doesn\'t know your plan. Low drama, high clarity.', color: 'from-yellow-700 to-amber-700' },
          { id: 'identity', icon: '\uD83C\uDF08', title: 'Identity & Language', body: 'Disability identity, the neurodiversity paradigm, person-first vs identity-first language, intersectionality, and finding community. The bigger questions of who you are and how you talk about yourself.', color: 'from-purple-700 to-indigo-700' },
          { id: 'glossary', icon: '\uD83D\uDCD6', title: 'Quick Glossary', body: 'Plain-language definitions of the terms used throughout this tool. Filter as you type. For when you hit a word you don\'t know.', color: 'from-stone-700 to-zinc-800' },
          { id: 'plan', icon: '\uD83C\uDFAF', title: 'Action Plan Builder', body: 'Pick ONE thing you want to advocate for right now. Break it into 3 steps with a check-in date. Print the card and stick it somewhere you\'ll see it.', color: 'from-lime-700 to-green-800' },
          { id: 'steady', icon: '\uD83E\uDDD8', title: 'Steady Yourself', body: 'The emotional side of advocacy. Tools for nerves before a meeting, getting through it without freezing or crying, recovering after a hard conversation, and trusting your own perception when adults dismiss you.', color: 'from-teal-700 to-emerald-800' },
          { id: 'teacher', icon: '\uD83C\uDF93', title: 'For Teachers', body: 'For educators using this tool with students. Six teaching principles, a 6-week curriculum scaffold, mapping to EL Education HOWLs, common pitfalls, and self-reflection prompts for teachers.', color: 'from-blue-800 to-sky-700' },
          { id: 'packet', icon: '\uD83D\uDCE6', title: 'Print Packet', body: 'Combine everything you\'ve filled in — Learning Profile, Accommodation Card, Action Plan, Meeting Prep, Journey milestones and recent entries — into one print-ready document for an advisor check-in.', color: 'from-zinc-700 to-stone-800' },
          { id: 'data', icon: '\uD83D\uDD12', title: 'My Data', body: 'Your privacy controls. Export everything you\'ve filled in to a file you own. Import a previous backup. Reset everything if you want to start fresh. This is your data, on your device.', color: 'from-slate-700 to-gray-800' }
        ];
          ...
          h('div', { className: 'grid grid-cols-1 md:grid-cols-2 gap-3 mt-4' },
            cards.map(function(c) {
              return h('button', {
                ...
                h('div', { className: 'text-xs text-white leading-snug' }, c.body)
              );
            })
          )
        );
