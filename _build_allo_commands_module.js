...
const entry = `/* global React */\n\n${source}\n\nwindow.__alloCommandsExports = { AlloCommandPalette, AlloCommandProgress, buildAlloCommands, getCommandAudience, getCommandAvailability, getLocalCommandInsights, mergeCommandProgressItems, scoreCommand, routeUtterance, executeCommand, cancelCommand, runCommandById, findReadingMatches, normalizeReadingRequest, readingMatchReasons, readingMatchWhyText, createVoiceLoop, looksMultiStep, getCommandContract, sanitizeCommandParams, validatePlan, planUtterance, runPlan, LEARNER_COMMAND_RISKS, LEARNER_CONFIRMATION_POLICIES, getLearnerCommandPolicy, createLearnerCommandAdapter, registerCommandScope, normalizeVoiceEditableFields, resolveVoiceEditableField, parseNamedFieldVoiceUtterance, createNamedFieldCommandAdapter, listActiveCommandScopes, getLearnerContextSnapshot, routeScopedUtterance, createCommandKernel };\n`;
