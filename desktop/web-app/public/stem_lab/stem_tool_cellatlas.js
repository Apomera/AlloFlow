      ...
      function renderAlphaFoldEvidenceRecord() {
        ...
        return h('section', { className: 'cal-card cal-af-return', 'aria-labelledby': 'cal-af-return-title' },
          ...
          h('div', { className: 'cal-af-review', 'aria-labelledby': 'cal-af-review-title' },
            ...
            h('textarea', { id: 'cal-af-teacher-feedback', rows: 3, maxLength: 800, value: d.alphaFoldTeacherNote || '', placeholder: __alloT('stem.cellatlas.name_one_strength_and_one_revision_that_woul','Name one strength and one revision that would make the evidence or limitation more specific.'), onChange: function (event) { patch({ alphaFoldTeacherNote: event.target.value.slice(0, 800), alphaFoldTeacherReviewStatus: '' }); } }),
          ...
          h('div', { className: 'cal-card' },
            ...
            h('div', { className: 'cal-cer' },
              h('div', { className: 'cal-field' },
                ...
                h('textarea', { id: 'cal-cer-claim', rows: 5, value: notebook.claim || '', placeholder: __alloT('stem.cellatlas.across_these_tissues_the_cells','Across these tissues, the cells...'), onChange: function (event) { updateNotebook('claim', event.target.value); } })),
              h('div', { className: 'cal-field' },
                h('label', { htmlFor: 'cal-cer-evidence' }, 'Evidence'),
                h('textarea', { id: 'cal-cer-evidence', rows: 5, value: notebook.evidence || '', placeholder: __alloT('stem.cellatlas.in_the_teaching_panels_marker_is_while_marke','In the teaching panels, [marker] is... while [marker] is...'), onChange: function (event) { updateNotebook('evidence', event.target.value); } })),
              h('div', { className: 'cal-field' },
                h('label', { htmlFor: 'cal-cer-reasoning' }, 'Reasoning + limitation'),
                h('textarea', { id: 'cal-cer-reasoning', rows: 5, value: notebook.reasoning || '', placeholder: __alloT('stem.cellatlas.this_supports_the_claim_because_however_the','This supports the claim because... However, the model cannot show...'), onChange: function (event) { updateNotebook('reasoning', event.target.value); } }))),
      ...
      function renderSource() {
        ...
        return h('div', { className: 'cal-source-grid' },
          ...
          h('section', { className: 'cal-card cal-teacher-review', 'aria-labelledby': 'cal-teacher-review-title' },
            ...
            h('textarea', { id: 'cal-teacher-feedback', rows: 3, maxLength: 800, value: d.cellAtlasTeacherNote || '', placeholder: __alloT('stem.cellatlas.name_one_strength_and_one_revision_that__2','Name one strength and one revision that would make the evidence or limitation more specific.'), onChange: function (event) { patch({ cellAtlasTeacherNote: event.target.value.slice(0, 800), cellAtlasTeacherReviewStatus: '' }); } }),
            h('div', { className: 'cal-actions' },
