...
The schema is illustrative; return a COMPLETE board with three projects and 8-12 locations. For order replace options/answer with items (3-5 distinct strings) and order (permutation of indices). For settings replace options/answer with controls (2-3 objects: label, options with 2-4 strings, answer index). Choice needs 3-5 distinct options. IDs: lowercase letter followed by lowercase letters/digits/_/-; max40. Limit complete JSON to32000 chars, title120, mission/debrief1200, location name80, scene450, instruction900, explanation1000, quote650, hints400 each, project description700.`;
  ...
  function saveBoard(storage, source, language, board) {
    ...
    else if (boards.length >= 4) throw Error("Four boards are already saved for this lesson. Remove one before saving another.");
    boards.unshift(valid);
    storage.setItem(libraryKey(source, language), JSON.stringify({ version: 1, source, language, boards }));
    return boards;
  }
  function removeBoard(storage, source, language, index) {
  ...
  function MovePreview({ board, run, target, t }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { "data-move-preview": true }, target.cost ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", null, tr(t, "cost", "Cost: {cost}", { cost: amounts(target.cost) })), !detail.complete && !detail.built && (detail.affordable ? /* @__PURE__ */ React.createElement("p", null, tr(t, "balance_after", "Resources after building: {balance}", { balance: amounts(detail.after) })) : /* @__PURE__ */ React.createElement("p", null, tr(t, "missing_resources", "Still needed: {resources}", { resources: amounts(detail.shortfall) }))), target.effect.kind === "path" && detail.pathAlreadyOpen && !detail.built && !detail.complete && /* @__PURE__ */ React.createElement("p", null, tr(t, "path_open_already", "That destination is already open. This still counts as a construction, but will not unlock a new location."))) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", null, tr(t, "concept_label", "Lesson concept: {concept}", { concept: detail.concept?.name }), " ", /* @__PURE__ */ React.createElement("strong", null, detail.newConcept ? tr(t, "new_concept", "Still to explore") : tr(t, "concept_covered", "Already explored together"))), !detail.complete && !detail.explored && /* @__PURE__ */ React.createElement("p", null, tr(t, "reward", "Successful exploration earns: {reward}", { reward: amounts(detail.reward) })), !detail.complete && detail.opens.length > 0 && !detail.explored && /* @__PURE__ */ React.createElement("p", null, tr(t, "opens_locations", "Successful exploration opens: {locations}", { locations: detail.opens.map((node) => node.name).join(", ") })), detail.connections.length > 0 && /* @__PURE__ */ React.createElement("p", { className: "lb-muted" }, tr(t, "connected_locations", "Connected locations: {locations}", { locations: detail.connections.map((node) => node.name).join(", ") }))));
  }
  function ClassProposals({ board, run, roster, onSelect, t }) {
    ...
    return /* @__PURE__ */ React.createElement("section", { className: "lb-panel", style: { marginTop: 14 }, "aria-label": tr(t, "class_proposals", "Class proposals"), "data-class-proposals": true }, /* @__PURE__ */ React.createElement("h3", null, tr(t, "class_proposals", "Class proposals")), /* @__PURE__ */ React.createElement("p", null, tr(t, "proposal_total", "{count}/{total} learners have proposed an available move. Select a proposal to inspect it before choosing.", { count: total, total: Object.keys(roster).length })), /* @__PURE__ */ React.createElement("div", { className: "lb-row" }, proposals.map((item) => /* @__PURE__ */ React.createElement("button", { type: "button", key: item.id, "data-proposal-target": item.id, onClick: () => onSelect(item.id) }, tr(t, "proposal_option", "{name} \u2014 proposals: {count}", item)))));
  }
  function TeacherLearningReview({ board, run, roster, t }) {
    const summary = learningSummary(board, run, roster);
    return /* @__PURE__ */ React.createElement("details", { "data-board-learning": true }, /* @__PURE__ */ React.createElement("summary", null, tr(t, "class_learning", "Class learning review")), /* @__PURE__ */ React.createElement("p", null, tr(t, "learning_explanation", "These records include resolved activities only. A successful shared move does not mean everyone answered correctly. Missing responses are kept separate; counts include retries.")), /* @__PURE__ */ React.createElement("h3", null, tr(t, "concept_review", "Concept review")), /* @__PURE__ */ React.createElement("ul", null, summary.concepts.map((concept) => /* @__PURE__ */ React.createElement("li", { key: concept.id }, /* @__PURE__ */ React.createElement("strong", null, concept.name), ": ", tr(t, "concept_demonstrated", "{demonstrated}/{responded} responding learners demonstrated this idea at least once.", concept), " ", tr(t, "concept_missing", "Learners without a recorded response for this idea: {count}.", { count: summary.learners.length - concept.responded })))), /* @__PURE__ */ React.createElement("h3", null, tr(t, "learner_review", "Learner review")), summary.learners.length === 0 && /* @__PURE__ */ React.createElement("p", null, tr(t, "no_learners", "No learners have joined this session yet.")), summary.learners.map((learner) => /* @__PURE__ */ React.createElement("details", { key: learner.uid, "data-learning-uid": learner.uid }, /* @__PURE__ */ React.createElement("summary", null, learner.name, " \u2014 ", learner.answered ? tr(t, "recorded_count", "{correct}/{answered} recorded responses correct", learner) : tr(t, "no_responses", "No recorded responses")), /* @__PURE__ */ React.createElement("ul", null, learner.concepts.map((concept) => /* @__PURE__ */ React.createElement("li", { key: concept.id }, concept.name, ": ", concept.answered ? tr(t, "recorded_count", "{correct}/{answered} recorded responses correct", concept) : tr(t, "no_responses", "No recorded responses")))))));
  }
  ...
  function Icon({ name }) {
    ...
    return /* @__PURE__ */ React2.createElement("svg", { className: "lb-icon", viewBox: "0 0 32 32", "aria-hidden": "true" }, /* @__PURE__ */ React2.createElement("path", { d: paths[name] || paths.book }));
  }
  function BoardMap({ board, progress, ready, selected, onSelect, view, currentId, t }) {
    const ref = useRef(null), [lines, setLines] = useState([]);
    useEffect(() => {
    ...
    return /* @__PURE__ */ React2.createElement("div", { ref, className: "lb-board", "data-view": view, "data-board-map": true }, /* @__PURE__ */ React2.createElement("svg", { className: "lb-paths", "aria-hidden": "true" }, lines.map(([x1, y1, x2, y2], i) => /* @__PURE__ */ React2.createElement("line", { key: i, x1, y1, x2, y2 }))), board.locations.map((node) => /* @__PURE__ */ React2.createElement("button", { key: node.id, type: "button", className: "lb-tile", "data-location": node.id, "data-built": progress.visited.includes(node.id), "aria-pressed": selected === node.id, onClick: () => onSelect(node.id) }, /* @__PURE__ */ React2.createElement(Icon, { name: node.icon }), /* @__PURE__ */ React2.createElement("span", null, node.name), /* @__PURE__ */ React2.createElement("small", null, currentId === node.id ? tr(t, "current_activity", "Current activity") : progress.visited.includes(node.id) ? tr(t, "explored", "Explored") : progress.complete ? tr(t, "not_explored_game", "Not explored in this game") : ready.includes(node.id) ? tr(t, "ready", "Ready to explore") : tr(t, "reach_first", "Open a connected location first")))));
  }
  function Activity({ node, value, onChange, disabled, t }) {
    const [movement, setMovement] = useState("");
    if (node.kind === "choice") return /* @__PURE__ */ React2.createElement("label", null, tr(t, "response", "Your response"), /* @__PURE__ */ React2.createElement("select", { "data-board-choice": true, value, disabled, onChange: (event) => onChange(event.target.value) }, /* @__PURE__ */ React2.createElement("option", { value: "" }, tr(t, "select_response", "Choose a response")), node.options.map((option, i) => /* @__PURE__ */ React2.createElement("option", { key: i, value: String(i) }, option))));
    if (node.kind === "settings") return /* @__PURE__ */ React2.createElement("div", null, node.controls.map((control, index) => /* @__PURE__ */ React2.createElement("label", { key: index }, control.label, /* @__PURE__ */ React2.createElement("select", { "data-board-control": index, value: value.split(",")[index] || "", disabled, onChange: (event) => {
      const values = value.split(",");
      values[index] = event.target.value;
      onChange(values.join(","));
    } }, /* @__PURE__ */ React2.createElement("option", { value: "" }, tr(t, "select_setting", "Choose a setting")), control.options.map((option, i) => /* @__PURE__ */ React2.createElement("option", { key: i, value: String(i) }, option))))));
    ...
    return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("ol", { className: "lb-order" }, order.map((item, index) => /* @__PURE__ */ React2.createElement("li", { key: item }, /* @__PURE__ */ React2.createElement("span", null, index + 1, ". ", node.items[item]), /* @__PURE__ */ React2.createElement("button", { type: "button", "data-board-up": item, disabled, "aria-disabled": index === 0 || disabled, "aria-label": tr(t, "move_up", "Move {item} up", { item: node.items[item] }), onClick: () => move(index, -1) }, "\u2191"), /* @__PURE__ */ React2.createElement("button", { type: "button", disabled, "aria-disabled": index === order.length - 1 || disabled, "aria-label": tr(t, "move_down", "Move {item} down", { item: node.items[item] }), onClick: () => move(index, 1) }, "\u2193")))), /* @__PURE__ */ React2.createElement("p", { className: "lb-visually-hidden", role: "status" }, movement));
  }
  function BoardView({ board, run, role = "solo", uid = "solo", roster = {}, onMove, onAnswer, onResolve, onAdvance, busy, paused, pending, notice, workspaceKey, t }) {
    const step = stepOf(run), progress = derive(board, run), ready = targets(board, run).map((n) => n.id), heading = useRef(null), phaseRef = useRef(step.phase), [selected, setSelected] = useState(board.starts[0]), [view, setView] = useState("board"), [drafts, setDrafts] = useState({}), [savedWarning, setSavedWarning] = useState(""), [confirmEarly, setConfirmEarly] = useState(false), [inspectId, setInspectId] = useState(""), inspection = useRef(null), earlyCancel = useRef(null), resolveTrigger = useRef(null);
    useEffect(() => {
    ...
    return /* @__PURE__ */ React2.createElement("div", { "data-board-play": true }, /* @__PURE__ */ React2.createElement("header", null, /* @__PURE__ */ React2.createElement("h2", null, board.title), /* @__PURE__ */ React2.createElement("p", null, board.mission), /* @__PURE__ */ React2.createElement("p", { className: "lb-muted" }, tr(t, "objective", "Explore every concept and build at least two projects. Choose the route and projects together.")), /* @__PURE__ */ React2.createElement("div", { className: "lb-row", "aria-label": tr(t, "resources", "Shared resources") }, board.resources.map((name, i) => /* @__PURE__ */ React2.createElement("span", { key: i }, /* @__PURE__ */ React2.createElement("strong", null, name, ": ", progress.balance[i]), progress.bonus[i] > 0 && /* @__PURE__ */ React2.createElement("small", null, " (+", progress.bonus[i], " ", tr(t, "per_location", "per successful location"), ")")))), /* @__PURE__ */ React2.createElement("div", { className: "lb-progress", role: "progressbar", "aria-label": tr(t, "concept_progress", "Concepts explored"), "aria-valuemin": 0, "aria-valuemax": board.concepts.length, "aria-valuenow": progress.concepts.length }, /* @__PURE__ */ React2.createElement("span", { style: { width: 100 * progress.concepts.length / board.concepts.length + "%" } })), /* @__PURE__ */ React2.createElement("p", null, tr(t, "progress", "{concepts}/{total} concepts explored \xB7 {projects}/2 projects built", { concepts: progress.concepts.length, total: board.concepts.length, projects: progress.built.length }))), /* @__PURE__ */ React2.createElement("p", { role: "status", "aria-live": "polite", "aria-atomic": "true", "data-board-phase": true }, progress.complete ? tr(t, "complete", "The shared objective is complete!") : step.phase === "choose" ? tr(t, "choose_phase", "Choose the next location or project.") : step.phase === "answer" ? tr(t, "answer_phase", "Activity open: {name}. Everyone can respond.", { name: activeNode?.name }) : tr(t, "review_phase", "Review the result before the next move.")), notice && /* @__PURE__ */ React2.createElement("p", { className: "lb-notice", role: "status" }, notice), savedWarning && /* @__PURE__ */ React2.createElement("p", { className: "lb-notice" }, savedWarning), paused && /* @__PURE__ */ React2.createElement("p", { className: "lb-notice", role: "status" }, tr(t, "paused", "Board paused. Your unfinished response is kept.")), /* @__PURE__ */ React2.createElement("div", { className: "lb-row", "aria-label": tr(t, "presentation", "Board presentation") }, /* @__PURE__ */ React2.createElement("button", { type: "button", "aria-pressed": view === "board", onClick: () => {
      setView("board");
      persist(drafts, selected, "board");
    } }, tr(t, "board_view", "Board view")), /* @__PURE__ */ React2.createElement("button", { type: "button", "aria-pressed": view === "list", onClick: () => {
      setView("list");
      persist(drafts, selected, "list");
    } }, tr(t, "list_view", "Location list")), /* @__PURE__ */ React2.createElement("button", { type: "button", onClick: () => heading.current?.focus() }, tr(t, "jump_move", "Jump to current move"))), role === "teacher" && step.phase === "choose" && !progress.complete && /* @__PURE__ */ React2.createElement(ClassProposals, { board, run, roster, onSelect: select, t }), /* @__PURE__ */ React2.createElement("div", { className: "lb-columns" }, /* @__PURE__ */ React2.createElement("div", null, /* @__PURE__ */ React2.createElement(BoardMap, { board, progress, ready, selected: inspectId || targetId, onSelect: select, view, currentId: step.phase === "answer" ? step.targetId : "", t }), /* @__PURE__ */ React2.createElement("h3", null, tr(t, "projects", "Construction projects")), /* @__PURE__ */ React2.createElement("div", { className: "lb-projects" }, board.projects.map((project) => /* @__PURE__ */ React2.createElement("button", { type: "button", key: project.id, "data-project": project.id, "aria-pressed": (inspectId || targetId) === project.id, onClick: () => select(project.id) }, /* @__PURE__ */ React2.createElement(Icon, { name: project.icon }), /* @__PURE__ */ React2.createElement("strong", null, project.name), /* @__PURE__ */ React2.createElement("small", null, progress.built.includes(project.id) ? tr(t, "built", "Built") : tr(t, "cost", "Cost: {cost}", { cost: cost(project.cost) })), /* @__PURE__ */ React2.createElement("small", null, projectEffect(project))))), inspected && /* @__PURE__ */ React2.createElement("section", { className: "lb-panel", style: { marginTop: 14 }, "data-board-inspection": true }, /* @__PURE__ */ React2.createElement("h3", { ref: inspection, tabIndex: -1 }, inspected.name), /* @__PURE__ */ React2.createElement("p", null, inspected.scene || inspected.description), /* @__PURE__ */ React2.createElement(MovePreview, { board, run, target: inspected, t }), inspected.cost ? /* @__PURE__ */ React2.createElement("p", null, projectEffect(inspected)) : progress.visited.includes(inspected.id) && /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("p", null, inspected.explanation), /* @__PURE__ */ React2.createElement("blockquote", null, inspected.sourceQuote)), /* @__PURE__ */ React2.createElement("button", { type: "button", onClick: () => {
      setInspectId("");
      heading.current?.focus();
    } }, tr(t, "return_move", "Return to current move")))), /* @__PURE__ */ React2.createElement("section", { className: "lb-panel lb-current", "aria-label": tr(t, "current_move", "Current move") }, /* @__PURE__ */ React2.createElement("h3", { ref: heading, tabIndex: -1 }, progress.complete ? tr(t, "well_done", "Your board is complete") : target.name), progress.complete ? /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("p", null, board.debrief), /* @__PURE__ */ React2.createElement("h4", null, tr(t, "built_choices", "Your construction choices")), /* @__PURE__ */ React2.createElement("ul", null, board.projects.filter((p) => progress.built.includes(p.id)).map((p) => /* @__PURE__ */ React2.createElement("li", { key: p.id }, p.name, " \u2014 ", projectEffect(p)))), /* @__PURE__ */ React2.createElement("p", null, tr(t, "reflect", "Which decision helped your route? Use lesson evidence to explain one connection or construction.")), progress.performance[uid] && /* @__PURE__ */ React2.createElement("p", null, tr(t, "your_learning", "Your recorded responses: {correct} correct out of {answered}. Shared construction progress is separate.", progress.performance[uid]))) : /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("p", null, target.scene || target.description), step.phase === "choose" && /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(MovePreview, { board, run, target, t }), target.cost && /* @__PURE__ */ React2.createElement("p", null, projectEffect(target)), ready.includes(target.id) ? /* @__PURE__ */ React2.createElement("button", { type: "button", className: "lb-primary", "data-board-move": target.id, disabled: locked, onClick: () => onMove(target.id) }, role === "student" ? tr(t, "propose", "Propose this move") : target.cost ? tr(t, "build", "Build this project") : tr(t, "explore", "Explore this location")) : /* @__PURE__ */ React2.createElement("p", null, target.cost ? progress.built.includes(target.id) ? tr(t, "already_built", "This project is already built.") : tr(t, "need_resources", "Explore more locations to earn the required resources.") : progress.visited.includes(target.id) ? tr(t, "already_explored", "Already explored. Its resources have been collected.") : tr(t, "reach_help", "Explore a connected location or build a shortcut to open this location.")), role !== "solo" && /* @__PURE__ */ React2.createElement("p", null, tr(t, "votes", "Confirmed proposals for this move: {count}.", { count: votes.filter((id) => id === target.id).length })), step.votes?.[uid] && role === "student" && /* @__PURE__ */ React2.createElement("p", { role: "status" }, tr(t, "your_proposal", "Your confirmed proposal: {name}", { name: [...board.locations, ...board.projects].find((n) => n.id === step.votes[uid])?.name || "" })), !target.cost && progress.visited.includes(target.id) && /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("p", null, target.explanation), /* @__PURE__ */ React2.createElement("blockquote", null, target.sourceQuote))), step.phase === "answer" && activeNode && /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("p", null, activeNode.instruction), /* @__PURE__ */ React2.createElement("fieldset", { disabled: locked || answered || role === "teacher" }, /* @__PURE__ */ React2.createElement("legend", null, tr(t, "activity", "Lesson activity")), /* @__PURE__ */ React2.createElement(Activity, { key: run.turn, node: activeNode, value: answered ? step.answers[uid].value : draft, disabled: locked || answered || role === "teacher", t, onChange: (value) => {
      const next = { [draftKey]: value };
      setDrafts(next);
      persist(next);
    } })), role !== "teacher" && /* @__PURE__ */ React2.createElement("button", { type: "button", className: "lb-primary", "data-board-submit": true, disabled: locked || answered || !validValue(activeNode, draft), onClick: () => onAnswer(draft) }, answered ? tr(t, "confirmed", "Response confirmed") : tr(t, "submit", "Submit response")), answered && /* @__PURE__ */ React2.createElement("p", { role: "status" }, tr(t, "wait_review", "Your response is confirmed. Review the lesson while the teacher gathers responses.")), /* @__PURE__ */ React2.createElement("details", null, /* @__PURE__ */ React2.createElement("summary", null, tr(t, "hints", "Hints and lesson evidence")), /* @__PURE__ */ React2.createElement("blockquote", null, activeNode.sourceQuote), activeNode.hints.map((hint, index) => /* @__PURE__ */ React2.createElement("details", { key: index }, /* @__PURE__ */ React2.createElement("summary", null, tr(t, "hint", "Hint {number}", { number: index + 1 })), /* @__PURE__ */ React2.createElement("p", null, hint)))), role === "teacher" && /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("p", null, tr(t, "response_count", "{count}/{total} learners have confirmed responses.", { count: answers.length, total: Object.keys(roster).length })), /* @__PURE__ */ React2.createElement("p", { className: "lb-muted" }, tr(t, "shared_rule", "The location is explored when at least half of the submitted responses are correct. Missing responses are not marked wrong. An unsuccessful activity costs no resources and can be tried again.")), /* @__PURE__ */ React2.createElement("button", { type: "button", ref: resolveTrigger, "data-board-resolve": true, disabled: locked || !answers.length, onClick: () => answers.length < Object.keys(roster).length ? setConfirmEarly(true) : onResolve() }, tr(t, "review_responses", "Review responses and resolve")), confirmEarly && /* @__PURE__ */ React2.createElement("div", { className: "lb-notice", role: "group", onKeyDown: (event) => {
      if (event.key === "Escape") {
        event.preventDefault();
        event.stopPropagation();
        cancelEarly();
      }
    }, "aria-label": tr(t, "early_review", "Resolve before everyone responds") }, /* @__PURE__ */ React2.createElement("p", null, tr(t, "early_notice", "{count} learners have not confirmed a response. Continue with the responses already received?", { count: Object.keys(roster).length - answers.length })), /* @__PURE__ */ React2.createElement("button", { type: "button", disabled: locked, onClick: () => {
      setConfirmEarly(false);
      onResolve();
    } }, tr(t, "resolve_received", "Resolve received responses")), /* @__PURE__ */ React2.createElement("button", { type: "button", ref: earlyCancel, disabled: locked, onClick: cancelEarly }, tr(t, "keep_waiting", "Keep waiting"))), /* @__PURE__ */ React2.createElement("details", null, /* @__PURE__ */ React2.createElement("summary", null, tr(t, "teacher_responses", "Teacher response review")), /* @__PURE__ */ React2.createElement("ul", null, answers.map((id) => /* @__PURE__ */ React2.createElement("li", { key: id }, /* @__PURE__ */ React2.createElement("strong", null, roster[id]?.name || id, ": ", step.answers[id].correct ? tr(t, "correct", "Correct") : tr(t, "revisit", "Needs review")), /* @__PURE__ */ React2.createElement("p", null, responseText(activeNode, step.answers[id].value))))), /* @__PURE__ */ React2.createElement("p", null, /* @__PURE__ */ React2.createElement("strong", null, tr(t, "solution", "Solution"), ": "), responseText(activeNode, solution(activeNode))), /* @__PURE__ */ React2.createElement("p", null, activeNode.explanation)))), step.phase === "review" && /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("p", { className: "lb-notice" }, target.cost ? tr(t, "project_completed", "Project built. Its effect now applies to your board.") : result?.success ? tr(t, "location_completed", "Location explored. Resources collected and connected paths opened.") : tr(t, "retry_activity", "This idea needs another look. No resources were lost. You can return to this location on a later move.")), activeNode && /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement("p", null, activeNode.explanation), /* @__PURE__ */ React2.createElement("blockquote", null, activeNode.sourceQuote), typeof personalResult === "boolean" && /* @__PURE__ */ React2.createElement("p", null, personalResult ? tr(t, "your_correct", "Your response demonstrated this idea.") : tr(t, "your_revisit", "Revisit your response using this explanation.")), role === "teacher" && /* @__PURE__ */ React2.createElement("p", null, tr(t, "round_learning", "{correct}/{total} submitted responses were correct.", { correct: Object.values(result?.marks || {}).filter(Boolean).length, total: Object.keys(result?.marks || {}).length }))), role !== "student" ? /* @__PURE__ */ React2.createElement("button", { type: "button", className: "lb-primary", "data-board-next": true, disabled: locked, onClick: onAdvance }, tr(t, "next_move", "Choose the next move")) : /* @__PURE__ */ React2.createElement("p", null, tr(t, "teacher_next", "The teacher will open the next move after discussion.")))))), role === "teacher" && /* @__PURE__ */ React2.createElement(TeacherLearningReview, { board, run, roster, t }), /* @__PURE__ */ React2.createElement("details", null, /* @__PURE__ */ React2.createElement("summary", null, tr(t, "learning_trail", "Learning trail")), /* @__PURE__ */ React2.createElement("ul", null, board.concepts.map((c) => /* @__PURE__ */ React2.createElement("li", { key: c.id }, c.name, ": ", progress.concepts.includes(c.id) ? tr(t, "explored", "Explored") : tr(t, "not_yet", "Still to explore")))), board.locations.filter((n) => progress.visited.includes(n.id)).map((n) => /* @__PURE__ */ React2.createElement("details", { key: n.id }, /* @__PURE__ */ React2.createElement("summary", null, n.name), /* @__PURE__ */ React2.createElement("p", null, n.explanation), /* @__PURE__ */ React2.createElement("blockquote", null, n.sourceQuote)))));
  }
  ...
  function BoardAuthoring({ board, source, disabled, onChange, t }) {
    ...
    const textField = (label, value, limit, onChange2, data = {}) => /* @__PURE__ */ React3.createElement("label", null, label, /* @__PURE__ */ React3.createElement("textarea", { ...data, value, maxLength: limit, disabled, onChange: (event) => onChange2(event.target.value) }));
    return /* @__PURE__ */ React3.createElement("details", { "data-board-editor": true }, /* @__PURE__ */ React3.createElement("summary", null, tr(t, "edit_board", "Review and edit the board")), /* @__PURE__ */ React3.createElement("p", null, tr(t, "editor_help", "Review every option, solution, hint and source excerpt. Edits apply to this board before play; saved copies stay unchanged until you save again.")), errors.length > 0 && /* @__PURE__ */ React3.createElement("div", { className: "lb-notice", role: "status", "data-board-validation": true }, /* @__PURE__ */ React3.createElement("strong", null, tr(t, "editor_fix", "Fix these items before saving or playing:")), /* @__PURE__ */ React3.createElement("ul", null, errors.map((error, index) => /* @__PURE__ */ React3.createElement("li", { key: index }, error)))), /* @__PURE__ */ React3.createElement("label", null, tr(t, "board_title", "Board title"), /* @__PURE__ */ React3.createElement("input", { maxLength: 120, value: board.title, disabled, onChange: (event) => onChange({ ...board, title: event.target.value }) })), textField(tr(t, "mission", "Mission"), board.mission, 1200, (value) => onChange({ ...board, mission: value })), textField(tr(t, "debrief", "Closing reflection"), board.debrief, 1200, (value) => onChange({ ...board, debrief: value })), board.locations.map((node) => /* @__PURE__ */ React3.createElement("details", { key: node.id, "data-edit-location": node.id }, /* @__PURE__ */ React3.createElement("summary", null, node.name, " \xB7 ", board.concepts.find((concept) => concept.id === node.conceptId)?.name), textField(tr(t, "scene", "Location description"), node.scene, 450, (value) => edit(node.id, { scene: value })), textField(tr(t, "instruction", "Activity instruction"), node.instruction, 900, (value) => edit(node.id, { instruction: value })), /* @__PURE__ */ React3.createElement("fieldset", { disabled }, /* @__PURE__ */ React3.createElement("legend", null, tr(t, "options_key", "Response options and answer key")), node.kind === "choice" && /* @__PURE__ */ React3.createElement(React3.Fragment, null, node.options.map((option, index) => textField(tr(t, "option_number", "Option {number}", { number: index + 1 }), option, 220, (value) => edit(node.id, { options: node.options.map((old, i) => i === index ? value : old) }), { key: index, "data-edit-option": index })), /* @__PURE__ */ React3.createElement("label", null, tr(t, "correct_option", "Correct option"), /* @__PURE__ */ React3.createElement("select", { "data-edit-answer": true, value: node.answer, onChange: (event) => edit(node.id, { answer: Number(event.target.value) }) }, node.options.map((option, index) => /* @__PURE__ */ React3.createElement("option", { key: index, value: index }, index + 1, ". ", option))))), node.kind === "order" && /* @__PURE__ */ React3.createElement(React3.Fragment, null, node.items.map((item, index) => textField(tr(t, "item_number", "Item {number}", { number: index + 1 }), item, 180, (value) => edit(node.id, { items: node.items.map((old, i) => i === index ? value : old) }), { key: index, "data-edit-item": index })), /* @__PURE__ */ React3.createElement("p", null, tr(t, "correct_order", "Arrange the correct order with the up and down buttons.")), /* @__PURE__ */ React3.createElement(Activity, { node, value: node.order.join(","), disabled, t, onChange: (value) => edit(node.id, { order: value.split(",").map(Number) }) })), node.kind === "settings" && node.controls.map((control, index) => /* @__PURE__ */ React3.createElement("fieldset", { key: index, "data-edit-control": index }, /* @__PURE__ */ React3.createElement("legend", null, tr(t, "control_number", "Setting {number}", { number: index + 1 })), /* @__PURE__ */ React3.createElement("label", null, tr(t, "control_label", "Setting label"), /* @__PURE__ */ React3.createElement("input", { maxLength: 100, value: control.label, onChange: (event) => controlEdit(node, index, { label: event.target.value }) })), control.options.map((option, item) => textField(tr(t, "option_number", "Option {number}", { number: item + 1 }), option, 160, (value) => controlEdit(node, index, { options: control.options.map((old, i) => i === item ? value : old) }), { key: item, "data-edit-option": item })), /* @__PURE__ */ React3.createElement("label", null, tr(t, "correct_option", "Correct option"), /* @__PURE__ */ React3.createElement("select", { "data-edit-answer": true, value: control.answer, onChange: (event) => controlEdit(node, index, { answer: Number(event.target.value) }) }, control.options.map((option, item) => /* @__PURE__ */ React3.createElement("option", { key: item, value: item }, item + 1, ". ", option))))))), textField(tr(t, "explanation", "Explanation"), node.explanation, 1e3, (value) => edit(node.id, { explanation: value })), node.hints.map((hint, index) => textField(tr(t, "hint", "Hint {number}", { number: index + 1 }), hint, 400, (value) => edit(node.id, { hints: node.hints.map((old, i) => i === index ? value : old) }), { key: index, "data-edit-hint": index })), textField(tr(t, "source_excerpt", "Exact lesson excerpt"), node.sourceQuote, 650, (value) => edit(node.id, { sourceQuote: value }), { "data-edit-quote": true }))), board.projects.map((project) => /* @__PURE__ */ React3.createElement("details", { key: project.id }, /* @__PURE__ */ React3.createElement("summary", null, project.name), /* @__PURE__ */ React3.createElement("p", null, project.description), /* @__PURE__ */ React3.createElement("p", null, project.cost.map((value, index) => value + " " + board.resources[index]).join(" \xB7 ")), /* @__PURE__ */ React3.createElement("p", null, project.effect.kind === "yield" ? tr(t, "yield_effect", "Future successful locations earn +1 {resource}.", { resource: board.resources[project.effect.resource] }) : tr(t, "path_effect", "Opens a direct path to {location}.", { location: board.locations.find((node) => node.id === project.effect.targetId)?.name })))));
  }
  ...
  var { useState: useState2, useEffect: useEffect3, useRef: useRef2 } = React4;
  ...
  function Confirmation({ title, message, confirm, onConfirm, onCancel, busy, t }) {
    const cancel = useRef2(null), trigger = useRef2(document.activeElement);
    useEffect3(() => {
    ...
    return /* @__PURE__ */ React4.createElement("div", { className: "lb-notice", role: "group", "aria-label": title, onKeyDown: (event) => {
      if (event.key === "Escape" && !busy) {
        event.preventDefault();
        event.stopPropagation();
        onCancel();
      }
    } }, /* @__PURE__ */ React4.createElement("h3", null, title), /* @__PURE__ */ React4.createElement("p", null, message), /* @__PURE__ */ React4.createElement("div", { className: "lb-row" }, /* @__PURE__ */ React4.createElement("button", { type: "button", disabled: busy, onClick: onConfirm }, confirm), /* @__PURE__ */ React4.createElement("button", { type: "button", ref: cancel, disabled: busy, onClick: onCancel }, tr(t, "cancel", "Cancel"))));
  }
  function LessonBoardSolo({ board, user, appId, onBack, preview = false, t }) {
    ...
    const [run, setRun] = useState2(initial.run), [error, setError] = useState2(initial.error || ""), [storageError, setStorageError] = useState2(""), [confirm, setConfirm] = useState2(false), [reset, setReset] = useState2(0);
    const update = (next) => {
      setRun(next);
      if (storageKey) try {
    ...
    return /* @__PURE__ */ React4.createElement(React4.Fragment, null, /* @__PURE__ */ React4.createElement("div", { className: "lb-row" }, /* @__PURE__ */ React4.createElement("button", { type: "button", onClick: onBack }, tr(t, "back_setup", "Back to board setup")), /* @__PURE__ */ React4.createElement("button", { type: "button", onClick: () => setConfirm(true) }, preview ? tr(t, "reset_preview", "Reset preview") : tr(t, "restart_solo", "Restart solo board")), /* @__PURE__ */ React4.createElement("span", null, preview ? tr(t, "preview_label", "Practice preview") : tr(t, "solo_label", "Solo \xB7 progress saved in this tab"))), error && /* @__PURE__ */ React4.createElement("p", { className: "lb-notice", role: "alert" }, error), storageError && /* @__PURE__ */ React4.createElement("p", { className: "lb-notice", role: "status" }, storageError), initial.error && error && /* @__PURE__ */ React4.createElement("button", { type: "button", onClick: () => {
      setConfirm(true);
    } }, tr(t, "new_local", "Start a new local game")), confirm && /* @__PURE__ */ React4.createElement(Confirmation, { t, title: tr(t, "restart_title", "Restart this board?"), message: tr(t, "restart_solo_notice", "This resets your local progress and unfinished settings. The board stays available."), confirm: tr(t, "reset_progress", "Reset my progress"), onCancel: () => setConfirm(false), onConfirm: () => {
      update(emptyRun());
      setError("");
      if (storageKey) try {
      ...
      setReset((n) => n + 1);
      setConfirm(false);
    } }), /* @__PURE__ */ React4.createElement(BoardView, { key: reset, board, run, busy: !!(initial.error && error) || confirm, roster: { solo: {} }, workspaceKey: storageKey && storageKey + ":draft", onMove: (id) => action((current) => merge(current, begin(board, current, id))), onAnswer: answer, onAdvance: () => action((current) => merge(current, advance(board, current))), t }));
  }
  function LessonBoardSetup({ inputText, generatedContent, language = "English", callGemini, user, appId, activeSessionCode, sessionData, allowLive = true, onClose, onLaunched, t }) {
    const source = sourceText(inputText, generatedContent), scope = language + ":" + source, dialog = useRef2(null), closeRef = useRef2(onClose), scopeRef = useRef2(scope), request = useRef2(0), generationBusy = useRef2(null), mounted = useRef2(true);
    closeRef.current = onClose;
    scopeRef.current = scope;
    useRoomDialog(dialog, closeRef);
    const [board, setBoard] = useState2(null), [library, setLibrary] = useState2([]), [stage, setStage] = useState2(""), [error, setError] = useState2(""), [notice, setNotice] = useState2(""), [theme, setTheme] = useState2(""), [level, setLevel] = useState2(""), [playing, setPlaying] = useState2(""), [choice, setChoice] = useState2(null);
    useEffect3(() => {
    ...
    const generate = async () => {
      ...
      try {
        ...
        if (mounted.current && request.current === id) setError(error2.message);
      } finally {
    ...
    return /* @__PURE__ */ React4.createElement("div", { className: "lb-backdrop" }, /* @__PURE__ */ React4.createElement("section", { className: "lb lb-dialog", "data-theme": board?.theme, ref: dialog, role: "dialog", "aria-modal": "true", "aria-label": tr(t, "title", "Lesson board game"), tabIndex: -1 }, /* @__PURE__ */ React4.createElement(Styles, null), /* @__PURE__ */ React4.createElement("div", { className: "lb-row lb-between" }, /* @__PURE__ */ React4.createElement("h2", null, tr(t, "title", "Lesson board game")), /* @__PURE__ */ React4.createElement("button", { type: "button", onClick: onClose }, tr(t, "close", "Close"))), playing && board ? /* @__PURE__ */ React4.createElement(LessonBoardSolo, { key: JSON.stringify(board), board, user, appId, preview: playing === "preview", t, onBack: () => {
      setPlaying("");
      setTimeout(() => dialog.current?.querySelector("[data-board-play-solo]")?.focus(), 0);
    } }) : /* @__PURE__ */ React4.createElement(React4.Fragment, null, /* @__PURE__ */ React4.createElement("p", null, tr(t, "intro", "Generate a lesson-based board, explore its activities, and build useful projects. Play solo or share one cooperative board with your class.")), /* @__PURE__ */ React4.createElement("p", null, tr(t, "language", "Board language: {language}", { language })), /* @__PURE__ */ React4.createElement("details", null, /* @__PURE__ */ React4.createElement("summary", null, tr(t, "source", "Lesson source")), /* @__PURE__ */ React4.createElement("blockquote", null, source || tr(t, "need_source", "Add lesson text or generate a quiz first."))), error && /* @__PURE__ */ React4.createElement("p", { className: "lb-notice", role: "alert" }, error), /* @__PURE__ */ React4.createElement("p", { role: "status" }, stage === "generating" ? tr(t, "generating", "Creating the board and lesson activities\u2026") : stage === "repairing" ? tr(t, "repairing", "Repairing paths, activities, or resource balance\u2026") : stage === "launching" ? tr(t, "launching", "Launching the shared board\u2026") : notice), /* @__PURE__ */ React4.createElement("div", { className: "lb-form" }, /* @__PURE__ */ React4.createElement("label", null, tr(t, "theme", "Setting preference (optional)"), /* @__PURE__ */ React4.createElement("input", { value: theme, maxLength: 150, disabled: !!stage || !!choice, onChange: (e) => setTheme(e.target.value) })), /* @__PURE__ */ React4.createElement("label", null, tr(t, "level", "Learner level (optional)"), /* @__PURE__ */ React4.createElement("input", { value: level, maxLength: 80, disabled: !!stage || !!choice, onChange: (e) => setLevel(e.target.value) }))), /* @__PURE__ */ React4.createElement("button", { type: "button", className: "lb-primary", "data-generate-board": true, disabled: !!stage || !!choice || source.length < 40, onClick: generate }, board ? tr(t, "generate_another", "Generate another board") : tr(t, "generate", "Generate lesson board")), library.length > 0 && /* @__PURE__ */ React4.createElement("details", null, /* @__PURE__ */ React4.createElement("summary", null, tr(t, "saved_boards", "Saved boards for this lesson"), " (", library.length, "/4)"), library.map((saved, index) => /* @__PURE__ */ React4.createElement("div", { className: "lb-row", key: index }, /* @__PURE__ */ React4.createElement("span", null, saved.title), /* @__PURE__ */ React4.createElement("button", { type: "button", disabled: !!stage || !!choice, onClick: () => setChoice({ kind: "open", index }) }, tr(t, "open_saved", "Open saved board")), /* @__PURE__ */ React4.createElement("button", { type: "button", disabled: !!stage || !!choice, onClick: () => setChoice({ kind: "remove", index }) }, tr(t, "remove_saved", "Remove saved board"))))), choice && /* @__PURE__ */ React4.createElement(Confirmation, { t, title: choice.kind === "open" ? tr(t, "open_saved", "Open saved board") : tr(t, "remove_saved", "Remove saved board"), message: choice.kind === "open" ? tr(t, "replace_notice", "Replace the current preview and any unsaved edits with {name}?", { name: library[choice.index]?.title }) : tr(t, "remove_notice", "Remove {name} from this browser library? The current preview stays available.", { name: library[choice.index]?.title }), confirm: choice.kind === "open" ? tr(t, "replace_preview", "Replace preview") : tr(t, "remove_saved", "Remove saved board"), onCancel: () => setChoice(null), onConfirm: () => {
      try {
        if (choice.kind === "open") setBoard(library[choice.index]);
        else setLibrary(removeBoard(localStorage, source, language, choice.index));
        setChoice(null);
        setError("");
      } catch (error2) {
        setError(error2.message);
      }
    } }), board && /* @__PURE__ */ React4.createElement(React4.Fragment, null, /* @__PURE__ */ React4.createElement("section", { className: "lb-panel", style: { marginTop: 18 } }, /* @__PURE__ */ React4.createElement("h3", null, board.title), /* @__PURE__ */ React4.createElement("p", null, board.mission), /* @__PURE__ */ React4.createElement("p", null, tr(t, "overview", "{locations} locations \xB7 {concepts} concepts \xB7 three projects to choose from", { locations: board.locations.length, concepts: board.concepts.length })), /* @__PURE__ */ React4.createElement("div", { className: "lb-row" }, /* @__PURE__ */ React4.createElement("button", { type: "button", disabled: !!stage || !!choice, onClick: () => play("preview") }, tr(t, "try_board", "Try the board")), /* @__PURE__ */ React4.createElement("button", { type: "button", "data-board-play-solo": true, disabled: !!stage || !!choice, onClick: () => play("solo") }, tr(t, "play_solo", "Play solo")), /* @__PURE__ */ React4.createElement("button", { type: "button", disabled: !!stage || !!choice, onClick: save }, tr(t, "save_board", "Save board")), allowLive && activeSessionCode && /* @__PURE__ */ React4.createElement("button", { type: "button", className: "lb-primary", "data-launch-board": true, disabled: !!stage || !!choice || sessionData?.escapeRoomState?.isActive || sessionData?.quizState?.isActive, onClick: launch }, tr(t, "launch", "Launch for everyone"))), /* @__PURE__ */ React4.createElement("p", { className: "lb-muted" }, tr(t, "review_guidance", "Check the activities, solutions and constructions before play. Connection and balance checks do not establish factual accuracy.")), allowLive && activeSessionCode && /* @__PURE__ */ React4.createElement("p", { className: "lb-muted" }, tr(t, "host_required", "Keep the teacher session open and connected during live play. The teacher chooses moves and resolves activities after learners respond."))), /* @__PURE__ */ React4.createElement(BoardAuthoring, { board, source, disabled: !!stage || !!choice, t, onChange: (next) => {
      setNotice("");
      setError("");
      setBoard(next);
    } })))));
  ...
  function LessonBoardHost({ sessionData, activeSessionCode, appId }) {
    const state = sessionData?.escapeRoomState, scope = scopeOf(appId, activeSessionCode, state), [retry, setRetry] = useState2(0), current = useRef2({ state, sessionData });
  ...
  function LessonBoardStudent({ sessionData, user, targetAppId, activeSessionCode, t }) {
    ...
    const [pending, setPending] = useState2(null), pendingRef = useRef2(null), sendRef = useRef2(null), scopeRef = useRef2(scope), mounted = useRef2(true), [sending, setSending] = useState2(false), [slow, setSlow] = useState2(false), [error, setError] = useState2(""), [notice, setNotice] = useState2(""), [joining, setJoining] = useState2(false), joinRef = useRef2(null), [pendingSaved, setPendingSaved] = useState2(true);
    scopeRef.current = scope;
    useEffect3(() => {
      mounted.current = true;
      return () => {
    ...
    if (!user?.uid) return /* @__PURE__ */ React4.createElement("div", { className: "lb lb-overlay" }, /* @__PURE__ */ React4.createElement(Styles, null), /* @__PURE__ */ React4.createElement("p", { role: "status" }, tr(t, "waiting_identity", "Waiting for your live session connection\u2026")));
    if (validateBoard(state.board).length) return /* @__PURE__ */ React4.createElement("div", { className: "lb lb-overlay" }, /* @__PURE__ */ React4.createElement(Styles, null), /* @__PURE__ */ React4.createElement("p", { role: "alert" }, tr(t, "invalid", "This board could not be opened. Ask the teacher to regenerate it.")));
    return /* @__PURE__ */ React4.createElement("div", { className: "lb lb-overlay", "data-theme": state.board.theme, role: "region", "aria-label": tr(t, "live_board", "Cooperative lesson board") }, /* @__PURE__ */ React4.createElement(Styles, null), /* @__PURE__ */ React4.createElement("div", { className: "lb-shell" }, state.teams?.[user?.uid] !== "All" && /* @__PURE__ */ React4.createElement("button", { type: "button", disabled: joining, onClick: join }, tr(t, "join_board", "Join shared board")), error && /* @__PURE__ */ React4.createElement("p", { className: "lb-notice", role: "alert" }, error), pending && /* @__PURE__ */ React4.createElement("div", { className: "lb-notice", "data-board-pending": true, role: "status" }, /* @__PURE__ */ React4.createElement("p", null, sending ? tr(t, "sending", "Sending your action\u2026") : tr(t, "waiting", "Waiting for teacher confirmation. Keep this page open.")), !pendingSaved && /* @__PURE__ */ React4.createElement("p", null, tr(t, "pending_not_saved", "Browser storage is unavailable. Keep this page open until confirmation; a reload may lose this pending action.")), (slow || error || !sending) && /* @__PURE__ */ React4.createElement("button", { type: "button", "aria-disabled": sending || state.isPaused, onClick: () => {
      if (!sending && !state.isPaused) transmit(pending);
    } }, tr(t, "retry_action", "Retry this action"))), /* @__PURE__ */ React4.createElement(BoardView, { key: scope, board: state.board, run, role: "student", uid: user.uid, roster: sessionData.roster, pending, paused: state.isPaused, busy: state.teams?.[user?.uid] !== "All", notice, workspaceKey: "allo-board-draft:" + scope, t, onMove: (id) => action("vote", id), onAnswer: (value) => action("answer", stepOf(run).targetId, value) })));
  }
  function LessonBoardTeacher({ sessionData, appId, activeSessionCode, t }) {
    const state = sessionData?.escapeRoomState, scope = scopeOf(appId, activeSessionCode, state), run = runOf(state), { busy, error: hostError } = useRuntime(scope), [error, setError] = useState2(""), [confirm, setConfirm] = useState2(""), current = useRef2({ state, run, sessionData }), mounted = useRef2(true);
    ...
    if (state?.mode !== "lesson-board" || !state.isActive) return null;
    if (validateBoard(state.board).length) return /* @__PURE__ */ React4.createElement("p", { role: "alert" }, tr(t, "invalid", "This board could not be opened. Ask the teacher to regenerate it."));
    return /* @__PURE__ */ React4.createElement("section", { className: "lb lb-panel", "data-theme": state.board.theme, "aria-label": tr(t, "teacher_controls", "Lesson board teacher controls") }, /* @__PURE__ */ React4.createElement(Styles, null), /* @__PURE__ */ React4.createElement(LessonBoardHost, { sessionData, appId, activeSessionCode }), /* @__PURE__ */ React4.createElement("div", { className: "lb-row" }, /* @__PURE__ */ React4.createElement("button", { type: "button", disabled: busy || !!confirm, onClick: () => commit("pause") }, state.isPaused ? tr(t, "resume", "Resume board") : tr(t, "pause", "Pause board")), /* @__PURE__ */ React4.createElement("button", { type: "button", disabled: busy || !!confirm, onClick: () => setConfirm("restart") }, tr(t, "restart", "Restart shared board")), /* @__PURE__ */ React4.createElement("button", { type: "button", disabled: busy || !!confirm, onClick: () => setConfirm("end") }, tr(t, "end", "End board"))), /* @__PURE__ */ React4.createElement("p", { className: "lb-muted" }, tr(t, "host_required", "Keep the teacher session open and connected during live play. The teacher chooses moves and resolves activities after learners respond.")), (error || hostError) && /* @__PURE__ */ React4.createElement("p", { role: "alert", className: "lb-notice" }, error || hostError), confirm && /* @__PURE__ */ React4.createElement(Confirmation, { busy, t, title: confirm === "restart" ? tr(t, "restart_title", "Restart this board?") : tr(t, "end_title", "End the shared board?"), message: confirm === "restart" ? tr(t, "restart_live_notice", "Everyone starts again with no explored locations, constructed projects, or responses. The generated board stays the same.") : tr(t, "end_notice", "This closes the board for everyone. Review the learning before ending."), confirm: confirm === "restart" ? tr(t, "restart_everyone", "Restart for everyone") : tr(t, "end_everyone", "End for everyone"), onCancel: () => setConfirm(""), onConfirm: () => commit(confirm) }), /* @__PURE__ */ React4.createElement(BoardView, { key: scope, board: state.board, run, role: "teacher", roster: sessionData.roster || {}, busy: busy || !!confirm, paused: state.isPaused, onMove: (id) => commit({ move: id }), onResolve: () => commit("resolve"), onAdvance: () => commit("next"), t }));
  }
