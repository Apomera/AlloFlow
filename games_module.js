 ...
 *
 * Contains: MemoryGame, MatchingGame, TimelineGame, ConceptSortGame, VennGame, CauseEffectSortGame, PipelineBuilderGame, CrosswordGame, SyntaxScramble, BingoGame, StudentBingoGame, WordScrambleGame, TChartSortGame, ConceptMapSortGame, OutlineSortGame, FishboneSortGame, ProblemSolutionSortGame
 *
...
const WordScrambleGame = React.memo(({ data, onClose, playSound, onScoreUpdate }) => {
  ...
  console.log('[GamesBundle] 17 game components registered');
})();
