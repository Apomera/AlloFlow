...
let level = localStorage.getItem('coaster_lab_level') || 'engineer';
let exploreAns = {};
      ...
      function bridge(ev){
        ...
        setToolData(function (prev) {
          ...
          if (ev.event === 'run') s.runs = (s.runs || 0) + 1;
            ...
            if (!s.certified && typeof addToast === 'function') { try { addToast('★ Coaster certified!', 'success'); } catch (e) {} }
            s.certified = true;
          }
          ...
          else if (ev.event === 'missions') s.missionCount = Math.max(s.missionCount || 0, ev.count || 0);
