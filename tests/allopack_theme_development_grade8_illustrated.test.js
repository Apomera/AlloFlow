...
const slug='theme_development_grade8',folder='allopacks/media/'+slug+'/',pack=read('allopacks/illustrated/'+slug+'.allopack.json'),original=read('allopacks/'+slug+'.allopack.json'),manifest=read(folder+'manifest.json');
...
describe('theme_development_grade8 illustrated edition',()=>{
