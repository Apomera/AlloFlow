...
function buildMemoryAidReadAloudText(card, tr) {
  ...
  const sections = [
    ...
    normalized.essentialFacts.length ? (normalized.factVerified ? T("speech_facts_verified", "Teacher-verified facts. ") : T("speech_facts_pending", "Facts awaiting teacher review. ")) + normalized.essentialFacts.join(" ") : ""
  ];
...
function MemoryAidPanel(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "animate-in motion-reduce:animate-none slide-in-from-top-2 duration-200" }, /* @__PURE__ */ React.createElement("div", { className: "m-3 space-y-4 rounded-2xl border border-teal-200 bg-teal-50/50 p-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-1 block text-xs font-black uppercase tracking-wide text-slate-700" }, tr("panel_aid_selection", "Aid selection")), /* @__PURE__ */ React.createElement("select", { "data-help-key": "memory_aid_selection", "aria-label": tr("panel_aid_selection_aria", "Memory aid selection"), value: memoryAidSelectionMode || "auto-mix", onChange: (event) => setMemoryAidSelectionMode(event.target.value), className: "min-h-11 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600" }, /* @__PURE__ */ React.createElement("option", { value: "auto-mix" }, tr("panel_auto_mix_option", "Auto Mix \u2014 match aids to the lesson")), /* @__PURE__ */ React.createElement("option", { value: "manual" }, tr("panel_choose_types_option", "Choose aid types")))), (memoryAidSelectionMode || "auto-mix") === "manual" && /* @__PURE__ */ React.createElement("fieldset", null, /* @__PURE__ */ React.createElement("legend", { className: "mb-2 text-xs font-black uppercase tracking-wide text-slate-700" }, tr("panel_include_at_least_one", "Include at least one")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2" }, Object.entries(MEMORY_AID_TYPES).map(([id, meta]) => {
    const active = selected.includes(id);
    return /* @__PURE__ */ React.createElement("button", { key: id, type: "button", "aria-pressed": active, onClick: () => toggleType(id), className: "min-h-11 rounded-xl border px-2 py-2 text-left text-xs font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 " + (active ? "border-teal-600 bg-teal-100 text-teal-950" : "border-slate-300 bg-white text-slate-700 hover:border-teal-400") }, trMeta("type", id, "shortLabel", MEMORY_AID_TYPES));
  }))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-1 block text-xs font-black uppercase tracking-wide text-slate-700" }, tr("panel_authorship_pathway", "Authorship pathway")), /* @__PURE__ */ React.createElement("select", { "data-help-key": "memory_aid_authorship", "aria-label": tr("panel_authorship_pathway_aria", "Memory aid authorship pathway"), value: memoryAidAuthorshipMode || "progressive", onChange: (event) => setMemoryAidAuthorshipMode(event.target.value), className: "min-h-11 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600" }, /* @__PURE__ */ React.createElement("option", { value: "progressive" }, tr("panel_progressive_option", "See one \u2192 Build one \u2192 Create one")), Object.entries(MEMORY_AID_MODES).map(([id]) => /* @__PURE__ */ React.createElement("option", { key: id, value: id }, trMeta("mode", id, "label", MEMORY_AID_MODES))))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-1 block text-xs font-black uppercase tracking-wide text-slate-700" }, tr("panel_student_reasoning", "Student reasoning")), /* @__PURE__ */ React.createElement("select", { "data-help-key": "memory_aid_reasoning", "aria-label": tr("panel_student_reasoning_aria", "Student reasoning level"), value: memoryAidReflectionLevel || "quick", onChange: (event) => updateReflectionLevel(event.target.value), className: "min-h-11 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600" }, Object.entries(MEMORY_AID_REFLECTION_LEVELS).map(([id]) => /* @__PURE__ */ React.createElement("option", { key: id, value: id }, trMeta("reflection", id, "label", MEMORY_AID_REFLECTION_LEVELS)))), /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-[11px] leading-snug text-slate-600" }, tr("panel_reasoning_help", "The mnemonic-to-fact connection is always visible. This controls whether students add their own explanation."))), (memoryAidReflectionLevel || "quick") !== "none" && /* @__PURE__ */ React.createElement("label", { className: "flex min-h-11 cursor-pointer items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-bold text-slate-700" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: memoryAidReasoningRequired === true, onChange: (event) => setMemoryAidReasoningRequired(event.target.checked), className: "h-4 w-4 accent-teal-700" }), tr("panel_require_reasoning", "Require reasoning before AI feedback")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-1 block text-xs font-black uppercase tracking-wide text-slate-700" }, tr("panel_target_count", "Number of memory targets")), /* @__PURE__ */ React.createElement("select", { "data-help-key": "memory_aid_count", "aria-label": tr("panel_target_count_aria", "Number of memory targets"), value: Number(memoryAidCount) || 3, onChange: (event) => setMemoryAidCount(Number(event.target.value)), className: "min-h-11 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600" }, /* @__PURE__ */ React.createElement("option", { value: 3 }, tr("panel_count_3", "3 \u2014 Compact")), /* @__PURE__ */ React.createElement("option", { value: 4 }, tr("panel_count_4", "4 \u2014 Standard")), /* @__PURE__ */ React.createElement("option", { value: 5 }, tr("panel_count_5", "5 \u2014 Extended")))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-1 block text-xs font-black uppercase tracking-wide text-slate-700" }, tr("panel_teacher_instructions", "Teacher instructions"), " ", /* @__PURE__ */ React.createElement("span", { className: "font-medium normal-case text-slate-500" }, tr("optional_paren", "(optional)"))), /* @__PURE__ */ React.createElement("textarea", { "data-help-key": "memory_aid_instructions", "aria-label": tr("panel_custom_instructions_aria", "Custom instructions for memory aids"), value: memoryAidCustomInstructions || "", onChange: (event) => setMemoryAidCustomInstructions(event.target.value), maxLength: 2e3, rows: 3, placeholder: tr("panel_custom_instructions_placeholder", "Prioritize vocabulary, avoid rhymes, connect to a class example..."), className: "w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600" }))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-help-key": "memory_aid_generate_button", "aria-label": tr("panel_generate_aria", "Generate memory aid resource"), onClick: () => handleGenerate("memory-aid"), disabled: !hasSourceOrAnalysis || isProcessing, "aria-busy": isProcessing, className: "group m-3 mt-0 flex min-h-12 w-[calc(100%_-_1.5rem)] items-center justify-between rounded-xl border border-teal-300 bg-white px-4 py-3 font-black text-teal-900 shadow-sm hover:bg-teal-50 disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600" }, /* @__PURE__ */ React.createElement("span", null, isProcessing ? tr("panel_building", "Building memory aids\u2026") : tr("panel_build", "Build Memory Aid Studio")), /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "\u2192")));
}
