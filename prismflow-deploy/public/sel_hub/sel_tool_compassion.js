    ...
    render: function(ctx) {
      ...
      var tabBar = h('div', {
        ...
        h('div', {
          ...
          h('span', { className: 'sel-badge', style: { marginLeft: '8px', fontSize: '10px', color: PURPLE, fontWeight: 700, whiteSpace: 'nowrap', background: _coC('#ede9fe'), padding: '2px 8px', borderRadius: '10px', flexShrink: 0 } }, exploredCount + '/' + TABS.length),
