...
| Learning chapters, diagrams, checks, flashcards, and memory aids | Structurally migrated; content review in progress | All 49 EPPP chapters and 109 of 415 flashcards have source-review records. The remaining flashcards, memory aids, term definitions, and diagrams retain separate review gates; independent qualified expert validation is still pending. |
