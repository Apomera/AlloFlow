...
function OpenSourceTab({ t }) {
  return /* @__PURE__ */ React.createElement("div", { className: "space-y-5 text-slate-700" }, /* @__PURE__ */ React.createElement("div", { className: "bg-indigo-50 p-4 rounded-lg border border-indigo-100" }, /* @__PURE__ */ React.createElement("h4", { className: "font-bold text-indigo-900 mb-1 flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true" }, "\u{1F49B}"), t("about.oss_credits_title") || "Built on open source"), /* @__PURE__ */ React.createElement("p", { className: "text-sm leading-relaxed text-slate-700" }, t("about.oss_credits_intro") || "AlloFlow is free and open source (AGPL-3.0), built on the generous work of the projects below. Thank you to their authors and communities. The projects highlighted first are ones you can explore directly inside AlloFlow.")), /* @__PURE__ */ React.createElement("div", { className: "bg-emerald-50 p-4 rounded-lg border border-emerald-100" }, /* @__PURE__ */ React.createElement("h5", { className: "font-bold text-emerald-900 text-sm mb-1" }, t("about.media_guardrails_title") || "Open/free media guardrails"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-700 leading-relaxed mb-3" }, t("about.media_guardrails_intro") || "Video Studio can track stock/open media credits in each project. We do not treat every free-stock site as open source: each asset needs its own license, source URL, and attribution record before sharing."), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2" }, MEDIA_SOURCE_GUIDE.map((item) => /* @__PURE__ */ React.createElement("a", { key: item.name, href: item.url, target: "_blank", rel: "noopener noreferrer", className: "block rounded-lg border border-emerald-100 bg-white p-3 hover:border-emerald-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600" }, /* @__PURE__ */ React.createElement("span", { className: "flex items-start justify-between gap-2" }, /* @__PURE__ */ React.createElement("strong", { className: "text-xs text-slate-800" }, item.name), /* @__PURE__ */ React.createElement("span", { className: "text-[10px] font-semibold text-emerald-700 bg-emerald-50 border border-emerald-100 rounded-full px-2 py-0.5" }, item.status)), /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] font-medium text-slate-500 mt-1" }, item.license), /* @__PURE__ */ React.createElement("span", { className: "block text-[11px] text-slate-600 leading-relaxed mt-1" }, item.guidance))))), /* @__PURE__ */ React.createElement("div", { className: "bg-amber-50 p-4 rounded-lg border border-amber-200" }, /* @__PURE__ */ React.createElement("h5", { className: "font-bold text-amber-950 text-sm mb-1" }, "Reading catalog acknowledgements"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-700 leading-relaxed" }, "Reading works and catalog records are not covered by AlloFlow\u2019s AGPL license. Every readable title keeps its creators, publisher, source link, exact item-level license, and applicable restrictions. Collections with mixed or unclear rights stay link-only until a title-level audit approves more."), /* @__PURE__ */ React.createElement("details", { className: "mt-3 rounded-lg border border-amber-200 bg-white group" }, /* @__PURE__ */ React.createElement("summary", { className: "min-h-11 cursor-pointer select-none px-3 py-2.5 font-bold text-amber-900 text-xs flex items-center gap-2 hover:text-amber-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-amber-700" }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "text-amber-600 group-open:rotate-90 transition-transform motion-reduce:transition-none" }, "\u25B8"), "View recognized reading sources (", READING_SOURCE_TOTAL, ")"), /* @__PURE__ */ React.createElement("div", { className: "px-3 pb-3 pt-1 space-y-4" }, READING_SOURCE_CREDITS.map((section) => /* @__PURE__ */ React.createElement("div", { key: section.group }, /* @__PURE__ */ React.createElement("h6", { className: "font-bold text-[10px] uppercase tracking-wider text-slate-500 mb-1.5" }, section.group), /* @__PURE__ */ React.createElement("ul", { className: "space-y-2 list-none" }, section.items.map((item) => /* @__PURE__ */ React.createElement("li", { key: item.sourceId, className: "text-[11px] text-slate-700 leading-relaxed" }, /* @__PURE__ */ React.createElement("a", { href: item.url, target: "_blank", rel: "noopener noreferrer", className: "font-bold text-indigo-700 hover:text-indigo-900 hover:underline rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600" }, item.name), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, " \u2014 ", item.scope), /* @__PURE__ */ React.createElement("span", { className: "block text-slate-500" }, /* @__PURE__ */ React.createElement("span", { className: "font-semibold" }, "Rights:"), " ", item.license))))))))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h5", { className: "font-bold text-[11px] uppercase tracking-wider text-slate-500 mb-2" }, t("about.oss_featured_header") || "Learning tools we integrate"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3" }, FEATURED_OSS.map((item) => /* @__PURE__ */ React.createElement(FeaturedCard, { key: item.name, item })))), /* @__PURE__ */ React.createElement("details", { className: "bg-slate-50 rounded-xl border border-slate-200 group" }, /* @__PURE__ */ React.createElement("summary", { className: "min-h-11 cursor-pointer select-none px-4 py-3 font-bold text-slate-700 text-sm flex items-center gap-2 hover:text-indigo-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-indigo-600" }, /* @__PURE__ */ React.createElement("span", { "aria-hidden": "true", className: "text-slate-400 group-open:rotate-90 transition-transform motion-reduce:transition-none" }, "\u25B8"), t("about.oss_full_list_header") || "Libraries and open resources we integrate", " (", OSS_TOTAL, ")"), /* @__PURE__ */ React.createElement("div", { className: "px-4 pb-4 pt-1 space-y-4" }, OSS_CREDITS.map((section) => /* @__PURE__ */ React.createElement("div", { key: section.group }, /* @__PURE__ */ React.createElement("h5", { className: "font-bold text-[11px] uppercase tracking-wider text-slate-500 mb-1.5" }, section.group), /* @__PURE__ */ React.createElement("ul", { className: "space-y-1.5 list-none" }, section.items.map((item) => /* @__PURE__ */ React.createElement("li", { key: item.name, className: "text-xs text-slate-700 leading-snug flex flex-col sm:flex-row sm:items-baseline sm:gap-2" }, /* @__PURE__ */ React.createElement(
    ...
    item.name
  ), /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, "\u2014 ", item.use, " ", /* @__PURE__ */ React.createElement("span", { className: "text-slate-600" }, "\xB7"), " ", /* @__PURE__ */ React.createElement("span", { className: "font-medium text-slate-500" }, item.license))))))))), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] text-slate-600 leading-relaxed pt-1 border-t border-slate-200" }, t("about.oss_credits_footer") || "Hosted AI features use the provider configured in AI settings (such as Gemini, OpenAI, Claude, or an OpenAI-compatible endpoint); those services are not bundled software. Software libraries above are credited with their copyright notices in THIRD_PARTY_LICENSES.md, and full verbatim license texts ship with the source in the licenses/ folder \u2014 bundled into the School Box desktop app too. Reading works retain title-level attribution, source, and rights notices in the catalog and reader. Spot something we should credit or correct? Let us know."));
}
const ATLAS_HUBS = [
  {
