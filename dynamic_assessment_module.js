    ...
    function generateCustomProbe(form) {
      ...
      Promise.resolve()
        ...
        .then(function (out) {
          ...
          // If self-critique is OFF, ship the draft as-is.
          if (!useSelfCritique) {
            setGeneratedItems(draftItems);
            setGenBusy(false);
            setGenStage(null);
            setStartScreenView("custom-review");
            announce("Generated " + draftItems.length + " items (self-critique disabled).");
            return null;
          }
          ...
          return Promise.resolve()
            ...
            .then(function (critiqueOut) {
              ...
              if (!critiques || critiques.length === 0) {
                ...
                setGenStage(null);
                setStartScreenView("custom-review");
                announce("Generated " + draftItems.length + " items. Self-critique pass returned no results — review carefully.");
                return null;
              }
              ...
              if (!needsRefinement) {
                ...
                setGenStage(null);
                setStartScreenView("custom-review");
                announce("Generated " + draftItems.length + " items. Self-critique pass found no issues.");
                return null;
              }
              ...
              return Promise.resolve()
                ...
                .then(function (refineOut) {
                  ...
                  if (!refinedArr || refinedArr.length === 0) {
                    ...
                    setGenStage(null);
                    setStartScreenView("custom-review");
                    announce("Generated " + draftItems.length + " items. Critique flagged issues but refinement pass failed — review carefully.");
                    return null;
                  }
                  ...
                  announce("Generated " + finalItems.length + " items. " + refinedCount + " refined based on self-critique.");
                  return null;
                });
            });
        })
