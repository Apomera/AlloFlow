              ...
              <div className={unsupportedRecall ? "border-b border-slate-200 bg-slate-50 px-4 py-2" : "border-b border-slate-200 bg-slate-50 p-4 sm:p-5"}>
                ...
                {isTeacherMode && isEditing && (
                  <div className="mt-3 grid gap-3 sm:grid-cols-2">
                    ...
                    <div role="group" className="flex flex-wrap items-end gap-2 sm:col-span-2" aria-label={tr('card_reorder_aria', 'Reorder {target}', { target: card.target || tr('memory_target_lower', 'memory target') })}>
