...
const AlloBot = React.memo(React.forwardRef(({
  ...
  useEffect(() => {
    try {
      ...
      var _apply = function () {
        var _r = disableAnimations || _mq && _mq.matches;
        try {
          if (_r) {
      ...
      if (_mq && _mq.addEventListener) {
        _mq.addEventListener("change", _apply);
        return function () {
          _mq.removeEventListener("change", _apply);
        };
      }
    } catch (e) {}
  }, [disableAnimations]);
  ...
  useEffect(() => {
    ...
    const start = () => {
      ...
      if (isSleeping || disableAnimations || mq && mq.matches) {
        setBlinkScale(1);
        return;
      }
      scheduleBlink();
...
`), /*#__PURE__*/React.createElement("div", {
  ...
  }), reactions.map(r => /*#__PURE__*/React.createElement(ReactionBubble, {
    key: r.id,
    emoji: r.emoji,
    onComplete: () => setReactions(prev => prev.filter(item => item.id !== r.id))
  })), bursts.map(b => /*#__PURE__*/React.createElement(BotConfettiBurst, {
    key: b.id,
    ...
    fill: "none",
    opacity: "0.6"
  }), (isFlying || localIsFlying) && /*#__PURE__*/React.createElement("g", {
  ...
  })), effectiveMood === 'thinking' && !isSleeping && /*#__PURE__*/React.createElement("g", {
    className: "animate-pulse",
    style: {
    ...
    strokeWidth: "4",
    strokeLinecap: "round"
  }), antennaAction === 'signal' && !isSleeping && effectiveMood !== 'thinking' && /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("circle", {
    cx: "50",
    cy: "5",
    r: "10",
    stroke: colors.antenna,
  ...
  }), activeView === 'faq' && !isSleeping && /*#__PURE__*/React.createElement("g", {
