...
for(const base of ['stem_lab','desktop/web-app/public/stem_lab'])edit(path.join(base,'stem_tool_geometryworld_builder.js'),'.theme-contrast .gwe-creation-summary[data-selected=\\\"true\\\"]{', '@media(max-width:420px){.gwe-creation-summary[data-selected=\\\"true\\\"]{padding:12px}}.theme-contrast .gwe-creation-summary[data-selected=\\\"true\\\"]{');
