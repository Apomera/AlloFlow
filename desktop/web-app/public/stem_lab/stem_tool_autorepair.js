...
(function() {
  ...
  var DAMAGE_CASES = [
    { id: 'd1', visual: '🛢️ Black, sticky residue dripping from above the oil filter, running down the side of the engine block. Low oil level on dipstick.',
      ...
      cause: { q: 'Most likely cause?', a: ['Gas-cap loose', 'Valve cover gasket failure (oil leaking down from above)', 'Head gasket seeping oil at the seam between head and block', 'Worn tires'], correct: 1 },
      sev: { q: 'How urgent?', a: ['Drive normally, since a small leak like this never gets worse on its own', 'Top off oil + plan repair within 30 days; check level weekly', 'Stop driving', 'No action needed'], correct: 1 } },
    { id: 'd2', visual: '🛞 Rotor with a sharp raised ridge around the outer edge (where the pad doesn\'t reach) — about 3/16" tall ridge. Friction surface looks heat-blued.',
      ...
      cause: { q: 'What does the ridge tell you?', a: ['New rotor', 'Rotor has worn down significantly + heat-cycled — replace, not resurface', 'Manufacturing defect in the rotor casting that new pads will grind smooth', 'Tire pressure issue'], correct: 1 },
      sev: { q: 'Action?', a: ['Resurface and reuse, since machining takes the blue heat marks off the face', 'Replace + new pads (heat-blued surface won\'t bed in pads correctly)', 'Drive 10K more miles', 'Add brake fluid'], correct: 1 } },
    { id: 'd3', visual: '🛞 Tire with the INSIDE edge worn down to the wear bars while the outside still has good tread. Tread looks feathered.',
      part: { q: 'What\'s this called?', a: ['Centerline wear from over-inflation', 'Inside-edge wear with feathering', 'Cupped wear', 'Plug failure'], correct: 1 },
      cause: { q: 'Most likely cause?', a: ['Over-inflation, which bulges the center and lifts the edges off the road', 'Toe alignment is OUT (pointing too far in or out) — alignment overdue', 'Bad shock', 'Brake fluid leak'], correct: 1 },
      sev: { q: 'Action?', a: ['Wait until the outside also wears down, then replace the pair', 'Replace tire + 4-wheel alignment within next month', 'Rotate to back', 'Add air'], correct: 1 } },
    { id: 'd4', visual: '🟢 Green crusty deposit forming on the radiator cap, with a slight wet trail down to the upper radiator hose connection.',
      part: { q: 'What system is this?', a: ['Brake (brake-fluid residue)', 'Cooling (coolant residue)', 'Fuel', 'Oil'], correct: 1 },
      cause: { q: 'What\'s happening?', a: ['Normal evaporation from the overflow tank on hot days, nothing leaking', 'Coolant slow-leaking + drying — radiator cap or hose-clamp issue', 'Air bubble', 'Brake fluid leak'], correct: 1 },
      sev: { q: 'Action?', a: ['Ignore', 'Pressure-test the cap; tighten or replace cap + clamp; top up coolant; monitor', 'Stop driving until a shop has replaced the radiator, since any coolant loss means the core is failing', 'Replace engine'], correct: 1 } },
    { id: 'd5', visual: '🔋 Battery terminals with a thick, fluffy white-and-blue powder caked around the post and clamp.',
      part: { q: 'What is this powder?', a: ['Snow', 'Lead-acid battery corrosion (sulfate + air reaction)', 'Anti-freeze that has dried to crystals on the terminal', 'Engine oil'], correct: 1 },
      cause: { q: 'What\'s causing it?', a: ['Cold weather only', 'Acid escape from a leaking or aging battery + air exposure', 'Overcharging by a failed voltage regulator boiling the electrolyte', 'No specific cause'], correct: 1 },
      sev: { q: 'Action?', a: ['Cosmetic, leave it alone: the powder is an inert sulfate crust that does not conduct, so it cannot affect starting or charging, and scrubbing it only exposes fresh metal to more corrosion', 'Disconnect (negative first), neutralize with baking soda + water, wire-brush, anti-corrosion spray. If recurring, the battery may be leaking — replace.', 'Pour water on it', 'Drive more often'], correct: 1 } },
    { id: 'd6', visual: '🌧️ Wiper blade leaving streaks across the windshield in a 4" gap on the driver-side. Other parts of the sweep are clean.',
      part: { q: 'What\'s wrong with the wiper?', a: ['Motor failure', 'A torn or worn section of the blade rubber', 'Wrong fluid', 'Cracked windshield glass catching the blade edge'], correct: 1 },
      cause: { q: 'Most likely cause?', a: ['Fluid contamination', 'Age + UV + ice cycles tore the rubber', 'Manufacturer defect in the rubber compound', 'Cold weather alone'], correct: 1 },
      sev: { q: 'Action?', a: ['Drive carefully', 'Replace blade ($15 + 5 min) — and do the other side too if you haven\'t recently', 'Replace the whole wiper arm assembly, since the blade and arm are sold as one unit and the linkage wears with the rubber', 'No action'], correct: 1 } },
    { id: 'd7', visual: '🟤 Engine oil dipstick reading is HIGH (above max) and the oil smells like gasoline.',
      part: { q: 'What\'s the issue?', a: ['Normal, the oil was recently changed', 'Fuel diluting the engine oil', 'Coolant in oil', 'Sludge'], correct: 1 },
      cause: { q: 'What causes fuel-diluted oil?', a: ['Cold weather', 'Failed fuel injector dribbling fuel into a cylinder + past the rings into the crankcase. Or excessive cold-start short-trips without full warm-up.', 'Loose oil cap', 'High mileage alone: after 150,000 miles the rings seal less tightly, so a little fuel always reaches the crankcase and the oil simply needs changing more often'], correct: 1 },
      sev: { q: 'Action?', a: ['Top up to max', 'Diagnose injectors + change oil immediately. Continued operation washes oil from cylinder walls + accelerates engine wear.', 'No action', 'Add a bottle of detergent additive at the next fill-up so the extra fuel burns cleaner, and change the oil at the normal interval'], correct: 1 } },
    { id: 'd8', visual: '🛑 Brake pad worn down to the steel backing plate. Shiny grooves cut into the rotor face.',
      part: { q: 'How worn?', a: ['New', 'Pads have been ground down to STEEL on STEEL — past wear-indicator stage', 'Half-worn', 'No way to tell without pulling the caliper and measuring the friction material with a gauge'], correct: 1 },
      cause: { q: 'How did it get this bad?', a: ['Just one drive', 'Driver ignored squealing wear-indicator for thousands of miles', 'Defective pads', 'Brake fluid issue: old fluid let the caliper drag and eat the pad in a few weeks'], correct: 1 },
      sev: { q: 'Action?', a: ['Resurface the rotors + new pads: a machine shop can take the grooves out for a fraction of the cost of new rotors, and the bleeders will free up with penetrating oil', 'Replace BOTH pads AND rotors (rotor is grooved past wear) + new pads. Maine: brake-line bleeders may be seized at this age.', 'Pads only', 'Drive carefully'], correct: 1 } },
    { id: 'd9', visual: '🔧 Frame rail with thick, flaking, layered rust scaling. Pieces flake off when poked. Visible holes.',
      part: { q: 'What\'s the structural concern?', a: ['Surface rust only, so a wire brush and paint touch-up will fix it', 'Frame perforation — structural integrity compromised', 'Cosmetic only', 'Wax helps'], correct: 1 },
      cause: { q: 'Maine cause?', a: ['Sun', 'Multi-year salt brine + moisture cycling — Maine-classic frame rot', 'Manufacturing: a bad batch of frame steel from the factory that year', 'Hit a curb'], correct: 1 },
      sev: { q: 'Maine state inspection?', a: ['Pass with a notation on the sticker; frame rust is cosmetic under Maine rules unless a suspension mount has let go, and the inspector only notes it for the next year', 'INSPECTION FAIL — vehicle may be uninspectable; some frame rot is unrepairable + vehicle becomes a total loss', 'Pass', 'Re-inspect'], correct: 1 } },
    { id: 'd10', visual: '⚙️ Serpentine belt with deep cracks across each rib, every 1-2 inches. Rib edges look frayed.',
      part: { q: 'What is this?', a: ['Timing belt', 'Serpentine (accessory) belt', 'V-belt', 'A/C compressor drive belt (dedicated)'], correct: 1 },
      cause: { q: 'How aged is this belt?', a: ['New', 'End of service life — cracks + frayed edges = imminent failure', 'Mid-life', 'Newly installed wrong, so it is rubbing on a pulley flange and fraying'], correct: 1 },
      sev: { q: 'Action?', a: ['Drive another 50,000 miles: cracks across the ribs are normal on a belt that has taken a set, and modern EPDM belts run to 100,000 miles before they need attention, so there is nothing to do until it squeals', 'Replace belt + tensioner pulley while you\'re in there ($30-60 part + 30-60 min). A snapped serpentine belt strands you (no power steering, no charging, no water pump).', 'Realign it', 'No action'], correct: 1 } },
    { id: 'd11', visual: '💨 Black soot ring around the tip of the exhaust tailpipe — when wiped, leaves a heavy black smudge on the rag.',
      part: { q: 'What is the soot?', a: ['Normal exhaust', 'Excessive carbon = engine running RICH (too much fuel, not enough air)', 'Coolant burning', 'Oil burning past worn rings (would be blue-tinted, oily, and smell sweet)'], correct: 1 },
      cause: { q: 'Likely causes?', a: ['Cold weather only: the engine runs rich for the first few minutes of every cold start, and the soot is the normal residue of that warm-up cycle', 'Failing O2 sensor, dirty MAF, leaky fuel injector, or fuel-pressure regulator stuck high', 'New filter', 'No specific cause'], correct: 1 },
      sev: { q: 'Action?', a: ['Drive it hard on the highway for an hour so the heat burns the carbon off the tailpipe and the mixture corrects itself', 'OBD scan first (often a P0172 rich code). Then clean MAF / replace O2 / fuel-pressure check.', 'Add fuel additive', 'Stop driving'], correct: 1 } },
    { id: 'd12', visual: '🦶 Brake pedal goes nearly to the floor before the car stops. No squealing, no grinding, no pulling.',
      part: { q: 'What system has the issue?', a: ['Brake pads (mechanical), worn past the backing plate', 'Brake hydraulics (master cylinder, lines, or air)', 'Tires', 'Suspension'], correct: 1 },
      cause: { q: 'Most likely?', a: ['Pads completely worn, so the pedal travels much farther before the bare metal backing plate meets the rotor', 'Air in brake lines (after a recent service?), fluid leak, OR master cylinder bypassing internally', 'Tire pressure', 'Engine issue'], correct: 1 },
      sev: { q: 'Action?', a: ['Drive carefully', 'STOP DRIVING. A failing brake system is a not-driveable safety issue. Check fluid level + look for leaks, then bleed system or replace master cylinder.', 'Add brake fluid + drive: a low reservoir explains the long pedal, and topping it up restores full braking; check it again in a week and top it up as needed, since older cars use a little fluid as the pads wear down', 'No action needed'], correct: 1 } },
    { id: 'd13', visual: '🌀 Front tire with a sidewall bulge the size of a marble, on the inside sidewall.',
      part: { q: 'What does the bulge represent?', a: ['Air pocket trapped between the liner and tread during mounting', 'Internal cord damage — tire structurally compromised', 'Manufacturer feature', 'Patched plug'], correct: 1 },
      cause: { q: 'Most likely cause?', a: ['Old age', 'Curb hit, pothole hit, or run-flat damage that broke internal cords', 'Over-inflation stretching the sidewall outward at the weakest point of the casing', 'No specific cause'], correct: 1 },
      sev: { q: 'Action?', a: ['Drive normally', 'REPLACE THE TIRE. A bulged sidewall can blow at any moment — at speed it can cause loss of control.', 'Patch it', 'Lower the pressure by 10 psi so the bulge relaxes, then drive gently and keep the tire as a spare once it is worn'], correct: 1 } },
    { id: 'd14', visual: '🛢️ Oil dipstick with a brown FOAM coating. Oil-cap underside has the same foamy residue.',
      part: { q: 'What is this foam?', a: ['Normal', 'Coolant + oil emulsion = "milkshake" oil', 'Old oil', 'Air bubbles whipped into the oil by a low level'], correct: 1 },
      cause: { q: 'What causes coolant in oil?', a: ['Loose oil cap', 'Failed head gasket OR cracked block OR cracked head', 'Wrong oil type', 'Cold weather only: condensation collects in the crankcase over a winter of short trips'], correct: 1 },
      sev: { q: 'Action?', a: ['Top up the oil, drive carefully for a week, and see whether the foam clears as the engine reaches full temperature; condensation usually burns off on the first long highway run', 'STOP DRIVING. Continued operation destroys bearings + crankshaft. Tow to shop. Often $1500-3500 head-gasket job; sometimes total loss.', 'Add stop-leak', 'No action'], correct: 1 } },
    { id: 'd15', visual: '⚡ Spark plug pulled from cyl 3 — electrode is glazed, slightly melted at the tip, with a thin tan deposit.',
      part: { q: 'What\'s the plug telling you?', a: ['Healthy plug', 'Plug ran HOTTER than design — wrong heat range, ignition timing too advanced, or pre-ignition', 'Normal wear', 'Worn from age only: the white insulator and rounded electrode are what a plug looks like after 60,000 miles'], correct: 1 },
      cause: { q: 'Likely root cause?', a: ['Bad fuel only', 'Lean fuel mixture (not enough fuel) OR knock-controller failure OR vacuum leak on this cylinder', 'Defective plug from the factory, with an insulator that cracked and let heat build up inside the shell', 'Cold weather'], correct: 1 },
  ...
  var QUIZ = [
    { id: 'q1', icon: '🛡️',
      ...
      choices: ['Slide right under', 'Set jack stands at the frame and lower jack onto them', 'Wedge the jack with a 2x4 under the saddle in case the seal fails', 'Have a friend hold the jack handle'],
    ...
    { id: 'q2', icon: '🔌',
      ...
      choices: ['Replace the catalytic converter immediately, before the code sets again', 'Drive normally — solid (not flashing) is non-emergency', 'Replace all 8 spark plugs', 'Disconnect the battery to clear it'],
    ...
    { id: 'q4', icon: '🛢️',
      ...
      choices: ['Time for an oil change', 'Coolant is mixing with oil — possible head-gasket failure. STOP DRIVING.', 'Wrong oil type was used', 'Air bubbles from a recent change that have not settled out of the oil yet'],
    ...
    { id: 'q5', icon: '❄️',
      ...
      choices: ['Engine RPM', 'The under-hood label for refrigerant type (R-134a vs R-1234yf)', 'Tire pressure, because the compressor load changes with rolling resistance', 'Tax records'],
    ...
    { id: 'q6', icon: '🛞',
      ...
      choices: ['Nothing — you\'re done', 'Re-torque the lug nuts', 'Replace them again', 'Check the air filter and cabin filter'],
    ...
    { id: 'q10', icon: '🌲',
      ...
      choices: ['Yes — weld a patch', 'No — frame work is structural and a Maine inspection station has to certify it. Plan to repair professionally or replace the vehicle.', 'Spray rust converter on it', 'Drive it to NH where the rules are different: New Hampshire has no frame-rust standard, so register it there with a relative\'s address and skip the Maine inspection for as long as the frame holds'],
    ...
    { id: 'q11', icon: '🧤',
      ...
      choices: ['Decorative, a manufacturer color choice that marks the hybrid system so technicians can identify the model at a glance, with no special handling needed beyond the usual 12-volt precautions', 'These are 200–800 volt high-voltage lines — DO NOT touch without HV-rated insulated gloves and the proper service-disconnect procedure', 'They\'re for the radio', 'They\'re fuel lines'],
    ...
    { id: 'q12', icon: '🛒',
      ...
      choices: ['Drive it — warm engine drives best', 'Insist on starting it COLD; warm engines hide cold-start knocks, misfires, and smoke', 'Skip the inspection because they prepped the car, which shows they take good care of it', 'Trust the seller'],
    ...
    { id: 'q13', icon: '🚩',
      ...
      choices: ['Magnet is broken', 'Lower rocker has filler / fiberglass over rust — body work was done', 'The car was painted recently, and fresh paint is thick enough to block a magnet', 'Normal'],
    ...
    { id: 'q14', icon: '〰️',
      ...
      choices: ['Drive normally, since flashing is just a stronger warning to book service soon; the car protects itself by limiting power, so there is no harm in finishing the trip and having it read next week', 'STOP DRIVING — flashing CEL means severe misfire that can destroy the catalytic converter ($800–2500 to replace)', 'Disconnect the battery to clear it', 'Add fuel additive'],
    ...
    { id: 'q15', icon: '🌧️',
      ...
      choices: ['Wash the car well, inside and out, and vacuum it: inspectors are human, and a clean car that looks cared for gets a lighter look at the underbody, the lights, and the belts', 'Walk around at night, have someone press the brake, cycle every signal/headlight; honk horn; try every seatbelt — bulb / fuse / seatbelt fails are 5-minute fixes', 'Park in a dry garage', 'Add expensive premium fuel'],
    ...
    { id: 'q16', icon: '💵',
      ...
      choices: ['Authorize it as preventive maintenance: a 130,000-mile engine has sludge that ordinary oil changes never reach, and a flush now saves a much larger cleaning bill later on', 'Decline — engine flushes on older engines can DISLODGE built-up sludge and clog oil passages; most OEM service manuals do not recommend it', 'Negotiate to $30', 'Ask for two flushes'],
    ...
    { id: 'q17', icon: '⚡',
      ...
      choices: ['Pads get too cold', 'Pads + rotors that don\'t get used can corrode (rust onto rotor face); need annual brake-system cleaning + occasional friction-braking', 'Brakes overheat', 'Charging gets slower, because the regenerative system has to share the battery with the friction brakes and the pads wear faster in the salt as a result'],
    ...
    { id: 'q18', icon: '🔍',
      ...
      choices: ['Stereo turning on, which proves the ignition switch is working', 'Fuel pump priming whir from the back of the car (~2 seconds)', 'Wipers parking', 'Door chime'],
    ...
    { id: 'q19', icon: '🛑',
      ...
      choices: ['Worn pads', 'Warped rotors (or rust deposits creating uneven thickness — common in Maine after winter)', 'Soft pedal / air in the lines, which lets the caliper pistons grab and release unevenly as you stop', 'ABS sensor fault'],
    ...
    { id: 'q20', icon: '🛞',
      ...
      choices: ['Left', 'Right (load shifts off it when turning right)', 'Both', 'Front-rear can\'t tell from a hum; only a lift and a wheel wiggle will'],
    ...
    { id: 'q21', icon: '❄️',
      ...
      choices: ['Leave it — it\'ll dilute', 'Spray it out + refill with -30°F (or colder) winter washer fluid; standard fluid freezes and can crack the reservoir', 'Add salt to lower the freeze point', 'Drain it and leave the reservoir empty for the winter, then refill in April; an empty tank cannot freeze and the wipers alone handle road salt film'],
    ...
    { id: 'q22', icon: '🌳',
      ...
      choices: ['Replace the starter', 'Key ON (don\'t crank) and listen for the fuel pump priming whir', 'Replace plugs and coils, since no fire almost always means no spark', 'Tow to dealer'],
    ...
    { id: 'q23', icon: '💵',
      ...
      choices: ['Yes — always pay', 'No — shop supplies fees are typically 5–10% of labor; $150 on $500 labor (30%) is excessive', 'Try to negotiate to $200', 'Switch shops immediately and refuse to pay any supplies fee at all, since Maine law bars unlisted charges'],
    ...
    { id: 'q24', icon: '🚗',
      ...
      choices: ['Repaint it', 'Title transfer at the BMV; switch insurance to your name', 'Replace the engine air filter and cabin filter as a baseline service', 'Buy a tow truck'],
    ...
    { id: 'q25', icon: '🧰',
      ...
      choices: ['Buy a $30K Snap-on tool box on credit before you start, because shops hire the technician who arrives with a full box, and the payments teach the discipline the trade demands', 'Apply to the half-day CTE auto-tech program at Region 9, PATHS, Mid-Coast, or your local school. Earn ASE Student Certifications by graduation.', 'Open your own shop without experience', 'Skip school'],
    ...
    { id: 'q28', icon: '📅',
      ...
      choices: ['Every 10 years', 'Every 2-3 years (Maine humidity accelerates moisture absorption)', 'Never', 'Every oil change, because the fluid absorbs moisture within weeks in Maine humidity'],
    ...
    { id: 'q29', icon: '🌐',
      ...
      choices: ['CarFax, paid: the report lists open recalls, and the dealer charges for the repair unless the car is still under warranty', 'NHTSA recalls (nhtsa.gov/recalls) — free; recall repair is also FREE at any dealer', 'Local mechanic — paid', 'Vehicle manual — paid'],
    ...
    { id: 'q30', icon: '🔧',
      ...
      choices: ['Replace the starter immediately', 'Multimeter on battery posts (engine off) — costs nothing, splits the diagnosis instantly', 'Tow to dealer', 'Jump start it without testing first, since rapid clicking with bright lights means the battery is fine and only the starter needs a boost'],
    ...
    { id: 'q31', icon: '🚛',
      ...
      choices: ['Accept — they\'re here', 'Politely decline; call YOUR roadside service (AAA, insurance, or known tow company); choose your own shop. Maine law gives you the right.', 'Pay them in cash on the spot to avoid the bill going through insurance, then let them tow the car wherever they suggest so you are off the highway quickly', 'Get out and run'],
    ...
    { id: 'q32', icon: '❄️',
      ...
      choices: ['Can you do it cheaper?', '"Did you find the leak? A/C is a sealed system — if it\'s low, there\'s a leak."', 'Will it last forever?', 'Is the refrigerant green, and can you add the dye that shows the level on the gauge?'],
    ...
    { id: 'q36', icon: '🏁',
      ...
      choices: ['Pushing, the front won\'t turn in, so the car leans toward the wall', 'Oversteer entering the corner — rear is sliding when turning in', 'Tires picking up debris', 'Engine misfire'],
    ...
    { id: 'q37', icon: '🛞',
      ...
      choices: ['Engine rebuild + body repair', 'Tire change (RF + RR) + fuel transfer all at once on the right side, with one jackman', 'Driver swap + tire change', 'Nothing, only one task at a time: NASCAR rules allow a single crew member over the wall on each side, so fuel and tires are done in sequence'],
    ...
    { id: 'q38', icon: '⚖️',
      ...
      choices: ['The driver\'s seat angle', 'Diagonal weight distribution (RF+LR vs LF+RR), adjusted by changing spring height with a wedge wrench', 'A type of tire compound, softer on the right side, that wedges the car into the banking through the corners', 'Engine timing'],
    ...
    { id: 'q39', icon: '🌲',
      ...
      choices: ['Move to North Carolina immediately', 'Volunteer at a Maine short track (Oxford Plains, Beech Ridge, Wiscasset, Speedway 95) — show up at the pit gate, ask a team if they need help, bring basic tools', 'Buy your own race car', 'Apply directly to NASCAR Cup teams in Charlotte: the big shops hire entry-level mechanics straight out of high school every season, and a Maine address stands out on the application because they want candidates from outside the region'],
    ...
    { id: 'q40', icon: '🪂',
      ...
      choices: ['It looks cooler', 'Short tracks need DOWNFORCE (rear grip in turns); superspeedways need TOP SPEED (less drag) — more spoiler = more downforce + more drag', 'Spoilers are mandatory at short tracks under the rulebook, at a fixed angle for every car, while superspeedway cars run whatever angle the team chooses', 'Driver preference'],
    ...
    { id: 'q41', icon: '🔍',
      ...
      choices: ['Burnt-out headlight bulb, which means the wiring harness is failing', 'Perforated frame rails (holes you can put a screwdriver through)', 'Old wiper blades', 'Faded paint'],
    ...
    { id: 'q42', icon: '📋',
      ...
      choices: ['Cosmetic first', 'Whatever\'s easiest', 'SAFETY → LEGAL → RELIABILITY → COMFORT → COSMETIC', 'Engine rebuild first, then the body, then the brakes and tires'],
    ...
    { id: 'q43', icon: '⛽',
      ...
      choices: ['Decoration', 'Diesels use compression ignition (no spark needed). Glow plugs pre-warm the cylinder for cold start so compression-heated air can ignite the fuel.', 'They\'re cheaper than spark plugs and last the life of the engine, because a diesel fires them only once at start-up rather than thousands of times a minute; the compression does the rest of the work', 'Government mandate'],
    ...
    { id: 'q44', icon: '💧',
      ...
      choices: ['Engine seized', 'DEF tank ran dry — modern diesels derate (limp-mode) or refuse to start when DEF is empty. Refill DEF + clear codes.', 'Transmission failure: the DEF warning is a coincidence, and a truck that will not go above 5 mph has lost its forward gears and needs a rebuild', 'Tires flat'],
    ...
    { id: 'q45', icon: '🛷',
      ...
      choices: ['Better fuel economy', 'Engine seizes within 30 seconds — 2-stroke engines rely on oil-in-fuel to lubricate piston rings + bearings. No oil = catastrophic engine damage.', 'Improved performance, because straight gasoline burns hotter and cleaner than the oil mix; the saw runs faster and the exhaust stops smoking, which is why racing saws are run lean', 'Quieter operation'],
    ...
    { id: 'q46', icon: '🌲',
      ...
      choices: ['Move south', 'Combine summer (lawn equipment, marine outboard, landscaping) with winter (snowmobile, ATV, plow truck service). Year-round flow.', 'Only work summers, when the tourist traffic keeps every shop full, and collect unemployment through the winter as most seasonal trades in Maine do', 'Only work winters'],
    ...
    { id: 'q47', icon: '🏆',
      ...
      choices: ['Twitter', 'The Badge Gallery on the menu — shows everything earned + everything still locked, grouped by module', 'Print them out from the certificate page, since the tool does not keep badges after the browser closes', 'They\'re hidden'],
    ...
    { id: 'q48', icon: '🛡️',
      ...
      choices: ['Yes — same as a regular car', 'NO — never connect 12V to high-voltage components. The 12V auxiliary is what you jump (just like any car); the HV drive battery is sealed + serviced only with HV-rated equipment + procedures.', 'Only with adapter', 'Hybrids can\'t be jumped at all: the 12-volt system is charged from the high-voltage pack through a converter, so a dead 12-volt battery means the pack is flat too, and only a dealer with HV equipment can bring the car back'],
    ...
    { id: 'q49', icon: '📚',
      ...
      choices: ['Google guess', 'This tool\'s Glossary — 50+ essential auto terms with category filter + search', 'An AI chatbot, which explains any term in plain language and rarely gets repair vocabulary wrong', 'Skip it'],
    ...
    { id: 'q50', icon: '🌲',
      ...
      choices: ['Buy every tool at once', 'Pick ONE module, pick ONE task, do it on a real car this weekend (your own or a friend\'s with permission). Hands-on beats theory by a wide margin.', 'Memorize all 50 quiz questions and their explanations first, so that when you finally open the hood you already know every answer and cannot make a mistake that costs money', 'Watch YouTube videos forever'],
    ...
    { id: 'q51', icon: '📏',
      ...
      choices: ['Tread depth', 'Aspect ratio — sidewall height as a percentage of tire width (so sidewall = 65% of 215mm ≈ 140mm)', 'Speed rating: the sidewall number shows the tire is certified for sustained speeds up to 65 mph on this size', 'Load index'],
    ...
    { id: 'q52', icon: '❄️',
      ...
      choices: ['All-seasons year-round', 'Dedicated winter (3-peak mountain-snowflake symbol) tires Oct-April + all-seasons or summer tires May-Sept. Pre-mount on dedicated wheels for fast swap.', 'Summer tires year-round', 'Studded tires year-round: the studs bite ice in winter and do no harm on dry pavement in summer, so leaving them on saves the cost and hassle of a second set of wheels and two swaps a year'],
    ...
    { id: 'q56', icon: '♿',
      ...
      choices: ['1:1', '3:1 (Success Criterion 1.4.11 Non-text Contrast)', '4.5:1 (Success Criterion 1.4.3 Contrast (Minimum))', '7:1'],
    ...
    { id: 'q57', icon: '⌨️',
      ...
      choices: ['Decoration', 'WCAG 2.4.1 Bypass Blocks — keyboard users can skip past the welcome banner straight to the navigable content. Hidden until focused via Tab key.', 'Marketing: a skip link at the top of the menu is the first thing search engines index, so it carries the module keywords for discoverability rather than serving any accessibility purpose', 'No reason'],
    ...
    { id: 'q58', icon: '🔇',
      ...
      choices: ['Be left as-is for screen readers, because every modern screen reader announces emoji by their Unicode names and users expect to hear the icon before the label, exactly as sighted users see it first', 'Be wrapped in a span with aria-hidden="true" so screen readers don\'t read "magnifying glass" before the word "Search" — the visible text already conveys the meaning', 'Be removed', 'Be in red'],
    ...
    { id: 'q59', icon: '🔋',
      ...
      choices: ['The battery went flat on its own: a cell shorted internally while driving, which is why the lights dimmed gradually instead of cutting out at once', 'The charging system — usually the alternator — so the car has been running off the battery and flattening it', 'A headlight bulb', 'The starter motor'],
    ...
    { id: 'q61', icon: '⭐',
      ...
      choices: ['It is faster', 'Crossing over pulls the wheel squarely onto the hub so it clamps evenly', 'It stops the threads seizing', 'It is a convention with no real effect, inherited from wooden-spoke wheel days'],
    ...
    { id: 'q62', icon: '🧰',
      ...
      choices: ['It saves time', 'So you find out now if the spare is flat, the wrench is missing, or the lock-nut key is not in the car', 'It keeps the boot tidy and gives you somewhere to put the flat wheel once it comes off, so nothing has to sit on the road while you work', 'It warms up the jack'],
    ...
    { id: 'q66', icon: '🛞',
      ...
      choices: ['Drive normally; it is a wheel like any other', 'Observe its speed and distance limits — usually around 50 mph and a short trip — and drive to a tyre shop', 'It is fine for a few thousand miles at normal speed; the narrow tread is a cost saving rather than a limitation, so replace the flat tyre when convenient', 'Move it to the front for better grip'],
    ...
    { id: 'q67', icon: '🌡️',
      ...
      choices: ['Open the radiator cap slowly using a rag', 'Read the level at the translucent overflow tank, and open nothing until the engine is cold', 'Crack the cap quickly with a thick rag to release the pressure in one burst, then check the level', 'Pour cold water straight in'],
    ...
    { id: 'q68', icon: '🌬️',
      ...
      choices: ['The thermostat', 'The radiator core, which clogs with road debris over the years', 'Low-speed airflow — the cooling fan, its fuse or its relay', 'The water pump'],
        ...
        case 'engineHunt': return (function() {
          ...
          return H('div', { style: { padding: 20, maxWidth: 900, margin: '0 auto' } },
            ...
            H('div', { style: { padding: 16, background: '#fff', border: '1px solid #cbd5e1', borderRadius: 10 } },
              ...
              H('textarea', { value: iq.hypothesis || '', onChange: function(e) { setIQ({ hypothesis: e.target.value }); }, 'aria-label': __alloT('stem.autorepair.hypothesis_input', 'Engine timing hypothesis'), placeholder: __alloT('stem.autorepair.hypothesis_what_combination_triggers_k', 'Hypothesis: What combination triggers knock?'),
              ...
              iq.understood && H('textarea', { value: iq.explanation || '', onChange: function(e) { setIQ({ explanation: e.target.value }); }, 'aria-label': __alloT('stem.autorepair.explanation_input', 'Engine timing explanation'), placeholder: __alloT('stem.autorepair.explain_why_timing_must_match_compress', 'Explain why timing must match compression and fuel.'),
