...
const outputCode = [
  ...
  'window.AlloModules.ClassroomImagePicker = ClassroomImagePicker;',
  ...
  '  MULBERRY_CREDIT: MULBERRY_CREDIT,',
  '  isClassroomLicense: isClassroomLicense,',
  '  normalizeCommonsPage: normalizeCommonsPage,',
  '  commonsMetadataBlocked: commonsMetadataBlocked,',
  '  openImageCreditLine: openImageCreditLine,',
  '  searchOpenImages: searchOpenImages,',
  '  buildScreenPrompt: buildScreenPrompt,',
  '  parseScreenReply: parseScreenReply,',
  '  screenOpenImages: screenOpenImages,',
  '  findClassroomImages: findClassroomImages,',
  '  fetchClassroomImage: fetchClassroomImage,',
  '  bakeCreditIntoImage: bakeCreditIntoImage,',
  '  bakeCreditBand: bakeCreditBand,',
  '  cropImageBottom: cropImageBottom,',
  '  creditBandLines: creditBandLines,',
  '  shrinkImageDataUrl: shrinkImageDataUrl,',
  '  mulberryLanguageCode: mulberryLanguageCode,',
  '  searchMulberrySymbols: searchMulberrySymbols,',
  '  ClassroomImagePicker: ClassroomImagePicker,',
  '};',
