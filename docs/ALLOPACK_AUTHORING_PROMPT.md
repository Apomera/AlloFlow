...
3. **glossary**: `data = [ { "term", "def", "tier": "Academic"|"Domain-Specific", "translations": { "Spanish": "Término: Definición" } } ]`. 8-12 terms; single-word terms play best in the word games; defs student-friendly, one sentence.
