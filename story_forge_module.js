...
<\/script></body></html>`;
  ...
  }, disabled: !imageEditState.prompt.trim(), className: "flex-1 text-[9px] font-bold bg-teal-600 text-white rounded py-1 hover:bg-teal-700 disabled:opacity-40" }, "Apply"), /* @__PURE__ */ React.createElement("button", { "aria-label": "Cancel illustration edit",  onClick: () => setImageEditState(null), className: "text-[9px] font-bold bg-slate-200 text-slate-600 rounded py-1 px-2 hover:bg-slate-300" }, "Cancel")))) : /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-1" }, /* @__PURE__ */ React.createElement(
    "button",
