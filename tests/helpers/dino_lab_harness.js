...
export function setupDinoLab() {
  ...
  src = src.replace(
    ...
    "globalThis.__dinoInternals = { DINOS: DINOS, PERIODS: PERIODS, CLADES: CLADES, EXTINCTIONS: EXTINCTIONS, KPG_EVIDENCE: KPG_EVIDENCE, ANATOMY: ANATOMY, MYTHS: MYTHS, QUIZ: QUIZ, GLOSSARY: GLOSSARY, SITES: SITES, RECORDS: RECORDS, PEOPLE: PEOPLE, byId: byId, periodName: periodName, fmtLength: fmtLength, fmtWeight: fmtWeight, fmtMya: fmtMya, catalogList: catalogList, specimenMap: specimenMap, notebookMap: notebookMap, notebookText: notebookText, dinoSurfaceGeometry: dinoSurfaceGeometry, dinoLoftRadius: dinoLoftRadius, dinoCranialGeometry: dinoCranialGeometry, dinoNeckJunction: dinoNeckJunction, dinoJawProfile: dinoJawProfile, dinoFrameDistance: dinoFrameDistance, dinoMeasurementTicks: dinoMeasurementTicks, dinoStudioLightProfile: dinoStudioLightProfile, dinoMotionStep: dinoMotionStep, dinoBodyPartDefinitions: dinoBodyPartDefinitions, dinoAnatomyQuizDeck: dinoAnatomyQuizDeck, dinoAnatomyQuizAnswer: dinoAnatomyQuizAnswer, dinoAnatomyQuizAdvance: dinoAnatomyQuizAdvance, dinoBodyLabelLayout: dinoBodyLabelLayout, dinoStudyBounds: dinoStudyBounds, dinoShadowOrbitBounds: dinoShadowOrbitBounds, dinoFitShadow: dinoFitShadow, dinoKeratinGeometry: dinoKeratinGeometry, dinoFilamentGeometry: dinoFilamentGeometry, dinoFeatherGeometry: dinoFeatherGeometry, dinoCoatGeometry: dinoCoatGeometry, dinoCoatShading: dinoCoatShading, dinoEyeGeometry: dinoEyeGeometry, dinoIrisShading: dinoIrisShading, coveringEvidenceFor: coveringEvidenceFor, handWingProfileFor: handWingProfileFor, dinoPlateGeometry: dinoPlateGeometry, dinoMembraneGeometry: dinoMembraneGeometry, dinoSkinMapping: dinoSkinMapping, dinoSkinTextureData: dinoSkinTextureData, integumentProfileFor: integumentProfileFor, dinoSkinCoordinates: dinoSkinCoordinates, dinoSurfaceAnchor: dinoSurfaceAnchor, dinoFacialStripGeometry: dinoFacialStripGeometry, dinoFeatherFrame: dinoFeatherFrame, skeletalAnatomyProfileFor: skeletalAnatomyProfileFor, reconstructionHypothesesFor: reconstructionHypothesesFor };\n  window.StemLab.registerTool('dinoLab'"
  );
