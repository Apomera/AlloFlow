  ...
  window.StemLab.registerTool('graphCalc', {
    ...
    render: function(ctx) {
      ...
      return (function() {
        ...
        React.useEffect(function() { checkBadges(); }, [
          d._graphsDrawn, d._multiGraphCount, d._analyzed,
          d._foundZero, d._foundIntersection, d._usedTrig,
          d._usedTable, d._challengesCompleted, d._usedSliders,
          d._usedDeriv, d.aiQuestions
        ]);
        ...
        }, [JSON.stringify(funcs), JSON.stringify(win), d.showDeriv, d.derivX, d.traceMode, d.traceX, d.showAnalysis, d.sliderA, d.sliderB, d.sliderC]);
