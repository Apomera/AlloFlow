...
(function () {
  ...
  var IMAGES = [
    ...
    { id: 'farside', emoji: '🌑', name: 'The far side of the Moon (LRO mosaic)', type: 'image', cors: false, width: 1600, height: 1600,
      scale: { px: 1568, metres: 3.4748e6, ref: 'the Moon', approx: false, basis: 'The Moon is 3,474.8 km across. This is an orthographic map, so the edge of the disc is the Moon’s limb; the disc measures about 1,568 pixels across in this file.', challenge: { ask: 'How wide is the Moon, edge to edge?', unit: 'km', answerMetres: 3.4748e6, tol: 0.12, hint: 'Measure straight across the disc through its middle, from one edge of the grey surface to the other.' } },
      src: 'https://images-assets.nasa.gov/image/GSFC_20171208_Archive_e001939/GSFC_20171208_Archive_e001939~orig.jpg',
      thumb: 'https://images-assets.nasa.gov/image/GSFC_20171208_Archive_e001939/GSFC_20171208_Archive_e001939~thumb.jpg',
      source: 'NASA', credit: 'NASA / Goddard / Arizona State University, Lunar Reconnaissance Orbiter Camera (public domain)', link: 'https://images.nasa.gov/details/GSFC_20171208_Archive_e001939',
      meta: 'The side of the Moon that never faces Earth, assembled from more than 15,000 Lunar Reconnaissance Orbiter Camera images taken between 2009 and 2011',
      describe: 'A black-and-white image of the whole Moon as a grey disc filling the frame against black. The surface is crowded edge to edge with overlapping craters of every size, from bowls with bright rims down to specks, with brighter rough highlands between them. Unlike the familiar side of the Moon there are almost no large dark plains: one dark oval patch sits toward the upper left, and a small dark-floored crater with a bright central peak sits near the lower left. Toward the very top and bottom the craters stretch and the picture looks streaky, because the map was stitched from strips.',
      notice: 'Zoom into the middle and count how many craters sit inside one bigger crater. Then find the dark oval patch toward the upper left and describe how its surface differs from the rough ground around it.',
      wonder: 'The side of the Moon we see from Earth has big dark plains across it; this side has almost none. What might have made the two sides so different?' },
