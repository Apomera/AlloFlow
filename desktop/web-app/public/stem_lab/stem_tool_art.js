                      ...
                      callGeminiVision && React.createElement("div", { className: "mb-2" },
                        ...
                        React.createElement("div", { className: "flex gap-2 mt-1" },
                          ...
                          React.createElement("button", {
                            ...
                            className: "px-3 py-1.5 rounded-lg text-[10px] font-bold bg-gradient-to-r from-violet-600 to-purple-600 text-white hover:from-violet-600 hover:to-purple-600 disabled:opacity-50 shadow-sm transition-all"
                  ...
                  (d.stereoAnimSource) === 'flipbook' && React.createElement("div", { className: "mb-3 space-y-2" },
                    ...
                    callImagen ? React.createElement("div", { className: "space-y-2" },
                      ...
                      React.createElement("button", {
                        ...
                        className: "w-full px-3 py-2 rounded-lg text-xs font-bold bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:from-indigo-600 hover:to-purple-600 disabled:opacity-50 shadow-sm transition-all"
