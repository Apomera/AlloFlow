...
describe('EPPP claim-level adjudication batch 07', () => {
  ...
  it('keeps deployment artifacts identical to source artifacts', () => {
    expect(read('desktop/web-app/public/test_prep/eppp_legacy/adjudication_batch_07.json')).toEqual(read('test_prep/eppp_legacy/adjudication_batch_07.json'));
    expect(fs.readFileSync(resolve(root, 'desktop/web-app/public/test_prep/eppp_legacy/adjudication_batch_07.md'), 'utf8')).toBe(fs.readFileSync(resolve(root, 'test_prep/eppp_legacy/adjudication_batch_07.md'), 'utf8'));
  });
});
