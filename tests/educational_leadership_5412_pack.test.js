...
describe('Praxis Educational Leadership 5412 diagnostic bank', () => {
  it('registers two ready 100-item diagnostics with the exact current ETS category proportions', () => {
  ...
  it('publishes zero-finding QA and exact deployment mirrors', () => {
    ...
    expect(qa.diagnosticBatch).toMatchObject({ batchCount: 2, batchSize: 100, categories: { 'strategic-leadership': 17, 'instructional-leadership': 23, 'climate-cultural-leadership': 18, 'ethical-leadership': 16, 'organizational-leadership': 13, 'community-engagement-leadership': 13 } });
