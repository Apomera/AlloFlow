...
4. Ask each teacher to complete [Start here](01-start-here.md) and save one reviewed project or export.
...
1. Reopen the first resource through [Accessibility and UDL](04-accessibility-and-udl.md).
...
Use [Review evidence and plan next steps](05-review-and-next-steps.md) to keep the conversation about instruction. Do not use a dashboard card, participation count, or generated quality signal as a stand-alone evaluation of a student, teacher, or program.
