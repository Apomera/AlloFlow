...
dataRef.current = d;
          ...
          var LEVELS = [

            {
              ...
              id: 1, title: t('stem.behaviorlab.first_food', 'First Food'), concept: 'Positive Reinforcement', target: 'pressLever', goal: 10,

              intro: t('stem.behaviorlab.in_positive_reinforcement_a_consequenc', 'In positive reinforcement, a consequence is ADDED after a behavior to INCREASE the likelihood of that behavior occurring again. Your job: click "Deliver Food" immediately after the mouse presses the lever. Reinforce 10 lever presses!'),
...

            {
              ...
              id: 3, title: t('stem.behaviorlab.the_burst', 'The Burst'), concept: 'Extinction', target: 'pressLever', goal: 0,

              intro: t('stem.behaviorlab.when_reinforcement_is_suddenly_withhel', 'When reinforcement is suddenly withheld, the organism often shows an extinction burst — a temporary INCREASE in the behavior before it decreases. First, reinforce 5 lever presses, then STOP reinforcing and watch what happens!'),
...

            {
              ...
              id: 4, title: t('stem.behaviorlab.on_schedule', 'On Schedule'), concept: 'Schedules of Reinforcement', target: 'pressLever', goal: 20,

              intro: t('stem.behaviorlab.not_every_response_needs_reinforcement', 'Not every response needs reinforcement! A Fixed Ratio (FR) schedule reinforces after a set number of responses. Try FR-3: reinforce every 3rd lever press. Watch how the mouse responds differently than continuous reinforcement!'),
...

            {
              ...
              id: 5, title: t('stem.behaviorlab.green_means_go', 'Green Means Go'), concept: 'Stimulus Discrimination', target: 'pressLever', goal: 10,

              intro: t('stem.behaviorlab.a_discriminative_stimulus_sd_signals_t', 'A discriminative stimulus (SD) signals that reinforcement is available. The green light = SD (reinforce lever presses). Red light = S-delta (do NOT reinforce). Teach the mouse to press only when the green light is on!'),
...

            {
              ...
              id: 6, title: t('stem.behaviorlab.free_lab', 'Free Lab'), concept: 'Sandbox Mode', target: null, goal: 0,

              intro: t('stem.behaviorlab.welcome_to_the_free_lab_all_tools_are_', 'Welcome to the Free Lab! All tools are unlocked. Design your own experiment. Try shaping a new behavior, testing different schedules, or building a behavior chain. Happy experimenting!'),
...

            {
              ...
              id: 7, title: t('stem.behaviorlab.chain_reaction', 'Chain Reaction'), concept: 'Behavior Chaining', target: 'pressLever', goal: 3,

              intro: t('stem.behaviorlab.a_behavior_chain_links_multiple_behavi', 'A behavior chain links multiple behaviors in a specific sequence. The completion of one step becomes the signal (SD) for the next. Teach the mouse this chain: Sniff ➜ Rear Up ➜ Press Lever. Reinforce ONLY when the full 3-step chain is completed!'),
...

            {
              ...
              id: 8, title: t('stem.behaviorlab.not_that', 'Not That!'), concept: 'DRO — Differential Reinforcement', target: null, goal: 5,

              intro: t('stem.behaviorlab.dro_differential_reinforcement_of_othe', 'DRO (Differential Reinforcement of Other behavior) means reinforcing the ABSENCE of a specific behavior for a set time interval. A countdown timer runs — if the mouse does NOT press the lever before the timer finishes, deliver food! If the mouse presses the lever, the timer resets. Deliver 5 successful DRO intervals!'),
...

            {
              ...
              id: 9, title: t('stem.behaviorlab.pavlov_s_bell', 'Pavlov\'s Bell'), concept: 'Classical Conditioning', target: null, goal: 0,

              intro: t('stem.behaviorlab.classical_conditioning_pairs_a_neutral', 'Classical conditioning pairs a neutral stimulus (bell) with an unconditioned stimulus (food) that naturally causes a response (salivation). After repeated pairings the bell ALONE triggers salivation! Phase 1: Ring the bell — nothing happens. Phase 2: Pair bell + food 5 times. Phase 3: Ring bell alone and watch for the conditioned response!'),
          ...
          var LEVEL_BADGES = {
            1: { icon: '\uD83C\uDF55', name: t('stem.behaviorlab.first_feeder', 'First Feeder'), desc: t('stem.behaviorlab.mastered_positive_reinforcement', 'Mastered positive reinforcement') },
            2: { icon: '\uD83C\uDFAF', name: t('stem.behaviorlab.shape_shifter', 'Shape Shifter'), desc: t('stem.behaviorlab.shaped_behavior_through_approximations', 'Shaped behavior through approximations') },
            3: { icon: '\uD83D\uDCA5', name: t('stem.behaviorlab.burst_observer', 'Burst Observer'), desc: t('stem.behaviorlab.witnessed_the_extinction_burst', 'Witnessed the extinction burst') },
            4: { icon: '\uD83D\uDCC5', name: t('stem.behaviorlab.scheduler', 'Scheduler'), desc: t('stem.behaviorlab.implemented_fr_3_schedule', 'Implemented FR-3 schedule') },
            5: { icon: '\uD83D\uDEA6', name: t('stem.behaviorlab.signal_master', 'Signal Master'), desc: t('stem.behaviorlab.taught_stimulus_discrimination', 'Taught stimulus discrimination') },
            6: { icon: '\uD83E\uDDEA', name: t('stem.behaviorlab.free_thinker', 'Free Thinker'), desc: t('stem.behaviorlab.explored_the_sandbox_lab', 'Explored the sandbox lab') },
            7: { icon: '\u26D3', name: t('stem.behaviorlab.chain_builder', 'Chain Builder'), desc: t('stem.behaviorlab.completed_a_behavior_chain', 'Completed a behavior chain') },
            8: { icon: '\u23F1', name: t('stem.behaviorlab.dro_pro', 'DRO Pro'), desc: t('stem.behaviorlab.mastered_differential_reinforcement', 'Mastered differential reinforcement') },
            9: { icon: '\uD83D\uDD14', name: t('stem.behaviorlab.pavlovian', 'Pavlovian'), desc: t('stem.behaviorlab.demonstrated_classical_conditioning', 'Demonstrated classical conditioning') }
          };

          // === Famous Behaviorists ===
          var FAMOUS_BEHAVIORISTS = [
            { name: t('stem.behaviorlab.ivan_pavlov', 'Ivan Pavlov'), year: '1849-1936', contribution: 'Discovered classical conditioning through salivation experiments with dogs. Won the Nobel Prize in Physiology (1904).', icon: '\uD83D\uDC36', field: 'Classical Conditioning' },
            { name: t('stem.behaviorlab.john_b_watson', 'John B. Watson'), year: '1878-1958', contribution: 'Founded behaviorism as a school of psychology. Argued psychology should study only observable behavior, not mental states. Controversial "Little Albert" experiment.', icon: '\uD83E\uDDEC', field: 'Behaviorism' },
            { name: t('stem.behaviorlab.edward_thorndike', 'Edward Thorndike'), year: '1874-1949', contribution: 'Formulated the Law of Effect: behaviors followed by satisfying consequences are strengthened. Puzzle box experiments with cats.', icon: '\uD83D\uDC31', field: 'Law of Effect' },
            { name: t('stem.behaviorlab.b_f_skinner', 'B.F. Skinner'), year: '1904-1990', contribution: 'Developed operant conditioning and the Skinner box. Identified reinforcement schedules (FR, VR, FI, VI). Most influential behavioral psychologist ever.', icon: '\uD83D\uDC2D', field: 'Operant Conditioning' },
            { name: t('stem.behaviorlab.albert_bandura', 'Albert Bandura'), year: '1925-2021', contribution: 'Social learning theory and the Bobo doll experiment. Showed learning occurs through observation (modeling), not just direct reinforcement. Self-efficacy theory.', icon: '\uD83E\uDDD1', field: 'Social Learning' },
            { name: t('stem.behaviorlab.baer_wolf_risley', 'Baer, Wolf & Risley'), year: '1968', contribution: 'Published the founding article of Applied Behavior Analysis (ABA). Defined ABA as applied, behavioral, analytic, technological, conceptually systematic, effective, and generalizable.', icon: '\uD83D\uDCDA', field: 'Applied Behavior Analysis' },
            { name: t('stem.behaviorlab.o_ivar_lovaas', 'O. Ivar Lovaas'), year: '1927-2010', contribution: 'Pioneered the use of ABA for autism intervention. His 1987 study showed 47% of children receiving intensive ABA achieved normal functioning.', icon: '\u2764', field: 'Autism Intervention' },
            { name: t('stem.behaviorlab.murray_sidman', 'Murray Sidman'), year: '1923-2019', contribution: 'Developed stimulus equivalence theory and the coercion framework. Advocated for reinforcement over punishment in all applications.', icon: '\u2696', field: 'Stimulus Equivalence' }
          ];

          // === Four Functions of Behavior (FBA) ===
          var FOUR_FUNCTIONS = [
            { name: t('stem.behaviorlab.attention', 'Attention'), abbrev: 'ATT', icon: '\uD83D\uDC40', color: '#3b82f6', desc: t('stem.behaviorlab.behavior_maintained_by_social_attentio', 'Behavior maintained by social attention from others. Example: A student calls out in class to get the teacher to look at them. The attention (even if negative) reinforces the calling out.'), example: 'Calling out, clowning around, tantrums when ignored', intervention: 'Planned ignoring of problem behavior + attention for appropriate behavior (DRA). Teach appropriate ways to get attention.' },
            { name: 'Escape/Avoidance', abbrev: 'ESC', icon: '\uD83C\uDFC3', color: '#ef4444', desc: t('stem.behaviorlab.behavior_maintained_by_removal_of_an_a', 'Behavior maintained by removal of an aversive stimulus. Example: A student has a meltdown when given math work, and the teacher removes the assignment. The meltdown is negatively reinforced.'), example: 'Work refusal, aggression to end demands, elopement', intervention: 'Escape extinction (don\'t remove demand). Break tasks into smaller steps. Provide breaks contingent on compliance (DRO/DRA).' },
            { name: t('stem.behaviorlab.tangible', 'Tangible'), abbrev: 'TAN', icon: '\uD83C\uDFAE', color: '#f59e0b', desc: t('stem.behaviorlab.behavior_maintained_by_access_to_a_pre', 'Behavior maintained by access to a preferred item or activity. Example: A child screams in the store until the parent buys them candy. The screaming is reinforced by getting the candy.'), example: 'Grabbing items, screaming for toys, negotiating for screen time', intervention: 'Don\'t provide the item contingent on problem behavior. Teach requesting (FCT). Provide access to preferred items for appropriate behavior.' },
            { name: 'Sensory/Automatic', abbrev: 'AUT', icon: '\u2728', color: '#8b5cf6', desc: t('stem.behaviorlab.behavior_maintained_by_the_sensory_sti', 'Behavior maintained by the sensory stimulation it produces, independent of social consequences. The behavior itself feels good. Example: Hand-flapping may produce proprioceptive input that is reinforcing.'), example: 'Hand flapping, rocking, humming, nail biting', intervention: 'Provide alternative sensory input (sensory diet). Modify the environment. Consider whether the behavior actually needs intervention (it may serve a regulatory function).' }
          ];

          // === Real-World ABA Applications ===
          var ABA_APPLICATIONS = [
            { name: t('stem.behaviorlab.autism_services', 'Autism Services'), icon: '\u2764', desc: t('stem.behaviorlab.evidence_based_intervention_for_indivi', 'Evidence-based intervention for individuals with autism. Teaches communication, social, self-care, and academic skills through systematic reinforcement and prompting strategies.'), setting: 'Clinics, homes, schools' },
            { name: t('stem.behaviorlab.education_classroom_management', 'Education & Classroom Management'), icon: '\uD83C\uDFEB', desc: t('stem.behaviorlab.token_economies_positive_behavior_supp', 'Token economies, positive behavior support (PBS), response to intervention (RTI), and group contingencies. Making learning reinforcing and reducing challenging behavior.'), setting: 'Schools (Pre-K through college)' },
            { name: t('stem.behaviorlab.animal_training', 'Animal Training'), icon: '\uD83D\uDC3E', desc: t('stem.behaviorlab.clicker_training_shaping_and_chaining_', 'Clicker training, shaping, and chaining are all ABA principles. Service dogs, marine mammals, and zoo animals are all trained using operant conditioning.'), setting: 'Zoos, aquariums, service dog organizations' },
            { name: t('stem.behaviorlab.organizational_behavior_management_obm', 'Organizational Behavior Management (OBM)'), icon: '\uD83C\uDFE2', desc: t('stem.behaviorlab.applying_aba_principles_to_improve_emp', 'Applying ABA principles to improve employee performance, safety, and satisfaction. Feedback systems, incentive programs, and performance management.'), setting: 'Businesses, hospitals, factories' },
            { name: t('stem.behaviorlab.sports_performance', 'Sports Performance'), icon: '\u26BD', desc: t('stem.behaviorlab.coaches_use_shaping_reinforcement_and_', 'Coaches use shaping, reinforcement, and behavioral rehearsal to improve athletic performance. Video feedback and goal-setting based on behavioral principles.'), setting: 'Professional & amateur sports' },
            { name: t('stem.behaviorlab.health_fitness', 'Health & Fitness'), icon: '\uD83D\uDCAA', desc: t('stem.behaviorlab.habit_formation_self_monitoring_contin', 'Habit formation, self-monitoring, contingency contracts for exercise. Behavioral approaches to weight management, medication adherence, and addiction treatment.'), setting: 'Hospitals, gyms, home programs' },
            { name: t('stem.behaviorlab.app_game_design', 'App & Game Design'), icon: '\uD83D\uDCF1', desc: t('stem.behaviorlab.variable_ratio_reinforcement_in_social', 'Variable ratio reinforcement in social media (likes, notifications). Shaping in game tutorials. Streaks and badges as conditioned reinforcers. Gamification IS applied behavior analysis.'), setting: 'Tech companies, UX design' },
            { name: t('stem.behaviorlab.environmental_sustainability', 'Environmental Sustainability'), icon: '\uD83C\uDF0D', desc: t('stem.behaviorlab.behavioral_interventions_for_recycling', 'Behavioral interventions for recycling, energy conservation, and sustainable transportation. Feedback and reinforcement can change environmental behaviors at scale.'), setting: 'Communities, policy' }
          ];
          ...
          var MEASUREMENT_METHODS = [
            ...
            { name: t('stem.behaviorlab.duration', 'Duration'), def: 'Total time a behavior occurs. Can be total or per-occurrence.', example: 'Student was off-task for 14 of 30 minutes (47%)', when: 'The concern is HOW LONG the behavior lasts (tantrums, on-task behavior, engagement).', icon: '\u23F1' },
            { name: t('stem.behaviorlab.latency', 'Latency'), def: 'Time between a stimulus (instruction) and behavior onset.', example: 'Teacher said "sit down" and student sat 45 seconds later', when: 'The concern is HOW LONG it takes to start responding after an instruction.', icon: '\u23F3' },
            { name: t('stem.behaviorlab.inter_response_time_irt', 'Inter-Response Time (IRT)'), def: 'Time between two consecutive instances of the same behavior.', example: 'Time between each hand-raise: 2 min, 5 min, 1 min, 8 min', when: 'Evaluating whether behavior is clustering or spreading out over time.', icon: '\u2194' },
            ...
            { name: t('stem.behaviorlab.partial_interval_recording', 'Partial Interval Recording'), def: 'Mark interval as "occurred" if behavior happened at ANY point during the interval.', example: 'Divide 30 min into 1-min intervals. Mark if student talked out at any point in each interval.', when: 'Overestimates behavior. Good for behaviors you want to decrease.', icon: '\uD83D\uDFE5' },
            { name: t('stem.behaviorlab.whole_interval_recording', 'Whole Interval Recording'), def: 'Mark as "occurred" only if behavior lasted the ENTIRE interval.', example: 'Mark 1-min interval only if student was on-task for all 60 seconds.', when: 'Underestimates behavior. Good for behaviors you want to increase.', icon: '\uD83D\uDFE9' },
            { name: t('stem.behaviorlab.momentary_time_sampling', 'Momentary Time Sampling'), def: 'At the end of each interval, check if behavior is occurring at that exact moment.', example: 'Every 5 minutes, look at student. On-task? Check. Off-task? Check.', when: 'Easiest method for teachers. Good for estimating proportion of time.', icon: '\uD83D\uDFE6' }
          ];
          ...
          var PBIS_TIERS_MOVED_TO_TOOLKIT = [
            {
              tier: 1,
              name: t('stem.behaviorlab.tier_1_universal', 'Tier 1 — Universal'),
              icon: '🟢', color: '#22c55e',
            ...
            {
              tier: 2,
              name: t('stem.behaviorlab.tier_2_targeted', 'Tier 2 — Targeted'),
              icon: '🟡', color: '#fbbf24',
            ...
            {
              tier: 3,
              name: t('stem.behaviorlab.tier_3_intensive', 'Tier 3 — Intensive'),
              icon: '🔴', color: '#ef4444',
          ...
          var RESTRAINT_PRINCIPLES_MOVED_TO_TOOLKIT = [
            ...
            {
              name: t('stem.behaviorlab.what_seclusion_is_and_is_not', 'What seclusion IS (and is NOT)'),
              icon: '🚪', color: '#ef4444',
              content: t('stem.behaviorlab.seclusion_involuntary_confinement_of_a', 'Seclusion = involuntary confinement of a student alone in a room or area from which the student is physically prevented from leaving. The "physically prevented from leaving" part is what makes it seclusion legally.'),
          ...
          var ACTING_OUT_CYCLE_MOVED_TO_TOOLKIT = [
            {
              phase: 1, name: t('stem.behaviorlab.calm', 'Calm'), icon: '🌊', color: '#22c55e',
            ...
            {
              phase: 2, name: t('stem.behaviorlab.triggers', 'Triggers'), icon: '⚡', color: '#fbbf24',
            ...
            {
              phase: 3, name: t('stem.behaviorlab.agitation', 'Agitation'), icon: '😟', color: '#f97316',
            ...
            {
              phase: 4, name: t('stem.behaviorlab.acceleration', 'Acceleration'), icon: '🌪️', color: '#ef4444',
            ...
            {
              phase: 5, name: t('stem.behaviorlab.peak', 'Peak'), icon: '🔥', color: '#dc2626',
            ...
            {
              phase: 7, name: t('stem.behaviorlab.recovery', 'Recovery'), icon: '🌅', color: '#a78bfa',
          ...
          var SETTING_EVENTS_MOVED_TO_TOOLKIT = [
            {
              ...
              note: t('stem.behaviorlab.a_kid_who_is_in_pain_cannot_perform_th', 'A kid who is in pain cannot perform the same way a kid who is not in pain can. Period.')
            },
            {
              ...
              note: t('stem.behaviorlab.schools_often_see_the_aftermath_of_a_h', 'Schools often see the AFTERMATH of a home event hours later — student is more dysregulated than usual but cannot or will not say why.')
            },
            {
              ...
              note: t('stem.behaviorlab.predictability_is_a_reinforcer_for_man', 'Predictability is a reinforcer for many learners. Removing it changes thresholds across the whole day, not just the moment.')
            },
            {
              ...
              note: t('stem.behaviorlab.adolescent_social_events_have_a_half_l', 'Adolescent social events have a half-life of days, not minutes. Behavior on Wednesday may trace to Friday.')
            },
            {
              ...
              note: t('stem.behaviorlab.for_sensory_sensitive_learners_the_env', 'For sensory-sensitive learners, the environment itself is a continuous setting event. Reduce input and threshold rises.')
            },
            {
              ...
              note: t('stem.behaviorlab.trauma_anniversaries_and_seasonal_ment', 'Trauma anniversaries and seasonal mental-health patterns are real and predictable. Calendar awareness is a clinical tool.')
            }
          ];
          ...
          var DISABILITY_VOICES_MOVED_TO_SEL_HUB = [
            {
              name: t('stem.behaviorlab.ari_ne_eman', 'Ari Ne\'eman'),
            ...
            {
              name: t('stem.behaviorlab.temple_grandin', 'Temple Grandin'),
            ...
            {
              name: t('stem.behaviorlab.damian_milton', 'Damian Milton'),
            ...
            {
              name: t('stem.behaviorlab.henny_kupferstein', 'Henny Kupferstein'),
            ...
            {
              name: t('stem.behaviorlab.kassiane_asasumasu', 'Kassiane Asasumasu'),
            ...
            {
              name: t('stem.behaviorlab.mel_baggs_1980_2020', 'Mel Baggs (1980–2020)'),
          ...
          var ABA_ETHICS = [
            { name: t('stem.behaviorlab.benefit_others', 'Benefit Others'), icon: '\u2764', desc: t('stem.behaviorlab.aba_practitioners_have_a_responsibilit', 'ABA practitioners have a responsibility to promote the well-being of their clients above all other considerations.') },
            { name: t('stem.behaviorlab.least_restrictive', 'Least Restrictive'), icon: '\uD83D\uDD13', desc: t('stem.behaviorlab.always_use_the_least_restrictive_effec', 'Always use the least restrictive effective treatment. Try reinforcement-based procedures before considering punishment-based ones.') },
            { name: t('stem.behaviorlab.informed_consent', 'Informed Consent'), icon: '\uD83D\uDCDD', desc: t('stem.behaviorlab.clients_or_their_guardians_must_unders', 'Clients (or their guardians) must understand and agree to all intervention procedures before they are implemented.') },
            { name: t('stem.behaviorlab.data_driven_decisions', 'Data-Driven Decisions'), icon: '\uD83D\uDCCA', desc: t('stem.behaviorlab.all_treatment_decisions_must_be_based_', 'All treatment decisions must be based on objective data, not opinions or assumptions. If data shows the intervention isn\'t working, change it.') },
            { name: t('stem.behaviorlab.social_validity', 'Social Validity'), icon: '\uD83E\uDDD1\u200D\uD83E\uDD1D\u200D\uD83E\uDDD1', desc: t('stem.behaviorlab.goals_procedures_and_outcomes_should_b', 'Goals, procedures, and outcomes should be acceptable and meaningful to the client and their community.') },
            { name: t('stem.behaviorlab.competence', 'Competence'), icon: '\uD83C\uDF93', desc: t('stem.behaviorlab.only_practice_within_your_area_of_trai', 'Only practice within your area of training and competence. Seek supervision and continuing education.') }
          ];

          // === Wave 2: SCHEDULE_TYPES for comparison canvas ===
          var SCHEDULE_TYPES = [
            { id: 'FR', name: t('stem.behaviorlab.fixed_ratio', 'Fixed Ratio'), abbrev: 'FR-5', color: '#f59e0b', desc: t('stem.behaviorlab.reinforce_every_nth_response_creates_p', 'Reinforce every Nth response. Creates post-reinforcement pause then rapid responding.'), example: 'Piecework pay: get paid per 5 items assembled', pattern: 'high-pause', ratio: 5 },
            { id: 'VR', name: t('stem.behaviorlab.variable_ratio', 'Variable Ratio'), abbrev: 'VR-5', color: '#ef4444', desc: t('stem.behaviorlab.reinforce_after_variable_number_of_res', 'Reinforce after variable number of responses (avg N). Produces high, steady rate. Most resistant to extinction.'), example: 'Slot machines: win after random number of pulls', pattern: 'high-steady', ratio: 5 },
            { id: 'FI', name: t('stem.behaviorlab.fixed_interval', 'Fixed Interval'), abbrev: 'FI-10', color: '#3b82f6', desc: t('stem.behaviorlab.reinforce_first_response_after_fixed_t', 'Reinforce first response after fixed time interval. Creates scallop pattern — slow after reinforcement, fast near end.'), example: 'Checking mail: arrives at same time daily', pattern: 'scallop', interval: 10 },
            { id: 'VI', name: t('stem.behaviorlab.variable_interval', 'Variable Interval'), abbrev: 'VI-10', color: '#10b981', desc: t('stem.behaviorlab.reinforce_first_response_after_variabl', 'Reinforce first response after variable time interval (avg N). Produces slow, steady rate.'), example: 'Fishing: fish bite at unpredictable times', pattern: 'low-steady', interval: 10 }
          ];

          // === Wave 2: REINFORCEMENT_MATRIX (2x2 operant conditioning) ===
          var REINFORCE_MATRIX = [
            { id: 'srPlus', row: 0, col: 0, name: t('stem.behaviorlab.positive_reinforcement', 'Positive Reinforcement'), abbrev: 'SR+', action: 'ADD', effect: 'INCREASE', color: '#22c55e', icon: '\u2795\u2B06',
              desc: t('stem.behaviorlab.adding_a_stimulus_to_increase_behavior', 'Adding a stimulus to increase behavior'), formal: 'The contingent presentation of a stimulus that increases the future probability of a behavior.',
            ...
            { id: 'srMinus', row: 0, col: 1, name: t('stem.behaviorlab.negative_reinforcement', 'Negative Reinforcement'), abbrev: 'SR-', action: 'REMOVE', effect: 'INCREASE', color: '#3b82f6', icon: '\u2796\u2B06',
              desc: t('stem.behaviorlab.removing_an_aversive_stimulus_to_incre', 'Removing an aversive stimulus to increase behavior'), formal: 'The contingent removal of an aversive stimulus that increases the future probability of a behavior.',
            ...
            { id: 'spPlus', row: 1, col: 0, name: t('stem.behaviorlab.positive_punishment', 'Positive Punishment'), abbrev: 'SP+', action: 'ADD', effect: 'DECREASE', color: '#ef4444', icon: '\u2795\u2B07',
              desc: t('stem.behaviorlab.adding_an_aversive_stimulus_to_decreas', 'Adding an aversive stimulus to decrease behavior'), formal: 'The contingent presentation of an aversive stimulus that decreases the future probability of a behavior.',
            ...
            { id: 'spMinus', row: 1, col: 1, name: t('stem.behaviorlab.negative_punishment', 'Negative Punishment'), abbrev: 'SP-', action: 'REMOVE', effect: 'DECREASE', color: '#f59e0b', icon: '\u2796\u2B07',
              desc: t('stem.behaviorlab.removing_a_desired_stimulus_to_decreas', 'Removing a desired stimulus to decrease behavior'), formal: 'The contingent removal of a reinforcing stimulus that decreases the future probability of a behavior.',
          ...
          var TOKEN_ITEMS = [
            { id: 'hw', name: t('stem.behaviorlab.homework_complete', 'Homework Complete'), tokens: 3, icon: '\uD83D\uDCD3', category: 'academic' },
            { id: 'onTask', name: t('stem.behaviorlab.on_task_15_min', 'On-task 15 min'), tokens: 2, icon: '\uD83C\uDFAF', category: 'behavior' },
            { id: 'kind', name: t('stem.behaviorlab.act_of_kindness', 'Act of Kindness'), tokens: 4, icon: '\u2764\uFE0F', category: 'social' },
            { id: 'clean', name: t('stem.behaviorlab.clean_up_area', 'Clean Up Area'), tokens: 2, icon: '\uD83E\uDDF9', category: 'behavior' },
            { id: 'help', name: t('stem.behaviorlab.help_a_peer', 'Help a Peer'), tokens: 3, icon: '\uD83E\uDD1D', category: 'social' },
            { id: 'quiet', name: t('stem.behaviorlab.quiet_transition', 'Quiet Transition'), tokens: 1, icon: '\uD83E\uDD2B', category: 'behavior' },
            { id: 'read', name: t('stem.behaviorlab.read_20_pages', 'Read 20 Pages'), tokens: 3, icon: '\uD83D\uDCDA', category: 'academic' },
            { id: 'test', name: t('stem.behaviorlab.score_80', 'Score 80%+'), tokens: 5, icon: '\uD83C\uDF1F', category: 'academic' }
          ];

          var TOKEN_REWARDS = [
            { id: 'sticker', name: t('stem.behaviorlab.sticker', 'Sticker'), cost: 5, icon: '\u2B50' },
            { id: 'freetime', name: t('stem.behaviorlab.5_min_free_time', '5 min Free Time'), cost: 10, icon: '\uD83C\uDFAE' },
            { id: 'snack', name: t('stem.behaviorlab.snack_choice', 'Snack Choice'), cost: 15, icon: '\uD83C\uDF6A' },
            { id: 'leader', name: t('stem.behaviorlab.line_leader', 'Line Leader'), cost: 8, icon: '\uD83D\uDC51' },
            { id: 'computer', name: t('stem.behaviorlab.computer_time', 'Computer Time'), cost: 12, icon: '\uD83D\uDCBB' },
            { id: 'homework', name: t('stem.behaviorlab.homework_pass', 'Homework Pass'), cost: 20, icon: '\uD83C\uDF89' },
            { id: 'teacher', name: t('stem.behaviorlab.lunch_with_teacher', 'Lunch with Teacher'), cost: 25, icon: '\uD83C\uDF55' },
            { id: 'mystery', name: t('stem.behaviorlab.mystery_prize', 'Mystery Prize'), cost: 30, icon: '\uD83C\uDF81' }
          ];
          ...
          var SCENARIO_CHALLENGES = [
            { id: 1, scenario: 'A student screams every time they are asked to complete a math worksheet. When they scream, the teacher sends them to the hallway.', question: t('stem.behaviorlab.what_function_does_the_screaming_likel', 'What function does the screaming likely serve?'),
            ...
            { id: 2, scenario: 'A child throws toys whenever their parent is on the phone. The parent stops the call to attend to the child.', question: t('stem.behaviorlab.what_function_does_throwing_toys_likel', 'What function does throwing toys likely serve?'),
            ...
            { id: 3, scenario: 'A student with autism rocks back and forth during independent work time. The rocking does not seem connected to getting or avoiding anything.', question: t('stem.behaviorlab.what_function_does_the_rocking_likely_', 'What function does the rocking likely serve?'),
            ...
            { id: 4, scenario: 'Every time a specific toy is visible, a child cries until they get it. The crying stops immediately once they have the toy.', question: t('stem.behaviorlab.what_function_does_the_crying_likely_s', 'What function does the crying likely serve?'),
            ...
            { id: 5, scenario: 'You are using FR-5 to reinforce a new behavior. The learner shows a post-reinforcement pause after each delivery.', question: t('stem.behaviorlab.what_should_you_do', 'What should you do?'),
            ...
            { id: 6, scenario: 'A student has learned to raise their hand in the classroom but does not do it at home or in other settings.', question: t('stem.behaviorlab.what_aba_concept_does_this_illustrate', 'What ABA concept does this illustrate?'),
            ...
            { id: 7, scenario: 'A therapist is teaching a child to brush their teeth using forward chaining. The child can do steps 1-3 independently.', question: t('stem.behaviorlab.what_should_the_therapist_do_next', 'What should the therapist do next?'),
            ...
            { id: 8, scenario: 'A teacher wants to reduce a student calling out in class but does not want to use punishment.', question: t('stem.behaviorlab.which_procedure_would_be_most_appropri', 'Which procedure would be MOST appropriate?'),
            ...
            { id: 9, scenario: 'During a Pavlovian conditioning experiment, you pair a tone (NS) with food (US) 10 times. On trial 11, you present the tone alone.', question: t('stem.behaviorlab.what_do_you_expect', 'What do you expect?'),
            ...
            { id: 10, scenario: 'A BCBAs client has been making great progress on a program. The insurance company is reviewing whether to continue funding.', question: t('stem.behaviorlab.what_should_the_bcba_present', 'What should the BCBA present?'),
            ...
            { id: 11, scenario: 'You are implementing DRO with a 30-second interval. The target behavior occurs at the 28-second mark.', question: t('stem.behaviorlab.what_happens', 'What happens?'),
            ...
            { id: 12, scenario: 'A parent reports that their child "had an extinction burst" when they stopped giving candy for tantrums. They want to give in.', question: t('stem.behaviorlab.what_is_the_best_advice', 'What is the best advice?'),
          ...
          var QUICK_REF_CARDS = [
            { title: t('stem.behaviorlab.the_7_dimensions_of_aba', 'The 7 Dimensions of ABA'), content: t('stem.behaviorlab.applied_behavioral_analytic_technologi', 'Applied \u2022 Behavioral \u2022 Analytic \u2022 Technological \u2022 Conceptually Systematic \u2022 Effective \u2022 Generality'), icon: '7\uFE0F\u20E3', color: '#f59e0b' },
            { title: t('stem.behaviorlab.reinforcement_rule', 'Reinforcement Rule'), content: t('stem.behaviorlab.if_a_consequence_increases_behavior_re', 'If a consequence INCREASES behavior = Reinforcement. + means ADD stimulus. - means REMOVE stimulus.'), icon: '\u2B06\uFE0F', color: '#22c55e' },
            { title: t('stem.behaviorlab.punishment_rule', 'Punishment Rule'), content: t('stem.behaviorlab.if_a_consequence_decreases_behavior_pu', 'If a consequence DECREASES behavior = Punishment. + means ADD stimulus. - means REMOVE stimulus.'), icon: '\u2B07\uFE0F', color: '#ef4444' },
            { title: t('stem.behaviorlab.three_term_contingency', 'Three-Term Contingency'), content: t('stem.behaviorlab.a_antecedent_b_behavior_c_consequence_', 'A (Antecedent) \u2192 B (Behavior) \u2192 C (Consequence). Also called the "ABC" of behavior analysis.'), icon: '\uD83D\uDD17', color: '#8b5cf6' },
            { title: t('stem.behaviorlab.extinction', 'Extinction'), content: t('stem.behaviorlab.withholding_reinforcement_for_a_previo', 'Withholding reinforcement for a previously reinforced behavior. Expect an initial extinction BURST (temporary increase) before decrease.'), icon: '\uD83D\uDCC9', color: '#6366f1' },
            { title: t('stem.behaviorlab.schedules_of_reinforcement', 'Schedules of Reinforcement'), content: t('stem.behaviorlab.fr_fixed_ratio_vr_variable_ratio_fi_fi', 'FR (Fixed Ratio) \u2022 VR (Variable Ratio) \u2022 FI (Fixed Interval) \u2022 VI (Variable Interval). Ratio = responses. Interval = time.'), icon: '\uD83D\uDCC5', color: '#3b82f6' },
            { title: t('stem.behaviorlab.motivating_operations', 'Motivating Operations'), content: t('stem.behaviorlab.eo_establishing_operation_increases_va', 'EO (Establishing Operation) = increases value of reinforcer. AO (Abolishing Operation) = decreases value of reinforcer.'), icon: '\uD83D\uDCA1', color: '#10b981' },
            { title: t('stem.behaviorlab.ethics_first', 'Ethics First'), content: t('stem.behaviorlab.least_restrictive_data_driven_informed', 'Least restrictive \u2022 Data-driven \u2022 Informed consent \u2022 Social validity \u2022 Competence \u2022 Client benefit above all.'), icon: '\u2764\uFE0F', color: '#ec4899' }
          ];
          ...
          if (blPhase === 'intro') {
            ...
            return React.createElement("div", { className: "p-6 space-y-4", role: "main", "aria-label": t('stem.behaviorlab.behavior_lab', "Behavior Lab"), style: { maxWidth: 700, margin: '0 auto' } },

              // Skip navigation
              React.createElement("a", { href: "#behaviorlab-main", className: "sr-only focus:not-sr-only focus:absolute focus:z-50 focus:p-2 focus:bg-indigo-600 focus:text-white focus:rounded-lg" }, t('stem.behaviorlab.skip_to_main_content', "Skip to main content")),
              ...
              React.createElement("div", {
                ...
                React.createElement("button", {
                  ...
                  'aria-label': t('stem.behaviorlab.back_to_stem_lab', 'Back to STEM Lab'),
                  style: {
              ...
              React.createElement("div", { className: "bg-gradient-to-br from-amber-900/40 to-orange-900/30 border border-amber-500/30 rounded-2xl p-6 space-y-3" },
                ...
                React.createElement("div", { className: "bg-slate-800/60 rounded-xl p-3 border border-slate-600/40" },
                  ...
                  React.createElement("p", { className: "text-xs text-amber-200 font-bold mb-1" }, t('stem.behaviorlab.key_term', "\uD83D\uDCD6 Key Term:")),
                ...
                (function () {
                  ...
                  var LEVELS = [
                    ...
                    { id: 'plain', label: t('stem.behaviorlab.plain', 'Plain'), hint: t('stem.behaviorlab.using_simple_everyday_words_and_short_', 'using simple everyday words and short sentences, no jargon') },

                    { id: 'grade5', label: t('stem.behaviorlab.grade_5', 'Grade 5'), hint: t('stem.behaviorlab.for_a_5th_grade_student_with_a_concret', 'for a 5th grade student, with a concrete classroom or family example') },

                    { id: 'hs', label: t('stem.behaviorlab.high_school', 'High School'), hint: t('stem.behaviorlab.for_a_high_school_psychology_student', 'for a high school psychology student') },

                    { id: 'prof', label: 'Pro', hint: t('stem.behaviorlab.for_a_new_school_psychologist_or_bcba_', 'for a new school psychologist or BCBA trainee, using accurate technical language') }
                  ...
                  return React.createElement("div", { className: "bg-slate-800/60 rounded-xl p-3 border border-purple-500/40 mt-2", role: "region", "aria-label": t('stem.behaviorlab.ai_behavior_analysis_tutor', "AI behavior-analysis tutor") },

                    React.createElement("div", { className: "flex items-center flex-wrap gap-2 mb-1.5" },

                      React.createElement("span", { className: "text-xs font-bold text-purple-300" }, t('stem.behaviorlab.explain_at_my_level', "\u2728 Explain at my level")),

                      React.createElement("div", { className: "ml-auto flex gap-1", role: "group", "aria-label": t('stem.behaviorlab.reading_level', "Reading level") },
                    ...
                    !aiText && !aiLoading && !aiError && React.createElement("p", { className: "text-[11px] italic text-slate-400" }, t('stem.behaviorlab.click_explain_for_a_classroom_example_', "Click \u201CExplain\u201D for a classroom example of this concept at your chosen reading level."))
              ...
              React.createElement("button", { "aria-label": t('stem.behaviorlab.start_experiment', "Start Experiment"),
              ...
              }, t('stem.behaviorlab.start_experiment_2', "\uD83D\uDE80 Start Experiment")),
              ...
              (function() {
                ...
                var sm = ({
                  addictive: { label: t('stem.behaviorlab.addictive_pattern', 'Addictive pattern'), color: '#f87171', bg: '#2a0a0a', border: '#dc2626', desc: t('stem.behaviorlab.vr_schedule_strong_reinforcer_no_alter', 'VR schedule + strong reinforcer + no alternative = gambling/scrolling pattern. Hardest to extinguish.') },
                  durable: { label: t('stem.behaviorlab.durable_habit', 'Durable habit'), color: '#facc15', bg: '#2a2410', border: '#eab308', desc: t('stem.behaviorlab.behavior_persists_through_occasional_n', 'Behavior persists through occasional non-reinforcement. Typical of well-trained skills.') },
                  moderate: { label: t('stem.behaviorlab.moderate_persistence', 'Moderate persistence'), color: '#22d3ee', bg: '#0a1f2e', border: '#0891b2', desc: t('stem.behaviorlab.standard_reinforcement_behavior_mainta', 'Standard reinforcement; behavior maintained while contingency holds.') },
                  fragile: { label: t('stem.behaviorlab.fragile', 'Fragile'), color: '#fb923c', bg: '#2a1a0a', border: '#ea580c', desc: t('stem.behaviorlab.crf_or_low_strength_alternatives_avail', 'CRF or low strength + alternatives available. Extinction begins quickly when reinforcement stops.') },
                  extinguishing: { label: t('stem.behaviorlab.already_extinguishing', 'Already extinguishing'), color: '#94a3b8', bg: '#1e293b', border: '#475569', desc: t('stem.behaviorlab.reinforcer_too_weak_vs_alternative_beh', 'Reinforcer too weak vs alternative \u2014 behavior dropping in frequency right now.') }
                })[state];
                return React.createElement("div", { style: { marginTop: 14, padding: 12, borderRadius: 12, background: sm.bg, border: '1px solid ' + sm.border, color: '#e8f0f5' } },
                  React.createElement("h4", { style: { margin: '0 0 4px', fontSize: 12, fontWeight: 800, color: sm.color, textTransform: 'uppercase', letterSpacing: 1 } }, t('stem.behaviorlab.reinforcement_inquiry_predict_persiste', '\uD83D\uDD2C Reinforcement Inquiry \u2014 Predict Persistence')),
                  React.createElement("p", { style: { margin: '0 0 6px', fontSize: 10, opacity: 0.85, lineHeight: 1.4 } }, t('stem.behaviorlab.set_schedule_reinforcer_strength_alter', 'Set schedule, reinforcer strength, alternatives, extinction time. Predict the persistence band. No score, no reveal.')),
                  ...
                  React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, marginBottom: 8 } },
                    React.createElement("label", { style: { fontSize: 10 } },
                      React.createElement("div", { style: { marginBottom: 2 } }, t('stem.behaviorlab.strength', 'Strength '), React.createElement("span", { style: { color: sm.color, fontFamily: 'monospace' } }, iq.reinforcerStrength)),
                    ...
                    React.createElement("label", { style: { fontSize: 10 } },
                      React.createElement("div", { style: { marginBottom: 2 } }, t('stem.behaviorlab.alternative', 'Alternative '), React.createElement("span", { style: { color: sm.color, fontFamily: 'monospace' } }, iq.alternativeReward)),
                    ...
                    React.createElement("label", { style: { fontSize: 10 } },
                      React.createElement("div", { style: { marginBottom: 2 } }, t('stem.behaviorlab.ext_time', 'Ext time '), React.createElement("span", { style: { color: sm.color, fontFamily: 'monospace' } }, iq.extinctionTime)),
                  ...
                  React.createElement("div", { style: { display: 'flex', gap: 6, marginBottom: 6 } },
                    ...
                    }, style: { flex: 1, padding: 4, fontSize: 10, fontWeight: 700, borderRadius: 4, border: '1px solid ' + sm.border, background: sm.bg, color: sm.color, cursor: 'pointer' } }, t('stem.behaviorlab.log', '\uD83D\uDCCB Log')),
                    React.createElement("button", { onClick: function() { setIQ({ schedule: 'FR3', reinforcerStrength: 5, alternativeReward: 3, extinctionTime: 5 }); }, style: { padding: '4px 8px', fontSize: 10, borderRadius: 4, border: '1px solid #1e293b', background: '#0a0a1a', color: '#94a3b8', cursor: 'pointer' } }, t('stem.behaviorlab.reset', 'Reset'))
                  ),
                  ...
                  iq.stuckRevealed && React.createElement("div", { style: { padding: 6, borderRadius: 4, background: '#0a0a1a', border: '1px dashed ' + sm.border, fontSize: 10, marginBottom: 6, lineHeight: 1.5 } },
                    React.createElement("div", { style: { fontWeight: 700, color: sm.color, marginBottom: 3 } }, t('stem.behaviorlab.open_questions_no_answer_key', 'Open questions (no answer key)')),
                    React.createElement("ul", { style: { margin: 0, paddingLeft: 14 } },
                      React.createElement("li", null, t('stem.behaviorlab.why_is_vr_variable_ratio_the_schedule_', 'Why is VR (variable ratio) the schedule behind slot machines + scrolling apps?')),
                      React.createElement("li", null, t('stem.behaviorlab.when_does_adding_an_alternative_reinfo', 'When does adding an alternative reinforcer FASTER extinguish a behavior than just removing the original?')),
                      React.createElement("li", null, t('stem.behaviorlab.what_pattern_of_responding_shows_durin', 'What pattern of responding shows during an FI (fixed interval) schedule? Why "scalloping"?')),
                      React.createElement("li", null, t('stem.behaviorlab.how_does_extinction_time_interact_with', 'How does extinction TIME interact with schedule type? (Hint: partial reinforcement extinction effect.)'))
                    )
                  ),
                  React.createElement("label", { style: { display: 'flex', alignItems: 'center', gap: 4, fontSize: 10, fontWeight: 700, cursor: 'pointer', marginBottom: 4 } },
                    ...
                    React.createElement("span", null, t('stem.behaviorlab.i_can_explain_why_this_schedule_streng', 'I can explain why this schedule + strength + alternative yields this persistence band.'))
                  ),
                  iq.understood && React.createElement("textarea", { value: iq.explanation, onChange: function(e) { setIQ({ explanation: e.target.value }); }, rows: 2, placeholder: t('stem.behaviorlab.explain_in_your_own_words', 'Explain in your own words...'), style: { width: '100%', padding: 4, borderRadius: 4, border: '1px solid ' + sm.border, background: '#0a0a1a', color: '#e8f0f5', fontSize: 10, marginBottom: 4, resize: 'vertical' } }),
                  React.createElement("p", { style: { margin: 0, fontSize: 9, fontStyle: 'italic', opacity: 0.6 } }, t('stem.behaviorlab.inquiry_widget_no_score_no_reveal_no_a', 'Inquiry widget \u2014 no score, no reveal, no answer dump. Skinner box terminology + matching-law extension. Persistence is multi-dimensional in real life; this is a teaching heuristic.'))
                );
              })()
          ...
          return React.createElement("div", { className: "p-4 space-y-3", role: "main", "aria-label": t('stem.behaviorlab.behavior_lab_simulation', "Behavior Lab Simulation"), style: { maxWidth: 720, margin: '0 auto' } },

            // Skip navigation
            React.createElement("a", { href: "#behaviorlab-sim", className: "sr-only focus:not-sr-only focus:absolute focus:z-50 focus:p-2 focus:bg-indigo-600 focus:text-white focus:rounded-lg" }, t('stem.behaviorlab.skip_to_simulation', "Skip to simulation")),
            ...
            React.createElement("div", {
              ...
              React.createElement("button", {
                ...
                className: "text-xl hover:scale-110 transition-transform", 'aria-label': t('stem.behaviorlab.back_to_level_select', 'Back to level select')
            ...
            blPhase === 'complete' && React.createElement("div", {
              ...
              React.createElement("div", { className: "grid grid-cols-3 gap-3 mb-4" },
                ...
                React.createElement("div", { className: "bg-slate-900/50 rounded-xl p-3 text-center border border-slate-700/40" },
                  ...
                  React.createElement("p", { className: "text-[11px] text-slate-200" }, t('stem.behaviorlab.reinforcements', "Reinforcements"))
                ...
                React.createElement("div", { className: "bg-slate-900/50 rounded-xl p-3 text-center border border-slate-700/40" },
                  ...
                  React.createElement("p", { className: "text-[11px] text-slate-200" }, t('stem.behaviorlab.ticks_to_complete', "Ticks to Complete"))
                ...
                React.createElement("div", { className: "bg-slate-900/50 rounded-xl p-3 text-center border border-slate-700/40" },
                  ...
                  React.createElement("p", { className: "text-[11px] text-slate-200" }, t('stem.behaviorlab.resp_rate_min', "Resp Rate / min"))
                ...
                blLatencies.length > 0 && React.createElement("div", { className: "bg-slate-900/50 rounded-xl p-3 text-center border border-slate-700/40" },
                  ...
                  React.createElement("p", { className: "text-[11px] text-slate-200" }, t('stem.behaviorlab.avg_latency_ticks', "Avg Latency (ticks)"))
              ...
              React.createElement("div", { className: "bg-slate-900/40 rounded-xl p-3 border border-slate-700/30 mb-3" },
                ...
                React.createElement("p", { className: "text-xs font-bold text-amber-300 mb-1" }, t('stem.behaviorlab.key_vocabulary', "\uD83D\uDCD6 Key Vocabulary:")),
              ...
              QUIZ_BANK[blLevel] && React.createElement("div", { className: "bg-gradient-to-br from-indigo-900/40 to-purple-900/30 rounded-xl p-4 border border-indigo-500/30" },
                ...
                React.createElement("p", { className: "text-xs font-bold text-indigo-300 mb-2" }, t('stem.behaviorlab.knowledge_check', "🧠 Knowledge Check")),
              ...
              React.createElement("button", { "aria-label": t('stem.behaviorlab.next_level', "Next Level"),
              ...
              }, t('stem.behaviorlab.next_level_2', "\u27A1\uFE0F Next Level"))
            ...
            (blLevel === 1 || blLevel === 2 || blLevel === 6) && React.createElement("div", {
              ...
              }, t('stem.behaviorlab.lever_proximity', '\uD83D\uDC2D \u2192 Lever proximity'))
            ),
            ...
            blRecentActions.length > 0 && React.createElement("div", {
              ...
              React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold mb-1.5 uppercase tracking-wider" }, t('stem.behaviorlab.recent_behaviors', "\uD83D\uDD25 Recent Behaviors")),
            ...
            React.createElement("div", { className: "flex gap-2 flex-wrap items-center" },
              ...
              }, t('stem.behaviorlab.automatic_dro_food_delivered_when_time', "\u23F1 Automatic (DRO) \u2014 food delivered when timer completes")) :
              ...
              }, t('stem.behaviorlab.use_the_classical_conditioning_panel_b', "\uD83D\uDD14 Use the Classical Conditioning panel below")) :
              ...
              blLevel === 3 && !blExtinctionPhase && blLevelScore >= 5 && React.createElement("button", { "aria-label": t('stem.behaviorlab.start_extinction', "Start Extinction"),
              ...
              }, t('stem.behaviorlab.start_extinction_2', "\uD83D\uDEAB Start Extinction")),
              ...
              }, t('stem.behaviorlab.extinction_in_progress_watch_the_burst', "\u23F3 Extinction in progress... watch the burst!")),
              ...
              blLevel === 6 && React.createElement("select", {
                ...
                'aria-label': t('stem.behaviorlab.target_behavior_selector', 'Target behavior selector'),
            ...
            blLevel === 7 && blPhase === 'running' && React.createElement("div", {
              ...
              React.createElement("h4", { className: "text-[11px] text-purple-300 font-bold mb-2 uppercase tracking-wider" }, t('stem.behaviorlab.chain_progress', "\uD83D\uDD17 Chain Progress")),
              ...
              React.createElement("div", { className: "flex items-center justify-center gap-2" },
                ...
                }, t('stem.behaviorlab.reinforce_now', "🍕 REINFORCE NOW!"))
            ...
            blLevel === 8 && blPhase === 'running' && React.createElement("div", {
              ...
              React.createElement("h4", { className: "text-[11px] text-cyan-300 font-bold mb-2 uppercase tracking-wider" }, t('stem.behaviorlab.dro_timer', "\u23F1 DRO Timer")),
            ...
            blLevel === 9 && blPhase === 'running' && React.createElement("div", {
              ...
              React.createElement("h4", { className: "text-[11px] text-rose-300 font-bold mb-2 uppercase tracking-wider" }, t('stem.behaviorlab.classical_conditioning', "\uD83D\uDD14 Classical Conditioning")),
              ...
              React.createElement("div", { className: "mb-3" },
                ...
                React.createElement("div", { className: "flex justify-between mb-1" },
                  ...
                  React.createElement("span", { style: { fontSize: 11, color: 'var(--allo-stem-text-soft, #94a3b8)', fontWeight: 600 } }, t('stem.behaviorlab.association_strength', 'Association Strength')),
              ...
              React.createElement("div", { className: "flex gap-2" },
                ...
                React.createElement("button", { "aria-label": t('stem.behaviorlab.ring_bell', "Ring Bell"),
                ...
                React.createElement("button", { "aria-label": t('stem.behaviorlab.pair_bell_with_food', "Pair Bell with Food"),
            ...
            React.createElement("div", { className: "grid grid-cols-2 gap-3" },
              ...
              React.createElement("div", {
                ...
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold mb-0.5 uppercase tracking-wider" }, t('stem.behaviorlab.last_behavior', "Last Behavior")),
              ...
              React.createElement("div", {
                ...
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold mb-0.5 uppercase tracking-wider" }, t('stem.behaviorlab.session_stats', "Session Stats")),
            ...
            React.createElement("div", {
              ...
              React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold mb-2 uppercase tracking-wider" }, t('stem.behaviorlab.behavior_probability_weights', "\uD83D\uDCCA Behavior Probability Weights")),
            ...
            blAbcLog.length > 0 && React.createElement("div", {
              ...
              React.createElement("div", { className: "flex items-center justify-between mb-2" },
                ...
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold uppercase tracking-wider" }, t('stem.behaviorlab.abc_data_log', "\uD83D\uDCCB ABC Data Log")),

                // CSV Export button

                React.createElement("button", { "aria-label": t('stem.behaviorlab.export_abc_data_as_csv', "Export ABC Data as CSV"),
                ...
                }, t('stem.behaviorlab.export_csv', "\uD83D\uDCE5 Export CSV"))
            ...
            React.createElement("div", {
              ...
              React.createElement("h3", { className: "text-[11px] text-slate-200 font-bold mb-2 uppercase tracking-wider" }, t('stem.behaviorlab.progress_badges', "\uD83C\uDFC6 Progress Badges")),
              React.createElement("div", { className: "flex flex-wrap gap-2 justify-center" },
                LEVELS.filter(function(l) { return l.id <= 9; }).map(function(l) {
                  ...
                  return React.createElement("div", { role: "button", tabIndex: 0, onKeyDown: function(e) { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); e.target.click(); } },  key: l.id,
                    ...
                    earned ? React.createElement("div", { className: "text-[11px] text-green-400" }, t('stem.behaviorlab.earned', '\u2713 Earned')) : React.createElement("div", { className: "text-[11px] text-slate-200" }, '\uD83D\uDD12')
                  );
                })
              ),
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { className: "flex items-center justify-between mb-2" },
                React.createElement("h3", { className: "text-[11px] text-slate-200 font-bold uppercase tracking-wider" }, t('stem.behaviorlab.four_functions_of_behavior_fba', "\uD83D\uDCA1 Four Functions of Behavior (FBA)")),
              ...
              d.blShowFunctions && React.createElement("div", null,
                React.createElement("div", { className: "text-[11px] text-slate-200 italic mb-2" }, t('stem.behaviorlab.every_behavior_serves_a_function_under', "Every behavior serves a function. Understanding WHY a behavior occurs is the key to changing it. These are the 4 functions identified by functional behavior assessment (FBA):")),
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 } },
                ...
                React.createElement("div", null,
                  React.createElement("div", { style: { fontSize: 13, fontWeight: 800, color: '#5eead4', lineHeight: 1.2 } }, t('stem.behaviorlab.continue_in_school_behavior_toolkit', "Continue in: School Behavior Toolkit")),
                  React.createElement("div", { style: { fontSize: 10, color: 'var(--allo-stem-text-soft, #94a3b8)', marginTop: 3, fontStyle: 'italic' } }, t('stem.behaviorlab.applied_k_12_practice_what_school_psyc', "Applied K-12 practice — what school psychs and educators DO with the science"))
                )
              ),
              React.createElement("div", { style: { fontSize: 11, color: 'var(--allo-stem-text, #cbd5e1)', lineHeight: 1.6, marginBottom: 10 } },
                t('stem.behaviorlab.if_you_have_just_learned_operant_condi', "If you have just learned operant conditioning here in BehaviorLab, the next step is the K-12 practice that uses it. "),
                React.createElement("b", null, t('stem.behaviorlab.we_deliberately_built_that_content_as_', "We deliberately built that content as a separate tool, not here.")),
                t('stem.behaviorlab.the_skinner_box_visual_frame_should_no', " The Skinner-box visual frame should not be adjacent to \"how to handle a kid in crisis\" content — different tonal space, different ethical weight. The Toolkit covers PBIS three-tier framework, replacement behaviors mapped to FBA functions, setting events (slow triggers most BIPs miss), Geoff Colvin's seven-phase Acting-Out Cycle for crisis de-escalation, and Restraint & Seclusion ethics anchored in Maine Chapter 33.")),
              React.createElement("div", { style: { fontSize: 11, color: 'var(--allo-stem-text-soft, #94a3b8)', lineHeight: 1.55, fontStyle: 'italic' } },
                t('stem.behaviorlab.open_stem_lab_behavioral_science', "Open STEM Lab → Behavioral Science → "),
                React.createElement("b", { style: { color: '#5eead4' } }, t('stem.behaviorlab.school_behavior_toolkit', '"🏫 School Behavior Toolkit."')))
            ),
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { className: "flex items-center justify-between mb-2" },
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold uppercase tracking-wider" }, t('stem.behaviorlab.beyond_pure_aba_neurodiversity_affirmi', "🧭 Beyond Pure ABA — neurodiversity-affirming + trauma-informed")),
              ...
              d.blShowBeyond && React.createElement("div", null,
                ...
                React.createElement("div", {
                  ...
                  t('stem.behaviorlab.identity_first_language_follows_commun', "💡 Identity-first language follows community-consensus norms (Kenny et al. 2016; Bury et al. 2020; Taboas et al. 2023). The Behavior Lab teaches the science of behavior; this panel teaches the ethics of applying it to humans who can tell us what they want."))
              )
            ),
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 } },
                ...
                React.createElement("div", null,
                  React.createElement("div", { style: { fontSize: 13, fontWeight: 800, color: '#f9a8d4', lineHeight: 1.2 } }, t('stem.behaviorlab.continue_in_disability_voices_sel_hub', "Continue in: Disability Voices (SEL Hub)")),
                  React.createElement("div", { style: { fontSize: 10, color: 'var(--allo-stem-text-soft, #94a3b8)', marginTop: 3, fontStyle: 'italic' } }, t('stem.behaviorlab.named_autistic_and_disabled_advocates_', "Named autistic and disabled advocates, not behavioral subjects"))
                )
              ),
              React.createElement("div", { style: { fontSize: 11, color: 'var(--allo-stem-text, #cbd5e1)', lineHeight: 1.6, marginBottom: 10 } },
                t('stem.behaviorlab.if_you_have_just_read_the_critical_fra', "If you have just read the critical-frame panels above, the next step is to hear from the people whose work shaped — and critiqued — applied behavior analysis. "),
                React.createElement("b", null, t('stem.behaviorlab.we_deliberately_built_that_content_in_', "We deliberately built that content in the SEL Hub, not here.")),
                t('stem.behaviorlab.putting_named_real_autistic_adults_ins', " Putting named real autistic adults inside a tool whose central image is a Skinner box would be exactly what the disability community has documented as harmful. The tool you want includes Ari Ne'eman, Temple Grandin, Damian Milton, Henny Kupferstein, Kassiane Asasumasu, Mel Baggs, Lydia X. Z. Brown, and Patty Berne — with documented quotes, context, and a curated reading list.")),
              React.createElement("div", { style: { fontSize: 11, color: 'var(--allo-stem-text-soft, #94a3b8)', lineHeight: 1.55, fontStyle: 'italic' } },
                t('stem.behaviorlab.open_sel_hub_identity_care', "Open SEL Hub → Identity & Care → "),
                React.createElement("b", { style: { color: '#f9a8d4' } }, t('stem.behaviorlab.disability_voices', '"🎤 Disability Voices."')))
            ),
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { className: "flex items-center justify-between mb-2" },
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold uppercase tracking-wider" }, t('stem.behaviorlab.schedule_comparison', "\uD83D\uDCC8 Schedule Comparison")),
              ...
              blSchedCanvas && React.createElement("div", null,
                React.createElement("div", { className: "text-[11px] text-slate-200 italic mb-2" }, t('stem.behaviorlab.watch_how_different_reinforcement_sche', "Watch how different reinforcement schedules produce distinct response patterns. FR creates post-reinforcement pauses, VR produces high steady rates, FI shows scalloping, VI shows low steady rates.")),
                ...
                React.createElement("div", { className: "flex gap-2 mt-2 justify-center" },
                  React.createElement("button", { "aria-label": t('stem.behaviorlab.toggle_schedule_animation', "Toggle schedule animation"),
                  ...
                  React.createElement("button", { "aria-label": t('stem.behaviorlab.reset_schedule_animation', "Reset schedule animation"),
                  ...
                  }, t('stem.behaviorlab.reset_2', '\u21BB Reset'))
                ),
                // Schedule details
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { className: "flex items-center justify-between mb-2" },
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold uppercase tracking-wider" }, t('stem.behaviorlab.schedule_sleuth_identify_the_schedule_', "\uD83D\uDD75\uFE0F Schedule Sleuth \u2014 identify the schedule from its curve")),
                React.createElement("button", {
              ...
              d.blShowSleuth && (function() {
                ...
                if (sleuthIdx < 0) {
                  return React.createElement("div", { className: "text-center py-4" },
                    React.createElement("p", { className: "text-[11px] text-slate-300 mb-3 italic" }, t('stem.behaviorlab.you_will_see_one_unlabeled_cumulative_', "You will see one unlabeled cumulative-response curve. Pick which schedule produced it. The curve shape is the only clue.")),
                    React.createElement("button", {
                      onClick: startRound,
                      "aria-label": t('stem.behaviorlab.start_schedule_sleuth', "Start Schedule Sleuth"),
                    ...
                    }, t('stem.behaviorlab.start_the_game', "\uD83D\uDD75\uFE0F Start the game"))
                  );
                }
                ...
                return React.createElement("div", null,
                  ...
                  React.createElement("div", { className: "flex items-center justify-between mb-2 text-[11px] flex-wrap gap-2" },
                    React.createElement("div", { className: "flex gap-3 items-center" },
                      React.createElement("span", { className: "text-slate-300" }, t('stem.behaviorlab.round', "Round "), React.createElement("strong", { className: "text-white" }, sleuthRounds + (sleuthAnswered ? '' : '+1'))),
                      React.createElement("span", { className: "text-slate-300" }, t('stem.behaviorlab.streak', "Streak "), React.createElement("strong", { className: "text-amber-400" }, sleuthStreak)),
                      React.createElement("span", { className: "text-slate-300" }, t('stem.behaviorlab.best', "Best "), React.createElement("strong", { className: "text-emerald-400" }, sleuthBestStreak)),
                      sleuthRounds > 0 && React.createElement("span", { className: "text-slate-300" }, t('stem.behaviorlab.accuracy', "Accuracy "), React.createElement("strong", { className: "text-cyan-400" }, pct + '%'))
                    )
                  ),
                  ...
                  React.createElement("details", {
                    ...
                    React.createElement("summary", { className: "cursor-pointer text-[11px] font-bold px-3 py-2 select-none text-cyan-300 select-none" }, t('stem.behaviorlab.how_to_read_this_curve_click_to_toggle', '📜 How to read this curve (click to toggle)')),
                    React.createElement("div", { className: "px-3 pb-3 space-y-2 text-[11px] text-slate-300" },
                      React.createElement("p", { className: "leading-relaxed" },
                        React.createElement("strong", null, t('stem.behaviorlab.cumulative_response_curve', "Cumulative-response curve")), t('stem.behaviorlab.each_reinforced_response_adds_one_to_t', ': each reinforced response adds one to the y-axis. Flat segments = no responding. Steep segments = rapid responding. Bumps where the curve briefly flattens = post-reinforcement pauses.')
                      ),
                      React.createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-1.5" },
                        [
                          { abbrev: 'FR', name: t('stem.behaviorlab.fixed_ratio_2', 'Fixed Ratio'),     pattern: 'High rate with predictable pause after each reinforcer.', color: '#f59e0b' },
                          { abbrev: 'VR', name: t('stem.behaviorlab.variable_ratio_2', 'Variable Ratio'),  pattern: 'High and steady. No pauses. Resistant to extinction.',    color: '#ef4444' },
                          { abbrev: 'FI', name: t('stem.behaviorlab.fixed_interval_2', 'Fixed Interval'),  pattern: 'Scallop shape: slow after reinforcer, fast near the end.', color: '#3b82f6' },
                          { abbrev: 'VI', name: t('stem.behaviorlab.variable_interval_2', 'Variable Interval'), pattern: 'Low and steady. Predictable but slow.',                color: '#10b981' }
                        ].map(function(s, i) {
                      ...
                      React.createElement('p', { className: 'text-[10px] italic text-slate-400 pt-1 border-t border-slate-700' },
                        t('stem.behaviorlab.tip_focus_on_shape_not_absolute_height', 'Tip: focus on shape, not absolute height. The curve below is unlabeled until you guess.')
                      )
                    )
                  ),
                  ...
                  React.createElement("div", { style: { background: 'var(--allo-stem-canvas, #0f172a)', borderRadius: 10, padding: 8, border: '1px solid rgba(100,116,139,0.3)' } },
                    React.createElement("svg", {
                      ...
                      // Axes labels
                      React.createElement('text', { x: MARGIN_X, y: 12, fontSize: 8, fill: '#94a3b8', fontFamily: 'monospace' }, t('stem.behaviorlab.cumulative_responses', 'Cumulative responses')),
                      React.createElement('text', { x: WIDTH - 36, y: HEIGHT - 1, fontSize: 8, fill: '#94a3b8', fontFamily: 'monospace' }, t('stem.behaviorlab.time', 'Time \u2192')),
                  ...
                  // Picker buttons
                  React.createElement("div", { className: "grid grid-cols-2 gap-2 mt-3", role: 'radiogroup', 'aria-label': t('stem.behaviorlab.pick_the_schedule', 'Pick the schedule') },
                  ...
                  sleuthAnswered && React.createElement("div", {
                    ...
                    React.createElement("button", {
                      onClick: startRound,
                      "aria-label": t('stem.behaviorlab.next_round', "Next round"),
                    ...
                    }, t('stem.behaviorlab.next_round_2', "\u27A1\uFE0F Next round"))
                  )
                );
              })()
            ),
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { className: "flex items-center justify-between mb-2" },
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold uppercase tracking-wider" }, t('stem.behaviorlab.function_sleuth_what_is_the_behavior_g', "🔍 Function Sleuth — what is the behavior getting?")),
                React.createElement("button", {
              ...
              d.blShowFnSleuth && (function() {
                ...
                var FN_OPTIONS = [
                  { id: 'Attention', label: t('stem.behaviorlab.attention_2', 'Attention'),         color: '#3b82f6', icon: '👀' },
                  { id: 'Escape',    label: t('stem.behaviorlab.escape_avoidance', 'Escape / Avoidance'), color: '#ef4444', icon: '🏃' },
                  { id: 'Tangible',  label: t('stem.behaviorlab.tangible_2', 'Tangible'),          color: '#f59e0b', icon: '🎮' },
                  { id: 'Sensory',   label: t('stem.behaviorlab.sensory_automatic', 'Sensory / Automatic'), color: '#8b5cf6', icon: '✨' }
                ];
                ...
                if (fnIdx < 0) {
                  return React.createElement("div", { className: "py-3" },
                    ...
                    React.createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-1.5 mb-3" },
                      [
                        { id: 'Attention', icon: '👀', color: '#3b82f6', name: t('stem.behaviorlab.attention_3', 'Attention'), def: 'Behavior produces interaction (positive OR corrective) from someone.' },
                        { id: 'Escape',    icon: '🏃', color: '#ef4444', name: t('stem.behaviorlab.escape', 'Escape'),    def: 'Behavior postpones, reduces, or removes a demand the kid wants to avoid.' },
                        { id: 'Tangible',  icon: '🎮', color: '#f59e0b', name: t('stem.behaviorlab.tangible_3', 'Tangible'),  def: 'Behavior produces access to a specific item or activity.' },
                        { id: 'Sensory',   icon: '✨', color: '#8b5cf6', name: t('stem.behaviorlab.sensory', 'Sensory'),   def: 'Behavior produces stimulation that is itself the reinforcer. No social or material payoff needed.' }
                      ].map(function(f, i) {
                    ...
                    React.createElement('p', { className: 'text-[10px] italic text-slate-400 mb-3 text-center' },
                      t('stem.behaviorlab.a_behavior_can_have_more_than_one_func', 'A behavior can have more than one function in reality. For these vignettes, pick the most-likely primary function based on the contingency described.')
                    ),
                    React.createElement("div", { className: "text-center" },
                      React.createElement("button", {
                        onClick: startFn,
                        "aria-label": t('stem.behaviorlab.start_function_sleuth', "Start Function Sleuth"),
                      ...
                      }, t('stem.behaviorlab.start_the_game_2', "🔍 Start the game"))
                    )
                  );
                }
                var v = FN_VIGNETTES[fnIdx];
                ...
                return React.createElement("div", null,
                  React.createElement("div", { className: "flex items-center flex-wrap gap-3 mb-2 text-[11px]" },
                    React.createElement("span", { className: "text-slate-300" }, t('stem.behaviorlab.round_2', "Round "), React.createElement("strong", { className: "text-white" }, fnShown.length)),
                    React.createElement("span", { className: "text-slate-300" }, t('stem.behaviorlab.streak_2', "Streak "), React.createElement("strong", { className: "text-amber-400" }, fnStreak)),
                    React.createElement("span", { className: "text-slate-300" }, t('stem.behaviorlab.best_2', "Best "), React.createElement("strong", { className: "text-emerald-400" }, fnBest)),
                    fnRounds > 0 && React.createElement("span", { className: "text-slate-300" }, t('stem.behaviorlab.accuracy_2', "Accuracy "), React.createElement("strong", { className: "text-cyan-400" }, pct + '%'))
                  ),
                  ...
                  React.createElement("div", { className: "grid grid-cols-2 gap-2 mb-2", role: 'radiogroup', 'aria-label': t('stem.behaviorlab.pick_the_function', 'Pick the function') },
                  ...
                  fnAnswered && React.createElement("div", {
                    ...
                    allDone
                      ? React.createElement("div", { style: { padding: '8px 10px', borderRadius: 8, background: 'rgba(59,130,246,0.10)', border: '1px solid rgba(59,130,246,0.45)' } },
                          React.createElement("div", { className: "text-[12px] font-bold text-blue-300 mb-1" }, t('stem.behaviorlab.all_12_vignettes_complete', '🏆 All 12 vignettes complete')),
                          ...
                          }, t('stem.behaviorlab.restart', '🔄 Restart'))
                        )
                      : React.createElement("button", {
                          onClick: startFn,
                        ...
                        }, t('stem.behaviorlab.next_vignette', '➡️ Next vignette'))
                  )
                );
              })()
            ),
            ...
            React.createElement("div", {
              ...
              React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold mb-2 uppercase tracking-wider" }, t('stem.behaviorlab.reinforcement_punishment_matrix', "\u2696\uFE0F Reinforcement \u0026 Punishment Matrix")),
              React.createElement("div", { className: "text-[11px] text-slate-200 italic mb-2" }, t('stem.behaviorlab.the_4_quadrants_of_operant_conditionin', "The 4 quadrants of operant conditioning. Click each cell to learn more:")),
              // Column headers
              React.createElement("div", { className: "grid grid-cols-3 gap-1 mb-1" },
                React.createElement("div", null),
                React.createElement("div", { className: "text-center text-[11px] font-bold text-emerald-400 uppercase" }, t('stem.behaviorlab.add_stimulus', "\u2795 Add Stimulus")),
                React.createElement("div", { className: "text-center text-[11px] font-bold text-blue-400 uppercase" }, t('stem.behaviorlab.remove_stimulus', "\u2796 Remove Stimulus"))
              ),
              // Row 1: Reinforcement
              React.createElement("div", { className: "grid grid-cols-3 gap-1 mb-1" },
                React.createElement("div", { className: "flex items-center text-[11px] font-bold text-green-400 uppercase pr-1" }, t('stem.behaviorlab.increase_behavior', "\u2B06 Increase Behavior")),
              ...
              React.createElement("div", { className: "grid grid-cols-3 gap-1" },
                React.createElement("div", { className: "flex items-center text-[11px] font-bold text-red-400 uppercase pr-1" }, t('stem.behaviorlab.decrease_behavior', "\u2B07 Decrease Behavior")),
              ...
              blMatrixIdx && (function() {
                ...
                return React.createElement("div", {
                  ...
                  React.createElement("div", { className: "text-[11px] text-slate-200 mb-2" },
                    ...
                    t('stem.behaviorlab.a_stimulus_to', ' a stimulus to '),
                    React.createElement("span", { className: "font-bold text-blue-400" }, sel.effect),
                    ' behavior'
                  ),
                  React.createElement("div", { className: "text-[11px] text-amber-400 font-medium mb-1" }, t('stem.behaviorlab.real_world_examples', '\uD83D\uDCA1 Real-world examples:')),
            ...
            React.createElement("div", {
              ...
              React.createElement("p", { className: "text-[11px] text-slate-200 font-bold mb-1 uppercase tracking-wider" }, t('stem.behaviorlab.token_economy_builder', "\uD83C\uDFAE Token Economy Builder")),
              React.createElement("div", { className: "text-[11px] text-slate-200 italic mb-2" }, t('stem.behaviorlab.design_a_classroom_token_economy_award', "Design a classroom token economy! Award tokens for positive behaviors, then let students exchange them for rewards. This is a real ABA strategy used in schools worldwide.")),
              // Token balance
              React.createElement("div", { className: "flex items-center justify-center gap-3 mb-3 py-2 bg-gradient-to-r from-amber-900/30 to-emerald-900/30 rounded-xl border border-amber-700/30" },
                ...
                React.createElement("div", { className: "text-center" },
                  React.createElement("div", { className: "text-[11px] text-slate-200 uppercase tracking-wider" }, t('stem.behaviorlab.token_balance', 'Token Balance')),
              ...
              // Earn tokens
              React.createElement("div", { className: "mb-3" },
                React.createElement("div", { className: "text-[11px] font-bold text-emerald-400 uppercase tracking-wider mb-1" }, t('stem.behaviorlab.earn_tokens', '\u2B06 Earn Tokens')),
              ...
              React.createElement("div", { className: "mb-2" },
                React.createElement("div", { className: "text-[11px] font-bold text-amber-400 uppercase tracking-wider mb-1" }, t('stem.behaviorlab.spend_tokens', '\uD83C\uDF81 Spend Tokens')),
                React.createElement("div", { className: "grid grid-cols-2 gap-1" },
              ...
              blTokenLog.length > 0 && React.createElement("div", { className: "mt-2" },
                React.createElement("div", { className: "text-[11px] text-slate-200 uppercase tracking-wider mb-0.5" }, t('stem.behaviorlab.recent_activity', 'Recent Activity')),
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { className: "flex items-center justify-between mb-2" },
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold uppercase tracking-wider" }, t('stem.behaviorlab.operant_vs_classical_conditioning', "\uD83D\uDD2C Operant vs Classical Conditioning")),
                React.createElement("button", { "aria-label": t('stem.behaviorlab.aspect', "Aspect"),
              ...
              blShowCondCompare && React.createElement("div", null,
                React.createElement("div", { className: "rounded-xl overflow-hidden border border-slate-700/30" },
                  ...
                  React.createElement("div", { className: "grid grid-cols-3 bg-slate-800/60" },
                    React.createElement("div", { className: "p-1.5 text-[11px] font-bold text-slate-200 uppercase" }, t('stem.behaviorlab.aspect_2', 'Aspect')),
                    React.createElement("div", { className: "p-1.5 text-[11px] font-bold text-amber-400 uppercase text-center border-l border-slate-700/30" }, t('stem.behaviorlab.operant', '\uD83D\uDC2D Operant')),
                    React.createElement("div", { className: "p-1.5 text-[11px] font-bold text-violet-400 uppercase text-center border-l border-slate-700/30" }, t('stem.behaviorlab.classical', '\uD83D\uDC36 Classical'))
                  ),
                  // Data rows
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { className: "flex items-center justify-between mb-2" },
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold uppercase tracking-wider" }, t('stem.behaviorlab.behavior_intervention_plan_bip_builder', "\uD83D\uDCCB Behavior Intervention Plan (BIP) Builder")),
              ...
              blShowBipPlanner && React.createElement("div", null,
                React.createElement("div", { className: "text-[11px] text-slate-200 italic mb-3" }, t('stem.behaviorlab.walk_through_the_steps_of_creating_a_r', "Walk through the steps of creating a real Behavior Intervention Plan \u2014 the document ABA professionals use to address challenging behavior.")),
                // Step indicators
                ...
                (function() {
                  var steps = [
                    { title: t('stem.behaviorlab.step_1_identify_target_behavior', 'Step 1: Identify Target Behavior'), prompt: t('stem.behaviorlab.describe_the_behavior_you_want_to_chan', 'Describe the behavior you want to change. Be specific and observable!'), field: 'behavior', placeholder: t('stem.behaviorlab.e_g_student_calls_out_answers_without_', 'e.g., Student calls out answers without raising hand (3-5 times per class)') },
                    { title: t('stem.behaviorlab.step_2_identify_antecedents', 'Step 2: Identify Antecedents'), prompt: t('stem.behaviorlab.what_happens_right_before_the_behavior', 'What happens RIGHT BEFORE the behavior? What triggers it?'), field: 'antecedent', placeholder: t('stem.behaviorlab.e_g_teacher_asks_a_question_to_the_who', 'e.g., Teacher asks a question to the whole class') },
                    { title: t('stem.behaviorlab.step_3_hypothesize_function', 'Step 3: Hypothesize Function'), prompt: t('stem.behaviorlab.why_does_the_student_engage_in_this_be', 'WHY does the student engage in this behavior? (Attention, Escape, Tangible, Sensory)'), field: 'func', placeholder: t('stem.behaviorlab.e_g_attention_student_wants_teacher_an', 'e.g., Attention \u2014 student wants teacher and peer attention') },
                    { title: t('stem.behaviorlab.step_4_replacement_behavior', 'Step 4: Replacement Behavior'), prompt: t('stem.behaviorlab.what_appropriate_behavior_should_repla', 'What appropriate behavior should REPLACE the problem behavior? Must serve the SAME function!'), field: 'replacement', placeholder: t('stem.behaviorlab.e_g_raise_hand_and_wait_to_be_called_o', 'e.g., Raise hand and wait to be called on (still gets attention but appropriately)') },
                    { title: t('stem.behaviorlab.step_5_intervention_strategy', 'Step 5: Intervention Strategy'), prompt: t('stem.behaviorlab.how_will_you_teach_and_reinforce_the_r', 'How will you teach and reinforce the replacement behavior?'), field: 'strategy', placeholder: t('stem.behaviorlab.e_g_teach_hand_raising_reinforce_with_', 'e.g., Teach hand-raising, reinforce with praise + 2 tokens; ignore call-outs (extinction)') }
                  ];
                  if (blBipStep < 5) {
                    ...
                    return React.createElement("div", { className: "space-y-2" },
                      ...
                      React.createElement("div", { className: "flex gap-2 justify-end" },
                        blBipStep > 0 && React.createElement("button", { "aria-label": t('stem.behaviorlab.back', "Back"),
                          onClick: function() { upd('blBipStep', blBipStep - 1); },
                          className: "transition-colors px-3 py-1 rounded-lg text-[11px] font-bold bg-slate-700 text-slate-100 hover:bg-slate-600 focus:ring-2 focus:ring-cyan-400 focus:outline-none active:scale-[0.97]"
                        }, t('stem.behaviorlab.back_2', '\u2190 Back')),
                        React.createElement("button", { "aria-label": t('stem.behaviorlab.next', "Next"),
                          onClick: function() {
                        ...
                        }, t('stem.behaviorlab.next_2', 'Next \u2192'))
                      )
                    );
                  } else {
                    // Summary view
                    return React.createElement("div", { className: "space-y-2" },
                      React.createElement("div", { className: "text-[11px] font-bold text-emerald-300" }, t('stem.behaviorlab.your_behavior_intervention_plan', '\u2705 Your Behavior Intervention Plan')),
                      React.createElement("div", { className: "rounded-xl bg-slate-800/60 p-3 space-y-2 border border-emerald-700/30" },
                        [
                          { label: t('stem.behaviorlab.target_behavior', 'Target Behavior'), value: blBipData.behavior, color: 'text-red-300' },
                          { label: t('stem.behaviorlab.antecedent', 'Antecedent'), value: blBipData.antecedent, color: 'text-blue-300' },
                          { label: t('stem.behaviorlab.hypothesized_function', 'Hypothesized Function'), value: blBipData.func, color: 'text-amber-300' },
                          { label: t('stem.behaviorlab.replacement_behavior', 'Replacement Behavior'), value: blBipData.replacement, color: 'text-emerald-300' },
                          { label: t('stem.behaviorlab.intervention_strategy', 'Intervention Strategy'), value: blBipData.strategy, color: 'text-violet-300' }
                      ...
                      React.createElement("div", { className: "flex gap-2 justify-center" },
                        React.createElement("button", { "aria-label": t('stem.behaviorlab.edit', "Edit"),
                          onClick: function() { upd('blBipStep', 0); },
                          className: "transition-colors px-3 py-1 rounded-lg text-[11px] font-bold bg-slate-700 text-slate-100 hover:bg-slate-600 focus:ring-2 focus:ring-cyan-400 focus:outline-none active:scale-[0.97]"
                        }, t('stem.behaviorlab.edit_2', '\u270F\uFE0F Edit')),
                        React.createElement("button", { "aria-label": t('stem.behaviorlab.new_plan', "New Plan"),
                        ...
                        }, t('stem.behaviorlab.new_plan_2', '\uD83D\uDD04 New Plan'))
                      )
                    );
                  }
                })()
                ...
                return React.createElement("div", null,
                  ...
                  answered && React.createElement("div", { className: "space-y-2" },
                    ...
                    React.createElement("div", { className: "rounded-xl p-2.5 text-[11px] bg-blue-900/20 border border-blue-700/30 text-blue-300" },
                      React.createElement("span", { className: "font-bold" }, t('stem.behaviorlab.better_approach', '\uD83D\uDCA1 Better approach: ')),
                      sc.better
                    ),
                    React.createElement("button", { "aria-label": t('stem.behaviorlab.next_scenario', "Next Scenario ("),
                      onClick: function() {
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { className: "flex items-center justify-between mb-2" },
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold uppercase tracking-wider" }, t('stem.behaviorlab.aba_history_timeline', "\uD83D\uDCC5 ABA History Timeline")),
              ...
              blShowTimeline && React.createElement("div", { className: "relative ml-4" },
                ...
                React.createElement("div", { className: "flex gap-3 mt-2 justify-center" },
                  [{ name: t('stem.behaviorlab.foundations', 'Foundations'), color: 'bg-blue-500' }, { name: t('stem.behaviorlab.growth', 'Growth'), color: 'bg-amber-500' }, { name: t('stem.behaviorlab.applied', 'Applied'), color: 'bg-emerald-500' }, { name: t('stem.behaviorlab.modern', 'Modern'), color: 'bg-violet-500' }].map(function(era) {
            ...
            React.createElement("div", {
              ...
              React.createElement("div", { className: "flex items-center justify-between mb-2" },
                React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold uppercase tracking-wider" }, t('stem.behaviorlab.quick_reference_cards', "\uD83D\uDCCB Quick Reference Cards")),
            ...
            React.createElement("div", {
              ...
              React.createElement("h4", { className: "text-[11px] text-slate-200 font-bold mb-2 uppercase tracking-wider" }, t('stem.behaviorlab.three_term_contingency_2', "\uD83D\uDD17 Three-Term Contingency")),
