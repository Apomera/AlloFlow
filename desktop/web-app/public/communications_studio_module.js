...
${translation}`);
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-3 p-4 text-slate-800", "data-communications-studio": "true" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2" }, /* @__PURE__ */ React.createElement("h2", { className: "text-lg font-black text-indigo-900" }, tr("comms.title", "Communications Studio")), /* @__PURE__ */ React.createElement("span", { className: "text-xs text-slate-600" }, tr("comms.subtitle", "Drafts from your notes. Codenames only. Nothing is sent from here.")), typeof props.onClose === "function" && /* @__PURE__ */ React.createElement("button", { type: "button", onClick: props.onClose, className: "ml-auto rounded-full border border-slate-300 px-3 py-1 text-xs font-bold hover:bg-slate-100" }, tr("common.close", "Close"))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2", role: "tablist", "aria-label": tr("comms.templates", "Templates") }, CS_TEMPLATES.map((x) => /* @__PURE__ */ React.createElement("button", { key: x.id, type: "button", role: "tab", "aria-selected": x.id === templateId, onClick: () => {
    setTemplateId(x.id);
    setDraft("");
    setBatch([]);
    setTranslation("");
