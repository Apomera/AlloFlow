...
// Source lines: 15366–16478 (1113 lines)
// Hash: 2d1bac95aa164d31
                          ...
                          <div className="flex flex-col sm:flex-row gap-2">
                              ...
                              <div className="flex-grow flex gap-2">
                                  ...
                                  <button aria-label={t('common.search_learning_standards')}
                                    ...
                                    className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-4 rounded-xl shadow-md transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
                                  >
                          ...
                          <div>
                              ...
                              <div className="flex gap-2 mb-6">
                                  ...
                                  <button
                                      ...
                                      className="bg-blue-600 text-white font-bold px-6 rounded-xl hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2 shadow-md"
                                  >
                          ...
                          <div>
                              ...
                              <div className="flex gap-2 mb-6">
                                  ...
                                  <button aria-label={t('common.search_with_ai')}
                                      ...
                                      className="bg-teal-700 text-white font-bold px-6 rounded-xl hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2 shadow-md"
                                  >
                          ...
                          <div>
                              ...
                              <div className="space-y-4">
                                        ...
                                        {standardMode === 'ai' ? (
                                            <div className="space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                                                <div className="flex gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="bg-indigo-600 hover:bg-indigo-700 text-white p-1.5 rounded disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm"
                                                        ...
                                                        {suggestedStandards.map((std, idx) => (
                                                            ...
                                                            >
                                                                <div className="flex justify-between items-start gap-1">
                                                                    ...
                                                                    <span className="text-[11px] text-slate-500 uppercase ml-auto">{std.framework}</span>
                                                                </div>
                                            ...
                                            <div className="flex gap-2 animate-in fade-in slide-in-from-top-1 duration-200">
                                                ...
                                                <button
                                                    ...
                                                    className="bg-indigo-100 text-indigo-700 p-1.5 rounded hover:bg-indigo-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                  ...
                                  <button
                                      ...
                                      className="w-full bg-purple-600 text-white font-bold py-3 rounded-xl hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-transform hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-2 shadow-md mt-4"
                                  >
                                      {t('common.next')} <ArrowRight size={18} />
                                  </button>
                              </div>
                  ...
                  <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                      <div>
                          ...
                          <div className="space-y-4">
                              ...
                              <div>
                                  ...
                                  <div className="flex gap-2 mb-2">
                                      ...
                                      <button aria-label={t('common.add')}
                                        ...
                                        className="bg-indigo-100 text-indigo-700 p-3 rounded-xl hover:bg-indigo-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                      >
                                        <Plus size={20} />
                                      </button>
                                  </div>
                              ...
                              <div>
                                  <label className="block text-sm font-bold text-slate-600 mb-1">{t('wizard.interests_label_optional').replace(' (Optional)', '')}<span className="text-slate-500 font-normal"> (Optional)</span></label>
                                  <div className="flex gap-2 mb-2">
