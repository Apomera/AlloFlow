...
(function() {
  ...
  window.SelHub.registerTool('journal', {
    ...
    render: function(ctx) {
      ...
      var _jou_FGL = {'#94a3b8':'#64748b','#cbd5e1':'#334155','#f1f5f9':'#0f172a','#e2e8f0':'#1e293b'}, _jou_FGH = {'#ec4899':'#ffff00','#94a3b8':'#ffff00','#cbd5e1':'#ffff00','#f1f5f9':'#ffff00','#f59e0b':'#ffff00','#22c55e':'#ffff00','#e2e8f0':'#ffff00','#fff':'#ffff00','#ef4444':'#ffff00','#8b5cf6':'#ffff00'};
      ...
      return (function() {
        ...
        if (showBadgePopup) {
          ...
          if (popBadge) {
            ...
            style: { position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, background: 'rgba(0,0,0,0.6)' }, onClick: function() { upd('showBadgePopup', null); } },
              ...
              h('div', { style: { display: 'flex', flexDirection: 'column', gap: 8 } },
                MOOD_PLAYLIST[showCoping].activities.map(function(act, idx) {
                  ...
                  return h('div', {                     key: idx,
                    ...
                    h('div', { style: { flex: 1 } },
                      h('div', { style: { fontSize: 12, fontWeight: 600, color: isDone ? _jouFg('#22c55e') : _jouFg('#f1f5f9'), marginBottom: 2, textDecoration: isDone ? 'line-through' : 'none' } }, act.label),
                  ...
                  LETTER_TIME_OPTIONS.map(function(opt) {
                    ...
                    return h('button', { 'aria-label': opt.label,
                      ...
                      style: {
                        ...
                        color: isActive ? _jouFg(letterColor) : _jouFg('#94a3b8')
                      }
                    }, opt.label);
                  })
                )
            ...
            letterViewerContent = h('div', null,
              letterEntries.slice().reverse().map(function(letter, i) {
                ...
                return h('div', { key: i, style: { padding: 16, borderRadius: 14, background: _jouBg('#0f172a'), border: '1px solid ' + letterCol + '33', marginBottom: 12 } },
                  ...
                  isFutureLetter && readDateStr && h('div', { style: { fontSize: 10, color: canRead ? _jouFg('#22c55e') : _jouFg('#f59e0b'), marginBottom: 8, fontStyle: 'italic' } },
