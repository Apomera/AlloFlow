...
Locator: getByLabel('Earliest finale round (open-ended)', { exact: true })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByLabel('Earliest finale round (open-ended)', { exact: true })
...
- main:
  - region "Essential setup":
    ...
    - combobox "Episode length":
      ...
      - option "Standard · 12 decisions"
      - option "Long · 20 decisions"
      - option "Open-ended" [selected]
    ...
    - text: Include a final challenge Earliest finale round (open-ended)
    - spinbutton "Earliest finale round (open-ended) The finale also waits for sufficient story progress.": "20"
    - text: The finale also waits for sufficient story progress. Social skill to practise
    - textbox "Social skill to practise":
      - /placeholder: e.g., Sharing toys, Dealing with frustration
      - text: Resolving disagreements
    - checkbox "Track resources Track how your decisions affect the system." [checked]
    - text: Track resources Track how your decisions affect the system. Resource setup
    - combobox "Resource setup":
      - option "AI-generated resources"
      - option "Teacher-defined resources" [selected]
    - text: Resource name 1
    - textbox "Resource name 1": Budget
    - text: Starting value 1
    - spinbutton "Starting value 1": "1200"
    - text: Unit 1
    - textbox "Unit 1": credits
    - button "Remove resource 1"
    - button "Add resource"
  - group: "Learning supports Reading practice: Off"
  - group: "Story & game rules Chance: Off"
  - group: "Visuals Art style: auto"
  - group: Story guidance No custom instructions
  - group: "Saving & permissions Cloud images: Off"
  - region "Setup summary":
    - strong: "Setup summary:"
    - text: Systems simulation · Open-ended · 4 suggested choices · English only
```
