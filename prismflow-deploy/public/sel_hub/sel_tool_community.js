    ...
    render: function(ctx) {
      return (function() {
        ...
        var tabBar = h('div', {
          ...
          h('button', { 'aria-label': 'Toggle sound', onClick: function() { upd({ soundEnabled: !soundEnabled }); }, style: { marginLeft: 'auto', background: 'none', border: 'none', cursor: 'pointer', fontSize: 14, padding: '4px 6px', color: '#9ca3af' }, title: soundEnabled ? 'Mute' : 'Unmute' }, soundEnabled ? '\uD83D\uDD0A' : '\uD83D\uDD07'),
          h('button', { 'aria-label': 'Toggle badges panel', onClick: function() { upd({ showBadgesPanel: !showBadgesPanel }); }, style: { background: 'none', border: 'none', cursor: 'pointer', fontSize: 14, padding: '4px 6px', color: '#9ca3af', position: 'relative' } },
            '\uD83C\uDFC5',
        ...
        if (showBadgesPanel) {
          badgePopup = h('div', { style: { position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9998, background: 'rgba(0,0,0,0.5)' }, onKeyDown: function(e) { if (e.key === 'Escape') e.currentTarget.click(); }, role: 'dialog', 'aria-modal': 'true', 'aria-label': 'Badge details', tabIndex: -1, onClick: function() { upd({ showBadgesPanel: false }); } },
          ...
          badgesContent = h('div', { style: { padding: 20, maxWidth: 600, margin: '0 auto' } },
            ...
            h('div', { style: { padding: 16, borderRadius: 14, background: '#1e293b', border: '1px solid ' + ACCENT_MED, marginBottom: 20 } },
              ...
              h('div', { style: { display: 'flex', gap: 6 } },
                ...
                h('button', { 'aria-label': 'Ask AI coach',
                  onClick: function() {
