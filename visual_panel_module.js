 ...
 *
 * Contains: VisualPanelGrid + visual planning/GIF generation helpers
 *
...
async function encodeFramesToGif(framesBase64, width, height, fps = 3) {
  ...
  for (let fi = 0; fi < canvases.length; fi++) {
    parts.push(new Uint8Array([33, 249, 4, 0, delay & 255, delay >> 8 & 255, 0, 0]));
...
async function generateVisualPlan(concept, gradeLevel, studentLanguage, artStyle = "", customInstructions = "", signal = null, deps = {}) {
  const { callGemini, cleanJson, warnLog = function() {
  } } = deps;
...
async function generateAnimatedPanel(panel, targetWidth = 400, targetQual = 0.8, artStyle = "", signal = null, deps = {}) {
  const { callGemini, callGeminiImageEdit, callImagen, warnLog = function() {
  } } = deps;
...
Return ONLY valid JSON:
{
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { id: "visual-label-move-instructions", className: "sr-only" }, "Use arrow keys to move labels and leader-line anchors. Hold Shift for a larger step."), /* @__PURE__ */ React.createElement("div", { role: "status", "aria-live": "polite", "aria-atomic": "true", className: "sr-only" }, labelMoveStatus), /* @__PURE__ */ React.createElement("div", { role: "status", "aria-live": "polite", "aria-atomic": "true", className: "sr-only" }, exportStatus), /* @__PURE__ */ React.createElement("div", { className: "visual-grid-controls", style: { display: "flex", flexWrap: "wrap", gap: "6px", padding: "8px 12px", background: "linear-gradient(135deg, #f8fafc 0%, #eef2ff 100%)", borderRadius: "10px", border: "1px solid #e2e8f0", marginBottom: "8px", alignItems: "center" } }, !isStudentChallenge && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "4px", alignItems: "center" } }, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("span", { className: "sr-only" }, "Place new label")
    ...
    return /* @__PURE__ */ React.createElement(
      "div",
      {
        ...
        role: "group",
        "aria-label": isUserFillBlank ? "Fill in this label" : uLabel.text + " label controls",
    ...
    !challengeSubmitted && /* @__PURE__ */ React.createElement("button", { type: "button", className: "label-delete-btn", onClick: () => handleDeleteStudentLabel(panelIdx, sLabel.id), "aria-label": `Remove student label from panel ${panelIdx + 1}`, style: { background: "#fff1f2", border: "1px solid #fecaca", borderRadius: "6px", cursor: "pointer", fontSize: "14px", padding: 0, color: "#b91c1c", minWidth: "32px", minHeight: "32px" } }, "\u2715"),
  ...
  window.AlloModules.VisualGeneration = {
    encodeFramesToGif: encodeFramesToGif,
    generateVisualPlan: generateVisualPlan,
    generateAnimatedPanel: generateAnimatedPanel,
    executeVisualPlan: executeVisualPlan
  };
