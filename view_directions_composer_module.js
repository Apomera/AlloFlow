...
function DirectionsComposerView({
  ...
  } }, /* @__PURE__ */ React.createElement("div", { "data-help-key": "directions_composer", role: "dialog", "aria-modal": "true", "aria-label": t("directions.title") || "Assignment Directions", className: "bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-md p-4 flex flex-col overflow-hidden", style: { maxHeight: "calc(100dvh - 2rem)" } }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-1" }, /* @__PURE__ */ React.createElement(ClipboardList, { size: 18, className: "text-amber-600", "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("h2", { className: "text-sm font-bold text-slate-800 flex-1" }, t("directions.title") || "Assignment Directions"), /* @__PURE__ */ React.createElement("button", { onClick: () => setShowDirectionsComposer(false), "aria-label": t("common.close") || "Close", className: "text-slate-600 hover:text-slate-700 p-1 rounded-lg transition-all" }, /* @__PURE__ */ React.createElement(X, { size: 16 }))), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-slate-500 mb-2" }, t("directions.subtitle") || "Student-facing. Students see this first \u2014 in class, on homework QRs, and on the take-home shelf."), /* @__PURE__ */ React.createElement("div", { className: "space-y-2 min-h-0 flex-1 overflow-y-auto pr-1", "data-directions-scroll": true }, /* @__PURE__ */ React.createElement("input", { "data-help-key": "directions_title", autoFocus: true, value: mbDirectionsDraft?.title || "", onChange: (e) => setMbDirectionsDraft((p) => ({ ...p || {}, title: e.target.value })), placeholder: t("directions.title_placeholder") || "Title (e.g. Tonight's homework)", "aria-label": t("directions.title_aria") || "Directions title", className: "w-full text-xs border border-slate-300 rounded-lg p-2 bg-white text-slate-800" }), /* @__PURE__ */ React.createElement("textarea", { "data-help-key": "directions_body", value: mbDirectionsDraft?.body || "", onChange: (e) => setMbDirectionsDraft((p) => ({ ...p || {}, body: e.target.value })), placeholder: t("directions.body_placeholder") || "Directions for students: the steps, and what finished work looks like.", "aria-label": t("directions.body_aria") || "Directions for students", rows: 6, className: "w-full text-xs border border-slate-300 rounded-lg p-2 bg-white text-slate-800" }), /* @__PURE__ */ React.createElement("input", { "data-help-key": "directions_due", value: mbDirectionsDraft?.due || "", onChange: (e) => setMbDirectionsDraft((p) => ({ ...p || {}, due: e.target.value })), placeholder: t("directions.due_placeholder") || "Due (optional, e.g. Friday)", "aria-label": t("directions.due_aria") || "Due date", className: "w-full text-xs border border-slate-300 rounded-lg p-2 bg-white text-slate-800" }), /* @__PURE__ */ React.createElement("details", { className: "rounded-lg border border-slate-200 bg-slate-50 p-2", "data-directions-preview": true }, /* @__PURE__ */ React.createElement("summary", { className: "cursor-pointer text-xs font-bold text-indigo-800" }, previewLabel && previewLabel !== "common.preview" ? previewLabel : "Preview"), directionsPreviewHtml ? /* @__PURE__ */ React.createElement("div", { className: "mt-3 text-sm text-slate-800 break-words", dangerouslySetInnerHTML: { __html: typeof window.sanitizeHtml === "function" ? window.sanitizeHtml(directionsPreviewHtml) : "" } }) : /* @__PURE__ */ React.createElement("p", { className: "mt-2 text-xs text-slate-600" }, t("directions.body_placeholder") || "Write directions to preview them here.")), /* @__PURE__ */ React.createElement("div", { className: "border-t border-indigo-100 pt-2" }, /* @__PURE__ */ React.createElement("label", { className: "flex items-start gap-2 cursor-pointer select-none" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "checkbox",
