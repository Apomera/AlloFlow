...
- Name: document_builder_responsive_keyboard.spec.ts >> Enhancements: table and image controls follow selection at 1440
...
- dialog "Document Builder":
  ...
  - tablist "Document Builder ribbon":
    ...
    - button "Expand ribbon"
  - iframe
  - text: Editing enabled
  - status: Saved on this device · 08:38 PM
  ...
  - combobox "Preview zoom mode":
    ...
    - option "Custom zoom"
  - button "Zoom out": −
  - slider "Editor zoom": "165"
  - button "Zoom in": +
  - button "Reset editor zoom to 100 percent": 165%
```
