...
function EducatorHubModal(props) {
  ...
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F52C}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-blue-800" }, t("educator_hub.dynamic_assessment_title") || "Dynamic Assessment"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-blue-600 mt-1" }, t("educator_hub.dynamic_assessment_desc") || "Vygotsky/Feuerstein/Lidz test-teach-retest probes with graduated prompt ladders, modifiability scoring, IEP goals, accommodations, and family/teacher handoffs"))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-help-key": "educator_hub_udl_walkthrough_card", onClick: () => {
    setShowEducatorHub(false);
    setIsUdlWalkthroughOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-cyan-50 to-sky-50 border border-cyan-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u{1F6AA}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-cyan-800" }, t("educator_hub.udl_walkthrough_title") || "UDL Walkthrough"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-cyan-700 mt-1" }, t("educator_hub.udl_walkthrough_desc") || "Growth-framed classroom visits for admins and coaches: tap UDL look-fors from the doorway, log student moments, and share a strengths-first feedback card. Data never leaves this device."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-help-key": "educator_hub_dispro_analyzer_card", onClick: () => {
    setShowEducatorHub(false);
    setIsDisproAnalyzerOpen(true);
  }, className: "flex items-start gap-3 p-4 bg-gradient-to-br from-slate-50 to-indigo-50 border border-slate-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all motion-reduce:transform-none motion-reduce:transition-none text-left" }, /* @__PURE__ */ React.createElement("span", { className: "text-3xl mt-1", "aria-hidden": "true" }, "\u2696\uFE0F"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-slate-800" }, t("educator_hub.dispro_analyzer_title") || "Disproportionality Analyzer"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-slate-600 mt-1" }, t("educator_hub.dispro_analyzer_desc") || "Risk indexes, risk ratios, and composition from aggregate discipline or identification counts \u2014 with stability cautions, computed entirely on this device. Descriptive analytics for root-cause review, not a compliance verdict."))), /* @__PURE__ */ React.createElement("button", { type: "button", "data-help-key": "educator_hub_lesson_builder_card", onClick: () => {
    setShowEducatorHub(false);
    startLessonFlow();
