...
export function ConnectedTeacher(props) {
  ...
  return <section className="cer cer-teacher" aria-label={tr(t, 'teacher_controls', 'Escape room teacher controls')}><Styles/><ConnectedHost {...props}/>
