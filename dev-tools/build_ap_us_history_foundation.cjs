...
const itemSpecs = [
  ...
  { unit: 8, section: 2, topicId: '8.12', practiceId: 'H5', skillId: '5.B', reasoning: 'continuity-change', prompt: 'Which development best connects youth culture and environmental activism in the 1960s and 1970s?', answer: 'Both challenged established institutions and encouraged Americans to question how economic growth affected daily life and public well-being.', distractors: ['Both movements rejected all federal action and public regulation.', 'Neither movement used media, organizations, or public protest.', 'Both movements were limited to one region and had no national effect.'], rationale: 'Youth and environmental movements differed in goals but shared a wider challenge to authority, consumption, and institutional trust.', sourceUrl: 'https://openstax.org/books/us-history/pages/30-introduction' },
  // Unit 9
...
function main() {
  ...
  assert(Object.values(specCounts).every((count, index) => count === (index === 0 || index === 1 || index === 8 ? 5 : 6)), 'Unexpected unit distribution.');
