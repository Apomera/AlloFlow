(function initResearchLaneScientific(retriesLeft) {
  ...
  function AiResultPanel(props) {
    ...
    var aiScalarText2 = primitives.aiScalarText || function(v) {
