...
var _alloUseFocusTrap = (typeof window !== 'undefined' && window.__alloHooks && window.__alloHooks.useFocusTrap) || function(){};
...
{"headingColor":"hex","accentColor":"hex","bgColor":"hex","headerBg":"hex","headerText":"hex","tableBg":"hex","tableBorder":"hex","bodyFont":"CSS font-family","headingFont":"CSS font-family"}`,
      ...
      "button",
      {
        onClick: async () => {
          try {
            ...
            // Born-digital linkage disclosure: text-layer PDFs get ActualText-associated
            // semantic tags, not full MCID linkage (unify pass is scanned-only) — disclose
            // rather than imply full PDF/UA linkage.
    ...
    }, "data-help-key": "pdf_audit_view_adobe_report_btn", className: "w-full px-4 py-2.5 text-left text-xs font-bold text-emerald-700 hover:bg-emerald-50 transition-colors" }, "\u{1F3DB}\uFE0F Adobe-style A11y Report", lastTaggedValidation ? ` (${lastTaggedValidation.pdfUa1Checks?.summary?.conformancePct ?? 0}% conformance)` : ""), (() => {
