...
Begin with the learning goal and evidence of success. Then choose AlloFlow tools because they serve that design. If you are preparing your first resource, start with [Start here](01-start-here.md).
...
![AlloFlow Source Material workspace with catalog, web-resource, and topic options](../assets/screenshots/03-source-material.png)
...
Avoid public labels based on perceived ability. In a live lesson, use private individual or group routing when that better protects student dignity. See [Live sessions](03-live-sessions.md).
...
Continue with [Accessibility and UDL](04-accessibility-and-udl.md) for a deeper learner-experience review, [Live sessions](03-live-sessions.md) for synchronous delivery, or [Review evidence and plan next steps](05-review-and-next-steps.md) for using classroom evidence responsibly.
