// Headless driver for pdfbox_verapdf_coload.html — boots the co-load window and reports
...
(async () => {
  ...
  page.on('console', (m) => { const t = m.text(); if (t.startsWith('[coload]')) console.log('  ' + t.slice(9)); });
  page.on('pageerror', (e) => console.log('[pageerror] ' + e.message));
  await page.goto('http://localhost:' + PORT + '/pdfbox_verapdf_coload.html', { waitUntil: 'load', timeout: 60000 });
