                        ...
                        React.createElement("div", { className: "flex gap-1" },
                          ...
                          [4, 6, 8].map(function(n) {
                            ...
                            return React.createElement("button", { key: n, onClick: function() { upd('stereoFlipbookFrameCount', n); },
                              ...
                              className: "px-3 py-1 rounded-lg text-[10px] font-bold transition-all " + ((d.stereoFlipbookFrameCount || 6) === n ? 'bg-indigo-600 text-white' : 'bg-white text-slate-600 border border-slate-400 hover:bg-indigo-50')
