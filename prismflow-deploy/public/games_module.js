 ...
 *
 * Contains: MemoryGame, MatchingGame, TimelineGame, ConceptSortGame, VennGame, CauseEffectSortGame, CrosswordGame, SyntaxScramble, BingoGame, StudentBingoGame, WordScrambleGame
 *
...
const WordScrambleGame = React.memo(({ data, onClose, playSound, onScoreUpdate }) => {
  ...
  console.log('[GamesBundle] 11 game components registered');
})();
