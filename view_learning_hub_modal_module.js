...
function LearningHubModal(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-[60] bg-black/40 flex items-center justify-center p-4", onClick: () => setShowLearningHub(false), role: "button", tabIndex: 0, onKeyDown: (e) => {
    ...
    setShowLearningHub(false);
    setShowLitLab(true);
  }, className: "flex flex-col items-center gap-3 p-5 bg-gradient-to-br from-violet-50 to-purple-50 border border-violet-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all text-center" }, /* @__PURE__ */ React.createElement("span", { className: "text-4xl" }, "\u{1F3AD}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-violet-800" }, "LitLab"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-violet-600 mt-1" }, "Bring stories to life with character voices & literary analysis"))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    setShowLearningHub(false);
    setShowPoetTree(true);
  }, className: "flex flex-col items-center gap-3 p-5 bg-gradient-to-br from-teal-50 to-cyan-50 border border-teal-600 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all text-center" }, /* @__PURE__ */ React.createElement("span", { className: "text-4xl" }, "\u{1F333}"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-bold text-teal-800" }, "PoetTree"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-teal-600 mt-1" }, "Write poems with form scaffolds, rhyme & meter analysis, AI feedback"))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    setShowLearningHub(false);
    setShowSelHub(true);
