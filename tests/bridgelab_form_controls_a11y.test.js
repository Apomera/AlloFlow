...
const sourcePath = path.join(process.cwd(), 'stem_lab', 'stem_tool_bridgelab.js');
const publicPath = path.join(process.cwd(), 'desktop/web-app', 'public', 'stem_lab', 'stem_tool_bridgelab.js');

describe('Bridge Lab design notes accessibility', () => {
